...
public enum ER2138PosReAsruu0102 implements IObject<KeyValueString> {
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER2138PosReAsruu0102 eEnum : ER2138PosReAsruu0102.values()) {
	...
	public static String getName() {
		return ER2138PosReAsruu0102.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER2138PosReAsruu0102.class.getSimpleName().substring(2, 6));
	}
	...
	public static SegmentValidation genValidationAsetB() {
		return UtilSegmentValidation.genEqualsFormula("2|3", R_01020100000000.key, R_01020200000000.key, "Total Aset|Total Liabilitas dan Ekuitas");
	}
