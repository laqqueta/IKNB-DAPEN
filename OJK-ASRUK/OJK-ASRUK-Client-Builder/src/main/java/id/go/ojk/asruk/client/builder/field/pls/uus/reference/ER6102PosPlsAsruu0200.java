...
public enum ER6102PosPlsAsruu0200 implements IObject<KeyValueString> {
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER6102PosPlsAsruu0200 eEnum : ER6102PosPlsAsruu0200.values()) {
	...
	public static String getName() {
		return ER6102PosPlsAsruu0200.class.getSimpleName().substring(6);
	}

	public static int getRefNumber() {
		return Integer.parseInt(ER6102PosPlsAsruu0200.class.getSimpleName().substring(2, 6));
	}
...
//		return UtilSegmentValidation.genIsExistsForm("3", R_0020010000.key, EFormLaporanPolisUus.PLS_0100.getCode(), "2");
		return UtilSegmentValidation.genIsExistsFormDb("3", R_0020010000.key, EFormLaporanPolisUus.PLS_0100.getCode(),
				ER6101PosPlsAsruu0100.R_0010010000.getObject().getKey(), "2");
	}
	...
	public static SegmentValidation genValidation4() {
		return UtilSegmentValidation.genIsExistsFormDb("5", R_0020010000.key, EFormLaporanPolisUus.PLS_0100.getCode(),
				ER6101PosPlsAsruu0100.R_0010010000.getObject().getKey(), "7");
	}
}
