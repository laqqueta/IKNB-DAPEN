...
import id.go.ojk.asruk.client.builder.field.rb.uus.reference.ER2121PosRbAsruu1003;
...
public class Rb1003 extends BaseMetadata {
	...
	public SubmissionFormat get() {
		...
		fs.add(sf(3, null, "Posisi Jabatan",
				sv(C, 0, 1000, all).confConditionalRequired(ER2121PosRbAsruu1003.genConditionalField())));
		...
		fs.add(sf(8, null, "Alasan",
				sv(C, 0, 4000, all).confConditionalRequired(ER2121PosRbAsruu1003.genConditionalField())));
		return res;
	}
}
