...
public enum ER2133PosRbAsruu1210 implements IObject<KeyValueString> {
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER2133PosRbAsruu1210 eEnum : ER2133PosRbAsruu1210.values()) {
	...
	public static String getName() {
		return ER2133PosRbAsruu1210.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER2133PosRbAsruu1210.class.getSimpleName().substring(2, 6));
	}
