...
public enum ER2136PosRbAsruu1303 implements IObject<KeyValueString> {
...
//	R_13030300000000 ("13030300000000", "3.    Rasio perubahan dana"),
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER2136PosRbAsruu1303 eEnum : ER2136PosRbAsruu1303.values()) {
	...
	public static String getName() {
		return ER2136PosRbAsruu1303.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER2136PosRbAsruu1303.class.getSimpleName().substring(2, 6));
	}
