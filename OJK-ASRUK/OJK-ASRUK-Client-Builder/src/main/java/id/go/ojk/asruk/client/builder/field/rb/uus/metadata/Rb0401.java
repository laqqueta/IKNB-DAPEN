...
import id.go.ojk.asruk.client.builder.field.rb.uus.reference.ER2109PosRbAsruu0401;
...
public class Rb0401 extends BaseMetadata {
	...
	public SubmissionFormat get() {
		...
		fs.add(sf(1, null, "Kode Komponen / Baris",
				sv(M, 10, 10, refTable).confReference(EHeaderMetadataRbUus.R2109_RB0401.getObject())));
		fs.add(sf(2, null, "Usulan Nama Produk Baru", sv(O, 0, 1000, all)));
		fs.add(sf(3, null, "Lini Usaha/ Cabang Asuransi",
				sv(C, 0, 1000, all).confConditionalRequired(ER2109PosRbAsruu0401.genConditionalField())));
