...
import id.go.ojk.asruk.client.builder.field.rb.uus.reference.ER2117PosRbAsruu0701;
...
public class Rb0701 extends BaseMetadata {
	...
	public SubmissionFormat get() {
		...
		SubmissionFormat res = new SubmissionFormat(eEnum.getCode(), eEnum.getName(), reportCode,
				new ArrayList<>(), extension, 4, null, ER2117PosRbAsruu0701.genFieldSave(), null,
				ER2117PosRbAsruu0701.getRequiredPos());
		res.addSegmentValidations(ER2117PosRbAsruu0701.genValidationTotalModalDisetor());
		...
		fs.add(sf(2, null, "Nama Pemegang Saham",
				sv(C, 0, 300, all).confConditionalRequired(ER2117PosRbAsruu0701.genConditionalField2())));
		fs.add(sf(3, null, "Uraian Lainnya",
				sv(C, 0, 200, all).confConditionalRequired(ER2117PosRbAsruu0701.genConditionalField3())));
