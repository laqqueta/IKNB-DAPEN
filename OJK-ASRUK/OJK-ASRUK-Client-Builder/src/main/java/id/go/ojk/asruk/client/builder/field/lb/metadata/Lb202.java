...
import id.go.ojk.asruk.client.builder.field.lb.reference.ER3033PosLbAsruk202;
...
public class Lb202 extends BaseMetadata {
	...
	public SubmissionFormat get() {
		...
		SubmissionFormat res = new SubmissionFormat(eEnum.getCode(), eEnum.getName(), reportCode,
				new ArrayList<>(), extension, 27, 27, ER3033PosLbAsruk202.genFieldSave(), null,
				ER3033PosLbAsruk202.getRequiredPos());
		res.addSegmentValidations(ER3033PosLbAsruk202.genValidationJumlahPendapatanPremiDalamNegeri());
		res.addSegmentValidations(ER3033PosLbAsruk202.genValidationJumlahPendapatanPremiAsean());
		res.addSegmentValidations(ER3033PosLbAsruk202.genValidationJumlahPendapatanPremiLainnya());
		res.addSegmentValidations(ER3033PosLbAsruk202.genValidationJumlahPremiBruto());
		res.addSegmentValidations(ER3033PosLbAsruk202.genValidationJumlahPremiReasuransi());
		res.addSegmentValidations(ER3033PosLbAsruk202.genValidationJumlahKlaimRetensiSendiri());
		...
		fs.add(sf(18, null, "Jumlah", sv(M, 1, 16, numericNegatif))
				.addFieldValidations(ER3033PosLbAsruk202.genFieldValidation18()));
		return res;
	}
}
