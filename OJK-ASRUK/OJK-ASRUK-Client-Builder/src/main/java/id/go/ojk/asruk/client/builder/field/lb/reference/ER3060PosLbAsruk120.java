...
public enum ER3060PosLbAsruk120 implements IObject<KeyValueString> {
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER3060PosLbAsruk120 eEnum : ER3060PosLbAsruk120.values()) {
	...
	public static FieldValidation genFieldValidation12() {
		return UtilFieldValidation.genReferenceCondition("2", String.valueOf(EHeaderMetadataShared.R050.getNumber()));
	}

	public static FieldValidation genFieldValidation13() {
		return UtilFieldValidation.genReferenceCondition("2", String.valueOf(EHeaderMetadataShared.R057.getNumber()));
	}
