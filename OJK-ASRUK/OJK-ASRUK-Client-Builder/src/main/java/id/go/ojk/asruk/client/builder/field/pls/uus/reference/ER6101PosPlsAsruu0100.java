package id.go.ojk.asruk.client.builder.field.pls.uus.reference;
...
public enum ER6101PosPlsAsruu0100 implements IObject<KeyValueString> {
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER6101PosPlsAsruu0100 eEnum : ER6101PosPlsAsruu0100.values()) {
	...
	public static String getName() {
		return ER6101PosPlsAsruu0100.class.getSimpleName().substring(6);
	}

	public static int getRefNumber() {
		return Integer.parseInt(ER6101PosPlsAsruu0100.class.getSimpleName().substring(2, 6));
	}
	...
	public static SegmentValidation genValidationTotal() {
		return UtilSegmentValidation.genEqualsFormula(UtilMetadata.genPipeColumn(14, 17), R_0010020000.key,
