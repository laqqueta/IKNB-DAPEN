...
public enum ER2142PosReAsruu0203 implements IObject<KeyValueString> {
...
//	R_02030102010000 ("02030102010000", "Beban Klaim"),
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER2142PosReAsruu0203 eEnum : ER2142PosReAsruu0203.values()) {
	...
	public static String getName() {
		return ER2142PosReAsruu0203.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER2142PosReAsruu0203.class.getSimpleName().substring(2, 6));
	}
	...
	public static SegmentValidation genValidationLabaUsahaAsuransi() {
		return UtilSegmentValidation.genEqualsFormula("2|3", R_02030103000000.key,
				R_02030102010300.key + "+" + R_02030102020000.key, 
