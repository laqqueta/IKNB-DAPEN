...
public enum ER2143PosReAsruu0301 implements IObject<KeyValueString> {
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER2143PosReAsruu0301 eEnum : ER2143PosReAsruu0301.values()) {
	...
	public static String getName() {
		return ER2143PosReAsruu0301.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER2143PosReAsruu0301.class.getSimpleName().substring(2, 6));
	}
