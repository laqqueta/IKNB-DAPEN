...
import id.go.ojk.asruk.client.builder.field.rb.reference.ER2018PosRbAsruk1313;
...
public class Rb1313 extends BaseMetadata {
	...
	public SubmissionFormat get() {
		...
		SubmissionFormat res = new SubmissionFormat(eEnum.getCode(), eEnum.getName(), reportCode,
				...
				ER2018PosRbAsruk1313.getRequiredPos());
		res.addSegmentValidations(ER2018PosRbAsruk1313.genValidationNumeric());
		res.addSegmentValidations(ER2018PosRbAsruk1313.genValidationNumericDot());
		res.addSegmentValidations(ER2018PosRbAsruk1313.genValidationMaxLengthNumeric());
		...
		fs.add(sf(2, null, "Asumsi",
				sv(O, 1, 1000, all).confConditionalRequired(ER2018PosRbAsruk1313.genConditionalField())));
