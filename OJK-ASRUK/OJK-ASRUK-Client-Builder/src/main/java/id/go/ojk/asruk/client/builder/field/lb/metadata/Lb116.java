...
import id.go.ojk.asruk.client.builder.field.lb.reference.ER3041PosLbAsruk116;
...
public class Lb116 extends BaseMetadata {
	...
	public SubmissionFormat get() {
		...
		SubmissionFormat res = new SubmissionFormat(eEnum.getCode(), eEnum.getName(), reportCode,
				new ArrayList<>(), extension, 3, 3, ER3041PosLbAsruk116.genFieldSave(), null, 
				ER3041PosLbAsruk116.getRequiredPos());
		res.addSegmentValidations(ER3041PosLbAsruk116.genValidationTotal());
		...
		fs.add(sf(11, null, "Total", sv(M, 1, 16, numericNegatif))
				.addFieldValidations(ER3041PosLbAsruk116.genFieldValidation11()));
