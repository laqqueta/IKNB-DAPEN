...
public enum ER2140PosReAsruu0201 implements IObject<KeyValueString> {
...
//	R_02010200000000 ("02010200000000", "BEBAN USAHA:"),
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER2140PosReAsruu0201 eEnum : ER2140PosReAsruu0201.values()) {
	...
	public static String getName() {
		return ER2140PosReAsruu0201.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER2140PosReAsruu0201.class.getSimpleName().substring(2, 6));
	}
