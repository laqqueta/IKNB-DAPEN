...
public enum ER2001PosRbAsruk0105 implements IObject<KeyValueString> {
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER2001PosRbAsruk0105 eEnum : ER2001PosRbAsruk0105.values()) {
	...
	public static String getName() {
		return ER2001PosRbAsruk0105.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER2001PosRbAsruk0105.class.getSimpleName().substring(2, 6));
	}
