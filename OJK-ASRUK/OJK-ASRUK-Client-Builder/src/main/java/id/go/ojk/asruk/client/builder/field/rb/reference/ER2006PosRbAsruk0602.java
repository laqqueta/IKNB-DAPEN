...
public enum ER2006PosRbAsruk0602 implements IObject<KeyValueString> {
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER2006PosRbAsruk0602 eEnum : ER2006PosRbAsruk0602.values()) {
	...
	public static String getName() {
		return ER2006PosRbAsruk0602.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER2006PosRbAsruk0602.class.getSimpleName().substring(2, 6));
	}
