...
public enum ER2020PosReAsruk0200 implements IObject<KeyValueString> {
...
//	R_5702000099 ("5702000099", "b. Beban Umum dan Administrasi:"),
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER2020PosReAsruk0200 eEnum : ER2020PosReAsruk0200.values()) {
	...
	public static String getName() {
		return ER2020PosReAsruk0200.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER2020PosReAsruk0200.class.getSimpleName().substring(2, 6));
	}
