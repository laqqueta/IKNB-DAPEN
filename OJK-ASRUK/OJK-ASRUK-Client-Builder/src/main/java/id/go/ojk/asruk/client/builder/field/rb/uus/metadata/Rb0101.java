...
import id.go.ojk.asruk.client.builder.field.rb.uus.reference.ER2100PosRbAsruu0101;
...
public class Rb0101 extends BaseMetadata {
	...
	public SubmissionFormat get() {
		...
		SubmissionFormat res = new SubmissionFormat(eEnum.getCode(), eEnum.getName(), reportCode,
				new ArrayList<>(), extension, 15, 15, null, null, ER2100PosRbAsruu0101.getRequiredPos());
