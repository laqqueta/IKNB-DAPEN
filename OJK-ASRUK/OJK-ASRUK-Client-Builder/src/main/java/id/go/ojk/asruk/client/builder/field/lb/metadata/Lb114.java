...
import id.go.ojk.asruk.client.builder.field.lb.reference.ER3030PosLbAsruk114;
...
public class Lb114 extends BaseMetadata {
	...
	public SubmissionFormat get() {
		...
		SubmissionFormat res = new SubmissionFormat(eEnum.getCode(), eEnum.getName(), reportCode,
				new ArrayList<>(), extension, 17, 17, ER3030PosLbAsruk114.genFieldSave(),
				ER3030PosLbAsruk114.genFieldSave(), ER3030PosLbAsruk114.getRequiredPos());
		res.addSegmentValidations(ER3030PosLbAsruk114.genValidationTotal());
