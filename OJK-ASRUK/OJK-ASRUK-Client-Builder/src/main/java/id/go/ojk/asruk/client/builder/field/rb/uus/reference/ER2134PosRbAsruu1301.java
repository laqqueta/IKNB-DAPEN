...
public enum ER2134PosRbAsruu1301 implements IObject<KeyValueString> {
...
//	R_13010204000000 ("13010204000000", "4.    Rasio Aset Unit Syariah"),
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER2134PosRbAsruu1301 eEnum : ER2134PosRbAsruu1301.values()) {
	...
	public static String getName() {
		return ER2134PosRbAsruu1301.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER2134PosRbAsruu1301.class.getSimpleName().substring(2, 6));
	}
