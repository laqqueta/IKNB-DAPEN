...
public enum ER6001PosPlsAsruk0100 implements IObject<KeyValueString> {
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER6001PosPlsAsruk0100 eEnum : ER6001PosPlsAsruk0100.values()) {
	...
	public static String getName() {
		return ER6001PosPlsAsruk0100.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER6001PosPlsAsruk0100.class.getSimpleName().substring(2, 6));
	}
  ...
  public static String getUniquePos() {
	...
	public static String genFieldSave() {
		return UtilMetadata.genFieldSave("13|14|15|16|17", getObjects());
	}
