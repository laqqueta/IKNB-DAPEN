...
public enum ER2008PosRbAsruk0900 implements IObject<KeyValueString> {
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER2008PosRbAsruk0900 eEnum : ER2008PosRbAsruk0900.values()) {
	...
	public static String getName() {
		return ER2008PosRbAsruk0900.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER2008PosRbAsruk0900.class.getSimpleName().substring(2, 6));
	}
