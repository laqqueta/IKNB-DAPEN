...
import id.go.ojk.asruk.client.builder.field.rb.uus.reference.ER2122PosRbAsruu1004;
...
public class Rb1004 extends BaseMetadata {
	...
	public SubmissionFormat get() {
		...
		fs.add(sf(3, null, "Alasan Pemanfaatan Tenaga Alih Daya",
				sv(C, 0, 1000, all).confConditionalRequired(ER2122PosRbAsruu1004.genConditionalField())));
