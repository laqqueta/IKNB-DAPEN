...
public enum ER2103PosRbAsruu0104 implements IObject<KeyValueString> {
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER2103PosRbAsruu0104 eEnum : ER2103PosRbAsruu0104.values()) {
	...
	public static String getName() {
		return ER2103PosRbAsruu0104.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER2103PosRbAsruu0104.class.getSimpleName().substring(2, 6));
	}
