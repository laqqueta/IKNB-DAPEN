...
public enum ER2019PosReAsruk0100 implements IObject<KeyValueString> {
...
//	R_3000000099 ("3000000099", "Ekuitas"),
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER2019PosReAsruk0100 eEnum : ER2019PosReAsruk0100.values()) {
	...
	public static String getName() {
		return ER2019PosReAsruk0100.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER2019PosReAsruk0100.class.getSimpleName().substring(2, 6));
	}
	...
	public static SegmentValidation genValidationLiabilitas() {
		return UtilSegmentValidation.genEqualsFormula("2|3", R_2000000000.key, 
