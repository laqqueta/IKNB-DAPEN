...
import id.go.ojk.asruk.client.builder.field.rb.reference.ER2009PosRbAsruk1002;
...
public class Rb1002 extends BaseMetadata {
	...
	public SubmissionFormat get() {
		...
		SubmissionFormat res = new SubmissionFormat(eEnum.getCode(), eEnum.getName(), reportCode,
				new ArrayList<>(), extension, 1, null, ER2009PosRbAsruk1002.genFieldSave(), null,
				ER2009PosRbAsruk1002.getRequiredPos());
		res.addSegmentValidations(ER2009PosRbAsruk1002.genValidationRencanaSDM());
		...
		fs.add(sf(2, null, "Level Jabatan",
				sv(C, 0, 1000, all).confConditionalRequired(ER2009PosRbAsruk1002.genConditionalField2())));
		fs.add(sf(3, null, "Jumlah SDM per 30 Sept 20XX-1",
				sv(C, 0, 16, numeric).confConditionalRequired(ER2009PosRbAsruk1002.genConditionalField())));
