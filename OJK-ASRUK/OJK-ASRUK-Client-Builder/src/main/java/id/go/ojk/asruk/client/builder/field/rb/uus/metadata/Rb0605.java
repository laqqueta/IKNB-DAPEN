...
import id.go.ojk.asruk.client.builder.field.rb.uus.reference.ER2115PosRbAsruu0605;
...
public class Rb0605 extends BaseMetadata {
	...
	public SubmissionFormat get() {
		...
		fs.add(sf(2, null, "Jenis Investasi",
				sv(O, 0, 4, refTable).confReference(EHeaderMetadataShared.R059.getObject())));
		fs.add(sf(3, null, "Aktual per 30 Sept 20XX-1", sv(C, 0, 16, numericNegatif)
				.confConditionalRequired(ER2115PosRbAsruu0605.genConditionalField())));
