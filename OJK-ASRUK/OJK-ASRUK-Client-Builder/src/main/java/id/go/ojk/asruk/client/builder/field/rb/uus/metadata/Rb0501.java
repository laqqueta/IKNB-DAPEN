...
import id.go.ojk.asruk.client.builder.field.rb.uus.reference.ER2110PosRbAsruu0501;
...
public class Rb0501 extends BaseMetadata {
	...
	public SubmissionFormat get() {
		...
		fs.add(sf(3, null, "Deskripsi Umum Kegiatan Usaha",
				sv(C, 0, 1000, all).confConditionalRequired(ER2110PosRbAsruu0501.genConditionalField())));
