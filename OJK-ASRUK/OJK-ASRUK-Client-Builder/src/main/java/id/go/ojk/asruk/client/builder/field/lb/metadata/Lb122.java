...
import id.go.ojk.asruk.client.builder.field.lb.reference.ER3062PosLbAsruk122;
...
public class Lb122 extends BaseMetadata {
	...
	public SubmissionFormat get() {
		...
		SubmissionFormat res = new SubmissionFormat(eEnum.getCode(), eEnum.getName(), reportCode,
				new ArrayList<>(), extension, 5, 5, ER3062PosLbAsruk122.genFieldSave(), null,
				ER3062PosLbAsruk122.getRequiredPos());
		res.addSegmentValidations(ER3062PosLbAsruk122.genValidationTotal());
		...
		fs.add(sf(4, null, "Aset - Total", sv(M, 1, 16, numeric))
				.addFieldValidations(ER3062PosLbAsruk122.genFieldValidation4()));
		...
		fs.add(sf(7, null, "Liabilitas - Total", sv(M, 1, 16, numeric))
				.addFieldValidations(ER3062PosLbAsruk122.genFieldValidation7()));
		return res;
	}
}
