...
import id.go.ojk.asruk.client.builder.field.rb.reference.ER2001PosRbAsruk0105;
...
public class Rb0105 extends BaseMetadata {
	...
	public SubmissionFormat get() {
		...
		SubmissionFormat res = new SubmissionFormat(eEnum.getCode(), eEnum.getName(), reportCode,
				new ArrayList<>(), extension, 10, 10, null, null, ER2001PosRbAsruk0105.getRequiredPos());
