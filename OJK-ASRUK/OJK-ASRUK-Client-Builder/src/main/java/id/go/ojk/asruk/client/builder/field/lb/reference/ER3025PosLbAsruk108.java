...
public enum ER3025PosLbAsruk108 implements IObject<KeyValueString> {
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER3025PosLbAsruk108 eEnum : ER3025PosLbAsruk108.values()) {
	...
	public static FieldValidation genFieldValidation4a() {
		return UtilFieldValidation.genReferenceCondition2("2", 
				...
				String.valueOf(EHeaderMetadataShared.R049.getNumber()));
	}
	...
	public static FieldValidation genFieldValidation7() {
		return UtilFieldValidation.genReferenceCondition("2", String.valueOf(EHeaderMetadataShared.R051.getNumber()));
	}

	public static FieldValidation genFieldValidation8() {
		return UtilFieldValidation.genReferenceCondition("2", String.valueOf(EHeaderMetadataShared.R055.getNumber()));
	}
