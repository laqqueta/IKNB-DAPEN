...
public enum ER2135PosRbAsruu1302 implements IObject<KeyValueString> {
...
//	R_13020207000000 ("13020207000000", "7. Penghitungan Qardh yang Diperlukan Dana Tanahud"),
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER2135PosRbAsruu1302 eEnum : ER2135PosRbAsruu1302.values()) {
	...
	public static String getName() {
		return ER2135PosRbAsruu1302.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER2135PosRbAsruu1302.class.getSimpleName().substring(2, 6));
	}
