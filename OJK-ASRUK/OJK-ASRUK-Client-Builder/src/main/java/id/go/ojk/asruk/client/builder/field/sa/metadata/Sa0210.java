...
import id.go.ojk.asruk.client.builder.field.sa.reference.ER4010PosSaAsruk0210;
...
public class Sa0210 extends BaseMetadata {
	...
	public SubmissionFormat get() {
		...
		SubmissionFormat res = new SubmissionFormat(eEnum.getCode(), eEnum.getName(), reportCode,
				new ArrayList<>(), extension, 4, 4, null, ER4010PosSaAsruk0210.genFieldSave(),
				ER4010PosSaAsruk0210.getRequiredPos());
		res.addSegmentValidations(ER4010PosSaAsruk0210.genValidationNumeric());
		res.addSegmentValidations(ER4010PosSaAsruk0210.genValidationMaxLengthNumeric());
		res.addSegmentValidations(ER4010PosSaAsruk0210.genValidationPeringkat());
