...
public enum ER2131PosRbAsruu1208 implements IObject<KeyValueString> {
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER2131PosRbAsruu1208 eEnum : ER2131PosRbAsruu1208.values()) {
	...
	public static String getName() {
		return ER2131PosRbAsruu1208.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER2131PosRbAsruu1208.class.getSimpleName().substring(2, 6));
	}
