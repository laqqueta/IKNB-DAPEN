...
public enum ER2014PosRbAsruk1301 implements IObject<KeyValueString> {
...
//	R_3000000099 ("3000000099", "Ekuitas"),
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER2014PosRbAsruk1301 eEnum : ER2014PosRbAsruk1301.values()) {
	...
	public static String getName() {
		return ER2014PosRbAsruk1301.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER2014PosRbAsruk1301.class.getSimpleName().substring(2, 6));
	}
	...
	public static SegmentValidation genValidationAset() {
		return UtilSegmentValidation.genEqualsFormula("2|3|4|5", R_1000000000.key, 
				UtilMetadata.genPlusRow(getObjects(), new int[] { 22, 35 }), 
