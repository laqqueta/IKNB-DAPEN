...
import id.go.ojk.asruk.client.builder.field.rb.uus.reference.ER2120PosRbAsruu1002;
...
public class Rb1002 extends BaseMetadata {
	...
	public SubmissionFormat get() {
		...
		fs.add(sf(1, null, "Kode Komponen / Baris",
				sv(M, 10, 10, refTable).confReference(EHeaderMetadataRbUus.R2120_RB1002.getObject())));
		fs.add(sf(2, null, "Materi/Topik", sv(O, 0, 1000, all)));
		fs.add(sf(3, null, "Metode Diklat",
				sv(C, 0, 1000, all).confConditionalRequired(ER2120PosRbAsruu1002.genConditionalField())));
		...
		fs.add(sf(9, null, "Biaya Diklat",
				sv(C, 0, 16, numeric).confConditionalRequired(ER2120PosRbAsruu1002.genConditionalField())));
		return res;
	}
}
