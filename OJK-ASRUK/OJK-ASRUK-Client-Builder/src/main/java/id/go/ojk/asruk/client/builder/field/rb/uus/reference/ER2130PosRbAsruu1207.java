...
public enum ER2130PosRbAsruu1207 implements IObject<KeyValueString> {
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER2130PosRbAsruu1207 eEnum : ER2130PosRbAsruu1207.values()) {
	...
	public static String getName() {
		return ER2130PosRbAsruu1207.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER2130PosRbAsruu1207.class.getSimpleName().substring(2, 6));
	}
