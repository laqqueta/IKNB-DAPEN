...
import id.go.ojk.asruk.client.builder.field.lb.reference.ER3001PosLbAsruk001;
...
public class Lb001 extends BaseMetadata {
	...
	public SubmissionFormat get() {
		...
		SubmissionFormat res = new SubmissionFormat(eEnum.getCode(), eEnum.getName(), reportCode,
				new ArrayList<>(), extension, 1, null, ER3001PosLbAsruk001.genFieldSave(), null,
				ER3001PosLbAsruk001.getRequiredPos());
		res.addSegmentValidations(ER3001PosLbAsruk001.genValidationFixedValue());
		res.addSegmentValidations(ER3001PosLbAsruk001.genValidationTotal());
		...
		fs.add(sf(2, null, "Nama Pemegang Saham", sv(C, 1, 50, all).confRegex(patternCompanyName.c())
				.confConditionalRequired(ER3001PosLbAsruk001.genConditionalExistPos())));
