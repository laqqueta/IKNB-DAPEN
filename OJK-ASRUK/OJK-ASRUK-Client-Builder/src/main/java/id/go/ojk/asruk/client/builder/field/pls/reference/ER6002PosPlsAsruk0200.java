package id.go.ojk.asruk.client.builder.field.pls.reference;
...
public enum ER6002PosPlsAsruk0200 implements IObject<KeyValueString> {
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER6002PosPlsAsruk0200 eEnum : ER6002PosPlsAsruk0200.values()) {
	...
	public static String getName() {
		return ER6002PosPlsAsruk0200.class.getSimpleName().substring(6);
	}

	public static int getRefNumber() {
		return Integer.parseInt(ER6002PosPlsAsruk0200.class.getSimpleName().substring(2, 6));
	}
...
//		return UtilSegmentValidation.genIsExistsForm("3", R_0020010000.key, EFormLaporanPolis.PLS_0100.getCode(), "2");
		return UtilSegmentValidation.genIsExistsFormDb("3", R_0020010000.key, EFormLaporanPolis.PLS_0100.getCode(),
				ER6001PosPlsAsruk0100.R_0010010000.getObject().getKey(), "2");
	}
	...
	public static SegmentValidation genValidation4() {
		return UtilSegmentValidation.genIsExistsFormDb("5", R_0020010000.key, EFormLaporanPolis.PLS_0100.getCode(),
				ER6001PosPlsAsruk0100.R_0010010000.getObject().getKey(), "7");
	}
}
