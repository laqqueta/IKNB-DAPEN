...
import id.go.ojk.asruk.client.builder.field.rb.uus.reference.ER2123PosRbAsruu1005;
...
public class Rb1005 extends BaseMetadata {
	...
	public SubmissionFormat get() {
		...
		fs.add(sf(1, null, "Kode Komponen / Baris",
				sv(M, 10, 10, refTable).confReference(EHeaderMetadataRbUus.R2123_RB1005.getObject())));
		fs.add(sf(2, null, "Jenis/ Nama Aplikasi", sv(O, 0, 1000, all)));
		fs.add(sf(3, null, "Kepemilikan (inhouse/ vendor)",
				sv(C, 0, 1000, all).confConditionalRequired(ER2123PosRbAsruu1005.genConditionalField())));
