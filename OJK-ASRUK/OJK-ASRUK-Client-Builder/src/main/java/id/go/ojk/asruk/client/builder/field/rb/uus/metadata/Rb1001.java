...
import id.go.ojk.asruk.client.builder.field.rb.uus.reference.ER2119PosRbAsruu1001;
...
public class Rb1001 extends BaseMetadata {
	...
	public SubmissionFormat get() {
		...
		SubmissionFormat res = new SubmissionFormat(eEnum.getCode(), eEnum.getName(), reportCode,
				new ArrayList<>(), extension, 1, null, ER2119PosRbAsruu1001.genFieldSave(), null,
				ER2119PosRbAsruu1001.getRequiredPos());
		res.addSegmentValidations(ER2119PosRbAsruu1001.genValidationTotal());
		...
		fs.add(sf(2, null, "Level Jabatan",
				sv(C, 1, 1000, all).confConditionalRequired(ER2119PosRbAsruu1001.genConditionalMustEmpty())));
		fs.add(sf(3, null, "Jumlah SDM per 30 Sept 20XX-1",
				sv(C, 1, 16, numeric).confConditionalRequired(ER2119PosRbAsruu1001.genConditionalField())));
