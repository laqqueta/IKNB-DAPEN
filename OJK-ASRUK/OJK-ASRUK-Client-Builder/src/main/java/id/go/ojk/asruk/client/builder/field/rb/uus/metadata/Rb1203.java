...
import id.go.ojk.asruk.client.builder.field.rb.uus.reference.ER2126PosRbAsruu1203;
...
public class Rb1203 extends BaseMetadata {
	...
	public SubmissionFormat get() {
		...
		SubmissionFormat res = new SubmissionFormat(eEnum.getCode(), eEnum.getName(), reportCode,
				new ArrayList<>(), extension, 34, 34, ER2126PosRbAsruu1203.genFieldSave(), null,
				ER2126PosRbAsruu1203.getRequiredPos());
		res.addSegmentValidations(ER2126PosRbAsruu1203.genValidationAsetA());
		res.addSegmentValidations(ER2126PosRbAsruu1203.genValidationInvestasi());
		res.addSegmentValidations(ER2126PosRbAsruu1203.genValidationBukanInvestasi());
		res.addSegmentValidations(ER2126PosRbAsruu1203.genValidationLiabilitasDanEkuitas());
		res.addSegmentValidations(ER2126PosRbAsruu1203.genValidationLiabilitas());
		res.addSegmentValidations(ER2126PosRbAsruu1203.genValidationEkuitasDana());
		res.addSegmentValidations(ER2126PosRbAsruu1203.genValidationAsetB());
