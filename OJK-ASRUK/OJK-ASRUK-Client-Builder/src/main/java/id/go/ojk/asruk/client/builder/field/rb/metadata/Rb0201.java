...
import id.go.ojk.asruk.client.builder.field.rb.reference.ER2002PosRbAsruk0201;
...
public class Rb0201 extends BaseMetadata {
	...
	public SubmissionFormat get() {
		...
		SubmissionFormat res = new SubmissionFormat(eEnum.getCode(), eEnum.getName(), reportCode,
				...
				ER2002PosRbAsruk0201.getRequiredPos());
		...
		fs.add(sf(2, null, "Nama Indikator Lain",
				sv(C, 0, 200, all).confConditionalRequired(ER2002PosRbAsruk0201.genConditionalField2())));
		...
		fs.add(sf(5, null, "%", sv(M, 1, 16, numericDotNegatif))
				.addFieldValidations(ER2002PosRbAsruk0201.genFieldValidation5()));
		return res;
	}
}
