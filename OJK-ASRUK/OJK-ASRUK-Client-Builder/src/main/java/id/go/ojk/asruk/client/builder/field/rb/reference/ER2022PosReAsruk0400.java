...
public enum ER2022PosReAsruk0400 implements IObject<KeyValueString> {
...
//	R_7006000099 ("7006000099", "vi. Return on Equity (ROE)"),
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER2022PosReAsruk0400 eEnum : ER2022PosReAsruk0400.values()) {
	...
	public static String getName() {
		return ER2022PosReAsruk0400.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER2022PosReAsruk0400.class.getSimpleName().substring(2, 6));
	}
	...
	public static SegmentValidation genValidationJumlatRasioABCD() {
		return UtilSegmentValidation.genEqualsFormula("2|3", R_7004000000.key, 
				...
				"Total Rasio I + Rasio II + Rasio III|Penjumlahan Rasio I + Rasio II + Rasio III");
	}
