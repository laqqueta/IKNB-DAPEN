...
public enum ER2128PosRbAsruu1205 implements IObject<KeyValueString> {
...
//	R_12050201010000 ("12050201010000", "Beban Klaim"),
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER2128PosRbAsruu1205 eEnum : ER2128PosRbAsruu1205.values()) {
	...
	public static String getName() {
		return ER2128PosRbAsruu1205.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER2128PosRbAsruu1205.class.getSimpleName().substring(2, 6));
	}
