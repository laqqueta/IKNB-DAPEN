...
public enum ER2005PosRbAsruk0601 implements IObject<KeyValueString> {
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER2005PosRbAsruk0601 eEnum : ER2005PosRbAsruk0601.values()) {
	...
	public static String getName() {
		return ER2005PosRbAsruk0601.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER2005PosRbAsruk0601.class.getSimpleName().substring(2, 6));
	}
	...
	public static ConditionalRequired genConditionalField2() {
		return UtilFieldConditional.genExistPos("N", "O", R_0601020000.key);
	}
	...
	public static SegmentValidation genValidationInvestasi() {
		return UtilSegmentValidation.genEqualsFormula("3|4|5|6", R_0601020000.key, R_0601010000.key, 
