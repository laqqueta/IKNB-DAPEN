...
public enum ER2007PosRbAsruk0702 implements IObject<KeyValueString> {
	R_0702010000 ("0702010000", "Posisi Modal"),
//	R_0702020000 ("0702020000", "Pemegang Saham"),
	R_0702020100 ("0702020100", "--------------------- (dst)"),
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER2007PosRbAsruk0702 eEnum : ER2007PosRbAsruk0702.values()) {
	...
	public static String getName() {
		return ER2007PosRbAsruk0702.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER2007PosRbAsruk0702.class.getSimpleName().substring(2, 6));
	}
