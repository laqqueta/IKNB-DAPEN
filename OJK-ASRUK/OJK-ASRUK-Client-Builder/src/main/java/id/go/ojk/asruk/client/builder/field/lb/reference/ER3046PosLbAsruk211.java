...
public enum ER3046PosLbAsruk211 implements IObject<KeyValueString> {
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER3046PosLbAsruk211 eEnum : ER3046PosLbAsruk211.values()) {
	...
	public static FieldValidation genFieldValidation3() {
		return UtilFieldValidation.genPosReferenceCondition3(R_5401000002.key, "2", String.valueOf(EHeaderMetadataShared.R048.getNumber()));
	}
