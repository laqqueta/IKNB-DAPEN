...
import id.go.ojk.asruk.client.builder.field.rb.reference.ER2011PosRbAsruk1004;
...
public class Rb1004 extends BaseMetadata {
	...
	public SubmissionFormat get() {
		...
		fs.add(sf(3, null, "Posisi Jabatan",
				sv(C, 0, 1000, all).confConditionalRequired(ER2011PosRbAsruk1004.genConditionalField())));
		...
		fs.add(sf(8, null, "Alasan",
				sv(C, 0, 4000, all).confConditionalRequired(ER2011PosRbAsruk1004.genConditionalField())));
		return res;
	}
}
