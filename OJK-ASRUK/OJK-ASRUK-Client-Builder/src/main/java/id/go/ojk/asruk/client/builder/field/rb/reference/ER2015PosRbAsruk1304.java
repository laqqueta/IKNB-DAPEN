...
public enum ER2015PosRbAsruk1304 implements IObject<KeyValueString> {
...
//	R_5702000099 ("5702000099", "b. Beban Umum dan Administrasi:"),
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER2015PosRbAsruk1304 eEnum : ER2015PosRbAsruk1304.values()) {
	...
	public static String getName() {
		return ER2015PosRbAsruk1304.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER2015PosRbAsruk1304.class.getSimpleName().substring(2, 6));
	}
	...
	public static SegmentValidation genValidationPendapatanPremi() {
		return UtilSegmentValidation.genEqualsFormula("2|3|4|5", R_4101000000.key, 
				UtilMetadata.genPlusRow(getObjects(), new int[] { 0, 1 }), 
