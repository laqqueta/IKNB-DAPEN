...
public enum ER2021PosReAsruk0300 implements IObject<KeyValueString> {
...
//	R_1501040298 ("1501040298", "Arus Kas Keluar"),
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER2021PosReAsruk0300 eEnum : ER2021PosReAsruk0300.values()) {
	...
	public static String getName() {
		return ER2021PosReAsruk0300.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER2021PosReAsruk0300.class.getSimpleName().substring(2, 6));
	}
