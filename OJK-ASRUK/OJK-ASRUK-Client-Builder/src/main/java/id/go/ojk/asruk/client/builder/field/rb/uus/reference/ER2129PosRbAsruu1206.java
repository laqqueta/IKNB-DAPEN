...
public enum ER2129PosRbAsruu1206 implements IObject<KeyValueString> {
...
//	R_12060102010000 ("12060102010000", "Beban Klaim"),
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER2129PosRbAsruu1206 eEnum : ER2129PosRbAsruu1206.values()) {
	...
	public static String getName() {
		return ER2129PosRbAsruu1206.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER2129PosRbAsruu1206.class.getSimpleName().substring(2, 6));
	}
