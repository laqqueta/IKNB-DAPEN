...
import id.go.ojk.asruk.client.builder.field.lb.reference.ER3049PosLbAsruk213;
...
public class Lb213 extends BaseMetadata {
	...
	public SubmissionFormat get() {
		...
		SubmissionFormat res = new SubmissionFormat(eEnum.getCode(), eEnum.getName(), reportCode,
				new ArrayList<>(), extension, 7, 7, ER3049PosLbAsruk213.genFieldSave(), null,
				ER3049PosLbAsruk213.getRequiredPos());
		res.addSegmentValidations(ER3049PosLbAsruk213.genValidationTotal());
