...
import id.go.ojk.asruk.client.builder.field.lb.reference.ER3065PosLbAsruk623;
...
public class Lb623 extends BaseMetadata {
	...
	public SubmissionFormat get() {
		...
		SubmissionFormat res = new SubmissionFormat(eEnum.getCode(), eEnum.getName(), reportCode,
				new ArrayList<>(), extension, 1, null, ER3065PosLbAsruk623.genFieldSave(), null,
				ER3065PosLbAsruk623.getRequiredPos());
		res.addSegmentValidations(ER3065PosLbAsruk623.genValidationTotal());
		...
		fs.add(sf(2, null, "Kelompok",
				sv(C, 1, 6, numeric).confConditionalRequired(ER3065PosLbAsruk623.genConditionField2())));
		fs.add(sf(3, null, "Tingkat Derajat Kepemilikan",
				sv(C, 1, 6, numeric).confConditionalRequired(ER3065PosLbAsruk623.genConditionField3())));
		fs.add(sf(4, null, "Nama Pemegang Saham",
				sv(C, 1, 50, all).confConditionalRequired(ER3065PosLbAsruk623.genConditionField4())));
		fs.add(sf(5, null, "Jenis Pemegang Saham",
				sv(C, 1, 6, refTable).confReference(EHeaderMetadataShared.R058.getObject())
						.confConditionalRequired(ER3065PosLbAsruk623.genConditionField5())));
		fs.add(sf(6, null, "Persentase Kepemilikan Saham",
				sv(C, 1, 16, numericDot).confConditionalRequired(ER3065PosLbAsruk623.genConditionField6())));
		return res;
	}
}
