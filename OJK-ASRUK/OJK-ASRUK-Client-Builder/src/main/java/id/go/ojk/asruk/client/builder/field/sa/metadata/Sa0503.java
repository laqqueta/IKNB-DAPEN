...
import id.go.ojk.asruk.client.builder.field.sa.reference.ER4016PosSaAsruk0503;
...
public class Sa0503 extends BaseMetadata {
	...
	public SubmissionFormat get() {
		...
		SubmissionFormat res = new SubmissionFormat(eEnum.getCode(), eEnum.getName(), reportCode,
				new ArrayList<>(), extension, 2, 2, null, null, ER4016PosSaAsruk0503.getRequiredPos());
		...
		fs.add(sf(2, null, "Individu", sv(M, 1, 1, numeric))
				.addFieldValidations(ER4016PosSaAsruk0503.genValidationPeringkat()));
