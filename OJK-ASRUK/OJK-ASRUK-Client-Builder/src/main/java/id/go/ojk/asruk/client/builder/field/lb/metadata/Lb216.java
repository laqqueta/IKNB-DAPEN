...
import id.go.ojk.asruk.client.builder.field.lb.reference.ER3053PosLbAsruk216;
...
public class Lb216 extends BaseMetadata {
	...
	public SubmissionFormat get() {
		...
		SubmissionFormat res = new SubmissionFormat(eEnum.getCode(), eEnum.getName(), reportCode,
				new ArrayList<>(), extension, 7, 7, ER3053PosLbAsruk216.genFieldSave(), null,
				ER3053PosLbAsruk216.getRequiredPos());
		res.addSegmentValidations(ER3053PosLbAsruk216.genValidationPremiBruto());
		res.addSegmentValidations(ER3053PosLbAsruk216.genValidationBebanKlaim());
		...
		fs.add(sf(23, null, "Jumlah", sv(M, 1, 16, numericNegatif))
				.addFieldValidations(ER3053PosLbAsruk216.genFieldValidation23()));
		return res;
	}
}
