...
public enum ER3024PosLbAsruk107 implements IObject<KeyValueString> {
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER3024PosLbAsruk107 eEnum : ER3024PosLbAsruk107.values()) {
	...
	public static FieldValidation genFieldValidation8() {
		return UtilFieldValidation.genReferenceCondition("2", String.valueOf(EHeaderMetadataShared.R053.getNumber()));
	}
