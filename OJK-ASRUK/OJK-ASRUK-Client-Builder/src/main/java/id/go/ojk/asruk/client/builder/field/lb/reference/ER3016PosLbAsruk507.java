...
public enum ER3016PosLbAsruk507 implements IObject<KeyValueString> {
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER3016PosLbAsruk507 eEnum : ER3016PosLbAsruk507.values()) {
	...
	private static String getLookupFactor1() {
		...
		ER3016PosLbAsruk507[] eEnums = ER3016PosLbAsruk507.values();
		int enumLength = eEnums.length;
		for (int i= 0; i < enumLength; i++) {
			ER3016PosLbAsruk507 eEnum = ER3016PosLbAsruk507.values()[i];
