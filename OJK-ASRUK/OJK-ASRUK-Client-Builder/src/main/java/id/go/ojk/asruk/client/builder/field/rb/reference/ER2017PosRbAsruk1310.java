...
public enum ER2017PosRbAsruk1310 implements IObject<KeyValueString> {
...
//	R_7006000099 ("7006000099", "vi. Return on Equity (ROE)"),
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER2017PosRbAsruk1310 eEnum : ER2017PosRbAsruk1310.values()) {
	...
	public static String getName() {
		return ER2017PosRbAsruk1310.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER2017PosRbAsruk1310.class.getSimpleName().substring(2, 6));
	}
