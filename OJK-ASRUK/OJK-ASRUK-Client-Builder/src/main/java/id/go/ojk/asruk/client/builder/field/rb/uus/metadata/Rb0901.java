...
import id.go.ojk.asruk.client.builder.field.rb.uus.reference.ER2118PosRbAsruu0901;
...
public class Rb0901 extends BaseMetadata {
	...
	public SubmissionFormat get() {
		...
		res.setRequiredPos(ER2118PosRbAsruu0901.getRequiredPos());
		...
		fs.add(sf(3, null, "Waktu Pelaksanaan",
				sv(C, 1, 1000, all).confConditionalRequired(ER2118PosRbAsruu0901.genConditionalField())));
		fs.add(sf(4, null, "Lokasi",
				sv(C, 1, 1000, all).confConditionalRequired(ER2118PosRbAsruu0901.genConditionalField())));
		fs.add(sf(5, null, "Perkiraan Investasi/Biaya",
				sv(C, 1, 16, numeric).confConditionalRequired(ER2118PosRbAsruu0901.genConditionalField())));
