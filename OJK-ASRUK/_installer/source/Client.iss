...
[Setup]
AppId=ASRUKClient
AppName=ASRUK Client
AppVersion=3.3.3
AppVerName=ASRUK-Client 3.3.3
AppPublisher=OJK
AppComments=OJK ASRUK Client
AppCopyright=Copyright (C) 2020
;AppPublisherURL=http://java.com/
;AppSupportURL=http://java.com/
;AppUpdatesURL=http://java.com/
DefaultDirName=C:\OJK-ASRUK-Client
...
[Setup]
SetupMutex=ASRUK-Client,Global\ASRUK-Client
OutputDir="..\ftp\app"

[Icons]
Name: "{group}\ASRUK-Client"; Filename: "{app}\OjkClient.exe"; IconFilename: "{app}\Client.ico"; Check: returnTrue()
Name: "{commondesktop}\AsrukClient"; Filename: "{app}\OjkClient.exe";  IconFilename: "{app}\Client.ico"; Check: returnFalse()    

[Run]
Filename: "{app}\OjkClient.exe"; Parameters: "-Xappcds:generatecache"; Check: returnFalse()
Filename: "{app}\OjkClient.exe"; Description: "{cm:LaunchProgram,ASRUKClient}"; Flags: nowait postinstall skipifsilent; Check: returnTrue()
Filename: "{app}\OjkClient.exe"; Parameters: "-install -svcName ""ASRUKClient"" -svcDesc ""ASRUKClient"" -mainExe ""OjkClient.exe""  "; Check: returnFalse()

[UninstallRun]
Filename: "{app}\OjkClient.exe "; Parameters: "-uninstall -svcName ASRUKClient -stopOnUninstall"; Check: returnFalse()
