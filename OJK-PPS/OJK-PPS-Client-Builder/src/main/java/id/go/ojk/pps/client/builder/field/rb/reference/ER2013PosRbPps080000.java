...
public enum ER2013PosRbPps080000 implements IObject<KeyValueString> {
	R_08010100000000 ("08010100000000", "Kantor"), 
	;
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER2013PosRbPps080000 eEnum : ER2013PosRbPps080000.values()) {
	...
	public static String getName() {
		return ER2013PosRbPps080000.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER2013PosRbPps080000.class.getSimpleName().substring(2, 6));
	}
