...
public enum ER2255PosRePps040501 implements IObject<KeyValueString> {
...
//	R_04050102000000 ("04050102000000", "Saldo Piutang Pembiayaan (Outstanding Principal):"),
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER2255PosRePps040501 eEnum : ER2255PosRePps040501.values()) {
	...
	public static String getName() {
		return ER2255PosRePps040501.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER2255PosRePps040501.class.getSimpleName().substring(2, 6));
	}
	...
	public static SegmentValidation genValidationTotalRencanaPenyaluranPembiayaanBaru() {
		return UtilSegmentValidation.genEqualsFormula("2|3", R_04050101360000.key,
	...
	public static SegmentValidation genValidationTotalSaldoPiutangPembiayaan() {
		return UtilSegmentValidation.genEqualsFormula("2|3", R_04050102360000.key,
	...
	public static SegmentValidation genValidationFormRencanaPenyaluranPembiayaanBaru() {
		...
		return UtilSegmentValidation.genEqualsForm2("2|3", R_04050101360000.key, comparatorFormCode, 
				ER2251PosRePps040102.R_04010201040000.getKey(), "Total Rencana Penyaluran Pembiayaan Baru|Total Rencana Penyaluran Pembiayaan Baru form " + comparatorFormCode + " #kolom#");
	}

	public static SegmentValidation genValidationFormSaldoPiutangPembiayaan() {
		String comparatorFormCode = EFormRealisasiBisnis.RE_040102.getCode();
		return UtilSegmentValidation.genEqualsForm2("2|3", R_04050102360000.key, comparatorFormCode, 
				ER2251PosRePps040102.R_04010202040000.getKey(), "Total Saldo Piutang Pembiayaan (Outstanding Principal)|Total Saldo Piutang Pembiayaan (Outstanding Principal) form " + comparatorFormCode + " #kolom#");
	}
}
