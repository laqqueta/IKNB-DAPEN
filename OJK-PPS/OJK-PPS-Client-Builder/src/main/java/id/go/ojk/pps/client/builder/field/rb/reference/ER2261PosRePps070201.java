...
public enum ER2261PosRePps070201 implements IObject<KeyValueString> {
...
//	R_07020102000000 ("07020102000000", "Saldo Penerimaan Pendanaan (Outstanding):"),
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER2261PosRePps070201 eEnum : ER2261PosRePps070201.values()) {
	...
	public static String getName() {
		return ER2261PosRePps070201.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER2261PosRePps070201.class.getSimpleName().substring(2, 6));
	}
