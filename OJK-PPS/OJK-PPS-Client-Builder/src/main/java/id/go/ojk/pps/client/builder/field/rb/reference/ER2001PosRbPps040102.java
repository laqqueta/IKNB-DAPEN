...
public enum ER2001PosRbPps040102 implements IObject<KeyValueString> {
...
//	R_04010202000000 ("04010202000000", "Saldo Piutang Pembiayaan Syariah (Outstanding Principal):"),
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER2001PosRbPps040102 eEnum : ER2001PosRbPps040102.values()) {
	...
	public static String getName() {
		return ER2001PosRbPps040102.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER2001PosRbPps040102.class.getSimpleName().substring(2, 6));
	}
