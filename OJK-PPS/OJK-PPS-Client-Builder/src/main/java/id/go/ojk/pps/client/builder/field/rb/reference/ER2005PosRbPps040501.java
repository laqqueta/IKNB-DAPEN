...
public enum ER2005PosRbPps040501 implements IObject<KeyValueString> {
...
//	R_04050102000000 ("04050102000000", "Saldo Piutang Pembiayaan (Outstanding Principal):"),
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER2005PosRbPps040501 eEnum : ER2005PosRbPps040501.values()) {
	...
	public static String getName() {
		return ER2005PosRbPps040501.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER2005PosRbPps040501.class.getSimpleName().substring(2, 6));
	}
	...
	public static SegmentValidation genValidationFormRencanaPenyaluranPembiayaanBaru() {
		...
		return UtilSegmentValidation.genEqualsForm2("2|3|4|5", R_04050101360000.key, comparatorFormCode, 
				ER2001PosRbPps040102.R_04010201040000.getKey(), "Total Rencana Penyaluran Pembiayaan Baru|Total Rencana Penyaluran Pembiayaan Syariah Baru form " + comparatorFormCode + " #kolom#");
	}
	...
	public static SegmentValidation genValidationFormSaldoPiutangPembiayaan() {
		...
		return UtilSegmentValidation.genEqualsForm2("2|3|4|5", R_04050102360000.key, comparatorFormCode, 
				ER2001PosRbPps040102.R_04010202040000.getKey(), "Total Saldo Piutang Pembiayaan (Outstanding Principal)|Total Saldo Piutang Pembiayaan Syariah (Outstanding Principal) form " + comparatorFormCode + " #kolom#");
	}
}
