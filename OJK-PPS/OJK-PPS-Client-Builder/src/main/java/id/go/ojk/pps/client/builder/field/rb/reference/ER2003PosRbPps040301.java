...
public enum ER2003PosRbPps040301 implements IObject<KeyValueString> {
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER2003PosRbPps040301 eEnum : ER2003PosRbPps040301.values()) {
	...
	public static String getName() {
		return ER2003PosRbPps040301.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER2003PosRbPps040301.class.getSimpleName().substring(2, 6));
	}
