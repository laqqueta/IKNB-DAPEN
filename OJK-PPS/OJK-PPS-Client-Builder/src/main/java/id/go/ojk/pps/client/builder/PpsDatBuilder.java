...
import id.go.ojk.pps.client.builder.field.EUpdateHeader;
import id.go.ojk.pps.client.builder.field.setup.ESetupKeyValueStringFilename;
import lombok.extern.slf4j.Slf4j;

@Slf4j
public class PpsDatBuilder extends BaseDatBuilder {
	private static final EReport REPORT_RB = EReport.RB_PPS;
	private static final EReport REPORT_SA = EReport.SA_PPS;
	private static final EReport REPORT_APU = EReport.APU_PPS;
	private static final String DUMMY_USER = "ppsdummy@gmail.com";

	public static void main(String[] args) {
		try {
			log.info("starting builder");
			PpsDatBuilder builder = new PpsDatBuilder(args);
	...
	public PpsDatBuilder(String[] args) {
	...
	protected String genDummyClientEntity() {
		return genDummyClientEntity(Constant.SECTOR.getCode(), Arrays.asList("291080", "299999"), DUMMY_USER);
	}
