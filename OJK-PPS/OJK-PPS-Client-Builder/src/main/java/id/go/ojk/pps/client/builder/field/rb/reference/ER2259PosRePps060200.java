...
public enum ER2259PosRePps060200 implements IObject<KeyValueString> {
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER2259PosRePps060200 eEnum : ER2259PosRePps060200.values()) {
	...
	public static String getName() {
		return ER2259PosRePps060200.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER2259PosRePps060200.class.getSimpleName().substring(2, 6));
	}
