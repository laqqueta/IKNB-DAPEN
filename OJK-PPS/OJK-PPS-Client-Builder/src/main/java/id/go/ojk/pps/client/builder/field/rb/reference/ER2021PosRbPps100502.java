...
public enum ER2021PosRbPps100502 implements IObject<KeyValueString> {
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER2021PosRbPps100502 eEnum : ER2021PosRbPps100502.values()) {
	...
	public static String getName() {
		return ER2021PosRbPps100502.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER2021PosRbPps100502.class.getSimpleName().substring(2, 6));
	}
	...
	public static SegmentValidation genValidationPenerbitanSuratSanggupBayarDenganPrinsipSyariah() {
		return UtilSegmentValidation.genEqualsFormula("2|3|4|5", R_10050203000000.key,
	...
	public static SegmentValidation genValidationInstrumenDerivatifUntukLindungNilaiSyariah() {
		return UtilSegmentValidation.genEqualsFormula("2|3|4|5", R_10050205000000.key,
	...
	public static SegmentValidation genValidationJumlah() {
		return UtilSegmentValidation.genEqualsFormula("2|3|4|5", R_10050207000000.key,
				UtilMetadata.genPlusRow(getObjects(), new int[] { 0, 9, 10, 13, 16, 19 }), "Total|Penjumlahan dari rincian");
	}
}
