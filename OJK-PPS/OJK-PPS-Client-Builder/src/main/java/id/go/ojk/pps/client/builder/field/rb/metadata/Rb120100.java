...
import id.go.ojk.pps.client.builder.field.rb.reference.ER2023PosRbPps120100;
...
public class Rb120100 extends BaseMetadata {
	...
	public SubmissionFormat get() {
		...
		fs.add(sf(1, null, "Kode Komponen / Baris",
				sv(M, 14, 14, refTable).confReference(EHeaderMetadataRb.R2023_RB120100.getObject())));
		fs.add(sf(2, null, "Nama Perusahaan Anak", sv(O, 0, 255, all)));
		fs.add(sf(3, null, "Kinerja Sept XX-1",
				sv(C, 1, 16, numericNegatif).confConditionalRequired(ER2023PosRbPps120100.genConditionalField())));
