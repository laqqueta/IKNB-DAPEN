...
public enum ER2004PosRbPps040401 implements IObject<KeyValueString> {
...
//	R_04040102000000 ("04040102000000", "Saldo Piutang Pembiayaan (Outstanding Principal):"),
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER2004PosRbPps040401 eEnum : ER2004PosRbPps040401.values()) {
	...
	public static String getName() {
		return ER2004PosRbPps040401.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER2004PosRbPps040401.class.getSimpleName().substring(2, 6));
	}
	...
	public static SegmentValidation genValidationFormRencanaPenyaluranPembiayaanBaru() {
		String comparatorFormCode = EFormRencanaBisnis.RB_040102.getCode();
		return UtilSegmentValidation.genEqualsForm2("2|3|4|5", R_04040101030000.key, comparatorFormCode, 
				ER2001PosRbPps040102.R_04010201040000.getKey(), "Total Rencana Penyaluran Pembiayaan Baru|Total Rencana Penyaluran Pembiayaan Baru form " + comparatorFormCode + " #kolom#");
	}

	public static SegmentValidation genValidationFormSaldoPiutangPembiayaan() {
		String comparatorFormCode = EFormRencanaBisnis.RB_040102.getCode();
		return UtilSegmentValidation.genEqualsForm2("2|3|4|5", R_04040102030000.key, comparatorFormCode, 
				ER2001PosRbPps040102.R_04010202040000.getKey(), "Total Saldo Piutang Pembiayaan|Total Saldo Piutang Pembiayaan form " + comparatorFormCode + " #kolom#");
	}

	public static SegmentValidation genValidationTotalSektorEkonomiLapanganUsahaA() {
		return UtilSegmentValidation.genEqualsFormula("2|3|4|5", R_04040101010000.key,
	...
	public static SegmentValidation genValidationTotalSektorEkonomiBukanLapanganUsahaA() {
		return UtilSegmentValidation.genEqualsFormula("2|3|4|5", R_04040101020000.key,
	...
	public static SegmentValidation genValidationTotalRencanaPenyaluranPembiayaanBaru() {
		return UtilSegmentValidation.genEqualsFormula("2|3|4|5", R_04040101030000.key,
	...
	public static SegmentValidation genValidationTotalSektorEkonomiLapanganUsahaB() {
		return UtilSegmentValidation.genEqualsFormula("2|3|4|5", R_04040102010000.key, 
	...
	public static SegmentValidation genValidationTotalSektorEkonomiBukanLapanganUsahaB() {
		return UtilSegmentValidation.genEqualsFormula("2|3|4|5", R_04040102020000.key,
				R_04040102020100.key + "+" + R_04040102020200.key,
				"Total Sektor Ekonomi Bukan Lapangan Usaha|Penjumlahan Sektor Ekonomi Bukan Lapangan Usaha");
	}

	public static SegmentValidation genValidationTotalSaldoPiutangPembiayaan() {
		return UtilSegmentValidation.genEqualsFormula("2|3|4|5", R_04040102030000.key,
