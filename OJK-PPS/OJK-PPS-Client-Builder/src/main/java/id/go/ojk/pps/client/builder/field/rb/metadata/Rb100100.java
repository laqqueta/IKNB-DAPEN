...
import id.go.ojk.pps.client.builder.field.rb.reference.ER2017PosRbPps100100;
...
public class Rb100100 extends BaseMetadata {
	...
	public SubmissionFormat get() {
		...
		SubmissionFormat res = new SubmissionFormat(eEnum.getCode(), eEnum.getName(), reportCode, new ArrayList<>(),
				extension, 8, null, null, null, ER2017PosRbPps100100.getRequiredPos());
		res.addSegmentValidations(ER2017PosRbPps100100.genValidationNumeric());
		res.addSegmentValidations(ER2017PosRbPps100100.genValidationNumericDot());
		res.addSegmentValidations(ER2017PosRbPps100100.genValidationMaxLengthNumeric());
		List<SubmissionField> fs = res.getFields();
		fs.add(sf(0, null, "Flag Detail", sv(M, 3, 3, alfaNumeric).confConstant("D01")));
		fs.add(sf(1, null, "Kode Komponen / Baris",
				sv(M, 14, 14, refTable).confReference(EHeaderMetadataRb.R2017_RB100100.getObject())));
		fs.add(sf(2, null, "Asumsi Lainnya",
				sv(C, 0, 200, all).confConditionalRequired(ER2017PosRbPps100100.genConditionalMustEmpty())));
