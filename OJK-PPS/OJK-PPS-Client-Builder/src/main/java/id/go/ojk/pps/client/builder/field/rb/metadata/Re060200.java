...
import id.go.ojk.pps.client.builder.field.rb.reference.ER2259PosRePps060200;
...
public class Re060200 extends BaseMetadata {
	...
	public SubmissionFormat get() {
		...
		SubmissionFormat res = new SubmissionFormat(eEnum.getCode(), eEnum.getName(), reportCode, new ArrayList<>(),
				extension, 4, null, null, null, ER2259PosRePps060200.getRequiredPos());
		...
		fs.add(sf(2, null, "Nama Pemegang Saham",
				sv(C, 0, 200, all).confConditionalRequired(ER2259PosRePps060200.genConditionalFieldMustEmpty())));
		fs.add(sf(3, null, "Kategori Pemegang Saham",
				sv(C, 0, 5, refTable).confReference(EHeaderMetadataShared.R003.getObject())
						.confConditionalRequired(ER2259PosRePps060200.genConditionalFieldMustEmpty())));
		...
		fs.add(sf(6, null, "Deviasi", sv(M, 0, 16, numericNegatif))
				.addFieldValidations(ER2259PosRePps060200.genValidationSum()));
		return res;
	}
}
