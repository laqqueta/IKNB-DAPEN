...
import id.go.ojk.pps.client.builder.field.rb.reference.ER2273PosRePps120100;
...
public class Re120100 extends BaseMetadata {
	...
	public SubmissionFormat get() {
		...
		fs.add(sf(1, null, "Kode Komponen / Baris",
				sv(M, 14, 14, refTable).confReference(EHeaderMetadataRb.R2273_RE120100.getObject())));
		fs.add(sf(2, null, "Nama Perusahaan Anak", sv(O, 0, 255, all)));
		fs.add(sf(3, null, "Proyeksi - Juni XX",
				sv(C, 1, 16, numericNegatif).confConditionalRequired(ER2273PosRePps120100.genConditionalField())));
		fs.add(sf(4, null, "Realisasi - Juni XX",
				sv(C, 1, 16, numericNegatif).confConditionalRequired(ER2273PosRePps120100.genConditionalField())));
		fs.add(sf(5, null, "Deviasi",
				sv(C, 1, 16, numericNegatif).confConditionalRequired(ER2273PosRePps120100.genConditionalField()))
				.addFieldValidations(ER2273PosRePps120100.genValidationSum()));
		return res;
	}
}
