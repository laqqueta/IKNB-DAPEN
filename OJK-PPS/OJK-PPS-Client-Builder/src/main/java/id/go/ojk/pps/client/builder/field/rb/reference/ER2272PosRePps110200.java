...
public enum ER2272PosRePps110200 implements IObject<KeyValueString> {
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER2272PosRePps110200 eEnum : ER2272PosRePps110200.values()) {
	...
	public static String getName() {
		return ER2272PosRePps110200.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER2272PosRePps110200.class.getSimpleName().substring(2, 6));
	}
