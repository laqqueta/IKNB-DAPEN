...
import id.go.ojk.pps.client.builder.field.rb.reference.ER2264PosRePps090202;
...
public class Re090202 extends BaseMetadata {
	...
	public SubmissionFormat get() {
		...
		fs.add(sf(1, null, "Kode Komponen / Baris",
				sv(M, 14, 14, refTable).confReference(EHeaderMetadataRb.R2264_RE090202.getObject())));
		fs.add(sf(2, null, "Materi/Topik", sv(O, 0, 1000, all)));
		fs.add(sf(3, null, "Metode Diklat",
				sv(C, 0, 1000, all).confConditionalRequired(ER2264PosRePps090202.genConditionalField())));
		fs.add(sf(4, null, "Waktu Diklat",
				sv(C, 0, 8, date).confConditionalRequired(ER2264PosRePps090202.genConditionalField())));
		...
		fs.add(sf(8, null, "Jumlah Seluruh Peserta",
				sv(C, 0, 10, numeric).confConditionalRequired(ER2264PosRePps090202.genConditionalField())));
		fs.add(sf(9, null, "Biaya Diklat",
				sv(C, 0, 16, numeric).confConditionalRequired(ER2264PosRePps090202.genConditionalField())));
		return res;
	}
}
