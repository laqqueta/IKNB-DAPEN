...
public enum ER2252PosRePps040201 implements IObject<KeyValueString> {
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER2252PosRePps040201 eEnum : ER2252PosRePps040201.values()) {
	...
	public static String getName() {
		return ER2252PosRePps040201.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER2252PosRePps040201.class.getSimpleName().substring(2, 6));
	}
