...
public enum ER2019PosRbPps100302 implements IObject<KeyValueString> {
...
//	R_10030204000000000000 ("10030204000000000000", "TAKSIRAN PAJAK PENGHASILAN"),
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER2019PosRbPps100302 eEnum : ER2019PosRbPps100302.values()) {
	...
	public static String getName() {
		return ER2019PosRbPps100302.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER2019PosRbPps100302.class.getSimpleName().substring(2, 6));
	}
	...
	public static SegmentValidation genValidationFormLabaSetelahPajak() {
		...
		return UtilSegmentValidation.genEqualsForm2("2|3|4|5", R_10030205000000000000.key, comparatorFormCode, 
				ER2018PosRbPps100202.R_10020203040000.getKey(), "Nilai Laba (Rugi) Bersih Setelah Pajak|Nilai Laba (Rugi) Bersih Setelah Pajak form " + comparatorFormCode + " #kolom#");
	}

	public static SegmentValidation genValidationFormKeuntunganPendapatanKomprehensifLainnya() {
		String comparatorFormCode = EFormRencanaBisnis.RB_100202.getCode();
		return UtilSegmentValidation.genEqualsForm2("2|3|4|5", R_10030206000000000000.key, comparatorFormCode, 
				ER2018PosRbPps100202.R_10020203050200.getKey(), "Nilai Keuntungan (Kerugian) Pendapatan Komprehensif Lainnya|Nilai Keuntungan (Kerugian) Komperehensif Lainnya Periode Berjalan form " + comparatorFormCode + " #kolom#");
	}

	public static SegmentValidation genValidationPendapatan() {
		return UtilSegmentValidation.genEqualsFormula("2|3|4|5", R_10030201000000000000.key,
	...
	public static SegmentValidation genValidationPendapatanOperasional() {
		return UtilSegmentValidation.genEqualsFormula("2|3|4|5", R_10030201010000000000.key,
	...
	public static SegmentValidation genValidationPendapatanKegiatanPembiayaan() {
		return UtilSegmentValidation.genEqualsFormula("2|3|4|5", R_10030201010100000000.key,
	...
	public static SegmentValidation genValidationPendapatanMarginDariKegiatanPembiayaanJualBeli() {
		return UtilSegmentValidation.genEqualsFormula("2|3|4|5", R_10030201010101000000.key,
	...
	public static SegmentValidation genValidationPendapatanBagiHasilPembiayaanInvestasi() {
		return UtilSegmentValidation.genEqualsFormula("2|3|4|5", R_10030201010102000000.key,
	...
	public static SegmentValidation genValidationPendapatanImbalJasaPembiayaanJasa() {
		return UtilSegmentValidation.genEqualsFormula("2|3|4|5", R_10030201010103000000.key,
	...
	public static SegmentValidation genValidationPendapatanOperasionalLainTerkaitPembiayaan() {
		return UtilSegmentValidation.genEqualsFormula("2|3|4|5", R_10030201010200000000.key,
	...
	public static SegmentValidation genValidationPendapatanNonOperasional() {
		return UtilSegmentValidation.genEqualsFormula("2|3|4|5", R_10030201020000000000.key,
	...
	public static SegmentValidation genValidationBeban() {
		return UtilSegmentValidation.genEqualsFormula("2|3|4|5", R_10030202000000000000.key,
				R_10030202010000000000.key + "+" + R_10030202020000000000.key, "Total Beban|Penjumlahan Beban");
	}

	public static SegmentValidation genValidationBebanOperasional() {
		return UtilSegmentValidation.genEqualsFormula("2|3|4|5", R_10030202010000000000.key,
	...
	public static SegmentValidation genValidationBebanMargin() {
		return UtilSegmentValidation.genEqualsFormula("2|3|4|5", R_10030202010100000000.key,
	...
	public static SegmentValidation genValidationBebanTenagaKerja() {
		return UtilSegmentValidation.genEqualsFormula("2|3|4|5", R_10030202010400000000.key,
	...
	public static SegmentValidation genValidationBebanPemasaran() {
		return UtilSegmentValidation.genEqualsFormula("2|3|4|5", R_10030202010500000000.key,
	...
	public static SegmentValidation genValidationBebanPenyisihan() {
		return UtilSegmentValidation.genEqualsFormula("2|3|4|5", R_10030202010600000000.key,
	...
	public static SegmentValidation genValidationBebanPenyisihanPiutang() {
		return UtilSegmentValidation.genEqualsFormula("2|3|4|5", R_10030202010601000000.key,
	...
	public static SegmentValidation genValidationLabaSebelumPajak() {
		return UtilSegmentValidation.genEqualsFormula("2|3|4|5", R_10030203000000000000.key,
	...
	public static SegmentValidation genValidationLabaSetelahPajak() {
		return UtilSegmentValidation.genEqualsFormula("2|3|4|5", R_10030205000000000000.key,
	...
	public static SegmentValidation genValidationKeuntunganPendapatanKomprehensifLainnya() {
		return UtilSegmentValidation.genEqualsFormula("2|3|4|5", R_10030206000000000000.key,
	...
	public static SegmentValidation genValidationLabaBersihKomprehensifPeriodeBerjalan() {
		return UtilSegmentValidation.genEqualsFormula("2|3|4|5", R_10030207000000000000.key,
