...
public enum ER2002PosRbPps040201 implements IObject<KeyValueString> {
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER2002PosRbPps040201 eEnum : ER2002PosRbPps040201.values()) {
	...
	public static String getName() {
		return ER2002PosRbPps040201.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER2002PosRbPps040201.class.getSimpleName().substring(2, 6));
	}
