...
public enum ER2012PosRbPps070301 implements IObject<KeyValueString> {
...
//	R_07030102000000 ("07030102000000", "Saldo Penerimaan Pendanaan (Outstanding):"),
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER2012PosRbPps070301 eEnum : ER2012PosRbPps070301.values()) {
	...
	public static String getName() {
		return ER2012PosRbPps070301.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER2012PosRbPps070301.class.getSimpleName().substring(2, 6));
	}
	...
	public static SegmentValidation genValidationFormPenerimaanPendanaanBaru() {
		String comparatorFormCode = EFormRencanaBisnis.RB_070102.getCode();
		return UtilSegmentValidation.genEqualsForm2("2|3|4|5", R_07030101070000.key, comparatorFormCode, 
				ER2010PosRbPps070102.R_07010201090000.getKey(), "Total Penerimaan Pendanaan Baru|Total Penerimaan Pendanaan Baru form " + comparatorFormCode + " #kolom#");
	}
	...
	public static SegmentValidation genValidationFormSaldoPenerimaanPendanaan() {
		...
		return UtilSegmentValidation.genEqualsForm2("2|3|4|5", R_07030102070000.key, comparatorFormCode, 
				ER2010PosRbPps070102.R_07010202090000.getKey(), "Total Saldo Penerimaan Pendanaan|Total Saldo Penerimaan Pendanaan form " + comparatorFormCode + " #kolom#");
	}
