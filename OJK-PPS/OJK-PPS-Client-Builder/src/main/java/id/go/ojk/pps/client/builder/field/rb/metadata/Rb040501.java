...
import id.go.ojk.pps.client.builder.field.rb.reference.ER2005PosRbPps040501;
...
public class Rb040501 extends BaseMetadata {
	...
	public SubmissionFormat get() {
		...
		SubmissionFormat res = new SubmissionFormat(eEnum.getCode(), eEnum.getName(), reportCode, new ArrayList<>(),
				extension, 72, 72, ER2005PosRbPps040501.genFieldSave(), null, ER2005PosRbPps040501.getRequiredPos());
		res.addSegmentValidations(ER2005PosRbPps040501.genValidationTotalRencanaPenyaluranPembiayaanBaru());
		res.addSegmentValidations(ER2005PosRbPps040501.genValidationTotalSaldoPiutangPembiayaan());
		res.addSegmentValidations(ER2005PosRbPps040501.genValidationFormRencanaPenyaluranPembiayaanBaru());
		res.addSegmentValidations(ER2005PosRbPps040501.genValidationFormSaldoPiutangPembiayaan());
