...
public enum ER2270PosRePps100402 implements IObject<KeyValueString> {
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER2270PosRePps100402 eEnum : ER2270PosRePps100402.values()) {
	...
	public static String getName() {
		return ER2270PosRePps100402.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER2270PosRePps100402.class.getSimpleName().substring(2, 6));
	}
	...
	public static SegmentValidation genValidationFormKasDanSetaraKasPadaAkhirPeriode() {
		...
		return UtilSegmentValidation.genEqualsForm2("2|3", R_10040207000000.key, comparatorFormCode, 
				ER2268PosRePps100202.R_10020201010000.getKey(), "Total Kas dan Setara Kas pada Akhir Periode|Total Kas dan Setara Kas pada Akhir Periode form " + comparatorFormCode + " #kolom#");
	}
