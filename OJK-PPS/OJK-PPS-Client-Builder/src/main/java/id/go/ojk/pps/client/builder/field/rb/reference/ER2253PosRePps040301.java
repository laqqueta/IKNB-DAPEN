...
public enum ER2253PosRePps040301 implements IObject<KeyValueString> {
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER2253PosRePps040301 eEnum : ER2253PosRePps040301.values()) {
	...
	public static String getName() {
		return ER2253PosRePps040301.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER2253PosRePps040301.class.getSimpleName().substring(2, 6));
	}
	...
	public static String genFieldSave() {
		return UtilMetadata.genFieldSave("5|6|7", getObjects());
	}

	public static ConditionalRequired genConditionalFieldMustEmpty() {
		return UtilFieldConditional.genExistPos("N", "O", R_04030104000000.key);
	}
	...
	public static FieldValidation genValidationSum() {
		return UtilFieldValidation.genEqualsPosFormula("6-5", UtilMetadata.genPipeRow(getObjects(), 0, 2));
	}
