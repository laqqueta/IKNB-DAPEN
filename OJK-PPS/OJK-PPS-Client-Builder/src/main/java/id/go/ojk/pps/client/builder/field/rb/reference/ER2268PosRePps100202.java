...
public enum ER2268PosRePps100202 implements IObject<KeyValueString> {
...
//	R_10020203000000 ("10020203000000", "EKUITAS"),
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER2268PosRePps100202 eEnum : ER2268PosRePps100202.values()) {
	...
	public static String getName() {
		return ER2268PosRePps100202.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER2268PosRePps100202.class.getSimpleName().substring(2, 6));
	}
	...
	public static SegmentValidation genValidationJumlahAset() {
		return UtilSegmentValidation.genEqualsFormula("2|3", R_10020201100000.key,
	...
	public static SegmentValidation genValidationJumlahLiabilitas() {
		return UtilSegmentValidation.genEqualsFormula("2|3", R_10020202090000.key,
	...
	public static SegmentValidation genValidationModal() {
		return UtilSegmentValidation.genEqualsFormula("2|3", R_10020203010000.key,
	...
	public static SegmentValidation genValidationTambahanModalDisetor() {
		return UtilSegmentValidation.genEqualsFormula("2|3", R_10020203010300.key,
	...
	public static SegmentValidation genValidationCadangan() {
		return UtilSegmentValidation.genEqualsFormula("2|3", R_10020203020000.key, 
				R_10020203020100.key + "+" + R_10020203020200.key, 
				"Total Cadangan|Penjumlahan Cadangan");
	}

	public static SegmentValidation genValidationKomponenEkuitasLainnya() {
		return UtilSegmentValidation.genEqualsFormula("2|3", R_10020203050000.key,
	...
	public static SegmentValidation genValidationJumlahEkuitas() {
		return UtilSegmentValidation.genEqualsFormula("2|3", R_10020203060000.key,
	...
	public static SegmentValidation genValidationJumlahLiabilitasDanEkuitas() {
		return UtilSegmentValidation.genEqualsFormula("2|3", R_10020204000000.key,
