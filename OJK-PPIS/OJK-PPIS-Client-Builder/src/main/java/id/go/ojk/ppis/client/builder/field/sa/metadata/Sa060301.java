...
import id.go.ojk.ppis.client.builder.field.sa.reference.EHeaderMetadataSa;
import id.go.ojk.ppis.client.builder.field.sa.reference.ER3301PosSaPpis060301;
...
public class Sa060301 extends BaseMetadata {
	...
	public SubmissionFormat get() {
		...
		SubmissionFormat res = new SubmissionFormat(eEnum.getCode(), eEnum.getName(), reportCode, new ArrayList<>(),
				extension, 9, 9);
		res.setRequiredPos(ER3301PosSaPpis060301.getRequiredPos());
		res.setUniquePos(ER3301PosSaPpis060301.getUniquePos());		
		List<SubmissionField> fs = res.getFields();
		fs.add(sf(0, null, "Flag Detail", sv(M, 3, 3, alfaNumeric).confConstant("D01")));
		fs.add(sf(1, null, "Kode Komponen / Baris", sv(M, 10, 10, refTable)
				.confReference(EHeaderMetadataSa.R3301_SA060301.getObject()).confRegex(patternNumeric)));
