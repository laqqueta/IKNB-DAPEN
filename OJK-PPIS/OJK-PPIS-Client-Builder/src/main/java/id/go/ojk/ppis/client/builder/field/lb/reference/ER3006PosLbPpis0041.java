...
public enum ER3006PosLbPpis0041 implements IObject<KeyValueString> {
...
//	R_0041030000 ("0041030000", "Jumlah Tenaga Kerja Kantor Cabang"),
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER3006PosLbPpis0041 eEnum : ER3006PosLbPpis0041.values()) {
	...
	public static String getName() {
		return ER3006PosLbPpis0041.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER3006PosLbPpis0041.class.getSimpleName().substring(2, 6));
	}
	...
	public static SegmentValidation genRowValidation14() {
		...
		return UtilSegmentValidation.genEqualsFormula(UtilMetadata.genPipeColumn(2, 11), R_0041050000.key,
				...
				UtilMetadata.genMessage("Tenaga kerja", UtilMetadata.genPlusDesc(getObjects(), fields)));
	}
}
