...
public enum ER3024PosLbPpis5310 implements IObject<KeyValueString> {
...
//	R_53100300000000 ("53100300000000", "II.  LIABILITAS"),
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER3024PosLbPpis5310 eEnum : ER3024PosLbPpis5310.values()) {
	...
	public static String getName() {
		return ER3024PosLbPpis5310.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER3024PosLbPpis5310.class.getSimpleName().substring(2, 6));
	}
