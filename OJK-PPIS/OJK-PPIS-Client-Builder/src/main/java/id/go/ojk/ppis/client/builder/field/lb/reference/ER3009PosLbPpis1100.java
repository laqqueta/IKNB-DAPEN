...
public enum ER3009PosLbPpis1100 implements IObject<KeyValueString> {
...
//	R_11000300000000 ("11000300000000", "Liabilitas dan Ekuitas"),
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER3009PosLbPpis1100 eEnum : ER3009PosLbPpis1100.values()) {
	...
	public static String getName() {
		return ER3009PosLbPpis1100.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER3009PosLbPpis1100.class.getSimpleName().substring(2, 6));
	}
	...
	public static SegmentValidation genRowValidation011A() {
		return UtilSegmentValidation.genEqualsFormulaForm2("2", R_11000102000000.key, "13",
				ER3015PosLbPpis2200.R_2200010000.getFormKey(), "7", ER1122JenisValuta.R_1.getKey(),
	...
	public static SegmentValidation genRowValidation013B() {
		return UtilSegmentValidation.genEqualsForm("2", R_11000107000000.key, EFormLaporanBulanan.LB_5310.getCode(), "8",
				ER3024PosLbPpis5310.R_53100101060000.getKey(), R_11000107000000.value);
	}
	...
	public static SegmentValidation genRowValidation014B() {
		return UtilSegmentValidation.genEqualsForm("2", R_11000107010000.key, EFormLaporanBulanan.LB_5310.getCode(), "8",
				ER3024PosLbPpis5310.R_53100101060100.getKey(), R_11000107010000.value);
	}
	...
	public static SegmentValidation genRowValidation015B() {
		...
		return UtilSegmentValidation.genEqualsFormulaFormMultiFilter("2", R_11000107010100.key, "19",
				ER3013PosLbPpis2100.R_2100010000.getFormKey(), "13|22", kegiatan + "|" + ER1122JenisValuta.R_1.getKey(), 
	...
	public static SegmentValidation genRowValidation015C() {
		...
		return UtilSegmentValidation.genEqualsFormulaFormMultiFilterNotEquals("3", R_11000107010100.key, "19",
				ER3013PosLbPpis2100.R_2100010000.getFormKey(), "13", kegiatan, "22", ER1122JenisValuta.R_1.getKey(),
	...
	public static SegmentValidation genRowValidation025A() {
		return UtilSegmentValidation.genEqualsForm("2", R_11000107010400.key, EFormLaporanBulanan.LB_5310.getCode(), "8",
				ER3024PosLbPpis5310.R_53100101060102.getKey(), R_11000107010400.value);
	}
	...
	public static SegmentValidation genRowValidation026B() {
		return UtilSegmentValidation.genEqualsForm("2", R_11000107020000.key, EFormLaporanBulanan.LB_5310.getCode(), "8",
				ER3024PosLbPpis5310.R_53100101060200.getKey(), R_11000107020000.value);
	}
	...
	public static SegmentValidation genRowValidation033B() {
		return UtilSegmentValidation.genEqualsForm("2", R_11000107030000.key, EFormLaporanBulanan.LB_5310.getCode(), "8",
				ER3024PosLbPpis5310.R_53100101060300.getKey(), R_11000107030000.value);
	}
	...
	public static SegmentValidation genRowValidation036C() {
		return UtilSegmentValidation.genEqualsForm("2", R_11000107030300.key, EFormLaporanBulanan.LB_5310.getCode(), "8",
				ER3024PosLbPpis5310.R_53100101060302.getKey(), R_11000107030300.value);
	}
	...
	public static SegmentValidation genRowValidation037B() {
		return UtilSegmentValidation.genEqualsForm("2", R_11000107040000.key, EFormLaporanBulanan.LB_5310.getCode(), "8",
				ER3024PosLbPpis5310.R_53100101060400.getKey(), R_11000107040000.value);
	}
	...
	public static SegmentValidation genRowValidation041B() {
		return UtilSegmentValidation.genEqualsForm("2", R_11000107050000.key, EFormLaporanBulanan.LB_5310.getCode(), "8",
				ER3024PosLbPpis5310.R_53100101060500.getKey(), R_11000107050000.value);
	}
	...
	public static SegmentValidation genRowValidation045D() {
		return UtilSegmentValidation.genEqualsForm("2", R_11000108000000.key, EFormLaporanBulanan.LB_5310.getCode(), "8",
				ER3024PosLbPpis5310.R_53100101060600.getKey(), R_11000108000000.value);
	}

	public static SegmentValidation genRowValidation045E() {
		return UtilSegmentValidation.genEqualsForm("3", R_11000108000000.key, EFormLaporanBulanan.LB_5310.getCode(), "15",
				ER3024PosLbPpis5310.R_53100101060600.getKey(), R_11000108000000.value);
	}

	public static SegmentValidation genRowValidation045F() {
		return UtilSegmentValidation.genEqualsForm("4", R_11000108000000.key, EFormLaporanBulanan.LB_5310.getCode(), "16",
				ER3024PosLbPpis5310.R_53100101060600.getKey(), R_11000108000000.value);
	}
	...
	public static SegmentValidation genRowValidation049B() {
		return UtilSegmentValidation.genEqualsFormulaForm2("2", R_11000109000000.key, "12",
				ER3016PosLbPpis2300.R_2300010000.getFormKey(), "8", ER1122JenisValuta.R_1.getKey(),
	...
	public static SegmentValidation genRowValidation052() {
		return UtilSegmentValidation.genEqualsFormula(UtilMetadata.genPipeColumn(2, 3), R_11000110000000.key,
				...
				UtilMetadata.genMessage(R_11000110000000.value, UtilMetadata.genPlusDesc(getObjects(), 51, 53)));
	}
	...
	public static SegmentValidation genRowValidation054A() {
		return UtilSegmentValidation.genEqualsFormulaForm2("2", R_11000110020000.key, "10",
				ER3017PosLbPpis2350.R_2350010000.getFormKey(), "6", ER1122JenisValuta.R_1.getKey(),
	...
	public static SegmentValidation genRowValidation063A() {
		return UtilSegmentValidation.genEqualsFormulaForm2("2", R_11000114000000.key, "4",
				ER3019PosLbPpis2490.R_2490010000.getFormKey(), "3", ER1122JenisValuta.R_1.getKey(),
	...
	public static SegmentValidation genRowValidation064C() {
		return UtilSegmentValidation.genEqualsForm("2", R_11000200000000.key, EFormLaporanBulanan.LB_5310.getCode(), "8",
				ER3024PosLbPpis5310.R_53100200000000.getKey(), R_11000200000000.value);
	}
	...
	public static SegmentValidation genRowValidation073B() {
		return UtilSegmentValidation.genEqualsForm("2", R_11000304000000.key, EFormLaporanBulanan.LB_5310.getCode(), "8",
				ER3024PosLbPpis5310.R_53100301000000.getKey(), R_11000304000000.value);
	}
	...
	public static SegmentValidation genRowValidation075A() {
		return UtilSegmentValidation.genEqualsFormulaFormMultiFilterNotEquals("2", R_11000304010100.key, "18",
				ER3020PosLbPpis2550.R_2550010000.getFormKey(), "6|7",
	...
	public static SegmentValidation genRowValidation075B() {
		return UtilSegmentValidation.genEqualsFormulaFormMultiFilterNotEquals("3", R_11000304010100.key, "18",
				ER3020PosLbPpis2550.R_2550010000.getFormKey(), "7", ER1140GolonganPihakLawan2550.getPmrnthPst(), "3|6",
	...
	public static SegmentValidation genRowValidation076B() {
		return UtilSegmentValidation.genEqualsFormulaFormMultiFilterNotEquals("3", R_11000304010200.key, "18",
				ER3020PosLbPpis2550.R_2550010000.getFormKey(), "7", ER1140GolonganPihakLawan2550.getPmrnthDrh(), "3|6",
				ER1150JenisPinjamanSyariah.R_4.getKey() + "|" + ER1122JenisValuta.R_1.getKey(),
	...
	public static SegmentValidation genRowValidation077B() {
		return UtilSegmentValidation.genEqualsFormulaFormMultiFilterNotEquals("3", R_11000304010300.key, "18",
				ER3020PosLbPpis2550.R_2550010000.getFormKey(), "7", ER1140GolonganPihakLawan2550.getPmrnthSng(), "3|6",
				ER1150JenisPinjamanSyariah.R_4.getKey() + "|" + ER1122JenisValuta.R_1.getKey(),
	...
	public static SegmentValidation genRowValidation078B() {
		return UtilSegmentValidation.genEqualsFormulaFormMultiFilterNotEquals("3", R_11000304020000.key, "18",
				ER3020PosLbPpis2550.R_2550010000.getFormKey(), "7", ER1140GolonganPihakLawan2550.getOrgnsiMltltrl(),
	...
	public static SegmentValidation genRowValidation080B() {
		return UtilSegmentValidation.genEqualsFormulaFormMultiFilterNotEquals("3", R_11000304030100.key, "18",
				ER3020PosLbPpis2550.R_2550010000.getFormKey(), "7", ER1140GolonganPihakLawan2550.getBnkDn(), "3|6",
				ER1150JenisPinjamanSyariah.R_4.getKey() + "|" + ER1122JenisValuta.R_1.getKey(),
	...
	public static SegmentValidation genRowValidation081B() {
		return UtilSegmentValidation.genEqualsFormulaFormMultiFilterNotEquals("3", R_11000304030200.key, "18",
				ER3020PosLbPpis2550.R_2550010000.getFormKey(), "7", ER1140GolonganPihakLawan2550.getBnkLn(), "3|6",
				ER1150JenisPinjamanSyariah.R_4.getKey() + "|" + ER1122JenisValuta.R_1.getKey(),
	...
	public static SegmentValidation genRowValidation083B() {
		return UtilSegmentValidation.genEqualsFormulaFormMultiFilterNotEquals("3", R_11000304040100.key, "18",
				ER3020PosLbPpis2550.R_2550010000.getFormKey(), "7", ER1140GolonganPihakLawan2550.getLjknbDn(), "3|6",
				ER1150JenisPinjamanSyariah.R_4.getKey() + "|" + ER1122JenisValuta.R_1.getKey(),
	...
	public static SegmentValidation genRowValidation084B() {
		return UtilSegmentValidation.genEqualsFormulaFormMultiFilterNotEquals("3", R_11000304040200.key, "18",
				ER3020PosLbPpis2550.R_2550010000.getFormKey(), "7", ER1140GolonganPihakLawan2550.getLjknbLn(), "3|6",
				ER1150JenisPinjamanSyariah.R_4.getKey() + "|" + ER1122JenisValuta.R_1.getKey(),
	...
	public static SegmentValidation genRowValidation085A() {
		return UtilSegmentValidation.genEqualsFormulaForm2("2", R_11000305000000.key, "14",
				ER3021PosLbPpis2600.R_2600010000.getFormKey(), "5", ER1122JenisValuta.R_1.getKey(),
	...
	public static SegmentValidation genRowValidation085C() {
		return UtilSegmentValidation.genEqualsForm("2", R_11000305000000.key, EFormLaporanBulanan.LB_5310.getCode(), "8",
				ER3024PosLbPpis5310.R_53100302000000.getKey(), R_11000305000000.value);
	}
	...
	public static SegmentValidation genRowValidation089A() {
		return UtilSegmentValidation.genEqualsFormulaFormMultiFilter("2", R_11000308010000.key, "18",
				ER3020PosLbPpis2550.R_2550010000.getFormKey(), "3|6|20",
				ER1150JenisPinjamanSyariah.R_4.getKey() + "|" + ER1122JenisValuta.R_1.getKey() + "|"
	...
	public static SegmentValidation genRowValidation089B() {
		return UtilSegmentValidation.genEqualsFormulaFormMultiFilterNotEquals("3", R_11000308010000.key, "18",
				ER3020PosLbPpis2550.R_2550010000.getFormKey(), "3|20",
	...
	public static SegmentValidation genRowValidation090A() {
		return UtilSegmentValidation.genEqualsFormulaFormMultiFilterNotEquals("2", R_11000308020000.key, "18",
				ER3020PosLbPpis2550.R_2550010000.getFormKey(), "3|6",
	...
	public static SegmentValidation genRowValidation090B() {
		return UtilSegmentValidation.genEqualsFormulaFormMultiFilterNotEquals("3", R_11000308020000.key, "18",
				ER3020PosLbPpis2550.R_2550010000.getFormKey(), "3", ER1150JenisPinjamanSyariah.R_4.getKey(), "6|20",
	...
	public static SegmentValidation genRowValidation091A() {
		return UtilSegmentValidation.genEqualsFormulaForm2("2", R_11000309000000.key, "4",
				ER3022PosLbPpis2790.R_2790010000.getFormKey(), "3", ER1122JenisValuta.R_1.getKey(),
	...
	public static SegmentValidation genRowValidation097A() {
	...
	public static SegmentValidation genRowValidation097B() {
		return UtilSegmentValidation.genEqualsForm("4", R_11000310010000.key, EFormLaporanBulanan.LB_0030.getCode(), "9",
				ER3003PosLbPpis0030.R_0030010000.getKey(), R_11000310010000.value);
	}
	...
	private static String messageForm2100A(String kodeKegiatan, boolean isRupiah) {
		return "Tagihan piutang pembiayaan bruto dengan [dimensi Jenis Pembiayaan terisi "  + kodeKegiatan + "] (" + getOther(isRupiah) + "rupiah) pada form 2100";
	}
	...
	private static String messageForm2550A(String kodeInvestor, boolean isRupiah) {
		return "Kolom [Saldo Pinjaman/Pendanaan yang Diterima] dengan  dimensi [Jenis Pinjaman/Pendanaan terisi selain Pinjaman Subordinasi (SF:e8)] dan Golongan Investor terisi sandi yang termasuk " + kodeInvestor + " (" + getOther(isRupiah) + "rupiah) pada form 2550";
	}
