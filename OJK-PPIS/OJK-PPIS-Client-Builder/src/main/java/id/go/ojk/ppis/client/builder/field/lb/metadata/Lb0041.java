...
import id.go.ojk.ppis.client.builder.field.lb.reference.ER3006PosLbPpis0041;
...
public class Lb0041 extends BaseMetadata {
	...
	public SubmissionFormat get() {
		...
		SubmissionFormat res = new SubmissionFormat(eEnum.getCode(), eEnum.getName(), reportCode, new ArrayList<>(),
				extension, 13, 13, ER3006PosLbPpis0041.genFieldSave(), ER3006PosLbPpis0041.genFieldSave(),
				ER3006PosLbPpis0041.getRequiredPos());
		res.addSegmentValidations(ER3006PosLbPpis0041.genRowValidation07());
		res.addSegmentValidations(ER3006PosLbPpis0041.genRowValidation13());
		res.addSegmentValidations(ER3006PosLbPpis0041.genRowValidation14());
		List<SubmissionField> fs = res.getFields();
		fs.add(sf(0, null, "Flag Detail", sv(M, 3, 3, alfaNumeric).confConstant("D01")));
		fs.add(sf(1, null, "Kode Komponen / Baris",
				sv(M, 10, 10, refTable).confReference(EHeaderMetadataLb.R3006_LB0041.getObject())
		...
		fs.add(sf(4, null, "Tenaga Kerja Tetap - Total", sv(M, 1, 4, numeric))
				.addFieldValidations(ER3006PosLbPpis0041.genFieldValidation4()));
		...
		fs.add(sf(7, null, "Tenaga Kerja Kontrak - Total", sv(M, 1, 4, numeric))
				.addFieldValidations(ER3006PosLbPpis0041.genFieldValidation7()));
		...
		fs.add(sf(10, null, "Tenaga Kerja Outsourcing - Total", sv(M, 1, 4, numeric))
				.addFieldValidations(ER3006PosLbPpis0041.genFieldValidation10()));
		fs.add(sf(11, null, "Total Keseluruhan", sv(M, 1, 4, numeric))
				.addFieldValidations(ER3006PosLbPpis0041.genFieldValidation11()));
		return res;
	}
}
