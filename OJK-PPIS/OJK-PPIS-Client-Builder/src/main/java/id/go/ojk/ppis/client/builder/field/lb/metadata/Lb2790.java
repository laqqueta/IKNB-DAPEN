...
import id.go.ojk.ppis.client.builder.field.lb.reference.ER3022PosLbPpis2790;
...
public class Lb2790 extends BaseMetadata {
	...
	public SubmissionFormat get() {
		...
		SubmissionFormat res = new SubmissionFormat(eEnum.getCode(), eEnum.getName(), reportCode, new ArrayList<>(),
				extension, 0, null);
		res.setSavePosForm(ER3022PosLbPpis2790.genFieldSave());
		...
		fs.add(sf(5, null, "Jangka Waktu, Tanggal Mulai", sv(O, 8, 8, date))
				.addFieldValidations(ER3022PosLbPpis2790.genFieldValidation5()));
