...
public enum ER3015PosLbPpis2200 implements IObject<KeyValueString> {
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER3015PosLbPpis2200 eEnum : ER3015PosLbPpis2200.values()) {
	...
	public static String getName() {
		return ER3015PosLbPpis2200.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER3015PosLbPpis2200.class.getSimpleName().substring(2, 6));
	}
