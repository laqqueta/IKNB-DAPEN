...
import id.go.ojk.ppis.client.builder.field.sa.reference.ER3300PosSaPpis060100;
...
public class Sa060100 extends BaseMetadata {
	...
	public SubmissionFormat get() {
		...
		SubmissionFormat res = new SubmissionFormat(eEnum.getCode(), eEnum.getName(), reportCode, new ArrayList<>(),
				extension, 5, 5);
		res.setRequiredPos(ER3300PosSaPpis060100.getRequiredPos());
		res.setUniquePos(ER3300PosSaPpis060100.getUniquePos());
		List<SubmissionField> fs = res.getFields();
		fs.add(sf(0, null, "Flag Detail", sv(M, 3, 3, alfaNumeric).confConstant("D01")));
		fs.add(sf(1, null, "Kode Komponen / Baris", sv(M, 10, 10, refTable)
				.confReference(EHeaderMetadataSa.R3300_SA060100.getObject()).confRegex(patternNumeric)));
