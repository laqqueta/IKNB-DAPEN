...
import id.go.ojk.ppis.client.builder.field.lb.reference.ER3024PosLbPpis5310;
...
public class Lb5310 extends BaseMetadata {
	...
	public SubmissionFormat get() {
		...
		SubmissionFormat res = new SubmissionFormat(eEnum.getCode(), eEnum.getName(), reportCode, new ArrayList<>(),
				extension, 24, 24, ER3024PosLbPpis5310.genFieldSave(), ER3024PosLbPpis5310.genFieldSave(),
				ER3024PosLbPpis5310.getRequiredPos());
		res.addSegmentValidations(ER3024PosLbPpis5310.genRowValidation02());
		res.addSegmentValidations(ER3024PosLbPpis5310.genRowValidation03());
		res.addSegmentValidations(ER3024PosLbPpis5310.genRowValidation06());
		res.addSegmentValidations(ER3024PosLbPpis5310.genRowValidation09());
		res.addSegmentValidations(ER3024PosLbPpis5310.genRowValidation12());
		res.addSegmentValidations(ER3024PosLbPpis5310.genRowValidation15());
		res.addSegmentValidations(ER3024PosLbPpis5310.genRowValidation20());
		res.addSegmentValidations(ER3024PosLbPpis5310.genRowValidation24());
		...
		fs.add(sf(8, null, "Rupiah, Jumlah", sv(M, 1, 16, numericNegatif))
				.addFieldValidations(ER3024PosLbPpis5310.genFieldValidation8()));
		...
		fs.add(sf(15, null, "Valas, Jumlah", sv(M, 1, 16, numericNegatif))
				.addFieldValidations(ER3024PosLbPpis5310.genFieldValidation15()));
		fs.add(sf(16, null, "Total", sv(M, 1, 16, numericNegatif))
				.addFieldValidations(ER3024PosLbPpis5310.genFieldValidation16()));
		return res;
	}
}
