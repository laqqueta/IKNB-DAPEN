...
public enum ER3008PosLbPpis0046 implements IObject<KeyValueString> {
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER3008PosLbPpis0046 eEnum : ER3008PosLbPpis0046.values()) {
	...
	public static String getName() {
		return ER3008PosLbPpis0046.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER3008PosLbPpis0046.class.getSimpleName().substring(2, 6));
	}
