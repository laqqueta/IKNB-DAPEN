...
public enum ER3007PosLbPpis0043 implements IObject<KeyValueString> {
//	R_0043010000 ("0043010000", "Jumlah Tenaga Kerja"),
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER3007PosLbPpis0043 eEnum : ER3007PosLbPpis0043.values()) {
	...
	public static String getName() {
		return ER3007PosLbPpis0043.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER3007PosLbPpis0043.class.getSimpleName().substring(2, 6));
	}
	...
	public static SegmentValidation genRowValidation13() {
		return UtilSegmentValidation.genEqualsForm("10", R_0043020000.key, EFormLaporanBulanan.LB_0041.getCode(), "11",
				ER3006PosLbPpis0041.R_0041050000.getKey(), R_0043020000.value);
	}
}
