...
public enum ER3004PosLbPpis0035 implements IObject<KeyValueString> {
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER3004PosLbPpis0035 eEnum : ER3004PosLbPpis0035.values()) {
	...
	public static String getName() {
		return ER3004PosLbPpis0035.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER3004PosLbPpis0035.class.getSimpleName().substring(2, 6));
	}
