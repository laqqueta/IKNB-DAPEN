...
public class Lb0010 extends BaseMetadata {
	...
	public SubmissionFormat get() {
		...
		fs.add(sf(2, null, "Nomor Izin Usaha", sv(M, 1, 35, all)));
		fs.add(sf(3, null, "Tanggal Izin Usaha", sv(M, 8, 8, date)));
		fs.add(sf(4, null, "Jenis Perizinan", sv(M, 1, 10, refTable)
				.confReference(EHeaderMetadataShared.R005.getObject()).confRegex(PATTERN_REFERENCE_1.c())));
		fs.add(sf(5, null, "Keterangan", sv(O, 1, 2000, all)));
		return res;
	}
}
