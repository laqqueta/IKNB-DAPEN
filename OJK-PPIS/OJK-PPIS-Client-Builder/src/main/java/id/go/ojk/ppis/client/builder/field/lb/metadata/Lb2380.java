...
import id.go.ojk.ppis.client.builder.field.lb.reference.ER3018PosLbPpis2380;
...
public class Lb2380 extends BaseMetadata {
	...
	public SubmissionFormat get() {
		...
		fs.add(sf(6, null, "Jangka Waktu, Tanggal Mulai", sv(M, 8, 8, date))
				.addFieldValidations(ER3018PosLbPpis2380.genFieldValidation6()));
		...
		fs.add(sf(11, null, "Margin/Bagi Hasil, Tingkat", sv(M, 1, 6, numericDot)));
		fs.add(sf(12, null, "Nominal Investasi, Dalam Nilai Mata Uang Asal",
				sv(C, 1, 16, numeric).confConditionalRequired(ER3018PosLbPpis2380.genFieldCondition())));
