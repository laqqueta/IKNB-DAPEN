...
import id.go.ojk.ppis.client.builder.field.lb.reference.ER3013PosLbPpis2100;
...
public class Lb2100 extends BaseMetadata {
	...
	public SubmissionFormat get() {
		...
		SubmissionFormat res = new SubmissionFormat(eEnum.getCode(), eEnum.getName(), reportCode, new ArrayList<>(),
				extension, 0, null);
		res.setSavePosForm(ER3013PosLbPpis2100.genFieldSave());
		res.addSegmentValidations(ER3013PosLbPpis2100.genRowValidation2());
		...
		fs.add(sf(15, null, "Jangka Waktu, Tanggal Mulai", sv(M, 8, 8, date))
				.addFieldValidations(ER3013PosLbPpis2100.genFieldValidation15()));
		...
		fs.add(sf(18, null, "Tagihan Piutang Pembiayaan Bruto, Dalam Nilai Mata Uang Asal",
				sv(C, 1, 16, numeric).confConditionalRequired(ER3013PosLbPpis2100.genFieldCondition())));
		...
		fs.add(sf(20, null, "Tagihan Piutang Pembiayaan Pokok, Dalam Nilai Mata Uang Asal",
				sv(C, 1, 16, numericNegatif).confConditionalRequired(ER3013PosLbPpis2100.genFieldCondition())));
		...
		fs.add(sf(42, null, "Jangka Waktu Asuransi/Penjaminan",
				sv(C, 1, 3, numeric).confConditionalRequired(ER3013PosLbPpis2100.genFieldCondition42())));
		...
		fs.add(sf(44, null, "Informasi Agunan, Nilai Agunan",
				sv(C, 1, 16, numeric).confConditionalRequired(ER3013PosLbPpis2100.genFieldCondition44())));
		return res;
	}
}
