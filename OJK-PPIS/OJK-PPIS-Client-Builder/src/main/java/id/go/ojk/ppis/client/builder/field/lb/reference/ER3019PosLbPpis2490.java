...
public enum ER3019PosLbPpis2490 implements IObject<KeyValueString> {
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER3019PosLbPpis2490 eEnum : ER3019PosLbPpis2490.values()) {
	...
	public static String getName() {
		return ER3019PosLbPpis2490.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER3019PosLbPpis2490.class.getSimpleName().substring(2, 6));
	}
