...
public enum ER3018PosLbPpis2380 implements IObject<KeyValueString> {
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER3018PosLbPpis2380 eEnum : ER3018PosLbPpis2380.values()) {
	...
	public static String getName() {
		return ER3018PosLbPpis2380.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER3018PosLbPpis2380.class.getSimpleName().substring(2, 6));
	}
