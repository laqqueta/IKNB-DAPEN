...
import id.go.ojk.ppis.client.builder.field.lb.reference.ER3007PosLbPpis0043;
...
public class Lb0043 extends BaseMetadata {
	...
	public SubmissionFormat get() {
		...
		SubmissionFormat res = new SubmissionFormat(eEnum.getCode(), eEnum.getName(), reportCode, new ArrayList<>(),
				extension, 12, 12, ER3007PosLbPpis0043.genFieldSave(), ER3007PosLbPpis0043.genFieldSave(),
				ER3007PosLbPpis0043.getRequiredPos());
		res.addSegmentValidations(ER3007PosLbPpis0043.genRowValidation12());
		res.addSegmentValidations(ER3007PosLbPpis0043.genRowValidation13());
		...
		fs.add(sf(8, null, "Total Tenaga Kerja - Tenaga Manajerial sampai satu level di bawah Direksi",
				sv(M, 1, 4, numeric)).addFieldValidations(ER3007PosLbPpis0043.genFieldValidation8()));
		fs.add(sf(9, null, "Total Tenaga Kerja - Staf dan Tingkat Tenaga Kerja Lainnya", sv(M, 1, 4, numeric))
				.addFieldValidations(ER3007PosLbPpis0043.genFieldValidation9()));
		fs.add(sf(10, null, "Total Tenaga Kerja Keseluruhan", sv(M, 1, 4, numeric))
				.addFieldValidations(ER3007PosLbPpis0043.genFieldValidation10()));
		fs.add(sf(11, null, "Keterangan Rangkap Jabatan",
				sv(C, 1, 500, all).confConditionalRequired(ER3007PosLbPpis0043.genFieldCondition11())));
		return res;
	}
}
