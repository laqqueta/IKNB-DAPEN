...
import id.go.ojk.ppis.client.builder.field.lb.reference.ER3020PosLbPpis2550;
...
public class Lb2550 extends BaseMetadata {
	...
	public SubmissionFormat get() {
		...
		SubmissionFormat res = new SubmissionFormat(eEnum.getCode(), eEnum.getName(), reportCode, new ArrayList<>(),
				extension, 0, null);
		res.setSavePosForm(ER3020PosLbPpis2550.genFieldSave());
		...
		fs.add(sf(8, null, "Tanggal Mulai", sv(M, 8, 8, date))
				.addFieldValidations(ER3020PosLbPpis2550.genFieldValidation8()));
		...
		fs.add(sf(13, null, "Plafon Pinjaman/Pendanaan, Dalam Mata Uang Asal",
				sv(C, 1, 16, numeric).confConditionalRequired(ER3020PosLbPpis2550.genFieldCondition())));
		...
		fs.add(sf(15, null, "Pinjaman/Pendanaan Awal, Dalam Mata Uang Asal",
				sv(C, 1, 16, numeric).confConditionalRequired(ER3020PosLbPpis2550.genFieldCondition()))
						.addFieldValidations(ER3020PosLbPpis2550.genFieldValidation15()));
		fs.add(sf(16, null, "Pinjaman/Pendanaan Awal, Dalam Ekuivalen Rupiah", sv(M, 1, 16, numeric))
				.addFieldValidations(ER3020PosLbPpis2550.genFieldValidation16()));
		...
		fs.add(sf(19, null, "Nama Investor", sv(M, 1, 50, all)));
