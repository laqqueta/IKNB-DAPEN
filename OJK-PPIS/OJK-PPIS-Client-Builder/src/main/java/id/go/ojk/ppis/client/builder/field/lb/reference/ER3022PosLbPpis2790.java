...
public enum ER3022PosLbPpis2790 implements IObject<KeyValueString> {
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER3022PosLbPpis2790 eEnum : ER3022PosLbPpis2790.values()) {
	...
	public static String getName() {
		return ER3022PosLbPpis2790.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER3022PosLbPpis2790.class.getSimpleName().substring(2, 6));
	}
