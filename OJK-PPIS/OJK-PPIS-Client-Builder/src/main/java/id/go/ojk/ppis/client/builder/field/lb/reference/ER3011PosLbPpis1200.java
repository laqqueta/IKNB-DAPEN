...
public enum ER3011PosLbPpis1200 implements IObject<KeyValueString> {
...
//	R_1200040000000000 ("1200040000000000", "Taksiran Pajak Penghasilan"),
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER3011PosLbPpis1200 eEnum : ER3011PosLbPpis1200.values()) {
	...
	public static String getName() {
		return ER3011PosLbPpis1200.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER3011PosLbPpis1200.class.getSimpleName().substring(2, 6));
	}
	...
	public static SegmentValidation genRowValidation71A() {
		...
		return UtilSegmentValidation.genEqualsFormula(UtilMetadata.genPipeColumn(2, 3), R_1200050000000000.key,
				...
				UtilMetadata.genMessage(R_1200050000000000.value, UtilMetadata.genMinusDesc(getObjects(), fields) + "+" + 
	...
	public static SegmentValidation genRowValidation71B() {
		return UtilSegmentValidation.genEqualsForm("2", R_1200050000000000.key, EFormLaporanBulanan.LB_1100.getCode(), 
				"2", ER3009PosLbPpis1100.R_11000313000000.getKey(), R_1200050000000000.value);
	}
	...
	public static SegmentValidation genRowValidation71C() {
		return UtilSegmentValidation.genEqualsForm("3", R_1200050000000000.key, EFormLaporanBulanan.LB_1100.getCode(), 
				"3", ER3009PosLbPpis1100.R_11000313000000.getKey(), R_1200050000000000.value);
	}
	...
	public static SegmentValidation genRowValidation71D() {
		return UtilSegmentValidation.genEqualsForm("4", R_1200050000000000.key, EFormLaporanBulanan.LB_1100.getCode(), 
				"4", ER3009PosLbPpis1100.R_11000313000000.getKey(), R_1200050000000000.value);
	}
	...
	public static SegmentValidation genRowValidation72A() {
		return UtilSegmentValidation.genEqualsFormula(UtilMetadata.genPipeColumn(2, 3), R_1200060000000000.key,
				...
				UtilMetadata.genMessage(R_1200060000000000.value, UtilMetadata.genPlusDesc(getObjects(), 71, 75)));
	}
	...
	public static SegmentValidation genRowValidation72B() {
		return UtilSegmentValidation.genEqualsForm("2", R_1200060000000000.key, EFormLaporanBulanan.LB_1100.getCode(), 
				"2", ER3009PosLbPpis1100.R_11000314020000.getKey(), R_1200060000000000.value);
	}
	...
	public static SegmentValidation genRowValidation72C() {
		return UtilSegmentValidation.genEqualsForm("3", R_1200060000000000.key, EFormLaporanBulanan.LB_1100.getCode(), 
				"3", ER3009PosLbPpis1100.R_11000314020000.getKey(), R_1200060000000000.value);
	}
	...
	public static SegmentValidation genRowValidation72D() {
		return UtilSegmentValidation.genEqualsForm("4", R_1200060000000000.key, EFormLaporanBulanan.LB_1100.getCode(), 
				"4", ER3009PosLbPpis1100.R_11000314020000.getKey(), R_1200060000000000.value);
	}
