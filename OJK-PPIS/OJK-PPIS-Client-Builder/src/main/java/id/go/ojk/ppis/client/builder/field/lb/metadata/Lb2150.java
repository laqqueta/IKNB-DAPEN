...
import id.go.ojk.ppis.client.builder.field.lb.reference.ER3014PosLbPpis2150;
...
public class Lb2150 extends BaseMetadata {
	...
	public SubmissionFormat get() {
		...
		SubmissionFormat res = new SubmissionFormat(eEnum.getCode(), eEnum.getName(), reportCode, new ArrayList<>(),
				extension, 0, null);
		res.setSavePosForm(ER3014PosLbPpis2150.genFieldSave());
		...
		fs.add(sf(4, null, "Nama Kelompok Nasabah",
				sv(C, 1, 10, refTable).confConditionalRequired(ER3014PosLbPpis2150.genFieldConditionA())
		...
		fs.add(sf(15, null, "Jangka Waktu, Tanggal Mulai", sv(M, 8, 8, date))
				.addFieldValidations(ER3014PosLbPpis2150.genFieldValidation15()));
		...
		fs.add(sf(20, null, "Tagihan Piutang Pembiayaan Bruto, Dalam Nilai Mata Uang Asal",
				sv(C, 1, 16, numeric).confConditionalRequired(ER3014PosLbPpis2150.genFieldConditionB())));
		...
		fs.add(sf(28, null, "Margin/Ujrah/Bagi Hasil yang Ditangguhkan, Dalam Mata Uang Asal", sv(M, 1, 16, numeric))
				.addFieldValidations(ER3014PosLbPpis2150.genFieldValidation28()));
		fs.add(sf(29, null, "Margin/Ujrah/Bagi Hasil yang Ditangguhkan, Dalam Ekuivalen Rupiah", sv(M, 1, 16, numeric))
				.addFieldValidations(ER3014PosLbPpis2150.genFieldValidation29()));
		...
		fs.add(sf(44, null, "Jangka Waktu Asuransi/Penjaminan",
				sv(C, 1, 3, numeric).confConditionalRequired(ER3014PosLbPpis2150.genFieldCondition44())));
		...
		fs.add(sf(46, null, "Informasi Agunan, Nilai Agunan",
				sv(C, 1, 16, numeric).confConditionalRequired(ER3014PosLbPpis2150.genFieldCondition46())));
		return res;
	}
}
