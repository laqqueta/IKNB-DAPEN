...
public enum ER3014PosLbPpis2150 implements IObject<KeyValueString> {
	...
	public String getFormKey() {
		return EFormLaporanBulanan.LB_2150.getCode() + key;
	}
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER3014PosLbPpis2150 eEnum : ER3014PosLbPpis2150.values()) {
	...
	public static String getName() {
		return ER3014PosLbPpis2150.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER3014PosLbPpis2150.class.getSimpleName().substring(2, 6));
	}
