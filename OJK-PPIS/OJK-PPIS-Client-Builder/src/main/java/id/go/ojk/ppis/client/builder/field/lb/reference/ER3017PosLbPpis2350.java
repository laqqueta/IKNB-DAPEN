...
public enum ER3017PosLbPpis2350 implements IObject<KeyValueString> {
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER3017PosLbPpis2350 eEnum : ER3017PosLbPpis2350.values()) {
	...
	public static String getName() {
		return ER3017PosLbPpis2350.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER3017PosLbPpis2350.class.getSimpleName().substring(2, 6));
	}
