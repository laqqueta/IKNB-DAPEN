...
public enum ER2129PosReReasu0102 implements IObject<KeyValueString> {
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER2129PosReReasu0102 eEnum : ER2129PosReReasu0102.values()) {
	...
	public static String getName() {
		return ER2129PosReReasu0102.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER2129PosReReasu0102.class.getSimpleName().substring(2, 6));
	}
	...
	public static String genFieldSave() {
		return UtilMetadata.genFieldSave("2|3|4|5", ER2129PosReReasu0102.getObjects());
	}
