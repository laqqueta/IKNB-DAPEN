...
public enum ER2104PosRbReasu0201 implements IObject<KeyValueString> {
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER2104PosRbReasu0201 eEnum : ER2104PosRbReasu0201.values()) {
	...
	public static String getName() {
		return ER2104PosRbReasu0201.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER2104PosRbReasu0201.class.getSimpleName().substring(2, 6));
	}
