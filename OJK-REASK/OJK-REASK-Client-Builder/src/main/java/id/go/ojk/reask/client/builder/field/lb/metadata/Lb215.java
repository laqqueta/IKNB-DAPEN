...
import id.go.ojk.reask.client.builder.field.lb.reference.ER3052PosLbReask215;
...
public class Lb215 extends BaseMetadata {
	...
	public SubmissionFormat get() {
		...
		SubmissionFormat res = new SubmissionFormat(eEnum.getCode(), eEnum.getName(), reportCode, new ArrayList<>(),
				extension, 6, 6, ER3052PosLbReask215.genFieldSave(), null, ER3052PosLbReask215.getRequiredPos());
		res.addSegmentValidations(ER3052PosLbReask215.genValidationNumericNegatif());
		res.addSegmentValidations(ER3052PosLbReask215.genValidationNumericDotNegatif());
		res.addSegmentValidations(ER3052PosLbReask215.genValidationTotalBiayaDiklat());
		res.addSegmentValidations(ER3052PosLbReask215.genValidationRasioBiayaDiklat());
