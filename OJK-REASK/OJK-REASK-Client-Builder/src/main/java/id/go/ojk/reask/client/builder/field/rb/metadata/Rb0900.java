...
import id.go.ojk.reask.client.builder.field.rb.reference.ER2008PosRbReask0900;
...
public class Rb0900 extends BaseMetadata {
	...
	public SubmissionFormat get() {
		...
		fs.add(sf(3, null, "Waktu Pelaksanaan",
				sv(C, 0, 1000, all).confConditionalRequired(ER2008PosRbReask0900.genConditionalField())));
		fs.add(sf(4, null, "Lokasi",
				sv(C, 0, 1000, all).confConditionalRequired(ER2008PosRbReask0900.genConditionalField())));
		fs.add(sf(5, null, "Perkiraan Investasi/Biaya",
				sv(C, 0, 16, numeric).confConditionalRequired(ER2008PosRbReask0900.genConditionalField())));
