...
import id.go.ojk.reask.client.builder.field.lb.reference.ER3064PosLbReask622;
...
public class Lb622 extends BaseMetadata {
	...
	public SubmissionFormat get() {
		...
		SubmissionFormat res = new SubmissionFormat(eEnum.getCode(), eEnum.getName(), reportCode, new ArrayList<>(),
				extension, 9, 9, ER3064PosLbReask622.genFieldSave(), null, ER3064PosLbReask622.getRequiredPos());
		res.addSegmentValidations(ER3064PosLbReask622.genValidationBadanUsahaSelainBank());
		res.addSegmentValidations(ER3064PosLbReask622.genValidationTenagaPemasar());
		...
		fs.add(sf(3, null, "Kategori Pemasar Badan Hukum",
				sv(C, 1, 50, all).confConditionalRequired(ER3064PosLbReask622.genConditionField3())));
		fs.add(sf(4, null, "Jumlah Pemasar Badan Hukum",
				sv(C, 1, 16, numeric).confConditionalRequired(ER3064PosLbReask622.genConditionField4())));
