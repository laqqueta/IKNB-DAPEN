...
import id.go.ojk.reask.client.builder.field.lb.reference.ER3044PosLbReask118;
...
public class Lb118 extends BaseMetadata {
	...
	public SubmissionFormat get() {
		...
		SubmissionFormat res = new SubmissionFormat(eEnum.getCode(), eEnum.getName(), reportCode, new ArrayList<>(),
				extension, 5, 5, ER3044PosLbReask118.genFieldSave(), null, ER3044PosLbReask118.getRequiredPos());
		res.addSegmentValidations(ER3044PosLbReask118.genValidationKlaimPenebusanUnit());
		...
		fs.add(sf(5, null, "Jumlah", sv(M, 1, 16, numericNegatif))
				.addFieldValidations(ER3044PosLbReask118.genFieldValidation5()));
		return res;
	}
}
