...
public enum ER3009PosLbReask500 implements IObject<KeyValueString> {
//	R_7000000000 ("7000000000", "Tingkat Solvabilitas"),
	R_7100000000 ("7100000000", "Aset Yang Diperkenankan"),
	R_7200000000 ("7200000000", "Liabilitas (kecuali Pinjaman Subordinasi)"),
	R_7000000099 ("7000000099", "Jumlah Tingkat Solvabilitas"),
...
//	R_7301000099 ("7301000099", "Risiko Kredit"),
	...
	R_7301000099 ("7301000099", "Jumlah Risiko Kredit"),
	R_7302000000 ("7302000000", "Risiko Likuiditas"),
//	R_7303000000 ("7303000000", "Risiko Pasar"),
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER3009PosLbReask500 eEnum : ER3009PosLbReask500.values()) {
	...
	public static SegmentValidation genValidationTingkatSovabilitas() {
		return UtilSegmentValidation.genEqualsFormula("3|4|5", R_7000000099.key, 
	...
	public static SegmentValidation genValidationResikoKredit() {
		return UtilSegmentValidation.genEqualsFormula("3|4|5", R_7301000099.key, 
				R_7301010000.key + "+" + R_7301020000.key,
				"Jumlah resiko kredit|Penjumlahan resiko kredit");
	}

	public static SegmentValidation genValidationResikoPasar() {
		return UtilSegmentValidation.genEqualsFormula("3|4|5", R_7303000099.key, 
				UtilMetadata.genPlusRow(getObjects(), 7, 9),
				"Jumlah resiko pasar|Penjumlahan resiko pasar");
	}

	public static SegmentValidation genValidationMbbr() {
		return UtilSegmentValidation.genEqualsFormula("3|4|5", R_7300000099.key, 
	...
	public static SegmentValidation genValidationPencapaianSolvabilitas() {
		return UtilSegmentValidation.genEqualsRatio("5", R_7000000098.key, 
				R_7000000099.key + "|" + R_7300000099.key,
	...
	public static SegmentValidation genValidationNumericDotNegative1() {
		return UtilSegmentValidation.genRegexNumericDotNegative("5", R_7000000098.key);
	}
	...
	public static SegmentValidation genValidationNumericDotNegativeLength3() {
		return UtilSegmentValidation.genMaxLength("3|4|5", 
				UtilMetadata.genPipeRow(getObjects(), new int[] { 15, 18, 19 }), 6);
	}
}
