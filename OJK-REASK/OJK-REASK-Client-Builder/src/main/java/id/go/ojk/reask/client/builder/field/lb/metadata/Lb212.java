...
import id.go.ojk.reask.client.builder.field.lb.reference.ER3048PosLbReask212;
...
public class Lb212 extends BaseMetadata {
	...
	public SubmissionFormat get() {
		...
		SubmissionFormat res = new SubmissionFormat(eEnum.getCode(), eEnum.getName(), reportCode, new ArrayList<>(),
				extension, 24, 24, ER3048PosLbReask212.genFieldSave(), null, ER3048PosLbReask212.getRequiredPos());
		res.addSegmentValidations(ER3048PosLbReask212.genValidationTotal());
