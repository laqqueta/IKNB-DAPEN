...
public enum ER2119PosRbReasu1201 implements IObject<KeyValueString> {
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER2119PosRbReasu1201 eEnum : ER2119PosRbReasu1201.values()) {
	...
	public static String getName() {
		return ER2119PosRbReasu1201.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER2119PosRbReasu1201.class.getSimpleName().substring(2, 6));
	}
