...
public enum ER2112PosRbReasu0701 implements IObject<KeyValueString> {
	R_0701010000 ("0701010000", "POSISI MODAL"),
//	R_0701020000 ("0701020000", "Pemegang Saham "),
	R_0701020100 ("0701020100", "Pemegang Saham"),
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER2112PosRbReasu0701 eEnum : ER2112PosRbReasu0701.values()) {
	...
	public static String getName() {
		return ER2112PosRbReasu0701.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER2112PosRbReasu0701.class.getSimpleName().substring(2, 6));
	}
