...
import id.go.ojk.reask.client.builder.field.sa.reference.ER4010PosSaReask0210;
...
public class Sa0210 extends BaseMetadata {
	...
	public SubmissionFormat get() {
		...
		SubmissionFormat res = new SubmissionFormat(eEnum.getCode(), eEnum.getName(), reportCode, new ArrayList<>(),
				extension, 4, 4, null, ER4010PosSaReask0210.genFieldSave(), ER4010PosSaReask0210.getRequiredPos());
		res.addSegmentValidations(ER4010PosSaReask0210.genValidationNumeric());
		res.addSegmentValidations(ER4010PosSaReask0210.genValidationMaxLengthNumeric());
		res.addSegmentValidations(ER4010PosSaReask0210.genValidationPeringkat());
