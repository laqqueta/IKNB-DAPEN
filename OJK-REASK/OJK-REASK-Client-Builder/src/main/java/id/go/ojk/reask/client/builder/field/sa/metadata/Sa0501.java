...
import id.go.ojk.reask.client.builder.field.sa.reference.ER4014PosSaReask0501;
...
public class Sa0501 extends BaseMetadata {
	...
	public SubmissionFormat get() {
		...
		SubmissionFormat res = new SubmissionFormat(eEnum.getCode(), eEnum.getName(), reportCode, new ArrayList<>(),
				extension, 6, 6, null, null, ER4014PosSaReask0501.getRequiredPos());
		...
		fs.add(sf(2, null, "Peringkat - Individu", sv(M, 1, 1, numeric))
				.addFieldValidations(ER4014PosSaReask0501.genValidationPeringkat()));
