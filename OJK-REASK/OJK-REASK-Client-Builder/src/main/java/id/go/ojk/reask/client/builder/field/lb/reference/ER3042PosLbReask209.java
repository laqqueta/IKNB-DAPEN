...
public enum ER3042PosLbReask209 implements IObject<KeyValueString> {
...
//	R_4401030099 ("4401030099", "Premi Top Up"),
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER3042PosLbReask209 eEnum : ER3042PosLbReask209.values()) {
	...
	public static FieldValidation genFieldValidation5() {
		return UtilFieldValidation.genEqualsPosFormula("3+4", UtilMetadata.genPipeRow(getObjects(), new int[] { 0, 1, 3, 5, 6, 8, 9 }));
	}
