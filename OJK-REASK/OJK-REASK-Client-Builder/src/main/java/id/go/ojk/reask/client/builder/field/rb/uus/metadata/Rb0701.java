...
import id.go.ojk.reask.client.builder.field.rb.uus.reference.ER2112PosRbReasu0701;
...
public class Rb0701 extends BaseMetadata {
	...
	public SubmissionFormat get() {
		...
		SubmissionFormat res = new SubmissionFormat(eEnum.getCode(), eEnum.getName(), reportCode, new ArrayList<>(),
				extension, 4, null, ER2112PosRbReasu0701.genFieldSave(), null, ER2112PosRbReasu0701.getRequiredPos());
		res.addSegmentValidations(ER2112PosRbReasu0701.genValidationTotalModalDisetor());
		List<SubmissionField> fs = res.getFields();
		fs.add(sf(0, null, "Flag Detail", sv(M, 3, 3, alfaNumeric).confConstant("D01")));
		fs.add(sf(1, null, "Kode Komponen / Baris",
				sv(M, 10, 10, refTable).confReference(EHeaderMetadataRbUus.R2112_RB0701.getObject())));
		fs.add(sf(2, null, "Nama Pemegang Saham",
				sv(C, 0, 300, all).confConditionalRequired(ER2112PosRbReasu0701.genConditionalField2())));
		fs.add(sf(3, null, "Uraian Lainnya",
				sv(C, 0, 200, all).confConditionalRequired(ER2112PosRbReasu0701.genConditionalField3())));
