...
public enum ER3056PosLbReask604 implements IObject<KeyValueString> {
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER3056PosLbReask604 eEnum : ER3056PosLbReask604.values()) {
	...
	private static String getLookup() {
		...
		ER3056PosLbReask604[] eEnums = ER3056PosLbReask604.values();
		int enumLength = eEnums.length;
		for (int i= 0; i < enumLength; i++) {
			ER3056PosLbReask604 eEnum = ER3056PosLbReask604.values()[i];
