...
public enum ER2250PosReReask0100 implements IObject<KeyValueString> {
...
//	R_3000000099 ("3000000099", "Ekuitas"),
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER2250PosReReask0100 eEnum : ER2250PosReReask0100.values()) {
	...
	public static String getName() {
		return ER2250PosReReask0100.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER2250PosReReask0100.class.getSimpleName().substring(2, 6));
	}
