...
import id.go.ojk.reask.client.builder.field.lb.reference.ER3035PosLbReask204;
...
public class Lb204 extends BaseMetadata {
	...
	public SubmissionFormat get() {
		...
		SubmissionFormat res = new SubmissionFormat(eEnum.getCode(), eEnum.getName(), reportCode, new ArrayList<>(),
				extension, 24, 24, ER3035PosLbReask204.genFieldSave(), null, ER3035PosLbReask204.getRequiredPos());
		res.addSegmentValidations(ER3035PosLbReask204.genValidationJumlahPenurunanCadanganPremiGross());
		res.addSegmentValidations(ER3035PosLbReask204.genValidationJumlahPenurunanAsetReasuransiAtasCadanganKlaim());
		res.addSegmentValidations(ER3035PosLbReask204.genValidationJumlahPenurunanCadanganPremi());
		res.addSegmentValidations(ER3035PosLbReask204.genValidationJumlahPenurunanCAPYBMPGross());
		res.addSegmentValidations(ER3035PosLbReask204.genValidationJumlahPenurunanAsetReasuransiAtasCAPYBMP());
		res.addSegmentValidations(ER3035PosLbReask204.genValidationJumlahPenurunanCAPYBMP());
		res.addSegmentValidations(ER3035PosLbReask204.genValidationJumlahPenurunanCadanganatasRisikoBencanaNetto());
		res.addSegmentValidations(ER3035PosLbReask204.genValidationJumlahPenurunanCadanganKlaimGross());
		res.addSegmentValidations(ER3035PosLbReask204.genValidationJumlahPenurunanAsetReasuransiAtasCadanganPremi());
		res.addSegmentValidations(ER3035PosLbReask204.genValidationJumlahPenurunanCadanganKlaim());
		...
		fs.add(sf(18, null, "Jumlah", sv(M, 1, 16, numericNegatif))
				.addFieldValidations(ER3035PosLbReask204.genFieldValidation5()));
		return res;
	}
}
