...
public enum ER2134PosReReasu0401 implements IObject<KeyValueString> {
...
//	R_04010204000000 ("04010204000000", "D.   Rasio Aset Unit Syariah"),
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER2134PosReReasu0401 eEnum : ER2134PosReReasu0401.values()) {
	...
	public static String getName() {
		return ER2134PosReReasu0401.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER2134PosReReasu0401.class.getSimpleName().substring(2, 6));
	}
