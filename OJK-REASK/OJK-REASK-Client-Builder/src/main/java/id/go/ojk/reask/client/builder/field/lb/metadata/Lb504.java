...
import id.go.ojk.reask.client.builder.field.lb.reference.ER3013PosLbReask504;
...
public class Lb504 extends BaseMetadata {
	...
	public SubmissionFormat get() {
		...
		SubmissionFormat res = new SubmissionFormat(eEnum.getCode(), eEnum.getName(), reportCode, new ArrayList<>(),
				extension, 24, 24, ER3013PosLbReask504.genFieldSave(), null, ER3013PosLbReask504.getRequiredPos());
		res.addSegmentValidations(ER3013PosLbReask504.genValidationTotal());
		...
		fs.add(sf(2, null, "Faktor",
				sv(C, 1, 10, all).confConditionalRequired(ER3013PosLbReask504.genConditionMustEmpty2()))
				.addFieldValidations(ER3013PosLbReask504.genFieldValidation2()));
		...
		fs.add(sf(4, null, "Tradisional - Jumlah Deviasi", sv(M, 1, 16, numericNegatif))
				.addFieldValidations(ER3013PosLbReask504.genFieldValidation4()));
		fs.add(sf(5, null, "PAYDI (Guaranteed) - Jumlah AYD",
				sv(C, 1, 16, numericNegatif).confConditionalRequired(ER3013PosLbReask504.genConditionMustEmpty56())));
		fs.add(sf(6, null, "PAYDI (Guaranteed) - Jumlah Deviasi",
				sv(C, 1, 16, numericNegatif).confConditionalRequired(ER3013PosLbReask504.genConditionMustEmpty56()))
				.addFieldValidations(ER3013PosLbReask504.genFieldValidation6()));
		fs.add(sf(7, null, "Total Deviasi", sv(M, 1, 16, numericNegatif))
				.addFieldValidations(ER3013PosLbReask504.genFieldValidation7a())
				.addFieldValidations(ER3013PosLbReask504.genFieldValidation7b()));
		return res;
	}
}
