...
public enum ER2127PosRbReasu1302 implements IObject<KeyValueString> {
...
//	R_13020207000000 ("13020207000000", "7. Penghitungan Qardh yang Diperlukan Dana Tanahud"),
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER2127PosRbReasu1302 eEnum : ER2127PosRbReasu1302.values()) {
	...
	public static String getName() {
		return ER2127PosRbReasu1302.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER2127PosRbReasu1302.class.getSimpleName().substring(2, 6));
	}
