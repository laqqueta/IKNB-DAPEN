...
import id.go.ojk.reask.client.builder.field.lb.reference.ER3014PosLbReask505;
...
public class Lb505 extends BaseMetadata {
	...
	public SubmissionFormat get() {
		...
		SubmissionFormat res = new SubmissionFormat(eEnum.getCode(), eEnum.getName(), reportCode, new ArrayList<>(),
				extension, 50, 50, ER3014PosLbReask505.genFieldSave(), null, ER3014PosLbReask505.getRequiredPos());
		res.addSegmentValidations(ER3014PosLbReask505.genValidationNumericNegatif());
		res.addSegmentValidations(ER3014PosLbReask505.genValidationNumericDotNegatif());
		res.addSegmentValidations(ER3014PosLbReask505.genValidationJumlahAsetYangDiperkenankan());
		res.addSegmentValidations(ER3014PosLbReask505.genValidationJumlahLiabilitas());
		res.addSegmentValidations(ER3014PosLbReask505.genValidationJumlahAsetYangDiperkenankanDalamRupiah());
		res.addSegmentValidations(ER3014PosLbReask505.genValidationJumlahLiabilitasDalamRupiah());
		res.addSegmentValidations(ER3014PosLbReask505.genValidationSelisihAsetYangDiperkenankanAtasLiabilitas());
		res.addSegmentValidations(ER3014PosLbReask505.genValidationFaktorSeMmbr2017());
		res.addSegmentValidations(ER3014PosLbReask505.genValidationDeviationFaktorSeMmbr2017());
		...
		fs.add(sf(29, null, "Kode Mata Uang",
				sv(M, 1, 3, refTable).confReference(EHeaderMetadataShared.R016.getObject()))
				.addFieldValidations(ER3014PosLbReask505.genFieldValidationUniqueToOther("2|5|8|11|14|17|20|23|26")));
		...
		fs.add(sf(32, null, "Kode Mata Uang",
				sv(M, 1, 3, refTable).confReference(EHeaderMetadataShared.R016.getObject())).addFieldValidations(
						ER3014PosLbReask505.genFieldValidationUniqueToOther("2|5|8|11|14|17|20|23|26|29")));
		...
		fs.add(sf(35, null, "Kode Mata Uang",
				sv(M, 1, 3, refTable).confReference(EHeaderMetadataShared.R016.getObject())).addFieldValidations(
						ER3014PosLbReask505.genFieldValidationUniqueToOther("2|5|8|11|14|17|20|23|26|29|32")));
		...
		fs.add(sf(38, null, "Kode Mata Uang",
				sv(M, 1, 3, refTable).confReference(EHeaderMetadataShared.R016.getObject())).addFieldValidations(
						ER3014PosLbReask505.genFieldValidationUniqueToOther("2|5|8|11|14|17|20|23|26|29|32|35")));
		...
		fs.add(sf(41, null, "Kode Mata Uang",
				sv(M, 1, 3, refTable).confReference(EHeaderMetadataShared.R016.getObject())).addFieldValidations(
						ER3014PosLbReask505.genFieldValidationUniqueToOther("2|5|8|11|14|17|20|23|26|29|32|35|38")));
		...
		fs.add(sf(44, null, "Kode Mata Uang",
				sv(M, 1, 3, refTable).confReference(EHeaderMetadataShared.R016.getObject())).addFieldValidations(
						ER3014PosLbReask505.genFieldValidationUniqueToOther("2|5|8|11|14|17|20|23|26|29|32|35|38|41")));
		...
		fs.add(sf(47, null, "Kode Mata Uang",
				sv(M, 1, 3, refTable).confReference(EHeaderMetadataShared.R016.getObject()))
				.addFieldValidations(ER3014PosLbReask505
		...
		fs.add(sf(56, null, "Kode Mata Uang",
				sv(M, 1, 3, refTable).confReference(EHeaderMetadataShared.R016.getObject()))
				.addFieldValidations(ER3014PosLbReask505
						.genFieldValidationUniqueToOther("2|5|8|11|14|17|20|23|26|29|32|35|38|41|44|47|50|53")));
		...
		fs.add(sf(62, null, "Jumlah-Tradisional",
				sv(C, 1, 16, all).confConditionalRequired(ER3014PosLbReask505.genConditionMustEmpty62_63()))
				.addFieldValidations(ER3014PosLbReask505.genFieldValidation62()));
		fs.add(sf(63, null, "Jumlah-PAYDI",
				sv(C, 1, 16, all).confConditionalRequired(ER3014PosLbReask505.genConditionMustEmpty62_63()))
				.addFieldValidations(ER3014PosLbReask505.genFieldValidation63()));
		return res;
	}
}
