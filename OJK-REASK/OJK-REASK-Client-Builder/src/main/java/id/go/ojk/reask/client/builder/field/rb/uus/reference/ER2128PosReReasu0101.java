...
public enum ER2128PosReReasu0101 implements IObject<KeyValueString> {
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER2128PosReReasu0101 eEnum : ER2128PosReReasu0101.values()) {
	...
	public static String getName() {
		return ER2128PosReReasu0101.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER2128PosReReasu0101.class.getSimpleName().substring(2, 6));
	}
