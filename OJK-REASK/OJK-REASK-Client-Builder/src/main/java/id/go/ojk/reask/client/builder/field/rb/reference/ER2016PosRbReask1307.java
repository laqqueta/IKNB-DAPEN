...
public enum ER2016PosRbReask1307 implements IObject<KeyValueString> {
...
//	R_1501040298 ("1501040298", "Arus Kas Keluar"),
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER2016PosRbReask1307 eEnum : ER2016PosRbReask1307.values()) {
	...
	public static String getName() {
		return ER2016PosRbReask1307.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER2016PosRbReask1307.class.getSimpleName().substring(2, 6));
	}
