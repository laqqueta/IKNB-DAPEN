...
import id.go.ojk.reask.client.builder.field.lb.reference.ER3020PosLbReask103;
...
public class Lb103 extends BaseMetadata {
	...
	public SubmissionFormat get() {
		...
		SubmissionFormat res = new SubmissionFormat(eEnum.getCode(), eEnum.getName(), reportCode, new ArrayList<>(),
				extension, 1, null, ER3020PosLbReask103.genFieldSave(), null, ER3020PosLbReask103.getRequiredPos());
		res.addSegmentValidations(ER3020PosLbReask103.genValidationTotal());
		...
		fs.add(sf(2, null, "Penempatan Pada Perusahaan-Nama Perusahaan",
				sv(C, 1, 100, all).confConditionalRequired(ER3020PosLbReask103.genConditional2())));
		fs.add(sf(3, null, "Penempatan Pada Perusahaan-Jenis Investasi",
				sv(C, 1, 3, refTable).confReference(EHeaderMetadataShared.R001.getObject())
						.confConditionalRequired(ER3020PosLbReask103.genConditionalField3())));
		fs.add(sf(4, null, "Tradisional-AYD Setelah Batasan Per Jenis Investasi dan Investasi di Luar negeri",
				sv(C, 1, 16, numericNegatif).confConditionalRequired(ER3020PosLbReask103.genConditionalField())));
