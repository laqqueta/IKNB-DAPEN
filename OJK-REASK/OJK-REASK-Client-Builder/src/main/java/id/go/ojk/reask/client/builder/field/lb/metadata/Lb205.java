...
import id.go.ojk.reask.client.builder.field.lb.reference.ER3036PosLbReask205;
...
public class Lb205 extends BaseMetadata {
	...
	public SubmissionFormat get() {
		...
		SubmissionFormat res = new SubmissionFormat(eEnum.getCode(), eEnum.getName(), reportCode, new ArrayList<>(),
				extension, 49, 49, ER3036PosLbReask205.genFieldSave(), null, ER3036PosLbReask205.getRequiredPos());
		res.addSegmentValidations(ER3036PosLbReask205.genValidationPenempatanInvestasiPadaBukanAfiliasi());
		res.addSegmentValidations(ER3036PosLbReask205.genValidationPenempatanInvestasiPadaAfiliasi());
		res.addSegmentValidations(ER3036PosLbReask205.genValidationHasilInvestasiBruto());
		res.addSegmentValidations(ER3036PosLbReask205.genValidationHasilInvestasiNeto());
		res.addSegmentValidations(ER3036PosLbReask205.genFormValidationHasilInvestasiNeto());
		...
		fs.add(sf(5, null, "Total Hasil Investasi", sv(M, 1, 16, numericNegatif))
				.addFieldValidations(ER3036PosLbReask205.genFieldValidation5()));
