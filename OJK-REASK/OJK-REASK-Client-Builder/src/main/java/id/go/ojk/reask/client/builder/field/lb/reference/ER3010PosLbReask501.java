...
public enum ER3010PosLbReask501 implements IObject<KeyValueString> {
...
//	R_1507000000 ("1507000000", "Tagihan Investasi", "0.00"),
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER3010PosLbReask501 eEnum : ER3010PosLbReask501.values()) {
	...
	private static String getLookup() {
		...
		ER3010PosLbReask501[] eEnums = ER3010PosLbReask501.values();
		int enumLength = eEnums.length;
		for (int i= 0; i < enumLength; i++) {
			ER3010PosLbReask501 eEnum = ER3010PosLbReask501.values()[i];
