...
public enum ER2113PosRbReasu0901 implements IObject<KeyValueString> {
...
//	R_0901030000 ("0901030000", "C. Penutupan "),
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER2113PosRbReasu0901 eEnum : ER2113PosRbReasu0901.values()) {
	...
	public static String getName() {
		return ER2113PosRbReasu0901.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER2113PosRbReasu0901.class.getSimpleName().substring(2, 6));
	}
