...
import id.go.ojk.reask.client.builder.field.lb.reference.ER3045PosLbReask210;
...
public class Lb210 extends BaseMetadata {
	...
	public SubmissionFormat get() {
		...
		SubmissionFormat res = new SubmissionFormat(eEnum.getCode(), eEnum.getName(), reportCode, new ArrayList<>(),
				extension, 1, null, ER3045PosLbReask210.genFieldSave(), null, ER3045PosLbReask210.getRequiredPos());
		res.addSegmentValidations(ER3045PosLbReask210.genValidationTotal());
		...
		fs.add(sf(2, null, "Kode Propinsi (DATI I)",
				sv(C, 1, 6, refTable).confReference(EHeaderMetadataShared.R004.getObject())
						.confConditionalRequired(ER3045PosLbReask210.genConditionField2())));
		fs.add(sf(3, null, "Kode Kota/Kabupaten (DATI II)",
				sv(C, 1, 6, refTable).confReference(EHeaderMetadataShared.R005.getObject())
						.confConditionalRequired(ER3045PosLbReask210.genConditionField3()))
				.addFieldValidations(ER3045PosLbReask210.genFieldValidation3()));
		fs.add(sf(4, null, "Harta Benda (Property) - Jumlah (Rupiah)",
				sv(C, 1, 16, numericNegatif).confConditionalRequired(ER3045PosLbReask210.genConditionField())));
		...
		fs.add(sf(60, null, "Total Tradisional - Jumlah (Rupiah)",
				sv(C, 1, 16, numericNegatif).confConditionalRequired(ER3045PosLbReask210.genConditionField()))
				.addFieldValidations(ER3045PosLbReask210.genFieldValidation60()));
		fs.add(sf(61, null, "Total Tradisional - Jumlah Polis",
				sv(C, 1, 16, numericNegatif).confConditionalRequired(ER3045PosLbReask210.genConditionField()))
				.addFieldValidations(ER3045PosLbReask210.genFieldValidation61()));
		fs.add(sf(62, null, "Total Tradisional - Jumlah Peserta/Objek Asuransi",
				sv(C, 1, 16, numericNegatif).confConditionalRequired(ER3045PosLbReask210.genConditionField()))
				.addFieldValidations(ER3045PosLbReask210.genFieldValidation62()));
		fs.add(sf(63, null, "Total Tradisional - Jumlah Uang Pertanggungan",
				sv(C, 1, 16, numericNegatif).confConditionalRequired(ER3045PosLbReask210.genConditionField()))
				.addFieldValidations(ER3045PosLbReask210.genFieldValidation63()));
		...
		fs.add(sf(68, null, "Total - Jumlah (Rupiah)",
				sv(C, 1, 16, numericNegatif).confConditionalRequired(ER3045PosLbReask210.genConditionField()))
				.addFieldValidations(ER3045PosLbReask210.genFieldValidation68()));
		fs.add(sf(69, null, "Total - Jumlah Polis",
				sv(C, 1, 16, numericNegatif).confConditionalRequired(ER3045PosLbReask210.genConditionField()))
				.addFieldValidations(ER3045PosLbReask210.genFieldValidation69()));
		fs.add(sf(70, null, "Total - Jumlah Peserta/Objek Asuransi",
				sv(C, 1, 16, numericNegatif).confConditionalRequired(ER3045PosLbReask210.genConditionField()))
				.addFieldValidations(ER3045PosLbReask210.genFieldValidation70()));
		fs.add(sf(71, null, "Total - Jumlah Uang Pertanggungan",
				sv(C, 1, 16, numericNegatif).confConditionalRequired(ER3045PosLbReask210.genConditionField()))
				.addFieldValidations(ER3045PosLbReask210.genFieldValidation71()));
		return res;
	}
}
