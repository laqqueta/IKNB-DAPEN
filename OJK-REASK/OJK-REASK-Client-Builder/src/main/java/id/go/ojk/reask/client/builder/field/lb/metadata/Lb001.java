...
import id.go.ojk.reask.client.builder.field.lb.reference.ER3001PosLbReask001;
...
public class Lb001 extends BaseMetadata {
	...
	public SubmissionFormat get() {
		...
		SubmissionFormat res = new SubmissionFormat(eEnum.getCode(), eEnum.getName(), reportCode, new ArrayList<>(),
				extension, 1, null, ER3001PosLbReask001.genFieldSave(), null, ER3001PosLbReask001.getRequiredPos());
		res.addSegmentValidations(ER3001PosLbReask001.genValidationFixedValue());
		res.addSegmentValidations(ER3001PosLbReask001.genValidationTotal());
		...
		fs.add(sf(2, null, "Nama Pemegang Saham", sv(C, 1, 50, all).confRegex(patternCompanyName.c())
				.confConditionalRequired(ER3001PosLbReask001.genConditionalExistPos())));
