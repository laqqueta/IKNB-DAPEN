...
import id.go.ojk.reask.client.builder.field.rb.reference.ER2013PosRbReask1006;
...
public class Rb1006 extends BaseMetadata {
	...
	public SubmissionFormat get() {
		...
		fs.add(sf(3, null, "Kepemilikan (inhouse/ vendor)",
				sv(C, 0, 1000, all).confConditionalRequired(ER2013PosRbReask1006.genConditionalField())));
