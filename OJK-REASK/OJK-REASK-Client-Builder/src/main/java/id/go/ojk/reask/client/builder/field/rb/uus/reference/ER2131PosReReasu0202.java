...
public enum ER2131PosReReasu0202 implements IObject<KeyValueString> {
...
//	R_02020201010000 ("02020201010000", "Beban Klaim"),
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER2131PosReReasu0202 eEnum : ER2131PosReReasu0202.values()) {
	...
	public static String getName() {
		return ER2131PosReReasu0202.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER2131PosReReasu0202.class.getSimpleName().substring(2, 6));
	}
	...
	public static String genFieldSave() {
		return UtilMetadata.genFieldSave("2|3", ER2131PosReReasu0202.getObjects());
	}
