...
public enum ER2000PosRbReask0104 implements IObject<KeyValueString> {
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER2000PosRbReask0104 eEnum : ER2000PosRbReask0104.values()) {
	...
	public static String getName() {
		return ER2000PosRbReask0104.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER2000PosRbReask0104.class.getSimpleName().substring(2, 6));
	}
