...
import id.go.ojk.reask.client.builder.field.rb.reference.ER2012PosRbReask1005;
...
public class Rb1005 extends BaseMetadata {
	...
	public SubmissionFormat get() {
		...
		fs.add(sf(3, null, "Alasan Pemanfaatan Tenaga Alih Daya",
				sv(C, 0, 1000, all).confConditionalRequired(ER2012PosRbReask1005.genConditionalField())));
		fs.add(sf(4, null, "Jumlah Tenaga Kerja Alih Daya",
				sv(C, 0, 10, numeric).confConditionalRequired(ER2012PosRbReask1005.genConditionalField())));
