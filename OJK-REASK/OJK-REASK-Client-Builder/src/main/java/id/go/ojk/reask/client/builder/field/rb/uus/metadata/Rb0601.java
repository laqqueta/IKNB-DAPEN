...
import id.go.ojk.reask.client.builder.field.rb.uus.reference.ER2108PosRbReasu0601;
...
public class Rb0601 extends BaseMetadata {
	...
	public SubmissionFormat get() {
		...
		fs.add(sf(1, null, "Kode Komponen / Baris",
				sv(M, 10, 10, refTable).confReference(EHeaderMetadataRbUus.R2108_RB0601.getObject())));
		...
		fs.add(sf(3, null, "Aktual per 30 Sept 20XX-1",
				sv(C, 0, 16, numericNegatif).confConditionalRequired(ER2108PosRbReasu0601.genConditionalField())));
