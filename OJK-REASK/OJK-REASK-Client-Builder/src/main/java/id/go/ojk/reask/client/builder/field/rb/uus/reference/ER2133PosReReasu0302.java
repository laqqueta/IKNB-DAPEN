...
public enum ER2133PosReReasu0302 implements IObject<KeyValueString> {
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER2133PosReReasu0302 eEnum : ER2133PosReReasu0302.values()) {
	...
	public static String getName() {
		return ER2133PosReReasu0302.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER2133PosReReasu0302.class.getSimpleName().substring(2, 6));
	}
