...
import id.go.ojk.reask.client.builder.field.rb.reference.ER2002PosRbReask0201;
...
public class Rb0201 extends BaseMetadata {
	...
	public SubmissionFormat get() {
		...
		SubmissionFormat res = new SubmissionFormat(eEnum.getCode(), eEnum.getName(), reportCode, new ArrayList<>(),
				extension, 9, null, null, null, ER2002PosRbReask0201.getRequiredPos());
		...
		fs.add(sf(2, null, "Nama Indikator Lain",
				sv(C, 0, 200, all).confConditionalRequired(ER2002PosRbReask0201.genConditionalField2())));
		...
		fs.add(sf(5, null, "%", sv(M, 1, 16, numericDotNegatif))
				.addFieldValidations(ER2002PosRbReask0201.genFieldValidationRatio()));
		return res;
	}
}
