...
public enum ER3050PosLbReask601 implements IObject<KeyValueString> {
...
//	R_7011000099 ("7011000099", "Pertumbuhan(delta) Klaim "),
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER3050PosLbReask601 eEnum : ER3050PosLbReask601.values()) {
	...
	public static SegmentValidation genValidationTotalRasio123() {
		return UtilSegmentValidation.genEqualsFormula("2", R_7004000000.key, 
				UtilMetadata.genPlusRow(getObjects(), 14, 16), "Total rasio|Penjumlahan rasio I,  rasio II, rasio III");
	}
