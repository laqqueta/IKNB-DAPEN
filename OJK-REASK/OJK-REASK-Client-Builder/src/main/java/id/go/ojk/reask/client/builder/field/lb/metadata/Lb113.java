...
import id.go.ojk.reask.client.builder.field.lb.reference.ER3029PosLbReask113;
...
public class Lb113 extends BaseMetadata {
	...
	public SubmissionFormat get() {
		...
		SubmissionFormat res = new SubmissionFormat(eEnum.getCode(), eEnum.getName(), reportCode, new ArrayList<>(),
				extension, 17, 17, ER3029PosLbReask113.genFieldSave(), ER3029PosLbReask113.genFieldSave(),
				ER3029PosLbReask113.getRequiredPos());
		res.addSegmentValidations(ER3029PosLbReask113.genValidationTotal());
		...
		fs.add(sf(5, null, "Jumlah Cadangan Klaim", sv(M, 1, 16, numericNegatif))
				.addFieldValidations(ER3029PosLbReask113.genFieldValidation5()));
		return res;
	}
}
