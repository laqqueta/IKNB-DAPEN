...
import id.go.ojk.reask.client.builder.field.lb.reference.ER3057PosLbReask619;
...
public class Lb619 extends BaseMetadata {
	...
	public SubmissionFormat get() {
		...
		SubmissionFormat res = new SubmissionFormat(eEnum.getCode(), eEnum.getName(), reportCode, new ArrayList<>(),
				extension, 17, 17, ER3057PosLbReask619.genFieldSave(), null, ER3057PosLbReask619.getRequiredPos());
		res.addSegmentValidations(ER3057PosLbReask619.genValidationTotal());
