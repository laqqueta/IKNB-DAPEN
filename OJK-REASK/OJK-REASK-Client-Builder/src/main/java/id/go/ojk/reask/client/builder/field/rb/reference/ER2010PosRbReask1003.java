...
public enum ER2010PosRbReask1003 implements IObject<KeyValueString> {
	R_1003010000 ("1003010000", "Detail"),
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER2010PosRbReask1003 eEnum : ER2010PosRbReask1003.values()) {
	...
	public static String getName() {
		return ER2010PosRbReask1003.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER2010PosRbReask1003.class.getSimpleName().substring(2, 6));
	}
	...
	public static ConditionalRequired genConditionalField7_8() {
		return UtilFieldConditional.genExistPosOrComparatorNotEmpty("N", "M", "M", R_1003020000.key, "2");
	}

	public static SegmentValidation genValidasiRencanaPelaksanaanPendidikandanPelatihanSDM() {
