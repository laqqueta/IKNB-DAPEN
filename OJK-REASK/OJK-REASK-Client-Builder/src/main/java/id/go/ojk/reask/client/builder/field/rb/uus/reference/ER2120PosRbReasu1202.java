...
public enum ER2120PosRbReasu1202 implements IObject<KeyValueString> {
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER2120PosRbReasu1202 eEnum : ER2120PosRbReasu1202.values()) {
	...
	public static String getName() {
		return ER2120PosRbReasu1202.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER2120PosRbReasu1202.class.getSimpleName().substring(2, 6));
	}
