...
import id.go.ojk.reask.client.builder.field.sa.reference.ER4015PosSaReask0502;
...
public class Sa0502 extends BaseMetadata {
	...
	public SubmissionFormat get() {
		...
		SubmissionFormat res = new SubmissionFormat(eEnum.getCode(), eEnum.getName(), reportCode, new ArrayList<>(),
				extension, 10, 10, null, null, ER4015PosSaReask0502.getRequiredPos());
		...
		fs.add(sf(2, null, "Individu - Peringkat Risiko Inheren", sv(M, 1, 1, numeric))
				.addFieldValidations(ER4015PosSaReask0502.genValidationPeringkat()));
