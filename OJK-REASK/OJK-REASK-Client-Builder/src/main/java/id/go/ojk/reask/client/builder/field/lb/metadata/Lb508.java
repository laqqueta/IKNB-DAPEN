...
import id.go.ojk.reask.client.builder.field.lb.reference.ER3017PosLbReask508;
...
public class Lb508 extends BaseMetadata {
	...
	public SubmissionFormat get() {
		...
		SubmissionFormat res = new SubmissionFormat(eEnum.getCode(), eEnum.getName(), reportCode, new ArrayList<>(),
				extension, 7, 7, ER3017PosLbReask508.genFieldSave(), null, ER3017PosLbReask508.getRequiredPos());
		res.addSegmentValidations(ER3017PosLbReask508.genValidationTotalRisikoOperasionalPerusahaan());
		res.addSegmentValidations(ER3017PosLbReask508.genValidationTotalRisikoOperasionalPAYDI());
		res.addSegmentValidations(ER3017PosLbReask508.genValidationTotalDeviasi());
