...
public enum ER2251PosReReask0200 implements IObject<KeyValueString> {
...
//	R_5702000099 ("5702000099", "b. Beban Umum dan Administrasi:"),
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER2251PosReReask0200 eEnum : ER2251PosReReask0200.values()) {
	...
	public static String getName() {
		return ER2251PosReReask0200.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER2251PosReReask0200.class.getSimpleName().substring(2, 6));
	}
	...
	public static SegmentValidation genValidationPremiBruto() {
		return UtilSegmentValidation.genEqualsFormula("2|3", R_4100000000.key, 
	...
	public static SegmentValidation genValidationPremiReasuransi() {
		return UtilSegmentValidation.genEqualsFormula("2|3", R_4200000000.key, 
				R_4201000000.key + "-" + R_4202000000.key, 
				"Total Premi Reasuransi|Penjumlahan Premi Reasuransi");
	}

	public static SegmentValidation genValidationPremiNeto() {
		return UtilSegmentValidation.genEqualsFormula("2|3", R_4300000000.key, 
				R_4100000000.key + "-" + R_4200000000.key, 
				"Total Premi Neto|Penjumlahan Premi Neto");
	}

	public static SegmentValidation genValidationPenurunanCadanganPremiCapybmp() {
	...
	public static SegmentValidation genValidationPendapatanPremiNeto() {
		return UtilSegmentValidation.genEqualsFormula("2|3", R_4500000000.key, 
	...
	public static SegmentValidation genValidationHasilUnderWriting() {
	...
	public static SegmentValidation genValidationBebanUsaha() {
		return UtilSegmentValidation.genEqualsFormula("2|3", R_5700000000.key, 
	...
	public static SegmentValidation genValidationLabaUsahaAsuransi() {
		return UtilSegmentValidation.genEqualsFormula("2|3", R_5801000000.key, 
	...
	public static SegmentValidation genValidationLabaSebelumPajak() {
		return UtilSegmentValidation.genEqualsFormula("2|3", R_5803000000.key, 
	...
	public static SegmentValidation genValidationLabaSetelahPajak() {
		return UtilSegmentValidation.genEqualsFormula("2|3", R_5805000000.key, 
	...
	public static SegmentValidation genValidationLabaKomprehensif() {
		return UtilSegmentValidation.genEqualsFormula("2|3", R_5800000000.key, 
