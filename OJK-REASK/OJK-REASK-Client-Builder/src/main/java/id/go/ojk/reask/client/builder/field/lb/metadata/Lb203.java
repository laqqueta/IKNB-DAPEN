...
import id.go.ojk.reask.client.builder.field.lb.reference.ER3034PosLbReask203;
...
public class Lb203 extends BaseMetadata {
	...
	public SubmissionFormat get() {
		...
		SubmissionFormat res = new SubmissionFormat(eEnum.getCode(), eEnum.getName(), reportCode, new ArrayList<>(),
				extension, 17, 17, ER3034PosLbReask203.genFieldSave(), null, ER3034PosLbReask203.getRequiredPos());
		res.addSegmentValidations(ER3034PosLbReask203.genValidationTotal());
		...
		fs.add(sf(5, null, "Premi Reasuransi-Total", sv(M, 1, 16, numericNegatif))
				.addFieldValidations(ER3034PosLbReask203.genFieldValidation5()));
		...
		fs.add(sf(9, null, "Komisi Reasuransi-Total", sv(M, 1, 16, numericNegatif))
				.addFieldValidations(ER3034PosLbReask203.genFieldValidation9()));
		return res;
	}
}
