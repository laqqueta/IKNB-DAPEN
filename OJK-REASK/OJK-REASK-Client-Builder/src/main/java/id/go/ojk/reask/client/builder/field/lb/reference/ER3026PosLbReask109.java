...
public enum ER3026PosLbReask109 implements IObject<KeyValueString> {
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER3026PosLbReask109 eEnum : ER3026PosLbReask109.values()) {
	...
	public static FieldValidation genFieldValidation5() {
		return UtilFieldValidation.genReferenceCondition("3", String.valueOf(EHeaderMetadataShared.R034.getNumber()));
	}
