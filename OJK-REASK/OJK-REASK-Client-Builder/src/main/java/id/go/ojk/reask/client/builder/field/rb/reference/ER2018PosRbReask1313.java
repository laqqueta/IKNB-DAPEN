...
public enum ER2018PosRbReask1313 implements IObject<KeyValueString> {
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER2018PosRbReask1313 eEnum : ER2018PosRbReask1313.values()) {
	...
	public static String getName() {
		return ER2018PosRbReask1313.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER2018PosRbReask1313.class.getSimpleName().substring(2, 6));
	}
