...
public enum ER3054PosLbReask602 implements IObject<KeyValueString> {
...
//	R_6020200099 ("6020200099", "2. Perhitungan Kecukupan Dana Jaminan Tahunan"),
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER3054PosLbReask602 eEnum : ER3054PosLbReask602.values()) {
	...
	public static SegmentValidation genValidationBatasMinimumDanaJaminanI() {
		return UtilSegmentValidation.genMultiply("2", R_6020205000.key, R_6020201000.key, ".20", "perkalian 0.2 dengan Ekuitas minimum yang dipersyaratkan");
	}
	
	public static SegmentValidation genValidationBatasMinimumDanaJaminanII() {
		return UtilSegmentValidation.genSumMultiply3("2", R_6020206000.key, R_6020202000.key, ".01", R_6020203000.key, ".0025",
				R_6020204000.key, ".02", "penjumlahan Batas Minimum Dana Jaminan II", 0);
	}
