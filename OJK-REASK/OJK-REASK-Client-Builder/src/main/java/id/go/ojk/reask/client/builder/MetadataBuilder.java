...
import id.go.ojk.reask.client.builder.field.lb.metadata.MetadataLb;
import id.go.ojk.reask.client.builder.field.rb.metadata.MetadataRb;
import id.go.ojk.reask.client.builder.field.rb.metadata.MetadataRe;
import id.go.ojk.reask.client.builder.field.rb.metadata.MetadataRp;
import id.go.ojk.reask.client.builder.field.rb.uus.metadata.MetadataRbUus;
import id.go.ojk.reask.client.builder.field.rb.uus.metadata.MetadataReUus;
import id.go.ojk.reask.client.builder.field.rb.uus.metadata.MetadataRpUus;
import id.go.ojk.reask.client.builder.field.sa.metadata.MetadataSaa;
import id.go.ojk.reask.client.builder.field.sa.metadata.MetadataSai;
import id.go.ojk.reask.client.builder.field.sa.uus.metadata.MetadataSaaUus;
import id.go.ojk.reask.client.builder.field.sa.uus.metadata.MetadataSaiUus;
