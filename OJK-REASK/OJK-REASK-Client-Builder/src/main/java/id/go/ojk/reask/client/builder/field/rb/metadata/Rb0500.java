...
import id.go.ojk.reask.client.builder.field.rb.reference.ER2004PosRbReask0500;
...
public class Rb0500 extends BaseMetadata {
	...
	public SubmissionFormat get() {
		...
		fs.add(sf(3, null, "Deskripsi Umum Kegiatan Usaha",
				sv(C, 0, 1000, all).confConditionalRequired(ER2004PosRbReask0500.genConditionalField())));
