...
public enum ER2114PosRbReasu1001 implements IObject<KeyValueString> {
	R_1001010000 ("1001010000", "SDM"),
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER2114PosRbReasu1001 eEnum : ER2114PosRbReasu1001.values()) {
	...
	public static String getName() {
		return ER2114PosRbReasu1001.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER2114PosRbReasu1001.class.getSimpleName().substring(2, 6));
	}
	...
	public static SegmentValidation genValidationTotal() {
		return UtilSegmentValidation.genEqualsFormula("3|4|5|6|7|8|9", R_1001020000.key, R_1001010000.key, "Total|Penjumlahan detail");
	}
}
