...
[Setup]
AppId=DPPKKClient
AppName=DPPKK Client
AppVersion=3.3.3
AppVerName=DPPKK-Client 3.3.3
AppPublisher=OJK
AppComments=OJK DPPKK Client
AppCopyright=Copyright (C) 2020
;AppPublisherURL=http://java.com/
;AppSupportURL=http://java.com/
;AppUpdatesURL=http://java.com/
DefaultDirName=C:\OJK-DPPKK-Client
...
[Setup]
SetupMutex=DPPKK-Client,Global\DPPKK-Client
OutputDir="..\ftp\app"

[Icons]
Name: "{group}\DPPKK-Client"; Filename: "{app}\OjkClient.exe"; IconFilename: "{app}\Client.ico"; Check: returnTrue()
Name: "{commondesktop}\DppkkClient"; Filename: "{app}\OjkClient.exe";  IconFilename: "{app}\Client.ico"; Check: returnFalse()    

[Run]
Filename: "{app}\OjkClient.exe"; Parameters: "-Xappcds:generatecache"; Check: returnFalse()
Filename: "{app}\OjkClient.exe"; Description: "{cm:LaunchProgram,DPPKKClient}"; Flags: nowait postinstall skipifsilent; Check: returnTrue()
Filename: "{app}\OjkClient.exe"; Parameters: "-install -svcName ""DPPKKClient"" -svcDesc ""DPPKKClient"" -mainExe ""OjkClient.exe""  "; Check: returnFalse()

[UninstallRun]
Filename: "{app}\OjkClient.exe "; Parameters: "-uninstall -svcName DPPKKClient -stopOnUninstall"; Check: returnFalse()
