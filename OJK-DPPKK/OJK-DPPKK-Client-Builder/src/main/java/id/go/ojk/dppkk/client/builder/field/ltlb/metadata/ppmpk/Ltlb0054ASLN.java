...
public class Ltlb0054ASLN extends BaseMetadata {
    ...
    public SubmissionFormat get() {
        ...
        fs.add(sf(2, null, "Jenis Aset Lain", sv(M, 1, 50, alfaNumeric)));
        fs.add(sf(3, null, "Tanggal Perolehan", sv(M, 8, 8, date)));
        fs.add(sf(4, null, "Tanggal Reklasifikasi menjadi Aset Lain", sv(M, 8, 8, date)));
        fs.add(sf(5, null, "Nilai Aset", sv(M, 1, 18, numeric)));
        fs.add(sf(6, null, "Pencatatan Sebelum Menjadi Aset Lain", sv(M, 1, 100, alfaNumeric)));
        fs.add(sf(7, null, "Manfaat Pensiun/Manfaat Pensiun Lainnya/Manfaat Lain", sv(M, 1, 6, alfaNumeric)));
