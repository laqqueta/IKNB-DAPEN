...
public class Ltlb0004NRC extends BaseMetadata {
    ...
    public SubmissionFormat get() {
        ...
        ER7003PosLtlbDppkNrc.getPpmpkSegmentValidations().forEach(res::addSegmentValidations);

//        res.addSegmentValidations(ENrcValidationsConfig.SG_EQUALS_FORM_FORMULA_LAN_1.toSegmentValidation());
