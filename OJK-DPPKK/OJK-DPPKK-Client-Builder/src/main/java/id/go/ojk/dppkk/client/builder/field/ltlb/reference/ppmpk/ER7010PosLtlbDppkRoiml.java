...
public enum ER7010PosLtlbDppkRoiml implements IObject<KeyValueString> {
    ...
    public static SegmentValidation genValidationSumPosColEqual() {
        return UtilSegmentValidation.genEqualsFormula(UtilMetadata.genPlusColumn(new int[] { 2, 3, 4, 5, 6, 7, 8, 10, 11}), R_ROIML2100000000.key,
                UtilMetadata.genPlusRow(getObjects(), 0, 19),
                UtilMetadata.genMessage(R_ROIML2100000000.value, UtilMetadata.genPlusRow(getObjects(), 0, 19)));
    }
}
