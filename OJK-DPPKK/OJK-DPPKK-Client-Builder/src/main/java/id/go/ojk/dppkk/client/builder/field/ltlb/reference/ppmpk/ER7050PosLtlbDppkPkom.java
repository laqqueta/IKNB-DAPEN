...
public enum ER7050PosLtlbDppkPkom implements IObject<KeyValueString> {
    ...
    public static ConditionalRequired genConditionForTotal() {
        return UtilFieldConditional.genExistPos("N", "M", R_PKOM000000.key);
    }

    public static ConditionalRequired genConditionForTotalOptional() {
        return UtilFieldConditional.genExistPos("N", "O", R_PKOM000000.key);
    }

    public static FieldValidation genFieldValidationNilaiBuku() {
        return UtilFieldValidation.genEqualsExceptPosFormula("4-5", R_PKOM000000.key);
    }

    public static SegmentValidation genValidation() {
        return UtilSegmentValidation.genEqualsFormula(UtilMetadata.genPipeColumn(4, 6), R_PKOM000000.key, R_PKOM010000.key,
