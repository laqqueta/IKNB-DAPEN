package id.go.ojk.dppkk.client.builder.field.tl.reference;
...
public enum ER5000PosTlDppkk0100 implements IObject<KeyValueString> {
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER5000PosTlDppkk0100 eEnum : ER5000PosTlDppkk0100.values()) {
	...
	public static String getName() {
		return ER5000PosTlDppkk0100.class.getSimpleName().substring(6);
	}

	public static int getRefNumber() {
		return Integer.parseInt(ER5000PosTlDppkk0100.class.getSimpleName().substring(2, 6));
	}
