...
public enum ER2100PosRbDppu0100 implements IObject<KeyValueString> {
	...
	R_0105000000 ("0105000000", "Dewan Pengawas"),
	R_0106000000 ("0106000000", "Dewan Pengawas Syariah"),
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER2100PosRbDppu0100 eEnum : ER2100PosRbDppu0100.values()) {
	...
	public static String getName() {
		return ER2100PosRbDppu0100.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER2100PosRbDppu0100.class.getSimpleName().substring(2, 6));
	}
	...
	public static String getUniquePos() {
		return UtilMetadata.genPipeRow(getObjects(), new int[] { 0, 1, 2, 6, 7 });
	}
	...
	public static SegmentValidation genValidationMaxLength100() {
		return UtilSegmentValidation.genMaxLength("2", UtilMetadata.genPipeRow(getObjects(), 3, 5), 100);
	}
	
	public static SegmentValidation genValidationMaxLength4() {
		return UtilSegmentValidation.genMaxLength("2", R_0103000000 + "|" + R_0108000000.key, 4);
	}
	
	public static SegmentValidation genValidationProgramA() {
		return UtilSegmentValidation.genFixedValue("2", R_0103000000.key, "PPIP|PPMP");
	}
	...
	public static SegmentValidation genValidationTahunRencanaBisnisA() {
		return UtilSegmentValidation.genRegexYear("2", R_0108000000.key);
	}
