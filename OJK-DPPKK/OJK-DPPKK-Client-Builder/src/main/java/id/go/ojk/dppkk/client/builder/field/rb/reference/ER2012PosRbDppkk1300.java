...
public enum ER2012PosRbDppkk1300 implements IObject<KeyValueString> {
...
//	R_1305000000 ("1305000000", "E. Penutupan Kantor"),
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER2012PosRbDppkk1300 eEnum : ER2012PosRbDppkk1300.values()) {
	...
	public static String getName() {
		return ER2012PosRbDppkk1300.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER2012PosRbDppkk1300.class.getSimpleName().substring(2, 6));
	}
