...
public enum ER2119PosReDppu0100 implements IObject<KeyValueString> {
	...
	R_0106000000 ("0105000000", "Dewan Pengawas"),
	R_0107000000 ("0106000000", "Dewan Pengawas Syariah"),
	R_0108000000 ("0107000000", "Alamat Kantor"),
	R_0109000000 ("0108000000", "Tahun Rencana Bisnis"),
	;
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER2119PosReDppu0100 eEnum : ER2119PosReDppu0100.values()) {
	...
	public static String getName() {
		return ER2119PosReDppu0100.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER2119PosReDppu0100.class.getSimpleName().substring(2, 6));
	}
	...
	public static SegmentValidation genValidationMaxLength80() {
		return UtilSegmentValidation.genMaxLength("2", R_0101000000.key + "|" + R_0102000000, 80);
	}
	
	public static SegmentValidation genValidationMaxLength100() {
		return UtilSegmentValidation.genMaxLength("2", 
				UtilMetadata.genPipeRow(getObjects(), 3, 6), 100);
	}
}
