...
public enum ER2004PosRbDppkk0500 implements IObject<KeyValueString> {
//	R_0501000000 ("0501000000", "INVESTASI"),
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER2004PosRbDppkk0500 eEnum : ER2004PosRbDppkk0500.values()) {
	...
	public static String getName() {
		return ER2004PosRbDppkk0500.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER2004PosRbDppkk0500.class.getSimpleName().substring(2, 6));
	}
