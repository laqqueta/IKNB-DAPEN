...
public class Ltlb0044PIUB extends BaseMetadata {
    ...
    public SubmissionFormat get() {
        ...
        fs.add(sf(3, null, "Piutang Bunga Iuran Peserta", sv(M, 1, 18, numeric)));
        fs.add(sf(4, null, "Piutang Bunga Iuran Pemberi Kerja", sv(M, 1, 18, numeric)));
        fs.add(sf(5, null, "Piutang Bunga Iuran Tambahan", sv(M, 1, 18, numeric)));
