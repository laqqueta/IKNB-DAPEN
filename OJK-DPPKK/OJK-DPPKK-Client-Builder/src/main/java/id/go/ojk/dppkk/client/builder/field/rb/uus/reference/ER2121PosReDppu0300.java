...
public enum ER2121PosReDppu0300 implements IObject<KeyValueString> {
...
//	R_0303000000 ("0303000000", "PENGURANGAN"),
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER2121PosReDppu0300 eEnum : ER2121PosReDppu0300.values()) {
	...
	public static String getName() {
		return ER2121PosReDppu0300.class.getSimpleName().substring(6);
	}

	public static int getRefNumber() {
		return Integer.parseInt(ER2121PosReDppu0300.class.getSimpleName().substring(2, 6));
	}
	...
	public static SegmentValidation genValidationPenambahan() {
		int[] fields = new int[] { 5, 6, 7, 12, 13 };
		return UtilSegmentValidation.genEqualsFormula("2|3", R_0302000000.key,
				UtilMetadata.genPlusRow(getObjects(), fields), "Total Penambahan|Penjumlahan Penambahan");
	}
