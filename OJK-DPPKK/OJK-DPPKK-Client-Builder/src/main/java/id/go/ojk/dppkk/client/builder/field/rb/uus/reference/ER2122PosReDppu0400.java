...
public enum ER2122PosReDppu0400 implements IObject<KeyValueString> {
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER2122PosReDppu0400 eEnum : ER2122PosReDppu0400.values()) {
	...
	public static String getName() {
		return ER2122PosReDppu0400.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER2122PosReDppu0400.class.getSimpleName().substring(2, 6));
	}
