...
import id.go.ojk.dppkk.client.builder.field.rb.uus.reference.ER2115PosRbDppu1004;
...
public class Rb1004 extends BaseMetadata {
	...
	public SubmissionFormat get() {
		...
		fs.add(sf(1, null, "Kode Komponen / Baris",
				sv(M, 10, 10, refTable).confReference(EHeaderMetadataRbUus.R2115_RB1004.getObject())));
		fs.add(sf(2, null, "Jenis/ Nama Aplikasi", sv(O, 0, 300, all)));
		fs.add(sf(3, null, "Kepemilikan (inhouse/ vendor)",
				sv(C, 1, 50, all).confConditionalRequired(ER2115PosRbDppu1004.genConditionalAllExist())));
		fs.add(sf(4, null, "Nama Vendor",
				sv(C, 1, 300, all).confConditionalRequired(ER2115PosRbDppu1004.genConditionalAllExist())));
