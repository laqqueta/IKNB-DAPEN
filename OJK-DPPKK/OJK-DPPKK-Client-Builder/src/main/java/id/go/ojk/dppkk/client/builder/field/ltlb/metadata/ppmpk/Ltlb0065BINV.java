...
public class Ltlb0065BINV extends BaseMetadata {

    public Ltlb0065BINV(String reportCode) {
    ...
    public SubmissionFormat get() {
        ...
        EFormLaporanTahunanLaporanBulanan eNum = EFormLaporanTahunanLaporanBulanan.LTLB_BINV;
        ...
        fs.add(sf(5, null, "Keterangan",
                sv(C, 1, 250, freeText)
                        .confConditionalRequired(ER7064PosLtlbDppkBinv.genConditionForTotalOptional())));
