...
import id.go.ojk.dppkk.client.builder.field.ltlb.reference.ppmpk.ER7066PosLtlbDppkBipr;
...
public class Ltlb0067BIPR extends BaseMetadata {

    public Ltlb0067BIPR(String reportCode) {
    ...
    public SubmissionFormat get() {
        ...
        EFormLaporanTahunanLaporanBulanan eNum = EFormLaporanTahunanLaporanBulanan.LTLB_BIPR;
        ...
        fs.add(sf(5, null, "Keterangan",
                sv(C, 1, 250, freeText)
                        .confConditionalRequired(ER7066PosLtlbDppkBipr.genConditionForTotalOptional())));
