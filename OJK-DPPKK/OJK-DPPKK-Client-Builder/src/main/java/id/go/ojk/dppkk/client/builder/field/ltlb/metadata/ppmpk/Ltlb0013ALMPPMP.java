...
public class Ltlb0013ALMPPMP extends BaseMetadata {
    ...
    public SubmissionFormat get() {
        ...
        fs.add(sf(4, null, "Jatuh tempo < 1 tahun - Total", sv(M, 1, 18, numeric)));
        ...
        fs.add(sf(7, null, "1 tahun <= jatuh tempo < 5 tahun - Total", sv(M, 1, 18, numeric)));
        ...
        fs.add(sf(10, null, "5 tahun <= jatuh tempo < 10 tahun - Total", sv(M, 1, 18, numeric)));
        ...
        fs.add(sf(13, null, "Jatuh Tempo >= 10 - Total", sv(M, 1, 18, numeric)));
        fs.add(sf(14, null, "Total - Rupiah", sv(M, 1, 18, numeric)));
        fs.add(sf(15, null, "Total - Non Rupiah", sv(M, 1, 18, numeric)));
        fs.add(sf(16, null, "Total - Total", sv(M, 1, 18, numeric)));
