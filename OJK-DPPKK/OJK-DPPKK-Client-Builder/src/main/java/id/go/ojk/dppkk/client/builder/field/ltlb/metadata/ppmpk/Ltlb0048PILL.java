...
public class Ltlb0048PILL extends BaseMetadata {
    ...
    public Ltlb0048PILL(String reportCode) {
    ...
    public SubmissionFormat get() {
        ...
        EFormLaporanTahunanLaporanBulanan eNum = EFormLaporanTahunanLaporanBulanan.LTLB_PILL;
        SubmissionFormat res = new SubmissionFormat(eNum.getCode(), eNum.getName(), reportCode, new ArrayList<>(),
                extension, 0, null);

        res.setSavePos(ER7047PosLtlbDppkPill.genFieldSave());
        res.setRequiredPos(ER7047PosLtlbDppkPill.getRequiredPos());

        res.addSegmentValidations(ER7047PosLtlbDppkPill.genValidation());
        ...
        fs.add(sf(2, null, "Jenis Piutang Lain",
        ...
        fs.add(sf(5, null, "Tanggal Muncul Piutang",
                sv(C, 8, 8, date)
                        .confConditionalRequired(ER7047PosLtlbDppkPill.genConditionForTotal())));
        ...
        fs.add(sf(7, null, "Keterangan",
                sv(C, 1, 250, freeText)
                        .confConditionalRequired(ER7047PosLtlbDppkPill.genConditionForTotalOptional())));
