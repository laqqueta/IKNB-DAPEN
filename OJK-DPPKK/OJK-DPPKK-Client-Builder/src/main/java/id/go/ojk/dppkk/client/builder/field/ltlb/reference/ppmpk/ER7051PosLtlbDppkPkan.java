...
public enum ER7051PosLtlbDppkPkan implements IObject<KeyValueString> {
    ...
    public static ConditionalRequired genConditionForTotal() {
        return UtilFieldConditional.genExistPos("N", "M", R_PKAN000000.key);
    }

    public static ConditionalRequired genConditionForTotalOptional() {
        return UtilFieldConditional.genExistPos("N", "O", R_PKAN000000.key);
    }

    public static FieldValidation genFieldValidationNilaiBuku() {
        return UtilFieldValidation.genEqualsExceptPosFormula("4-5", R_PKAN000000.key);
    }

    public static SegmentValidation genValidation() {
        return UtilSegmentValidation.genEqualsFormula(UtilMetadata.genPipeColumn(4, 7), R_PKAN000000.key, R_PKAN010000.key,
