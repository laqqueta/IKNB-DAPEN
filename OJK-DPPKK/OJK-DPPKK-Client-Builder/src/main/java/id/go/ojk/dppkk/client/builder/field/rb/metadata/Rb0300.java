...
import id.go.ojk.dppkk.client.builder.field.rb.reference.ER2002PosRbDppkk0300;
...
public class Rb0300 extends BaseMetadata {
	...
	public SubmissionFormat get() {
		...
		SubmissionFormat res = new SubmissionFormat(eEnum.getCode(), eEnum.getName(), reportCode, new ArrayList<>(),
				extension, 16, 16, null, null, ER2002PosRbDppkk0300.getRequiredPos());
		res.addSegmentValidations(ER2002PosRbDppkk0300.genValidationNumericNegatif());
		res.addSegmentValidations(ER2002PosRbDppkk0300.genValidationNumericDotNegatif());
		res.addSegmentValidations(ER2002PosRbDppkk0300.genValidationMaxLengthDecimal());
		...
		fs.add(sf(4, null, "Pencapaian (%)", sv(M, 1, 10, numericDotNegatif))
				.addFieldValidations(ER2002PosRbDppkk0300.genValidationRatio1()));
		return res;
	}
}
