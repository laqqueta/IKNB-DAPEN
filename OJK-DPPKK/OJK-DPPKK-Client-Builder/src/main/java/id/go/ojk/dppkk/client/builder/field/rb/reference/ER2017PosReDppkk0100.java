...
public enum ER2017PosReDppkk0100 implements IObject<KeyValueString> {
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER2017PosReDppkk0100 eEnum : ER2017PosReDppkk0100.values()) {
	...
	public static String getName() {
		return ER2017PosReDppkk0100.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER2017PosReDppkk0100.class.getSimpleName().substring(2, 6));
	}
