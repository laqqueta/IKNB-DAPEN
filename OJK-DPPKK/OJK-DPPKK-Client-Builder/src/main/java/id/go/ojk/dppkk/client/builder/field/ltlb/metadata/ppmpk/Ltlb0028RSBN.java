...
public class Ltlb0028RSBN extends BaseMetadata {
    ...
    public SubmissionFormat get() {
        ...
        fs.add(sf(2, null, "Kode Surat Berharga", sv(M, 1, 50, alfaNumeric)));
        ...
        fs.add(sf(12, null, "Metode Pencatatan", sv(M, 1, 6, alfa)));
        fs.add(sf(13, null, "Pengelolaan Swakelola/ KPD", sv(M, 1, 6, alfa)));
        fs.add(sf(14, null, "Pengelolaan Nama Manajer Investasi", sv(C, 1, 250, alfa)));
        fs.add(sf(15, null, "Keterangan", sv(O, 1, 250, freeText)));
