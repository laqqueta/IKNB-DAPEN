...
import id.go.ojk.dppkk.client.builder.field.rb.uus.reference.ER2118PosRbDppu1203;
...
public class Rb1203 extends BaseMetadata {
	...
	public SubmissionFormat get() {
		...
		SubmissionFormat res = new SubmissionFormat(eEnum.getCode(), eEnum.getName(), reportCode, new ArrayList<>(),
				extension, 5, null, null, null, ER2118PosRbDppu1203.getRequiredPos());
		res.setUniquePos(ER2118PosRbDppu1203.getUniquePos());
		res.addSegmentValidations(ER2118PosRbDppu1203.genValidationNumericDotNegatif());
		res.addSegmentValidations(ER2118PosRbDppu1203.genValidationDecimalMaxLength10());
		List<SubmissionField> fs = res.getFields();
		fs.add(sf(0, null, "Flag Detail", sv(M, 3, 3, alfaNumeric).confConstant("D01")));
		fs.add(sf(1, null, "Kode Komponen / Baris",
				sv(M, 10, 10, refTable).confReference(EHeaderMetadataRbUus.R2118_RB1203.getObject())));
		fs.add(sf(2, null, "Asumsi Lain yang Relevan",
				sv(C, 0, 200, all).confConditionalRequired(ER2118PosRbDppu1203.genConditionalMustEmpty())));
