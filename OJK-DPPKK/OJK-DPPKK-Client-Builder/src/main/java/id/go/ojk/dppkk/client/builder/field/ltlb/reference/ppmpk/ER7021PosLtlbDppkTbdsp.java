...
public enum ER7021PosLtlbDppkTbdsp implements IObject<KeyValueString> {
    ...
    R_TBDSP0100000000("TBDSP0100000000", "A. Saldo Awal"), // 0
    R_TBDSP0200000000("TBDSP0200000000", "B. Penambahan Tahun Berjalan"), // 1
    R_TBDSP0201000000("TBDSP0201000000", "1. Transaksi tidak sesuai dengan prinsip syariah yang tidak dapat dihindarkan, termasuk pendapatan bunga (riba)"), // 2
    R_TBDSP0202010000("TBDSP0202010000", "Detail - Mitra Pemberi Kerja"), // 3
    R_TBDSP0202030000("TBDSP0202030000", "Total dana sanksi (dana ta'zir)"), // 4
    R_TBDSP0203000000("TBDSP0203000000", "3. Transaksi syariah yang tidak terpenuhi ketentuan dan batasannya"), // 5
    R_TBDSP0204000000("TBDSP0204000000", "4. Dana yang tidak diketahui pemiliknya, diketahui pemiliknya tetapi tidak ditemukan, atau diketahui pemiliknya tetapi biaya pengembaliannya lebih besar dari jumlah dana tersebut"), // 6
    R_TBDSP0205000000("TBDSP0205000000", "5. Transaksi lainnya yang tidak sesuai dengan Prinsip Syariah"), // 7
    R_TBDSP0301000000("TBDSP0301000000", "Detail - Nama Penerima"), // 8
    R_TBDSP0303000000("TBDSP0303000000", "Total Pengguna Tahun Berjalan"), // 9
    R_TBDSP0400000000("TBDSP0400000000", "D. Saldo Akhir (A+B-C)"); // 10
    ...
    private static SegmentValidation genValidationSumMitra() {
        return UtilSegmentValidation.genEqualsFormula("3", R_TBDSP0202030000.key, R_TBDSP0202010000.key,
                UtilMetadata.genMessageTotal(R_TBDSP0202030000.value, R_TBDSP0202010000.value));
    }
