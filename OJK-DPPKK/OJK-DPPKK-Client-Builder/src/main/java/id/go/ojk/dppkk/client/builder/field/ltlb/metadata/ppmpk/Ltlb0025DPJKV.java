...
public class Ltlb0025DPJKV extends BaseMetadata {
    ...
    public SubmissionFormat get() {
        ...
        fs.add(sf(3, null, "Kode Bank", sv(M, 1, 6, numeric)));
        fs.add(sf(4, null, "Cabang", sv(O, 1, 100, alfaNumeric)));
        fs.add(sf(5, null, "Tanggal Perolehan", sv(M, 8, 8, date)));
        fs.add(sf(6, null, "Nilai Nominal", sv(M, 1, 18, numeric)));
        fs.add(sf(7, null, "Nilai Wajar", sv(M, 1, 18, numeric)));
        ...
        fs.add(sf(10, null, "Jangka Waktu (Hari)", sv(M, 1, 3, numeric)));
        fs.add(sf(11, null, "Tingkat Bunga/Nisbah (%)", sv(M, 2, 5, numericDot)));
        fs.add(sf(12, null, "Manfaat Pensiun/Manfaat Pensiun Lainnya/Manfaat Lain/LCF", sv(M, 1, 6, alfaNumeric)));
        fs.add(sf(13, null, "Pengelolaan Swakelola/ KPD", sv(M, 1, 6, alfaNumeric)));
        fs.add(sf(14, null, "Pengelolaan Nama Manajer Investasi", sv(C, 1, 250, alfa)));
        fs.add(sf(15, null, "Jenis Mata Uang", sv(M, 1, 8, alfa)));
        fs.add(sf(16, null, "Keterangan", sv(O, 1, 250, freeText)));
