...
public enum ER2106PosRbDppu0701 implements IObject<KeyValueString> {
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER2106PosRbDppu0701 eEnum : ER2106PosRbDppu0701.values()) {
	...
	public static String getName() {
		return ER2106PosRbDppu0701.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER2106PosRbDppu0701.class.getSimpleName().substring(2, 6));
	}
