...
public class Ltlb0032OBSUD extends BaseMetadata {
    ...
    public SubmissionFormat get() {
        ...
        fs.add(sf(3, null, "Kode Obligasi/ Sukuk Daerah", sv(M, 1, 30, alfaNumeric)));
        fs.add(sf(4, null, "Nama Obligasi/ Sukuk Daerah", sv(M, 1, 100, alfa)));
        ...
        fs.add(sf(15, null, "Sektor Ekonomi", sv(M, 1, 9191, freeText)));
        fs.add(sf(16, null, "Manfaat Pensiun/Manfaat Pensiun Lainnya/Manfaat Lain", sv(M, 1, 6, alfaNumeric)));
        fs.add(sf(17, null, "Metode Pencatatan", sv(M, 1, 9191, freeText)));
