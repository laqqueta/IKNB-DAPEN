...
import id.go.ojk.dppkk.client.builder.field.rb.uus.reference.ER2107PosRbDppu0702;
...
public class Rb0702 extends BaseMetadata {
	...
	public SubmissionFormat get() {
		EFormRencanaBisnisUus eEnum = EFormRencanaBisnisUus.RB_0702;
		SubmissionFormat res = new SubmissionFormat(eEnum.getCode(), eEnum.getName(), reportCode, new ArrayList<>(),
				extension, 21, 21, ER2107PosRbDppu0702.genFieldSave(), null, ER2107PosRbDppu0702.getRequiredPos());
		res.addSegmentValidations(ER2107PosRbDppu0702.genValidationInvestasi());
		res.addSegmentValidations(ER2107PosRbDppu0702.genValidationRatioInvestasi3());
		res.addSegmentValidations(ER2107PosRbDppu0702.genValidationRatioInvestasi5());
		res.addSegmentValidations(ER2107PosRbDppu0702.genValidationRatioInvestasi7());
		res.addSegmentValidations(ER2107PosRbDppu0702.genValidationRatioInvestasi9());
		res.addSegmentValidations(ER2107PosRbDppu0702.genValidationRatioInvestasi());
		res.addSegmentValidations(ER2107PosRbDppu0702.genValidationFixedValue());
		List<SubmissionField> fs = res.getFields();
		fs.add(sf(0, null, "Flag Detail", sv(M, 3, 3, alfaNumeric).confConstant("D01")));
		fs.add(sf(1, null, "Kode Komponen / Baris",
				sv(M, 10, 10, refTable).confReference(EHeaderMetadataRbUus.R2107_RB0702.getObject())).confUnique(U));
