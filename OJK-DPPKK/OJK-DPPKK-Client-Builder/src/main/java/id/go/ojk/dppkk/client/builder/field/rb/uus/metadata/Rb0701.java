...
import id.go.ojk.dppkk.client.builder.field.rb.uus.reference.ER2106PosRbDppu0701;
...
public class Rb0701 extends BaseMetadata {
	...
	public SubmissionFormat get() {
		EFormRencanaBisnisUus eEnum = EFormRencanaBisnisUus.RB_0701;
		SubmissionFormat res = new SubmissionFormat(eEnum.getCode(), eEnum.getName(), reportCode, new ArrayList<>(),
				extension, 21, 21, ER2106PosRbDppu0701.genFieldSave(), null, ER2106PosRbDppu0701.getRequiredPos());
		res.addSegmentValidations(ER2106PosRbDppu0701.genValidationInvestasi());
		res.addSegmentValidations(ER2106PosRbDppu0701.genValidationRatioInvestasi3());
		res.addSegmentValidations(ER2106PosRbDppu0701.genValidationRatioInvestasi5());
		res.addSegmentValidations(ER2106PosRbDppu0701.genValidationRatioInvestasi7());
		res.addSegmentValidations(ER2106PosRbDppu0701.genValidationRatioInvestasi9());
		res.addSegmentValidations(ER2106PosRbDppu0701.genValidationRatioInvestasi());
		res.addSegmentValidations(ER2106PosRbDppu0701.genValidationFixedValue());
		List<SubmissionField> fs = res.getFields();
		fs.add(sf(0, null, "Flag Detail", sv(M, 3, 3, alfaNumeric).confConstant("D01")));
		fs.add(sf(1, null, "Kode Komponen / Baris",
				sv(M, 10, 10, refTable).confReference(EHeaderMetadataRbUus.R2106_RB0701.getObject())).confUnique(U));
