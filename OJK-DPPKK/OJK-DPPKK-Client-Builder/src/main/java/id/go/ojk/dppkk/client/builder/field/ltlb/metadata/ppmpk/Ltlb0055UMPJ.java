...
public class Ltlb0055UMPJ extends BaseMetadata {

    public Ltlb0055UMPJ(String reportCode) {
    ...
    public SubmissionFormat get() {
        ...
        EFormLaporanTahunanLaporanBulanan eNum = EFormLaporanTahunanLaporanBulanan.LTLB_UMPJ;
        SubmissionFormat res = new SubmissionFormat(eNum.getCode(), eNum.getName(), reportCode, new ArrayList<>(),
                extension, 0, null);

        res.setSavePos(ER7054PosLtlbDppkUmpj.genFieldSave());
        res.setRequiredPos(ER7054PosLtlbDppkUmpj.getRequiredPos());

        res.addSegmentValidations(ER7054PosLtlbDppkUmpj.genValidation());
        ...
        fs.add(sf(4, null, "Jumlah Total",
                sv(M, 1, 18, numeric))
                .addFieldValidations(ER7054PosLtlbDppkUmpj.genFieldValidationTotal()));

        fs.add(sf(5, null, "Manfaat Pensiun/Manfaat Pensiun Lainnya/Manfaat Lain",
                sv(C, 1, 6, refTable)
                        .confConditionalRequired(ER7054PosLtlbDppkUmpj.genConditionForTotal())
                        .confRegex(SimpleValidation.patternAlfaNumeric)
                        .confReference(EHeaderMetadataShared.R009.getObject())));

        fs.add(sf(6, null, "Keterangan",
                sv(C, 1, 250, freeText)
                        .confConditionalRequired(ER7054PosLtlbDppkUmpj.genConditionForTotalOptional())));
