...
public enum ER2111PosRbDppu0900 implements IObject<KeyValueString> {
...
//	R_0905000000 ("0905000000", "E. Penutupan Kantor"),
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER2111PosRbDppu0900 eEnum : ER2111PosRbDppu0900.values()) {
	...
	public static String getName() {
		return ER2111PosRbDppu0900.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER2111PosRbDppu0900.class.getSimpleName().substring(2, 6));
	}
