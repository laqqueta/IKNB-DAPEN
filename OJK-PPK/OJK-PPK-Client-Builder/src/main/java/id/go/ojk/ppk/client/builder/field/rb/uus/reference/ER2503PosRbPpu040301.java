...
public enum ER2503PosRbPpu040301 implements IObject<KeyValueString> {
	R_04030101000000 ("04030101000000", "Debitur"), 
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER2503PosRbPpu040301 eEnum : ER2503PosRbPpu040301.values()) {
	...
	public static String getName() {
		return ER2503PosRbPpu040301.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER2503PosRbPpu040301.class.getSimpleName().substring(2, 6));
	}
	...
	public static ConditionalRequired genConditionalField1() {
		return UtilFieldConditional.genExistPosOrComparatorNotEmpty("N", "N", "M", 
				UtilMetadata.genPlusRow(getObjects(), 1, 3), "2");
	}
	...
	public static SegmentValidation genValidationNumericDot() {
		return UtilSegmentValidation.genRegexNumericDotNegative("5|6|7|8", R_04030104000000.key);
	}

	public static SegmentValidation genValidationNumeric() {
		return UtilSegmentValidation.genRegexNumericNegative("5|6|7|8", UtilMetadata.genPipeRow(getObjects(), 0, 2));
	}

	public static SegmentValidation genValidationTotalPenyaluranPembiayaankepadaPihakTerkait() {
		return UtilSegmentValidation.genEqualsFormula("5|6|7|8", R_04030102000000.key, R_04030101000000.key,
				"Total Penyaluran Pembiayaan kepada Pihak Terkait|Penjumlahan Penyaluran Pembiayaan kepada Pihak Terkait");
	}

	public static SegmentValidation genValidationRasioEqual() {
		return UtilSegmentValidation.genEqualsRatio("5|6|7|8",
