...
public enum ER2260PosRePpk070101 implements IObject<KeyValueString> {
...
//	R_07010102000000 ("07010102000000", "Saldo Penerimaan Pendanaan (Outstanding):"),
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER2260PosRePpk070101 eEnum : ER2260PosRePpk070101.values()) {
	...
	public static String getName() {
		return ER2260PosRePpk070101.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER2260PosRePpk070101.class.getSimpleName().substring(2, 6));
	}
	...
	public static SegmentValidation genValidationTotalPenerimaanPendanaanBaru() {
		return UtilSegmentValidation.genEqualsFormula("2|3", R_07010101090000.key,
	...
	public static SegmentValidation genValidationTotalSaldoPenerimaanPendanaan() {
		return UtilSegmentValidation.genEqualsFormula("2|3", R_07010102090000.key,
