...
public enum ER5000PosApuPpk01 implements IObject<KeyValueString> {
...
//	R_0102020400000000 ("0102020400000000", "  4) Pembayaran melalui Cara Tidak Tatap Muka Lainnya:"),
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER5000PosApuPpk01 eEnum : ER5000PosApuPpk01.values()) {
	...
	public static String getName() {
		return ER5000PosApuPpk01.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER5000PosApuPpk01.class.getSimpleName().substring(2, 6));
	}
