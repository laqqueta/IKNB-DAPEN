...
public enum ER2258PosRePpk060101 implements IObject<KeyValueString> {
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER2258PosRePpk060101 eEnum : ER2258PosRePpk060101.values()) {
	...
	public static String getName() {
		return ER2258PosRePpk060101.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER2258PosRePpk060101.class.getSimpleName().substring(2, 6));
	}
	...
	public static SegmentValidation genValidationNumericDot() {
		return UtilSegmentValidation.genRegexNumericDotNegative("2|3|4", R_06010103000000.key);
	}

	public static SegmentValidation genValidationNumeric() {
		return UtilSegmentValidation.genRegexNumericNegative("2|3|4", R_06010101000000.key + "|" + R_06010102000000.key);
	}
}
