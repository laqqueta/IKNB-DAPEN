...
public enum ER2003PosRbPpk040301 implements IObject<KeyValueString> {
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER2003PosRbPpk040301 eEnum : ER2003PosRbPpk040301.values()) {
	...
	public static String getName() {
		return ER2003PosRbPpk040301.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER2003PosRbPpk040301.class.getSimpleName().substring(2, 6));
	}
