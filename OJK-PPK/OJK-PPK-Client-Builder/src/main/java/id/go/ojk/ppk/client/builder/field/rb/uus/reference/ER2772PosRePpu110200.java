...
public enum ER2772PosRePpu110200 implements IObject<KeyValueString> {
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER2772PosRePpu110200 eEnum : ER2772PosRePpu110200.values()) {
	...
	public static String getName() {
		return ER2772PosRePpu110200.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER2772PosRePpu110200.class.getSimpleName().substring(2, 6));
	}
