...
import id.go.ojk.ppk.client.builder.field.rb.reference.ER2258PosRePpk060101;
...
public class Re060101 extends BaseMetadata {
	...
	public SubmissionFormat get() {
		...
		SubmissionFormat res = new SubmissionFormat(eEnum.getCode(), eEnum.getName(), reportCode, new ArrayList<>(),
				extension, 3, 3, ER2258PosRePpk060101.genFieldSave(), null, ER2258PosRePpk060101.getRequiredPos());
		res.addSegmentValidations(ER2258PosRePpk060101.genValidationNumeric());
		res.addSegmentValidations(ER2258PosRePpk060101.genValidationNumericDot());
		res.addSegmentValidations(ER2258PosRePpk060101.genValidationFormRasioPermodalan());
		...
		fs.add(sf(4, null, "Deviasi", sv(M, 1, 16, all)).addFieldValidations(ER2258PosRePpk060101.genValidationSum()));
		return res;
	}
}
