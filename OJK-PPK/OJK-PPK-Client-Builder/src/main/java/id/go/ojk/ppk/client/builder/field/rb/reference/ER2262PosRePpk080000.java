...
public enum ER2262PosRePpk080000 implements IObject<KeyValueString> {
	R_08010100000000 ("08010100000000", "Rencana"),
	;
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER2262PosRePpk080000 eEnum : ER2262PosRePpk080000.values()) {
	...
	public static String getName() {
		return ER2262PosRePpk080000.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER2262PosRePpk080000.class.getSimpleName().substring(2, 6));
	}
