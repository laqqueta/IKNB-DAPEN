...
import id.go.ojk.ppk.client.builder.field.rb.reference.ER2003PosRbPpk040301;
...
public class Rb040301 extends BaseMetadata {
	...
	public SubmissionFormat get() {
		...
		SubmissionFormat res = new SubmissionFormat(eEnum.getCode(), eEnum.getName(), reportCode, new ArrayList<>(),
				extension, 3, null, ER2003PosRbPpk040301.genFieldSave(), null, ER2003PosRbPpk040301.getRequiredPos());
		res.addSegmentValidations(ER2003PosRbPpk040301.genValidationNumeric());
		res.addSegmentValidations(ER2003PosRbPpk040301.genValidationNumericDot());
		res.addSegmentValidations(ER2003PosRbPpk040301.genValidationTotalPenyaluranPembiayaankepadaPihakTerkait());
		res.addSegmentValidations(ER2003PosRbPpk040301.genValidationRasioEqual());
		...
		fs.add(sf(2, null, "Nama Debitur Pihak Terkait",
				sv(C, 0, 255, alfaSpace).confConditionalRequired(ER2003PosRbPpk040301.genConditionalFieldMustEmpty())));
		fs.add(sf(3, null, "Jenis Pembiayaan",
				sv(C, 0, 6, refTable).confReference(EHeaderMetadataShared.R001.getObject())
						.confConditionalRequired(ER2003PosRbPpk040301.genConditionalField1())));
		...
		fs.add(sf(5, null, "Kinerja Sept XX-1",
				sv(C, 0, 16, all).confConditionalRequired(ER2003PosRbPpk040301.genConditionalField2())));
