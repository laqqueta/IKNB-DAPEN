...
public enum ER2271PosRePpk110100 implements IObject<KeyValueString> {
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER2271PosRePpk110100 eEnum : ER2271PosRePpk110100.values()) {
	...
	public static String getName() {
		return ER2271PosRePpk110100.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER2271PosRePpk110100.class.getSimpleName().substring(2, 6));
	}
