...
import id.go.ojk.ppk.client.builder.field.rb.reference.ER2252PosRePpk040201;
...
public class Re040201 extends BaseMetadata {
	...
	public SubmissionFormat get() {
		...
		SubmissionFormat res = new SubmissionFormat(eEnum.getCode(), eEnum.getName(), reportCode, new ArrayList<>(),
				extension, 1, null, ER2252PosRePpk040201.genFieldSave(), null, ER2252PosRePpk040201.getRequiredPos());
		res.addSegmentValidations(ER2252PosRePpk040201.genValidationTotalPenyaluranPembiayaanKepadaDebiturInti());
		...
		fs.add(sf(2, null, "Nama Debitur",
				sv(C, 0, 1000, all).confConditionalRequired(ER2252PosRePpk040201.genConditionalMustEmpty())));
		fs.add(sf(3, null, "Proyeksi",
				sv(C, 0, 16, numericNegatif).confConditionalRequired(ER2252PosRePpk040201.genConditionalField())));
		fs.add(sf(4, null, "Realisasi",
				sv(C, 0, 16, numericNegatif).confConditionalRequired(ER2252PosRePpk040201.genConditionalField())));
		fs.add(sf(5, null, "Deviasi",
				sv(C, 0, 16, numericNegatif).confConditionalRequired(ER2252PosRePpk040201.genConditionalField()))
				.addFieldValidations(ER2252PosRePpk040201.genValidationSum()));
		return res;
	}
}
