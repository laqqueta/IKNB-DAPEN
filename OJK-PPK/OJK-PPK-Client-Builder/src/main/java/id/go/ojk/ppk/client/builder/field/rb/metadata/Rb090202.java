...
import id.go.ojk.ppk.client.builder.field.rb.reference.ER2013PosRbPpk090202;
...
public class Rb090202 extends BaseMetadata {
	...
	public SubmissionFormat get() {
		...
		fs.add(sf(1, null, "Kode Komponen / Baris",
				sv(M, 14, 14, refTable).confReference(EHeaderMetadataRb.R2013_RB090202.getObject())));
		fs.add(sf(2, null, "Materi/Topik", sv(O, 0, 1000, all)));
		fs.add(sf(3, null, "Metode Diklat",
				sv(C, 0, 1000, all).confConditionalRequired(ER2013PosRbPpk090202.genConditionalField())));
		fs.add(sf(4, null, "Perkiraan Waktu Diklat",
				sv(C, 0, 25, all).confConditionalRequired(ER2013PosRbPpk090202.genConditionalField())));
		...
		fs.add(sf(8, null, "Jumlah Seluruh Peserta",
				sv(C, 0, 10, numeric).confConditionalRequired(ER2013PosRbPpk090202.genConditionalField())));
		fs.add(sf(9, null, "Biaya Diklat",
				sv(C, 0, 16, numeric).confConditionalRequired(ER2013PosRbPpk090202.genConditionalField())));
		return res;
	}
}
