...
public enum ER2501PosRbPpu040102 implements IObject<KeyValueString> {
...
//	R_04010202000000 ("04010202000000", "Saldo Piutang Pembiayaan Syariah (Outstanding Principal):"),
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER2501PosRbPpu040102 eEnum : ER2501PosRbPpu040102.values()) {
	...
	public static String getName() {
		return ER2501PosRbPpu040102.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER2501PosRbPpu040102.class.getSimpleName().substring(2, 6));
	}
	...
	public static SegmentValidation genValidationPembiayaanJualBeliA() {
		return UtilSegmentValidation.genEqualsFormula("2|3|4|5", R_04010201010000.key,
				UtilMetadata.genPlusRow(getObjects(), 1, 4),
				"Total Pembiayaan Jual Beli A|Penjumlahan Pembiayaan Jual Beli A");
	}

	public static SegmentValidation genValidationPembiayaanInvestasiA() {
		return UtilSegmentValidation.genEqualsFormula("2|3|4|5", R_04010201020000.key,
				UtilMetadata.genPlusRow(getObjects(), 6, 10),
				"Total Pembiayaan Investasi A|Penjumlahan Pembiayaan Investasi A");
	}

	public static SegmentValidation genValidationPembiayaanJasaA() {
		return UtilSegmentValidation.genEqualsFormula("2|3|4|5", R_04010201030000.key,
				UtilMetadata.genPlusRow(getObjects(), 12, 19),
				"Total Pembiayaan Jasa A|Penjumlahan Pembiayaan Jasa A");
	}

	public static SegmentValidation genValidationTotalRencanaPenyaluranPembiayaanBaru() {
		return UtilSegmentValidation.genEqualsFormula("2|3|4|5", R_04010201040000.key,
	...
	public static SegmentValidation genValidationPembiayaanJualBeliB() {
		return UtilSegmentValidation.genEqualsFormula("2|3|4|5", R_04010202010000.key,
				UtilMetadata.genPlusRow(getObjects(), 22, 25),
				"Total Pembiayaan Jual Beli B|Penjumlahan Pembiayaan Jual Beli B");
	}

	public static SegmentValidation genValidationPembiayaanInvestasiB() {
		return UtilSegmentValidation.genEqualsFormula("2|3|4|5", R_04010202020000.key,
				UtilMetadata.genPlusRow(getObjects(), 27, 31),
				"Total Pembiayaan Investasi B|Penjumlahan Pembiayaan Investasi B");
	}

	public static SegmentValidation genValidationPembiayaanJasaB() {
		return UtilSegmentValidation.genEqualsFormula("2|3|4|5", R_04010202030000.key,
				UtilMetadata.genPlusRow(getObjects(), 33, 40),
				"Total Pembiayaan Jasa B|Penjumlahan Pembiayaan Jasa B");
	}

	public static SegmentValidation genValidationTotalSaldoPiutangPembiayaan() {
		return UtilSegmentValidation.genEqualsFormula("2|3|4|5", R_04010202040000.key,
