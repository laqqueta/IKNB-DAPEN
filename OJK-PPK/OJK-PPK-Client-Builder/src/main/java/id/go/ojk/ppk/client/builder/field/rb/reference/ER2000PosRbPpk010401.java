...
public enum ER2000PosRbPpk010401 implements IObject<KeyValueString> {
...
//	R_01040113000000 ("01040113000000", "Likuiditas"),
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER2000PosRbPpk010401 eEnum : ER2000PosRbPpk010401.values()) {
	...
	public static String getName() {
		return ER2000PosRbPpk010401.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER2000PosRbPpk010401.class.getSimpleName().substring(2, 6));
	}
	...
	public static SegmentValidation genValidationNumeric() {
		return UtilSegmentValidation.genRegexNumericNegative("2|3|4|5", UtilMetadata.genPipeRow(getObjects(), 0, 14));
	}

	public static SegmentValidation genValidationNumericDot() {
		return UtilSegmentValidation.genRegexNumericDotNegative("2|3|4|5", UtilMetadata.genPipeRow(getObjects(), 15, 23));
	}

	public static SegmentValidation genValidationTotalPiutangPembiayaan() {
		return UtilSegmentValidation.genEqualsFormula("2|3|4|5", R_01040102000000.key,
	...
	public static SegmentValidation genValidationPenyaluranPembiayaanBersamaPorsiPihakKetiga() {
		return UtilSegmentValidation.genEqualsFormula("2|3|4|5", R_01040108000000.key,
	...
	public static SegmentValidation genValidationFormTotalAset() {
		...
		return UtilSegmentValidation.genEqualsForm2("2|3|4|5", R_01040101000000.key, comparatorFormCode, 
				ER2017PosRbPpk100201.R_10020101100000.getKey(), 
				"Total Aset|Jumlah Aset form " + comparatorFormCode + " #kolom#");
	}

	public static SegmentValidation genValidationFormPiutang() {
		String comparatorFormCode = EFormRencanaBisnis.RB_100201.getCode();
		return UtilSegmentValidation.genEqualsForm2("2|3|4|5", R_01040102000000.key, comparatorFormCode, 
				ER2017PosRbPpk100201.R_10020101030000.getKey(), 
	...
	public static SegmentValidation genValidationFormPenerbitanSuratBerharga() {
		String comparatorFormCode = EFormRencanaBisnis.RB_100201.getCode();
		return UtilSegmentValidation.genEqualsForm2("2|3|4|5", R_01040105000000.key, comparatorFormCode, 
				ER2017PosRbPpk100201.R_10020102050000.getKey(), 
	...
	public static SegmentValidation genValidationFormEkuitas() {
		String comparatorFormCode = EFormRencanaBisnis.RB_100201.getCode();
		return UtilSegmentValidation.genEqualsForm2("2|3|4|5", R_01040106000000.key, comparatorFormCode, 
				ER2017PosRbPpk100201.R_10020103060000.getKey(), 
				"Nilai Ekuitas|Nilai Ekuitas form " + comparatorFormCode + " #kolom#");
	}

	public static SegmentValidation genValidationFormLaba() {
		String comparatorFormCode = EFormRencanaBisnis.RB_100201.getCode();
		return UtilSegmentValidation.genEqualsForm2("2|3|4|5", R_01040107000000.key, comparatorFormCode, 
	...
	public static SegmentValidation genValidationFormPenyaluran() {
		String comparatorFormCode = EFormRencanaBisnis.RB_100501.getCode();
		return UtilSegmentValidation.genEqualsForm2("2|3|4|5", R_01040108000000.key, comparatorFormCode, 
				ER2020PosRbPpk100501.R_10050104000000.getKey(), 
	...
	public static SegmentValidation genValidationFormRasioPermodalan() {
		...
		return UtilSegmentValidation.genEqualsForm2("2|3|4|5", R_01040109000000.key, comparatorFormCode, 
	...
	public static SegmentValidation genValidationFormRasioNpfBruto() {
		String comparatorFormCode = EFormRencanaBisnis.RB_110100.getCode();
		return UtilSegmentValidation.genEqualsForm2("2|3|4|5", R_01040110000000.key, comparatorFormCode, 
				ER2021PosRbPpk110100.R_11010800000000.getKey(), 
	...
	public static SegmentValidation genValidationFormRasioNpfNeto() {
		String comparatorFormCode = EFormRencanaBisnis.RB_110100.getCode();
		return UtilSegmentValidation.genEqualsForm2("2|3|4|5", R_01040111000000.key, comparatorFormCode, 
				ER2021PosRbPpk110100.R_11010900000000.getKey(), 
				"Nilai Rasio NPF Neto|Nilai NPF Netto form " + comparatorFormCode + " #kolom#");
	}

	public static SegmentValidation genValidationFormRoa() {
		String comparatorFormCode = EFormRencanaBisnis.RB_110100.getCode();
		return UtilSegmentValidation.genEqualsForm2("2|3|4|5", R_01040112010000.key, comparatorFormCode, 
				ER2021PosRbPpk110100.R_11011100000000.getKey(), 
				"Nilai ROA|Nilai ROA form " + comparatorFormCode + " #kolom#");
	}

	public static SegmentValidation genValidationFormRoe() {
		String comparatorFormCode = EFormRencanaBisnis.RB_110100.getCode();
		return UtilSegmentValidation.genEqualsForm2("2|3|4|5", R_01040112020000.key, comparatorFormCode, 
				ER2021PosRbPpk110100.R_11011000000000.getKey(), 
				"Nilai ROE|Nilai ROE form " + comparatorFormCode + " #kolom#");
	}

	public static SegmentValidation genValidationFormBopo() {
		String comparatorFormCode = EFormRencanaBisnis.RB_110100.getCode();
		return UtilSegmentValidation.genEqualsForm2("2|3|4|5", R_01040112030000.key, comparatorFormCode, 
				ER2021PosRbPpk110100.R_11011200000000.getKey(), 
				"Nilai BOPO|Nilai BOPO form " + comparatorFormCode + " #kolom#");
	}

	public static SegmentValidation genValidationFormNim() {
		String comparatorFormCode = EFormRencanaBisnis.RB_110100.getCode();
		return UtilSegmentValidation.genEqualsForm2("2|3|4|5", R_01040112040000.key, comparatorFormCode, 
				ER2021PosRbPpk110100.R_11011300000000.getKey(), 
				"Nilai NIM|Nilai NIM form " + comparatorFormCode + " #kolom#");
	}

	public static SegmentValidation genValidationFormCurrentRatio() {
		String comparatorFormCode = EFormRencanaBisnis.RB_110100.getCode();
		return UtilSegmentValidation.genEqualsForm2("2|3|4|5", R_01040113010000.key, comparatorFormCode, 
				ER2021PosRbPpk110100.R_11011400000000.getKey(), 
	...
	public static SegmentValidation genValidationFormCashRatio() {
		String comparatorFormCode = EFormRencanaBisnis.RB_110100.getCode();
		return UtilSegmentValidation.genEqualsForm2("2|3|4|5", R_01040113020000.key, comparatorFormCode, 
				ER2021PosRbPpk110100.R_11011500000000.getKey(), 
