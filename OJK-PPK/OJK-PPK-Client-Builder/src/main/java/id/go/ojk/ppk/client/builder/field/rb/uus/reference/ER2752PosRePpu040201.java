...
public enum ER2752PosRePpu040201 implements IObject<KeyValueString> {
	R_04020101000000 ("04020101000000", "Debitur"), 
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER2752PosRePpu040201 eEnum : ER2752PosRePpu040201.values()) {
	...
	public static String getName() {
		return ER2752PosRePpu040201.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER2752PosRePpu040201.class.getSimpleName().substring(2, 6));
	}
	...
	public static SegmentValidation genValidationTotalPenyaluranPembiayaanKepadaDebiturInti() {
		return UtilSegmentValidation.genEqualsFormula("3|4", R_04020102000000.key, R_04020101000000.key,
