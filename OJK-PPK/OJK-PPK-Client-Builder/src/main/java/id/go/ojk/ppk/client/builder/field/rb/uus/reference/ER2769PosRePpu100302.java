...
public enum ER2769PosRePpu100302 implements IObject<KeyValueString> {
...
//	R_10030204000000000000 ("10030204000000000000", "TAKSIRAN PAJAK PENGHASILAN"),
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER2769PosRePpu100302 eEnum : ER2769PosRePpu100302.values()) {
	...
	public static String getName() {
		return ER2769PosRePpu100302.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER2769PosRePpu100302.class.getSimpleName().substring(2, 6));
	}
	...
	public static SegmentValidation genValidationFormLabaSetelahPajak() {
		...
		return UtilSegmentValidation.genEqualsForm2("2|3", R_10030205000000000000.key, comparatorFormCode, 
				ER2768PosRePpu100202.R_10020203040000.getKey(), "Nilai Laba (Rugi) Bersih Setelah Pajak|Nilai Laba (Rugi) Bersih Setelah Pajak form " + comparatorFormCode + " #kolom#");
	}
	...
	public static SegmentValidation genValidationFormKeuntunganPendapatanKomprehensifLainnya() {
		...
		return UtilSegmentValidation.genEqualsForm2("2|3", R_10030206000000000000.key, comparatorFormCode, 
				ER2768PosRePpu100202.R_10020203050200.getKey(), "Nilai Keuntungan (Kerugian) Pendapatan Komprehensif Lainnya|Nilai Keuntungan (Kerugian) Pendapatan Komprehensif Lainnya form " + comparatorFormCode + " #kolom#");
	}
	...
	public static SegmentValidation genValidationKeuntunganPendapatanKomprehensifLainnya() {
		return UtilSegmentValidation.genEqualsFormula("2|3", R_10030206000000000000.key,
				...
				"Total Keuntungan (Kerugian) Pendapatan Komprehensif Lainnya|Penjumlahan (Kerugian) Keuntungan Pendapatan Komprehensif Lainnya");
	}
