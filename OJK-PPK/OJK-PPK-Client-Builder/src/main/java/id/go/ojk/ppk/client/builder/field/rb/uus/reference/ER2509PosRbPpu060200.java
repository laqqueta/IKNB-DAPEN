...
public enum ER2509PosRbPpu060200 implements IObject<KeyValueString> {
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER2509PosRbPpu060200 eEnum : ER2509PosRbPpu060200.values()) {
	...
	public static String getName() {
		return ER2509PosRbPpu060200.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER2509PosRbPpu060200.class.getSimpleName().substring(2, 6));
	}
