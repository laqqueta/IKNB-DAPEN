...
import id.go.ojk.ppk.client.builder.field.rb.reference.ER2015PosRbPpk090204;
...
public class Rb090204 extends BaseMetadata {
	...
	public SubmissionFormat get() {
		...
		fs.add(sf(1, null, "Kode Komponen / Baris",
				sv(M, 14, 14, refTable).confReference(EHeaderMetadataRb.R2015_RB090204.getObject())));
		fs.add(sf(2, null, "Bidang Tugas",
				sv(O, 0, 1000, all).confConditionalRequired(ER2015PosRbPpk090204.genConditionalField())));
		fs.add(sf(3, null, "Alasan Pemanfaatan Tenaga Alih Daya",
				sv(C, 0, 1000, all).confConditionalRequired(ER2015PosRbPpk090204.genConditionalField())));
		fs.add(sf(4, null, "Jumlah Tenaga Kerja Alih Daya",
				sv(C, 1, 16, numeric).confConditionalRequired(ER2015PosRbPpk090204.genConditionalField())));
