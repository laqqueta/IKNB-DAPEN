...
public enum ER2522PosRbPpu110200 implements IObject<KeyValueString> {
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER2522PosRbPpu110200 eEnum : ER2522PosRbPpu110200.values()) {
	...
	public static String getName() {
		return ER2522PosRbPpu110200.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER2522PosRbPpu110200.class.getSimpleName().substring(2, 6));
	}
