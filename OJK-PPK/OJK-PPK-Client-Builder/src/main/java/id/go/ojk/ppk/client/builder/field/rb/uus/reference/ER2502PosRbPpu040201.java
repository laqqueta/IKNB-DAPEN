...
public enum ER2502PosRbPpu040201 implements IObject<KeyValueString> {
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER2502PosRbPpu040201 eEnum : ER2502PosRbPpu040201.values()) {
	...
	public static String getName() {
		return ER2502PosRbPpu040201.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER2502PosRbPpu040201.class.getSimpleName().substring(2, 6));
	}
