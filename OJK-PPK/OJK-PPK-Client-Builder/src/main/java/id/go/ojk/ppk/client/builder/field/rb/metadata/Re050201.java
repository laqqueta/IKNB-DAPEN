...
import id.go.ojk.ppk.client.builder.field.rb.reference.ER2257PosRePpk050201;
...
public class Re050201 extends BaseMetadata {
	...
	public SubmissionFormat get() {
		...
		fs.add(sf(3, null, "Deskripsi Umum Kegiatan Usaha",
				sv(C, 0, 1000, all).confConditionalRequired(ER2257PosRePpk050201.genConditionalField())));
		fs.add(sf(4, null, "Waktu Pelaksanaan Kegiatan Usaha Baru",
				sv(C, 0, 8, date).confConditionalRequired(ER2257PosRePpk050201.genConditionalField())));
