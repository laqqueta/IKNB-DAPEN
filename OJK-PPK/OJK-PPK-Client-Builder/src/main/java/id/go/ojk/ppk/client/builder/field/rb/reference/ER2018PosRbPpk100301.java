...
public enum ER2018PosRbPpk100301 implements IObject<KeyValueString> {
...
//	R_10030104000000000000 ("10030104000000000000", "TAKSIRAN PAJAK PENGHASILAN"),
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER2018PosRbPpk100301 eEnum : ER2018PosRbPpk100301.values()) {
	...
	public static String getName() {
		return ER2018PosRbPpk100301.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER2018PosRbPpk100301.class.getSimpleName().substring(2, 6));
	}
	...
	public static SegmentValidation genValidationFormLabaSetelahPajak() {
		...
		return UtilSegmentValidation.genEqualsForm2("2|3|4|5", R_10030105000000000000.key, comparatorFormCode, 
				ER2017PosRbPpk100201.R_10020103040000.getKey(), 
				"Nilai Laba Setelah Pajak|Nilai Laba (Rugi) Bersih Setelah Pajak form " + comparatorFormCode + " #kolom#");
	}

	public static SegmentValidation genValidationFormKeuntunganPendapatanKomprehensifLainnya() {
		String comparatorFormCode = EFormRencanaBisnis.RB_100201.getCode();
		return UtilSegmentValidation.genEqualsForm2("2|3|4|5", R_10030106000000000000.key, comparatorFormCode, 
				ER2017PosRbPpk100201.R_10020103050200.getKey(), 
				"Nilai Keuntungan (Kerugian) Pendapatan Komprehensif Lainnya|Nilai Keuntungan (Kerugian) Pendapatan Komprehensif Lainnya form " + comparatorFormCode + " #kolom#");
	}

	public static SegmentValidation genValidationPendapatan() {
		return UtilSegmentValidation.genEqualsFormula("2|3|4|5", R_10030101000000000000.key,
	...
	public static SegmentValidation genValidationPendapatanOperasional() {
		return UtilSegmentValidation.genEqualsFormula("2|3|4|5", R_10030101010000000000.key,
	...
	public static SegmentValidation genValidationPendapatanKegiatanOperasi() {
		return UtilSegmentValidation.genEqualsFormula("2|3|4|5", R_10030101010100000000.key,
	...
	public static SegmentValidation genValidationPendapatanBungaDariKegiatanPembiayaanKonvensional() {
		return UtilSegmentValidation.genEqualsFormula("2|3|4|5", R_10030101010101000000.key,
	...
	public static SegmentValidation genValidationPembiayaanInvestasi() {
		return UtilSegmentValidation.genEqualsFormula("2|3|4|5", R_10030101010101010000.key,
	...
	public static SegmentValidation genValidationPembiayaanModalKerja() {
		return UtilSegmentValidation.genEqualsFormula("2|3|4|5", R_10030101010101020000.key,
	...
	public static SegmentValidation genValidationPembiayaanMultiguna() {
		return UtilSegmentValidation.genEqualsFormula("2|3|4|5", R_10030101010101030000.key,
	...
	public static SegmentValidation genValidationPembiayaanBerdasarkanPrinsipSyariah() {
		return UtilSegmentValidation.genEqualsFormula("2|3|4|5", R_10030101010102000000.key,
	...
	public static SegmentValidation genValidationPendapatanOperasionalLainTerkaitPembiayaan() {
		return UtilSegmentValidation.genEqualsFormula("2|3|4|5", R_10030101010200000000.key,
	...
	public static SegmentValidation genValidationPendapatanOperasionalTidakTerkaitPembiayaan() {
		return UtilSegmentValidation.genEqualsFormula("2|3|4|5", R_10030101010300000000.key,
	...
	public static SegmentValidation genValidationPendapatanDariKegiatanBerbasisFee() {
		return UtilSegmentValidation.genEqualsFormula("2|3|4|5", R_10030101010302000000.key,
	...
	public static SegmentValidation genValidationPendapatanNonOperasional() {
		return UtilSegmentValidation.genEqualsFormula("2|3|4|5", R_10030101020000000000.key,
	...
	public static SegmentValidation genValidationBeban() {
		return UtilSegmentValidation.genEqualsFormula("2|3|4|5", R_10030102000000000000.key,
				R_10030102010000000000.key + "+" + R_10030102020000000000.key, "Total Beban|Penjumlahan Beban");
	}

	public static SegmentValidation genValidationBebanOperasional() {
		return UtilSegmentValidation.genEqualsFormula("2|3|4|5", R_10030102010000000000.key,
	...
	public static SegmentValidation genValidationBebanBunga() {
		return UtilSegmentValidation.genEqualsFormula("2|3|4|5", R_10030102010100000000.key,
	...
	public static SegmentValidation genValidationBebanTenagaKerja() {
		return UtilSegmentValidation.genEqualsFormula("2|3|4|5", R_10030102010400000000.key,
	...
	public static SegmentValidation genValidationBebanPemasaran() {
		return UtilSegmentValidation.genEqualsFormula("2|3|4|5", R_10030102010500000000.key,
	...
	public static SegmentValidation genValidationBebanPenyisihan() {
		return UtilSegmentValidation.genEqualsFormula("2|3|4|5", R_10030102010600000000.key,
	...
	public static SegmentValidation genValidationBebanPenyisihanPiutang() {
		return UtilSegmentValidation.genEqualsFormula("2|3|4|5", R_10030102010601000000.key,
	...
	public static SegmentValidation genValidationLabaSebelumPajak() {
		return UtilSegmentValidation.genEqualsFormula("2|3|4|5", R_10030103000000000000.key,
	...
	public static SegmentValidation genValidationLabaSetelahPajak() {
		return UtilSegmentValidation.genEqualsFormula("2|3|4|5", R_10030105000000000000.key,
	...
	public static SegmentValidation genValidationKeuntunganPendapatanKomprehensifLainnya() {
		return UtilSegmentValidation.genEqualsFormula("2|3|4|5", R_10030106000000000000.key,
	...
	public static SegmentValidation genValidationLabaBersihKomprehensifPeriodeBerjalan() {
		return UtilSegmentValidation.genEqualsFormula("2|3|4|5", R_10030107000000000000.key,
