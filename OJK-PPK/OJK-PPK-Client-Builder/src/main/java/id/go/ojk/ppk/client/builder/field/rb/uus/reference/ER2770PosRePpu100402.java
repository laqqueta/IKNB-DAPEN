...
public enum ER2770PosRePpu100402 implements IObject<KeyValueString> {
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER2770PosRePpu100402 eEnum : ER2770PosRePpu100402.values()) {
	...
	public static String getName() {
		return ER2770PosRePpu100402.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER2770PosRePpu100402.class.getSimpleName().substring(2, 6));
	}
	...
	public static SegmentValidation genValidationFormKasDanSetaraKasPadaAkhirPeriode() {
		...
		return UtilSegmentValidation.genEqualsForm2("2|3", R_10040207000000.key, comparatorFormCode, 
				ER2768PosRePpu100202.R_10020201010000.getKey(), "Total Kas dan Setara Kas pada Akhir Periode|Total Kas dan Setara Kas pada Akhir Periode form " + comparatorFormCode + " #kolom#");
	}

	public static SegmentValidation genValidationArusKasBersihDariKegiatanOperasi() {
		return UtilSegmentValidation.genEqualsFormula("2|3", R_10040201000000.key,
	...
	public static SegmentValidation genValidationPenerimaanKasDariKegiatanOperasi() {
		return UtilSegmentValidation.genEqualsFormula("2|3", R_10040201010000.key,
				UtilMetadata.genPlusRow(getObjects(), new int[] { 2, 7, 13, 22, 23, 24, 25 }),
				"Total Penerimaan Kas dari Kegiatan Operasi|Perhitungan Penerimaan Kas dari Kegiatan Operasi");
	}

	public static SegmentValidation genValidationPenerimaanDariPembiayaanJualBeli() {
		return UtilSegmentValidation.genEqualsFormula("2|3", R_10040201010100.key,
	...
	public static SegmentValidation genValidationPenerimaanDariPembiayaanInvestasi() {
		return UtilSegmentValidation.genEqualsFormula("2|3", R_10040201010200.key,
	...
	public static SegmentValidation genValidationPenerimaanDariPembiayaanJasa() {
		return UtilSegmentValidation.genEqualsFormula("2|3", R_10040201010300.key,
	...
	public static SegmentValidation genValidationPembayaranKasUntukKegiatanOperasi() {
		return UtilSegmentValidation.genEqualsFormula("2|3", R_10040201020000.key,
	...
	public static SegmentValidation genValidationPembayaranUntukKegiatanPembiayaanJualBeli() {
		return UtilSegmentValidation.genEqualsFormula("2|3", R_10040201020100.key,
	...
	public static SegmentValidation genValidationPembayaranUntukKegiatanPembiayaanInvestasi() {
		return UtilSegmentValidation.genEqualsFormula("2|3", R_10040201020200.key,
	...
	public static SegmentValidation genValidationPembayaranUntukKegiatanPembiayaanJasa() {
		return UtilSegmentValidation.genEqualsFormula("2|3", R_10040201020300.key,
	...
	public static SegmentValidation genValidationArusKasBersihDariKegiatanInvestasi() {
		return UtilSegmentValidation.genEqualsFormula("2|3", R_10040202000000.key,
				R_10040202010000.key + "-" + R_10040202020000.key,
				"Total Arus Kas Bersih dari Kegiatan Investasi|Penjumlahan Arus Kas Bersih dari Kegiatan Investasi");
	}

	public static SegmentValidation genValidationPenerimaanKasDariKegiatanInvestasi() {
		return UtilSegmentValidation.genEqualsFormula("2|3", R_10040202010000.key,
	...
	public static SegmentValidation genValidationPembayaranKasUntukKegiatanInvestasi() {
		return UtilSegmentValidation.genEqualsFormula("2|3", R_10040202020000.key,
	...
	public static SegmentValidation genValidationArusKasBersihDariAktivitasPendanaan() {
		return UtilSegmentValidation.genEqualsFormula("2|3", R_10040203000000.key,
	...
	public static SegmentValidation genValidationPenerimaanKasDariKegiatanPendanaan() {
		return UtilSegmentValidation.genEqualsFormula("2|3", R_10040203010000.key,
	...
	public static SegmentValidation genValidationPenerimaanDariPendanaanBank() {
		return UtilSegmentValidation.genEqualsFormula("2|3", R_10040203010100.key,
	...
	public static SegmentValidation genValidationPenerimaanDariPendanaanNonbank() {
		return UtilSegmentValidation.genEqualsFormula("2|3", R_10040203010200.key,
	...
	public static SegmentValidation genValidationPembayaranKasUntukKegiatanPendanaan() {
		return UtilSegmentValidation.genEqualsFormula("2|3", R_10040203020000.key,
	...
	public static SegmentValidation genValidationPengeluaranDariPendanaanBank() {
		return UtilSegmentValidation.genEqualsFormula("2|3", R_10040203020100.key,
	...
	public static SegmentValidation genValidationPengeluaranDariPendanaanNonbank() {
		return UtilSegmentValidation.genEqualsFormula("2|3", R_10040203020200.key,
	...
	public static SegmentValidation genValidationKenaikanBersihKasDanSetarKas() {
		return UtilSegmentValidation.genEqualsFormula("2|3", R_10040205000000.key,
	...
	public static SegmentValidation genValidationKasDanSetaraKasPadaAkhirPeriode() {
		return UtilSegmentValidation.genEqualsFormula("2|3", R_10040207000000.key,
