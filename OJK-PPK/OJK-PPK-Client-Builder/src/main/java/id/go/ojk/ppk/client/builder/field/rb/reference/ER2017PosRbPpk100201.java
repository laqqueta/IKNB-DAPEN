...
public enum ER2017PosRbPpk100201 implements IObject<KeyValueString> {
...
//	R_10020103000000 ("10020103000000", "EKUITAS"),
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER2017PosRbPpk100201 eEnum : ER2017PosRbPpk100201.values()) {
	...
	public static String getName() {
		return ER2017PosRbPpk100201.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER2017PosRbPpk100201.class.getSimpleName().substring(2, 6));
	}
	...
	public static SegmentValidation genValidationJumlahAset() {
		return UtilSegmentValidation.genEqualsFormula("2|3|4|5", R_10020101100000.key,
	...
	public static SegmentValidation genValidationCadangan() {
		return UtilSegmentValidation.genEqualsFormula("2|3|4|5", R_10020103020000.key,
				R_10020103020100.key + "+" + R_10020103020200.key, "Total Cadangan|Penjumlahan Cadangan");
	}
