...
public enum ER2252PosRePpk040201 implements IObject<KeyValueString> {
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER2252PosRePpk040201 eEnum : ER2252PosRePpk040201.values()) {
	...
	public static String getName() {
		return ER2252PosRePpk040201.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER2252PosRePpk040201.class.getSimpleName().substring(2, 6));
	}
