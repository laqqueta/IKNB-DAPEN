...
public enum ER2518PosRbPpu100202 implements IObject<KeyValueString> {
...
//	R_10020203000000 ("10020203000000", "EKUITAS"),
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER2518PosRbPpu100202 eEnum : ER2518PosRbPpu100202.values()) {
	...
	public static String getName() {
		return ER2518PosRbPpu100202.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER2518PosRbPpu100202.class.getSimpleName().substring(2, 6));
	}
