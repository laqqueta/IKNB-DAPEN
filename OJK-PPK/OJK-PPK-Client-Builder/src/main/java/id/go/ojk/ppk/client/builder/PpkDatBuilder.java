...
import id.go.ojk.ppk.client.builder.field.EUpdateHeader;
import id.go.ojk.ppk.client.builder.field.setup.ESetupKeyValueStringFilename;
import lombok.extern.slf4j.Slf4j;

@Slf4j
public class PpkDatBuilder extends BaseDatBuilder {
	private static final EReport REPORT_RB = EReport.RB_PPK;
	private static final EReport REPORT_RB_UUS = EReport.RB_PPU;
	private static final EReport REPORT_SA = EReport.SA_PPK;
	private static final EReport REPORT_SA_UUS = EReport.SA_PPU;
	private static final EReport REPORT_APU = EReport.APU_PPK;
	private static final String DUMMY_USER = "ppkdummy@gmail.com";

	public static void main(String[] args) {
		try {
			log.info("starting builder");
			PpkDatBuilder builder = new PpkDatBuilder(args);
			builder.setLjkCodeMinLen(6);
			builder.setLjkCodeMaxLen(6);
			builder.buildAll();
	...
	public PpkDatBuilder(String[] args) {
	...
	protected String genDummyClientEntity() {
		return genDummyClientEntity(Constant.SECTOR.getCode(), Arrays.asList("251030", "299998"), DUMMY_USER);
	}
