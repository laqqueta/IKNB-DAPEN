...
public enum ER2773PosRePpu120100 implements IObject<KeyValueString> {
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER2773PosRePpu120100 eEnum : ER2773PosRePpu120100.values()) {
	...
	public static String getName() {
		return ER2773PosRePpu120100.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER2773PosRePpu120100.class.getSimpleName().substring(2, 6));
	}
