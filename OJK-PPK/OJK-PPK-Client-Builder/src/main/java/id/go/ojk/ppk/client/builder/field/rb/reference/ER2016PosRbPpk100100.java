...
public enum ER2016PosRbPpk100100 implements IObject<KeyValueString> {
...
//	R_10010200000000 ("10010200000000", "Asumsi Mikro:"),
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER2016PosRbPpk100100 eEnum : ER2016PosRbPpk100100.values()) {
	...
	public static String getName() {
		return ER2016PosRbPpk100100.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER2016PosRbPpk100100.class.getSimpleName().substring(2, 6));
	}
	...
	public static SegmentValidation genValidationNumericDotOpt() {
		return UtilSegmentValidation.genRegexNumericDotOpt("3|4|5|6",
