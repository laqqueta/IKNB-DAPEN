...
public enum ER2269PosRePpk100401 implements IObject<KeyValueString> {
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER2269PosRePpk100401 eEnum : ER2269PosRePpk100401.values()) {
	...
	public static String getName() {
		return ER2269PosRePpk100401.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER2269PosRePpk100401.class.getSimpleName().substring(2, 6));
	}
	...
	public static SegmentValidation genValidationFormKasDanSetaraKasPadaAkhirPeriode() {
		...
		return UtilSegmentValidation.genEqualsForm2("2|3", R_10040107000000.key, comparatorFormCode, 
				ER2267PosRePpk100201.R_10020101010000.getKey(), 
