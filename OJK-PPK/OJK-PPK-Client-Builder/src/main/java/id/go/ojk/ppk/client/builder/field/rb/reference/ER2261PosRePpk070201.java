...
public enum ER2261PosRePpk070201 implements IObject<KeyValueString> {
...
//	R_07020102000000 ("07020102000000", "Saldo Penerimaan Pendanaan (Outstanding):"),
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER2261PosRePpk070201 eEnum : ER2261PosRePpk070201.values()) {
	...
	public static String getName() {
		return ER2261PosRePpk070201.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER2261PosRePpk070201.class.getSimpleName().substring(2, 6));
	}
	...
	public static SegmentValidation genValidationFormPenerimaanPendanaanBaru() {
		String comparatorFormCode = EFormRealisasiBisnis.RE_070101.getCode();
		return UtilSegmentValidation.genEqualsForm2("2|3", R_07020101050000.key, comparatorFormCode, 
				ER2260PosRePpk070101.R_07010101090000.getKey(), 
	...
	public static SegmentValidation genValidationFormSaldoPenerimaanPendanaan() {
		...
		return UtilSegmentValidation.genEqualsForm2("2|3", R_07020102050000.key, comparatorFormCode, 
				ER2260PosRePpk070101.R_07010102090000.getKey(), 
				"Total Saldo Penerimaan Pendanaan|Total Saldo Penerimaan Pendanaan form " + comparatorFormCode + " #kolom#");
	}
