...
public enum ER2761PosRePpu070201 implements IObject<KeyValueString> {
...
//	R_07020102000000 ("07020102000000", "Saldo Penerimaan Pendanaan (Outstanding):"),
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER2761PosRePpu070201 eEnum : ER2761PosRePpu070201.values()) {
	...
	public static String getName() {
		return ER2761PosRePpu070201.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER2761PosRePpu070201.class.getSimpleName().substring(2, 6));
	}
	...
	public static SegmentValidation genValidationFormPenerimaanPendanaanBaru() {
		String comparatorFormCode = EFormRealisasiBisnisUus.RE_070102.getCode();
		return UtilSegmentValidation.genEqualsForm2("2|3", R_07020101050000.key, comparatorFormCode, 
				ER2760PosRePpu070102.R_07010201090000.getKey(), "Total Penerimaan Pendanaan Baru|Total Penerimaan Pendanaan Baru form " + comparatorFormCode + " #kolom#");
	}
	...
	public static SegmentValidation genValidationFormSaldoPenerimaanPendanaan() {
		...
		return UtilSegmentValidation.genEqualsForm2("2|3", R_07020102050000.key, comparatorFormCode, 
				ER2760PosRePpu070102.R_07010202090000.getKey(), "Total Saldo Penerimaan Pendanaan|Total Saldo Penerimaan Pendanaan form " + comparatorFormCode + " #kolom#");
	}

	public static SegmentValidation genValidationTotalPenerimaanPendanaanBaru() {
		return UtilSegmentValidation.genEqualsFormula("2|3", R_07020101050000.key,
	...
	public static SegmentValidation genValidationTotalSaldoPenerimaanPendanaan() {
		return UtilSegmentValidation.genEqualsFormula("2|3", R_07020102050000.key,
