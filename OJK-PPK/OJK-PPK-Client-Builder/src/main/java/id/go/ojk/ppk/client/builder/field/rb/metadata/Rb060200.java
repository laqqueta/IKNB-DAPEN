...
import id.go.ojk.ppk.client.builder.field.rb.reference.ER2009PosRbPpk060200;
...
public class Rb060200 extends BaseMetadata {
	...
	public SubmissionFormat get() {
		...
		SubmissionFormat res = new SubmissionFormat(eEnum.getCode(), eEnum.getName(), reportCode, new ArrayList<>(),
				extension, 4, null, null, null, ER2009PosRbPpk060200.getRequiredPos());
		...
		fs.add(sf(2, null, "Nama Pemegang Saham",
				sv(C, 0, 200, all).confConditionalRequired(ER2009PosRbPpk060200.genConditionalFieldMustEmpty())));
		fs.add(sf(3, null, "Kategori Pemegang Saham",
				sv(C, 0, 5, refTable).confReference(EHeaderMetadataShared.R003.getObject())
						.confConditionalRequired(ER2009PosRbPpk060200.genConditionalFieldMustEmpty())));
