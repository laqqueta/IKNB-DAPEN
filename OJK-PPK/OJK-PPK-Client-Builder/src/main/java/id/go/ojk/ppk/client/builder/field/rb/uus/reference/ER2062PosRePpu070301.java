...
public enum ER2062PosRePpu070301 implements IObject<KeyValueString> {
...
//	R_07030102000000 ("07030102000000", "Saldo Penerimaan Pendanaan (Outstanding):"),
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER2062PosRePpu070301 eEnum : ER2062PosRePpu070301.values()) {
	...
	public static String getName() {
		return ER2062PosRePpu070301.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER2062PosRePpu070301.class.getSimpleName().substring(2, 6));
	}
