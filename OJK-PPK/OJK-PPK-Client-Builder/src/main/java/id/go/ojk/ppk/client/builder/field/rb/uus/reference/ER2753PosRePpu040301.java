...
public enum ER2753PosRePpu040301 implements IObject<KeyValueString> {
	R_04030101000000 ("04030101000000", "Detail"), 
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER2753PosRePpu040301 eEnum : ER2753PosRePpu040301.values()) {
	...
	public static String getName() {
		return ER2753PosRePpu040301.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER2753PosRePpu040301.class.getSimpleName().substring(2, 6));
	}
	...
	public static FieldValidation genValidationSum() {
		return UtilFieldValidation.genEqualsPosFormula("6-5", 2, UtilMetadata.genPipeRow(getObjects(), 0, 2));
	}
