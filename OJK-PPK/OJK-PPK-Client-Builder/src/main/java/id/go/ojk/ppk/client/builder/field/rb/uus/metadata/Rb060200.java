...
import id.go.ojk.ppk.client.builder.field.rb.uus.reference.ER2509PosRbPpu060200;
...
public class Rb060200 extends BaseMetadata {
	...
	public SubmissionFormat get() {
		EFormRencanaBisnisUus eEnum = EFormRencanaBisnisUus.RB_060200;
		SubmissionFormat res = new SubmissionFormat(eEnum.getCode(), eEnum.getName(), reportCode, new ArrayList<>(),
				extension, 4, null, null, null, ER2509PosRbPpu060200.getRequiredPos());
		List<SubmissionField> fs = res.getFields();
		fs.add(sf(0, null, "Flag Detail", sv(M, 3, 3, alfaNumeric).confConstant("D01")));
		fs.add(sf(1, null, "Kode Komponen / Baris",
				sv(M, 14, 14, refTable).confReference(EHeaderMetadataRbUus.R2509_RB060200.getObject())));
		fs.add(sf(2, null, "Nama Pemegang Saham",
				sv(C, 0, 160, all).confConditionalRequired(ER2509PosRbPpu060200.genConditionalFieldMustEmpty())));
		fs.add(sf(3, null, "Kategori Pemegang Saham",
				sv(C, 0, 5, refTable).confReference(EHeaderMetadataShared.R003.getObject())
						.confConditionalRequired(ER2509PosRbPpu060200.genConditionalFieldMustEmpty())));
