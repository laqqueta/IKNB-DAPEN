...
public enum ER2004PosRbPpk040401 implements IObject<KeyValueString> {
...
//	R_04040102000000 ("04040102000000", "Saldo Piutang Pembiayaan (Outstanding Principal):"),
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER2004PosRbPpk040401 eEnum : ER2004PosRbPpk040401.values()) {
	...
	public static String getName() {
		return ER2004PosRbPpk040401.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER2004PosRbPpk040401.class.getSimpleName().substring(2, 6));
	}
	...
	public static SegmentValidation genValidationFormRencanaPenyaluranPembiayaanBaru() {
		String comparatorFormCode = EFormRencanaBisnis.RB_040101.getCode();
		return UtilSegmentValidation.genEqualsForm2("2|3|4|5", R_04040101030000.key, comparatorFormCode, 
				ER2001PosRbPpk040101.R_04010101050000.getKey(), 
	...
	public static SegmentValidation genValidationFormSaldoPiutangPembiayaan() {
		...
		return UtilSegmentValidation.genEqualsForm2("2|3|4|5", R_04040102030000.key, comparatorFormCode, 
				ER2001PosRbPpk040101.R_04010102050000.getKey(), 
