...
public enum ER2760PosRePpu070102 implements IObject<KeyValueString> {
...
//	R_07010202000000 ("07010202000000", "Saldo Penerimaan Pendanaan (Outstanding):"),
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER2760PosRePpu070102 eEnum : ER2760PosRePpu070102.values()) {
	...
	public static String getName() {
		return ER2760PosRePpu070102.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER2760PosRePpu070102.class.getSimpleName().substring(2, 6));
	}
