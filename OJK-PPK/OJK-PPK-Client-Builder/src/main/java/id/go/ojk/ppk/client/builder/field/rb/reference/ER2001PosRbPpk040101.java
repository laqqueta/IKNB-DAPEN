...
public enum ER2001PosRbPpk040101 implements IObject<KeyValueString> {
//	R_04010101000000 ("04010101000000", "Rencana Penyaluran Pembiayaan Baru:"),
	R_04010101010000 ("04010101010000", "A Pembiayaan Investasi"), 
	...
	R_04010101020500 ("04010101020500",
			"Pembiayaan Lain Setelah Terlebih Dahulu Mendapatkan Persetujuan dari Otoritas Jasa Keuangan"),
	R_04010101030000 ("04010101030000", "Pembiayaan Multiguna"), R_04010101030100 ("04010101030100", "Sewa Pembiayaan"),
...
//	R_04010102000000 ("04010102000000", "Saldo Piutang Pembiayaan (Outstanding Principal):"),
	R_04010102010000 ("04010102010000", "B Pembiayaan Investasi"), 
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER2001PosRbPpk040101 eEnum : ER2001PosRbPpk040101.values()) {
	...
	public static String getName() {
		return ER2001PosRbPpk040101.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER2001PosRbPpk040101.class.getSimpleName().substring(2, 6));
	}
	...
	public static SegmentValidation genValidationPembiayaanInvestasiA() {
		return UtilSegmentValidation.genEqualsFormula("2|3|4|5", R_04010101010000.key,
	...
	public static SegmentValidation genValidationPembiayaanModalKerjaA() {
		return UtilSegmentValidation.genEqualsFormula("2|3|4|5", R_04010101020000.key,
	...
	public static SegmentValidation genValidationPembiayaanMultigunaA() {
		return UtilSegmentValidation.genEqualsFormula("2|3|4|5", R_04010101030000.key,
	...
	public static SegmentValidation genValidationTotalRencanaPenyaluranPembiayaanBaru() {
		return UtilSegmentValidation.genEqualsFormula("2|3|4|5", R_04010101050000.key,
