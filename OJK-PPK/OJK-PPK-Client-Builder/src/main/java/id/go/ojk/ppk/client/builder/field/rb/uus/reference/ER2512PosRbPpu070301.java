...
public enum ER2512PosRbPpu070301 implements IObject<KeyValueString> {
...
//	R_07030102000000 ("07030102000000", "Saldo Penerimaan Pendanaan (Outstanding):"),
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER2512PosRbPpu070301 eEnum : ER2512PosRbPpu070301.values()) {
	...
	public static String getName() {
		return ER2512PosRbPpu070301.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER2512PosRbPpu070301.class.getSimpleName().substring(2, 6));
	}
	...
	public static SegmentValidation genValidationFormPenerimaanPendanaanBaru() {
		String comparatorFormCode = EFormRencanaBisnisUus.RB_070102.getCode();
		return UtilSegmentValidation.genEqualsForm2("2|3|4|5", R_07030101070000.key, comparatorFormCode, 
				ER2510PosRbPpu070102.R_07010201090000.getKey(), "Total Penerimaan Pendanaan Baru|Total Penerimaan Pendanaan Baru form " + comparatorFormCode + " #kolom#");
	}

	public static SegmentValidation genValidationFormSaldoPenerimaanPendanaan() {
		String comparatorFormCode = EFormRencanaBisnisUus.RB_070102.getCode();
		return UtilSegmentValidation.genEqualsForm2("2|3|4|5", R_07030102070000.key, comparatorFormCode, 
				ER2510PosRbPpu070102.R_07010202090000.getKey(), "Total Saldo Penerimaan Pendanaan|Total Saldo Penerimaan Pendanaan form " + comparatorFormCode + " #kolom#");
	}

	public static SegmentValidation genValidationTotalPenerimaanPendanaanBaru() {
		return UtilSegmentValidation.genEqualsFormula("2|3|4|5", R_07030101070000.key,
	...
	public static SegmentValidation genValidationTotalSaldoPenerimaanPendanaan() {
		return UtilSegmentValidation.genEqualsFormula("2|3|4|5", R_07030102070000.key,
