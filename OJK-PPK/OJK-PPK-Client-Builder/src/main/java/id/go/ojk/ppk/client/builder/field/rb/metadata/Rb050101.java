...
import id.go.ojk.ppk.client.builder.field.rb.reference.ER2006PosRbPpk050101;
...
public class Rb050101 extends BaseMetadata {
	...
	public SubmissionFormat get() {
		...
		fs.add(sf(3, null, "Deskripsi Umum Kegiatan Usaha",
				sv(C, 0, 1000, all).confConditionalRequired(ER2006PosRbPpk050101.genConditionalField())));
		fs.add(sf(4, null, "Waktu Pelaksanaan Kegiatan Usaha Baru",
				sv(C, 0, 8, date).confConditionalRequired(ER2006PosRbPpk050101.genConditionalField())));
