...
public enum ER2020PosRbPpk100501 implements IObject<KeyValueString> {
	...
	R_10050105010000 ("10050105010000", "Interest Rate Swap"), 
	R_10050105020000 ("10050105020000", "Currency Swap"),
	R_10050105030000 ("10050105030000", "Cross Currency Swap"), 
	R_10050105040000 ("10050105040000", "Forward"),
	R_10050105050000 ("10050105050000", "Option"), 
	R_10050105060000 ("10050105060000", "Future"),
	R_10050105070000 ("10050105070000", "Lainnya"), 
	R_10050106000000 ("10050106000000", "Rekening Administratif Lainnya"),
	...
	R_10050106030000 ("10050106030000", "Piutang Pembiayaan Hapus Tagih"), 
	R_10050107000000 ("10050107000000", "Jumlah"),;
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER2020PosRbPpk100501 eEnum : ER2020PosRbPpk100501.values()) {
	...
	public static String getName() {
		return ER2020PosRbPpk100501.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER2020PosRbPpk100501.class.getSimpleName().substring(2, 6));
	}
