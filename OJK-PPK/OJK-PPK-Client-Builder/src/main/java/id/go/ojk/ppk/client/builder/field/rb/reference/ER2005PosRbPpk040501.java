...
public enum ER2005PosRbPpk040501 implements IObject<KeyValueString> {
...
//	R_04050102000000 ("04050102000000", "Saldo Piutang Pembiayaan (Outstanding Principal):"),
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER2005PosRbPpk040501 eEnum : ER2005PosRbPpk040501.values()) {
	...
	public static String getName() {
		return ER2005PosRbPpk040501.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER2005PosRbPpk040501.class.getSimpleName().substring(2, 6));
	}
