...
import id.go.ojk.ppk.client.builder.field.sa.reference.ER4001PosSaPpk060301;
...
public class Sa060301 extends BaseMetadata {
	...
	public SubmissionFormat get() {
		...
		SubmissionFormat res = new SubmissionFormat(eEnum.getCode(), eEnum.getName(), reportCode, new ArrayList<>(),
				extension, 9, 9, null, null, ER4001PosSaPpk060301.getRequiredPos());
		...
		fs.add(sf(2, null, "Individu - Peringkat Risiko Inheren", sv(M, 1, 1, numeric))
				.addFieldValidations(ER4001PosSaPpk060301.genValidationPeringkat()));
