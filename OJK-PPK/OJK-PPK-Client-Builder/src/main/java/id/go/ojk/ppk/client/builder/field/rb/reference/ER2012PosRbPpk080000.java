...
public enum ER2012PosRbPpk080000 implements IObject<KeyValueString> {
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER2012PosRbPpk080000 eEnum : ER2012PosRbPpk080000.values()) {
	...
	public static String getName() {
		return ER2012PosRbPpk080000.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER2012PosRbPpk080000.class.getSimpleName().substring(2, 6));
	}
