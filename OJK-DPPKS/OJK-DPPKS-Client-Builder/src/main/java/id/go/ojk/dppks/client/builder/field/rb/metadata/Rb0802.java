...
import id.go.ojk.dppks.client.builder.field.rb.reference.ER2010PosRbDppks0802;
...
public class Rb0802 extends BaseMetadata {
	...
	public SubmissionFormat get() {
		...
		SubmissionFormat res = new SubmissionFormat(eEnum.getCode(), eEnum.getName(), reportCode, new ArrayList<>(),
				extension, 5, 5, ER2010PosRbDppks0802.genFieldSave(), null, ER2010PosRbDppks0802.getRequiredPos());
		res.addSegmentValidations(ER2010PosRbDppks0802.genValidationDanaIuran());
