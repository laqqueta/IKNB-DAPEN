...
import id.go.ojk.dppks.client.builder.field.sa.reference.ER4006PosSaDpps0500;
...
public class Sa0500 extends BaseMetadata {
	...
	public SubmissionFormat get() {
		...
		SubmissionFormat res = new SubmissionFormat(eEnum.getCode(), eEnum.getName(), reportCode, new ArrayList<>(),
				extension, 2, 2, ER4006PosSaDpps0500.getRequiredPos(), true);
		...
		fs.add(sf(2, null, "Peringkat - Individu", sv(M, 1, 1, numeric))
				.addFieldValidations(ER4006PosSaDpps0500.genValidationPeringkat()));
