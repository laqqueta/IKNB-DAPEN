...
public enum ER2010PosRbDppks0802 implements IObject<KeyValueString> {
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER2010PosRbDppks0802 eEnum : ER2010PosRbDppks0802.values()) {
	...
	public static String getName() {
		return ER2010PosRbDppks0802.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER2010PosRbDppks0802.class.getSimpleName().substring(2, 6));
	}
