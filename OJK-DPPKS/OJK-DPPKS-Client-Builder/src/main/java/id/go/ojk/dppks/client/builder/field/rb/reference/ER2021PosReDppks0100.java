...
public enum ER2021PosReDppks0100 implements IObject<KeyValueString> {
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER2021PosReDppks0100 eEnum : ER2021PosReDppks0100.values()) {
	...
	public static String getName() {
		return ER2021PosReDppks0100.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER2021PosReDppks0100.class.getSimpleName().substring(2, 6));
	}
	...
	public static SegmentValidation genValidationTahunRencanaBisnisA() {
		return UtilSegmentValidation.genRegexDate("2", R_0109000000.key, "yyyy");
	}
	...
	public static SegmentValidation genValidationMaxLength300() {
		return UtilSegmentValidation.genMaxLength("2", R_0108000000.key, 300);
	}
}
