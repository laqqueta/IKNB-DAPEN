...
import id.go.ojk.dppks.client.builder.field.rb.reference.ER2006PosRbDppks0701;
...
public class Rb0701 extends BaseMetadata {
	...
	public SubmissionFormat get() {
		...
		SubmissionFormat res = new SubmissionFormat(eEnum.getCode(), eEnum.getName(), reportCode, new ArrayList<>(),
				extension, 21, 21, ER2006PosRbDppks0701.genFieldSave(), null, ER2006PosRbDppks0701.getRequiredPos());
		res.addSegmentValidations(ER2006PosRbDppks0701.genValidationInvestasi());
		res.addSegmentValidations(ER2006PosRbDppks0701.genValidationRatioInvestasi3());
		res.addSegmentValidations(ER2006PosRbDppks0701.genValidationRatioInvestasi5());
		res.addSegmentValidations(ER2006PosRbDppks0701.genValidationRatioInvestasi7());
		res.addSegmentValidations(ER2006PosRbDppks0701.genValidationRatioInvestasi9());
		res.addSegmentValidations(ER2006PosRbDppks0701.genValidationRatioInvestasi());
		res.addSegmentValidations(ER2006PosRbDppks0701.genValidationFixedValue());
