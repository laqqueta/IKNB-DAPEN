...
public enum ER2008PosRbDppks0703 implements IObject<KeyValueString> {
//	R_0703000000 ("0703000000", "INVESTASI"),
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER2008PosRbDppks0703 eEnum : ER2008PosRbDppks0703.values()) {
	...
	public static String getName() {
		return ER2008PosRbDppks0703.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER2008PosRbDppks0703.class.getSimpleName().substring(2, 6));
	}
