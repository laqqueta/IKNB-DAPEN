...
public enum ER2018PosRbDppks1203 implements IObject<KeyValueString> {
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER2018PosRbDppks1203 eEnum : ER2018PosRbDppks1203.values()) {
	...
	public static String getName() {
		return ER2018PosRbDppks1203.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER2018PosRbDppks1203.class.getSimpleName().substring(2, 6));
	}
