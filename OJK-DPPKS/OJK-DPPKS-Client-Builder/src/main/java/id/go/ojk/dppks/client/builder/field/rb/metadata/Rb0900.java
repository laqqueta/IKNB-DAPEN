...
import id.go.ojk.dppks.client.builder.field.rb.reference.ER2011PosRbDppks0900;
...
public class Rb0900 extends BaseMetadata {
	...
	public SubmissionFormat get() {
		...
		fs.add(sf(3, null, "Waktu Pelaksanaan",
				sv(C, 0, 6, yearMonth).confConditionalRequired(ER2011PosRbDppks0900.genConditionalAllExist())));
		fs.add(sf(4, null, "Lokasi",
				sv(C, 0, 200, all).confConditionalRequired(ER2011PosRbDppks0900.genConditionalAllExist())));
		fs.add(sf(5, null, "Keterangan",
				sv(C, 0, 300, all).confConditionalRequired(ER2011PosRbDppks0900.genConditionalAllExist())));
		return res;
	}
}
