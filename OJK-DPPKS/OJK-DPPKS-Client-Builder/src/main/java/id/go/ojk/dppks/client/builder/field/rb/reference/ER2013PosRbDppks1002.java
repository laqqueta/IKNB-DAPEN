...
public enum ER2013PosRbDppks1002 implements IObject<KeyValueString> {
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER2013PosRbDppks1002 eEnum : ER2013PosRbDppks1002.values()) {
	...
	public static String getName() {
		return ER2013PosRbDppks1002.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER2013PosRbDppks1002.class.getSimpleName().substring(2, 6));
	}
