...
import id.go.ojk.dppks.client.builder.field.sa.reference.ER4000PosSaDpps0100;
...
public class Sa0100 extends BaseMetadata {
	...
	public SubmissionFormat get() {
		...
		SubmissionFormat res = new SubmissionFormat(eEnum.getCode(), eEnum.getName(), reportCode, new ArrayList<>(),
				extension, 6, 6, ER4000PosSaDpps0100.getRequiredPos(), true);
		...
		fs.add(sf(2, null, "Peringkat - Individu", sv(M, 1, 1, numeric))
				.addFieldValidations(ER4000PosSaDpps0100.genValidationPeringkat()));
