package id.go.ojk.dppks.client.builder.field.tl.reference;
...
public enum ER5000PosTlDppks0100 implements IObject<KeyValueString> {
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER5000PosTlDppks0100 eEnum : ER5000PosTlDppks0100.values()) {
	...
	public static String getName() {
		return ER5000PosTlDppks0100.class.getSimpleName().substring(6);
	}

	public static int getRefNumber() {
		return Integer.parseInt(ER5000PosTlDppks0100.class.getSimpleName().substring(2, 6));
	}
