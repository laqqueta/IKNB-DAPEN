...
public enum ER2017PosRbDppks1202 implements IObject<KeyValueString> {
...
//	R_1202030000 ("1202030000", "PENGURANGAN"),
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER2017PosRbDppks1202 eEnum : ER2017PosRbDppks1202.values()) {
	...
	public static String getName() {
		return ER2017PosRbDppks1202.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER2017PosRbDppks1202.class.getSimpleName().substring(2, 6));
	}
	...
	public static SegmentValidation genValidationKenaikanAsetNeto() {
		return UtilSegmentValidation.genEqualsFormula("2|3|4|5", R_1202050000.key,
				R_1202020000.key + "-" + R_1202040000.key,
	...
	public static SegmentValidation genValidationAsetNetoAkhirPeriode() {
		return UtilSegmentValidation.genEqualsFormula("2|3|4|5", R_1202070000.key,
				R_1202050000.key + "+" + R_1202060000.key,
