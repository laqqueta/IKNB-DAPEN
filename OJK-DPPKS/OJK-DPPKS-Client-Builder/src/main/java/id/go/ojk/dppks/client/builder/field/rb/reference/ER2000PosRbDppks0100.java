...
public enum ER2000PosRbDppks0100 implements IObject<KeyValueString> {
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER2000PosRbDppks0100 eEnum : ER2000PosRbDppks0100.values()) {
	...
	public static String getName() {
		return ER2000PosRbDppks0100.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER2000PosRbDppks0100.class.getSimpleName().substring(2, 6));
	}
	...
	public static SegmentValidation genValidationMaxLength4() {
		return UtilSegmentValidation.genMaxLength("2", R_0103000000 + "|" + R_0109000000.key, 4);
	}
