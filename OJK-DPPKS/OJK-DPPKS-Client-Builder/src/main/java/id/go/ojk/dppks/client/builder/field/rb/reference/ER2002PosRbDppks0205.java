...
public enum ER2002PosRbDppks0205 implements IObject<KeyValueString> {
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER2002PosRbDppks0205 eEnum : ER2002PosRbDppks0205.values()) {
	...
	public static String getName() {
		return ER2002PosRbDppks0205.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER2002PosRbDppks0205.class.getSimpleName().substring(2, 6));
	}
