...
public enum ER2003PosRbDppks0301 implements IObject<KeyValueString> {
...
//	R_0301040000 ("0301040000", "Iuran:"),
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER2003PosRbDppks0301 eEnum : ER2003PosRbDppks0301.values()) {
	...
	public static String getName() {
		return ER2003PosRbDppks0301.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER2003PosRbDppks0301.class.getSimpleName().substring(2, 6));
	}
