...
import id.go.ojk.dppks.client.builder.field.sa.reference.ER4005PosSaDpps0400;
...
public class Sa0400 extends BaseMetadata {
	...
	public SubmissionFormat get() {
		...
		SubmissionFormat res = new SubmissionFormat(eEnum.getCode(), eEnum.getName(), reportCode, new ArrayList<>(),
				extension, 2, 2, ER4005PosSaDpps0400.getRequiredPos(), true);
		...
		fs.add(sf(2, null, "Peringkat - Individu", sv(M, 1, 1, numeric))
				.addFieldValidations(ER4005PosSaDpps0400.genValidationPeringkat()));
