...
import id.go.ojk.dppks.client.builder.field.rb.reference.ER2007PosRbDppks0702;
...
public class Rb0702 extends BaseMetadata {
	...
	public SubmissionFormat get() {
		...
		SubmissionFormat res = new SubmissionFormat(eEnum.getCode(), eEnum.getName(), reportCode, new ArrayList<>(),
				extension, 21, 21, ER2007PosRbDppks0702.genFieldSave(), null, ER2007PosRbDppks0702.getRequiredPos());
		res.addSegmentValidations(ER2007PosRbDppks0702.genValidationInvestasi());
		res.addSegmentValidations(ER2007PosRbDppks0702.genValidationRatioInvestasi3());
		res.addSegmentValidations(ER2007PosRbDppks0702.genValidationRatioInvestasi5());
		res.addSegmentValidations(ER2007PosRbDppks0702.genValidationRatioInvestasi7());
		res.addSegmentValidations(ER2007PosRbDppks0702.genValidationRatioInvestasi9());
		res.addSegmentValidations(ER2007PosRbDppks0702.genValidationRatioInvestasi());
		res.addSegmentValidations(ER2007PosRbDppks0702.genValidationFixedValue());
