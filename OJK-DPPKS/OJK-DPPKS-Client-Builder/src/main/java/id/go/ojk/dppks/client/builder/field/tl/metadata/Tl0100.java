package id.go.ojk.dppks.client.builder.field.tl.metadata;
...
import id.go.ojk.dppks.client.builder.field.EFormTindakLanjut;
import id.go.ojk.dppks.client.builder.field.tl.reference.EHeaderMetadataTl;
import id.go.ojk.dppks.client.builder.field.tl.reference.ER5000PosTlDppks0100;
...
public class Tl0100 extends BaseMetadata {
	...
	public SubmissionFormat get() {
		...
		fs.add(sf(1, null, "Kode Komponen / Baris", sv(M, 10, 10, refTable)
				.confReference(EHeaderMetadataTl.R5000_TL0100.getObject())
		...
		fs.add(sf(3, null, "Ringkasan Rekomendasi OJK", sv(C, 1, 5000, all)
				.confConditionalRequired(ER5000PosTlDppks0100.genConditionalExist03())));
		fs.add(sf(4, null, "Ringkasan Tindak Lanjut Dana Pensiun", sv(C, 1, 5000, all)
				.confConditionalRequired(ER5000PosTlDppks0100.genConditionalExist04())));
		fs.add(sf(5, null, "Tanggal Jatuh Tempo Rekomendasi", sv(C, 8, 8, DataType.date)
				.confConditionalRequired(ER5000PosTlDppks0100.genConditionalExist05())));
		return res;
	}
}
