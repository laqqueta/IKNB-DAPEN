...
import id.go.ojk.dppks.client.builder.field.rb.reference.ER2008PosRbDppks0703;
...
public class Rb0703 extends BaseMetadata {
	...
	public SubmissionFormat get() {
		...
		SubmissionFormat res = new SubmissionFormat(eEnum.getCode(), eEnum.getName(), reportCode, new ArrayList<>(),
				extension, 21, 21, ER2008PosRbDppks0703.genFieldSave(), null, ER2008PosRbDppks0703.getRequiredPos());
		res.addSegmentValidations(ER2008PosRbDppks0703.genValidationTotal());
		...
		fs.add(sf(5, null, "Hasil Investasi Bersih Aktual Per 30 Sept 20XX-1", sv(M, 1, 20, numericNegatif))
				.addFieldValidations(ER2008PosRbDppks0703.genValidation5()));
		...
		fs.add(sf(9, null, "Hasil Investasi Bersih Proyeksi Per 31 Des 20XX-1", sv(M, 1, 20, numericNegatif))
				.addFieldValidations(ER2008PosRbDppks0703.genValidation9()));
		...
		fs.add(sf(13, null, "Hasil Investasi Bersih Proyeksi Per 30 Jun 20XX", sv(M, 1, 20, numericNegatif))
				.addFieldValidations(ER2008PosRbDppks0703.genValidation13()));
		...
		fs.add(sf(17, null, "Hasil Investasi Bersih Proyeksi Per 31 Des 20XX", sv(M, 1, 20, numericNegatif))
				.addFieldValidations(ER2008PosRbDppks0703.genValidation17()));
		return res;
	}
}
