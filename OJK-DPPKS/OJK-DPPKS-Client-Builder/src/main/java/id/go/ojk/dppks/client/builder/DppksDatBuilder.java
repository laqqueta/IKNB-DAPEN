...
import id.go.ojk.dppks.client.builder.field.EUpdateHeader;
import id.go.ojk.dppks.client.builder.field.setup.ESetupKeyValueStringFilename;
import id.go.ojk.lib.client.model.update.UpdateHeader;
import lombok.extern.slf4j.Slf4j;

@Slf4j
public class DppksDatBuilder extends BaseDatBuilder {
	private static final EReport REPORT_RB = EReport.RB_DPPKS;
	private static final EReport REPORT_SA = EReport.SA_DPPKS;
	private static final EReport REPORT_TL = EReport.TL_DPPKS;
	private static final EReport REPORT_LKTB = EReport.LKBT_DPPKS;
	private static final List<String> DUMMY_USER = Arrays.asList("airdev.test03@gmail.com", "dppksdummy@gmail.com", "apolo.sit008@gmail.com", "apolo.sit006@gmail.com");

	public static void main(String[] args) {
		try {
			log.info("starting builder");
			DppksDatBuilder builder = new DppksDatBuilder(args);
	...
	public DppksDatBuilder(String[] args) {
	...
	protected String genDummyClientEntity() {
		return genDummyClientEntity(Constant.SECTOR.getCode(), Arrays.asList("2000004778", "1403202201"), DUMMY_USER);
	}
