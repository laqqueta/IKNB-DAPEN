...
public enum ER2022PosReDppks0200 implements IObject<KeyValueString> {
...
//	R_0203000000 ("0203000000", "LIABILITAS"),
	...
	R_0204000000 ("0204000000", "Total Liabilitas di Luar Nilai Kini Aktuarial"),
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER2022PosReDppks0200 eEnum : ER2022PosReDppks0200.values()) {
	...
	public static String getName() {
		return ER2022PosReDppks0200.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER2022PosReDppks0200.class.getSimpleName().substring(2, 6));
	}
	...
	public static SegmentValidation genValidationAsetNeto() {
		return UtilSegmentValidation.genEqualsFormula("2|3", R_0206000000.key,
				R_0202000000.key + "-" + R_0205000000.key, 
