...
public enum ER2025PosReDppks0500 implements IObject<KeyValueString> {
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER2025PosReDppks0500 eEnum : ER2025PosReDppks0500.values()) {
	...
	public static String getName() {
		return ER2025PosReDppks0500.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER2025PosReDppks0500.class.getSimpleName().substring(2, 6));
	}
