...
public enum ER2023PosReDppks0300 implements IObject<KeyValueString> {
//	R_0301000000 ("0301000000", "PENAMBAHAN"),
//	R_0301010000 ("0301010000", "Pendapatan Investasi"),
	R_0301010100 ("0301010100", "Bagi Hasil "),
	...
	R_0301020000 ("0301020000", "Total Pendapatan Investasi"),
	R_0301030000 ("0301030000", "Peningkatan (Penurunan) Nilai Investasi "),
	R_0301040000 ("0301040000", "Iuran Jatuh Tempo:"),
	R_0301040100 ("0301040100", "- Iuran Normal Pemberi Kerja"),
	R_0301040200 ("0301040200", "- Iuran Normal Peserta"),
	R_0301040300 ("0301040300", "- Iuran Sukarela Peserta"),
	R_0301040400 ("0301040400", "- Iuran Tambahan"),
	R_0301050000 ("0301050000", "Pendapatan di Luar Investasi "),
	R_0301060000 ("0301060000", "Pengalihan Dana Dari Dana Pensiun Lain "),
...
//	R_0303000000 ("0303000000", "PENGURANGAN"),
	...
	R_0304000000 ("0304000000", "Jumlah Pengurangan"),
	R_0305000000 ("0305000000", "KENAIKAN (PENURUNAN) ASET NETO"),
	R_0306000000 ("0306000000", "ASET NETO AWAL PERIODE"),
	R_0307000000 ("0307000000", "ASET NETO AKHIR PERIODE"),
	;
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER2023PosReDppks0300 eEnum : ER2023PosReDppks0300.values()) {
	...
	public static String getName() {
		return ER2023PosReDppks0300.class.getSimpleName().substring(6);
	}

	public static int getRefNumber() {
		return Integer.parseInt(ER2023PosReDppks0300.class.getSimpleName().substring(2, 6));
	}
	...
	public static SegmentValidation genValidationPendapatanInvestasi() {
		return UtilSegmentValidation.genEqualsFormula("2|3", R_0301020000.key,
	...
	public static SegmentValidation genValidationIuranJatuhTempo() {
		return UtilSegmentValidation.genEqualsFormula("2|3", R_0301040000.key,
				UtilMetadata.genPlusRow(getObjects(), 8, 11), "Total Iuran Jatuh Tempo|Penjumlahan Iuran Jatuh Tempo");
	}
	...
	public static SegmentValidation genValidationPengurangan() {
		return UtilSegmentValidation.genEqualsFormula("2|3", R_0304000000.key,
				UtilMetadata.genPlusRow(getObjects(), 15, 20), "Total Pengurangan|Penjumlahan Pengurangan");
	}
	...
	public static SegmentValidation genValidationKenaikanAsetNeto() {
		return UtilSegmentValidation.genEqualsFormula("2|3", R_0305000000.key,
				R_0302000000.key + "-" + R_0304000000.key, "Total Kenaikan Aset Neto|Penjumlahan Kenaikan Aset Neto");
	}
	...
	public static SegmentValidation genValidationAsetNetoAkhirPeriode() {
		return UtilSegmentValidation.genEqualsFormula("2|3", R_0307000000.key,
				R_0305000000.key + "+" + R_0306000000.key,
