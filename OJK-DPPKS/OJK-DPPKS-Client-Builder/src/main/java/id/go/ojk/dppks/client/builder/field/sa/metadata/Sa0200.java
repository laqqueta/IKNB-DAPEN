...
import id.go.ojk.dppks.client.builder.field.sa.reference.ER4001PosSaDpps0200;
...
public class Sa0200 extends BaseMetadata {
	...
	public SubmissionFormat get() {
		...
		SubmissionFormat res = new SubmissionFormat(eEnum.getCode(), eEnum.getName(), reportCode, new ArrayList<>(),
				extension, 2, 2, ER4001PosSaDpps0200.getRequiredPos(), true);
		...
		fs.add(sf(2, null, "Peringkat - Individu", sv(M, 1, 1, numeric))
				.addFieldValidations(ER4001PosSaDpps0200.genValidationPeringkat()));
