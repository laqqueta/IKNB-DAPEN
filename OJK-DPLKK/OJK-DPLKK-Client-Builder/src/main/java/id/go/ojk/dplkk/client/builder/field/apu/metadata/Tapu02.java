...
import id.go.ojk.dplkk.client.builder.field.apu.reference.ER5001PosApuDplkk02;
...
public class Tapu02 extends BaseMetadata {
	...
	public SubmissionFormat get() {
		...
		SubmissionFormat res = new SubmissionFormat(eEnum.getCode(), eEnum.getName(), reportCode,
				new ArrayList<>(), extension, 24, 24, null, null, ER5001PosApuDplkk02.getRequiredPos());
		...
		fs.add(sf(2, null, "Penilaian", sv(M, 1, 1, numeric))
				.addFieldValidations(ER5001PosApuDplkk02.genValidationPenilaian()));
