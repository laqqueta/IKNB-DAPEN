...
public enum ER2017PosReDplkk0100 implements IObject<KeyValueString> {
	...
	R_0108000000 ("0108000000", "Periode Realisasi Semester"),
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER2017PosReDplkk0100 eEnum : ER2017PosReDplkk0100.values()) {
	...
	public static String getName() {
		return ER2017PosReDplkk0100.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER2017PosReDplkk0100.class.getSimpleName().substring(2, 6));
	}
	
	public static String getRequiredPos() {
		return UtilMetadata.genPipeRow(getObjects(), new int[] { 0, 1, 2, 3, 6, 7, 8 });
	}
	...
	public static SegmentValidation genValidationProgramA() {
		return UtilSegmentValidation.genFixedValue("2", R_0104000000.key, "DPLK");
	}
	
	public static SegmentValidation genValidationProgramB() {
		return UtilSegmentValidation.genRegexAlfaSpace("2", R_0104000000.key);
	}
	
	public static SegmentValidation genValidationProgramMaxLength() {
		return UtilSegmentValidation.genMaxLength("2", R_0104000000.key, 9);
	}
	...
	public static SegmentValidation genValidationPeriodeRealisasiSemesterA() {
		return UtilSegmentValidation.genFixedValue("2", R_0108000000.key, "1|2");
	}
	
	public static SegmentValidation genValidationPeriodeRealisasiSemesterB() {
		return UtilSegmentValidation.genRegexNumeric("2", R_0108000000.key);
	}
	
	public static SegmentValidation genValidationPeriodeRealisasiSemesterMaxLength() {
		return UtilSegmentValidation.genMaxLength("2", R_0108000000.key, 1);
	}
	
	public static SegmentValidation genValidationTahunRencanaBisnisA() {
		return UtilSegmentValidation.genRegexNumeric("2", R_0109000000.key);
	}
	...
	public static SegmentValidation genValidationTahunRencanaBisnisMaxLength() {
		return UtilSegmentValidation.genMaxLength("2", R_0109000000.key, 4);
	}
}
