...
public enum ER2018PosReDplkk0200 implements IObject<KeyValueString> {
...
//	R_0201010000 ("0201010000", "INVESTASI"),
	...
	R_0201011400 ("0201011400", "Dana investasi real estate berbentuk kontrak investasi kolektif"),
...
//	R_0201020000 ("0201020000", "ASET LANCAR DI LUAR INVESTASI"),
	...
	R_0201020200 ("0201020200", "Beban Dibayar di Muka "),
	R_0201020300 ("0201020300", "Piutang Investasi"),
	R_0201020400 ("0201020400", "Piutang Hasil Investasi"),
	R_0201020500 ("0201020500", "Piutang Lain-lain"),
	R_0201020600 ("0201020600", "TOTAL ASET LANCAR DI LUAR INVESTASI"),
	R_0201030000 ("0201030000", "ASET TERSEDIA"),
//	R_0202000000 ("0202000000", "LIABILITAS "),
//	R_0202010000 ("0202010000", "Liabilitas di luar Liabilitas Manfaat Pensiun"),
	R_0202020000 ("0202020000", "Utang Manfaat Pensiun dan Manfaat Lain Jatuh Tempo"),
	R_0202030000 ("0202030000", "Utang Manfaat Sukarela"),
	R_0202040000 ("0202040000", "Utang Investasi"),
	R_0202050000 ("0202050000", "Pendapatan Diterima di Muka"),
	R_0202060000 ("0202060000", "Beban yang Masih Harus di Bayar"),
	R_0202070000 ("0202070000", "Utang Lain"),
	R_0202080000 ("0202080000", "Total Liabilitas di luar Liabilitas Manfaat Pensiun"),
	R_0202090000 ("0202090000", "TOTAL LIABILITAS"),
	R_0203000000 ("0203000000", "ASET NETO"),
	;
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER2018PosReDplkk0200 eEnum : ER2018PosReDplkk0200.values()) {
	...
	public static String getName() {
		return ER2018PosReDplkk0200.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER2018PosReDplkk0200.class.getSimpleName().substring(2, 6));
	}
	...
	public static SegmentValidation genValidationAsetLancarDiluarInvestasi() {
		return UtilSegmentValidation.genEqualsFormula("2|3", R_0201020600.key,
	...
	public static SegmentValidation genValidationAsetTersedia() {
		return UtilSegmentValidation.genEqualsFormula("2|3", R_0201030000.key,
				R_0201012200.key + "+" + R_0201020600.key, 
	...
	public static SegmentValidation genValidationLiabilitasDiluarLiabilitasManfaatPensiun() {
		return UtilSegmentValidation.genEqualsFormula("2|3", R_0202080000.key,
	...
	public static SegmentValidation genValidationLiabilitas() {
		return UtilSegmentValidation.genEqualsFormula("2|3", R_0202090000.key, R_0202080000.key, 
				"Total Liabilitas|Penjumlahan Liabilitas");
	}

	public static SegmentValidation genValidationAsetNeto() {
		return UtilSegmentValidation.genEqualsFormula("2|3", R_0203000000.key,
				R_0201030000.key + "-" + R_0202090000.key, "Total Aset Neto|Penjumlahan Aset Neto");
	}

	public static SegmentValidation genValidationFormAsetNeto() {
		String comparatorFormCode = EFormRealisasiBisnis.RE_0300.getCode();
		return UtilSegmentValidation.genEqualsForm2("2|3", R_0203000000.key, comparatorFormCode, 
				ER2019PosReDplkk0300.R_0305000000.getKey(), "Total Aset Neto|Total Aset Neto Akhir Periode form " + comparatorFormCode + " #kolom#");
	}
}
