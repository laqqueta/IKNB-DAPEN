...
public enum ER2000PosRbDplkk0100 implements IObject<KeyValueString> {
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER2000PosRbDplkk0100 eEnum : ER2000PosRbDplkk0100.values()) {
	...
	public static String getName() {
		return ER2000PosRbDplkk0100.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER2000PosRbDplkk0100.class.getSimpleName().substring(2, 6));
	}
