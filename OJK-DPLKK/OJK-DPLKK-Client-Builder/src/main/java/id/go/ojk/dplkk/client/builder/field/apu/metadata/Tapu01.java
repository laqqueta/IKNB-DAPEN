...
import id.go.ojk.dplkk.client.builder.field.EFormApuPenilaian;
import id.go.ojk.dplkk.client.builder.field.apu.reference.EHeaderMetadataPenilaian;
import id.go.ojk.dplkk.client.builder.field.apu.reference.ER5000PosApuDplkk01;
...
public class Tapu01 extends BaseMetadata {
	...
	public SubmissionFormat get() {
		...
		SubmissionFormat res = new SubmissionFormat(eEnum.getCode(), eEnum.getName(), reportCode,
				new ArrayList<>(), extension, 43, 43, null, null, ER5000PosApuDplkk01.getRequiredPos());
