package id.go.ojk.dplkk.client.builder.field.reference;
...
public enum EHeaderMetadataShared implements IObject<ReferenceMetadata> {
	...
	R002 (ER1012KualitasPendanaan.getRefNumber(), ER1012KualitasPendanaan.getName(), ER1012KualitasPendanaan.getObjects()),
	;
