...
import id.go.ojk.dplkk.client.builder.field.sa.reference.ER4004PosSaDplkk0400;
...
public class Sa0400 extends BaseMetadata {
	...
	public SubmissionFormat get() {
		...
		SubmissionFormat res = new SubmissionFormat(eEnum.getCode(), eEnum.getName(), reportCode,
				new ArrayList<>(), extension, 2, 2, ER4004PosSaDplkk0400.getRequiredPos(), true);
		...
		fs.add(sf(2, null, "Analisis", sv(M, 1, 1, numeric))
				.addFieldValidations(ER4004PosSaDplkk0400.genValidationPeringkat()));
