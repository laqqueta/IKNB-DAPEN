...
import id.go.ojk.dplkk.client.builder.field.rb.reference.ER2012PosRbDplkk1300;
...
public class Rb1300 extends BaseMetadata {
	...
	public SubmissionFormat get() {
		...
		fs.add(sf(3, null, "Waktu Pelaksanaan",
				sv(C, 1, 6, yearMonth).confConditionalRequired(ER2012PosRbDplkk1300.genConditionalAllExist())));
		fs.add(sf(4, null, "Lokasi",
				sv(C, 1, 200, all).confConditionalRequired(ER2012PosRbDplkk1300.genConditionalAllExist())));
		fs.add(sf(5, null, "Keterangan",
				sv(C, 1, 300, all).confConditionalRequired(ER2012PosRbDplkk1300.genConditionalAllExist())));
		return res;
	}
}
