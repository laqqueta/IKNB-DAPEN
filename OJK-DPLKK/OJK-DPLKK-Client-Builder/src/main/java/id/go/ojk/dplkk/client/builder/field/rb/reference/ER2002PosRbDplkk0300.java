...
public enum ER2002PosRbDplkk0300 implements IObject<KeyValueString> {
//	R_0301000000 ("0301000000", ""),
	R_0301010000 ("0301010000", "Aset Neto"),
	R_0301020000 ("0301020000", "Aset Investasi"),
	R_0301030000 ("0301030000", "Pendapatan Investasi"),
	R_0301040000 ("0301040000", "Beban Investasi"),
	R_0301050000 ("0301050000", "Beban Operasional"),
//	R_0302000000 ("0302000000", ""),
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER2002PosRbDplkk0300 eEnum : ER2002PosRbDplkk0300.values()) {
	...
	public static String getName() {
		return ER2002PosRbDplkk0300.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER2002PosRbDplkk0300.class.getSimpleName().substring(2, 6));
	}
