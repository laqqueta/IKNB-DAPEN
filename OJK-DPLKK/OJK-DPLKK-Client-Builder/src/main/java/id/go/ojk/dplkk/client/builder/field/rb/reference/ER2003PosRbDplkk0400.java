...
public enum ER2003PosRbDplkk0400 implements IObject<KeyValueString> {
...
//	R_0402000000 ("0402000000", "Berdasarkan Nilai Wajar"),
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER2003PosRbDplkk0400 eEnum : ER2003PosRbDplkk0400.values()) {
	...
	public static String getName() {
		return ER2003PosRbDplkk0400.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER2003PosRbDplkk0400.class.getSimpleName().substring(2, 6));
	}
	...
	public static SegmentValidation genValidationRatioNilaiPerolehan7() {
		return UtilSegmentValidation.genCurrentRowVsCustomRowRatio("6|6|7", 
				UtilMetadata.genPipeRow(getObjects(), 0, 20), R_0401220000.key, 
				"Persentase Nilai Perolehan|Perhitungan Persentase Perolehan Perolehan");
	}
