...
import id.go.ojk.dplkk.client.builder.field.sa.reference.ER4002PosSaDplkk0301;
...
public class Sa0301 extends BaseMetadata {
	...
	public SubmissionFormat get() {
		...
		SubmissionFormat res = new SubmissionFormat(eEnum.getCode(), eEnum.getName(), reportCode,
				new ArrayList<>(), extension, 9, 9, null, null, ER4002PosSaDplkk0301.getRequiredPos());
		...
		fs.add(sf(2, null, "Peringkat Risiko Inheren", sv(M, 1, 1, numeric))
				.addFieldValidations(ER4002PosSaDplkk0301.genValidationPeringkat()));
