...
public enum ER5000PosApuDplkk01 implements IObject<KeyValueString> {
...
//	R_0103020000000000 ("0103020000000000",  "B. Tidak Tatap Muka"),
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER5000PosApuDplkk01 eEnum : ER5000PosApuDplkk01.values()) {
	...
	public static String getName() {
		return ER5000PosApuDplkk01.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER5000PosApuDplkk01.class.getSimpleName().substring(2, 6));
	}
