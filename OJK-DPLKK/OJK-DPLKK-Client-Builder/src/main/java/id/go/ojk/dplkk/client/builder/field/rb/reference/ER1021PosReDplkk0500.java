...
public enum ER1021PosReDplkk0500 implements IObject<KeyValueString> {
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER1021PosReDplkk0500 eEnum : ER1021PosReDplkk0500.values()) {
	...
	public static String getName() {
		return ER1021PosReDplkk0500.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER1021PosReDplkk0500.class.getSimpleName().substring(2, 6));
	}
