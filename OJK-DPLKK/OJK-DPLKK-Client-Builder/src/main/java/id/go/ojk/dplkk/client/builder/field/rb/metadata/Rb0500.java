...
import id.go.ojk.dplkk.client.builder.field.rb.reference.ER2004PosRbDplkk0500;
...
public class Rb0500 extends BaseMetadata {
	...
	public SubmissionFormat get() {
		...
		SubmissionFormat res = new SubmissionFormat(eEnum.getCode(), eEnum.getName(), reportCode,
				new ArrayList<>(), extension, 22, 22, ER2004PosRbDplkk0500.genFieldSave(), null,
				ER2004PosRbDplkk0500.getRequiredPos());
		res.addSegmentValidations(ER2004PosRbDplkk0500.genValidationInvestasi());
		...
		fs.add(sf(5, null, "Hasil Investasi Bersih", sv(M, 1, 20, numericNegatif))
				.addFieldValidations(ER2004PosRbDplkk0500.genValidationSumEqual5()));
		...
		fs.add(sf(9, null, "Hasil Investasi Bersih", sv(M, 1, 20, numericNegatif))
				.addFieldValidations(ER2004PosRbDplkk0500.genValidationSumEqual9()));
		...
		fs.add(sf(13, null, "Hasil Investasi Bersih", sv(M, 1, 20, numericNegatif))
				.addFieldValidations(ER2004PosRbDplkk0500.genValidationSumEqual13()));
		...
		fs.add(sf(17, null, "Hasil Investasi Bersih", sv(M, 1, 20, numericNegatif))
				.addFieldValidations(ER2004PosRbDplkk0500.genValidationSumEqual17()));
		return res;
	}
}
