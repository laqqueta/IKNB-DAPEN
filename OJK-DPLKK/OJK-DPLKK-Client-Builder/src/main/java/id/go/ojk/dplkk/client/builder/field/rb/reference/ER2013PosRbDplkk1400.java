...
public enum ER2013PosRbDplkk1400 implements IObject<KeyValueString> {
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER2013PosRbDplkk1400 eEnum : ER2013PosRbDplkk1400.values()) {
	...
	public static String getName() {
		return ER2013PosRbDplkk1400.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER2013PosRbDplkk1400.class.getSimpleName().substring(2, 6));
	}
	...
	public static SegmentValidation genTotal() {
		return UtilSegmentValidation.genEqualsFormula(UtilMetadata.genPipeColumn(3, 13), R_1402000000.key,
