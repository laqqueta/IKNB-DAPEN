...
import id.go.ojk.dplkk.client.builder.field.rb.reference.ER2014PosRbDplkk1500;
...
public class Rb1500 extends BaseMetadata {
	...
	public SubmissionFormat get() {
		...
		fs.add(sf(3, null, "Kepemilikan (inhouse/ vendor)",
				sv(C, 1, 50, all).confConditionalRequired(ER2014PosRbDplkk1500.genConditionalAllExist())));
		fs.add(sf(4, null, "Nama Vendor",
				sv(C, 1, 300, all).confConditionalRequired(ER2014PosRbDplkk1500.genConditionalAllExist())));
