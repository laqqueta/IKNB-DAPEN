...
[Setup]
AppId=DPLKKClient
AppName=DPLKK Client
AppVersion=3.3.3
AppVerName=DPLKK-Client 3.3.3
AppPublisher=OJK
AppComments=OJK DPLKK Client
AppCopyright=Copyright (C) 2020
;AppPublisherURL=http://java.com/
;AppSupportURL=http://java.com/
;AppUpdatesURL=http://java.com/
DefaultDirName=C:\OJK-DPLKK-Client
...
[Setup]
SetupMutex=DPLKK-Client,Global\DPLKK-Client
OutputDir="..\ftp\app"

[Icons]
Name: "{group}\DPLKK-Client"; Filename: "{app}\OjkClient.exe"; IconFilename: "{app}\Client.ico"; Check: returnTrue()
Name: "{commondesktop}\DplkkClient"; Filename: "{app}\OjkClient.exe";  IconFilename: "{app}\Client.ico"; Check: returnFalse()    

[Run]
Filename: "{app}\OjkClient.exe"; Parameters: "-Xappcds:generatecache"; Check: returnFalse()
Filename: "{app}\OjkClient.exe"; Description: "{cm:LaunchProgram,DPLKKClient}"; Flags: nowait postinstall skipifsilent; Check: returnTrue()
Filename: "{app}\OjkClient.exe"; Parameters: "-install -svcName ""DPLKKClient"" -svcDesc ""DPLKKClient"" -mainExe ""OjkClient.exe""  "; Check: returnFalse()

[UninstallRun]
Filename: "{app}\OjkClient.exe "; Parameters: "-uninstall -svcName DPLKKClient -stopOnUninstall"; Check: returnFalse()
