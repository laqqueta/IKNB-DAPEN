...
public enum ER3031PosLbReass223 implements IObject<KeyValueString> {
//	R_2235010000 ("2235010000", "Risiko Operasional Perusahaan"),
	...
	R_2235010005 ("2235010005", "e. Risiko Opersional =(50%*d)"),
	R_2235010006 ("2235010006", "f. Sub Total Risiko Operasional Perusahaan (c+e)"),
//	R_2235010007 ("2235010007", "Risiko Operasional PAYDI (ROPAYDI)"),
	R_2235010008 ("2235010008", "g. Aset Dana PAYDI "),
	R_2235010009 ("2235010009", "h. Sub Total Risiko Operasional PAYDI (ROPAYDI = (1‰*g))"),
//	R_2235010010 ("2235010010", "Risiko Operasional Dana Tabarru' (RODT)"),
	R_2235010011 ("2235010011", "i. Investasi Dana Tabarru'"),
	R_2235010012 ("2235010012", "j. Sub Total RODT = (1‰*i)"),
	R_2235010013 ("2235010013", "Total Deviasi (f+h+j)"),
	;
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER3031PosLbReass223 eEnum : ER3031PosLbReass223.values()) {
	...
	public static ConditionalRequired genConditional2() {
		return UtilFieldConditional.genExistPos("M", "N", UtilMetadata.genPipeRow(getObjects(), 8, 10));
	}
	
	public static ConditionalRequired genConditional3() {
		return UtilFieldConditional.genExistPos("M", "N", 
				UtilMetadata.genPipeRowExcept(getObjects(), new int[] { 8, 9 }));
	}
	...
	public static SegmentValidation genValidationRisikoOperasional1() {
		return UtilSegmentValidation.genMultiply("3", R_2235010003.key, UtilMetadata.genMinusRow(getObjects(), 0, 1), 
				".01", 0, "perhitungan Risiko Operasional " + EMacro.EQUALS.getMacro() + " (1%*(a-b))");
	}
	...
	public static SegmentValidation genValidationRisikoOperasional2() {
		return UtilSegmentValidation.genMultiply("3", R_2235010005.key, R_2235010004.key, 
				".5", 0, "perhitungan Risiko Operasional " + EMacro.EQUALS.getMacro() + " (50%*d)");
	}
	...
	public static SegmentValidation genValidationSubTotalRisikoOperasionalPerusahaan() {
		return UtilSegmentValidation.genEqualsFormula("3", R_2235010006.key, UtilMetadata.genPlusRow(getObjects(), new int[] { 2, 4 }), 
				"Sub Total Risiko Operasional Perusahaan (c+e)|Penjumlahan Risiko Operasional Perusahaan (c+e)");
	}
	...
	public static SegmentValidation genValidationSubTotalRisikoOperasionalPAYDI() {
		return UtilSegmentValidation.genMultiply("3", R_2235010009.key, R_2235010008.key, 
				".001", 0, "perhitungan Sub Total Risiko Operasional PAYDI (ROPAYDI " + EMacro.EQUALS.getMacro() + " (1‰*g))");
	}
	...
	public static SegmentValidation genValidationSubTotalRODT() {
		return UtilSegmentValidation.genMultiply("2", R_2235010012.key, R_2235010011.key, 
				".001", 0, "perhitungan Sub Total RODT " + EMacro.EQUALS.getMacro() + " (1‰*i)");
	}
	
	public static SegmentValidation genValidationTotalDeviasi() {
		return UtilSegmentValidation.genEqualsFormula("3", R_2235010013.key, UtilMetadata.genPlusRow(getObjects(), new int[] { 5, 7, 9 }), 
				"Total Deviasi (f+h+j)|Perhitungan Deviasi (f+h+j)");
	}
}
