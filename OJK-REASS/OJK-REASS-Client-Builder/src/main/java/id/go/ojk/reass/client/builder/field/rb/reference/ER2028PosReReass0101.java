...
public enum ER2028PosReReass0101 implements IObject<KeyValueString> {
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER2028PosReReass0101 eEnum : ER2028PosReReass0101.values()) {
	...
	public static String getName() {
		return ER2028PosReReass0101.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER2028PosReReass0101.class.getSimpleName().substring(2, 6));
	}
	...
	public static SegmentValidation genValidationAsetB() {
		return UtilSegmentValidation.genEqualsFormula("2|3|4|5", R_01010100000000.key, R_01010200000000.key, 
