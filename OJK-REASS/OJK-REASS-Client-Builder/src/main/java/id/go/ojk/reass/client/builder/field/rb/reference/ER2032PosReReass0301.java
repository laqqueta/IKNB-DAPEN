...
public enum ER2032PosReReass0301 implements IObject<KeyValueString> {
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER2032PosReReass0301 eEnum : ER2032PosReReass0301.values()) {
	...
	public static String getName() {
		return ER2032PosReReass0301.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER2032PosReReass0301.class.getSimpleName().substring(2, 6));
	}
