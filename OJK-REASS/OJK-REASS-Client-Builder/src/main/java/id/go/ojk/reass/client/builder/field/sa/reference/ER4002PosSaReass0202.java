...
public enum ER4002PosSaReass0202 implements IObject<KeyValueString> {
...
//	R_02020400000000 ("02020400000000", "Tabel II.B.4: Tingkat Risiko Inheren untuk Risiko Operasional Konsolidasi"),
	R_02020401000000 ("02020401000000", "Tingkat Risiko Inheren untuk Risiko Operasional "),
//	R_02020500000000 ("02020500000000", "Tabel II.B.5: Kualitas Penerapan Manajemen Risiko untuk Risiko Operasional Konsolidasi"),
	R_02020501000000 ("02020501000000", "Kualitas Penerapan Manajemen Risiko untuk Risiko Operasional "),
//	R_02020502000000 ("02020502000000", "Tingkat Risiko Operasional "),
	R_02020503000000 ("02020503000000", "Tingkat Risiko Operasional Net Risk"),
	R_02020600000000 ("02020600000000", "ANALISIS"),
	;
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER4002PosSaReass0202 eEnum : ER4002PosSaReass0202.values()) {
	...
	public static ConditionalRequired genConditional2() {
		return UtilFieldConditional.genExistPos("O", "M", UtilMetadata.genPipeRow(getObjects(), 35, 37));
	}
	...
	public static SegmentValidation genValidationMaxLengthNumericDot() {
		return UtilSegmentValidation.genMaxLength("2", UtilMetadata.genPipeRow(getObjects(), new int[] { 0, 1, 2, 3, 4, 5, 6, 9, 10, 11 }), 10);
	}
	
	public static SegmentValidation genValidationNumeric() {
		return UtilSegmentValidation.genRegexNumeric("2", UtilMetadata.genPipeRow(getObjects(), new int[] { 7, 8, 32, 33, 34, 35, 36, 37 }));
	}
	
	public static SegmentValidation genValidationMaxLengthNumeric1() {
		return UtilSegmentValidation.genMaxLength("2", UtilMetadata.genPipeRow(getObjects(), 7, 8), 10);
	}
	
	public static SegmentValidation genValidationMaxLengthNumeric2() {
		return UtilSegmentValidation.genMaxLength("2", UtilMetadata.genPipeRow(getObjects(), 32, 37), 1);
	}
	
	public static SegmentValidation genValidationPeringkat1() {
		return UtilSegmentValidation.genFixedValue("2", UtilMetadata.genPipeRow(getObjects(), 32, 35), ER1099Peringkat.getPipedKey());
	}
	
	public static SegmentValidation genValidationPeringkat2() {
		return UtilSegmentValidation.genFixedValueOptional("2", UtilMetadata.genPipeRow(getObjects(), 35, 37), ER1099Peringkat.getPipedKey());
	}
}
