...
public enum ER2004PosRbReass0201 implements IObject<KeyValueString> {
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER2004PosRbReass0201 eEnum : ER2004PosRbReass0201.values()) {
	...
	public static String getName() {
		return ER2004PosRbReass0201.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER2004PosRbReass0201.class.getSimpleName().substring(2, 6));
	}
