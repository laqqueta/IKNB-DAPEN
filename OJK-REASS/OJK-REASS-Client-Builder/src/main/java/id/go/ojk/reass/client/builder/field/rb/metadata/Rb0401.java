...
import id.go.ojk.reass.client.builder.field.rb.reference.ER2006PosRbReass0401;
...
public class Rb0401 extends BaseMetadata {
	...
	public SubmissionFormat get() {
		...
		fs.add(sf(1, null, "Kode Komponen / Baris",
				sv(M, 10, 10, refTable).confReference(EHeaderMetadataRb.R2006_RB0401.getObject())));
		fs.add(sf(2, null, "Usulan Nama Produk Baru", sv(O, 0, 1000, all)));
		fs.add(sf(3, null, "Lini Usaha/ Cabang Asuransi",
				sv(C, 0, 1000, all).confConditionalRequired(ER2006PosRbReass0401.genConditionalField())));
