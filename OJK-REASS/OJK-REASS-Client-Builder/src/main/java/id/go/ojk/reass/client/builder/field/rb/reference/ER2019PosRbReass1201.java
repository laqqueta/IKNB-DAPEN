...
public enum ER2019PosRbReass1201 implements IObject<KeyValueString> {
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER2019PosRbReass1201 eEnum : ER2019PosRbReass1201.values()) {
	...
	public static String getName() {
		return ER2019PosRbReass1201.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER2019PosRbReass1201.class.getSimpleName().substring(2, 6));
	}
	...
	public static SegmentValidation genValidationAsetA() {
		return UtilSegmentValidation.genEqualsFormula("2|3|4|5", R_12010100000000.key,
				R_12010101000000.key + "+" + R_12010102000000.key, "Total Aset|Penjumlahan Aset");
	}

	public static SegmentValidation genValidationAsetB() {
		return UtilSegmentValidation.genEqualsFormula("2|3|4|5", R_12010100000000.key, R_12010200000000.key, 
