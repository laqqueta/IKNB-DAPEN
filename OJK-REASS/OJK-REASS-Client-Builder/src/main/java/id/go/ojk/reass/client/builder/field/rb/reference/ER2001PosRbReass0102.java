...
public enum ER2001PosRbReass0102 implements IObject<KeyValueString> {
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER2001PosRbReass0102 eEnum : ER2001PosRbReass0102.values()) {
	...
	public static String getName() {
		return ER2001PosRbReass0102.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER2001PosRbReass0102.class.getSimpleName().substring(2, 6));
	}
