...
public enum ER2022PosRbReass1204 implements IObject<KeyValueString> {
...
//	R_12050201010000 ("12050201010000", "Beban Klaim"),
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER2022PosRbReass1204 eEnum : ER2022PosRbReass1204.values()) {
	...
	public static String getName() {
		return ER2022PosRbReass1204.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER2022PosRbReass1204.class.getSimpleName().substring(2, 6));
	}
