...
public enum ER2030PosReReass0201 implements IObject<KeyValueString> {
...
//	R_02010200000000 ("02010200000000", "BEBAN USAHA:"),
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER2030PosReReass0201 eEnum : ER2030PosReReass0201.values()) {
	...
	public static String getName() {
		return ER2030PosReReass0201.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER2030PosReReass0201.class.getSimpleName().substring(2, 6));
	}
	...
	public static SegmentValidation genValidationLabaSebelumPajak() {
		return UtilSegmentValidation.genEqualsFormula("2|3", R_02010600000000.key,
				...
				"Total Laba Sebelum Pajak|Perhitungan Laba Sebelum Pajak");
	}
