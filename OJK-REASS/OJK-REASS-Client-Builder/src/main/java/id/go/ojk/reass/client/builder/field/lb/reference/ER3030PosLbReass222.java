...
public enum ER3030PosLbReass222 implements IObject<KeyValueString> {
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER3030PosLbReass222 eEnum : ER3030PosLbReass222.values()) {
	...
	private static String getLookup() {
		...
		ER3030PosLbReass222[] eEnums = ER3030PosLbReass222.values();
		int enumLength = eEnums.length;
		for (int i= 0; i < enumLength; i++) {
			ER3030PosLbReass222 eEnum = ER3030PosLbReass222.values()[i];
