...
import id.go.ojk.reass.client.builder.field.lb.reference.ER3018PosLbReass210;
...
public class Lb210 extends BaseMetadata {
	...
	public SubmissionFormat get() {
		...
		SubmissionFormat res = new SubmissionFormat(eEnum.getCode(), eEnum.getName(), reportCode, new ArrayList<>(),
				extension, 3, 3, ER3018PosLbReass210.genFieldSave(), null, ER3018PosLbReass210.getRequiredPos());
		res.addSegmentValidations(ER3018PosLbReass210.genValidationTotalRisikoKredit());
