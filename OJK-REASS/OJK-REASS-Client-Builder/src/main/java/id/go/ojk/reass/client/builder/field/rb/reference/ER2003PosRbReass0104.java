...
public enum ER2003PosRbReass0104 implements IObject<KeyValueString> {
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER2003PosRbReass0104 eEnum : ER2003PosRbReass0104.values()) {
	...
	public static String getName() {
		return ER2003PosRbReass0104.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER2003PosRbReass0104.class.getSimpleName().substring(2, 6));
	}
