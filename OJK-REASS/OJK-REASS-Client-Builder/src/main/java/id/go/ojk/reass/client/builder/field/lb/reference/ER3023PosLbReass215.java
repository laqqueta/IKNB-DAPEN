...
public enum ER3023PosLbReass215 implements IObject<KeyValueString> {
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER3023PosLbReass215 eEnum : ER3023PosLbReass215.values()) {
	...
	private static String getLookup() {
		...
		ER3023PosLbReass215[] eEnums = ER3023PosLbReass215.values();
		int enumLength = eEnums.length;
		for (int i= 0; i < enumLength; i++) {
			ER3023PosLbReass215 eEnum = ER3023PosLbReass215.values()[i];
