...
public enum ER2033PosReReass0302 implements IObject<KeyValueString> {
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER2033PosReReass0302 eEnum : ER2033PosReReass0302.values()) {
	...
	public static String getName() {
		return ER2033PosReReass0302.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER2033PosReReass0302.class.getSimpleName().substring(2, 6));
	}
	...
	public static SegmentValidation genValidationArusKasMasukOperasi() {
		return UtilSegmentValidation.genEqualsFormula("2|3", R_03020401000000.key,
				...
				"Total Arus Kas Masuk Operasi|Penjumlahan Arus Kas Masuk Dari Aktifitas Operasi");
	}
	...
	public static SegmentValidation genValidationArusKasDariAktifitasInvestasi() {
		return UtilSegmentValidation.genEqualsFormula("2|3", R_03020500000000.key,
				...
				"Total Arus Kas Dari Aktifitas Dari Aktifitas Investasi|Perhitungan Arus Kas Dari Aktifitas Investasi");
	}
	...
	public static SegmentValidation genValidationArusKasMasukPendanaan() {
		return UtilSegmentValidation.genEqualsFormula("2|3", R_03020601000000.key,
				...
				"Total Arus Kas Masuk Dari Aktifitas Pendanaan|Penjumlahan Arus Kas Masuk Dari Aktifitas Pendanaan");
	}
	...
	public static SegmentValidation genValidationArusKasKeluarPendanaan() {
		return UtilSegmentValidation.genEqualsFormula("2|3", R_03020602000000.key,
				...
				"Total Arus Kas Keluar Dari Aktifitas Pendanaan|Penjumlahan Arus Kas Keluar Dari Aktifitas Pendanaan");
	}
}
