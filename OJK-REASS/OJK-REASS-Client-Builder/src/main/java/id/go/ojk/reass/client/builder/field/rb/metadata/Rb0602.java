...
import id.go.ojk.reass.client.builder.field.rb.reference.ER2009PosRbReass0602;
...
public class Rb0602 extends BaseMetadata {
	...
	public SubmissionFormat get() {
		...
		fs.add(sf(1, null, "Kode Komponen / Baris",
				sv(M, 10, 10, refTable).confReference(EHeaderMetadataRb.R2009_RB0602.getObject())));
		...
		fs.add(sf(3, null, "Aktual per 30 Sept 20XX-1",
				sv(C, 0, 16, numericNegatif).confConditionalRequired(ER2009PosRbReass0602.genConditionalField())));
