...
public enum ER2021PosRbReass1203 implements IObject<KeyValueString> {
...
//	R_12040200000000 ("12040200000000", "BEBAN USAHA:"),
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER2021PosRbReass1203 eEnum : ER2021PosRbReass1203.values()) {
	...
	public static String getName() {
		return ER2021PosRbReass1203.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER2021PosRbReass1203.class.getSimpleName().substring(2, 6));
	}
