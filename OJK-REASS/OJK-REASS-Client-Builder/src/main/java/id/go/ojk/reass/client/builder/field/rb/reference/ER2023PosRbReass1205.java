...
public enum ER2023PosRbReass1205 implements IObject<KeyValueString> {
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER2023PosRbReass1205 eEnum : ER2023PosRbReass1205.values()) {
	...
	public static String getName() {
		return ER2023PosRbReass1205.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER2023PosRbReass1205.class.getSimpleName().substring(2, 6));
	}
