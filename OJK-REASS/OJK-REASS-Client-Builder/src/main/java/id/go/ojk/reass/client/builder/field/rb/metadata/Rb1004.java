...
import id.go.ojk.reass.client.builder.field.rb.reference.ER2017PosRbReass1004;
...
public class Rb1004 extends BaseMetadata {
	...
	public SubmissionFormat get() {
		...
		fs.add(sf(1, null, "Kode Komponen / Baris",
				sv(M, 10, 10, refTable).confReference(EHeaderMetadataRb.R2017_RB1004.getObject())));
		fs.add(sf(2, null, "Bidang Tugas", sv(O, 0, 1000, all)));
		fs.add(sf(3, null, "Alasan Pemanfaatan Tenaga Alih Daya",
				sv(C, 0, 1000, all).confConditionalRequired(ER2017PosRbReass1004.genConditionalField())));
