...
public enum ER4005PosSaReass0205 implements IObject<KeyValueString> {
...
//	R_02050502000000 ("02050502000000", "Tingkat Risiko Pasar "),
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER4005PosSaReass0205 eEnum : ER4005PosSaReass0205.values()) {
	...
	public static ConditionalRequired genConditional2() {
		return UtilFieldConditional.genExistPos("O", "M", UtilMetadata.genPipeRow(getObjects(), 19, 21));
	}
	...
	public static SegmentValidation genValidationNumeric() {
		return UtilSegmentValidation.genRegexNumeric("2", UtilMetadata.genPipeRow(getObjects(), 16, 21));
	}
	
	public static SegmentValidation genValidationMaxLengthNumeric() {
		return UtilSegmentValidation.genMaxLength("2", UtilMetadata.genPipeRow(getObjects(), 16, 21), 1);
	}
	
	public static SegmentValidation genValidationPeringkat1() {
		return UtilSegmentValidation.genFixedValue("2", UtilMetadata.genPipeRow(getObjects(), 16, 18), ER1099Peringkat.getPipedKey());
	}
	
	public static SegmentValidation genValidationPeringkat2() {
		return UtilSegmentValidation.genFixedValueOptional("2", UtilMetadata.genPipeRow(getObjects(), 19, 21), ER1099Peringkat.getPipedKey());
	}
}
