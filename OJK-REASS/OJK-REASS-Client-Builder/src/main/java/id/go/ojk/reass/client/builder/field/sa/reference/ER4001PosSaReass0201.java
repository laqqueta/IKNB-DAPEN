...
public enum ER4001PosSaReass0201 implements IObject<KeyValueString> {
...
//	R_02010400000000 ("02010400000000", "Tabel II.A.4: Tingkat Risiko Inheren untuk Risiko Strategis Konsolidasi"),
	R_02010401000000 ("02010401000000", "Tingkat Risiko Inheren untuk Risiko Strategis"),
//	R_02010500000000 ("02010500000000", "Tabel II.A.5: Kualitas Penerapan Manajemen Risiko untuk Risiko Strategis Konsolidasi"),
	R_02010501000000 ("02010501000000", "Kualitas Penerapan Manajemen Risiko untuk Risiko Strategis"),
//	R_02010502000000 ("02010502000000", "Tingkat Risiko Strategis"),
	R_02010503000000 ("02010503000000", "Tingkat Risiko Strategis Nett Risk"),
	R_02010600000000 ("02010600000000", "ANALISIS"),
	;
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER4001PosSaReass0201 eEnum : ER4001PosSaReass0201.values()) {
	...
	public static ConditionalRequired genConditional2() {
		return UtilFieldConditional.genExistPos("O", "M", UtilMetadata.genPipeRow(getObjects(), 26, 28));
	}
	...
	public static SegmentValidation genValidationNumeric() {
		return UtilSegmentValidation.genRegexNumeric("2", UtilMetadata.genPipeRow(getObjects(), 23, 28));
	}
	
	public static SegmentValidation genValidationMaxLengthNumeric() {
		return UtilSegmentValidation.genMaxLength("2", UtilMetadata.genPipeRow(getObjects(), 23, 28), 1);
	}
	...
	public static SegmentValidation genValidationPeringkat2() {
		return UtilSegmentValidation.genFixedValueOptional("2", UtilMetadata.genPipeRow(getObjects(), 26, 28), ER1099Peringkat.getPipedKey());
	}
}
