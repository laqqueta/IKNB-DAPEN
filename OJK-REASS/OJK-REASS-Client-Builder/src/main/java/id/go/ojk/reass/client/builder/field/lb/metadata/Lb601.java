...
import id.go.ojk.reass.client.builder.field.lb.reference.ER3013PosLbReass601;
...
public class Lb601 extends BaseMetadata {
	...
	public SubmissionFormat get() {
		...
		SubmissionFormat res = new SubmissionFormat(eEnum.getCode(), eEnum.getName(), reportCode, new ArrayList<>(),
				extension, 6, 6, ER3013PosLbReass601.genFieldSave(), null, ER3013PosLbReass601.getRequiredPos());
		res.addSegmentValidations(ER3013PosLbReass601.genValidationJumlahLiabilitas());
		...
		fs.add(sf(4, null, "Selisih Penilaian SAK dan SAP", sv(M, 1, 16, numericNegatif))
				.addFieldValidations(ER3013PosLbReass601.genValidation4()));
		return res;
	}
}
