...
public enum ER4003PosSaReass0203 implements IObject<KeyValueString> {
...
//	R_02030502000000 ("02030502000000", "Tingkat Risiko Asuransi "),
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER4003PosSaReass0203 eEnum : ER4003PosSaReass0203.values()) {
	...
	public static ConditionalRequired genConditional2() {
		return UtilFieldConditional.genExistPos("O", "M", UtilMetadata.genPipeRow(getObjects(), 56, 58));
	}
	...
	public static SegmentValidation genValidationNumeric() {
		return UtilSegmentValidation.genRegexNumeric("2", UtilMetadata.genPipeRow(getObjects(), 53, 58));
	}
	
	public static SegmentValidation genValidationMaxLengthNumeric() {
		return UtilSegmentValidation.genMaxLength("2", UtilMetadata.genPipeRow(getObjects(), 53, 58), 1);
	}
	...
	public static SegmentValidation genValidationPeringkat2() {
		return UtilSegmentValidation.genFixedValueOptional("2", UtilMetadata.genPipeRow(getObjects(), 56, 58), ER1099Peringkat.getPipedKey());
	}
}
