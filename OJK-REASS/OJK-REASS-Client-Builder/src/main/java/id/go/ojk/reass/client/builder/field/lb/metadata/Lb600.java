...
import id.go.ojk.reass.client.builder.field.lb.reference.ER3012PosLbReass600;
...
public class Lb600 extends BaseMetadata {
	...
	public SubmissionFormat get() {
		...
		SubmissionFormat res = new SubmissionFormat(eEnum.getCode(), eEnum.getName(), reportCode, new ArrayList<>(),
				extension, 31, 31, ER3012PosLbReass600.genFieldSave(), null, ER3012PosLbReass600.getRequiredPos());
		res.addSegmentValidations(ER3012PosLbReass600.genValidationJumlahInvestasi());
		res.addSegmentValidations(ER3012PosLbReass600.genValidationJumlahBukanInvestasi());
		res.addSegmentValidations(ER3012PosLbReass600.genValidationJumlahAset());
