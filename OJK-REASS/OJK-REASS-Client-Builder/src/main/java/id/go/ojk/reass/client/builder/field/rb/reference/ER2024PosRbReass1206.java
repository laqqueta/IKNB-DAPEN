...
public enum ER2024PosRbReass1206 implements IObject<KeyValueString> {
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER2024PosRbReass1206 eEnum : ER2024PosRbReass1206.values()) {
	...
	public static String getName() {
		return ER2024PosRbReass1206.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER2024PosRbReass1206.class.getSimpleName().substring(2, 6));
	}
