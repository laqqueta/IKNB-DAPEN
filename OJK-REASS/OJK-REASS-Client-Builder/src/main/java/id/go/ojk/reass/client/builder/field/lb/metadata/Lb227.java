...
import id.go.ojk.reass.client.builder.field.lb.reference.ER3035PosLbReass227;
...
public class Lb227 extends BaseMetadata {
	...
	public SubmissionFormat get() {
		...
		fs.add(sf(3, null, "Jenis Utang", sv(C, 1, 4, refTable).confReference(EHeaderMetadataShared.R021.getObject())
				.confConditionalRequired(ER3035PosLbReass227.genConditional())));
		...
		fs.add(sf(5, null, "Periode Mulai",
				sv(C, 1, 8, date).confConditionalRequired(ER3035PosLbReass227.genConditional())));
		...
		fs.add(sf(8, null, "Saldo Buku",
				sv(C, 1, 10, numericNegatif).confConditionalRequired(ER3035PosLbReass227.genConditional())));
