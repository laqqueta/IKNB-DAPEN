...
public enum ER2005PosRbReass0202 implements IObject<KeyValueString> {
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER2005PosRbReass0202 eEnum : ER2005PosRbReass0202.values()) {
	...
	public static String getName() {
		return ER2005PosRbReass0202.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER2005PosRbReass0202.class.getSimpleName().substring(2, 6));
	}
