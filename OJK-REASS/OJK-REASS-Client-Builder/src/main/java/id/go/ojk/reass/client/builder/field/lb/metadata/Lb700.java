...
import id.go.ojk.reass.client.builder.field.lb.reference.ER3014PosLbReass700;
...
public class Lb700 extends BaseMetadata {
	...
	public SubmissionFormat get() {
		...
		SubmissionFormat res = new SubmissionFormat(eEnum.getCode(), eEnum.getName(), reportCode, new ArrayList<>(),
				extension, 25, 25, ER3014PosLbReass700.genFieldSave(), null, ER3014PosLbReass700.getRequiredPos());
		res.addSegmentValidations(ER3014PosLbReass700.genValidationJumlahInvestasi());
		res.addSegmentValidations(ER3014PosLbReass700.genValidationJumlahBukanInvestasi());
		res.addSegmentValidations(ER3014PosLbReass700.genValidationJumlahKekayaan());
		...
		fs.add(sf(4, null, "Selisih Penilaian Berdasarkan SAK dan SAP", sv(M, 1, 16, numericNegatif))
				.addFieldValidations(ER3014PosLbReass700.genValidation4()));
