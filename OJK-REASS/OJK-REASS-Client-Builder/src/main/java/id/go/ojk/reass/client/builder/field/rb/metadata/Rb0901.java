...
import id.go.ojk.reass.client.builder.field.rb.reference.ER2013PosRbReass0901;
...
public class Rb0901 extends BaseMetadata {
	...
	public SubmissionFormat get() {
		...
		fs.add(sf(1, null, "Kode Komponen / Baris",
				sv(M, 10, 10, refTable).confReference(EHeaderMetadataRb.R2013_RB0901.getObject())));
		fs.add(sf(2, null, "Jenis Kantor", sv(O, 1, 1000, all)));
		fs.add(sf(3, null, "Waktu Pelaksanaan",
				sv(C, 1, 1000, all).confConditionalRequired(ER2013PosRbReass0901.genConditionalField())));
		fs.add(sf(4, null, "Lokasi",
				sv(C, 1, 1000, all).confConditionalRequired(ER2013PosRbReass0901.genConditionalField())));
		fs.add(sf(5, null, "Perkiraan Investasi/Biaya",
				sv(C, 1, 16, numeric).confConditionalRequired(ER2013PosRbReass0901.genConditionalField())));
