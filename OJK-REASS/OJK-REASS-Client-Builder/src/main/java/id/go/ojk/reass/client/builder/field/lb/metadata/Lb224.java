...
import id.go.ojk.reass.client.builder.field.lb.reference.ER3032PosLbReass224;
...
public class Lb224 extends BaseMetadata {
	...
	public SubmissionFormat get() {
		...
		fs.add(sf(3, null, "Dana Jaminan", sv(C, 1, 4, refTable).confReference(EHeaderMetadataShared.R003.getObject())
				.confConditionalRequired(ER3032PosLbReass224.genConditional())));
		...
		fs.add(sf(5, null, "Nama Penerbit / Pihak",
				sv(C, 1, 100, all).confConditionalRequired(ER3032PosLbReass224.genConditional())));
		...
		fs.add(sf(11, null, "Tanggal Mulai",
				sv(C, 1, 8, date).confConditionalRequired(ER3032PosLbReass224.genConditional())));
		...
		fs.add(sf(20, null, "Bagian Kepemilikan (%)",
				sv(C, 1, 6, numericDotNegatif).confConditionalRequired(ER3032PosLbReass224.genConditional())));
		...
		fs.add(sf(23, null, "Tingkat Pengembalian (%)",
				sv(C, 1, 16, numericDotNegatif).confConditionalRequired(ER3032PosLbReass224.genConditional())));
		...
		fs.add(sf(25, null, "Saldo Buku",
				sv(C, 1, 16, numericNegatif).confConditionalRequired(ER3032PosLbReass224.genConditional())));
