...
public enum ER2020PosRbReass1202 implements IObject<KeyValueString> {
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER2020PosRbReass1202 eEnum : ER2020PosRbReass1202.values()) {
	...
	public static String getName() {
		return ER2020PosRbReass1202.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER2020PosRbReass1202.class.getSimpleName().substring(2, 6));
	}
