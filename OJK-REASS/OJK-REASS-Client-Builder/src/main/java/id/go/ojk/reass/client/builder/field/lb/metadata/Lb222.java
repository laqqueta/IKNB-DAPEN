...
import id.go.ojk.reass.client.builder.field.lb.reference.ER3030PosLbReass222;
...
public class Lb222 extends BaseMetadata {
	...
	public SubmissionFormat get() {
		...
		SubmissionFormat res = new SubmissionFormat(eEnum.getCode(), eEnum.getName(), reportCode, new ArrayList<>(),
				extension, 15, 15, ER3030PosLbReass222.genFieldSave(), null, ER3030PosLbReass222.getRequiredPos());
		res.addSegmentValidations(ER3030PosLbReass222.genValidationTotal());
		...
		fs.add(sf(4, null, "fpk",
				sv(C, 1, 6, numericDotNegatif).confConditionalRequired(ER3030PosLbReass222.genConditional4()))
				.addFieldValidations(ER3030PosLbReass222.genValidation4()));
		fs.add(sf(5, null, "Jumlah Deviasi Penyisihan Risiko Bencana ((2) - (3)) x (4)", sv(M, 1, 16, numericNegatif))
				.addFieldValidations(ER3030PosLbReass222.genValidation5()));
		return res;
	}
}
