...
public enum ER2014PosRbReass1001 implements IObject<KeyValueString> {
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER2014PosRbReass1001 eEnum : ER2014PosRbReass1001.values()) {
	...
	public static String getName() {
		return ER2014PosRbReass1001.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER2014PosRbReass1001.class.getSimpleName().substring(2, 6));
	}
