...
import id.go.ojk.reass.client.builder.field.lb.metadata.MetadataLb;
import id.go.ojk.reass.client.builder.field.rb.metadata.MetadataRb;
import id.go.ojk.reass.client.builder.field.rb.metadata.MetadataRe;
import id.go.ojk.reass.client.builder.field.rb.metadata.MetadataRp;
import id.go.ojk.reass.client.builder.field.sa.metadata.MetadataSaa;
import id.go.ojk.reass.client.builder.field.sa.metadata.MetadataSai;
