...
public enum ER2025PosRbReass1207 implements IObject<KeyValueString> {
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER2025PosRbReass1207 eEnum : ER2025PosRbReass1207.values()) {
	...
	public static String getName() {
		return ER2025PosRbReass1207.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER2025PosRbReass1207.class.getSimpleName().substring(2, 6));
	}
	...
	public static SegmentValidation genValidationNumeric() {
		return UtilSegmentValidation.genRegexNumeric("3|4|5|6",
