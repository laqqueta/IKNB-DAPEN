...
[Setup]
AppId=REASSClient
AppName=REASS Client
AppVersion=3.3.3
AppVerName=REASS-Client 3.3.3
AppPublisher=OJK
AppComments=OJK REASS Client
AppCopyright=Copyright (C) 2020
;AppPublisherURL=http://java.com/
;AppSupportURL=http://java.com/
;AppUpdatesURL=http://java.com/
DefaultDirName=C:\OJK-REASS-Client
...
[Setup]
SetupMutex=REASS-Client,Global\REASS-Client
OutputDir="..\ftp\app"

[Icons]
Name: "{group}\REASS-Client"; Filename: "{app}\OjkClient.exe"; IconFilename: "{app}\Client.ico"; Check: returnTrue()
Name: "{commondesktop}\ReassClient"; Filename: "{app}\OjkClient.exe";  IconFilename: "{app}\Client.ico"; Check: returnFalse()    

[Run]
Filename: "{app}\OjkClient.exe"; Parameters: "-Xappcds:generatecache"; Check: returnFalse()
Filename: "{app}\OjkClient.exe"; Description: "{cm:LaunchProgram,REASSClient}"; Flags: nowait postinstall skipifsilent; Check: returnTrue()
Filename: "{app}\OjkClient.exe"; Parameters: "-install -svcName ""REASSClient"" -svcDesc ""REASSClient"" -mainExe ""OjkClient.exe""  "; Check: returnFalse()

[UninstallRun]
Filename: "{app}\OjkClient.exe "; Parameters: "-uninstall -svcName REASSClient -stopOnUninstall"; Check: returnFalse()
