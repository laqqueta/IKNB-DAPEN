...
import id.go.ojk.fins.client.builder.field.lt.reference.ER6007PosLtFins2112;
...
public class Lt2112 extends BaseMetadata {
	...
	public SubmissionFormat get() {
		...
		SubmissionFormat res = new SubmissionFormat(eEnum.getCode(), eEnum.getName(), reportCode, new ArrayList<>(),
				extension, 1, null, ER6007PosLtFins2112.genFieldSave(), ER6007PosLtFins2112.genFieldSave(),
				ER6007PosLtFins2112.getRequiredPos());
		res.addSegmentValidations(ER6007PosLtFins2112.genRowValidation2());
		...
		fs.add(sf(2, null, "Nama Debitur", sv(C, 1, 100, all).confRegex(patternLJKName)
				.confConditionalRequired(ER6007PosLtFins2112.genConditional())));
		...
		fs.add(sf(5, null, "Jumlah Piutang Lancar Lainnya", sv(M, 1, 16, numericNegatif))
				.addFieldValidations(ER6007PosLtFins2112.genFieldValidation5()));
		fs.add(sf(6, null, "Tanggal Pencairan",
				sv(C, 1, 8, date).confConditionalRequired(ER6007PosLtFins2112.genConditional())));
