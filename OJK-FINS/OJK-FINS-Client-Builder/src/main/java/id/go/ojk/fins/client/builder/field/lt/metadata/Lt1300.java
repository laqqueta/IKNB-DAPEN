...
import id.go.ojk.fins.client.builder.field.lt.reference.ER6004PosLtFins1300;
...
public class Lt1300 extends BaseMetadata {
	...
	public SubmissionFormat get() {
		...
		SubmissionFormat res = new SubmissionFormat(eEnum.getCode(), eEnum.getName(), reportCode, new ArrayList<>(),
				extension, 13, 13, ER6004PosLtFins1300.genFieldSave(), ER6004PosLtFins1300.genFieldSave(),
				ER6004PosLtFins1300.getRequiredPos());
		res.addSegmentValidations(ER6004PosLtFins1300.genRowValidation01());
		res.addSegmentValidations(ER6004PosLtFins1300.genRowValidation04());
		res.addSegmentValidations(ER6004PosLtFins1300.genRowValidation07());
		res.addSegmentValidations(ER6004PosLtFins1300.genRowValidation11());
		res.addSegmentValidations(ER6004PosLtFins1300.genRowValidation13());
