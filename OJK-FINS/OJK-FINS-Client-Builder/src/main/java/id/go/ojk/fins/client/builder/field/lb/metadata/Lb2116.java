...
import id.go.ojk.fins.client.builder.field.lb.reference.ER3018PosLbFins2116;
...
public class Lb2116 extends BaseMetadata {
	...
	public SubmissionFormat get() {
		...
		SubmissionFormat res = new SubmissionFormat(eEnum.getCode(), eEnum.getName(), reportCode, new ArrayList<>(),
				extension, 1, null, ER3018PosLbFins2116.genFieldSave(), ER3018PosLbFins2116.genFieldSave(),
				ER3018PosLbFins2116.getRequiredPos());
		res.addSegmentValidations(ER3018PosLbFins2116.genRowValidation2());
		...
		fs.add(sf(2, null, "Nama Aset Tak Berwujud", sv(C, 1, 1000, all).confRegex(PATTERN_ALL_1)
				.confConditionalRequired(ER3018PosLbFins2116.genConditional())));
		...
		fs.add(sf(6, null, "Saldo Akhir", sv(M, 1, 16, numericNegatif))
				.addFieldValidations(ER3018PosLbFins2116.genFieldValidation6()));
