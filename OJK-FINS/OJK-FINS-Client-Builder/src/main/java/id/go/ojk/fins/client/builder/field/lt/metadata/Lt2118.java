...
import id.go.ojk.fins.client.builder.field.lt.reference.ER6013PosLtFins2118;
...
public class Lt2118 extends BaseMetadata {
	...
	public SubmissionFormat get() {
		...
		SubmissionFormat res = new SubmissionFormat(eEnum.getCode(), eEnum.getName(), reportCode, new ArrayList<>(),
				extension, 1, null, ER6013PosLtFins2118.genFieldSave(), ER6013PosLtFins2118.genFieldSave(),
				ER6013PosLtFins2118.getRequiredPos());
		res.addSegmentValidations(ER6013PosLtFins2118.genRowValidation2A());
//		res.addSegmentValidations(ER6013PosLtFins2118.genRowValidation2B());
		...
		fs.add(sf(2, null, "Nama Pihak Berelasi/Pihak Ketiga", sv(C, 1, 1000, all).confRegex(PATTERN_ALL_1)
				.confConditionalRequired(ER6013PosLtFins2118.genConditional())));
