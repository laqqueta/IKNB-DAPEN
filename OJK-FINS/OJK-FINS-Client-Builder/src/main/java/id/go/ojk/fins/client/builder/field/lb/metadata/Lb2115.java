...
import id.go.ojk.fins.client.builder.field.lb.reference.ER3021PosLbFins2115;
...
public class Lb2115 extends BaseMetadata {
	...
	public SubmissionFormat get() {
		...
		SubmissionFormat res = new SubmissionFormat(eEnum.getCode(), eEnum.getName(), reportCode, new ArrayList<>(),
				extension, 1, null, ER3021PosLbFins2115.genFieldSave(), ER3021PosLbFins2115.genFieldSave(),
				ER3021PosLbFins2115.getRequiredPos());
		res.addSegmentValidations(ER3021PosLbFins2115.genRowValidation2());
		...
		fs.add(sf(2, null, "Nama Kreditur", sv(C, 1, 100, all).confRegex(patternLJKName)
				.confConditionalRequired(ER3021PosLbFins2115.genConditional())));
		...
		fs.add(sf(5, null, "Jumlah Utang Jangka Panjang Lainnya", sv(M, 1, 16, numericNegatif))
				.addFieldValidations(ER3021PosLbFins2115.genFieldValidation5()));
		fs.add(sf(6, null, "Tanggal Pencairan",
				sv(C, 1, 8, date).confConditionalRequired(ER3021PosLbFins2115.genConditional())));
