...
import id.go.ojk.fins.client.builder.field.lt.reference.ER6008PosLtFins2116;
...
public class Lt2116 extends BaseMetadata {
	...
	public SubmissionFormat get() {
		...
		SubmissionFormat res = new SubmissionFormat(eEnum.getCode(), eEnum.getName(), reportCode, new ArrayList<>(),
				extension, 1, null, ER6008PosLtFins2116.genFieldSave(), ER6008PosLtFins2116.genFieldSave(),
				ER6008PosLtFins2116.getRequiredPos());
		res.addSegmentValidations(ER6008PosLtFins2116.genRowValidation2());
		...
		fs.add(sf(2, null, "Nama Aset Tak Berwujud", sv(C, 1, 1000, all).confRegex(PATTERN_ALL_1)
				.confConditionalRequired(ER6008PosLtFins2116.genConditional())));
		...
		fs.add(sf(6, null, "Saldo Akhir", sv(M, 1, 16, numericNegatif))
				.addFieldValidations(ER6008PosLtFins2116.genFieldValidation6()));
