...
import id.go.ojk.fins.client.builder.field.lb.reference.ER3020PosLbFins2114;
...
public class Lb2114 extends BaseMetadata {
	...
	public SubmissionFormat get() {
		...
		SubmissionFormat res = new SubmissionFormat(eEnum.getCode(), eEnum.getName(), reportCode, new ArrayList<>(),
				extension, 1, null, ER3020PosLbFins2114.genFieldSave(), ER3020PosLbFins2114.genFieldSave(),
				ER3020PosLbFins2114.getRequiredPos());
		res.addSegmentValidations(ER3020PosLbFins2114.genRowValidation2());
		...
		fs.add(sf(2, null, "Nama Kreditur", sv(C, 1, 100, all).confRegex(patternLJKName)
				.confConditionalRequired(ER3020PosLbFins2114.genConditional())));
		...
		fs.add(sf(5, null, "Jumlah Utang Jangka Pendek Lainnya", sv(M, 1, 16, numericNegatif))
				.addFieldValidations(ER3020PosLbFins2114.genFieldValidation5()));
		fs.add(sf(6, null, "Tanggal Pencairan",
				sv(C, 1, 8, date).confConditionalRequired(ER3020PosLbFins2114.genConditional())));
