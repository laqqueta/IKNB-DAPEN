...
public enum ER3005PosLbFins1200 implements IObject<KeyValueString> {
...
//	R_120006000000("120006000000", "III. Pendapatan Non Operasional"),
	R_120006010000("120006010000", "1. Pendapatan Bagi Hasil"),
...
//	R_120008000000("120008000000", "IV. Beban Non Operasional"),
	R_120008010000("120008010000", "1. Distribusi Bagi Hasil"),
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER3005PosLbFins1200 eEnum : ER3005PosLbFins1200.values()) {
	...
	public static String getName() {
		return ER3005PosLbFins1200.class.getSimpleName().substring(6);
	}

	public static int getRefNumber() {
		return Integer.parseInt(ER3005PosLbFins1200.class.getSimpleName().substring(2, 6));
	}
	...
	public static SegmentValidation genRowValidation07() {
		return UtilSegmentValidation.genEqualsForm("2", R_120003040000.key, EFormLaporanBulanan.LB_2118.getCode(), "3",
				ER3026PosLbFins2118.R_211801000000.getKey(),
	...
	public static SegmentValidation genRowValidation09() {
		return UtilSegmentValidation.genEqualsForm("2", R_120003060000.key, EFormLaporanBulanan.LB_2913.getCode(), "3",
				ER3027PosLbFins2913.R_291301000000.getKey(),
	...
	public static SegmentValidation genRowValidation16B() {
		return UtilSegmentValidation.genEqualsForm("2", R_120007000000.key, EFormLaporanBulanan.LB_2119.getCode(), "3",
				ER3025PosLbFins2119.R_211901000000.getKey(),
