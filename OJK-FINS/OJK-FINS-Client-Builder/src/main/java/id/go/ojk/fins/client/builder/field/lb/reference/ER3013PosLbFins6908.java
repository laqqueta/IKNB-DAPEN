...
public enum ER3013PosLbFins6908 implements IObject<KeyValueString> {
...
//	R_690805040000("690805040000", "d.Usia Borrower Perseorangan yang masuk dalam kategori Pendanaan Macet", ""),
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER3013PosLbFins6908 eEnum : ER3013PosLbFins6908.values()) {
	...
	public static String getName() {
		return ER3013PosLbFins6908.class.getSimpleName().substring(6);
	}

	public static int getRefNumber() {
		return Integer.parseInt(ER3013PosLbFins6908.class.getSimpleName().substring(2, 6));
	}
	...
	public static String getLookup() {
		...
		ER3013PosLbFins6908[] eEnums = ER3013PosLbFins6908.values();
		int enumLength = eEnums.length;
		for (int i= 0; i < enumLength; i++) {
			ER3013PosLbFins6908 eEnum = eEnums[i];
