...
public enum ER3010PosLbFins6902 implements IObject<KeyValueString> {
...
//	R_690203000000("690203000000", "Total Outstanding Pendanaan per Bulan Laporan (dalam Rp)", ""),
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER3010PosLbFins6902 eEnum : ER3010PosLbFins6902.values()) {
	...
	public static String getName() {
		return ER3010PosLbFins6902.class.getSimpleName().substring(6);
	}

	public static int getRefNumber() {
		return Integer.parseInt(ER3010PosLbFins6902.class.getSimpleName().substring(2, 6));
	}
	...
	public static String getLookup() {
		...
		ER3010PosLbFins6902[] eEnums = ER3010PosLbFins6902.values();
		int enumLength = eEnums.length;
		for (int i= 0; i < enumLength; i++) {
			ER3010PosLbFins6902 eEnum = eEnums[i];
	...
	public static SegmentValidation genRowValidation043() {
		return UtilSegmentValidation.genEqualsRatioForm("3|4", R_690201050000.key, R_690201040000.key,
				EFormLaporanBulanan.LB_6901.getCode(), ER3009PosLbFins6901.R_690102010400.getKey(),
	...
	public static SegmentValidation genRowValidation085() {
		return UtilSegmentValidation.genEqualsRatioForm("3|4", R_690202040000.key, R_690202030000.key,
				EFormLaporanBulanan.LB_6901.getCode(), ER3009PosLbFins6901.R_690102020300.getKey(),
