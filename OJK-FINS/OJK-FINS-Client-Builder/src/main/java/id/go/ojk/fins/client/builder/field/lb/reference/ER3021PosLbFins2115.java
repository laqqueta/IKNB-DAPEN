...
public enum ER3021PosLbFins2115 implements IObject<KeyValueString> {
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER3021PosLbFins2115 eEnum : ER3021PosLbFins2115.values()) {
	...
	public static String getName() {
		return ER3021PosLbFins2115.class.getSimpleName().substring(6);
	}

	public static int getRefNumber() {
		return Integer.parseInt(ER3021PosLbFins2115.class.getSimpleName().substring(2, 6));
	}
