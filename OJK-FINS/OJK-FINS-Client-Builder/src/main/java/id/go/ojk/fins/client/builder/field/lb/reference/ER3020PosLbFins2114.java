...
public enum ER3020PosLbFins2114 implements IObject<KeyValueString> {
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER3020PosLbFins2114 eEnum : ER3020PosLbFins2114.values()) {
	...
	public static String getName() {
		return ER3020PosLbFins2114.class.getSimpleName().substring(6);
	}

	public static int getRefNumber() {
		return Integer.parseInt(ER3020PosLbFins2114.class.getSimpleName().substring(2, 6));
	}
