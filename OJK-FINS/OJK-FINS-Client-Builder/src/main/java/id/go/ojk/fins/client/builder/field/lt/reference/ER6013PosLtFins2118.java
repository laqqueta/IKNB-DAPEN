...
public enum ER6013PosLtFins2118 implements IObject<KeyValueString> {
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER6013PosLtFins2118 eEnum : ER6013PosLtFins2118.values()) {
	...
	public static String getName() {
		return ER6013PosLtFins2118.class.getSimpleName().substring(6);
	}

	public static int getRefNumber() {
		return Integer.parseInt(ER6013PosLtFins2118.class.getSimpleName().substring(2, 6));
	}
	...
	public static SegmentValidation genRowValidation2B() {
		return UtilSegmentValidation.genEqualsForm("3", R_211801000000.key, EFormLaporanTahunan.LT_1200.getCode(), "2",
				ER6002PosLtFins1200.R_120003040000.getKey(),
