...
import id.go.ojk.fins.client.builder.field.lb.reference.ER3022PosLbFins2117;
...
public class Lb2117 extends BaseMetadata {
	...
	public SubmissionFormat get() {
		...
		SubmissionFormat res = new SubmissionFormat(eEnum.getCode(), eEnum.getName(), reportCode, new ArrayList<>(),
				extension, 1, null, ER3022PosLbFins2117.genFieldSave(), ER3022PosLbFins2117.genFieldSave(),
				ER3022PosLbFins2117.getRequiredPos());
		res.addSegmentValidations(ER3022PosLbFins2117.genRowValidation2());
		...
		fs.add(sf(2, null, "Nama Pihak Berelasi/Pihak Ketiga", sv(C, 1, 1000, all).confRegex(PATTERN_ALL_1)
				.confConditionalRequired(ER3022PosLbFins2117.genConditional())));
		fs.add(sf(3, null, "Jumlah Biaya", sv(M, 1, 16, numericNegatif)));
		fs.add(sf(4, null, "Tanggal Jatuh Tempo",
				sv(C, 1, 8, date).confConditionalRequired(ER3022PosLbFins2117.genConditional())));
