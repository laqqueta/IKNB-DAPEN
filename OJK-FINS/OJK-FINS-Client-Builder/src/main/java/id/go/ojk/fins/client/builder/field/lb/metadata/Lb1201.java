...
import id.go.ojk.fins.client.builder.field.lb.reference.ER3006PosLbFins1201;
...
public class Lb1201 extends BaseMetadata {
	...
	public SubmissionFormat get() {
		...
		SubmissionFormat res = new SubmissionFormat(eEnum.getCode(), eEnum.getName(), reportCode, new ArrayList<>(),
				extension, 6, 6, ER3006PosLbFins1201.genFieldSave(), ER3006PosLbFins1201.genFieldSave(),
				ER3006PosLbFins1201.getRequiredPos());
//		res.addSegmentValidations(ER3006PosLbFins1201.genRowValidation2());//disable, request by OJK
		res.addSegmentValidations(ER3006PosLbFins1201.genRowValidation3());
		res.addSegmentValidations(ER3006PosLbFins1201.genRowValidation6());
