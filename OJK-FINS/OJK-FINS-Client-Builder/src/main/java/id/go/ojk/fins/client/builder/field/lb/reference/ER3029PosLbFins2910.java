...
public enum ER3029PosLbFins2910 implements IObject<KeyValueString> {
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER3029PosLbFins2910 eEnum : ER3029PosLbFins2910.values()) {
	...
	public static String getName() {
		return ER3029PosLbFins2910.class.getSimpleName().substring(6);
	}

	public static int getRefNumber() {
		return Integer.parseInt(ER3029PosLbFins2910.class.getSimpleName().substring(2, 6));
	}
