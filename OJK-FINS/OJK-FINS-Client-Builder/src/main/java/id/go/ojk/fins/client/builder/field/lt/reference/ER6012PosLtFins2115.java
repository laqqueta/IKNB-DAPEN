...
public enum ER6012PosLtFins2115 implements IObject<KeyValueString> {
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER6012PosLtFins2115 eEnum : ER6012PosLtFins2115.values()) {
	...
	public static String getName() {
		return ER6012PosLtFins2115.class.getSimpleName().substring(6);
	}

	public static int getRefNumber() {
		return Integer.parseInt(ER6012PosLtFins2115.class.getSimpleName().substring(2, 6));
	}
