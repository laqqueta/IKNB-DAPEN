...
import id.go.ojk.fins.client.builder.field.lt.reference.ER6009PosLtFins2113;
...
public class Lt2113 extends BaseMetadata {
	...
	public SubmissionFormat get() {
		...
		SubmissionFormat res = new SubmissionFormat(eEnum.getCode(), eEnum.getName(), reportCode, new ArrayList<>(),
				extension, 1, null, ER6009PosLtFins2113.genFieldSave(), ER6009PosLtFins2113.genFieldSave(),
				ER6009PosLtFins2113.getRequiredPos());
		res.addSegmentValidations(ER6009PosLtFins2113.genRowValidation2());
		...
		fs.add(sf(2, null, "Nama Debitur", sv(C, 1, 100, all).confRegex(patternLJKName)
				.confConditionalRequired(ER6009PosLtFins2113.genConditional())));
		...
		fs.add(sf(5, null, "Jumlah Piutang Tidak Lancar Lainnya", sv(M, 1, 16, numericNegatif))
				.addFieldValidations(ER6009PosLtFins2113.genFieldValidation5()));
		fs.add(sf(6, null, "Tanggal Pencairan",
				sv(C, 1, 8, date).confConditionalRequired(ER6009PosLtFins2113.genConditional())));
