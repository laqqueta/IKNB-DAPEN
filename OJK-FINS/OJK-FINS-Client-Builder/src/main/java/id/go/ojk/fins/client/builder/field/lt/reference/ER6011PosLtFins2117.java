...
public enum ER6011PosLtFins2117 implements IObject<KeyValueString> {
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER6011PosLtFins2117 eEnum : ER6011PosLtFins2117.values()) {
	...
	public static String getName() {
		return ER6011PosLtFins2117.class.getSimpleName().substring(6);
	}

	public static int getRefNumber() {
		return Integer.parseInt(ER6011PosLtFins2117.class.getSimpleName().substring(2, 6));
	}
