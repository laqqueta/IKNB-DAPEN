...
public enum ER6007PosLtFins2112 implements IObject<KeyValueString> {
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER6007PosLtFins2112 eEnum : ER6007PosLtFins2112.values()) {
	...
	public static String getName() {
		return ER6007PosLtFins2112.class.getSimpleName().substring(6);
	}

	public static int getRefNumber() {
		return Integer.parseInt(ER6007PosLtFins2112.class.getSimpleName().substring(2, 6));
	}
