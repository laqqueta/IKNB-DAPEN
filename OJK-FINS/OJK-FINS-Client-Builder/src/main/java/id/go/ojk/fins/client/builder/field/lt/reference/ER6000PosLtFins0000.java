...
public enum ER6000PosLtFins0000 implements IObject<KeyValueString> {
	...
	R_000026000000("000026000000", "Nama Kantor Akuntan Publik"),
	R_000027000000("000027000000", "Nama Akuntan Publik"),
	R_000028000000("000028000000", "Opini Akuntan Publik"),
	;
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER6000PosLtFins0000 eEnum : ER6000PosLtFins0000.values()) {
	...
	public static String getName() {
		return ER6000PosLtFins0000.class.getSimpleName().substring(6);
	}

	public static int getRefNumber() {
		return Integer.parseInt(ER6000PosLtFins0000.class.getSimpleName().substring(2, 6));
	}
	...
	public static SegmentValidation genValidationLjkAddress() {
		return UtilSegmentValidation.genRegexLjkAddress("2",
				UtilMetadata.genPipeRow(getObjects(), new int[] { 15, 25, 26, 27 }));
	}
	...
	public static SegmentValidation genValidationLen100() {
		return UtilSegmentValidation.genMaxLength("2",
				UtilMetadata.genPipeRow(getObjects(), new int[] { 0, 1, 2, 4, 12, 25, 26, 27 }), 100);
	}
