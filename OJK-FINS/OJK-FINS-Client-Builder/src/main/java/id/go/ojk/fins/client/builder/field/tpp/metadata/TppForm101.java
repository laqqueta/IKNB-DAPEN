...
import id.go.ojk.fins.client.builder.field.tpp.reference.EHeaderMetadataTpp;
...
public class TppForm101 extends BaseMetadata {
    ...
    public SubmissionFormat get() {
        ...
        fsList.add(sf(11, null, "Borrower - Persentase target pemenuhan Single Customer Identification File yang akan dikinikan pada periode tertentu", sv(M, 1, 1000, all).confRegex(SimpleValidation.FREE_TEXT_PATTERN)));
