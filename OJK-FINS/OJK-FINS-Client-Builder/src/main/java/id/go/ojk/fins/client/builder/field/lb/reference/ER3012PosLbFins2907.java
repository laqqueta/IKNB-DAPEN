...
public enum ER3012PosLbFins2907 implements IObject<KeyValueString> {
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER3012PosLbFins2907 eEnum : ER3012PosLbFins2907.values()) {
	...
	public static String getName() {
		return ER3012PosLbFins2907.class.getSimpleName().substring(6);
	}

	public static int getRefNumber() {
		return Integer.parseInt(ER3012PosLbFins2907.class.getSimpleName().substring(2, 6));
	}
	...
	public static SegmentValidation genRowValidation27B() {
		...
		return UtilSegmentValidation.genEqualsFormulaForm("2", R_290702000000.key, "3",
				UtilMetadata.genPlusRow(ER3013PosLbFins6908.getObjectsForm(), rows),
				UtilMetadata.genMessage(R_290702000000.getValue(),
						UtilMetadata.genPlusDesc(ER3013PosLbFins6908.getObjects(), rows) + " pada form 6908"));
	}
