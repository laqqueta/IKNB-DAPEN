...
import id.go.ojk.fins.client.builder.field.lb.reference.ER3032PosLbFins2912;
...
public class Lb2912 extends BaseMetadata {
	...
	public SubmissionFormat get() {
		...
		SubmissionFormat res = new SubmissionFormat(eEnum.getCode(), eEnum.getName(), reportCode, new ArrayList<>(),
				extension, 1, null, ER3032PosLbFins2912.genFieldSave(), null, ER3032PosLbFins2912.getRequiredPos());
		res.addSegmentValidations(ER3032PosLbFins2912.genRowValidation2());
		...
		fs.add(sf(2, null, "Nama Perusahaan Pemberi Pendanaan", sv(C, 1, 1000, all).confRegex(patternLJKName)
				.confConditionalRequired(ER3032PosLbFins2912.genConditional())));
		...
		fs.add(sf(4, null, "Afiliasi/non Afiliasi", sv(C, 1, 100, all).confRegex(patternLJKName)
				.confConditionalRequired(ER3032PosLbFins2912.genConditional())));
		fs.add(sf(5, null, "Jumlah Borrower yang Menerima Pendanaan", sv(M, 1, 16, numericNegatif)));
