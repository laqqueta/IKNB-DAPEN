...
import id.go.ojk.fins.client.builder.field.apu.metadata.MetadataPenilaian;
import id.go.ojk.fins.client.builder.field.lb.metadata.MetadataLb;
import id.go.ojk.fins.client.builder.field.lt.metadata.MetadataLt;
import id.go.ojk.fins.client.builder.field.tpp.metadata.MetadataTpp;
