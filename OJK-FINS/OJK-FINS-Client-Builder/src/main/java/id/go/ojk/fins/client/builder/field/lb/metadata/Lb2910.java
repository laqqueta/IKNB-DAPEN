...
import id.go.ojk.fins.client.builder.field.lb.reference.ER3029PosLbFins2910;
...
public class Lb2910 extends BaseMetadata {
	...
	public SubmissionFormat get() {
		...
		SubmissionFormat res = new SubmissionFormat(eEnum.getCode(), eEnum.getName(), reportCode, new ArrayList<>(),
				extension, 1, null, ER3029PosLbFins2910.genFieldSave(), null, ER3029PosLbFins2910.getRequiredPos());
		res.addSegmentValidations(ER3029PosLbFins2910.genRowValidation2());
		...
		fs.add(sf(2, null, "Nama Lender", sv(C, 1, 100, all).confRegex(patternLJKName)
				.confConditionalRequired(ER3029PosLbFins2910.genConditional())));
		fs.add(sf(3, null, "Nomor Dokumen Persetujuan Hapus Buku dan Hapus Tagih", sv(C, 1, 100, all)
				.confRegex(patternLJKName).confConditionalRequired(ER3029PosLbFins2910.genConditional())));
		fs.add(sf(4, null, "Tanggal Persetujuan Hapus Buku dan Hapus Tagih",
				sv(C, 1, 8, date).confConditionalRequired(ER3029PosLbFins2910.genConditional())));
