...
public enum ER3007PosLbFins1300 implements IObject<KeyValueString> {
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER3007PosLbFins1300 eEnum : ER3007PosLbFins1300.values()) {
	...
	public static String getName() {
		return ER3007PosLbFins1300.class.getSimpleName().substring(6);
	}

	public static int getRefNumber() {
		return Integer.parseInt(ER3007PosLbFins1300.class.getSimpleName().substring(2, 6));
	}
