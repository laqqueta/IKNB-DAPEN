...
public enum ER6010PosLtFins2114 implements IObject<KeyValueString> {
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER6010PosLtFins2114 eEnum : ER6010PosLtFins2114.values()) {
	...
	public static String getName() {
		return ER6010PosLtFins2114.class.getSimpleName().substring(6);
	}

	public static int getRefNumber() {
		return Integer.parseInt(ER6010PosLtFins2114.class.getSimpleName().substring(2, 6));
	}
