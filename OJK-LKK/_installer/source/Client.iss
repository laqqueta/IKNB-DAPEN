...
AppName=LKK Client
AppVersion=1.0.0
AppVerName=LKK-Client 1.0.0
AppPublisher=OJK
AppComments=OJK LKK Client
AppCopyright=Copyright (C) 2020
;AppPublisherURL=http://java.com/
;AppSupportURL=http://java.com/
;AppUpdatesURL=http://java.com/
DefaultDirName=C:\OJK-LKK-Client
...
UninstallDisplayName=LKK-Client
...
[Setup]
SetupMutex=LKK-Client,Global\LKK-Client
OutputDir="..\ftp\app"

[Icons]
Name: "{group}\LKK-Client"; Filename: "{app}\OjkClient.exe"; IconFilename: "{app}\Client.ico"; Check: returnTrue()
Name: "{commondesktop}\LkkClient"; Filename: "{app}\OjkClient.exe";  IconFilename: "{app}\Client.ico"; Check: returnFalse()    

[Run]
Filename: "{app}\OjkClient.exe"; Parameters: "-Xappcds:generatecache"; Check: returnFalse()
Filename: "{app}\OjkClient.exe"; Description: "{cm:LaunchProgram,LKKClient}"; Flags: nowait postinstall skipifsilent; Check: returnTrue()
Filename: "{app}\OjkClient.exe"; Parameters: "-install -svcName ""LKKClient"" -svcDesc ""LKKClient"" -mainExe ""OjkClient.exe""  "; Check: returnFalse()

[UninstallRun]
Filename: "{app}\OjkClient.exe "; Parameters: "-uninstall -svcName LKKClient -stopOnUninstall"; Check: returnFalse()
