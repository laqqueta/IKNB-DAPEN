...
public enum ER2506PosRbPmvu060100 implements IObject<KeyValueString> {
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER2506PosRbPmvu060100 eEnum : ER2506PosRbPmvu060100.values()) {
	...
	public static String getName() {
		return ER2506PosRbPmvu060100.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER2506PosRbPmvu060100.class.getSimpleName().substring(2, 6));
	}
