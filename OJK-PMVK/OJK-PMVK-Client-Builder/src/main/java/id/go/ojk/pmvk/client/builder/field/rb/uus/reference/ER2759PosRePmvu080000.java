...
public enum ER2759PosRePmvu080000 implements IObject<KeyValueString> {
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER2759PosRePmvu080000 eEnum : ER2759PosRePmvu080000.values()) {
	...
	public static String getName() {
		return ER2759PosRePmvu080000.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER2759PosRePmvu080000.class.getSimpleName().substring(2, 6));
	}
