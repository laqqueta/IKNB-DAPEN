...
public enum ER2764PosRePmvu100202 implements IObject<KeyValueString> {
...
//	R_10020203000000 ("10020203000000", "EKUITAS"),
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER2764PosRePmvu100202 eEnum : ER2764PosRePmvu100202.values()) {
	...
	public static String getName() {
		return ER2764PosRePmvu100202.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER2764PosRePmvu100202.class.getSimpleName().substring(2, 6));
	}
	...
	public static FieldValidation genValidationSum() {
		return UtilFieldValidation.genEqualsPosFormula("3-2", 0, UtilMetadata.genPipeRowExcept(getObjects(), new int[] { 10, 19, 20, 23, 31, 36, 39, 40 }));
	}

	public static SegmentValidation genValidationJumlahAset() {
		return UtilSegmentValidation.genEqualsFormula("2|3|4", R_10020201110000.key,
	...
	public static SegmentValidation genValidationJumlahAsetJumlahLiabilitasDanEkuitas() {
		return UtilSegmentValidation.genEqualsFormula("2|3", R_10020201110000.key,
	...
	public static SegmentValidation genValidationJumlahLiabilitas() {
		return UtilSegmentValidation.genEqualsFormula("2|3|4", R_10020202090000.key,
	...
	public static SegmentValidation genValidationModal() {
		return UtilSegmentValidation.genEqualsFormula("2|3|4", R_10020203010000.key,
	...
	public static SegmentValidation genValidationTambahanModalDisetor() {
		return UtilSegmentValidation.genEqualsFormula("2|3|4", R_10020203010300.key,
	...
	public static SegmentValidation genValidationCadangan() {
		return UtilSegmentValidation.genEqualsFormula("2|3|4", R_10020203020000.key, 
				UtilMetadata.genPlusRow(getObjects(), 32, 33), 
				"Total Cadangan|Penjumlahan Cadangan");
	}

	public static SegmentValidation genValidationKomponenEkuitasLainnya() {
		return UtilSegmentValidation.genEqualsFormula("2|3|4", R_10020203050000.key,
	...
	public static SegmentValidation genValidationJumlahEkuitas() {
		return UtilSegmentValidation.genEqualsFormula("2|3|4", R_10020203060000.key,
	...
	public static SegmentValidation genValidationJumlahLiabilitasDanEkuitas() {
		return UtilSegmentValidation.genEqualsFormula("2|3|4", R_10020204000000.key,
