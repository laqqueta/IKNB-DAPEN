...
public enum ER2515PosRbPmvu100302 implements IObject<KeyValueString> {
...
//	R_10030204000000000000 ("10030204000000000000", "TAKSIRAN PAJAK PENGHASILAN"),
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER2515PosRbPmvu100302 eEnum : ER2515PosRbPmvu100302.values()) {
	...
	public static String getName() {
		return ER2515PosRbPmvu100302.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER2515PosRbPmvu100302.class.getSimpleName().substring(2, 6));
	}
	...
	public static SegmentValidation genValidationPendapatanDariKegiatanUsahaLain() {
		return UtilSegmentValidation.genEqualsFormula("2|3|4|5", R_10030201010400000000.key,
	...
	public static SegmentValidation genValidationPendapatanNonOperasional() {
		return UtilSegmentValidation.genEqualsFormula("2|3|4|5", R_10030201040000000000.key,
	...
	public static SegmentValidation genValidationTotalPendapatan() {
		return UtilSegmentValidation.genEqualsFormula("2|3|4|5", R_10030201050000000000.key,
	...
	public static SegmentValidation genValidationTotalBeban() {
		return UtilSegmentValidation.genEqualsFormula("2|3|4|5", R_10030202030000000000.key,
	...
	public static SegmentValidation genValidationFormLabaSetelahPajak() {
		...
		return UtilSegmentValidation.genEqualsForm2("2|3|4|5", R_10030205000000000000.key, comparatorFormCode, 
				ER2514PosRbPmvu100202.R_10020203040000.getKey(), 
	...
	public static SegmentValidation genValidationFormKeuntunganPendapatanKomprehensifLainnya() {
		...
		return UtilSegmentValidation.genEqualsForm2("2|3|4|5", R_10030206000000000000.key, comparatorFormCode, 
				ER2514PosRbPmvu100202.R_10020203050200.getKey(), 
				"Total Keuntungan (Kerugian) Pendapatan Komprehensif Lainnya|Nilai Keuntungan (Kerugian) Pendapatan Komprehensif Lainnya form " + comparatorFormCode + " #kolom#");
	}
}
