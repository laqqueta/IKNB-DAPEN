...
import id.go.ojk.pmvk.client.builder.field.rb.reference.ER2262PosRePmvk090204;
...
public class Re090204 extends BaseMetadata {
	...
	public SubmissionFormat get() {
		...
		fs.add(sf(2, null, "Bidang Tugas",
				sv(O, 0, 1000, all).confConditionalRequired(ER2262PosRePmvk090204.genConditionalField())));
		fs.add(sf(3, null, "Alasan Pemanfaatan Tenaga Alih Daya",
				sv(C, 0, 1000, all).confConditionalRequired(ER2262PosRePmvk090204.genConditionalField())));
		fs.add(sf(4, null, "Jumlah Tenaga Kerja Alih Daya",
				sv(C, 1, 16, numeric).confConditionalRequired(ER2262PosRePmvk090204.genConditionalField())));
