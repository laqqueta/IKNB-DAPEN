...
public enum ER2760PosRePmvu090202 implements IObject<KeyValueString> {
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER2760PosRePmvu090202 eEnum : ER2760PosRePmvu090202.values()) {
	...
	public static String getName() {
		return ER2760PosRePmvu090202.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER2760PosRePmvu090202.class.getSimpleName().substring(2, 6));
	}
