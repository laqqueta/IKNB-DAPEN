...
public enum ER2507PosRbPmvu070102 implements IObject<KeyValueString> {
...
//	R_07010202000000 ("07010202000000", "Saldo Penerimaan Pendanaan (Outstanding):"),
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER2507PosRbPmvu070102 eEnum : ER2507PosRbPmvu070102.values()) {
	...
	public static String getName() {
		return ER2507PosRbPmvu070102.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER2507PosRbPmvu070102.class.getSimpleName().substring(2, 6));
	}
	...
	public static SegmentValidation genValidationTotalPenerimaanPendanaanBaru() {
		return UtilSegmentValidation.genEqualsFormula("2|3|4|5", R_07010201160000.key,
	...
	public static SegmentValidation genValidationTotalSaldoPenerimaanPendanaan() {
		return UtilSegmentValidation.genEqualsFormula("2|3|4|5", R_07010202160000.key,
