...
public enum ER2002PosRbPmvk040201 implements IObject<KeyValueString> {
...
//	R_04020102000000 ("04020102000000", "Saldo Posisi (Outstanding Principal):"),
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER2002PosRbPmvk040201 eEnum : ER2002PosRbPmvk040201.values()) {
	...
	public static String getName() {
		return ER2002PosRbPmvk040201.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER2002PosRbPmvk040201.class.getSimpleName().substring(2, 6));
	}
	...
	public static SegmentValidation genValidationFormTotalRencanaPenyaluranPembiayaanBaru() {
		...
		return UtilSegmentValidation.genEqualsForm2("2|3|4|5", R_04020101030000.key, comparatorFormCode, 
				...
				"Nilai Rencana Penyaluran Pembiayaan Baru|Nilai Total Rencana Pembiayaan/Penyertaan Baru form " + comparatorFormCode + " #kolom#");
	}
