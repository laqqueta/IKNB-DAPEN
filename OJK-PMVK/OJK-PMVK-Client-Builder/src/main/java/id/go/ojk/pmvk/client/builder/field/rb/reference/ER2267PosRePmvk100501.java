...
public enum ER2267PosRePmvk100501 implements IObject<KeyValueString> {
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER2267PosRePmvk100501 eEnum : ER2267PosRePmvk100501.values()) {
	...
	public static String getName() {
		return ER2267PosRePmvk100501.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER2267PosRePmvk100501.class.getSimpleName().substring(2, 6));
	}
	...
	public static SegmentValidation genValidationJumlah() {
		return UtilSegmentValidation.genEqualsFormula("2|3", R_10050108000000.key,
				UtilMetadata.genPlusRow(getObjects(), new int[] { 0, 9, 10, 11, 14, 17, 25 }), "Total|Penjumlahan dari rincian");
	}
}
