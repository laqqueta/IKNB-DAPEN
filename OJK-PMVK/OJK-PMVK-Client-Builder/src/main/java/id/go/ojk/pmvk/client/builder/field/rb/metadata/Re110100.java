...
import id.go.ojk.pmvk.client.builder.field.rb.reference.ER2268PosRePmvk110100;
...
public class Re110100 extends BaseMetadata {
	...
	public SubmissionFormat get() {
		...
		SubmissionFormat res = new SubmissionFormat(eEnum.getCode(), eEnum.getName(), reportCode, new ArrayList<>(),
				extension, 11, 11, null, ER2268PosRePmvk110100.genFieldSave(), ER2268PosRePmvk110100.getRequiredPos());
		...
		fs.add(sf(4, null, "Deviasi", sv(M, 1, 16, numericDotNegatif))
				.addFieldValidations(ER2268PosRePmvk110100.genValidationSum()));
		return res;
	}
}
