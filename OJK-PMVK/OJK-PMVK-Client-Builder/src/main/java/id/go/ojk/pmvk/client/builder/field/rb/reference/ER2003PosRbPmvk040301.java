...
public enum ER2003PosRbPmvk040301 implements IObject<KeyValueString> {
...
//	R_04030102000000 ("04030102000000", "Saldo Posisi (Outstanding Principal):"),
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER2003PosRbPmvk040301 eEnum : ER2003PosRbPmvk040301.values()) {
	...
	public static String getName() {
		return ER2003PosRbPmvk040301.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER2003PosRbPmvk040301.class.getSimpleName().substring(2, 6));
	}
	...
	public static SegmentValidation genValidationTotalRencanaPenyaluranPembiayaanBaru() {
		return UtilSegmentValidation.genEqualsFormula("2|3|4|5", R_04030101360000.key, 
	...
	public static SegmentValidation genValidationTotalSaldoPosisi() {
		return UtilSegmentValidation.genEqualsFormula("2|3|4|5", R_04030102360000.key, 
	...
	public static SegmentValidation genValidationFormTotalRencanaPenyaluranPembiayaanBaru() {
		...
		return UtilSegmentValidation.genEqualsForm2("2|3|4|5", R_04030101360000.key, comparatorFormCode, 
				ER2001PosRbPmvk040101.R_04010101060000.getKey(), 
	...
	public static SegmentValidation genValidationFormTotalSaldoPosisi() {
		String comparatorFormCode = EFormRencanaBisnis.RB_040101.getCode();
		return UtilSegmentValidation.genEqualsForm2("2|3|4|5", R_04030102360000.key, comparatorFormCode, 
				ER2001PosRbPmvk040101.R_04010102060000.getKey(), 
