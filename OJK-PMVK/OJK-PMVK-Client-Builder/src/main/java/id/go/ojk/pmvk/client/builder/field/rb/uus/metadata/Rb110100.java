...
import id.go.ojk.pmvk.client.builder.field.rb.uus.reference.ER2518PosRbPmvu110100;
...
public class Rb110100 extends BaseMetadata {
	...
	public SubmissionFormat get() {
		EFormRencanaBisnisUus eEnum = EFormRencanaBisnisUus.RB_110100;
		SubmissionFormat res = new SubmissionFormat(eEnum.getCode(), eEnum.getName(), reportCode, new ArrayList<>(),
				extension, 11, 11, null, ER2518PosRbPmvu110100.genFieldSave(), ER2518PosRbPmvu110100.getRequiredPos());
		List<SubmissionField> fs = res.getFields();
		fs.add(sf(0, null, "Flag Detail", sv(M, 3, 3, alfaNumeric).confConstant("D01")));
		fs.add(sf(1, null, "Kode Komponen / Baris",
				sv(M, 14, 14, refTable).confReference(EHeaderMetadataRbUus.R2518_RB110100.getObject())).confUnique(U));
