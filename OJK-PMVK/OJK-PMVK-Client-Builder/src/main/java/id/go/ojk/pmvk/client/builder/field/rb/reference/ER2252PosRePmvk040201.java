...
public enum ER2252PosRePmvk040201 implements IObject<KeyValueString> {
...
//	R_04020102000000 ("04020102000000", "Saldo Posisi (Outstanding Principal):"),
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER2252PosRePmvk040201 eEnum : ER2252PosRePmvk040201.values()) {
	...
	public static String getName() {
		return ER2252PosRePmvk040201.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER2252PosRePmvk040201.class.getSimpleName().substring(2, 6));
	}
	...
	public static FieldValidation genValidationSum() {
		return UtilFieldValidation.genEqualsPosFormula("3-2", 0, UtilMetadata.genPipeRowExcept(getObjects(), new int[] { 0, 22, 25, 26, 48, 51 }));
	}

	public static SegmentValidation genValidationSektorEkonomiLapanganUsahaA() {
		return UtilSegmentValidation.genEqualsFormula("2|3|4", R_04020101010000.key, 
	...
	public static SegmentValidation genValidationSektorEkonomiBukanLapanganUsahaA() {
		return UtilSegmentValidation.genEqualsFormula("2|3|4", R_04020101020000.key, 
	...
	public static SegmentValidation genValidationTotalRencanaPenyaluranPembiayaanBaru() {
		return UtilSegmentValidation.genEqualsFormula("2|3|4", R_04020101030000.key, 
	...
	public static SegmentValidation genValidationSektorEkonomiLapanganUsahaB() {
		return UtilSegmentValidation.genEqualsFormula("2|3|4", R_04020102010000.key, 
	...
	public static SegmentValidation genValidationSektorEkonomiBukanLapanganUsahaB() {
		return UtilSegmentValidation.genEqualsFormula("2|3|4", R_04020102020000.key, 
	...
	public static SegmentValidation genValidationTotalSaldoPosisi() {
		return UtilSegmentValidation.genEqualsFormula("2|3|4", R_04020102030000.key, 
	...
	public static SegmentValidation genValidationFormTotalRencanaPenyaluranPembiayaanBaru() {
		...
		return UtilSegmentValidation.genEqualsForm2("2|3", R_04020101030000.key, comparatorFormCode, 
				ER2251PosRePmvk040101.R_04010101060000.getKey(), 
				"Total Rencana Penyaluran Pembiayaan Baru|Total Rencana Pembiayaan/Penyertaan Baru form " + comparatorFormCode + " #kolom#");
	}

	public static SegmentValidation genValidationFormTotalSaldoPosisi() {
		String comparatorFormCode = EFormRealisasiBisnis.RE_040101.getCode();
		return UtilSegmentValidation.genEqualsForm2("2|3", R_04020102030000.key, comparatorFormCode, 
				ER2251PosRePmvk040101.R_04010102060000.getKey(), 
