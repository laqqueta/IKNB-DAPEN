...
public enum ER5000PosApuPmvk01 implements IObject<KeyValueString> {
...
//	R_0103020400000000 ("0103020400000000", "  4) Pembayaran melalui Cara Tidak Tatap Muka Lainnya:"),
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER5000PosApuPmvk01 eEnum : ER5000PosApuPmvk01.values()) {
	...
	public static String getName() {
		return ER5000PosApuPmvk01.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER5000PosApuPmvk01.class.getSimpleName().substring(2, 6));
	}
