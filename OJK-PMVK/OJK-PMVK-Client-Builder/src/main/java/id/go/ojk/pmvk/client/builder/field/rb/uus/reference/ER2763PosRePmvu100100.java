...
public enum ER2763PosRePmvu100100 implements IObject<KeyValueString> {
...
//	R_10010200000000 ("10010200000000", "Asumsi Mikro:"),
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER2763PosRePmvu100100 eEnum : ER2763PosRePmvu100100.values()) {
	...
	public static String getName() {
		return ER2763PosRePmvu100100.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER2763PosRePmvu100100.class.getSimpleName().substring(2, 6));
	}
