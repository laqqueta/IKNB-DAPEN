...
public enum ER2260PosRePmvk090202 implements IObject<KeyValueString> {
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER2260PosRePmvk090202 eEnum : ER2260PosRePmvk090202.values()) {
	...
	public static String getName() {
		return ER2260PosRePmvk090202.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER2260PosRePmvk090202.class.getSimpleName().substring(2, 6));
	}
