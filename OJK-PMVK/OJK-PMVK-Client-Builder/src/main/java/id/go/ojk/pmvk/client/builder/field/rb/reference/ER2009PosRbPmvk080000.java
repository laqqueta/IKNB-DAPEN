...
public enum ER2009PosRbPmvk080000 implements IObject<KeyValueString> {
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER2009PosRbPmvk080000 eEnum : ER2009PosRbPmvk080000.values()) {
	...
	public static String getName() {
		return ER2009PosRbPmvk080000.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER2009PosRbPmvk080000.class.getSimpleName().substring(2, 6));
	}
