...
import id.go.ojk.pmvk.client.builder.field.rb.uus.reference.ER2506PosRbPmvu060100;
...
public class Rb060100 extends BaseMetadata {
	...
	public SubmissionFormat get() {
		EFormRencanaBisnisUus eEnum = EFormRencanaBisnisUus.RB_060100;
		SubmissionFormat res = new SubmissionFormat(eEnum.getCode(), eEnum.getName(), reportCode, new ArrayList<>(),
				extension, 4, null, null, null, ER2506PosRbPmvu060100.getRequiredPos());
		List<SubmissionField> fs = res.getFields();
		fs.add(sf(0, null, "Flag Detail", sv(M, 3, 3, alfaNumeric).confConstant("D01")));
		fs.add(sf(1, null, "Kode Komponen / Baris",
				sv(M, 14, 14, refTable).confReference(EHeaderMetadataRbUus.R2506_RB060100.getObject())));
		fs.add(sf(2, null, "Nama Pemegang Saham",
				sv(C, 0, 160, all).confConditionalRequired(ER2506PosRbPmvu060100.genValidationMustEmpty())));
		fs.add(sf(3, null, "Kategori Pemegang Saham",
				sv(C, 0, 10, refTable).confReference(EHeaderMetadataShared.R001.getObject())
						.confConditionalRequired(ER2506PosRbPmvu060100.genValidationMustEmpty())));
