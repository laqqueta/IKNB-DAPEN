...
import id.go.ojk.pmvk.client.builder.field.rb.reference.ER2010PosRbPmvk090202;
...
public class Rb090202 extends BaseMetadata {
	...
	public SubmissionFormat get() {
		...
		fs.add(sf(1, null, "Kode Komponen / Baris",
				sv(M, 14, 14, refTable).confReference(EHeaderMetadataRb.R2010_RB090202.getObject())));
		...
		fs.add(sf(3, null, "Metode Diklat", sv(C, 0, 10, refTable).confReference(EHeaderMetadataShared.R007.getObject())
				.confConditionalRequired(ER2010PosRbPmvk090202.genConditionalField())));
		fs.add(sf(4, null, "Perkiraan Waktu Diklat",
				sv(C, 0, 6, yearMonth).confConditionalRequired(ER2010PosRbPmvk090202.genConditionalField())));
		fs.add(sf(5, null, "Durasi Diklat",
				sv(C, 0, 1000, all).confConditionalRequired(ER2010PosRbPmvk090202.genConditionalField())));
		...
		fs.add(sf(9, null, "Biaya Diklat",
				sv(C, 0, 16, numericNegatif).confConditionalRequired(ER2010PosRbPmvk090202.genConditionalField())));
		return res;
	}
}
