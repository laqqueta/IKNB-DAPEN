...
import id.go.ojk.pmvk.client.builder.field.rb.reference.ER2263PosRePmvk100100;
...
public class Re100100 extends BaseMetadata {
	...
	public SubmissionFormat get() {
		...
		SubmissionFormat res = new SubmissionFormat(eEnum.getCode(), eEnum.getName(), reportCode, new ArrayList<>(),
				extension, 10, null, null, null, ER2263PosRePmvk100100.getRequiredPos());
		res.addSegmentValidations(ER2263PosRePmvk100100.genValidationNumeric());
		res.addSegmentValidations(ER2263PosRePmvk100100.genValidationNumericDot());
		res.addSegmentValidations(ER2263PosRePmvk100100.genValidationMaxLengthNumeric());
		...
		fs.add(sf(2, null, "Asumsi Lainnya",
				sv(C, 0, 200, all).confConditionalRequired(ER2263PosRePmvk100100.genConditionalMustEmpty())));
		...
		fs.add(sf(5, null, "Deviasi", sv(M, 1, 200, all))
				.addFieldValidations(ER2263PosRePmvk100100.genValidationSum()));
		return res;
	}
}
