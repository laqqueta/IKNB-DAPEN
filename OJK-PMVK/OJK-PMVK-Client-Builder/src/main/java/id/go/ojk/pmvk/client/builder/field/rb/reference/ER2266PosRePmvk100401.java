...
public enum ER2266PosRePmvk100401 implements IObject<KeyValueString> {
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER2266PosRePmvk100401 eEnum : ER2266PosRePmvk100401.values()) {
	...
	public static String getName() {
		return ER2266PosRePmvk100401.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER2266PosRePmvk100401.class.getSimpleName().substring(2, 6));
	}
	...
	public static SegmentValidation genValidationArusKasBersihDariKegiatanOperasi() {
		return UtilSegmentValidation.genEqualsFormula("2|3", R_10040101000000.key,
	...
	public static SegmentValidation genValidationArusKasMasukDariKegiatanOperasi() {
		return UtilSegmentValidation.genEqualsFormula("2|3", R_10040101010000.key,
				UtilMetadata.genPlusRow(getObjects(), 2, 8) + "+" + UtilMetadata.genPlusRow(getObjects(), 11, 12),
	...
	public static SegmentValidation genValidationArusKasMasukDariKegiatanUsahaLain() {
		return UtilSegmentValidation.genEqualsFormula("2|3", R_10040101010700.key,
	...
	public static SegmentValidation genValidationArusKasKeluarUntukKegiatanOperasi() {
		return UtilSegmentValidation.genEqualsFormula("2|3", R_10040101020000.key,
	...
	public static SegmentValidation genValidationArusKasKeluarUntukKegiatanUsahaLain() {
		return UtilSegmentValidation.genEqualsFormula("2|3", R_10040101020700.key,
	...
	public static SegmentValidation genValidationArusKasBersihDariKegiatanInvestasi() {
		return UtilSegmentValidation.genEqualsFormula("2|3", R_10040102000000.key,
	...
	public static SegmentValidation genValidationArusKasMasukDariKegiatanInvestasi() {
		return UtilSegmentValidation.genEqualsFormula("2|3", R_10040102010000.key,
	...
	public static SegmentValidation genValidationArusKasKeluarUntukKegiatanInvestasi() {
		return UtilSegmentValidation.genEqualsFormula("2|3", R_10040102020000.key,
	...
	public static SegmentValidation genValidationArusKasBersihDariKegiatanPendanaan() {
		return UtilSegmentValidation.genEqualsFormula("2|3", R_10040103000000.key,
	...
	public static SegmentValidation genValidationArusKasMasukDariKegiatanPendanaan() {
		return UtilSegmentValidation.genEqualsFormula("2|3", R_10040103010000.key,
	...
	public static SegmentValidation genValidationArusKasKeluarUntukKegiatanPendanaan() {
		return UtilSegmentValidation.genEqualsFormula("2|3", R_10040103020000.key,
	...
	public static SegmentValidation genValidationKenaikanBersihKasDanSetaraKas() {
		return UtilSegmentValidation.genEqualsFormula("2|3", R_10040105000000.key,
	...
	public static SegmentValidation genValidationKasDanSetaraKasPadaAkhirPeriode() {
		return UtilSegmentValidation.genEqualsFormula("2|3", R_10040107000000.key,
	...
	public static SegmentValidation genValidationFormKasDanSetaraKasPadaAkhirPeriode() {
		...
		return UtilSegmentValidation.genEqualsForm2("2|3", R_10040107000000.key, comparatorFormCode, 
				ER2264PosRePmvk100201.R_10020101010000.getKey(), 
