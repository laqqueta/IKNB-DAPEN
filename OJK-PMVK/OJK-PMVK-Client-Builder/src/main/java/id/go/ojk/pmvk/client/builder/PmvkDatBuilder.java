...
import id.go.ojk.pmvk.client.builder.field.EUpdateHeader;
import id.go.ojk.pmvk.client.builder.field.setup.ESetupKeyValueStringFilename;
import lombok.extern.slf4j.Slf4j;

@Slf4j
public class PmvkDatBuilder extends BaseDatBuilder {
	private static final EReport REPORT_RB = EReport.RB_PMVK;
	private static final EReport REPORT_RB_UUS = EReport.RB_PMVU;
	private static final EReport REPORT_APU = EReport.APU_PMVK;
	private static final String DUMMY_USER = "pmvkdummy@gmail.com";

	public static void main(String[] args) {
		try {
			log.info("starting builder");
			PmvkDatBuilder builder = new PmvkDatBuilder(args);
	...
	public PmvkDatBuilder(String[] args) {
	...
	protected String genDummyClientEntity() {
		return genDummyClientEntity(Constant.SECTOR.getCode(), Arrays.asList("2000002657"), DUMMY_USER);
	}
