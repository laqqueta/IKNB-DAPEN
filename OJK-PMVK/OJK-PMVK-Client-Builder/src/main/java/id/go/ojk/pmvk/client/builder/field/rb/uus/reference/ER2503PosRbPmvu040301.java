...
public enum ER2503PosRbPmvu040301 implements IObject<KeyValueString> {
...
//	R_04030102000000 ("04030102000000", "Saldo Posisi (Outstanding Principal):"),
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER2503PosRbPmvu040301 eEnum : ER2503PosRbPmvu040301.values()) {
	...
	public static String getName() {
		return ER2503PosRbPmvu040301.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER2503PosRbPmvu040301.class.getSimpleName().substring(2, 6));
	}
