...
import id.go.ojk.pmvk.client.builder.field.rb.reference.ER2005PosRbPmvk050201;
...
public class Rb050201 extends BaseMetadata {
	...
	public SubmissionFormat get() {
		...
		fs.add(sf(3, null, "Deskripsi Umum Kegiatan Usaha",
				sv(C, 0, 1000, all).confConditionalRequired(ER2005PosRbPmvk050201.genConditionalField())));
		fs.add(sf(4, null, "Waktu Pelaksanaan Kegiatan Usaha Baru",
				sv(C, 0, 8, date).confConditionalRequired(ER2005PosRbPmvk050201.genConditionalField())));
