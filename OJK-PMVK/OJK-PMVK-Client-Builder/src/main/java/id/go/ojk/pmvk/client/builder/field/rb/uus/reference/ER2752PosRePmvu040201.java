...
public enum ER2752PosRePmvu040201 implements IObject<KeyValueString> {
...
//	R_04020102000000 ("04020102000000", "Saldo Posisi (Outstanding Principal):"),
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER2752PosRePmvu040201 eEnum : ER2752PosRePmvu040201.values()) {
	...
	public static String getName() {
		return ER2752PosRePmvu040201.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER2752PosRePmvu040201.class.getSimpleName().substring(2, 6));
	}
