...
import id.go.ojk.pmvk.client.builder.field.rb.uus.reference.ER2768PosRePmvu110100;
...
public class Re110100 extends BaseMetadata {
	...
	public SubmissionFormat get() {
		EFormRealisasiBisnisUus eEnum = EFormRealisasiBisnisUus.RE_110100;
		SubmissionFormat res = new SubmissionFormat(eEnum.getCode(), eEnum.getName(), reportCode, new ArrayList<>(),
				extension, 11, 11, null, ER2768PosRePmvu110100.genFieldSave(), ER2768PosRePmvu110100.getRequiredPos());
		List<SubmissionField> fs = res.getFields();
		fs.add(sf(0, null, "Flag Detail", sv(M, 3, 3, alfaNumeric).confConstant("D01")));
		fs.add(sf(1, null, "Kode Komponen / Baris",
				sv(M, 14, 14, refTable).confReference(EHeaderMetadataRbUus.R2768_RE110100.getObject())).confUnique(U));
		...
		fs.add(sf(4, null, "Deviasi", sv(M, 1, 16, numericDotNegatif))
				.addFieldValidations(ER2768PosRePmvu110100.genValidationSum()));
		return res;
	}
}
