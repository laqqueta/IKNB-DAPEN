...
public enum ER2766PosRePmvu100402 implements IObject<KeyValueString> {
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER2766PosRePmvu100402 eEnum : ER2766PosRePmvu100402.values()) {
	...
	public static String getName() {
		return ER2766PosRePmvu100402.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER2766PosRePmvu100402.class.getSimpleName().substring(2, 6));
	}
	...
	public static FieldValidation genValidationSum() {
		return UtilFieldValidation.genEqualsPosFormula("3-2", 0, UtilMetadata.genPipeRowExcept(getObjects(), new int[] { 0, 1, 7, 12, 18, 26, 27, 34, 39, 40, 44, 50, 52 }));
	}

	public static SegmentValidation genValidationArusKasBersihDariKegiatanOperasi() {
		return UtilSegmentValidation.genEqualsFormula("2|3|4", R_10040201000000.key,
	...
	public static SegmentValidation genValidationArusKasMasukDariKegiatanOperasi() {
		return UtilSegmentValidation.genEqualsFormula("2|3|4", R_10040201010000.key,
				UtilMetadata.genPlusRow(getObjects(), 2, 7) + "+" + UtilMetadata.genPlusRow(getObjects(), 10, 11),
	...
	public static SegmentValidation genValidationArusKasMasukDariKegiatanUsahaLain() {
		return UtilSegmentValidation.genEqualsFormula("2|3|4", R_10040201010600.key,
	...
	public static SegmentValidation genValidationArusKasKeluarUntukKegiatanOperasi() {
		return UtilSegmentValidation.genEqualsFormula("2|3|4", R_10040201020000.key,
	...
	public static SegmentValidation genValidationArusKasKeluarUntukKegiatanUsahaLain() {
		return UtilSegmentValidation.genEqualsFormula("2|3|4", R_10040201020600.key,
	...
	public static SegmentValidation genValidationArusKasBersihDariKegiatanInvestasi() {
		return UtilSegmentValidation.genEqualsFormula("2|3|4", R_10040202000000.key,
	...
	public static SegmentValidation genValidationArusKasMasukDariKegiatanInvestasi() {
		return UtilSegmentValidation.genEqualsFormula("2|3|4", R_10040202010000.key,
	...
	public static SegmentValidation genValidationArusKasKeluarUntukKegiatanInvestasi() {
		return UtilSegmentValidation.genEqualsFormula("2|3|4", R_10040202020000.key,
	...
	public static SegmentValidation genValidationArusKasBersihDariKegiatanPendanaan() {
		return UtilSegmentValidation.genEqualsFormula("2|3|4", R_10040203000000.key,
	...
	public static SegmentValidation genValidationArusKasMasukDariKegiatanPendanaan() {
		return UtilSegmentValidation.genEqualsFormula("2|3|4", R_10040203010000.key,
	...
	public static SegmentValidation genValidationArusKasKeluarUntukKegiatanPendanaan() {
		return UtilSegmentValidation.genEqualsFormula("2|3|4", R_10040203020000.key,
	...
	public static SegmentValidation genValidationKenaikanBersihKasDanSetaraKas() {
		return UtilSegmentValidation.genEqualsFormula("2|3|4", R_10040205000000.key,
	...
	public static SegmentValidation genValidationKasDanSetaraKasPadaAkhirPeriode() {
		return UtilSegmentValidation.genEqualsFormula("2|3|4", R_10040207000000.key,
	...
	public static SegmentValidation genValidationFormKasDanSetaraKasPadaAkhirPeriode() {
		...
		return UtilSegmentValidation.genEqualsForm2("2|3", R_10040207000000.key, comparatorFormCode, 
				ER2764PosRePmvu100202.R_10020201010000.getKey(), 
