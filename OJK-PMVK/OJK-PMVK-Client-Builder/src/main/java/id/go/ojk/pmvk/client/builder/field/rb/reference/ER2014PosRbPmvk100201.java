...
public enum ER2014PosRbPmvk100201 implements IObject<KeyValueString> {
...
//	R_10020103000000 ("10020103000000", "EKUITAS"),
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER2014PosRbPmvk100201 eEnum : ER2014PosRbPmvk100201.values()) {
	...
	public static String getName() {
		return ER2014PosRbPmvk100201.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER2014PosRbPmvk100201.class.getSimpleName().substring(2, 6));
	}
	...
	public static SegmentValidation genValidationJumlahAset() {
		return UtilSegmentValidation.genEqualsFormula("2|3|4|5", R_10020101120000.key,
	...
	public static SegmentValidation genValidationJumlahLiabilitas() {
		return UtilSegmentValidation.genEqualsFormula("2|3|4|5", R_10020102090000.key,
	...
	public static SegmentValidation genValidationModal() {
		return UtilSegmentValidation.genEqualsFormula("2|3|4|5", R_10020103010000.key,
	...
	public static SegmentValidation genValidationTambahanModalDisetor() {
		return UtilSegmentValidation.genEqualsFormula("2|3|4|5", R_10020103010300.key,
	...
	public static SegmentValidation genValidationCadangan() {
		return UtilSegmentValidation.genEqualsFormula("2|3|4|5", R_10020103020000.key,
				UtilMetadata.genPlusRow(getObjects(), 33, 34), "Total Cadangan|Penjumlahan Cadangan");
	}

	public static SegmentValidation genValidationKomponenEkuitasLainnya() {
		return UtilSegmentValidation.genEqualsFormula("2|3|4|5", R_10020103050000.key,
	...
	public static SegmentValidation genValidationJumlahEkuitas() {
		return UtilSegmentValidation.genEqualsFormula("2|3|4|5", R_10020103060000.key,
	...
	public static SegmentValidation genValidationJumlahLiabilitasDanEkuitas() {
		return UtilSegmentValidation.genEqualsFormula("2|3|4|5", R_10020104000000.key,
