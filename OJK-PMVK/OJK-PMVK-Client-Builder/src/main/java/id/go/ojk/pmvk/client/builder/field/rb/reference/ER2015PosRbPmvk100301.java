...
public enum ER2015PosRbPmvk100301 implements IObject<KeyValueString> {
...
//	R_10030104000000000000 ("10030104000000000000", "TAKSIRAN PAJAK PENGHASILAN"),
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER2015PosRbPmvk100301 eEnum : ER2015PosRbPmvk100301.values()) {
	...
	public static String getName() {
		return ER2015PosRbPmvk100301.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER2015PosRbPmvk100301.class.getSimpleName().substring(2, 6));
	}
	...
	public static SegmentValidation genValidationPendapatanDariKegiatanUsahaLain() {
		return UtilSegmentValidation.genEqualsFormula("2|3|4|5", R_10030101010500000000.key,
	...
	public static SegmentValidation genValidationPendapatanNonOperasional() {
		return UtilSegmentValidation.genEqualsFormula("2|3|4|5", R_10030101040000000000.key,
	...
	public static SegmentValidation genValidationTotalPendapatan() {
		return UtilSegmentValidation.genEqualsFormula("2|3|4|5", R_10030101050000000000.key,
	...
	public static SegmentValidation genValidationTotalBeban() {
		return UtilSegmentValidation.genEqualsFormula("2|3|4|5", R_10030102030000000000.key,
	...
	public static SegmentValidation genValidationFormLabaSetelahPajak() {
		...
		return UtilSegmentValidation.genEqualsForm2("2|3|4|5", R_10030105000000000000.key, comparatorFormCode, 
				...
				"Nilai Laba (Rugi) Bersih Setelah Pajak|Nilai Laba (Rugi) Bersih Setelah Pajak form " + comparatorFormCode + " #kolom#");
	}
	...
	public static SegmentValidation genValidationFormKeuntunganPendapatanKomprehensifLainnya() {
		...
		return UtilSegmentValidation.genEqualsForm2("2|3|4|5", R_10030106000000000000.key, comparatorFormCode, 
				ER2014PosRbPmvk100201.R_10020103050200.getKey(), 
				"Nilai Keuntungan (Kerugian) Pendapatan Komprehensif Lainnya|Nilai Keuntungan (Kerugian) Komperehensif Lainnya Periode Berjalan form " + comparatorFormCode + " #kolom#");
	}
}
