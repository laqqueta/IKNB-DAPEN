...
public enum ER2767PosRePmvu100502 implements IObject<KeyValueString> {
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER2767PosRePmvu100502 eEnum : ER2767PosRePmvu100502.values()) {
	...
	public static String getName() {
		return ER2767PosRePmvu100502.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER2767PosRePmvu100502.class.getSimpleName().substring(2, 6));
	}
