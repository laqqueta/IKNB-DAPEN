...
public enum ER2001PosRbPmvk040101 implements IObject<KeyValueString> {
...
//	R_04010102000000 ("04010102000000", "Saldo Posisi (Outstanding Principal):"),
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER2001PosRbPmvk040101 eEnum : ER2001PosRbPmvk040101.values()) {
	...
	public static String getName() {
		return ER2001PosRbPmvk040101.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER2001PosRbPmvk040101.class.getSimpleName().substring(2, 6));
	}
	...
	public static SegmentValidation genValidationTotalRencanaPembiayaanBaru() {
		return UtilSegmentValidation.genEqualsFormula("2|3|4|5", R_04010101060000.key,
	...
	public static SegmentValidation genValidationTotalSaldoPosisi() {
		return UtilSegmentValidation.genEqualsFormula("2|3|4|5", R_04010102060000.key,
