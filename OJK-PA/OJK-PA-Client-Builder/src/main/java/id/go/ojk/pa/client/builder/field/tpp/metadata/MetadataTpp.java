...
public class MetadataTpp {
    ...
    public static List<SubmissionFormat> getMetadata() {
        ...
        String rencana = EReportTpp.PA_RENCANA_RUTIN.getReportTypeCode();
        String realisasi = EReportTpp.PA_REALISASI_RUTIN.getReportTypeCode();
        String penilaianResiko = EReportTpp.PA_PENILAIAN_RESIKO_RUTIN.getReportTypeCode();
