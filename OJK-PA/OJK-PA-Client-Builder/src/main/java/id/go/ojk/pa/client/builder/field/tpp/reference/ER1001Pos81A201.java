...
public enum ER1001Pos81A201 implements IObject<KeyValueString> {
    ...
    public static List<KeyValueString> getObjects() {
        ...
        for (ER1001Pos81A201 eEnum : ER1001Pos81A201.values()) {
    ...
    public static String getName() {
        return ER1001Pos81A201.class.getSimpleName().substring(6);
    }

    public static int getRefNumber() {
        return Integer.parseInt(ER1001Pos81A201.class.getSimpleName().substring(2, 6));
    }
}
