...
AppName=PA Client
AppVersion=1.0.0
AppVerName=PA-Client 1.0.0
AppPublisher=OJK
AppComments=OJK PA Client
AppCopyright=Copyright (C) 2020
;AppPublisherURL=http://java.com/
;AppSupportURL=http://java.com/
;AppUpdatesURL=http://java.com/
DefaultDirName=C:\OJK-PA-Client
...
[Setup]
SetupMutex=PA-Client,Global\PA-Client
OutputDir="..\ftp\app"

[Icons]
Name: "{group}\PA-Client"; Filename: "{app}\OjkClient.exe"; IconFilename: "{app}\Client.ico"; Check: returnTrue()
...
Filename: "{app}\OjkClient.exe"; Description: "{cm:LaunchProgram,PAClient}"; Flags: nowait postinstall skipifsilent; Check: returnTrue()
Filename: "{app}\OjkClient.exe"; Parameters: "-install -svcName ""PAClient"" -svcDesc ""PAClient"" -mainExe ""OjkClient.exe""  "; Check: returnFalse()

[UninstallRun]
Filename: "{app}\OjkClient.exe "; Parameters: "-uninstall -svcName PAClient -stopOnUninstall"; Check: returnFalse()
