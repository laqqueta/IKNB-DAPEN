...
public class SampleForm2400 extends BaseSampleForm {

	public SampleForm2400(String folder, String periode, String ljk, String kodeKoreksi, int dataCount) {
		super(folder, periode, ljk, kodeKoreksi, dataCount);
	}

	@Override
	public String genFilename() {
		String filename = "LBPNMK-2400-{0}-M-{1}-{2}-01.txt";
		return genFilename(filename);
	}

	@Override
	public void writeHeader(BufferedWriter writer) throws IOException {
		final String[] HEADER = new String[] { "H01", "030491", "{ljk}", "{periode}", "LBPNMK", "2400", "{kodekoreksi}",
				"" };
	...
	public void writeDetail(BufferedWriter writer) throws IOException {
		String[] DETAIL = new String[] { "D01", "2400010000", "LO:e11", "LO:e1101", "test1", "testA", "SE:e01111", "aasdf",
		...
		for (int i = 0; i < dataCount; i++) {
			...
			String field14 = getBunga(random);
			String field15 = getRandomInt(random);
			String field16 = getKualitas(random);
			String field17 = getRandomInt(random);
			String field18 = getRandomInt(random);
