...
public class SampleForm2500 extends BaseSampleForm {

	public SampleForm2500(String folder, String periode, String ljk, String kodeKoreksi, int dataCount) {
		super(folder, periode, ljk, kodeKoreksi, dataCount);
	}

	@Override
	public String genFilename() {
		String filename = "LBPNMK-2500-{0}-M-{1}-{2}-01.txt";
		return genFilename(filename);
	}

	@Override
	public void writeHeader(BufferedWriter writer) throws IOException {
		final String[] HEADER = new String[] { "H01", "030491", "{ljk}", "{periode}", "LBPNMK", "2500", "{kodekoreksi}",
				"" };
	...
	public void writeDetail(BufferedWriter writer) throws IOException {
		String[] DETAIL = new String[] { "D01", "2500010000", "LO:e11", "LO:e1101", "test", "SE:e01111", "aasdf",
				"3131321212313", "1231321", "aasd", "20220630", "20220630", "0", "12.32", "100", "1", "0", "0" };
		...
		for (int i = 0; i < dataCount; i++) {
			...
			String field05 = getReferenceCode(sektorEkonomi, idxSektorEkonomi);
			String field06 = getNamaDebitur(i);
			String field07 = getRandomInt(random);
			String field08 = getUuid();
			String field09 = getNamaProduk(i);
			String field12 = getRandomInt(random);
			String field13 = getBunga(random);
			String field14 = getRandomInt(random);
			String field15 = getKualitas(random);
