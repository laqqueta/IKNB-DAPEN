...
public enum ER3012PosLbPnmk2600 implements IObject<KeyValueString> {
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER3012PosLbPnmk2600 eEnum : ER3012PosLbPnmk2600.values()) {
	...
	public static String getName() {
		return ER3012PosLbPnmk2600.class.getSimpleName().substring(6);
	}

	public static int getRefNumber() {
		return Integer.parseInt(ER3012PosLbPnmk2600.class.getSimpleName().substring(2, 6));
	}
