...
import id.go.ojk.pnmk.client.builder.field.lb.uus.reference.ER3107PosLbPnmu2100;
...
public class Lb2100 extends BaseMetadata {
	...
	public SubmissionFormat get() {
		...
		SubmissionFormat res = new SubmissionFormat(eEnum.getCode(), eEnum.getName(), reportCode, new ArrayList<>(),
				extension, 4, 4, ER3107PosLbPnmu2100.genFieldSave(), ER3107PosLbPnmu2100.genFieldSave(),
				ER3107PosLbPnmu2100.getRequiredPos());
		res.addSegmentValidations(ER3107PosLbPnmu2100.genRowValidation5());
		List<SubmissionField> fs = res.getFields();
		fs.add(sf(0, null, "Flag Detail", sv(M, 3, 3, alfaNumeric).confConstant("D01")));
		fs.add(sf(1, null, "Kode Komponen / Baris", sv(M, 10, 10, refTable)
				.confReference(EHeaderMetadataLbUus.R3107_LB2100.getObject()).confRegex(patternNumeric)).confUnique(U));
