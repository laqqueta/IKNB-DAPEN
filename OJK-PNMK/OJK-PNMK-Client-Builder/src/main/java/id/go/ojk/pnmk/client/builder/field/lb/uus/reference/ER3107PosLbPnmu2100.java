...
public enum ER3107PosLbPnmu2100 implements IObject<KeyValueString> {
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER3107PosLbPnmu2100 eEnum : ER3107PosLbPnmu2100.values()) {
	...
	public static String getName() {
		return ER3107PosLbPnmu2100.class.getSimpleName().substring(6);
	}

	public static int getRefNumber() {
		return Integer.parseInt(ER3107PosLbPnmu2100.class.getSimpleName().substring(2, 6));
	}
