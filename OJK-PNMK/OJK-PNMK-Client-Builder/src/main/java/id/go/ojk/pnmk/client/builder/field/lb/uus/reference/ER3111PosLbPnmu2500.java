...
public enum ER3111PosLbPnmu2500 implements IObject<KeyValueString> {
	...
	public String getFormKey() {
		return EFormLaporanBulananUus.LB_2500.getCode() + key;
	}
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER3111PosLbPnmu2500 eEnum : ER3111PosLbPnmu2500.values()) {
	...
	public static String getName() {
		return ER3111PosLbPnmu2500.class.getSimpleName().substring(6);
	}

	public static int getRefNumber() {
		return Integer.parseInt(ER3111PosLbPnmu2500.class.getSimpleName().substring(2, 6));
	}
	...
	public static String genFieldSave() {
		return UtilMetadata.genFieldSave("14|15", getObjects());
	}
