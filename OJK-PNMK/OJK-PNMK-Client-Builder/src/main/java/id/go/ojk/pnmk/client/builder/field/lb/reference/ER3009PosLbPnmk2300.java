...
public enum ER3009PosLbPnmk2300 implements IObject<KeyValueString> {
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER3009PosLbPnmk2300 eEnum : ER3009PosLbPnmk2300.values()) {
	...
	public static String getName() {
		return ER3009PosLbPnmk2300.class.getSimpleName().substring(6);
	}

	public static int getRefNumber() {
		return Integer.parseInt(ER3009PosLbPnmk2300.class.getSimpleName().substring(2, 6));
	}
	...
	public static String genFieldSave() {
		return UtilMetadata.genFieldSave("10|14", getObjects());
	}
