...
import id.go.ojk.pnmk.client.builder.field.lb.reference.ER3002PosLbPnmk0030;
...
public class Lb0030 extends BaseMetadata {
	...
	public SubmissionFormat get() {
		...
		SubmissionFormat res = new SubmissionFormat(eEnum.getCode(), eEnum.getName(), reportCode, new ArrayList<>(),
				extension, 4, 4, ER3002PosLbPnmk0030.genFieldSave(), ER3002PosLbPnmk0030.genFieldSave(),
				ER3002PosLbPnmk0030.getRequiredPos());
		res.addSegmentValidations(ER3002PosLbPnmk0030.genRowValidation5());
		List<SubmissionField> fs = res.getFields();
		fs.add(sf(0, null, "Flag Detail", sv(M, 3, 3, alfaNumeric).confConstant("D01")));
		fs.add(sf(1, null, "Kode Komponen / Baris", sv(M, 10, 10, refTable)
				.confReference(EHeaderMetadataLb.R3002_LB0030.getObject()).confRegex(patternNumeric)).confUnique(U));
