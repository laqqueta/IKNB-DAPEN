...
public enum ER3110PosLbPnmu2400 implements IObject<KeyValueString> {
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER3110PosLbPnmu2400 eEnum : ER3110PosLbPnmu2400.values()) {
	...
	public static String getName() {
		return ER3110PosLbPnmu2400.class.getSimpleName().substring(6);
	}

	public static int getRefNumber() {
		return Integer.parseInt(ER3110PosLbPnmu2400.class.getSimpleName().substring(2, 6));
	}
