...
public enum ER3108PosLbPnmu2200 implements IObject<KeyValueString> {
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER3108PosLbPnmu2200 eEnum : ER3108PosLbPnmu2200.values()) {
	...
	public static String getName() {
		return ER3108PosLbPnmu2200.class.getSimpleName().substring(6);
	}

	public static int getRefNumber() {
		return Integer.parseInt(ER3108PosLbPnmu2200.class.getSimpleName().substring(2, 6));
	}
