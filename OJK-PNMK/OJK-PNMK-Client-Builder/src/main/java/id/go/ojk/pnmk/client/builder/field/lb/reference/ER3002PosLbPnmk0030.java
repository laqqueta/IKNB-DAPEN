...
public enum ER3002PosLbPnmk0030 implements IObject<KeyValueString> {
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER3002PosLbPnmk0030 eEnum : ER3002PosLbPnmk0030.values()) {
	...
	public static String getName() {
		return ER3002PosLbPnmk0030.class.getSimpleName().substring(6);
	}

	public static int getRefNumber() {
		return Integer.parseInt(ER3002PosLbPnmk0030.class.getSimpleName().substring(2, 6));
	}
