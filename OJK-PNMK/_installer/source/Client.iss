...
AppName=PNMK Client
AppVersion=1.0.0
AppVerName=PNMK-Client 1.0.0
AppPublisher=OJK
AppComments=OJK PNMK Client
AppCopyright=Copyright (C) 2020
;AppPublisherURL=http://java.com/
;AppSupportURL=http://java.com/
;AppUpdatesURL=http://java.com/
DefaultDirName=C:\OJK-PNMK-Client
...
UninstallDisplayName=PNMK-Client
...
[Setup]
SetupMutex=PNMK-Client,Global\PNMK-Client
OutputDir="..\ftp\app"

[Icons]
Name: "{group}\PNMK-Client"; Filename: "{app}\OjkClient.exe"; IconFilename: "{app}\Client.ico"; Check: returnTrue()
Name: "{commondesktop}\PnmkClient"; Filename: "{app}\OjkClient.exe";  IconFilename: "{app}\Client.ico"; Check: returnFalse()    

[Run]
Filename: "{app}\OjkClient.exe"; Parameters: "-Xappcds:generatecache"; Check: returnFalse()
Filename: "{app}\OjkClient.exe"; Description: "{cm:LaunchProgram,PNMKClient}"; Flags: nowait postinstall skipifsilent; Check: returnTrue()
Filename: "{app}\OjkClient.exe"; Parameters: "-install -svcName ""PNMKClient"" -svcDesc ""PNMKClient"" -mainExe ""OjkClient.exe""  "; Check: returnFalse()

[UninstallRun]
Filename: "{app}\OjkClient.exe "; Parameters: "-uninstall -svcName PNMKClient -stopOnUninstall"; Check: returnFalse()
