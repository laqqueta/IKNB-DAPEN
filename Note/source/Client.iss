...
AppName=%NAME% Client
AppVersion=3.3.3
AppVerName=%NAME%-Client 3.3.3
AppPublisher=OJK
AppComments=OJK %NAME% Client
AppCopyright=Copyright (C) 2020
;AppPublisherURL=http://java.com/
;AppSupportURL=http://java.com/
;AppUpdatesURL=http://java.com/
DefaultDirName=C:\OJK-%NAME%-Client
...
[Setup]
SetupMutex=%NAME%-Client,Global\%NAME%-Client
OutputDir="..\ftp\app"

[Icons]
Name: "{group}\%NAME%-Client"; Filename: "{app}\OjkClient.exe"; IconFilename: "{app}\Client.ico"; Check: returnTrue()
Name: "{commondesktop}\%NAME1%Client"; Filename: "{app}\OjkClient.exe";  IconFilename: "{app}\Client.ico"; Check: returnFalse()    

[Run]
Filename: "{app}\OjkClient.exe"; Parameters: "-Xappcds:generatecache"; Check: returnFalse()
Filename: "{app}\OjkClient.exe"; Description: "{cm:LaunchProgram,%NAME%Client}"; Flags: nowait postinstall skipifsilent; Check: returnTrue()
Filename: "{app}\OjkClient.exe"; Parameters: "-install -svcName ""%NAME%Client"" -svcDesc ""%NAME%Client"" -mainExe ""OjkClient.exe""  "; Check: returnFalse()

[UninstallRun]
Filename: "{app}\OjkClient.exe "; Parameters: "-uninstall -svcName %NAME%Client -stopOnUninstall"; Check: returnFalse()
