...
public enum ER7004PosLbLpeiu0043 implements IObject<KeyValueString> {
	R_0043010000 ("0043010000","Pemasaran"),
	...
	public String getFormKey() {
		return EFormLaporanBulananUus.LB_0043.getCode() + key;
	}
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER7004PosLbLpeiu0043 eEnum : ER7004PosLbLpeiu0043.values()) {
	...
	public static String getName() {
		return ER7004PosLbLpeiu0043.class.getSimpleName().substring(6);
	}

	public static int getRefNumber() {
		return Integer.parseInt(ER7004PosLbLpeiu0043.class.getSimpleName().substring(2, 6));
	}
