...
import id.go.ojk.lpei.client.builder.field.lb.uus.reference.ER7005PosLbLpeiu0046;
...
public class Lb0046 extends BaseMetadata {
	...
	public SubmissionFormat get() {
		...
		fs.add(sf(1, null, "Kode Komponen / Baris", sv(M, 10, 10, DataType.refTable)
				.confReference(EHeaderMetadataLbUus.R7005_LB0046.getObject())
		...
		fs.add(sf(10, null, "Awal Masa Laku Izin Kerja", sv(M, 8, 8, DataType.date))
				.addFieldValidations(ER7005PosLbLpeiu0046.genFieldValidation10()));
