...
public enum ER7003PosLbLpeiu0041 implements IObject<KeyValueString> {
	...
	//	R_0041030000 ("0041030000", "Jumlah Tenaga Kerja Kantor Diluar Kantor Pusat"),
	...
	R_0041040000 ("0041040000", "Total Tenaga Kerja Diluar Kantor Pusat"),
	R_0041050000 ("0041050000", "Jumlah Tenaga Kerja Kantor Pusat dan Kantor Diluar Kantor Pusat")
	;
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER7003PosLbLpeiu0041 eEnum : ER7003PosLbLpeiu0041.values()) {
	...
	public static String getName() {
		return ER7003PosLbLpeiu0041.class.getSimpleName().substring(6);
	}

	public static int getRefNumber() {
		return Integer.parseInt(ER7003PosLbLpeiu0041.class.getSimpleName().substring(2, 6));
	}
	...
	public static FieldValidation genFieldValidation11() {
		return UtilFieldValidation.genEqualsPosFormula("2+5+8",
				UtilMetadata.genPipeRowExcept(getObjects(), new int[] { 5, 11, 12 }));
	}

	public static FieldValidation genFieldValidation12() {
		return UtilFieldValidation.genEqualsPosFormula("3+6+9",
				UtilMetadata.genPipeRowExcept(getObjects(), new int[] { 5, 11, 12 }));
	}
	...
	public static SegmentValidation genRowValidation07() {
		return UtilSegmentValidation.genEqualsFormula(UtilMetadata.genPipeColumn(2, 13), R_0041020000.key,
				UtilMetadata.genPlusRow(getObjects(), 0, 4),
				UtilMetadata.genMessage(R_0041020000.value, UtilMetadata.genPlusDesc(getObjects(), 0, 4)));
	}

	public static SegmentValidation genRowValidation13() {
		return UtilSegmentValidation.genEqualsFormula(UtilMetadata.genPipeColumn(2, 13), R_0041040000.key,
				UtilMetadata.genPlusRow(getObjects(), 6, 10),
				UtilMetadata.genMessage(R_0041040000.value, UtilMetadata.genPlusDesc(getObjects(), 6, 10)));
	}

	public static SegmentValidation genRowValidation13B() {
		// return UtilSegmentValidation.genEqualsForm("13", "0041040000", "0020", "8", "0020010000");
		return UtilSegmentValidation.genEqualsForm("13", R_0041040000.key,
				EFormLaporanBulanan.LB_0020.getCode(), "8", ER7001PosLbLpeiu0020.R_0020010000.getKey());
	}

	public static SegmentValidation genRowValidation13C() {
			return UtilSegmentValidation.genEqualsFormColumCalculation("13", R_0041050000.key, "8+9",
					ER7004PosLbLpeiu0043.R_0043112000.getFormKey(),
					UtilMetadata.genMessage(R_0041050000.value, "jumlah Total Tenaga Kerja Manajerial sampai satu level di bawah SEVP + Total Tenaga Kerja Staf dan Tingkat Tenaga Kerja Lainnya pada Jumlah Tenaga Kerja (Form " + EFormLaporanBulananUus.LB_0043.getCode() + ")"), 0);
		}

	public static SegmentValidation genRowValidation14() {
		int[] fields = new int[] { 5, 11 };
		return UtilSegmentValidation.genEqualsFormula(UtilMetadata.genPipeColumn(2, 13), R_0041050000.key,
