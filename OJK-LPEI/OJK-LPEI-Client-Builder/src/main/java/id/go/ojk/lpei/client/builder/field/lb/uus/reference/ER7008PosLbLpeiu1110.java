...
public enum ER7008PosLbLpeiu1110 implements IObject<KeyValueString> {
	...
	R_11100602000000 ("11100602000000", "Pendapatan Bagi Hasil, Margin, serta Ujrah dalam Penyelesaian"),
	R_11100602010000 ("11100602010000", "Bagi Hasil, Margin, serta Ujrah atas Pembiayaan yang Diberikan"),
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER7008PosLbLpeiu1110 eEnum : ER7008PosLbLpeiu1110.values()) {
	...
	public static String getName() {
		return ER7008PosLbLpeiu1110.class.getSimpleName().substring(6);
	}

	public static int getRefNumber() {
		return Integer.parseInt(ER7008PosLbLpeiu1110.class.getSimpleName().substring(2, 6));
	}
	...
	public static SegmentValidation genRowValidation23() {
		...
		return UtilSegmentValidation.genEqualsFormula(UtilMetadata.genPipeColumn(2, 3), R_11101101000000.key,
				UtilMetadata.genPlusRow(getObjects(), fields),
				UtilMetadata.genMessage(R_11101101000000.value, "", UtilMetadata.genPlusDesc(getObjects(), fields)));
	}
