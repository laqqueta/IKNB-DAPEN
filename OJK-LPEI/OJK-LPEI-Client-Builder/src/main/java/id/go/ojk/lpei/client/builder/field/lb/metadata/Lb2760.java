...
public class Lb2760 extends BaseMetadata {
	...
	public SubmissionFormat get() {
		EFormLaporanBulanan eEnum = EFormLaporanBulanan.LB_2760;
		...
		fs.add(sf(1, null, "Kode Komponen / Baris", sv(M, 10, 10, refTable)
				.confReference(EHeaderMetadataLb.R5025_LB2760.getObject())
		...
		fs.add(sf(5, null, "Tanggal Penutupan", sv(M, 8, 8, date)));
		...
		fs.add(sf(8, null, "Tanggal Klaim", sv(M, 8, 8, date)));
		fs.add(sf(9, null, "Total Klaim", sv(M, 1, 20, numeric)));
		fs.add(sf(10, null, "Tanggal Persetujuan Klaim", sv(M, 8, 8, date)));
