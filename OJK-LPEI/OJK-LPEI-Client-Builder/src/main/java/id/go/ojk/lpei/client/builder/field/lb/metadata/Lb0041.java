...
import id.go.ojk.lpei.client.builder.field.lb.reference.ER5003PosLbLpeig0041;
...
public class Lb0041 extends BaseMetadata {
	...
	public SubmissionFormat get() {
		...
		SubmissionFormat res = new SubmissionFormat(eEnum.getCode(), eEnum.getName(), reportCode, new ArrayList<>(), extension, 13, 13);

		res.setRequiredPos(ER5003PosLbLpeig0041.getRequiredPos());
		res.setUniquePos(ER5003PosLbLpeig0041.getUniquePos());
		res.setSavePos(ER5003PosLbLpeig0041.genFieldSave());
		res.setSavePosForm(ER5003PosLbLpeig0041.genFieldSave());

		res.addSegmentValidations(ER5003PosLbLpeig0041.genRowValidation07());
		res.addSegmentValidations(ER5003PosLbLpeig0041.genRowValidation13());
		res.addSegmentValidations(ER5003PosLbLpeig0041.genRowValidation14());
		res.addSegmentValidations(ER5003PosLbLpeig0041.genRowValidation13B());
		res.addSegmentValidations(ER5003PosLbLpeig0041.genRowValidation13C());

		List<SubmissionField> fs = res.getFields();
		fs.add(sf(0, null, "Flag Detail", sv(M, 3, 3, alfaNumeric).confConstant("D01")));
		fs.add(sf(1, null, "Kode Komponen / Baris", sv(M, 10, 10, DataType.refTable)
				.confReference(EHeaderMetadataLb.R5003_LB0041.getObject())
		...
		fs.add(sf(4, null, "Tenaga Kerja Tetap - Total", sv(M, 1, 5, DataType.numeric))
				.addFieldValidations(ER5003PosLbLpeig0041.genFieldValidation4()));
		...
		fs.add(sf(7, null, "Tenaga Kerja Kontrak - Total", sv(M, 1, 5, DataType.numeric))
				.addFieldValidations(ER5003PosLbLpeig0041.genFieldValidation7()));
		...
		fs.add(sf(10, null, "Tenaga Kerja Alih Daya - Total", sv(M, 1, 5, DataType.numeric))
				.addFieldValidations(ER5003PosLbLpeig0041.genFieldValidation10()));
		fs.add(sf(11, null, "Total Tenaga Kerja  - Laki-Laki", sv(M, 1, 5, DataType.numeric))
				.addFieldValidations(ER5003PosLbLpeig0041.genFieldValidation11()));
		fs.add(sf(12, null, "Total Tenaga Kerja  - Perempuan", sv(M, 1, 5, DataType.numeric))
				.addFieldValidations(ER5003PosLbLpeig0041.genFieldValidation12()));
		fs.add(sf(13, null, "Total Tenaga Kerja - Total", sv(M, 1, 5, DataType.numeric))
				.addFieldValidations(ER5003PosLbLpeig0041.genFieldValidation13()));
		return res;
	}
}
