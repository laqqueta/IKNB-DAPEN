...
@Slf4j
public class LpeiDatBuilder extends BaseDatBuilder {
	private static final EReport REPORT_LB = EReport.LB_LPEIG;
	private static final EReport REPORT_LB_UUS = EReport.LB_LPEIU;
	...
	public static void main(String[] args) {
		try {
			...
			LpeiDatBuilder builder = new LpeiDatBuilder(args);
	...
	public LpeiDatBuilder(String[] args) {
