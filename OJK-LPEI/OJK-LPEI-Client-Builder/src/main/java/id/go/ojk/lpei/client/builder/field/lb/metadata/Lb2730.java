...
import id.go.ojk.lpei.client.builder.field.lb.reference.ER5024PosLbLpeig2730;
...
public class Lb2730 extends BaseMetadata {
	...
	public SubmissionFormat get() {
		...
		fs.add(sf(10, null, "Nominal - Dalam Mata Uang Asal", sv(M, 1, 20, all)
				.confRegex(SimpleValidation.patternNumericDotOptTwo)));
