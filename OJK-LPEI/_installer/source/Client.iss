...
AppName=LPEI Client
AppVersion=1.0.0
AppVerName=LPEI-Client 1.0.0
AppPublisher=OJK
AppComments=OJK LPEI Client
AppCopyright=Copyright (C) 2020
;AppPublisherURL=http://java.com/
;AppSupportURL=http://java.com/
;AppUpdatesURL=http://java.com/
DefaultDirName=C:\OJK-LPEI-Client
...
[Setup]
SetupMutex=LPEI-Client,Global\LPEI-Client
OutputDir="..\ftp\app"

[Icons]
Name: "{group}\LPEI-Client"; Filename: "{app}\OjkClient.exe"; IconFilename: "{app}\Client.ico"; Check: returnTrue()
Name: "{commondesktop}\LpeiClient"; Filename: "{app}\OjkClient.exe";  IconFilename: "{app}\Client.ico"; Check: returnFalse()    

[Run]
Filename: "{app}\OjkClient.exe"; Parameters: "-Xappcds:generatecache"; Check: returnFalse()
Filename: "{app}\OjkClient.exe"; Description: "{cm:LaunchProgram,LPEIClient}"; Flags: nowait postinstall skipifsilent; Check: returnTrue()
Filename: "{app}\OjkClient.exe"; Parameters: "-install -svcName ""LPEIClient"" -svcDesc ""LPEIClient"" -mainExe ""OjkClient.exe""  "; Check: returnFalse()

[UninstallRun]
Filename: "{app}\OjkClient.exe "; Parameters: "-uninstall -svcName LPEIClient -stopOnUninstall"; Check: returnFalse()
