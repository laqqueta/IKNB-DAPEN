...
public enum ER3115PosLbPpiu2300 implements IObject<KeyValueString> {
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER3115PosLbPpiu2300 eEnum : ER3115PosLbPpiu2300.values()) {
	...
	public static String getName() {
		return ER3115PosLbPpiu2300.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER3115PosLbPpiu2300.class.getSimpleName().substring(2, 6));
	}
