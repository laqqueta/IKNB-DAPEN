...
public enum ER3014PosLbPpik2150 implements IObject<KeyValueString> {
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER3014PosLbPpik2150 eEnum : ER3014PosLbPpik2150.values()) {
	...
	public static String getName() {
		return ER3014PosLbPpik2150.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER3014PosLbPpik2150.class.getSimpleName().substring(2, 6));
	}
