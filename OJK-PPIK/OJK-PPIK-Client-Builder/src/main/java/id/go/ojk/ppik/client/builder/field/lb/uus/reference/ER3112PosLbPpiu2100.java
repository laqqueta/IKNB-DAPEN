...
public enum ER3112PosLbPpiu2100 implements IObject<KeyValueString> {
	...
	public String getFormKey() {
		return EFormLaporanBulananUus.LB_2100.getCode() + key;
	}
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER3112PosLbPpiu2100 eEnum : ER3112PosLbPpiu2100.values()) {
	...
	public static String getName() {
		return ER3112PosLbPpiu2100.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER3112PosLbPpiu2100.class.getSimpleName().substring(2, 6));
	}
