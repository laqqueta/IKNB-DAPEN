...
public enum ER3119PosLbPpiu2550 implements IObject<KeyValueString> {
	...
	public String getFormKey() {
		return EFormLaporanBulananUus.LB_2550.getCode() + key;
	}
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER3119PosLbPpiu2550 eEnum : ER3119PosLbPpiu2550.values()) {
	...
	public static String getName() {
		return ER3119PosLbPpiu2550.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER3119PosLbPpiu2550.class.getSimpleName().substring(2, 6));
	}
