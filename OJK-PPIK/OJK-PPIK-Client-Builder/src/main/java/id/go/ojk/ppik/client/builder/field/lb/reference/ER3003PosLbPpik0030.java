...
public enum ER3003PosLbPpik0030 implements IObject<KeyValueString> {
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER3003PosLbPpik0030 eEnum : ER3003PosLbPpik0030.values()) {
	...
	public static String getName() {
		return ER3003PosLbPpik0030.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER3003PosLbPpik0030.class.getSimpleName().substring(2, 6));
	}
