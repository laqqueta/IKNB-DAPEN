...
import id.go.ojk.ppik.client.builder.field.lb.reference.ER3017PosLbPpik2350;
...
public class Lb2350 extends BaseMetadata {
	...
	public SubmissionFormat get() {
		...
		SubmissionFormat res = new SubmissionFormat(eEnum.getCode(), eEnum.getName(), reportCode, new ArrayList<>(),
				extension, 0, null);
		res.setSavePosForm(ER3017PosLbPpik2350.genFieldSave());
		...
		fs.add(sf(3, null, "Status Usaha",
				sv(C, 1, 10, refTable).confConditionalRequired(ER3017PosLbPpik2350.genFieldCondition())
		...
		fs.add(sf(7, null, "Nilai Proyek Awal, Dalam Nilai Mata Uang Asal",
				sv(C, 1, 16, numeric).confConditionalRequired(ER3017PosLbPpik2350.genFieldCondition())));
		...
		fs.add(sf(11, null, "Jangka Waktu, Tanggal Mulai",
				sv(C, 8, 8, date).confConditionalRequired(ER3017PosLbPpik2350.genFieldCondition()))
						.addFieldValidations(ER3017PosLbPpik2350.genFieldValidation11()));
