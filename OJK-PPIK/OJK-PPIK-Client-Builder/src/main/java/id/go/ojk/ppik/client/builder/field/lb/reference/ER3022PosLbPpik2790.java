...
public enum ER3022PosLbPpik2790 implements IObject<KeyValueString> {
	...
	public String getFormKey() {
		return EFormLaporanBulanan.LB_2790.getCode() + key;
	}
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER3022PosLbPpik2790 eEnum : ER3022PosLbPpik2790.values()) {
	...
	public static String getName() {
		return ER3022PosLbPpik2790.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER3022PosLbPpik2790.class.getSimpleName().substring(2, 6));
	}
