...
public enum ER3020PosLbPpik2550 implements IObject<KeyValueString> {
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER3020PosLbPpik2550 eEnum : ER3020PosLbPpik2550.values()) {
	...
	public static String getName() {
		return ER3020PosLbPpik2550.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER3020PosLbPpik2550.class.getSimpleName().substring(2, 6));
	}
	...
	public static String genFieldSave() {
		return UtilMetadata.genFieldSave(UtilMetadata.genPipeColumn(new int[] { 3, 5, 6, 17, 19 }), getObjects());
	}
	...
	public static FieldValidation genFieldValidation14() {
		return UtilFieldValidation.genLessEquals("12");
	}
