...
public enum ER3006PosLbPpik0041 implements IObject<KeyValueString> {
...
//	R_0041030000 ("0041030000", "Jumlah Tenaga Kerja Kantor Cabang"),
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER3006PosLbPpik0041 eEnum : ER3006PosLbPpik0041.values()) {
	...
	public static String getName() {
		return ER3006PosLbPpik0041.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER3006PosLbPpik0041.class.getSimpleName().substring(2, 6));
	}
