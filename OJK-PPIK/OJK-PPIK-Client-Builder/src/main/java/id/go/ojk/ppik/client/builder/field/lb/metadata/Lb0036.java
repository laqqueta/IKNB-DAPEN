...
import id.go.ojk.ppik.client.builder.field.lb.reference.ER3005PosLbPpik0036;
...
public class Lb0036 extends BaseMetadata {
	...
	public SubmissionFormat get() {
		...
		fs.add(sf(1, null, "Kode Komponen / Baris", sv(M, 10, 10, refTable)
				.confReference(EHeaderMetadataLb.R3005_LB0036.getObject()).confRegex(patternNumeric)));
		fs.add(sf(2, null, "Nama Pihak Terkait", sv(M, 1, 100, all).confRegex(PATTERN_NAME.c())));
		fs.add(sf(3, null, "Golongan",
				sv(C, 1, 10, refTable).confConditionalRequired(ER3005PosLbPpik0036.genFieldCondition())
