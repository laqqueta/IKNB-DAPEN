...
public enum ER3100PosLbPpiu0000 implements IObject<KeyValueString> {
//	R_000001000000 ("000001000000", "Informasi Unit Usaha Syariah"),
...
//	R_000002000000 ("000002000000", "Informasi Alamat Unit Usaha Syariah"),
...
//	R_000003000000 ("000003000000", "Informasi Jumlah Pelayanan"),
	R_000003010000 ("000003010000", "Jumlah Kantor Cabang UUS"),
//	R_000004000000 ("000004000000", "Informasi Tenaga Kerja"),
	R_000004010000 ("000004010000", "Jumlah Tenaga Kerja Kantor UUS"),
	R_000004020000 ("000004020000", "Jumlah Tenaga Kerja Kantor Cabang UUS"),
...
//	R_000005020000 ("000005020000", "Petugas Penyusun Laporan"),
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER3100PosLbPpiu0000 eEnum : ER3100PosLbPpiu0000.values()) {
	...
	public static String getName() {
		return ER3100PosLbPpiu0000.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER3100PosLbPpiu0000.class.getSimpleName().substring(2, 6));
	}
	...
	public static SegmentValidation genValidationLen100() {
		return UtilSegmentValidation.genMaxLength("2", UtilMetadata.genPipeRow(getObjects(), new int[] { 0, 18, 22 }),
				100);
	}

	public static SegmentValidation genValidationLen50() {
		return UtilSegmentValidation.genMaxLength("2",
				UtilMetadata.genPipeRow(getObjects(), new int[] { 13, 14, 21, 25 }), 50);
	}
	...
	public static SegmentValidation genValidationLen15() {
		return UtilSegmentValidation.genMaxLength("2", UtilMetadata.genPipeRow(getObjects(), new int[] { 11, 20, 24 }),
				15);
	}
	...
	public static SegmentValidation genValidationLen10() {
		return UtilSegmentValidation.genMaxLength("2",
				UtilMetadata.genPipeRow(getObjects(), new int[] { 3, 4, 5, 6, 9, 12, 15, 16, 17 }), 10);
	}

	public static SegmentValidation genValidationLen8() {
		return UtilSegmentValidation.genLength("2", UtilMetadata.genPipeRow(getObjects(), new int[] { 7 }), 8, 8);
	}

	public static SegmentValidation genValidationLen5() {
		return UtilSegmentValidation.genMaxLength("2", UtilMetadata.genPipeRow(getObjects(), new int[] { 10 }), 5);
	}

	public static SegmentValidation genValidationLen40() {
		return UtilSegmentValidation.genMaxLength("2", UtilMetadata.genPipeRow(getObjects(), new int[] { 19, 23 }), 40);
	}
	...
	public static SegmentValidation genValidationReference1() {
		return UtilSegmentValidation.genRegexReference1("2",
				UtilMetadata.genPipeRow(getObjects(), new int[] { 3, 4, 5, 6, 9, 12 }));
	}

	public static SegmentValidation genValidationDate() {
		return UtilSegmentValidation.genRegexDate("2", UtilMetadata.genPipeRow(getObjects(), new int[] { 7 }));
	}

	public static SegmentValidation genValidationNumeric() {
		return UtilSegmentValidation.genRegexNumeric("2",
				UtilMetadata.genPipeRow(getObjects(), new int[] { 10, 15, 16, 17 }));
	}

	public static SegmentValidation genValidationPhone() {
		return UtilSegmentValidation.genRegexPhone2("2",
				UtilMetadata.genPipeRow(getObjects(), new int[] { 11, 20, 24 }));
	}
	...
	public static SegmentValidation genValidationReferenceLokasiDati2() {
		return UtilSegmentValidation.genReference("2", UtilMetadata.genPipeRow(getObjects(), new int[] { 9 }),
	...
	public static SegmentValidation genValidationReferenceStatusKepemilikanGedungUnitUsaha() {
		return UtilSegmentValidation.genReference("2", UtilMetadata.genPipeRow(getObjects(), new int[] { 12 }),
	...
	public static SegmentValidation genRowValidation17() {
		return UtilSegmentValidation.genEqualsFormTotalRow("2", R_000003010000.key,
				EFormLaporanBulananUus.LB_0020.getCode(),
	...
	public static SegmentValidation genRowValidation18() {
		return UtilSegmentValidation.genEqualsForm("2", R_000004010000.key, EFormLaporanBulananUus.LB_0041.getCode(), "11",
				ER3105PosLbPpiu0041.R_0041020000.getKey(), R_000004010000.value);
	}

	public static SegmentValidation genRowValidation20A() {
		return UtilSegmentValidation.genEqualsForm("2", R_000004020000.key, EFormLaporanBulananUus.LB_0041.getCode(), "11",
				ER3105PosLbPpiu0041.R_0041040000.getKey(), R_000004020000.value);
	}

	public static SegmentValidation genRowValidation20B() {
		return UtilSegmentValidation.genEqualsForm("2", R_000004020000.key, EFormLaporanBulananUus.LB_0020.getCode(), "10",
				ER3102PosLbPpiu0020.R_0020010000.getKey(), R_000004020000.value);
	}
}
