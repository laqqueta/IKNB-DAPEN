...
public enum ER3123PosLbPpiu5310 implements IObject<KeyValueString> {
//	R_53100100000000 ("53100100000000", "I.    ASET"),
	R_53100101060000 ("53100101060000", "Piutang Pembiayaan Berdasarkan Prinsip Syariah Neto"),
	...
	R_53100101060600 ("53100101060600", "Aset Ijarah Neto"),
...
//	R_53100300000000 ("53100300000000", "II.  LIABILITAS"),
	R_53100301000000 ("53100301000000", "Pendanaan yang Diterima "),
	R_53100302000000 ("53100302000000", "Surat Berharga yang Diterbitkan "),
	R_53100303000000 ("53100303000000", "Liabilitas Selain Pendanaan dan Surat Berharga yang Diterbitkan"),
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER3123PosLbPpiu5310 eEnum : ER3123PosLbPpiu5310.values()) {
	...
	public static String getName() {
		return ER3123PosLbPpiu5310.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER3123PosLbPpiu5310.class.getSimpleName().substring(2, 6));
	}
	...
	public static SegmentValidation genRowValidation03() {
		return UtilSegmentValidation.genEqualsFormula(
				...
				UtilMetadata.genMessage(R_53100101060100.value, UtilMetadata.genMinusDesc(getObjects(), 2, 3)));
	}
	...
	public static SegmentValidation genRowValidation06() {
		return UtilSegmentValidation.genEqualsFormula(
				...
				UtilMetadata.genMessage(R_53100101060200.value, UtilMetadata.genMinusDesc(getObjects(), 5, 6)));
	}
	...
	public static SegmentValidation genRowValidation09() {
		return UtilSegmentValidation.genEqualsFormula(
				...
				UtilMetadata.genMessage(R_53100101060300.value, UtilMetadata.genMinusDesc(getObjects(), 8, 9)));
	}
	...
	public static SegmentValidation genRowValidation12() {
		return UtilSegmentValidation.genEqualsFormula(
				...
				UtilMetadata.genMessage(R_53100101060400.value, UtilMetadata.genMinusDesc(getObjects(), 11, 12)));
	}
	...
	public static SegmentValidation genRowValidation15() {
		return UtilSegmentValidation.genEqualsFormula(
				...
				UtilMetadata.genMessage(R_53100101060500.value, UtilMetadata.genMinusDesc(getObjects(), 14, 15)));
	}
	
	public static SegmentValidation genRowValidation20() {
		int[] fields = new int[] { 0, 16, 17 };
		return UtilSegmentValidation.genEqualsFormula(
	...
	public static SegmentValidation genRowValidation24() {
		return UtilSegmentValidation.genEqualsFormula(
				...
				UtilMetadata.genMessage(R_53100400000000.value, UtilMetadata.genPlusDesc(getObjects(), 19, 21)));
	}
	
	public static SegmentValidation genRowValidation40() {
		int[] fields = new int[] { 18, 22 };
		return UtilSegmentValidation.genEqualsFormula(
