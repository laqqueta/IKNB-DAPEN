...
public enum ER3021PosLbPpik2600 implements IObject<KeyValueString> {
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER3021PosLbPpik2600 eEnum : ER3021PosLbPpik2600.values()) {
	...
	public static String getName() {
		return ER3021PosLbPpik2600.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER3021PosLbPpik2600.class.getSimpleName().substring(2, 6));
	}
	...
	public static String genFieldSave() {
		return UtilMetadata.genFieldSave(UtilMetadata.genPipeColumn(new int[] { 4, 13 }), getObjects());
	}
