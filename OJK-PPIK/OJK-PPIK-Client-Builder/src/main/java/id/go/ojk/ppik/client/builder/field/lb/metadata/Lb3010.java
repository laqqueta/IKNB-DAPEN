...
import id.go.ojk.ppik.client.builder.field.lb.reference.ER3023PosLbPpik3010;
...
public class Lb3010 extends BaseMetadata {
	...
	public SubmissionFormat get() {
		...
		SubmissionFormat res = new SubmissionFormat(eEnum.getCode(), eEnum.getName(), reportCode, new ArrayList<>(),
				extension, 0, null);
		res.setSavePosForm(ER3023PosLbPpik3010.genFieldSave());
		...
		fs.add(sf(3, null, "Nominal Underlying Transaksi Pinjaman/ Pendanaan",
				sv(C, 1, 16, numeric).confConditionalRequired(ER3023PosLbPpik3010.genFieldConditionA())));
		fs.add(sf(4, null, "Nomor Kontrak Instrumen Derivatif",
				sv(C, 1, 35, all).confConditionalRequired(ER3023PosLbPpik3010.genFieldConditionA())));
		fs.add(sf(5, null, "Jenis Instrumen Derivatif",
				sv(C, 1, 10, refTable).confConditionalRequired(ER3023PosLbPpik3010.genFieldConditionA())
						.confReference(EHeaderMetadataShared.R029.getObject()).confRegex(PATTERN_REFERENCE_1.c())));
		...
		fs.add(sf(7, null, "Tanggal Mulai",
				sv(C, 8, 8, date).confConditionalRequired(ER3023PosLbPpik3010.genFieldConditionA()))
						.addFieldValidations(ER3023PosLbPpik3010.genFieldValidation7()));
		...
		fs.add(sf(9, null, "Nominal Instrumen Derivatif untuk Lindung Nilai (Dalam Mata Uang Asal)",
				sv(C, 1, 16, numeric).confConditionalRequired(ER3023PosLbPpik3010.genFieldConditionB())));
		...
		fs.add(sf(11, null, "Nama Counterparty", sv(C, 1, 100, all)
				.confConditionalRequired(ER3023PosLbPpik3010.genFieldConditionA())));
