...
public enum ER3109PosLbPpiu1110 implements IObject<KeyValueString> {
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER3109PosLbPpiu1110 eEnum : ER3109PosLbPpiu1110.values()) {
	...
	public static String getName() {
		return ER3109PosLbPpiu1110.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER3109PosLbPpiu1110.class.getSimpleName().substring(2, 6));
	}
	...
	public static SegmentValidation genRowValidation17B() {
		return UtilSegmentValidation.genEqualsFormulaFormNotEquals("3", R_11100400000000.key, "10",
				ER3122PosLbPpiu3010.R_3010010000.getFormKey(), "6", ER1122JenisValuta.R_1.getKey(),
	...
	public static SegmentValidation genRowValidation18A() {
		...
		return UtilSegmentValidation.genEqualsFormulaFormMultiFilter("2", R_11100404000000.key, "10",
				ER3122PosLbPpiu3010.R_3010010000.getFormKey(), "5|6", instrumen + "|" + ER1122JenisValuta.R_1.getKey(),
	...
	public static SegmentValidation genRowValidation18B() {
		...
		return UtilSegmentValidation.genEqualsFormulaFormMultiFilterNotEquals("3", R_11100404000000.key, "10",
				ER3122PosLbPpiu3010.R_3010010000.getFormKey(), "5", instrumen, "6", ER1122JenisValuta.R_1.getKey(),
