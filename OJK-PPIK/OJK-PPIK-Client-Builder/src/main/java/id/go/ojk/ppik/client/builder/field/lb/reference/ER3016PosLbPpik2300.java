...
public enum ER3016PosLbPpik2300 implements IObject<KeyValueString> {
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER3016PosLbPpik2300 eEnum : ER3016PosLbPpik2300.values()) {
	...
	public static String getName() {
		return ER3016PosLbPpik2300.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER3016PosLbPpik2300.class.getSimpleName().substring(2, 6));
	}
