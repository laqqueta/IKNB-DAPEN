...
import id.go.ojk.ppik.client.builder.field.EUpdateHeader;
import id.go.ojk.ppik.client.builder.field.setup.ESetupKeyValueStringFilename;
import lombok.extern.slf4j.Slf4j;

@Slf4j
public class PpikDatBuilder extends BaseDatBuilder {
	private static final EReport REPORT_LB = EReport.LB_PPIK;
	private static final EReport REPORT_LB_UUS = EReport.LB_PPIU;
	private static final EReport REPORT_SA = EReport.SA_PPIK;
	private static final EReport REPORT_SA_UUS = EReport.SA_PPIU;
	private static final List<String> DUMMY_USER = Arrays.asList("dev.external001@gmail.com", "dev.external002@gmail.com", "ppikdummy@gmail.com", "apolo.sit001@gmail.com", "apolo.sit003@gmail.com");

	public static void main(String[] args) {
		try {
			log.info("starting builder");
			Constant.initAppVersion();
			PpikDatBuilder builder = new PpikDatBuilder(args);
	...
	public PpikDatBuilder(String[] args) {
	...
	protected String genDummyClientEntity() {
		return genDummyClientEntity(Constant.SECTOR.getCode(), Arrays.asList("2100000099"), DUMMY_USER);
	}
