...
public enum ER3400PosSaPpiu060302 implements IObject<KeyValueString> {
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER3400PosSaPpiu060302 eEnum : ER3400PosSaPpiu060302.values()) {
	...
	public static String getName() {
		return ER3400PosSaPpiu060302.class.getSimpleName().substring(6);
	}

	public static int getRefNumber() {
		return Integer.parseInt(ER3400PosSaPpiu060302.class.getSimpleName().substring(2, 6));
	}
