...
public enum ER3117PosLbPpiu2380 implements IObject<KeyValueString> {
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER3117PosLbPpiu2380 eEnum : ER3117PosLbPpiu2380.values()) {
	...
	public static String getName() {
		return ER3117PosLbPpiu2380.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER3117PosLbPpiu2380.class.getSimpleName().substring(2, 6));
	}
	...
	public static ConditionalRequired genFieldCondition11() {
		return UtilFieldConditional.genEquals("N", "M", "8", ER1146JenisAkadProyekPemulihanEkonomiNasional.R_1.getKey());
	}
