...
public enum ER3120PosLbPpiu2600 implements IObject<KeyValueString> {
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER3120PosLbPpiu2600 eEnum : ER3120PosLbPpiu2600.values()) {
	...
	public static String getName() {
		return ER3120PosLbPpiu2600.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER3120PosLbPpiu2600.class.getSimpleName().substring(2, 6));
	}
