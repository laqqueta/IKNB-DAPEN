...
public enum ER3101PosLbPpiu0010 implements IObject<KeyValueString> {
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER3101PosLbPpiu0010 eEnum : ER3101PosLbPpiu0010.values()) {
	...
	public static String getName() {
		return ER3101PosLbPpiu0010.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER3101PosLbPpiu0010.class.getSimpleName().substring(2, 6));
	}
