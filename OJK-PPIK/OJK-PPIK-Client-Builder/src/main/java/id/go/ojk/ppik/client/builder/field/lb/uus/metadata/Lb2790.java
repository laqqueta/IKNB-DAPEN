...
import id.go.ojk.ppik.client.builder.field.lb.uus.reference.ER3121PosLbPpiu2790;
...
public class Lb2790 extends BaseMetadata {
	...
	public SubmissionFormat get() {
		...
		SubmissionFormat res = new SubmissionFormat(eEnum.getCode(), eEnum.getName(), reportCode, new ArrayList<>(),
				extension, 0, null);
		res.setSavePosForm(ER3121PosLbPpiu2790.genFieldSave());
		List<SubmissionField> fs = res.getFields();
		fs.add(sf(0, null, "Flag Detail", sv(M, 3, 3, alfaNumeric).confConstant("D01")));
		fs.add(sf(1, null, "Kode Komponen / Baris",
				sv(M, 10, 10, refTable).confReference(EHeaderMetadataLbUus.R3122_LB2790.getObject())
		...
		fs.add(sf(5, null, "Jangka Waktu, Tanggal Mulai", sv(O, 8, 8, date))
				.addFieldValidations(ER3121PosLbPpiu2790.genFieldValidation5()));
