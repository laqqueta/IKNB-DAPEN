...
public enum ER3004PosLbPpik0035 implements IObject<KeyValueString> {
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER3004PosLbPpik0035 eEnum : ER3004PosLbPpik0035.values()) {
	...
	public static String getName() {
		return ER3004PosLbPpik0035.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER3004PosLbPpik0035.class.getSimpleName().substring(2, 6));
	}
	...
	public static ConditionalRequired genFieldRequired() {
		return UtilFieldConditional.genComparatorHasValue("M", "O", "5",
				ER1105JabatanKepengurusan.R_5.getKey() + "|" + ER1105JabatanKepengurusan.R_6.getKey());
	}
