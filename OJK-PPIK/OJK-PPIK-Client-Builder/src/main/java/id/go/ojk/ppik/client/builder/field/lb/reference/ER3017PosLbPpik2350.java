...
public enum ER3017PosLbPpik2350 implements IObject<KeyValueString> {
	...
	public String getFormKey() {
		return EFormLaporanBulanan.LB_2350.getCode() + key;
	}
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER3017PosLbPpik2350 eEnum : ER3017PosLbPpik2350.values()) {
	...
	public static String getName() {
		return ER3017PosLbPpik2350.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER3017PosLbPpik2350.class.getSimpleName().substring(2, 6));
	}
