...
public enum ER3201PosSaPpik060301 implements IObject<KeyValueString> {
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER3201PosSaPpik060301 eEnum : ER3201PosSaPpik060301.values()) {
	...
	public static String getName() {
		return ER3201PosSaPpik060301.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER3201PosSaPpik060301.class.getSimpleName().substring(2, 6));
	}
