...
public enum ER6106RKPMF implements IObject<KeyValueString> {
  RKPMF0101000000("RKPMF0101000000","Jenis Klaim, Usia Pensiun (56 Tahun)"),
  RKPMF0102000000("RKPMF0102000000","Jenis Klaim, Meninggal"),
  RKPMF0103000000("RKPMF0103000000","Jenis Klaim, Cacat Total Tetap"),
  RKPMF0104000000("RKPMF0104000000","Jenis Klaim, Pemutusan Hubungan Kerja"),
  RKPMF0105000000("RKPMF0105000000","Jenis Klaim, Mengundurkan Diri"),
  RKPMF0106000000("RKPMF0106000000","Jenis Klaim, Keluar Wilayah RI"),
  RKPMF0107000000("RKPMF0107000000","Jenis Klaim, Klaim Sebagian 10%"),
  RKPMF0108000000("RKPMF0108000000","Jenis Klaim, Klaim Sebagian 30%"),
  ...
  private static final String RPMF = EFormLpbptkjht.RPMF.getCode();
  private static final String RPMF0200000000_KEYFORM = ER6003RPMF.RPMF0200000000.getKeyForm();
  public static final int[] COLS_NON_TOTAL = { 2, 3, 4, 5, 6, 7 };

  public static String getName() {
    return ER6106RKPMF.class.getSimpleName().substring(6);
  }

  public static int getRefNumber() {
    return Integer.parseInt(ER6106RKPMF.class.getSimpleName().substring(2, 6));
  }

  public String getKeyForm() {
    return EFormLpbptkjht.RKPMF.getCode() + key;
  }
  ...
  public static List<KeyValueString> getObjects() {
    ...
    for (ER6106RKPMF eEnum : ER6106RKPMF.values()) {
  ...
  public static SegmentValidation genValidationTotalJenisKlaim() {
    List<IObject<KeyValueString>> listKv = Arrays.asList(RKPMF0101000000, RKPMF0102000000, RKPMF0103000000,
        RKPMF0104000000, RKPMF0105000000, RKPMF0106000000, RKPMF0107000000, RKPMF0108000000);
  ...
  public static SegmentValidation genValidatonFormJumlahDiajukan() {
    ...
    return genEqualsFormColumn("9", RKPMF0401000000, new int[] { 18 }, RPMF0200000000_KEYFORM, errMsg);
  }
  ...
  public static SegmentValidation genValidatonFormNilaiDiajukan() {
    ...
    return genEqualsFormColumn("9", RKPMF0402000000, new int[] { 19 }, RPMF0200000000_KEYFORM, errMsg);
  }
  ...
  public static SegmentValidation genValidatonFormJumlahDitetapkan() {
    ...
    return genEqualsFormColumn("9", RKPMF0501000000, new int[] { 20 }, RPMF0200000000_KEYFORM, errMsg);
  }
  ...
  public static SegmentValidation genValidatonFormJumlahDitolak() {
    ...
    return genEqualsFormColumn("9", RKPMF0601000000, new int[] { 22 }, RPMF0200000000_KEYFORM, errMsg);
  }
  ...
  public static SegmentValidation genValidatonFormJumlahDibayarkan() {
    ...
    return genEqualsFormColumn("9", RKPMF0701000000, new int[] { 24 }, RPMF0200000000_KEYFORM, errMsg);
  }
