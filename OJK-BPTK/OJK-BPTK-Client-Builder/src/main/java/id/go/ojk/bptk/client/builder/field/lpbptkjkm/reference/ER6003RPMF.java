...
public enum ER6003RPMF implements IObject<KeyValueString> {
  ...
  public static String getName() {
    return ER6003RPMF.class.getSimpleName().substring(6);
  }

  public static int getRefNumber() {
    return Integer.parseInt(ER6003RPMF.class.getSimpleName().substring(2, 6));
  }

  public String getKeyForm() {
    return EFormLpbptkjk.RPMF.getCode() + key;
  }
  ...
  public static List<KeyValueString> getObjects() {
    ...
    for (ER6003RPMF eEnum : ER6003RPMF.values()) {
  ...
  public static String genFieldSave() {
    return UtilMetadata.genFieldSave(UtilMetadata.genPipeColumn(9, 19), getObjects());
  }
  ...
  public static SegmentValidation genValidationTotal() {
    ...
    return UtilSegmentValidation.genEqualsFormula(UtilMetadata.genPipeColumn(9, 19), RPMF0200000000.key,
        RPMF0100000000.key, errMsg);
  }

  public static FieldValidation genValidationTotalJenisKlaim() {
    return UtilFieldValidation.genEqualsExceptPosFormula(UtilMetadata.genPlusColumn(9, 10), RPMF0200000000.key);
  }
  
  public static FieldValidation genDati2Validation() {
    return UtilFieldValidation.getEqualsDati2And1(RPMF0100000000.key, 7, ER1157LokasiDati1.getRefNumber(), ER1206LokasiDati2.getRefNumber());
  }
}
