...
public enum ER5709INVDEP implements IObject<KeyValueString> {
  ...
  public static String getName() {
    return ER5709INVDEP.class.getSimpleName().substring(6);
  }

  public static int getRefNumber() {
    return Integer.parseInt(ER5709INVDEP.class.getSimpleName().substring(2, 6));
  }
  ...
  public static List<KeyValueString> getObjects() {
    ...
    for (ER5709INVDEP eEnum : ER5709INVDEP.values()) {
  ...
  public static SegmentValidation genRowValidation19() {
    ...
    String comparatorPosCode = ER5701LPK.LPK0108000000.getKey();
