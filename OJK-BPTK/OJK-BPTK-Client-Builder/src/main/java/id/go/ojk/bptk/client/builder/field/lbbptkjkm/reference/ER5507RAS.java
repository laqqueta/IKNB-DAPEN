...
public enum ER5507RAS implements IObject<KeyValueString> {
  ...
  RAS0102010000("RAS0102010000", "a. Beban Jaminan Kematian"),
  ...
  private static final String LPK = EFormLbbptkjkm.LPK.getCode();
  private static final String LPKOMP = EFormLbbptkjkm.LPKOMP.getCode();
  private static final String AI = EFormLbbptkjkm.AI.getCode();
  private static final String LPAN = EFormLbbptkjkm.LPAN.getCode();
  ...
  public static String getName() {
    return ER5507RAS.class.getSimpleName().substring(6);
  }

  public static int getRefNumber() {
    return Integer.parseInt(ER5507RAS.class.getSimpleName().substring(2, 6));
  }
  ...
  public static List<KeyValueString> getObjects() {
    ...
    for (ER5507RAS eEnum : ER5507RAS.values()) {
  ...
  public static SegmentValidation genRowValidation02() {
    ...
    String comparatorPosCode = ER5501LPK.LPK0102000000.getKey();
  ...
  public static SegmentValidation genRowValidation03() {
    ...
    String comparatorPosCode = ER5502LPKOMP.LPKOMP0201000000.getKey();
  ...
  public static SegmentValidation genRowValidation05() {
    ...
    String comparatorPosCode = ER5502LPKOMP.LPKOMP0401000000.getKey();
    return UtilSegmentValidation.genEqualsForm("2", selecPosCode, LPKOMP, "2", comparatorPosCode);
  }

  public static SegmentValidation genRowValidation06() {
    String selecPosCode = RAS0102020000.key;
    String comparatorPosCode = ER5502LPKOMP.LPKOMP0402000000.getKey();
    return UtilSegmentValidation.genEqualsForm("2", selecPosCode, LPKOMP, "2", comparatorPosCode);
  }
  ...
  public static SegmentValidation genRowValidation09() {
    ...
    String comparatorPosCode = ER5501LPK.LPK0600000000.getKey();
    return UtilSegmentValidation.genEqualsForm("2", selecPosCode, LPK, "2", comparatorPosCode);
  }
  ...
  public static SegmentValidation genRowValidation19() {
    ...
    String comparatorPosCode = ER5501LPK.LPK0304000000.getKey();
    return UtilSegmentValidation.genEqualsForm("2", selecPosCode, LPK, "2", comparatorPosCode);
  }

  public static SegmentValidation genRowValidation24() {
    String selecPosCode = RAS0501010000.key;
    String comparatorPosCode = ER5503LPAN.LPAN1800000000.getKey();
  ...
  public static SegmentValidation genRowValidation25() {
    ...
    String comparatorPosCode = UtilMetadata.genPlusRow(ER5503LPAN.getObjectsForm(), rows);
    String msgError = UtilMetadata.genPlusDesc(ER5503LPAN.getObjects(), rows) + " pada form " + LPAN;
