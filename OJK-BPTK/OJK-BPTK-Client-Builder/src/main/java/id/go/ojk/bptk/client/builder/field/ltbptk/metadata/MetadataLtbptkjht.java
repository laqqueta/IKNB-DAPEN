...
import id.go.ojk.bptk.client.builder.field.lbbptkjht.metadata.LbAi;
import id.go.ojk.bptk.client.builder.field.lbbptkjht.metadata.LbAnt;
import id.go.ojk.bptk.client.builder.field.lbbptkjht.metadata.LbHai;
import id.go.ojk.bptk.client.builder.field.lbbptkjht.metadata.LbInvdep;
import id.go.ojk.bptk.client.builder.field.lbbptkjht.metadata.LbInvsb;
import id.go.ojk.bptk.client.builder.field.lbbptkjht.metadata.LbLan;
import id.go.ojk.bptk.client.builder.field.lbbptkjht.metadata.LbLpan;
import id.go.ojk.bptk.client.builder.field.lbbptkjht.metadata.LbPiut;
import id.go.ojk.bptk.client.builder.field.lbbptkjht.metadata.LbRas;
import id.go.ojk.bptk.client.builder.field.lbbptkjht.metadata.LbRasl;
...
public class MetadataLtbptkjht {
  public static final String REPORT_CODE = EReportBpjs.LTBPTKJHT_RUTIN.getReportTypeCode();
  @Getter
