...
public enum ER5406HAI implements IObject<KeyValueString> {
  ...
  HAI1100000000("HAI1100000000", "TOTAL HASIL INVESTASI"),;
  ...
  public static String getName() {
    return ER5406HAI.class.getSimpleName().substring(6);
  }

  public static int getRefNumber() {
    return Integer.parseInt(ER5406HAI.class.getSimpleName().substring(2, 6));
  }
  ...
  public static List<KeyValueString> getObjects() {
    ...
    for (ER5406HAI eEnum : ER5406HAI.values()) {
  ...
  public static SegmentValidation genRowValidation12a() {
    ...
    return genPlusValidation("2|3|4|5", HAI1100000000, rows);
  }
