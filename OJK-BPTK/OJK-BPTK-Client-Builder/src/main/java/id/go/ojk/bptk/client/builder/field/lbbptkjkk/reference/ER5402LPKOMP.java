...
public enum ER5402LPKOMP implements IObject<KeyValueString> {
  ...
  LPKOMP0401000000("LPKOMP0401000000", "Beban Jaminan"),
  LPKOMP0402000000("LPKOMP0402000000", "Beban Cadangan Teknis Program"),
  LPKOMP0402010000("LPKOMP0402010000", "Beban Cadangan Teknis Program, Kenaikan (Penurunan) Liabilitas Jaminan Kecelakaan Kerja Dalam Proses"),
  LPKOMP0402020000("LPKOMP0402020000", "Beban Cadangan Teknis Program, Kenaikan (Penurunan) Liabilitas Jaminan Kecelakaan Kerja Belum Dilaporkan"),
  LPKOMP0402030000("LPKOMP0402030000", "Beban Cadangan Teknis Program, Kenaikan (Penurunan) Iuran Yang Belum Merupakan Pendapatan"),
  LPKOMP0402040000("LPKOMP0402040000", "Beban Cadangan Teknis Program, Kenaikan (Penurunan) Liabilitas Jaminan Kecelakaan Kerja Masa Depan"),
  ...
  LPKOMP0700000000("LPKOMP0700000000", "ASET NETO AWAL PERIODE"),
  LPKOMP0800000000("LPKOMP0800000000", "ASET NETO AKHIR PERIODE"),
  LPKOMP0901000000("LPKOMP0901000000", "Penghasilan Komprehensif lain"),
  LPKOMP1000000000("LPKOMP1000000000", "JUMLAH PENGHASILAN KOMPREHENSIF"),;
  ...
  public static String getName() {
    return ER5402LPKOMP.class.getSimpleName().substring(6);
  }

  public static int getRefNumber() {
    return Integer.parseInt(ER5402LPKOMP.class.getSimpleName().substring(2, 6));
  }
  ...
  public static List<KeyValueString> getObjects() {
    ...
    for (ER5402LPKOMP eEnum : ER5402LPKOMP.values()) {
  ...
  public static SegmentValidation genRowValidation28() {
    int[] rows = { 22, 25 };
    return genPlusValidation("2", LPKOMP1000000000, rows);
  };
