...
import id.go.ojk.bptk.client.builder.field.lbbptkjkk.reference.ER5408RASL;
...
public class LbRasl extends BaseMetadata {
  ...
  public SubmissionFormat get() {
    EFormLbbptkjkk eEnum = EFormLbbptkjkk.RASL;
    SubmissionFormat res = new SubmissionFormat(eEnum.getCode(), eEnum.getName(), reportCode, new ArrayList<>(),
        extension, 30, 30);

    res.setRequiredPos(ER5408RASL.genRequiredPos());
    res.setUniquePos(ER5408RASL.genUniquePos());
    res.setSavePos(ER5408RASL.genFieldSave());

    res.addSegmentValidations(ER5408RASL.genRowValidation18a());
    res.addSegmentValidations(ER5408RASL.genRowValidation20());
    res.addSegmentValidations(ER5408RASL.genRowValidation24());
    res.addSegmentValidations(ER5408RASL.genRowValidation30());
    res.addSegmentValidations(ER5408RASL.genRowValidation31());

    /* -- ANTAR FORM -- */
    res.addSegmentValidations(ER5408RASL.genRowValidation18b());

    List<SubmissionField> fs = res.getFields();
    fs.add(sf(0, null, "Flag Detail", sv(M, 3, 3, alfaNumeric).confConstant("D01")));
    fs.add(sf(1, null, "Kode Komponen / Baris", sv(M, 14, 14, refTable)
        .confReference(EHeaderMetadataLbbptkjkk.R5408RASL.getObject())
    ...
    fs.add(sf(4, null, "Jatuh Tempo Aset dan Liabilitas, Jatuh tempo < 1 thn, Total", sv(M, 1, 20, numericNegatif))
        .addFieldValidations(ER5408RASL.genFieldValidation05()));
    ...
    fs.add(sf(7, null, "Jatuh Tempo Aset dan Liabilitas, 1 thn ≤ jatuh tempo < 3 thn, Total", sv(M, 1, 20, numericNegatif))
        .addFieldValidations(ER5408RASL.genFieldValidation08()));
    ...
    fs.add(sf(10, null, "Jatuh Tempo Aset dan Liabilitas, 3 thn ≤ jatuh tempo < 5 thn, Total", sv(M, 1, 20, numericNegatif))
        .addFieldValidations(ER5408RASL.genFieldValidation11()));
    ...
    fs.add(sf(13, null, "Jatuh Tempo Aset dan Liabilitas, 5 thn ≤ jatuh tempo < 10 thn, Total", sv(M, 1, 20, numericNegatif))
        .addFieldValidations(ER5408RASL.genFieldValidation14()));
    ...
    fs.add(sf(16, null, "Jatuh Tempo Aset dan Liabilitas, ≥ 10 thn, Total", sv(M, 1, 20, numericNegatif))
        .addFieldValidations(ER5408RASL.genFieldValidation17()));
    ...
    fs.add(sf(19, null, "Jatuh Tempo Aset dan Liabilitas, Total, Total", sv(M, 1, 20, numericNegatif))
        .addFieldValidations(ER5408RASL.genFieldValidation20()));
    return res;
  }
}
