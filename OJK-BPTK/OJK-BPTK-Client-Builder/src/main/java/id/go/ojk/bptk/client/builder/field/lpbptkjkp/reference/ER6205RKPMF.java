...
public enum ER6205RKPMF implements IObject<KeyValueString> {
  ...
  public static String getName() {
    return ER6205RKPMF.class.getSimpleName().substring(6);
  }

  public static int getRefNumber() {
    return Integer.parseInt(ER6205RKPMF.class.getSimpleName().substring(2, 6));
  }

  public String getKeyForm() {
    return EFormLpbptkjkp.RKPMF.getCode() + key;
  }
  ...
  public static List<KeyValueString> getObjects() {
    ...
    for (ER6205RKPMF eEnum : ER6205RKPMF.values()) {
