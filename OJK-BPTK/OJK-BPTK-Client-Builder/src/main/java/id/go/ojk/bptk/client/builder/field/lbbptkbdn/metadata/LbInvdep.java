...
public class LbInvdep extends BaseMetadata {
  ...
  public SubmissionFormat get() {
    EFormLbbptkbdn eEnum = EFormLbbptkbdn.INVDEP;
    SubmissionFormat res = new SubmissionFormat(eEnum.getCode(), eEnum.getName(), reportCode, new ArrayList<>(),
        extension, 1, null);

    res.setRequiredPos(ER5309INVDEP.genRequiredPos());
    res.setUniquePos(ER5309INVDEP.genUniquePos());
    res.setSavePos(ER5309INVDEP.genFieldSave());
    ...
    fs.add(sf(1, null, "Kode Komponen / Baris", sv(M, 16, 16, refTable)
        .confReference(EHeaderMetadataLbbptkbdn.R5309INVDEP.getObject())
    ...
    fs.add(sf(2, null, "Jenis Deposito", sv(C, 1, 10, refTable)
        ...
        .confConditionalRequired(ER5309INVDEP.genConditionalExistA())));
    ...
    fs.add(sf(4, null, "Penerbit, Jenis Bank", sv(C, 1, 10, refTable)
        ...
        .confConditionalRequired(ER5309INVDEP.genConditionalExistA()))
        .addFieldValidations(ER5309INVDEP.genFieldValidation05()));
    ...
    fs.add(sf(11, null, "Penerbit, Tingkat Suku Bunga", sv(C, 1, 6, numericDot)
        .confConditionalRequired(ER5309INVDEP.genConditionalExistA()))
        .addFieldValidations(ER5309INVDEP.genFieldValidation12()));
    fs.add(sf(12, null, "Jangka Waktu, Mulai", sv(C, 8, 8, date)
        .confConditionalRequired(ER5309INVDEP.genConditionalExistA()))
        .addFieldValidations(ER5309INVDEP.genFieldValidation13()));
    fs.add(sf(13, null, "Jangka Waktu, Jatuh Tempo", sv(C, 8, 8, date)
        .confConditionalRequired(ER5309INVDEP.genConditionalExistA()))
        .addFieldValidations(ER5309INVDEP.genFieldValidation14()));
    fs.add(sf(14, null, "Jangka Waktu, Tenor", sv(C, 1, 8, numeric)
        .confConditionalRequired(ER5309INVDEP.genConditionalExistA()))
        .addFieldValidations(ER5309INVDEP.genFieldValidation15()));
    ...
    fs.add(sf(16, null, "CKPN, Individual", sv(C, 1, 20, numeric)
        .confConditionalRequired(ER5309INVDEP.genConditionalExist17())));
    fs.add(sf(17, null, "CKPN, Kolektif", sv(C, 1, 20, numeric)
        .confConditionalRequired(ER5309INVDEP.genConditionalExist18())));
    fs.add(sf(18, null, "Jumlah Neto", sv(M, 1, 20, numeric))
        .addFieldValidations(ER5309INVDEP.genFieldValidation18()));
    return res;
  }
}
