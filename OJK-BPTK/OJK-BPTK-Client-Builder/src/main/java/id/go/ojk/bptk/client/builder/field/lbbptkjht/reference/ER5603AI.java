...
public enum ER5603AI implements IObject<KeyValueString> {
  ...
  public static String getName() {
    return ER5603AI.class.getSimpleName().substring(6);
  }

  public static int getRefNumber() {
    return Integer.parseInt(ER5603AI.class.getSimpleName().substring(2, 6));
  }
  ...
  public static List<KeyValueString> getObjects() {
    ...
    for (ER5603AI eEnum : ER5603AI.values()) {
