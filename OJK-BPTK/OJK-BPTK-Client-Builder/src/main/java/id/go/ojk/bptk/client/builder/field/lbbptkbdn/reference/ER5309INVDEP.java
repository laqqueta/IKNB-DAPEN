...
public enum ER5309INVDEP implements IObject<KeyValueString> {
  ...
  public static String getName() {
    return ER5309INVDEP.class.getSimpleName().substring(6);
  }

  public static int getRefNumber() {
    return Integer.parseInt(ER5309INVDEP.class.getSimpleName().substring(2, 6));
  }
  ...
  public static List<KeyValueString> getObjects() {
    ...
    for (ER5309INVDEP eEnum : ER5309INVDEP.values()) {
  ...
  public static SegmentValidation genRowValidation19Bdn() {
    String selecPosCode = INVDEP0200000000.key;
    String comparatorPosCode = ER5301LPK.LPK0101090100.getKey();
    return UtilSegmentValidation.genEqualsForm("18", selecPosCode, "LPK", "2",
        comparatorPosCode);
  }

  public static SegmentValidation genRowValidation19Jkk() {
    String selecPosCode = INVDEP0200000000.key;
    String comparatorPosCode = ER5401LPK.LPK0107000000.getKey();
    return UtilSegmentValidation.genEqualsForm("18", selecPosCode, "LPK", "2",
        comparatorPosCode);
  }
}
