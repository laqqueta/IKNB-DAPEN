...
public enum ER5401LPK implements IObject<KeyValueString> {
  ...
  LPK0301000000("LPK0301000000", "Utang Jaminan Kecelakaan Kerja"),
  LPK0302000000("LPK0302000000", "Utang Kepada BPJS"),
  LPK0302010000("LPK0302010000", "Utang Kepada BPJS, Dana Operasional"),
  LPK0302020000("LPK0302020000", "Utang Kepada BPJS, Dana Talangan"),
  LPK0303000000("LPK0303000000", "Utang Kepada Pihak Lain"),
  LPK0304000000("LPK0304000000", "Cadangan Teknis"),
  LPK0304010000("LPK0304010000", "Cadangan Teknis, Liabilitas Jaminan Kecelakaan Kerja Dalam Proses"),
  LPK0304020000("LPK0304020000", "Cadangan Teknis, Liabilitas Jaminan Kecelakaan Kerja Belum Dilaporkan"),
  LPK0304030000("LPK0304030000", "Cadangan Teknis, Iuran Yang Belum Merupakan Pendapatan"),
  LPK0304040000("LPK0304040000", "Cadangan Teknis, Liabilitas Jaminan Kecelakaan Kerja Masa Depan"),
  ...
  LPK0502000000("LPK0502000000", "Kenaikan (Penurunan) Aset Neto Program"),
  ...
  public static String getName() {
    return ER5401LPK.class.getSimpleName().substring(6);
  }

  public static int getRefNumber() {
    return Integer.parseInt(ER5401LPK.class.getSimpleName().substring(2, 6));
  }
  ...
  public static List<KeyValueString> getObjects() {
    ...
    for (ER5401LPK eEnum : ER5401LPK.values()) {
  ...
  public static SegmentValidation genRowValidation34() {
    int[] rows = { 16, 28 };
    return genMinusValidation("2", LPK0600000000, rows);
  };
