...
public enum ER5904RKPIU implements IObject<KeyValueString> {
  ...
  private static final String RKPST = EFormLpbptkjkk.RKPST.getCode();
  private static final String RPIU = EFormLpbptkjkk.RPIU.getCode();
  public static final int[] COLS_NON_TOTAL = { 2, 3, 4, 5, 6, 7 };

  public static String getName() {
    return ER5904RKPIU.class.getSimpleName().substring(6);
  }

  public static int getRefNumber() {
    return Integer.parseInt(ER5904RKPIU.class.getSimpleName().substring(2, 6));
  }
  ...
  public static List<KeyValueString> getObjects() {
    ...
    for (ER5904RKPIU eEnum : ER5904RKPIU.values()) {
