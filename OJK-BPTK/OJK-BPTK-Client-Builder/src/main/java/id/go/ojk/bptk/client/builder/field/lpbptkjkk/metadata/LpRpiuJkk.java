...
public class LpRpiuJkk extends BaseMetadata {
  ...
  public SubmissionFormat get() {
    ...
    fs.add(sf(15, null, "Pembebanan Iuran Peserta", sv(M, 1, 23, numericDotNegatif)));
    fs.add(sf(16, null, "Pembebanan Iuran Beban Pemberi Kerja", sv(M, 1, 23, numericDotNegatif)));
    fs.add(sf(17, null, "Total Pembebanan Iuran", sv(M, 1, 23, numericDotNegatif))
        .addFieldValidations(ER5902RPIU.genValidationTotalPembebananIuran()));
    fs.add(sf(18, null, "Iuran Yang Diterima Jatuh Tempo Sudah rekonsiliasi", sv(M, 1, 23, numericDotNegatif)));
    fs.add(sf(19, null, "Iuran Yang Diterima Jatuh Tempo Belum rekonsiliasi", sv(M, 1, 23, numericDotNegatif)));
    fs.add(sf(20, null, "Iuran Yang Diterima Dibayar Di Muka", sv(M, 1, 23, numericDotNegatif)));
    fs.add(sf(21, null, "Iuran Yang Diterima Iuran Belum Rinci (IBR) Tahun Lalu", sv(M, 1, 23, numericDotNegatif)));
