...
public enum ER5713PIUT implements IObject<KeyValueString> {
  ...
  public static String getName() {
    return ER5713PIUT.class.getSimpleName().substring(6);
  }

  public static int getRefNumber() {
    return Integer.parseInt(ER5713PIUT.class.getSimpleName().substring(2, 6));
  }
  ...
  public static List<KeyValueString> getObjects() {
    ...
    for (ER5713PIUT eEnum : ER5713PIUT.values()) {
  ...
  public static SegmentValidation genRowValidation14() {
    ...
    String errMsg = UtilMetadata.genMessage("Total Saldo",
        UtilMetadata.genPlusDesc(ER5701LPK.getObjects(), rows) + " pada form LPK");
