...
public enum ER5808INVSB implements IObject<KeyValueString> {
  ...
  public static String getName() {
    return ER5808INVSB.class.getSimpleName().substring(6);
  }

  public static int getRefNumber() {
    return Integer.parseInt(ER5808INVSB.class.getSimpleName().substring(2, 6));
  }
  ...
  public static List<KeyValueString> getObjects() {
    ...
    for (ER5808INVSB eEnum : ER5808INVSB.values()) {
