...
public enum ER5503LPAN implements IObject<KeyValueString> {
  ...
  public static String getName() {
    return ER5503LPAN.class.getSimpleName().substring(6);
  }

  public static int getRefNumber() {
    return Integer.parseInt(ER5503LPAN.class.getSimpleName().substring(2, 6));
  }
  ...
  public static List<KeyValueString> getObjects() {
    ...
    for (ER5503LPAN eEnum : ER5503LPAN.values()) {
