...
public enum ER5802LPAN implements IObject<KeyValueString> {
  LPAN0300000000("LPAN0300000000","Pendapatan Iuran Pensiun"),
  ...
  LPAN1100000000("LPAN1100000000","Beban Jaminan Pensiun"),
  ...
  public static String getName() {
    return ER5802LPAN.class.getSimpleName().substring(6);
  }

  public static int getRefNumber() {
    return Integer.parseInt(ER5802LPAN.class.getSimpleName().substring(2, 6));
  }

  public String getKeyForm() {
    return EFormLbbptkjp.LPAN.getCode() + key;
  }
  ...
  public static List<KeyValueString> getObjects() {
    ...
    for (ER5802LPAN eEnum : ER5802LPAN.values()) {
