...
public enum ER6202RPIU implements IObject<KeyValueString> {
  ...
  public static String getName() {
    return ER6202RPIU.class.getSimpleName().substring(6);
  }

  public static int getRefNumber() {
    return Integer.parseInt(ER6202RPIU.class.getSimpleName().substring(2, 6));
  }
  ...
  public static List<KeyValueString> getObjects() {
    ...
    for (ER6202RPIU eEnum : ER6202RPIU.values()) {
  ...
  public static FieldValidation genValidationTotalPembebananIuran() {
    return UtilFieldValidation.genEqualsExceptPosFormula(UtilMetadata.genPlusColumn(15, 17), RPIU0200000000.key, 2);
  }

  public static FieldValidation genValidationIuranYangDiterima() {
    return UtilFieldValidation.genEqualsExceptPosFormula(UtilMetadata.genPlusColumn(19, 21), RPIU0200000000.key, 2);
  }
