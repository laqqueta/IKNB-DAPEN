...
public enum ER5604HAI implements IObject<KeyValueString> {
  ...
  public static String getName() {
    return ER5604HAI.class.getSimpleName().substring(6);
  }

  public static int getRefNumber() {
    return Integer.parseInt(ER5604HAI.class.getSimpleName().substring(2, 6));
  }
  ...
  public static List<KeyValueString> getObjects() {
    ...
    for (ER5604HAI eEnum : ER5604HAI.values()) {
