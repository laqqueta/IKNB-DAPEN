...
public enum ER6203RPMF implements IObject<KeyValueString> {
  ...
  public static String getName() {
    return ER6203RPMF.class.getSimpleName().substring(6);
  }

  public static int getRefNumber() {
    return Integer.parseInt(ER6203RPMF.class.getSimpleName().substring(2, 6));
  }
  ...
  public static List<KeyValueString> getObjects() {
    ...
    for (ER6203RPMF eEnum : ER6203RPMF.values()) {
  ...
  public static String genFieldSave() {
    return UtilMetadata.genFieldSave(UtilMetadata.genPipeColumn(9, 20), getObjects());
  }

  public static String genFieldSaveForm() {
    return UtilMetadata.genFieldSave(UtilMetadata.genPipeColumn(12, 20), getObjects());
  }
  ...
  public static SegmentValidation genValidationTotal() {
    ...
    return UtilSegmentValidation.genEqualsFormula(UtilMetadata.genPipeColumn(9, 20), RPMF0200000000.key,
        RPMF0100000000.key, errMsg);
  }

  public static FieldValidation genValidationTotalJenisManfaat() {
    return UtilFieldValidation.genEqualsExceptPosFormula(UtilMetadata.genPlusColumn(9, 11), RPMF0200000000.key);
  }
