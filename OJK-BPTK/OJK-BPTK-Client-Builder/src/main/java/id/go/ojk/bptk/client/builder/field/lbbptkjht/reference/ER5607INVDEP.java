...
public enum ER5607INVDEP implements IObject<KeyValueString> {
  ...
  public static final int[] ROW_TOTAL = { 9, 15, 16, 17 };

  public static String getName() {
    return ER5607INVDEP.class.getSimpleName().substring(6);
  }

  public static int getRefNumber() {
    return Integer.parseInt(ER5607INVDEP.class.getSimpleName().substring(2, 6));
  }
  ...
  public static List<KeyValueString> getObjects() {
    ...
    for (ER5607INVDEP eEnum : ER5607INVDEP.values()) {
  ...
  public static String genFieldSave() {
    return UtilMetadata.genFieldSave(UtilMetadata.genPipeColumn(new int[] { 9, 10, 11, 12, 13, 15, 16, 17 }),
        getObjects());
  }
  ...
  public static FieldValidation genFieldValidation13() {
    return UtilFieldValidation.genDateGreater("11");
  }
  ...
  public static FieldValidation genFieldValidation18() {
    int[] cols = { 9, 15, 16 };
    String msgError = "Kolom 18 | Kolom 10 - (Kolom 16 + Kolom 17)";
