...
import id.go.ojk.bptk.client.builder.field.lbbptkjkk.metadata.LbLpan;
import id.go.ojk.bptk.client.builder.field.lbbptkjkk.metadata.LbLpk;
import id.go.ojk.bptk.client.builder.field.lbbptkjkk.metadata.LbLpkomp;
import id.go.ojk.bptk.client.builder.field.lbbptkjkk.metadata.LbPiut;
import id.go.ojk.bptk.client.builder.field.lbbptkjkk.metadata.LbRas;
import id.go.ojk.bptk.client.builder.field.lbbptkjkk.metadata.LbRasl;
...
public class MetadataLtbptkjkk {
  public static final String REPORT_CODE = EReportBpjs.LTBPTKJKK_RUTIN.getReportTypeCode();
  @Getter
