...
public enum ER5811PIUT implements IObject<KeyValueString> {
  ...
  public static String getName() {
    return ER5811PIUT.class.getSimpleName().substring(6);
  }

  public static int getRefNumber() {
    return Integer.parseInt(ER5811PIUT.class.getSimpleName().substring(2, 6));
  }
  ...
  public static List<KeyValueString> getObjects() {
    ...
    for (ER5811PIUT eEnum : ER5811PIUT.values()) {
