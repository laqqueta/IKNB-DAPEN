...
public enum ER6104RPMF implements IObject<KeyValueString> {
  ...
  public static String getName() {
    return ER6104RPMF.class.getSimpleName().substring(6);
  }

  public static int getRefNumber() {
    return Integer.parseInt(ER6104RPMF.class.getSimpleName().substring(2, 6));
  }

  public String getKeyForm() {
    return EFormLpbptkjht.RPMF.getCode() + key;
  }
  ...
  public static List<KeyValueString> getObjects() {
    ...
    for (ER6104RPMF eEnum : ER6104RPMF.values()) {
  ...
  public static String genFieldSave() {
    return UtilMetadata.genFieldSave(UtilMetadata.genPipeColumn(9, 25), getObjects());
  }

  public static String genFieldSaveForm() {
    return UtilMetadata.genFieldSave(UtilMetadata.genPipeColumn(17, 25), getObjects());
  }
  ...
  public static SegmentValidation genValidationTotal() {
    ...
    return UtilSegmentValidation.genEqualsFormula(UtilMetadata.genPipeColumn(9, 25), RPMF0200000000.key,
        RPMF0100000000.key, errMsg);
  }

  public static FieldValidation genValidationTotalJenisManfaat() {
    return UtilFieldValidation.genEqualsExceptPosFormula(UtilMetadata.genPlusColumn(9, 16), RPMF0200000000.key);
  }
