...
public enum ER4003PosSaAsrjs0203 implements IObject<KeyValueString> {
...
//	R_02030102060000 ("02030102060000", "6.  Bauran risiko produk asuransi dan jenis manfaat"),
	R_02030102060100 ("02030102060100", "a. jenis risiko yang ditanggung;"),
	R_02030102060200 ("02030102060200", "b. cara pembayaran manfaat;"),
	R_02030102060300 ("02030102060300", "c. jenis sumber pertanggungan; dan"),
	R_02030102060400 ("02030102060400", "d. jenis produk."),
//	R_02030102070000 ("02030102070000", "7.  Pemantauan kinerja produk asuransi"),
	...
	R_02030102080100 ("02030102080100", "   a. desain produk: 1) lini usaha/jenis produk yang akan dikembangkan; 2) penilaian risiko produk; 3) modifikasi produk; 4) ketentuan polis (policy wording); dan 5) dukungan reasuransi."),
	R_02030102080200 ("02030102080200", "b. produk tradisional (produk asuransi yang tidak dikaitkan dengan investasi) atau paydi (produk tradisional yang memberikan manfaat investasi)"),
	R_02030102090000 ("02030102090000", "9.  Saluran pemasaran"),
//	R_02030102100000 ("02030102100000", "10.  Risiko liabilitas"),
...
//	R_02030400000000 ("02030400000000", "Tabel II.C.4: Tingkat Risiko Inheren untuk Risiko Asuransi Konsolidasi"),
	R_02030401000000 ("02030401000000", "Tingkat Risiko Inheren untuk Risiko Asuransi "),
//	R_02030500000000 ("02030500000000", "Tabel II.C.5: Kualitas Penerapan Manajemen Risiko untuk Risiko Asuransi Konsolidasi"),
	R_02030501000000 ("02030501000000", "Kualitas Penerapan Manajemen Risiko untuk Risiko Asuransi "),
//	R_02030502000000 ("02030502000000", "Tingkat Risiko Asuransi "),
	R_02030503000000 ("02030503000000", "Tingkat Risiko Asuransi Net Risk"),
	R_02030600000000 ("02030600000000", "ANALISIS"),
	;
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER4003PosSaAsrjs0203 eEnum : ER4003PosSaAsrjs0203.values()) {
	...
	public static ConditionalRequired genConditional2() {
		return UtilFieldConditional.genExistPos("O", "M", UtilMetadata.genPipeRow(getObjects(), 55, 57));
	}
	...
	public static SegmentValidation genValidationNumeric() {
		return UtilSegmentValidation.genRegexNumeric("2", UtilMetadata.genPipeRow(getObjects(), 52, 57));
	}
	
	public static SegmentValidation genValidationMaxLengthNumeric() {
		return UtilSegmentValidation.genMaxLength("2", UtilMetadata.genPipeRow(getObjects(), 52, 57), 1);
	}
	
	public static SegmentValidation genValidationPeringkat1() {
		return UtilSegmentValidation.genFixedValue("2", UtilMetadata.genPipeRow(getObjects(), 52, 54), ER1099Peringkat.getPipedKey());
	}
	
	public static SegmentValidation genValidationPeringkat2() {
		return UtilSegmentValidation.genFixedValueOptional("2", UtilMetadata.genPipeRow(getObjects(), 55, 57), ER1099Peringkat.getPipedKey());
	}
}
