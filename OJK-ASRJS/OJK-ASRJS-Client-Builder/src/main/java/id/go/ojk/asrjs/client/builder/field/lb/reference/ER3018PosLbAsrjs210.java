...
public enum ER3018PosLbAsrjs210 implements IObject<KeyValueString> {
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER3018PosLbAsrjs210 eEnum : ER3018PosLbAsrjs210.values()) {
	...
	public static ConditionalRequired genConditional3() {
		return UtilFieldConditional.genExistPos("M", "N", UtilMetadata.genPipeRowExcept(getObjects(), new int[] { 2 }));
	}
	
	public static SegmentValidation genValidationTotalRisikoKredit() {
		return UtilSegmentValidation.genEqualsFormula(UtilMetadata.genPipeColumn(new int[] {2, 4}), R_2101000003.key, 
