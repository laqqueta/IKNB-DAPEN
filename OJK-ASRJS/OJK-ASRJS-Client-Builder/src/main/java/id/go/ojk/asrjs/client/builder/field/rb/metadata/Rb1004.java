...
import id.go.ojk.asrjs.client.builder.field.rb.reference.ER2022PosRbAsrjs1004;
...
public class Rb1004 extends BaseMetadata {
	...
	public SubmissionFormat get() {
		...
		fs.add(sf(3, null, "Alasan Pemanfaatan Tenaga Alih Daya",
				sv(C, 0, 1000, all).confConditionalRequired(ER2022PosRbAsrjs1004.genConditionalField())));
