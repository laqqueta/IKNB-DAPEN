...
import id.go.ojk.asrjs.client.builder.field.rb.reference.ER2007PosRbAsrjs0202;
...
public class Rb0202 extends BaseMetadata {
	...
	public SubmissionFormat get() {
		...
		SubmissionFormat res = new SubmissionFormat(eEnum.getCode(), eEnum.getName(), reportCode,
				...
				ER2007PosRbAsrjs0202.getRequiredPos());
		res.addSegmentValidations(ER2007PosRbAsrjs0202.genValidationNumeric());
		res.addSegmentValidations(ER2007PosRbAsrjs0202.genValidationNumericDot());
		...
		fs.add(sf(2, null, "Indikator Lain", sv(C, 0, 200, all)
				.confConditionalRequired(ER2007PosRbAsrjs0202.genConditionalField())));
		...
		fs.add(sf(5, null, "%", sv(M, 0, 16, numericDotNegatif))
				.addFieldValidations(ER2007PosRbAsrjs0202.genValidationRatioField()));
		return res;
	}
}
