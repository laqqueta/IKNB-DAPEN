...
public enum ER2024PosRbAsrjs1201 implements IObject<KeyValueString> {
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER2024PosRbAsrjs1201 eEnum : ER2024PosRbAsrjs1201.values()) {
	...
	public static String getName() {
		return ER2024PosRbAsrjs1201.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER2024PosRbAsrjs1201.class.getSimpleName().substring(2, 6));
	}
