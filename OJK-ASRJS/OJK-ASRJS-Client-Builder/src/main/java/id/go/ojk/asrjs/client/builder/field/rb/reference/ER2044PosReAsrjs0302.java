...
public enum ER2044PosReAsrjs0302 implements IObject<KeyValueString> {
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER2044PosReAsrjs0302 eEnum : ER2044PosReAsrjs0302.values()) {
	...
	public static String getName() {
		return ER2044PosReAsrjs0302.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER2044PosReAsrjs0302.class.getSimpleName().substring(2, 6));
	}
