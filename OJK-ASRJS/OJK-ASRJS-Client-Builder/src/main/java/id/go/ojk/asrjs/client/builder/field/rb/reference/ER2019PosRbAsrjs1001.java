...
public enum ER2019PosRbAsrjs1001 implements IObject<KeyValueString> {
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER2019PosRbAsrjs1001 eEnum : ER2019PosRbAsrjs1001.values()) {
	...
	public static String getName() {
		return ER2019PosRbAsrjs1001.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER2019PosRbAsrjs1001.class.getSimpleName().substring(2, 6));
	}
