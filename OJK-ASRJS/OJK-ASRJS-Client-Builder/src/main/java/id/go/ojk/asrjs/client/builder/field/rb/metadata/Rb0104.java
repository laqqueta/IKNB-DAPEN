...
import id.go.ojk.asrjs.client.builder.field.rb.reference.ER2003PosRbAsrjs0104;
...
public class Rb0104 extends BaseMetadata {
	...
	public SubmissionFormat get() {
		...
		SubmissionFormat res = new SubmissionFormat(eEnum.getCode(), eEnum.getName(), reportCode,
				new ArrayList<>(), extension, 6, 6, null, null, ER2003PosRbAsrjs0104.getRequiredPos());
