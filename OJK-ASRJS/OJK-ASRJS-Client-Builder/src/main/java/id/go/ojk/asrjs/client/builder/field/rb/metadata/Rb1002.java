...
import id.go.ojk.asrjs.client.builder.field.rb.reference.ER2020PosRbAsrjs1002;
...
public class Rb1002 extends BaseMetadata {
	...
	public SubmissionFormat get() {
		...
		fs.add(sf(3, null, "Metode Diklat",
				sv(C, 0, 1000, all).confConditionalRequired(ER2020PosRbAsrjs1002.genConditionalField())));
		...
		fs.add(sf(9, null, "Biaya Diklat",
				sv(C, 0, 16, numeric).confConditionalRequired(ER2020PosRbAsrjs1002.genConditionalField())));
		return res;
	}
}
