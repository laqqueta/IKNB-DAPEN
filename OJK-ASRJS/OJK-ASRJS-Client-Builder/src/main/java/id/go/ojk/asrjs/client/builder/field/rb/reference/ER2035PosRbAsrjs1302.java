...
public enum ER2035PosRbAsrjs1302 implements IObject<KeyValueString> {
...
//	R_13020207000000 ("13020207000000", "7.    Penghitungan Qardh yang Diperlukan Dana Tanahud"),
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER2035PosRbAsrjs1302 eEnum : ER2035PosRbAsrjs1302.values()) {
	...
	public static String getName() {
		return ER2035PosRbAsrjs1302.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER2035PosRbAsrjs1302.class.getSimpleName().substring(2, 6));
	}
	...
	public static SegmentValidation genValidationKekuranganTingkatSolvabilitasDariTargetInternal() {
		return UtilSegmentValidation.genMaxValue2("2|3|4|5", R_13020106010000.key,
				...
				"Perhitungan Kekurangan (kelebihan) tingkat solvabilitas dari target internal' dan Tanahud", 0);
	}
