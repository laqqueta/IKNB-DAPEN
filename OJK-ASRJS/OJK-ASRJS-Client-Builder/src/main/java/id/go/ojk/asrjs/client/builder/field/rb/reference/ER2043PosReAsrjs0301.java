...
public enum ER2043PosReAsrjs0301 implements IObject<KeyValueString> {
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER2043PosReAsrjs0301 eEnum : ER2043PosReAsrjs0301.values()) {
	...
	public static String getName() {
		return ER2043PosReAsrjs0301.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER2043PosReAsrjs0301.class.getSimpleName().substring(2, 6));
	}
