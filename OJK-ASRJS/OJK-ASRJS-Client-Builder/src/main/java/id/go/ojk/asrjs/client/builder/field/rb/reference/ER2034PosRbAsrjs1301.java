...
public enum ER2034PosRbAsrjs1301 implements IObject<KeyValueString> {
...
//	R_13010204000000 ("13010204000000", "4.    Rasio Aset Unit Syariah"),
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER2034PosRbAsrjs1301 eEnum : ER2034PosRbAsrjs1301.values()) {
	...
	public static String getName() {
		return ER2034PosRbAsrjs1301.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER2034PosRbAsrjs1301.class.getSimpleName().substring(2, 6));
	}
	...
	public static SegmentValidation genValidationAsetYgTersediaUntukQardhYgDiperhitungkanSebagaiPenambahAYDDanaTabarruDanTanahud() {
		return UtilSegmentValidation.genMaxValue("2|3|4|5", R_13010106000000.key,
	...
	public static SegmentValidation genValidationKekuranganTingkatSolvabilitasDariTargetInternal() {
		return UtilSegmentValidation.genMaxValue2("2|3|4|5", R_13010106010000.key,
				R_13010104000000.key + "-" + R_13010103000000.key + "*" + R_13010102000000.key, ".01", "0",
				"Perhitungan Kekurangan (kelebihan) tingkat solvabilitas dari target internal' dan Tanahud");
	}

	public static SegmentValidation genValidationRasioTingkatSolvabilitasDanaPerusahaan() {
		return UtilSegmentValidation.genEqualsRatio("2|3|4|5", R_13010107000000.key,
				UtilMetadata.genPlusRow(getObjects(), new int[] { 0, 7 }) + "|" + R_13010102000000.key, 
