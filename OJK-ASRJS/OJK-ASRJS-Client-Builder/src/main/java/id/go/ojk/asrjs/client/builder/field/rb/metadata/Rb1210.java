...
import id.go.ojk.asrjs.client.builder.field.rb.reference.ER2033PosRbAsrjs1210;
...
public class Rb1210 extends BaseMetadata {
	...
	public SubmissionFormat get() {
		...
		SubmissionFormat res = new SubmissionFormat(eEnum.getCode(), eEnum.getName(), reportCode,
				...
				ER2033PosRbAsrjs1210.getRequiredPos());
		res.addSegmentValidations(ER2033PosRbAsrjs1210.genValidationNumericNegative());
		res.addSegmentValidations(ER2033PosRbAsrjs1210.genValidationNumeric2());
		res.addSegmentValidations(ER2033PosRbAsrjs1210.genValidationNumeric2());
		res.addSegmentValidations(ER2033PosRbAsrjs1210.genValidationNumericDot());
		res.addSegmentValidations(ER2033PosRbAsrjs1210.genValidationNumericMaxLength());
		...
		fs.add(sf(2, null, "Asumsi Lain",
				sv(C, 0, 200, all).confConditionalRequired(ER2033PosRbAsrjs1210.genConditionField())));
