...
public enum ER4004PosSaAsrjs0204 implements IObject<KeyValueString> {
...
//	R_02040400000000 ("02040400000000", "Tabel II.D.4: Tingkat Risiko Inheren untuk Risiko Kredit Konsolidasi"),
	R_02040401000000 ("02040401000000", "Tingkat Risiko Inheren untuk Risiko Kredit "),
//	R_02040500000000 ("02040500000000", "Tabel II.D.5: Kualitas Penerapan Manajemen Risiko untuk Risiko Kredit Konsolidasi"),
	R_02040501000000 ("02040501000000", "Kualitas Penerapan Manajemen Risiko untuk Risiko Kredit "),
//	R_02040502000000 ("02040502000000", "Tingkat Risiko Kredit "),
	R_02040503000000 ("02040503000000", "Tingkat Risiko Kredit Net Risk"),
	R_02040600000000 ("02040600000000", "ANALISIS"),
	;
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER4004PosSaAsrjs0204 eEnum : ER4004PosSaAsrjs0204.values()) {
	...
	public static ConditionalRequired genConditional2() {
		return UtilFieldConditional.genExistPos("O", "M", UtilMetadata.genPipeRow(getObjects(), 17, 19));
	}
	...
	public static SegmentValidation genValidationNumeric() {
		return UtilSegmentValidation.genRegexNumeric("2", UtilMetadata.genPipeRow(getObjects(), 14, 19));
	}
	
	public static SegmentValidation genValidationMaxLengthNumeric() {
		return UtilSegmentValidation.genMaxLength("2", UtilMetadata.genPipeRow(getObjects(), 14, 19), 1);
	}
	...
	public static SegmentValidation genValidationPeringkat2() {
		return UtilSegmentValidation.genFixedValueOptional("2", UtilMetadata.genPipeRow(getObjects(), 17, 19), ER1099Peringkat.getPipedKey());
	}
}
