...
import id.go.ojk.asrjs.client.builder.field.lb.reference.ER3046PosLbAsrjs607;
...
public class Lb607 extends BaseMetadata {
	...
	public SubmissionFormat get() {
		...
		SubmissionFormat res = new SubmissionFormat(eEnum.getCode(), eEnum.getName(), reportCode,
				new ArrayList<>(), extension, 13, 13, ER3046PosLbAsrjs607.genFieldSave(), null,
				ER3046PosLbAsrjs607.getRequiredPos());
		res.addSegmentValidations(ER3046PosLbAsrjs607.genValidationJumlah1());
		res.addSegmentValidations(ER3046PosLbAsrjs607.genValidationJumlah2());
		res.addSegmentValidations(ER3046PosLbAsrjs607.genValidationPertanggunganPadaAkhirTahun());
		List<SubmissionField> fs = res.getFields();
		fs.add(sf(0, null, "Flag Detail", sv(M, 3, 3, alfaNumeric).confConstant("D01")));
		fs.add(sf(1, null, "Kode Komponen / Baris",
				sv(M, 10, 10, refTable).confReference(EHeaderMetadataLb.R3046_LB607.getObject())).confUnique(U));
		...
		fs.add(sf(24, null, "Total - Jml Polis", sv(M, 1, 16, numericNegatif))
				.addFieldValidations(ER3046PosLbAsrjs607.genFieldValidation24()));
		fs.add(sf(25, null, "Total - JUP", sv(M, 1, 16, numericNegatif))
				.addFieldValidations(ER3046PosLbAsrjs607.genFieldValidation25()));
		return res;
	}
}
