...
import id.go.ojk.asrjs.client.builder.field.rb.reference.ER2002PosRbAsrjs0103;
...
public class Rb0103 extends BaseMetadata {
	...
	public SubmissionFormat get() {
		...
		SubmissionFormat res = new SubmissionFormat(eEnum.getCode(), eEnum.getName(), reportCode,
				new ArrayList<>(), extension, 8, 8, null, null, ER2002PosRbAsrjs0103.getRequiredPos());
