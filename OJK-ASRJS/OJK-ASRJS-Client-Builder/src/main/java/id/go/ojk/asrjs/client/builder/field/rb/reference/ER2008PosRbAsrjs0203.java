...
public enum ER2008PosRbAsrjs0203 implements IObject<KeyValueString> {
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER2008PosRbAsrjs0203 eEnum : ER2008PosRbAsrjs0203.values()) {
	...
	public static String getName() {
		return ER2008PosRbAsrjs0203.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER2008PosRbAsrjs0203.class.getSimpleName().substring(2, 6));
	}
