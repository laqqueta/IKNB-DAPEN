...
public enum ER3012PosLbAsrjs600 implements IObject<KeyValueString> {
...
//	R_7004070000 ("7004070000", "II. Bukan Investasi"),
	...
	R_1400000000 ("1400000000", "Tagihan Kontribusi  Koasuransi"),
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER3012PosLbAsrjs600 eEnum : ER3012PosLbAsrjs600.values()) {
	...
	public static ConditionalRequired genConditional5() {
		return UtilFieldConditional.genExistPos("M", "N", UtilMetadata.genPipeRowExcept(getObjects(), new int[] { 17, 26 }));
	}
	...
	public static SegmentValidation genValidationJumlahBukanInvestasi() {
		return UtilSegmentValidation.genEqualsFormula(UtilMetadata.genPipeColumn(2, 8), R_7002000098.key, 
				UtilMetadata.genPlusRow(getObjects(), 19, 26), "Jumlah Bukan Investasi|Penjumlahan Bukan Investasi");
	}
	...
	public static SegmentValidation genValidationJumlahAset() {
		return UtilSegmentValidation.genEqualsFormula(UtilMetadata.genPipeColumn(2, 8), R_7007010000.key, 
				UtilMetadata.genPlusRow(getObjects(), new int[] { 18, 27 }), "Jumlah Aset|Penjumlahan Aset");
	}
}
