...
public enum ER3019PosLbAsrjs211 implements IObject<KeyValueString> {
...
//	R_2111000002 ("2111000002", "Deposito Berjangka dan Sertifikat Deposito", "0"),
	...
	R_2111000010 ("2111000010", "Sukuk / Obligasi Korporasi Syariah", "0"),
	...
	R_2111000016 ("2111000016", "MTN Syariah", "0"),
	...
	R_2111000048 ("2111000048", "c. Peringkat klaster 3", "40.00"),
	R_2111000049 ("2111000049", "d. Peringkat klaster 4", "60.00"),
	...
	R_2111000065 ("2111000065", "Tagihan Klaim Reasuransi ", "0.00"),
	R_2111000066 ("2111000066", "Dalam Negeri", "2.80"),
	R_2111000067 ("2111000067", "Luar Negeri:", "0.00"),
	R_2111000068 ("2111000068", "a. Peringkat klaster 1", "2.80"),
	R_2111000069 ("2111000069", "b. Peringkat klaster 2", "4.00"),
	R_2111000070 ("2111000070", "c. Peringkat klaster 3", "6.00"),
	R_2111000071 ("2111000071", "d. Peringkat klaster 4", "12.00"),
	R_2111000072 ("2111000072", "e. Peringkat klaster 5", "15.00"),
	R_2111000073 ("2111000073", "Tagihan Investasi", "0.00"),
	R_2111000074 ("2111000074", "a. Investasi yang belum diterima pembayarannya pada tanggal jatuh tempo", "2.00"),
	R_2111000075 ("2111000075", "b. Investasi yang gagal bayar pada tanggal jatuh tempo/saat dicairkan", "25.00"),
	R_2111000076 ("2111000076", "Tagihan Hasil Investasi", "2.00"),
	R_2111000077 ("2111000077", "Total", "0.00"),
	;
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER3019PosLbAsrjs211 eEnum : ER3019PosLbAsrjs211.values()) {
	...
	public static ConditionalRequired genConditional5() {
		return UtilFieldConditional.genExistPos("M", "N", 
				UtilMetadata.genPipeRowExcept(getObjects(), new int[] { 0, 2, 8, 14, 22, 30, 35, 36, 39, 43, 49, 52, 55, 57, 63, 65, 71, 75 }));
	}
	
	public static FieldValidation genValidation5() {
		return UtilFieldValidation.genPosLookup("1", UtilMetadata.genPipeRowExcept(getObjects(), new int[] { 0, 2, 8, 14, 22, 30, 35, 36, 39, 43, 49, 52, 55, 57, 63, 65, 71, 75 }), 
				getLookup());
	}
	...
	public static FieldValidation genValidation6() {
		return UtilFieldValidation.genPosPercentage("2|5", UtilMetadata.genPipeRowExcept(getObjects(), 
				new int[] { 0, 2, 8, 14, 22, 30, 35, 36, 39, 43, 49, 52, 55, 57, 63, 65, 71, 75 }), 0);
	}
	...
	public static SegmentValidation genValidationBukanInvestasi() {
		return UtilSegmentValidation.genEqualsFormula(UtilMetadata.genPipeColumn(new int[] { 2, 3, 4, 6, 7, 8 }), 
				R_2111000051.key, UtilMetadata.genPlusRow(getObjects(), new int[] { 50, 51, 52, 55, 63, 71, 74 }), 
	...
	public static SegmentValidation genValidationTotal() {
		return UtilSegmentValidation.genEqualsFormula(UtilMetadata.genPipeColumn(new int[] { 2, 3, 4, 6, 7, 8 }), 
				R_2111000077.key, UtilMetadata.genPlusRow(getObjects(), new int[] { 0, 49 }), "Total|Penjumlahan Detail");
	}

	private static String getLookup() {
		StringBuilder res = new StringBuilder();
		ER3019PosLbAsrjs211[] eEnums = ER3019PosLbAsrjs211.values();
		int enumLength = eEnums.length;
		for (int i= 0; i < enumLength; i++) {
			ER3019PosLbAsrjs211 eEnum = ER3019PosLbAsrjs211.values()[i];
