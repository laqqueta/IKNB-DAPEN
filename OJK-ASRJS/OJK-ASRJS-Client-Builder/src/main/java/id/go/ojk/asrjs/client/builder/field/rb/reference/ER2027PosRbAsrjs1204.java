...
public enum ER2027PosRbAsrjs1204 implements IObject<KeyValueString> {
...
//	R_12040200000000 ("12040200000000", "BEBAN USAHA:"),
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER2027PosRbAsrjs1204 eEnum : ER2027PosRbAsrjs1204.values()) {
	...
	public static String getName() {
		return ER2027PosRbAsrjs1204.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER2027PosRbAsrjs1204.class.getSimpleName().substring(2, 6));
	}
