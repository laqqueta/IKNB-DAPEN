...
public enum ER2037PosReAsrjs0101 implements IObject<KeyValueString> {
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER2037PosReAsrjs0101 eEnum : ER2037PosReAsrjs0101.values()) {
	...
	public static String getName() {
		return ER2037PosReAsrjs0101.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER2037PosReAsrjs0101.class.getSimpleName().substring(2, 6));
	}
	...
	public static SegmentValidation genValidationAsetB() {
		return UtilSegmentValidation.genEqualsFormula("2|3", R_01010100000000.key, R_01010200000000.key, 
