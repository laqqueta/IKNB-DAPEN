...
import id.go.ojk.asrjs.client.builder.field.rb.reference.ER2006PosRbAsrjs0201;
...
public class Rb0201 extends BaseMetadata {
	...
	public SubmissionFormat get() {
		...
		SubmissionFormat res = new SubmissionFormat(eEnum.getCode(), eEnum.getName(), reportCode,
				...
				ER2006PosRbAsrjs0201.getRequiredPos());
		res.addSegmentValidations(ER2006PosRbAsrjs0201.genValidationNumeric());
		res.addSegmentValidations(ER2006PosRbAsrjs0201.genValidationNumericDot());
		...
		fs.add(sf(2, null, "Indikator Lain", sv(C, 0, 200, all)
				.confConditionalRequired(ER2006PosRbAsrjs0201.genConditionalField())));
		...
		fs.add(sf(5, null, "%", sv(M, 0, 16, numericDotNegatif))
				.addFieldValidations(ER2006PosRbAsrjs0201.genValidationRatioField()));
		return res;
	}
}
