...
public enum ER2002PosRbAsrjs0103 implements IObject<KeyValueString> {
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER2002PosRbAsrjs0103 eEnum : ER2002PosRbAsrjs0103.values()) {
	...
	public static String getName() {
		return ER2002PosRbAsrjs0103.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER2002PosRbAsrjs0103.class.getSimpleName().substring(2, 6));
	}
