...
import id.go.ojk.asrjs.client.builder.field.lb.reference.ER3011PosLbAsrjs501;
...
public class Lb501 extends BaseMetadata {
	...
	public SubmissionFormat get() {
		...
		SubmissionFormat res = new SubmissionFormat(eEnum.getCode(), eEnum.getName(), reportCode,
				new ArrayList<>(), extension, 4, 4, ER3011PosLbAsrjs501.genFieldSave(), null,
				ER3011PosLbAsrjs501.getRequiredPos());
		res.addSegmentValidations(ER3011PosLbAsrjs501.genValidationJumlahKewajiban());
		...
		fs.add(sf(4, null, "Selisih Penilaian SAK dan SAP", sv(M, 1, 16, numericNegatif))
				.addFieldValidations(ER3011PosLbAsrjs501.genFieldValidation4()));
		return res;
	}
}
