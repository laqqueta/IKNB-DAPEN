...
public enum ER2004PosRbAsrjs0105 implements IObject<KeyValueString> {
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER2004PosRbAsrjs0105 eEnum : ER2004PosRbAsrjs0105.values()) {
	...
	public static String getName() {
		return ER2004PosRbAsrjs0105.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER2004PosRbAsrjs0105.class.getSimpleName().substring(2, 6));
	}
