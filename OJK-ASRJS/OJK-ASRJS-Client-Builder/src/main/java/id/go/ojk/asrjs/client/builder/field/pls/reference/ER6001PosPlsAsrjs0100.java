...
public enum ER6001PosPlsAsrjs0100 implements IObject<KeyValueString> {
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER6001PosPlsAsrjs0100 eEnum : ER6001PosPlsAsrjs0100.values()) {
	...
	public static String getName() {
		return ER6001PosPlsAsrjs0100.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER6001PosPlsAsrjs0100.class.getSimpleName().substring(2, 6));
	}
  ...
  public static String getUniquePos() {
	...
	public static SegmentValidation genValidationTotal() {
		return UtilSegmentValidation.genEqualsFormula(UtilMetadata.genPipeColumn(13, 26), R_0010020000.key, 
