...
public enum ER2026PosRbAsrjs1203 implements IObject<KeyValueString> {
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER2026PosRbAsrjs1203 eEnum : ER2026PosRbAsrjs1203.values()) {
	...
	public static String getName() {
		return ER2026PosRbAsrjs1203.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER2026PosRbAsrjs1203.class.getSimpleName().substring(2, 6));
	}
	...
	public static SegmentValidation genValidationAsetB() {
		return UtilSegmentValidation.genEqualsFormula("2|3|4|5", R_12030100000000.key, R_12030200000000.key, 
