...
public enum ER2046PosReAsrjs0401 implements IObject<KeyValueString> {
...
//	R_04010204000000 ("04010204000000", "D.   Rasio Aset Unit Syariah"),
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER2046PosReAsrjs0401 eEnum : ER2046PosReAsrjs0401.values()) {
	...
	public static String getName() {
		return ER2046PosReAsrjs0401.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER2046PosReAsrjs0401.class.getSimpleName().substring(2, 6));
	}
	...
	public static SegmentValidation genValidationAsetYgTersediaUntukQardhYgDiperhitungkanSebagaiPenambahAYDDanaTabarruDanTanahud() {
		return UtilSegmentValidation.genMaxValue("2|3", R_04010106000000.key,
	...
	public static SegmentValidation genValidationKekuranganTingkatSolvabilitasDariTargetInternal() {
		return UtilSegmentValidation.genMaxValue2("2|3", R_04010106010000.key,
				R_04010104000000.key + "-" + R_04010103000000.key + "*" + R_04010102000000.key, ".01", "0",
	...
	public static SegmentValidation genValidationRasioTingkatSolvabilitasDanaPerusahaan() {
		return UtilSegmentValidation.genEqualsRatio("2|3", R_04010107000000.key,
				UtilMetadata.genPlusRow(getObjects(), new int[] { 0, 7 }) + "|" + R_04010102000000.key, 
