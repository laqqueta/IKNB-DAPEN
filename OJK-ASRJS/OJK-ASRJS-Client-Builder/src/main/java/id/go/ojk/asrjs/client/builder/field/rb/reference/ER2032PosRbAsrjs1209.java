...
public enum ER2032PosRbAsrjs1209 implements IObject<KeyValueString> {
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER2032PosRbAsrjs1209 eEnum : ER2032PosRbAsrjs1209.values()) {
	...
	public static String getName() {
		return ER2032PosRbAsrjs1209.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER2032PosRbAsrjs1209.class.getSimpleName().substring(2, 6));
	}
