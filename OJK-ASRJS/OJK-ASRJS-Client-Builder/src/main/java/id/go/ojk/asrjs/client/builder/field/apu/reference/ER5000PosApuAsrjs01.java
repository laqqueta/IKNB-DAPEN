package id.go.ojk.asrjs.client.builder.field.apu.reference;
...
public enum ER5000PosApuAsrjs01 implements IObject<KeyValueString> {
...
//	R_0105010000 ("0105010000", "Kategorisasi Produk"),
	...
	R_0105010200 ("0105010200", "2. Pinjaman Polis"),
//	R_0106000000 ("0106000000", "VI. Kategorisasi Risiko"),
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER5000PosApuAsrjs01 eEnum : ER5000PosApuAsrjs01.values()) {
	...
	public static String getName() {
		return ER5000PosApuAsrjs01.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER5000PosApuAsrjs01.class.getSimpleName().substring(2, 6));
	}
