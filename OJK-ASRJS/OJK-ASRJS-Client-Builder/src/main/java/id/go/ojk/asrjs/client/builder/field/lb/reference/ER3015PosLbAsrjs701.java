...
public enum ER3015PosLbAsrjs701 implements IObject<KeyValueString> {
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER3015PosLbAsrjs701 eEnum : ER3015PosLbAsrjs701.values()) {
	...
	public static SegmentValidation genValidationJumlahLiabilitas() {
		return UtilSegmentValidation.genEqualsFormula(UtilMetadata.genPipeColumn(2, 4), R_7301020103.key, UtilMetadata.genPlusRow(getObjects(), 0, 2), 
