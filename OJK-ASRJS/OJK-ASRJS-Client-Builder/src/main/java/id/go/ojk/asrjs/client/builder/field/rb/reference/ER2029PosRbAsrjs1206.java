...
public enum ER2029PosRbAsrjs1206 implements IObject<KeyValueString> {
...
//	R_12060102010000 ("12060102010000", "Beban Klaim"),
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER2029PosRbAsrjs1206 eEnum : ER2029PosRbAsrjs1206.values()) {
	...
	public static String getName() {
		return ER2029PosRbAsrjs1206.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER2029PosRbAsrjs1206.class.getSimpleName().substring(2, 6));
	}
