...
public enum ER3017PosLbAsrjs111 implements IObject<KeyValueString> {
...
//	R_2502040000 ("2502040000", "Rasio Aset Unit Syariah"),
	R_2502050000 ("2502050000", "A. Aset Dana Tabarru dan Dana Tanahud"),
...
//	R_2502120001 ("2502120001", "Penghitungan Qardh yang Diperlukan Dana Tanahud"),
	R_2502120002 ("2502120002", "A. Jumlah Kewajiban selain Qardh"),
	R_2502120003 ("2502120003", "B. Jumlah Aset"),
	R_2502120004 ("2502120004", "Jumlah Qardh yang Diperlukan (a-b)"),
	;
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER3017PosLbAsrjs111 eEnum : ER3017PosLbAsrjs111.values()) {
	...
	public static ConditionalRequired genConditional3() {
		return UtilFieldConditional.genExistPos("M", "N", UtilMetadata.genPipeRowExcept(getObjects(), new int[] { 3, 4, 5, 6, 10, 11, 12, 21, 22, 23, 24, 25, 26 }));
	}
	...
	public static ConditionalRequired genConditional5() {
		return UtilFieldConditional.genExistPos("M", "N", UtilMetadata.genPipeRowExcept(getObjects(), new int[] { 21, 22, 23, 24, 25, 26 }));
	}
	...
	public static FieldValidation genFieldValidation5() {
		return UtilFieldValidation.genEqualsPosFormula(UtilMetadata.genPlusColumn(2, 4), 
				UtilMetadata.genPipeRow(getObjects(), new int[] { 0, 1, 3, 4, 5, 7, 8, 10, 11, 13, 14, 17, 18, 19 }));
	}
	...
	public static SegmentValidation genValidationNumericNegative() {
		return UtilSegmentValidation.genRegexNumericNegative(UtilMetadata.genPipeColumn(2, 5), 
				UtilMetadata.genPipeRowExcept(getObjects(), new int[] { 2, 6, 9, 12, 16, 20 }));
	}
	...
	public static SegmentValidation genValidationNumericDotNegative() {
		return UtilSegmentValidation.genRegexNumericDotNegative(UtilMetadata.genPipeColumn(2, 5), 
				UtilMetadata.genPipeRow(getObjects(), new int[] { 2, 6, 9, 12, 16, 20 }));
	}
	...
	public static SegmentValidation genValidationPenghitunganQardhYangDiperlukanDanaTabarru() {
		return UtilSegmentValidation.genMaxValue("2", R_2502120000.key, 
				UtilMetadata.genMinusRow(getObjects(), 21, 22), "0", 
				"perhitungan Qardh yang Diperlukan Dana Tabarru");
	}
	
	public static SegmentValidation genValidationPenghitunganQardhYangDiperlukanDanaTanahud() {
		return UtilSegmentValidation.genEqualsFormula("2", R_2502120004.key, 
				UtilMetadata.genMinusRow(getObjects(), 24, 25), 
				"Jumlah Qardh yang Diperlukan Dana Tanahud (a-b)|Perhitungan Qardh yang Diperlukan Dana Tanahud");
	}
}
