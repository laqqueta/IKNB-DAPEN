...
public enum ER3004PosLbAsrjs004 implements IObject<KeyValueString> {
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER3004PosLbAsrjs004 eEnum : ER3004PosLbAsrjs004.values()) {
	...
	public static SegmentValidation genValidationNumericDot() {
		return UtilSegmentValidation.genRegexNumericDot("2|3", UtilMetadata.genPipeRow(getObjects(), new int[] { 7 }));
	}
