...
import id.go.ojk.asrjs.client.builder.field.lb.reference.ER3013PosLbAsrjs601;
...
public class Lb601 extends BaseMetadata {
	...
	public SubmissionFormat get() {
		...
		SubmissionFormat res = new SubmissionFormat(eEnum.getCode(), eEnum.getName(), reportCode,
				new ArrayList<>(), extension, 6, 6, ER3013PosLbAsrjs601.genFieldSave(), null,
				ER3013PosLbAsrjs601.getRequiredPos());
		res.addSegmentValidations(ER3013PosLbAsrjs601.genValidationJumlahLiabilitas());
		...
		fs.add(sf(4, null, "Selisih Penilaian SAK dan SAP", sv(M, 1, 16, numericNegatif))
				.addFieldValidations(ER3013PosLbAsrjs601.genValidation4()));
		return res;
	}
}
