...
import id.go.ojk.asrjs.client.builder.field.lb.reference.ER3014PosLbAsrjs700;
...
public class Lb700 extends BaseMetadata {
	...
	public SubmissionFormat get() {
		...
		SubmissionFormat res = new SubmissionFormat(eEnum.getCode(), eEnum.getName(), reportCode,
				new ArrayList<>(), extension, 33, 33, ER3014PosLbAsrjs700.genFieldSave(), null,
				ER3014PosLbAsrjs700.getRequiredPos());
		res.addSegmentValidations(ER3014PosLbAsrjs700.genValidationJumlahInvestasi());
		res.addSegmentValidations(ER3014PosLbAsrjs700.genValidationJumlahBukanInvestasi());
		res.addSegmentValidations(ER3014PosLbAsrjs700.genValidationJumlahKekayaan());
		...
		fs.add(sf(3, null, "Penilaian Berdasarkan SAP",
				sv(C, 1, 16, numericNegatif).confConditionalRequired(ER3014PosLbAsrjs700.genConditional3())));
		fs.add(sf(4, null, "Selisih Penilaian Berdasarkan SAK dan SAP", sv(M, 1, 16, numericNegatif))
				.addFieldValidations(ER3014PosLbAsrjs700.genValidation4()));
