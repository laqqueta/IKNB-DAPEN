...
public enum ER2031PosRbAsrjs1208 implements IObject<KeyValueString> {
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER2031PosRbAsrjs1208 eEnum : ER2031PosRbAsrjs1208.values()) {
	...
	public static String getName() {
		return ER2031PosRbAsrjs1208.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER2031PosRbAsrjs1208.class.getSimpleName().substring(2, 6));
	}
