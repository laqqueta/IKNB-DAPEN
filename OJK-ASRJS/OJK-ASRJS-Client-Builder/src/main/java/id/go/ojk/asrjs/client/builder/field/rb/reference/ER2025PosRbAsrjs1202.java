...
public enum ER2025PosRbAsrjs1202 implements IObject<KeyValueString> {
	...
	R_12020101080000 ("12020101080000", "8.    Surat Berharga Syariah yang Diterbitkan oleh Negara Selain Negara Republik Indonesia "),
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER2025PosRbAsrjs1202 eEnum : ER2025PosRbAsrjs1202.values()) {
	...
	public static String getName() {
		return ER2025PosRbAsrjs1202.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER2025PosRbAsrjs1202.class.getSimpleName().substring(2, 6));
	}
	...
	public static SegmentValidation genValidationAsetA() {
		return UtilSegmentValidation.genEqualsFormula("2|3|4|5", R_12020100000000.key,
				R_12020101000000.key + "+" + R_12020102000000.key, 
				"Total Aset|Penjumlahan Investasi dan Bukan Investasi");
	}
	...
	public static SegmentValidation genValidationEkuitasDana() {
		return UtilSegmentValidation.genEqualsFormula("2|3|4|5", R_12020203000000.key,
				R_12020203010000.key + "+" + R_12020203020000.key, 
				"Total Ekuitas Dana|Penjumlahan Ekuitas Dana");
	}

	public static SegmentValidation genValidationAsetB() {
		return UtilSegmentValidation.genEqualsFormula("2|3|4|5", R_12020100000000.key, R_12020200000000.key, 
