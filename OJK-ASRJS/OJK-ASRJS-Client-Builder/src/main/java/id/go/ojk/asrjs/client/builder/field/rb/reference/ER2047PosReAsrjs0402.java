...
public enum ER2047PosReAsrjs0402 implements IObject<KeyValueString> {
...
//	R_04020207000000 ("04020207000000", "G.   Penghitungan Qardh yang Diperlukan Dana Tanahud"),
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER2047PosReAsrjs0402 eEnum : ER2047PosReAsrjs0402.values()) {
	...
	public static String getName() {
		return ER2047PosReAsrjs0402.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER2047PosReAsrjs0402.class.getSimpleName().substring(2, 6));
	}
	...
	public static SegmentValidation genValidationAsetYgTersediaUntukQardhYgDiperhitungkanSebagaiPenambahAYDDanaTabarruDanTanahud() {
		return UtilSegmentValidation.genMaxValue("2|3", R_04020106000000.key,
	...
	public static SegmentValidation genValidationKekuranganTingkatSolvabilitasDariTargetInternal() {
		return UtilSegmentValidation.genMaxValue2("2|3", R_04020106010000.key,
				R_04020104000000.key + "-" + R_04020103000000.key + "*" + R_04020102000000.key, ".01", "0",
	...
	public static SegmentValidation genValidationRasioTingkatSolvabilitasDanaPerusahaan() {
		return UtilSegmentValidation.genEqualsRatio("2|3", R_04020107000000.key,
				UtilMetadata.genPlusRow(getObjects(), new int[] { 0, 7 }) + "|" + R_04020102000000.key, 
