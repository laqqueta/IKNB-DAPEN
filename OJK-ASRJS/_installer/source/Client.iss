...
[Setup]
AppId=ASRJSClient
AppName=ASRJS Client
AppVersion=3.3.3
AppVerName=ASRJS-Client 3.3.3
AppPublisher=OJK
AppComments=OJK ASRJS Client
AppCopyright=Copyright (C) 2020
;AppPublisherURL=http://java.com/
;AppSupportURL=http://java.com/
;AppUpdatesURL=http://java.com/
DefaultDirName=C:\OJK-ASRJS-Client
...
[Setup]
SetupMutex=ASRJS-Client,Global\ASRJS-Client
OutputDir="..\ftp\app"

[Icons]
Name: "{group}\ASRJS-Client"; Filename: "{app}\OjkClient.exe"; IconFilename: "{app}\Client.ico"; Check: returnTrue()
Name: "{commondesktop}\AsrjsClient"; Filename: "{app}\OjkClient.exe";  IconFilename: "{app}\Client.ico"; Check: returnFalse()    

[Run]
Filename: "{app}\OjkClient.exe"; Parameters: "-Xappcds:generatecache"; Check: returnFalse()
Filename: "{app}\OjkClient.exe"; Description: "{cm:LaunchProgram,ASRJSClient}"; Flags: nowait postinstall skipifsilent; Check: returnTrue()
Filename: "{app}\OjkClient.exe"; Parameters: "-install -svcName ""ASRJSClient"" -svcDesc ""ASRJSClient"" -mainExe ""OjkClient.exe""  "; Check: returnFalse()

[UninstallRun]
Filename: "{app}\OjkClient.exe "; Parameters: "-uninstall -svcName ASRJSClient -stopOnUninstall"; Check: returnFalse()
