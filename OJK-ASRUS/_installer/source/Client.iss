...
[Setup]
AppId=ASRUSClient
AppName=ASRUS Client
AppVersion=3.3.3
AppVerName=ASRUS-Client 3.3.3
AppPublisher=OJK
AppComments=OJK ASRUS Client
AppCopyright=Copyright (C) 2020
;AppPublisherURL=http://java.com/
;AppSupportURL=http://java.com/
;AppUpdatesURL=http://java.com/
DefaultDirName=C:\OJK-ASRUS-Client
...
[Setup]
SetupMutex=ASRUS-Client,Global\ASRUS-Client
OutputDir="..\ftp\app"

[Icons]
Name: "{group}\ASRUS-Client"; Filename: "{app}\OjkClient.exe"; IconFilename: "{app}\Client.ico"; Check: returnTrue()
Name: "{commondesktop}\AsrusClient"; Filename: "{app}\OjkClient.exe";  IconFilename: "{app}\Client.ico"; Check: returnFalse()    

[Run]
Filename: "{app}\OjkClient.exe"; Parameters: "-Xappcds:generatecache"; Check: returnFalse()
Filename: "{app}\OjkClient.exe"; Description: "{cm:LaunchProgram,ASRUSClient}"; Flags: nowait postinstall skipifsilent; Check: returnTrue()
Filename: "{app}\OjkClient.exe"; Parameters: "-install -svcName ""ASRUSClient"" -svcDesc ""ASRUSClient"" -mainExe ""OjkClient.exe""  "; Check: returnFalse()

[UninstallRun]
Filename: "{app}\OjkClient.exe "; Parameters: "-uninstall -svcName ASRUSClient -stopOnUninstall"; Check: returnFalse()
