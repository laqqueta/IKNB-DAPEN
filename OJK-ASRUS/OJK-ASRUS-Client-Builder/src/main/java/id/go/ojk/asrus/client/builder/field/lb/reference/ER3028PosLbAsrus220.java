...
public enum ER3028PosLbAsrus220 implements IObject<KeyValueString> {
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER3028PosLbAsrus220 eEnum : ER3028PosLbAsrus220.values()) {
	...
	private static String getLookup() {
		...
		ER3028PosLbAsrus220[] eEnums = ER3028PosLbAsrus220.values();
		int enumLength = eEnums.length;
		for (int i= 0; i < enumLength; i++) {
			ER3028PosLbAsrus220 eEnum = ER3028PosLbAsrus220.values()[i];
