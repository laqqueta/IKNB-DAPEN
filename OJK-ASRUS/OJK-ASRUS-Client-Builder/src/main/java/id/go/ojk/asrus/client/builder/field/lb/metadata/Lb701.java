...
import id.go.ojk.asrus.client.builder.field.lb.reference.ER3015PosLbAsrus701;
...
public class Lb701 extends BaseMetadata {
	...
	public SubmissionFormat get() {
		...
		SubmissionFormat res = new SubmissionFormat(eEnum.getCode(), eEnum.getName(), reportCode,
				new ArrayList<>(), extension, 4, 4, ER3015PosLbAsrus701.genFieldSave(), null,
				ER3015PosLbAsrus701.getRequiredPos());
		res.addSegmentValidations(ER3015PosLbAsrus701.genValidationJumlahLiabilitas());
		...
		fs.add(sf(4, null, "Selisih Penilaian SAK dan SAP", sv(M, 1, 16, numericNegatif))
				.addFieldValidations(ER3015PosLbAsrus701.genFieldValidation4()));
		return res;
	}
}
