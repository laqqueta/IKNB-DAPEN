...
public enum ER2030PosRbAsrus1207 implements IObject<KeyValueString> {
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER2030PosRbAsrus1207 eEnum : ER2030PosRbAsrus1207.values()) {
	...
	public static String getName() {
		return ER2030PosRbAsrus1207.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER2030PosRbAsrus1207.class.getSimpleName().substring(2, 6));
	}
