...
import id.go.ojk.asrus.client.builder.field.rb.reference.ER2001PosRbAsrus0102;
...
public class Rb0102 extends BaseMetadata {
	...
	public SubmissionFormat get() {
		...
		SubmissionFormat res = new SubmissionFormat(eEnum.getCode(), eEnum.getName(), reportCode,
				new ArrayList<>(), extension, 10, 10, null, null, ER2001PosRbAsrus0102.getRequiredPos());
