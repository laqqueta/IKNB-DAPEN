...
public enum ER2026PosRbAsrus1203 implements IObject<KeyValueString> {
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER2026PosRbAsrus1203 eEnum : ER2026PosRbAsrus1203.values()) {
	...
	public static String getName() {
		return ER2026PosRbAsrus1203.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER2026PosRbAsrus1203.class.getSimpleName().substring(2, 6));
	}
