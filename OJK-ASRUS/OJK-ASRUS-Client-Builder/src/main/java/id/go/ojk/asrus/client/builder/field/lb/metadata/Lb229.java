...
import id.go.ojk.asrus.client.builder.field.lb.reference.ER3037PosLbAsrus229;
...
public class Lb229 extends BaseMetadata {
	...
	public SubmissionFormat get() {
		...
		SubmissionFormat res = new SubmissionFormat(eEnum.getCode(), eEnum.getName(), reportCode,
				new ArrayList<>(), extension, 17, 17, ER3037PosLbAsrus229.genFieldSave(), null,
				ER3037PosLbAsrus229.getRequiredPos());
		res.addSegmentValidations(ER3037PosLbAsrus229.genValidationTotal());
		...
		fs.add(sf(5, null, "Jumlah Penyisihan Klaim", sv(M, 1, 16, numericNegatif))
				.addFieldValidations(ER3037PosLbAsrus229.genFieldValidation5()));
		return res;
	}
}
