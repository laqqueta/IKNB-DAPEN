...
public enum ER2025PosRbAsrus1202 implements IObject<KeyValueString> {
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER2025PosRbAsrus1202 eEnum : ER2025PosRbAsrus1202.values()) {
	...
	public static String getName() {
		return ER2025PosRbAsrus1202.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER2025PosRbAsrus1202.class.getSimpleName().substring(2, 6));
	}
