...
public enum ER2048PosReAsrus0403 implements IObject<KeyValueString> {
...
//	R_04030300000000 ("04030300000000", "III.        Rasio perubahan dana"),
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER2048PosReAsrus0403 eEnum : ER2048PosReAsrus0403.values()) {
	...
	public static String getName() {
		return ER2048PosReAsrus0403.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER2048PosReAsrus0403.class.getSimpleName().substring(2, 6));
	}
