...
public enum ER2045PosReAsrus0303 implements IObject<KeyValueString> {
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER2045PosReAsrus0303 eEnum : ER2045PosReAsrus0303.values()) {
	...
	public static String getName() {
		return ER2045PosReAsrus0303.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER2045PosReAsrus0303.class.getSimpleName().substring(2, 6));
	}
