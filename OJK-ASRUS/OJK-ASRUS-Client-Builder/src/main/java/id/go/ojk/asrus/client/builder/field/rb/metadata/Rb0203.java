...
import id.go.ojk.asrus.client.builder.field.rb.reference.ER2008PosRbAsrus0203;
...
public class Rb0203 extends BaseMetadata {
	...
	public SubmissionFormat get() {
		...
		SubmissionFormat res = new SubmissionFormat(eEnum.getCode(), eEnum.getName(), reportCode,
				...
				ER2008PosRbAsrus0203.getRequiredPos());
		res.addSegmentValidations(ER2008PosRbAsrus0203.genValidationNumeric());
		res.addSegmentValidations(ER2008PosRbAsrus0203.genValidationNumericDot());
		...
		fs.add(sf(2, null, "Indikator Lain",
				sv(C, 0, 200, all).confConditionalRequired(ER2008PosRbAsrus0203.genConditionalField2())));
		...
		fs.add(sf(5, null, "%", sv(M, 0, 16, numericDotNegatif))
				.addFieldValidations(ER2008PosRbAsrus0203.genValidationRatioField()));
		return res;
	}
}
