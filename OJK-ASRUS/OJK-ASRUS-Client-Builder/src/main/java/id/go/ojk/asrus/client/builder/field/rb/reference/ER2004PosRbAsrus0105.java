...
public enum ER2004PosRbAsrus0105 implements IObject<KeyValueString> {
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER2004PosRbAsrus0105 eEnum : ER2004PosRbAsrus0105.values()) {
	...
	public static String getName() {
		return ER2004PosRbAsrus0105.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER2004PosRbAsrus0105.class.getSimpleName().substring(2, 6));
	}
