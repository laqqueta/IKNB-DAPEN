...
import id.go.ojk.asrus.client.builder.field.lb.reference.ER3041PosLbAsrus233;
...
public class Lb233 extends BaseMetadata {
	...
	public SubmissionFormat get() {
		...
		fs.add(sf(3, null, "Lokasi", sv(C, 1, 4, refTable).confReference(EHeaderMetadataShared.R013.getObject())
				.confConditionalRequired(ER3041PosLbAsrus233.genConditional())));
		...
		fs.add(sf(6, null, "Jumlah",
				sv(C, 1, 16, numericNegatif).confConditionalRequired(ER3041PosLbAsrus233.genConditional())));
