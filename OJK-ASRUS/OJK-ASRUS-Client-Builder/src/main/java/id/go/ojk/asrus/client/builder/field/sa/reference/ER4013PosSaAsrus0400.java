...
public enum ER4013PosSaAsrus0400 implements IObject<KeyValueString> {
...
//	R_04000200000000 ("04000200000000", "Tabel IV.B: Peringkat Faktor Permodalan"),
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER4013PosSaAsrus0400 eEnum : ER4013PosSaAsrus0400.values()) {
	...
	public static SegmentValidation genValidationPeringkat2() {
		return UtilSegmentValidation.genFixedValueOptional("2", UtilMetadata.genPipeRow(getObjects(), new int[] { 8 }), ER1099Peringkat.getPipedKey());
	}
}
