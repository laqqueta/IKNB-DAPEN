...
public enum ER2029PosRbAsrus1206 implements IObject<KeyValueString> {
...
//	R_12060102010000 ("12060102010000", "Beban Klaim"),
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER2029PosRbAsrus1206 eEnum : ER2029PosRbAsrus1206.values()) {
	...
	public static String getName() {
		return ER2029PosRbAsrus1206.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER2029PosRbAsrus1206.class.getSimpleName().substring(2, 6));
	}
	...
	public static SegmentValidation genValidationLabaUsahaAsuransi() {
		return UtilSegmentValidation.genEqualsFormula("2|3|4|5", R_12060103000000.key,
				R_12060102010300.key + "+" + R_12060102020000.key, 
