...
import id.go.ojk.asrus.client.builder.field.lb.reference.ER3011PosLbAsrus501;
...
public class Lb501 extends BaseMetadata {
	...
	public SubmissionFormat get() {
		...
		SubmissionFormat res = new SubmissionFormat(eEnum.getCode(), eEnum.getName(), reportCode,
				new ArrayList<>(), extension, 4, 4, ER3011PosLbAsrus501.genFieldSave(), null,
				ER3011PosLbAsrus501.getRequiredPos());
		res.addSegmentValidations(ER3011PosLbAsrus501.genValidationJumlahKewajiban());
		...
		fs.add(sf(4, null, "Selisih Penilaian SAK dan SAP", sv(M, 1, 16, numericNegatif))
				.addFieldValidations(ER3011PosLbAsrus501.genFieldValidation4()));
		return res;
	}
}
