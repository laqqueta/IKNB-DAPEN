...
public enum ER4008PosSaAsrus0208 implements IObject<KeyValueString> {
...
//	R_02080400000000 ("02080400000000", "Tabel II.H.4: Tingkat Risiko Inheren untuk Risiko Kepatuhan Konsolidasi"),
	R_02080401000000 ("02080401000000", "Tingkat Risiko Inheren untuk Risiko Kepatuhan "),
//	R_02080500000000 ("02080500000000", "Tabel II.H.5: Kualitas Penerapan Manajemen Risiko untuk Risiko Kepatuhan Konsolidasi"),
	R_02080501000000 ("02080501000000", "Kualitas Penerapan Manajemen Risiko untuk Risiko Kepatuhan "),
//	R_02080502000000 ("02080502000000", "Tingkat Risiko Kepatuhan "),
	R_02080503000000 ("02080503000000", "Tingkat Risiko Kepatuhan Net Risk"),
	R_02080600000000 ("02080600000000", "ANALISIS"),
	;
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER4008PosSaAsrus0208 eEnum : ER4008PosSaAsrus0208.values()) {
	...
	public static ConditionalRequired genConditional2() {
		return UtilFieldConditional.genExistPos("O", "M", UtilMetadata.genPipeRow(getObjects(), 14, 16));
	}
	
	public static SegmentValidation genValidationNumeric() {
		return UtilSegmentValidation.genRegexNumeric("2", UtilMetadata.genPipeRow(getObjects(), new int[] { 0, 1, 2, 3, 11, 12, 13, 14, 15, 16 }));
	}
	
	public static SegmentValidation genValidationMaxLengthNumeric1() {
		return UtilSegmentValidation.genMaxLength("2", UtilMetadata.genPipeRow(getObjects(), 0, 2), 10);
	}
	...
	public static SegmentValidation genValidationMaxLengthNumeric3() {
		return UtilSegmentValidation.genMaxLength("2", UtilMetadata.genPipeRow(getObjects(), 11, 16), 1);
	}
	...
	public static SegmentValidation genValidationPeringkat2() {
		return UtilSegmentValidation.genFixedValueOptional("2", UtilMetadata.genPipeRow(getObjects(), 14, 16), ER1099Peringkat.getPipedKey());
	}
}
