...
public enum ER2042PosReAsrus0203 implements IObject<KeyValueString> {
...
//	R_02030102010000 ("02030102010000", "Beban Klaim"),
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER2042PosReAsrus0203 eEnum : ER2042PosReAsrus0203.values()) {
	...
	public static String getName() {
		return ER2042PosReAsrus0203.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER2042PosReAsrus0203.class.getSimpleName().substring(2, 6));
	}
