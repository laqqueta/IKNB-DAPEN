...
import id.go.ojk.asrus.client.builder.field.rb.reference.ER2023PosRbAsrus1005;
...
public class Rb1005 extends BaseMetadata {
	...
	public SubmissionFormat get() {
		...
		fs.add(sf(3, null, "Kepemilikan (inhouse/ vendor)",
				sv(C, 0, 1000, all).confConditionalRequired(ER2023PosRbAsrus1005.genConditionalField())));
