...
public enum ER2031PosRbAsrus1208 implements IObject<KeyValueString> {
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER2031PosRbAsrus1208 eEnum : ER2031PosRbAsrus1208.values()) {
	...
	public static String getName() {
		return ER2031PosRbAsrus1208.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER2031PosRbAsrus1208.class.getSimpleName().substring(2, 6));
	}
