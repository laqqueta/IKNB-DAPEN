package id.go.ojk.asrus.client.builder.field.reference;
...
public enum EHeaderMetadataShared implements IObject<ReferenceMetadata> {
	...
	R028(ER1196JenisPolis.getRefNumber(), ER1196JenisPolis.getName(), ER1196JenisPolis.getObjects()),
	R029(ER1197JenisKelamin.getRefNumber(), ER1197JenisKelamin.getName(), ER1197JenisKelamin.getObjects()),
	R030(ER1198LokasiPemegangPolis.getRefNumber(), ER1198LokasiPemegangPolis.getName(),
			ER1198LokasiPemegangPolis.getObjects()),
	R031(ER1199LiniUsahaAsuransiJiwa.getRefNumber(), ER1199LiniUsahaAsuransiJiwa.getName(),
			ER1199LiniUsahaAsuransiJiwa.getObjects()),
	R032(ER1200LiniUsahaAsuransiUmum.getRefNumber(), ER1200LiniUsahaAsuransiUmum.getName(),
			ER1200LiniUsahaAsuransiUmum.getObjects()),
	R033(ER1201CaraBayar.getRefNumber(), ER1201CaraBayar.getName(), ER1201CaraBayar.getObjects()),
	R034(ER1202StatusPertanggungan.getRefNumber(), ER1202StatusPertanggungan.getName(),
			ER1202StatusPertanggungan.getObjects()),
	R035(ER1203JenisKlaimAsuransiJiwa.getRefNumber(), ER1203JenisKlaimAsuransiJiwa.getName(),
			ER1203JenisKlaimAsuransiJiwa.getObjects()),
	R036(ER1204JenisKlaimAsuransiUmum.getRefNumber(), ER1204JenisKlaimAsuransiUmum.getName(),
