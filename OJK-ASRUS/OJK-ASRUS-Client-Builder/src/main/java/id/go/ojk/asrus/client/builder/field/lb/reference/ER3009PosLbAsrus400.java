...
public enum ER3009PosLbAsrus400 implements IObject<KeyValueString> {
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER3009PosLbAsrus400 eEnum : ER3009PosLbAsrus400.values()) {
	...
	public static ConditionalRequired genConditional3() {
		return UtilFieldConditional.genExistPos("M", "N", 
				UtilMetadata.genPipeRowExcept(getObjects(), new int[] { 3, 7, 9 }));
	}
	...
	public static SegmentValidation genValidationPenambahan() {
		return UtilSegmentValidation.genEqualsFormula(UtilMetadata.genPipeColumn(2, 5), R_3410000000.key, 
	...
	public static SegmentValidation genValidationPengurangan() {
		return UtilSegmentValidation.genEqualsFormula(UtilMetadata.genPipeColumn(2, 5), R_3411990100.key, 
	...
	public static SegmentValidation genValidationSaldoAkhirDana() {
		return UtilSegmentValidation.genEqualsFormula(UtilMetadata.genPipeColumn(2, 5), R_3412010000.key, 
				UtilMetadata.genPlusRow(getObjects(), 0, 1) + "-" + R_3411990100.key, 
