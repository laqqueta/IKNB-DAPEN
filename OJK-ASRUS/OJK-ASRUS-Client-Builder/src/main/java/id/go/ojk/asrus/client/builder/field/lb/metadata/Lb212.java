...
import id.go.ojk.asrus.client.builder.field.lb.reference.ER3020PosLbAsrus212;
...
public class Lb212 extends BaseMetadata {
	...
	public SubmissionFormat get() {
		...
		fs.add(sf(6, null, "Eksposur Reasuransi Netto ((2)-(3))", sv(M, 1, 16, numericNegatif))
				.addFieldValidations(ER3020PosLbAsrus212.genValidation6()));
		fs.add(sf(7, null, "Faktor", sv(M, 1, 6, numericDotNegatif))
				.addFieldValidations(ER3020PosLbAsrus212.genValidation7()));
		fs.add(sf(8, null, "Jumlah Deviasi", sv(M, 1, 19, numericNegatif))
				.addFieldValidations(ER3020PosLbAsrus212.genValidation8()));
		return res;
	}
}
