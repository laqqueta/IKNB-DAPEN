...
public enum ER6002PosPlsAsrus0200 implements IObject<KeyValueString> {
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER6002PosPlsAsrus0200 eEnum : ER6002PosPlsAsrus0200.values()) {
	...
	public static String getName() {
		return ER6002PosPlsAsrus0200.class.getSimpleName().substring(6);
	}

	public static int getRefNumber() {
		return Integer.parseInt(ER6002PosPlsAsrus0200.class.getSimpleName().substring(2, 6));
	}
	...
	public static SegmentValidation genValidation3() {
		return UtilSegmentValidation.genIsExistsFormDb("3", R_0020010000.key, EFormLaporanPolis.PLS_0100.getCode(),
				ER6001PosPlsAsrus0100.R_0010010000.getObject().getKey(), "2");
//		return UtilSegmentValidation.genIsExistsForm("3", R_0020010000.key, EFormLaporanPolis.PLS_0100.getCode(), "2");
	...
	public static SegmentValidation genValidation4() {
		return UtilSegmentValidation.genIsExistsFormDb("5", R_0020010000.key, EFormLaporanPolis.PLS_0100.getCode(),
				ER6001PosPlsAsrus0100.R_0010010000.getObject().getKey(), "7");
	}
}
