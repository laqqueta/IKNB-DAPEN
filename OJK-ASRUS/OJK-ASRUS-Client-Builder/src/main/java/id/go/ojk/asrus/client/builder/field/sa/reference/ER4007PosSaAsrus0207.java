...
public enum ER4007PosSaAsrus0207 implements IObject<KeyValueString> {
...
//	R_02070102000000 ("02070102000000", "II Kualitatif"),
...
//	R_02070302000000 ("02070302000000", "Tingkat Risiko Hukum"),
	R_02070303000000 ("02070303000000", "Tingkat Risiko Operasional Net Risk"),
//	R_02070400000000 ("02070400000000", "Tabel II.G.4: Tingkat Risiko Inheren untuk Risiko Hukum Konsolidasi"),
	R_02070401000000 ("02070401000000", "Tingkat Risiko Inheren untuk Risiko Hukum "),
//	R_02070500000000 ("02070500000000", "Tabel II.G.5: Kualitas Penerapan Manajemen Risiko untuk Risiko Hukum Konsolidasi"),
	R_02070501000000 ("02070501000000", "Kualitas Penerapan Manajemen Risiko untuk Risiko Hukum "),
//	R_02070502000000 ("02070502000000", "Tingkat Risiko Hukum "),
	R_02070503000000 ("02070503000000", "Tingkat Risiko Hukum Nett Risk"),
	R_02070600000000 ("02070600000000", "ANALISIS"),
	;
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER4007PosSaAsrus0207 eEnum : ER4007PosSaAsrus0207.values()) {
	...
	public static ConditionalRequired genConditional2() {
		return UtilFieldConditional.genExistPos("O", "M", UtilMetadata.genPipeRow(getObjects(), 9, 11));
	}
	...
	public static SegmentValidation genValidationNumeric() {
		return UtilSegmentValidation.genRegexNumeric("2", UtilMetadata.genPipeRow(getObjects(), new int[] { 2, 6, 7, 8, 9, 10, 11 }));
	}
	...
	public static SegmentValidation genValidationMaxLengthNumeric2() {
		return UtilSegmentValidation.genMaxLength("2", UtilMetadata.genPipeRow(getObjects(), 6, 11), 1);
	}
	...
	public static SegmentValidation genValidationPeringkat2() {
		return UtilSegmentValidation.genFixedValueOptional("2", UtilMetadata.genPipeRow(getObjects(), 9, 11), ER1099Peringkat.getPipedKey());
	}
}
