...
import id.go.ojk.asrus.client.builder.field.lb.reference.ER3022PosLbAsrus214;
...
public class Lb214 extends BaseMetadata {
	...
	public SubmissionFormat get() {
		...
		SubmissionFormat res = new SubmissionFormat(eEnum.getCode(), eEnum.getName(), reportCode,
				new ArrayList<>(), extension, 4, 4, ER3022PosLbAsrus214.genFieldSave(), null,
				ER3022PosLbAsrus214.getRequiredPos());
		res.addSegmentValidations(ER3022PosLbAsrus214.genValidationTotalRisikoPasar());
		...
		fs.add(sf(5, null, "Total", sv(M, 1, 16, numericNegatif))
				.addFieldValidations(ER3022PosLbAsrus214.genValidation5()));
		return res;
	}
}
