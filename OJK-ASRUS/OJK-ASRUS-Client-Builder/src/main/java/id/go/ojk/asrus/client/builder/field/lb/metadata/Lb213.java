...
import id.go.ojk.asrus.client.builder.field.lb.reference.ER3021PosLbAsrus213;
...
public class Lb213 extends BaseMetadata {
	...
	public SubmissionFormat get() {
		...
		SubmissionFormat res = new SubmissionFormat(eEnum.getCode(), eEnum.getName(), reportCode,
				new ArrayList<>(), extension, 55, 55, ER3021PosLbAsrus213.genFieldSave(), null,
				ER3021PosLbAsrus213.getRequiredPos());
		res.addSegmentValidations(ER3021PosLbAsrus213.genValidationAset());
		res.addSegmentValidations(ER3021PosLbAsrus213.genValidationInvestasi());
		res.addSegmentValidations(ER3021PosLbAsrus213.genValidationBukanInvestasi());
		res.addSegmentValidations(ER3021PosLbAsrus213.genValidationLiabilitas());
		res.addSegmentValidations(ER3021PosLbAsrus213.genValidationUtang());
		res.addSegmentValidations(ER3021PosLbAsrus213.genValidationPenyisihanTeknis());
		res.addSegmentValidations(ER3021PosLbAsrus213.genValidationSelisihLiabilitasDanAset());
		res.addSegmentValidations(ER3021PosLbAsrus213.genValidationDeviasi());
		...
		fs.add(sf(7, null, "Jumlah Dana Perusahaan", sv(M, 1, 16, numericNegatif))
				.addFieldValidations(ER3021PosLbAsrus213.genValidation7()));
		...
		fs.add(sf(13, null, "Jumlah Dana Tabarru'", sv(M, 1, 16, numericNegatif))
				.addFieldValidations(ER3021PosLbAsrus213.genValidation13()));
		...
		fs.add(sf(19, null, "Jumlah PAYDI (digaransi)", sv(M, 1, 16, numericNegatif))
				.addFieldValidations(ER3021PosLbAsrus213.genValidation19()));
		return res;
	}
}
