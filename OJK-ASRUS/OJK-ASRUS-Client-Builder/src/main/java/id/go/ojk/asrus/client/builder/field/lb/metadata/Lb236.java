...
import id.go.ojk.asrus.client.builder.field.lb.reference.ER3044PosLbAsrus236;
	...
	public SubmissionFormat get() {
		...
		fs.add(sf(3, null, "Wilayah Pemasaran",
				sv(C, 1, 4, refTable).confReference(EHeaderMetadataShared.R026.getObject())
						.confConditionalRequired(ER3044PosLbAsrus236.genConditional())));
		...
		fs.add(sf(5, null, "Jumlah Badan Hukum",
				sv(C, 1, 16, numericNegatif).confConditionalRequired(ER3044PosLbAsrus236.genConditional())));
		fs.add(sf(6, null, "Jumlah Pemasar Perorangan",
				sv(C, 1, 16, numericNegatif).confConditionalRequired(ER3044PosLbAsrus236.genConditional())));
		fs.add(sf(7, null, "Nama Produk Yang Dipasarkan",
				sv(C, 1, 100, all).confConditionalRequired(ER3044PosLbAsrus236.genConditional())));
