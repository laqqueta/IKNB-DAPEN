...
import id.go.ojk.asrus.client.builder.field.lb.reference.ER3034PosLbAsrus226;
...
public class Lb226 extends BaseMetadata {
	...
	public SubmissionFormat get() {
		...
		fs.add(sf(3, null, "Jenis Dana", sv(C, 1, 4, refTable).confReference(EHeaderMetadataShared.R006.getObject())
				.confConditionalRequired(ER3034PosLbAsrus226.genConditional())));
		fs.add(sf(4, null, "Nilai Pasar / Apraisal",
				sv(C, 1, 16, numericNegatif).confConditionalRequired(ER3034PosLbAsrus226.genConditional())));
