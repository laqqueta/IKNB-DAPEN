...
import id.go.ojk.asrus.client.builder.field.lb.reference.ER3024PosLbAsrus216;
...
public class Lb216 extends BaseMetadata {
	...
	public SubmissionFormat get() {
		...
		SubmissionFormat res = new SubmissionFormat(eEnum.getCode(), eEnum.getName(), reportCode,
				new ArrayList<>(), extension, 52, 52, ER3024PosLbAsrus216.genFieldSave(), null,
				ER3024PosLbAsrus216.getRequiredPos());
		res.addSegmentValidations(ER3024PosLbAsrus216.genValidationNumericNegative());
		res.addSegmentValidations(ER3024PosLbAsrus216.genValidationNumericDotNegative());
		res.addSegmentValidations(ER3024PosLbAsrus216.genValidationJumlahAsetYangDiperkenankan());
		res.addSegmentValidations(ER3024PosLbAsrus216.genValidationJumlahLiabilitas());
		res.addSegmentValidations(ER3024PosLbAsrus216.genValidationJumlahAsetYangDiperkenankanDalamRupiah());
		res.addSegmentValidations(ER3024PosLbAsrus216.genValidationJumlahLiabilitasDalamRupiah());
		res.addSegmentValidations(ER3024PosLbAsrus216.genValidationSelisihAsetYangDiperkenankanAtasLiabilitas());
		res.addSegmentValidations(ER3024PosLbAsrus216.genValidationFactorA());
		res.addSegmentValidations(ER3024PosLbAsrus216.genValidationFactorB());
		res.addSegmentValidations(ER3024PosLbAsrus216.genValidationJumlahDeviasi());
		...
		fs.add(sf(10, null, "Dana Perusahaan-Jumlah",
				sv(C, 1, 16, all).confConditionalRequired(ER3024PosLbAsrus216.genConditional10()))
						.addFieldValidations(ER3024PosLbAsrus216.genValidation10()));
		...
		fs.add(sf(19, null, "Dana Tabarru'-Jumlah", sv(M, 1, 16, all))
				.addFieldValidations(ER3024PosLbAsrus216.genValidation19()));
		...
		fs.add(sf(28, null, "PAYDI (digaransi)-Jumlah", sv(M, 1, 16, all))
				.addFieldValidations(ER3024PosLbAsrus216.genValidation28()));
		return res;
	}
}
