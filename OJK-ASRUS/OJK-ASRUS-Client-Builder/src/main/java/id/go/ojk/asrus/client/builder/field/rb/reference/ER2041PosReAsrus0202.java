...
public enum ER2041PosReAsrus0202 implements IObject<KeyValueString> {
...
//	R_02020201010000 ("02020201010000", "Beban Klaim"),
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER2041PosReAsrus0202 eEnum : ER2041PosReAsrus0202.values()) {
	...
	public static String getName() {
		return ER2041PosReAsrus0202.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER2041PosReAsrus0202.class.getSimpleName().substring(2, 6));
	}
