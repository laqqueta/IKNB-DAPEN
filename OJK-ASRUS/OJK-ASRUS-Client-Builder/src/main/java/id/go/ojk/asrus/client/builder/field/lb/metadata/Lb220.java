...
import id.go.ojk.asrus.client.builder.field.lb.reference.ER3028PosLbAsrus220;
...
public class Lb220 extends BaseMetadata {
	...
	public SubmissionFormat get() {
		...
		SubmissionFormat res = new SubmissionFormat(eEnum.getCode(), eEnum.getName(), reportCode,
				new ArrayList<>(), extension, 15, 15, ER3028PosLbAsrus220.genFieldSave(), null,
				ER3028PosLbAsrus220.getRequiredPos());
		res.addSegmentValidations(ER3028PosLbAsrus220.genValidationTotal());
		...
		fs.add(sf(4, null, "fpk",
				sv(C, 1, 6, numericDotNegatif).confConditionalRequired(ER3028PosLbAsrus220.genConditional4()))
						.addFieldValidations(ER3028PosLbAsrus220.genValidation4()));
		fs.add(sf(5, null, "Jumlah Deviasi PAKYBMP ((2) - (3)) x (4)", sv(M, 1, 16, numericNegatif))
				.addFieldValidations(ER3028PosLbAsrus220.genValidation5()));
		return res;
	}
}
