...
public enum ER2038PosReAsrus0102 implements IObject<KeyValueString> {
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER2038PosReAsrus0102 eEnum : ER2038PosReAsrus0102.values()) {
	...
	public static String getName() {
		return ER2038PosReAsrus0102.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER2038PosReAsrus0102.class.getSimpleName().substring(2, 6));
	}
