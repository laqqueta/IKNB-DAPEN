...
public enum ER3019PosLbAsrus211 implements IObject<KeyValueString> {
...
//	R_2111000002 ("2111000002", "Deposito Berjangka dan Sertifikat Deposito", "0"),
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER3019PosLbAsrus211 eEnum : ER3019PosLbAsrus211.values()) {
	...
	private static String getLookup() {
		...
		ER3019PosLbAsrus211[] eEnums = ER3019PosLbAsrus211.values();
		int enumLength = eEnums.length;
		for (int i= 0; i < enumLength; i++) {
			ER3019PosLbAsrus211 eEnum = ER3019PosLbAsrus211.values()[i];
