...
public enum ER3029PosLbAsrus221 implements IObject<KeyValueString> {
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER3029PosLbAsrus221 eEnum : ER3029PosLbAsrus221.values()) {
	...
	private static String getLookup() {
		...
		ER3029PosLbAsrus221[] eEnums = ER3029PosLbAsrus221.values();
		int enumLength = eEnums.length;
		for (int i= 0; i < enumLength; i++) {
			ER3029PosLbAsrus221 eEnum = ER3029PosLbAsrus221.values()[i];
