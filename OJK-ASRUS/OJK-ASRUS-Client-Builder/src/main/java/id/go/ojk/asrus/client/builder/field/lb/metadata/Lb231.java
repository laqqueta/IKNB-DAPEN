...
import id.go.ojk.asrus.client.builder.field.lb.reference.ER3039PosLbAsrus231;
...
public class Lb231 extends BaseMetadata {
	...
	public SubmissionFormat get() {
		...
		SubmissionFormat res = new SubmissionFormat(eEnum.getCode(), eEnum.getName(), reportCode,
				new ArrayList<>(), extension, 5, 5, ER3039PosLbAsrus231.genFieldSave(), null,
				ER3039PosLbAsrus231.getRequiredPos());
		res.addSegmentValidations(ER3039PosLbAsrus231.genValidationTotal());
		...
		fs.add(sf(4, null, "Aset-Total", sv(M, 1, 16, numericNegatif))
				.addFieldValidations(ER3039PosLbAsrus231.genValidation4()));
