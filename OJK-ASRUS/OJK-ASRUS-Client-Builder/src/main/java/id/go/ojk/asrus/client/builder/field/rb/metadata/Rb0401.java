...
import id.go.ojk.asrus.client.builder.field.rb.reference.ER2009PosRbAsrus0401;
...
public class Rb0401 extends BaseMetadata {
	...
	public SubmissionFormat get() {
		...
		fs.add(sf(3, null, "Lini Usaha/ Cabang Asuransi",
				sv(C, 0, 1000, all).confConditionalRequired(ER2009PosRbAsrus0401.genConditionalField())));
