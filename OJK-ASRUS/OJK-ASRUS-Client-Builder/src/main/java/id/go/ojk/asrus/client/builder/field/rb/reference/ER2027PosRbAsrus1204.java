...
public enum ER2027PosRbAsrus1204 implements IObject<KeyValueString> {
...
//	R_12040200000000 ("12040200000000", "BEBAN USAHA:"),
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER2027PosRbAsrus1204 eEnum : ER2027PosRbAsrus1204.values()) {
	...
	public static String getName() {
		return ER2027PosRbAsrus1204.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER2027PosRbAsrus1204.class.getSimpleName().substring(2, 6));
	}
