...
import id.go.ojk.asrus.client.builder.field.rb.reference.ER2003PosRbAsrus0104;
...
public class Rb0104 extends BaseMetadata {
	...
	public SubmissionFormat get() {
		...
		SubmissionFormat res = new SubmissionFormat(eEnum.getCode(), eEnum.getName(), reportCode,
				new ArrayList<>(), extension, 6, 6, null, null, ER2003PosRbAsrus0104.getRequiredPos());
