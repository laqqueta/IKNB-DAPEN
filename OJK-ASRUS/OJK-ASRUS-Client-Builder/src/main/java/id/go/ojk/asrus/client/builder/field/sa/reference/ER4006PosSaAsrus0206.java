...
public enum ER4006PosSaAsrus0206 implements IObject<KeyValueString> {
...
//	R_02060101050000 ("02060101050000", "5.  Pertumbuhan risiko likuiditas (dari DTMBR, MMBR dan PAYDI garansi)"),
	...
	R_02060101050300 ("02060101050300", "Dana Perusahaan (MMBR atas PAYDI digaransi)"),
...
//	R_02060400000000 ("02060400000000", "Tabel II.F.4: Tingkat Risiko Inheren untuk Risiko Likuiditas Konsolidasi"),
	R_02060401000000 ("02060401000000", "Tingkat Risiko Inheren untuk Risiko Likuiditas "),
//	R_02060500000000 ("02060500000000", "Tabel II.F.5: Kualitas Penerapan Manajemen Risiko untuk Risiko Likuiditas Konsolidasi"),
	R_02060501000000 ("02060501000000", "Kualitas Penerapan Manajemen Risiko untuk Risiko Likuiditas "),
//	R_02060502000000 ("02060502000000", "Tingkat Risiko Likuiditas "),
	R_02060503000000 ("02060503000000", "Tingkat Risiko Likuiditas Net Risk"),
	R_02060600000000 ("02060600000000", "ANALISIS"),
	;
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER4006PosSaAsrus0206 eEnum : ER4006PosSaAsrus0206.values()) {
	...
	public static ConditionalRequired genConditional2() {
		return UtilFieldConditional.genExistPos("O", "M", UtilMetadata.genPipeRow(getObjects(), 18, 20));
	}
	...
	public static SegmentValidation genValidationNumeric() {
		return UtilSegmentValidation.genRegexNumeric("2", UtilMetadata.genPipeRow(getObjects(), 15, 20));
	}
	
	public static SegmentValidation genValidationMaxLengthNumeric() {
		return UtilSegmentValidation.genMaxLength("2", UtilMetadata.genPipeRow(getObjects(), 15, 20), 1);
	}
	...
	public static SegmentValidation genValidationPeringkat2() {
		return UtilSegmentValidation.genFixedValueOptional("2", UtilMetadata.genPipeRow(getObjects(), 18, 20), ER1099Peringkat.getPipedKey());
	}
}
