...
import id.go.ojk.asrus.client.builder.field.lb.reference.ER3040PosLbAsrus232;
...
public class Lb232 extends BaseMetadata {
	...
	public SubmissionFormat get() {
		...
		SubmissionFormat res = new SubmissionFormat(eEnum.getCode(), eEnum.getName(), reportCode,
				new ArrayList<>(), extension, 2, 2, null, null, ER3040PosLbAsrus232.getRequiredPos());
		...
		fs.add(sf(4, null, "Total", sv(M, 1, 6, numericDotNegatif))
				.addFieldValidations(ER3040PosLbAsrus232.genValidation4()));
		return res;
	}
}
