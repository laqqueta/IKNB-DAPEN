...
public enum ER2033PosRbAsrus1210 implements IObject<KeyValueString> {
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER2033PosRbAsrus1210 eEnum : ER2033PosRbAsrus1210.values()) {
	...
	public static String getName() {
		return ER2033PosRbAsrus1210.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER2033PosRbAsrus1210.class.getSimpleName().substring(2, 6));
	}
