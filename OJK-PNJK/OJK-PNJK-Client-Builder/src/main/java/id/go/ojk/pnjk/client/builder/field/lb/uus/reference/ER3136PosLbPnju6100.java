...
public enum ER3136PosLbPnju6100 implements IObject<KeyValueString> {
...
//	R_6100020000 ("6100020000", "Ditambah/(Dikurangi):"),
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER3136PosLbPnju6100 eEnum : ER3136PosLbPnju6100.values()) {
	...
	public static String getName() {
		return ER3136PosLbPnju6100.class.getSimpleName().substring(6);
	}

	public static int getRefNumber() {
		return Integer.parseInt(ER3136PosLbPnju6100.class.getSimpleName().substring(2, 6));
	}
