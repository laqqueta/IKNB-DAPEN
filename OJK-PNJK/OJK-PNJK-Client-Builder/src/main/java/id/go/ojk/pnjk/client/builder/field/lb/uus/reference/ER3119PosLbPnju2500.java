...
public enum ER3119PosLbPnju2500 implements IObject<KeyValueString> {
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER3119PosLbPnju2500 eEnum : ER3119PosLbPnju2500.values()) {
	...
	public static String getName() {
		return ER3119PosLbPnju2500.class.getSimpleName().substring(6);
	}

	public static int getRefNumber() {
		return Integer.parseInt(ER3119PosLbPnju2500.class.getSimpleName().substring(2, 6));
	}
    ...
    public static SegmentValidation genValidation2() {
        return UtilSegmentValidation.genEqualsFormAdd("3", R_2500000000.key, "2|2",
                ER3104PosLbPnju1100.R_11000101110000.getKeyForm() + "|" + ER3104PosLbPnju1100.R_11000102090000.getKeyForm(),
