...
import id.go.ojk.pnjk.client.builder.field.lb.reference.ER3013PosLbPnjk2100C2;
...
public class Lb2100C2 extends BaseMetadata {
	...
	public SubmissionFormat get() {
		EFormLaporanBulanan eEnum = EFormLaporanBulanan.LB_2100C2;
		SubmissionFormat res = new SubmissionFormat(eEnum.getCode(), eEnum.getName(), reportCode, new ArrayList<>(),
				extension, 0, null, ER3013PosLbPnjk2100C2.genFieldSave(), ER3013PosLbPnjk2100C2.genFieldSaveForm(), ER3013PosLbPnjk2100C2.getRequiredPos());
		res.addSegmentValidations(ER3013PosLbPnjk2100C2.genValidation1());
		List<SubmissionField> fs = res.getFields();
		fs.add(sf(0, null, "Flag Detail", sv(M, 3, 3, alfaNumeric).confConstant("D01")));
		fs.add(sf(1, null, "Kode Komponen / Baris",
				sv(M, 10, 10, refTable).confReference(EHeaderMetadataLb.R3013_LB2100C2.getObject())));
		fs.add(sf(2, null, "Jenis Investasi",
				sv(C, 1, 10, refTable).confRegex(PATTERN_REFERENCE_1)
						...
						.confConditionalRequired(ER3013PosLbPnjk2100C2.genCondition1())));
		fs.add(sf(3, null, "Alamat",
				sv(C, 1, 200, all).confConditionalRequired(ER3013PosLbPnjk2100C2.genCondition1())));
		...
		fs.add(sf(7, null, "CKPN-Individual",
				sv(C, 1, 16, numeric).confConditionalRequired(ER3013PosLbPnjk2100C2.genCondition2("8"))));
		fs.add(sf(8, null, "CKPN-Kolektif",
				sv(C, 1, 16, numeric).confConditionalRequired(ER3013PosLbPnjk2100C2.genCondition2("7"))));
		fs.add(sf(9, null, "Jumlah Neto", sv(M, 1, 16, numericNegatif))
				.addFieldValidations(ER3013PosLbPnjk2100C2.genFieldValidation9()));
		return res;
	}
}
