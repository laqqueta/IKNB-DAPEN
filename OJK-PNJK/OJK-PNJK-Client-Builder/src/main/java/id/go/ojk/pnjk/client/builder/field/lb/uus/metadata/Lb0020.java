...
import id.go.ojk.pnjk.client.builder.field.lb.uus.reference.ER3101PosLbPnju0020;
...
public class Lb0020 extends BaseMetadata {
	...
	public SubmissionFormat get() {
		...
		SubmissionFormat res = new SubmissionFormat(eEnum.getCode(), eEnum.getName(), reportCode, new ArrayList<>(),
				extension, 0, null, null, ER3101PosLbPnju0020.genFieldSave(), null);
		List<SubmissionField> fs = res.getFields();
		fs.add(sf(0, null, "Flag Detail", sv(M, 3, 3, alfaNumeric).confConstant("D01")));
		fs.add(sf(1, null, "Kode Komponen / Baris",
				sv(M, 10, 10, refTable).confReference(EHeaderMetadataLbUus.R3101_LB0020.getObject())));
		...
		fs.add(sf(6, null, "Kecamatan", sv(O, 0, 50, all)));
