...
public enum ER3107PosLbPnju2100A1 implements IObject<KeyValueString> {
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER3107PosLbPnju2100A1 eEnum : ER3107PosLbPnju2100A1.values()) {
	...
	public static String getName() {
		return ER3107PosLbPnju2100A1.class.getSimpleName().substring(6);
	}

	public static int getRefNumber() {
		return Integer.parseInt(ER3107PosLbPnju2100A1.class.getSimpleName().substring(2, 6));
	}
