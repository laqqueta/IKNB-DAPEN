...
public enum ER3024PosLbPnjk3000 implements IObject<KeyValueString> {
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER3024PosLbPnjk3000 eEnum : ER3024PosLbPnjk3000.values()) {
	...
	public static String getName() {
		return ER3024PosLbPnjk3000.class.getSimpleName().substring(6);
	}

	public static int getRefNumber() {
		return Integer.parseInt(ER3024PosLbPnjk3000.class.getSimpleName().substring(2, 6));
	}
