...
public enum ER3106PosLbPnju1300 implements IObject<KeyValueString> {
...
//	R_13000302000000 ("13000302000000", "Arus Kas Keluar"),
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER3106PosLbPnju1300 eEnum : ER3106PosLbPnju1300.values()) {
	...
	public static String getName() {
		return ER3106PosLbPnju1300.class.getSimpleName().substring(6);
	}

	public static int getRefNumber() {
		return Integer.parseInt(ER3106PosLbPnju1300.class.getSimpleName().substring(2, 6));
	}
