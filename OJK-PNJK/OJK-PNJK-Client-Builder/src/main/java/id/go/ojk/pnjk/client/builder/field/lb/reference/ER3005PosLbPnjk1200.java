...
public enum ER3005PosLbPnjk1200 implements IObject<KeyValueString> {
//	R_12000100000000 ("12000100000000", "Pendapatan"),
//	R_12000101000000 ("12000101000000", "Pendapatan IJP"),
	R_12000101010000 ("12000101010000", "IJP Bruto"),
	R_12000101020000 ("12000101020000", "Beban IJP co-guarantee/IJP penjaminan ulang/premi reasuransi"),
	...
	R_12000101060000 ("12000101060000", "Jumlah Pendapatan IJP Bersih"),
//	R_12000102000000 ("12000102000000", "Pendapatan Operasional Lainnya"),
	R_12000102010000 ("12000102010000", "Pendapatan Bunga"),
	R_12000102020000 ("12000102020000", "Pendapatan Investasi Selain Bunga"),
...
//	R_12000200000000 ("12000200000000", "Beban"), 11 6 3 19
...
//	R_12000202000000 ("12000202000000", "Beban Operasional Lainnya"),
	...
	R_12000203000000 ("12000203000000", "Beban Operasional"),
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER3005PosLbPnjk1200 eEnum : ER3005PosLbPnjk1200.values()) {
	...
	public static String getName() {
		return ER3005PosLbPnjk1200.class.getSimpleName().substring(6);
	}

	public static int getRefNumber() {
		return Integer.parseInt(ER3005PosLbPnjk1200.class.getSimpleName().substring(2, 6));
	}
