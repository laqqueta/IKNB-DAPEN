...
public enum ER3100PosLbPnju0000 implements IObject<KeyValueString> {
...
//	R_000005020000 ("000005020000", "Penanggung Jawab Laporan"),
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER3100PosLbPnju0000 eEnum : ER3100PosLbPnju0000.values()) {
	...
	public static String getName() {
		return ER3100PosLbPnju0000.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER3100PosLbPnju0000.class.getSimpleName().substring(2, 6));
	}
	...
	public static SegmentValidation genValidation18B() {
		return UtilSegmentValidation.genEqualsFormColumCalculation("2", R_000004000000.key,
				UtilMetadata.genPlusColumn(2, 5), ER3102PosLbPnju0030.R_0030010000.getKeyForm(),
