...
import id.go.ojk.pnjk.client.builder.field.lb.reference.ER3012PosLbPnjk2100C1;
...
public class Lb2100C1 extends BaseMetadata {
	...
	public SubmissionFormat get() {
		...
		SubmissionFormat res = new SubmissionFormat(eEnum.getCode(), eEnum.getName(), reportCode, new ArrayList<>(),
				extension, 0, null, ER3012PosLbPnjk2100C1.genFieldSave(), ER3012PosLbPnjk2100C1.genFieldSaveForm(), ER3012PosLbPnjk2100C1.getRequiredPos());
		res.addSegmentValidations(ER3012PosLbPnjk2100C1.genValidation1());
		...
		fs.add(sf(2, null, "Jenis Investasi",
				sv(C, 1, 10, refTable).confRegex(PATTERN_REFERENCE_1)
						...
						.confConditionalRequired(ER3012PosLbPnjk2100C1.genCondition1())));
		fs.add(sf(3, null, "Alamat",
				sv(C, 1, 200, all).confConditionalRequired(ER3012PosLbPnjk2100C1.genCondition1())));
		...
		fs.add(sf(7, null, "CKPN-Individual",
				sv(C, 1, 16, numeric).confConditionalRequired(ER3012PosLbPnjk2100C1.genCondition2("8"))));
		fs.add(sf(8, null, "CKPN-Kolektif",
				sv(C, 1, 16, numeric).confConditionalRequired(ER3012PosLbPnjk2100C1.genCondition2("7"))));
		fs.add(sf(9, null, "Jumlah Neto", sv(M, 1, 16, numericNegatif))
				.addFieldValidations(ER3012PosLbPnjk2100C1.genFieldValidation9()));
		return res;
	}
}
