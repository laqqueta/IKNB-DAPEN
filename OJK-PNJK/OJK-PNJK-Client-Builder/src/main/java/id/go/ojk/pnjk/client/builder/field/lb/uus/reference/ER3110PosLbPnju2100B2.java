...
public enum ER3110PosLbPnju2100B2 implements IObject<KeyValueString> {
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER3110PosLbPnju2100B2 eEnum : ER3110PosLbPnju2100B2.values()) {
	...
	public static String getName() {
		return ER3110PosLbPnju2100B2.class.getSimpleName().substring(6);
	}

	public static int getRefNumber() {
		return Integer.parseInt(ER3110PosLbPnju2100B2.class.getSimpleName().substring(2, 6));
	}
    ...
    public static SegmentValidation genValidation1() {
        ...
        return UtilSegmentValidation.genEqualsFormAdd("20", R_2100B20000.key, compareField,
                UtilMetadata.genPipeRow(ER3104PosLbPnju1100.getObjectsForm(), comparePos),
