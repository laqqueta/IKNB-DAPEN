...
import id.go.ojk.pnjk.client.builder.field.lb.uus.reference.ER3116PosLbPnju2200;
...
public class Lb2200 extends BaseMetadata {
	...
	public SubmissionFormat get() {
		...
		SubmissionFormat res = new SubmissionFormat(eEnum.getCode(), eEnum.getName(), reportCode, new ArrayList<>(),
				extension, 0, null, null, ER3116PosLbPnju2200.genFieldSave(), null);
		List<SubmissionField> fs = res.getFields();
		fs.add(sf(0, null, "Flag Detail", sv(M, 3, 3, alfaNumeric).confConstant("D01")));
		fs.add(sf(1, null, "Kode Komponen / Baris",
				sv(M, 10, 10, refTable).confReference(EHeaderMetadataLbUus.R3116_LB2200.getObject())));
		...
		fs.add(sf(11, null, "Jumlah Netto (Rp)", sv(M, 1, 16, numericNegatif))
                .addFieldValidations(ER3116PosLbPnju2200.genFieldValidation()));
		return res;
	}
}
