...
public enum ER3023PosLbPnjk2900 implements IObject<KeyValueString> {
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER3023PosLbPnjk2900 eEnum : ER3023PosLbPnjk2900.values()) {
	...
	public static String getName() {
		return ER3023PosLbPnjk2900.class.getSimpleName().substring(6);
	}

	public static int getRefNumber() {
		return Integer.parseInt(ER3023PosLbPnjk2900.class.getSimpleName().substring(2, 6));
	}
