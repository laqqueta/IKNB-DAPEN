...
public enum ER3137PosLbPnju7100 implements IObject<KeyValueString> {
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER3137PosLbPnju7100 eEnum : ER3137PosLbPnju7100.values()) {
	...
	public static String getName() {
		return ER3137PosLbPnju7100.class.getSimpleName().substring(6);
	}

	public static int getRefNumber() {
		return Integer.parseInt(ER3137PosLbPnju7100.class.getSimpleName().substring(2, 6));
	}
