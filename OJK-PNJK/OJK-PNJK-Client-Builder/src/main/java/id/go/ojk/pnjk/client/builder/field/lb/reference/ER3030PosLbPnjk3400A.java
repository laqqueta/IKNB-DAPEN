...
public enum ER3030PosLbPnjk3400A implements IObject<KeyValueString> {
	R_3400A10100 ("3400A10100", "Detail"),
	;
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER3030PosLbPnjk3400A eEnum : ER3030PosLbPnjk3400A.values()) {
	...
	public static String getName() {
		return ER3030PosLbPnjk3400A.class.getSimpleName().substring(6);
	}

	public static int getRefNumber() {
		return Integer.parseInt(ER3030PosLbPnjk3400A.class.getSimpleName().substring(2, 6));
	}
