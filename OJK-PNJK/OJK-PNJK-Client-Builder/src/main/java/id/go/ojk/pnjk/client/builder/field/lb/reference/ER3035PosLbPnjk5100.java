...
public enum ER3035PosLbPnjk5100 implements IObject<KeyValueString> {
...
//	R_5100030000 ("5100030000", "Rentabilitas", ""),
	...
	R_5100030300 ("5100030300", "Klaim terhadap Pendapatan IJP", "35.00"),
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER3035PosLbPnjk5100 eEnum : ER3035PosLbPnjk5100.values()) {
	...
	public static String getName() {
		return ER3035PosLbPnjk5100.class.getSimpleName().substring(6);
	}

	public static int getRefNumber() {
		return Integer.parseInt(ER3035PosLbPnjk5100.class.getSimpleName().substring(2, 6));
	}
	...
	private static String getLookup() {
		...
		for (int i = 0; i < enumLength; i++) {
			ER3035PosLbPnjk5100 eEnum = ER3035PosLbPnjk5100.values()[i];
