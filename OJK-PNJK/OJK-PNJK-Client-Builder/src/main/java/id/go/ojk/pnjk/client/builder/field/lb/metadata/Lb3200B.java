...
import id.go.ojk.pnjk.client.builder.field.lb.reference.ER3027PosLbPnjk3200B;
...
public class Lb3200B extends BaseMetadata {
	...
	public SubmissionFormat get() {
		...
		fs.add(sf(36, null, "Total-Jumlah Terjamin (Satuan)", sv(M, 1, 8, numeric))
				.addFieldValidations(ER3027PosLbPnjk3200B.genFieldValidation36()));
		fs.add(sf(37, null, "Total-Nilai Jaminan (Rp)", sv(M, 1, 16, numeric))
				.addFieldValidations(ER3027PosLbPnjk3200B.genFieldValidation37()));
		fs.add(sf(38, null, "Total-Nilai Klaim (Rp)", sv(M, 1, 16, numeric))
				.addFieldValidations(ER3027PosLbPnjk3200B.genFieldValidation38()));
		return res;
	}
}
