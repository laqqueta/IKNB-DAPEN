...
public enum ER3129PosLbPnju3300B implements IObject<KeyValueString> {
	R_3300B10100 ("3300B10100", "Detail"),
	;
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER3129PosLbPnju3300B eEnum : ER3129PosLbPnju3300B.values()) {
	...
	public static String getName() {
		return ER3129PosLbPnju3300B.class.getSimpleName().substring(6);
	}

	public static int getRefNumber() {
		return Integer.parseInt(ER3129PosLbPnju3300B.class.getSimpleName().substring(2, 6));
	}
