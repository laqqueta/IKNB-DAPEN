...
public enum ER3111PosLbPnju2100B3 implements IObject<KeyValueString> {
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER3111PosLbPnju2100B3 eEnum : ER3111PosLbPnju2100B3.values()) {
	...
	public static String getName() {
		return ER3111PosLbPnju2100B3.class.getSimpleName().substring(6);
	}

	public static int getRefNumber() {
		return Integer.parseInt(ER3111PosLbPnju2100B3.class.getSimpleName().substring(2, 6));
	}
	...
	public static SegmentValidation genValidation6() {
		...
		return UtilSegmentValidation.genEqualsFormulaForm("2", R_2100B30500.key, "2",
				UtilMetadata.genPlusRow(ER3104PosLbPnju1100.getObjectsForm(), field), 
