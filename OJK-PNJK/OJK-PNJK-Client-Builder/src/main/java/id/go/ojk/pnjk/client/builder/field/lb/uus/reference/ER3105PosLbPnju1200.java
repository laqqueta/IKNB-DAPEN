...
public enum ER3105PosLbPnju1200 implements IObject<KeyValueString> {
...
//	R_12000202000000 ("12000202000000", "Beban Operasional Lainnya"),
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER3105PosLbPnju1200 eEnum : ER3105PosLbPnju1200.values()) {
	...
	public static String getName() {
		return ER3105PosLbPnju1200.class.getSimpleName().substring(6);
	}

	public static int getRefNumber() {
		return Integer.parseInt(ER3105PosLbPnju1200.class.getSimpleName().substring(2, 6));
	}
