...
public enum ER3134PosLbPnju4100 implements IObject<KeyValueString> {
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER3134PosLbPnju4100 eEnum : ER3134PosLbPnju4100.values()) {
	...
	public static String getName() {
		return ER3134PosLbPnju4100.class.getSimpleName().substring(6);
	}

	public static int getRefNumber() {
		return Integer.parseInt(ER3134PosLbPnju4100.class.getSimpleName().substring(2, 6));
	}
