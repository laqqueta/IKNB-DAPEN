...
import id.go.ojk.pnjk.client.builder.field.lb.uus.reference.ER3118PosLbPnju2400;
...
public class Lb2400 extends BaseMetadata {
	...
	public SubmissionFormat get() {
		...
		SubmissionFormat res = new SubmissionFormat(eEnum.getCode(), eEnum.getName(), reportCode, new ArrayList<>(),
				extension, 0, null, ER3118PosLbPnju2400.genFieldSave(), ER3118PosLbPnju2400.genFieldSave(), ER3118PosLbPnju2400.getRequiredPos());

        res.addSegmentValidations(ER3118PosLbPnju2400.genValidation1());
        res.addSegmentValidations(ER3118PosLbPnju2400.genValidation2());

		List<SubmissionField> fs = res.getFields();
		fs.add(sf(0, null, "Flag Detail", sv(M, 3, 3, alfaNumeric).confConstant("D01")));
		fs.add(sf(1, null, "Kode Komponen / Baris",
				sv(M, 10, 10, refTable).confReference(EHeaderMetadataLbUus.R3118_LB2400.getObject())));
		fs.add(sf(2, null, "Keterangan", sv(C, 1, 200, all)
                .confConditionalRequired(ER3118PosLbPnju2400.genConditionForTotal())));
