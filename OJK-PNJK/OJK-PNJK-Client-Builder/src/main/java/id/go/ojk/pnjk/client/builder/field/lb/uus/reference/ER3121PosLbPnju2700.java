...
public enum ER3121PosLbPnju2700 implements IObject<KeyValueString> {
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER3121PosLbPnju2700 eEnum : ER3121PosLbPnju2700.values()) {
	...
	public static String getName() {
		return ER3121PosLbPnju2700.class.getSimpleName().substring(6);
	}

	public static int getRefNumber() {
		return Integer.parseInt(ER3121PosLbPnju2700.class.getSimpleName().substring(2, 6));
	}
    ...
    public static SegmentValidation genValidation2() {
        return UtilSegmentValidation.genEqualsFormAdd("6", R_2700000000.key, "2|2",
                ER3104PosLbPnju1100.R_11000201070000.getKeyForm() + "|" + ER3104PosLbPnju1100.R_11000202070000.getKeyForm(),
