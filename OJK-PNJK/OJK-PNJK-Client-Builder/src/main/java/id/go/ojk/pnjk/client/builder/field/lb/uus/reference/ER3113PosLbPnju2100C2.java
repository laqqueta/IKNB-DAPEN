...
public enum ER3113PosLbPnju2100C2 implements IObject<KeyValueString> {
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER3113PosLbPnju2100C2 eEnum : ER3113PosLbPnju2100C2.values()) {
	...
	public static String getName() {
		return ER3113PosLbPnju2100C2.class.getSimpleName().substring(6);
	}

	public static int getRefNumber() {
		return Integer.parseInt(ER3113PosLbPnju2100C2.class.getSimpleName().substring(2, 6));
	}
