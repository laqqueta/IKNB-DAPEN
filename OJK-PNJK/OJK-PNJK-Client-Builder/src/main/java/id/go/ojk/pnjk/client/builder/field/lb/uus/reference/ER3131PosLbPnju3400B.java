...
public enum ER3131PosLbPnju3400B implements IObject<KeyValueString> {
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER3131PosLbPnju3400B eEnum : ER3131PosLbPnju3400B.values()) {
	...
	public static String getName() {
		return ER3131PosLbPnju3400B.class.getSimpleName().substring(6);
	}

	public static int getRefNumber() {
		return Integer.parseInt(ER3131PosLbPnju3400B.class.getSimpleName().substring(2, 6));
	}
