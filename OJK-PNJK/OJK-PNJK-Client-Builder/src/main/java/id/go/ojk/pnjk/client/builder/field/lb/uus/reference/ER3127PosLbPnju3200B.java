...
public enum ER3127PosLbPnju3200B implements IObject<KeyValueString> {
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER3127PosLbPnju3200B eEnum : ER3127PosLbPnju3200B.values()) {
	...
	public static String getName() {
		return ER3127PosLbPnju3200B.class.getSimpleName().substring(6);
	}

	public static int getRefNumber() {
		return Integer.parseInt(ER3127PosLbPnju3200B.class.getSimpleName().substring(2, 6));
	}
