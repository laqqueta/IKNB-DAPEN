...
public enum ER3038PosLbPnjk8100 implements IObject<KeyValueString> {
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER3038PosLbPnjk8100 eEnum : ER3038PosLbPnjk8100.values()) {
	...
	public static String getName() {
		return ER3038PosLbPnjk8100.class.getSimpleName().substring(6);
	}

	public static int getRefNumber() {
		return Integer.parseInt(ER3038PosLbPnjk8100.class.getSimpleName().substring(2, 6));
	}
