...
import id.go.ojk.pnjk.client.builder.field.lb.uus.reference.ER3125PosLbPnju3100;
...
public class Lb3100 extends BaseMetadata {
	...
	public SubmissionFormat get() {
		EFormLaporanBulananUus eEnum = EFormLaporanBulananUus.LB_3100;
		SubmissionFormat res = new SubmissionFormat(eEnum.getCode(), eEnum.getName(), reportCode, new ArrayList<>(),
				extension, 0, null, ER3125PosLbPnju3100.genFieldSave(), ER3125PosLbPnju3100.genFieldSave() , ER3125PosLbPnju3100.getRequiredPos());

        res.addSegmentValidations(ER3125PosLbPnju3100.genValidation());

		List<SubmissionField> fs = res.getFields();
		fs.add(sf(0, null, "Flag Detail", sv(M, 3, 3, alfaNumeric).confConstant("D01")));
		fs.add(sf(1, null, "Kode Komponen / Baris",
				sv(M, 10, 10, refTable).confReference(EHeaderMetadataLbUus.R3125_LB3100.getObject())));
		fs.add(sf(2, null, "Nomor Sertifikat Kafalah", sv(C, 1, 35, all)
                .confConditionalRequired(ER3125PosLbPnju3100.genConditionForTotal())));
