...
public enum ER3037PosLbPnjk7100 implements IObject<KeyValueString> {
	R_7100010000 ("7100010000", "Nilai Penjaminan Yang Ditanggung Sendiri"),
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER3037PosLbPnjk7100 eEnum : ER3037PosLbPnjk7100.values()) {
	...
	public String getKeyForm() {
		return EFormLaporanBulanan.LB_7100.getCode() + key;
	}
	...
	public static String getName() {
		return ER3037PosLbPnjk7100.class.getSimpleName().substring(6);
	}

	public static int getRefNumber() {
		return Integer.parseInt(ER3037PosLbPnjk7100.class.getSimpleName().substring(2, 6));
	}
