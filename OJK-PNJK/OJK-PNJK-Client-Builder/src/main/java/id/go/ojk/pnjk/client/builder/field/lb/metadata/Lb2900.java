...
import id.go.ojk.pnjk.client.builder.field.lb.reference.ER3023PosLbPnjk2900;
...
public class Lb2900 extends BaseMetadata {
	...
	public SubmissionFormat get() {
		...
		SubmissionFormat res = new SubmissionFormat(eEnum.getCode(), eEnum.getName(), reportCode, new ArrayList<>(),
				extension, 0, null, ER3023PosLbPnjk2900.genFieldSave(), ER3023PosLbPnjk2900.genFieldSave(), ER3023PosLbPnjk2900.getRequiredPos());

        res.addSegmentValidations(ER3023PosLbPnjk2900.genValidation1());
        res.addSegmentValidations(ER3023PosLbPnjk2900.genValidation2());
		...
		fs.add(sf(2, null, "Keterangan", sv(C, 1, 100, all)
                .confConditionalRequired(ER3023PosLbPnjk2900.genConditionForTotal())));
