...
import id.go.ojk.pnjk.client.builder.field.lb.uus.reference.ER3102PosLbPnju0030;
...
public class Lb0030 extends BaseMetadata {
	...
	public SubmissionFormat get() {
		...
		SubmissionFormat res = new SubmissionFormat(eEnum.getCode(), eEnum.getName(), reportCode, new ArrayList<>(),
				extension, 4, 4, ER3102PosLbPnju0030.genFieldSave(), ER3102PosLbPnju0030.genFieldSave(), 
				ER3102PosLbPnju0030.getRequiredPos());
		res.addSegmentValidations(ER3102PosLbPnju0030.genValidation5());
		List<SubmissionField> fs = res.getFields();
		fs.add(sf(0, null, "Flag Detail", sv(M, 3, 3, alfaNumeric).confConstant("D01")));
		fs.add(sf(1, null, "Kode Komponen / Baris",
				sv(M, 10, 10, refTable).confReference(EHeaderMetadataLbUus.R3102_LB0030.getObject())).confUnique(U));
