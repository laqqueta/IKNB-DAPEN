...
public enum ER3126PosLbPnju3200A implements IObject<KeyValueString> {
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER3126PosLbPnju3200A eEnum : ER3126PosLbPnju3200A.values()) {
	...
	public static String getName() {
		return ER3126PosLbPnju3200A.class.getSimpleName().substring(6);
	}

	public static int getRefNumber() {
		return Integer.parseInt(ER3126PosLbPnju3200A.class.getSimpleName().substring(2, 6));
	}
