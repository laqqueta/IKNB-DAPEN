...
public enum ER3008PosLbPnjk2100A2 implements IObject<KeyValueString> {
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER3008PosLbPnjk2100A2 eEnum : ER3008PosLbPnjk2100A2.values()) {
	...
	public static String getName() {
		return ER3008PosLbPnjk2100A2.class.getSimpleName().substring(6);
	}

	public static int getRefNumber() {
		return Integer.parseInt(ER3008PosLbPnjk2100A2.class.getSimpleName().substring(2, 6));
	}
