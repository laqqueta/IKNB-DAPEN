...
public enum ER3031PosLbPnjk3400B implements IObject<KeyValueString> {
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER3031PosLbPnjk3400B eEnum : ER3031PosLbPnjk3400B.values()) {
	...
	public static String getName() {
		return ER3031PosLbPnjk3400B.class.getSimpleName().substring(6);
	}

	public static int getRefNumber() {
		return Integer.parseInt(ER3031PosLbPnjk3400B.class.getSimpleName().substring(2, 6));
	}
