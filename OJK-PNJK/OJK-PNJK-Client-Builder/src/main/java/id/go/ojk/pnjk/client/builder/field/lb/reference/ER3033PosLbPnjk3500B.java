...
public enum ER3033PosLbPnjk3500B implements IObject<KeyValueString> {
//	R_3500B10100 ("3500B10100", "Penerima Jaminan"),
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER3033PosLbPnjk3500B eEnum : ER3033PosLbPnjk3500B.values()) {
	...
	public String getKeyForm() {
		return EFormLaporanBulanan.LB_3500B.getCode() + key;
	}
	...
	public static String getName() {
		return ER3033PosLbPnjk3500B.class.getSimpleName().substring(6);
	}

	public static int getRefNumber() {
		return Integer.parseInt(ER3033PosLbPnjk3500B.class.getSimpleName().substring(2, 6));
	}
