...
import id.go.ojk.client.model.config.validation.segmen.ComparisonFormValidation4;
...
public enum ER3004PosLbPnjk1100 implements IObject<KeyValueString> {
...
//	R_11000101000000 ("11000101000000", "Aset Lancar"),
	...
	R_11000101020200("11000101020200", "Surat Berharga Negara"),
	R_11000101020300("11000101020300", "Surat Berharga yang Diterbitkan oleh Bank Indonesia"),
	R_11000101020400("11000101020400", "Obligasi Korporasi"),
	R_11000101020500("11000101020500", "Saham yang Tercatat di Bursa Efek Indonesia"),
	R_11000101020600("11000101020600", "Efek Beragun Aset"), 
	R_11000101020700("11000101020700", "Reksa Dana"),
	R_11000101020800("11000101020800", "Medium Term Notes"), 
	R_11000101020900("11000101020900", "Repurchase Agreement"),
	R_11000101021000("11000101021000", "Dana Investasi Real Estat Berbentuk Kontrak Investasi Kolektif"),
	R_11000101021100("11000101021100", "Tanah dan Bangunan"),
	R_11000101021200("11000101021200", "Penyertaan Langsung pada Perusahaan di Sektor Jasa Keuangan di Indonesia"),
	R_11000101021300("11000101021300", "Obligasi Daerah"),
	...
	R_11000101030000("11000101030000", "Piutang Imbal Jasa Penjaminan (Piutang IJP)"),
	R_11000101040000("11000101040000", "Piutang Penjaminan Bersama (Piutang Co-Guarantee)"),
	R_11000101050000("11000101050000", "Piutang Reasuransi/Penjaminan Ulang"),
...
//	R_11000102000000 ("11000102000000", "Aset Tidak Lancar"),
	...
	R_11000102010200("11000102010200", "Surat Berharga Negara"),
	R_11000102010300("11000102010300", "Surat Berharga yang Diterbitkan oleh Bank Indonesia"),
	R_11000102010400("11000102010400", "Obligasi Korporasi"),
	R_11000102010500("11000102010500", "Saham yang Tercatat di Bursa Efek Indonesia"),
	R_11000102010600("11000102010600", "Efek Beragun Aset"), 
	R_11000102010700("11000102010700", "Reksa Dana"),
	R_11000102010800("11000102010800", "Medium Term Notes"), 
	R_11000102010900("11000102010900", "Repurchase Agreement"),
	R_11000102011000("11000102011000", "Dana Investasi Real Estat Berbentuk Kontrak Investasi Kolektif"),
	R_11000102011100("11000102011100", "Tanah dan Bangunan"),
	R_11000102011200("11000102011200", "Penyertaan Langsung pada Perusahaan di Sektor Jasa Keuangan di Indonesia"),
	R_11000102011300("11000102011300", "Obligasi Daerah"),
	...
	R_11000102020000("11000102020000", "Piutang IJP"),
	R_11000102030000("11000102030000", "Piutang Co-Guarantee"),
	R_11000102040000("11000102040000", "Piutang Reasuransi/Penjaminan Ulang"),
...
//	R_11000201000000 ("11000201000000", "Liabilitas Lancar"),
	...
	R_11000201030000("11000201030000", "Penampungan IJP"), 
	R_11000201040000("11000201040000", "IJP Ditangguhkan"),
	...
	R_11000201080000("11000201080000", "Utang IJP Co-Guarantee"),
	R_11000201090000("11000201090000", "Utang Premi Reasuransi/IJP Penjaminan Ulang"),
	R_11000201100000("11000201100000", "Beban Yang Masih Harus Dibayar"),
	R_11000201110000("11000201110000", "Liabilitas Pajak Tangguhan"),
	R_11000201120000("11000201120000", "Obligasi Wajib Konversi"),
...
//	R_11000202000000 ("11000202000000", "Liabilitas Tidak Lancar"),
	...
	R_11000202030000("11000202030000", "Penampungan IJP"), 
	R_11000202040000("11000202040000", "IJP Ditangguhkan"),
	...
	R_11000202080000("11000202080000", "Utang IJP Co-Guarantee"),
	R_11000202090000("11000202090000", "Utang Premi Reasuransi/IJP Penjaminan Ulang"),
	R_11000202100000("11000202100000", "Beban Yang Masih Harus Dibayar"),
	R_11000202110000("11000202110000", "Liabilitas Pajak Tangguhan"),
	R_11000202120000("11000202120000", "Obligasi Wajib Konversi"),
...
//	R_11000300000000 ("11000300000000", "Ekuitas"),
	...
	R_11000301010000("11000301010000", "Modal Disetor"),
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER3004PosLbPnjk1100 eEnum : ER3004PosLbPnjk1100.values()) {
			res.add(eEnum.getObject());
		}
		return res;
	}

    public KeyValueString getObjectKey() {
        return new KeyValueString(EFormLaporanBulanan.LB_1100.getCode() + key, value, new String[] {});
    }

    public static List<KeyValueString> getObjectsKeyForm() {
        List<KeyValueString> res = new ArrayList<>();
        for (ER3004PosLbPnjk1100 eEnum : ER3004PosLbPnjk1100.values()) {
            res.add(eEnum.getObjectKey());
        }
        return res;
    }
	...
	public static String getName() {
		return ER3004PosLbPnjk1100.class.getSimpleName().substring(6);
	}

	public static int getRefNumber() {
		return Integer.parseInt(ER3004PosLbPnjk1100.class.getSimpleName().substring(2, 6));
	}
	...
	public static SegmentValidation genValidation101() {
		...
		return UtilSegmentValidation.genEqualsFormula("2", R_11000302000000.key, UtilMetadata.genPlusRow(getObjects(), field),
				UtilMetadata.genMessage(R_11000302000000.value, UtilMetadata.genPlusDesc(getObjects(), field) + " dapat diisi dengan angka +/-."));
	}
    ...
    public static SegmentValidation genValidationR11000202140000() {
        return UtilSegmentValidation.genEqualsForm("2", R_11000202140000.key, EFormLaporanBulanan.LB_2900.getCode(), "4",
                ER3023PosLbPnjk2900.R_2900000000.getKey());
    }
    ...
    public static SegmentValidation genValidationR11000101130000() {
        return UtilSegmentValidation.genEqualsForm("2", R_11000101130000.key, EFormLaporanBulanan.LB_2400.getCode(), "3",
                ER3018PosLbPnjk2400.R_2400000000.getKey());
    }
    ...
    public static SegmentValidation genValidationR11000101020100() {
        return UtilSegmentValidation.genEqualsForm("2", R_11000101020100.key, EFormLaporanBulanan.LB_2100A1.getCode(), "14",
                ER3007PosLbPnjk2100A1.R_2100A10000.getKey());
    }
    ...
    public static SegmentValidation genValidationR11000102010100() {
        return UtilSegmentValidation.genEqualsForm("2", R_11000102010100.key, EFormLaporanBulanan.LB_2100A2.getCode(), "14",
                ER3008PosLbPnjk2100A2.R_2100A20000.getKey());
    }
    ...
    public static SegmentValidation genValidationR11000101021200() {
        return UtilSegmentValidation.genEqualsForm("2", R_11000101021200.key, EFormLaporanBulanan.LB_2100D1.getCode(), "10",
                ER3014PosLbPnjk2100D1.R_2100D10000.getKey());
    }
    ...
    public static SegmentValidation genValidationR11000102011200() {
        return UtilSegmentValidation.genEqualsForm("2", R_11000102011200.key, EFormLaporanBulanan.LB_2100D2.getCode(), "10",
                ER3015PosLbPnjk2100D2.R_2100D20000.getKey());
    }
    ...
    public static SegmentValidation genValidationR11000101021100() {
        return UtilSegmentValidation.genEqualsForm("2", R_11000101021100.key, EFormLaporanBulanan.LB_2100C1.getCode(), "9",
                ER3012PosLbPnjk2100C1.R_2100C10000.getKey());
    }
    ...
    public static SegmentValidation genValidationR11000102011100() {
        return UtilSegmentValidation.genEqualsForm("2", R_11000102011100.key, EFormLaporanBulanan.LB_2100C2.getCode(), "9",
                ER3013PosLbPnjk2100C2.R_2100C20000.getKey());
    }

    // Validation M : M
    public static SegmentValidation genRowValidationMulti1() {
        String comparatorPosCode = UtilMetadata.genPipeRow(ER3016PosLbPnjk2200.getObjects(), new int[] { 0 });
    ...
    public static SegmentValidation genRowValidationMulti2() {
        String comparatorPosCode = UtilMetadata.genPipeRow(ER3022PosLbPnjk2800.getObjects(), new int[] { 0 });
        String selectPosCode = UtilMetadata.genPipeRow(getObjects(), new int[] { 79, 64, 80, 65 }); // 81, 66, 82, 67
        String errMsg = "Penjumlahan Utang IJK CoGar (Lancar + Tidak Lancar) dan Utang Premi Reasurnasi/IJK PU (Lancar + Tidak Lancar) harus sama dengan Total Utang IJP - Total CKPN pada form 2800)";
    ...
    public static SegmentValidation genRowValidationMulti3() {
        String comparatorPosCode = UtilMetadata.genPipeRow(ER3017PosLbPnjk2300.getObjects(), new int[] { 0 });
