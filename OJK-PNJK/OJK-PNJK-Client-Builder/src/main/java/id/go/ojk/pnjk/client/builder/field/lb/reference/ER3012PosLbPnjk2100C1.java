...
public enum ER3012PosLbPnjk2100C1 implements IObject<KeyValueString> {
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER3012PosLbPnjk2100C1 eEnum : ER3012PosLbPnjk2100C1.values()) {
	...
	public static String getName() {
		return ER3012PosLbPnjk2100C1.class.getSimpleName().substring(6);
	}

	public static int getRefNumber() {
		return Integer.parseInt(ER3012PosLbPnjk2100C1.class.getSimpleName().substring(2, 6));
	}
