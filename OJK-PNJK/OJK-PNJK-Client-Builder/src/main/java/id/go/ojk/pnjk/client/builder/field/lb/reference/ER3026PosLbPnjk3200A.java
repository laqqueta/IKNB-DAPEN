...
public enum ER3026PosLbPnjk3200A implements IObject<KeyValueString> {
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER3026PosLbPnjk3200A eEnum : ER3026PosLbPnjk3200A.values()) {
	...
	public static String getName() {
		return ER3026PosLbPnjk3200A.class.getSimpleName().substring(6);
	}

	public static int getRefNumber() {
		return Integer.parseInt(ER3026PosLbPnjk3200A.class.getSimpleName().substring(2, 6));
	}
