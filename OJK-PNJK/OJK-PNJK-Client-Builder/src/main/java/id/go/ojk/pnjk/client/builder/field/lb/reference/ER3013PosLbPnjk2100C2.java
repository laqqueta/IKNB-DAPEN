...
public enum ER3013PosLbPnjk2100C2 implements IObject<KeyValueString> {
	R_2100C20100 ("2100C20100", "Detail"),
	R_2100C20000 ("2100C20000", "Total"),
	;
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER3013PosLbPnjk2100C2 eEnum : ER3013PosLbPnjk2100C2.values()) {
	...
	public static String getName() {
		return ER3013PosLbPnjk2100C2.class.getSimpleName().substring(6);
	}

	public static int getRefNumber() {
		return Integer.parseInt(ER3013PosLbPnjk2100C2.class.getSimpleName().substring(2, 6));
	}
	...
	public static ConditionalRequired genCondition1() {
		return UtilFieldConditional.genExistPos("N", "M", UtilMetadata.genPipeRow(getObjects(), new int[] { 1 }));
	}
	
	public static ConditionalRequired genCondition2(String comparatorField) {
	...
	public static SegmentValidation genValidation1() {
		int[] field = new int[] { 0 };
		return UtilSegmentValidation.genEqualsFormula(UtilMetadata.genPipeColumn(5, 9), R_2100C20000.key,
				UtilMetadata.genPlusRow(getObjects(), field),
				UtilMetadata.genMessageTotal(R_2100C20000.value, R_2100C20100.value));
	}
}
