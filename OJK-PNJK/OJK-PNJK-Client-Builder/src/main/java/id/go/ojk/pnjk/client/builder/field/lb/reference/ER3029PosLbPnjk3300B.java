...
public enum ER3029PosLbPnjk3300B implements IObject<KeyValueString> {
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER3029PosLbPnjk3300B eEnum : ER3029PosLbPnjk3300B.values()) {
	...
	public static String getName() {
		return ER3029PosLbPnjk3300B.class.getSimpleName().substring(6);
	}

	public static int getRefNumber() {
		return Integer.parseInt(ER3029PosLbPnjk3300B.class.getSimpleName().substring(2, 6));
	}
