...
public enum ER3011PosLbPnjk2100B3 implements IObject<KeyValueString> {
	R_2100B30100 ("2100B30100", "Surat Berharga Negara"),
	R_2100B30200 ("2100B30200", "Obligasi Infrastruktur"),
	R_2100B30300 ("2100B30300", "Reksadana Underlying SBN"),
	R_2100B30400 ("2100B30400", "TOTAL SBN"),
	R_2100B30500 ("2100B30500", "TOTAL INVESTASI"),
	R_2100B30600 ("2100B30600", "TOTAL SBN/TOTAL INVESTASI"),
	;
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER3011PosLbPnjk2100B3 eEnum : ER3011PosLbPnjk2100B3.values()) {
	...
	public static String getName() {
		return ER3011PosLbPnjk2100B3.class.getSimpleName().substring(6);
	}

	public static int getRefNumber() {
		return Integer.parseInt(ER3011PosLbPnjk2100B3.class.getSimpleName().substring(2, 6));
	}
	...
	public static SegmentValidation genValidation6() {
		...
		return UtilSegmentValidation.genEqualsFormulaForm("2", R_2100B30500.key, "2",
				UtilMetadata.genPlusRow(ER3004PosLbPnjk1100.getObjectsForm(), field), 
