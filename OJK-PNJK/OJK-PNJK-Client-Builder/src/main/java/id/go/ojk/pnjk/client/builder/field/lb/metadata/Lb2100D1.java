...
import id.go.ojk.pnjk.client.builder.field.lb.reference.ER3014PosLbPnjk2100D1;
...
public class Lb2100D1 extends BaseMetadata {
	...
	public SubmissionFormat get() {
		...
		SubmissionFormat res = new SubmissionFormat(eEnum.getCode(), eEnum.getName(), reportCode, new ArrayList<>(),
				extension, 0, null, ER3014PosLbPnjk2100D1.genFieldSave(), ER3014PosLbPnjk2100D1.genFieldSaveForm(), ER3014PosLbPnjk2100D1.getRequiredPos());
		res.addSegmentValidations(ER3014PosLbPnjk2100D1.genValidation1());
		...
		fs.add(sf(2, null, "Nama Investee",
				sv(C, 1, 100, all).confConditionalRequired(ER3014PosLbPnjk2100D1.genConditionA())));
		fs.add(sf(3, null, "Metode Penyertaan",
				sv(C, 1, 10, refTable).confRegex(PATTERN_REFERENCE_1)
						...
						.confConditionalRequired(ER3014PosLbPnjk2100D1.genConditionA())));
		fs.add(sf(4, null, "Tanggal Mulai Penyertaan",
				sv(C, 8, 8, date).confConditionalRequired(ER3014PosLbPnjk2100D1.genConditionA())));
		fs.add(sf(5, null, "Persentase Kepemilikan",
				sv(C, 3, 6, numericDot).confConditionalRequired(ER3014PosLbPnjk2100D1.genConditionA()))
				.addFieldValidations(ER3014PosLbPnjk2100D1.genFieldValidation05()));
		fs.add(sf(6, null, "Nilai Perolehan", sv(M, 1, 16, numeric)));
		fs.add(sf(7, null, "Jumlah Bulan Laporan",
				sv(C, 1, 16, numeric).confConditionalRequired(ER3014PosLbPnjk2100D1.genConditionA())));
		fs.add(sf(8, null, "CKPN-Individual",
				sv(C, 1, 16, numeric).confConditionalRequired(ER3014PosLbPnjk2100D1.genConditionB("9"))));
		fs.add(sf(9, null, "CKPN-Kolektif",
				sv(C, 1, 16, numeric).confConditionalRequired(ER3014PosLbPnjk2100D1.genConditionB("8"))));
		fs.add(sf(10, null, "Jumlah Neto", sv(M, 1, 16, numericNegatif))
				.addFieldValidations(ER3014PosLbPnjk2100D1.genFieldValidation10()));
		return res;
	}
}
