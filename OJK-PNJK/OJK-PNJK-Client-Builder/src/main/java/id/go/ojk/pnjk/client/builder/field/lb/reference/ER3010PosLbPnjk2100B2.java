...
public enum ER3010PosLbPnjk2100B2 implements IObject<KeyValueString> {
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER3010PosLbPnjk2100B2 eEnum : ER3010PosLbPnjk2100B2.values()) {
	...
	public static String getName() {
		return ER3010PosLbPnjk2100B2.class.getSimpleName().substring(6);
	}

	public static int getRefNumber() {
		return Integer.parseInt(ER3010PosLbPnjk2100B2.class.getSimpleName().substring(2, 6));
	}
