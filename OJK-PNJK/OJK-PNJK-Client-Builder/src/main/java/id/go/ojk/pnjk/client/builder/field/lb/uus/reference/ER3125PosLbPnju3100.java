...
public enum ER3125PosLbPnju3100 implements IObject<KeyValueString> {
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER3125PosLbPnju3100 eEnum : ER3125PosLbPnju3100.values()) {
	...
	public static String getName() {
		return ER3125PosLbPnju3100.class.getSimpleName().substring(6);
	}

	public static int getRefNumber() {
		return Integer.parseInt(ER3125PosLbPnju3100.class.getSimpleName().substring(2, 6));
	}
