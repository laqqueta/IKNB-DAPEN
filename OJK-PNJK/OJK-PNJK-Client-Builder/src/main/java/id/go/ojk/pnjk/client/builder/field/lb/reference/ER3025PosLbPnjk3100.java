...
public enum ER3025PosLbPnjk3100 implements IObject<KeyValueString> {
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER3025PosLbPnjk3100 eEnum : ER3025PosLbPnjk3100.values()) {
	...
	public static String getName() {
		return ER3025PosLbPnjk3100.class.getSimpleName().substring(6);
	}

	public static int getRefNumber() {
		return Integer.parseInt(ER3025PosLbPnjk3100.class.getSimpleName().substring(2, 6));
	}
