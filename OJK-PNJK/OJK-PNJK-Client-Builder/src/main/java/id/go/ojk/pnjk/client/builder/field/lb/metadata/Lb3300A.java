...
import id.go.ojk.pnjk.client.builder.field.lb.reference.ER3028PosLbPnjk3300A;
...
public class Lb3300A extends BaseMetadata {
	...
	public SubmissionFormat get() {
		...
		fs.add(sf(18, null, "Total-Jumlah Terjamin (Satuan)", sv(M, 1, 8, numeric))
				.addFieldValidations(ER3028PosLbPnjk3300A.genFieldValidation18()));
		fs.add(sf(19, null, "Total-Nilai Jaminan (Rp)", sv(M, 1, 16, numeric))
				.addFieldValidations(ER3028PosLbPnjk3300A.genFieldValidation19()));
		fs.add(sf(20, null, "Total-Nilai Klaim (Rp)", sv(M, 1, 16, numeric))
				.addFieldValidations(ER3028PosLbPnjk3300A.genFieldValidation20()));
		return res;
	}
}
