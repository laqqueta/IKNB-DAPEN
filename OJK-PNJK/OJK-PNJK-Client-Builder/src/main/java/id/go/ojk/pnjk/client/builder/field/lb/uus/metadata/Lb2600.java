...
import id.go.ojk.pnjk.client.builder.field.lb.uus.reference.ER3120PosLbPnju2600;
...
public class Lb2600 extends BaseMetadata {
	...
	public SubmissionFormat get() {
		...
		SubmissionFormat res = new SubmissionFormat(eEnum.getCode(), eEnum.getName(), reportCode, new ArrayList<>(),
				extension, 0, null, ER3120PosLbPnju2600.genFieldSave(), null, ER3120PosLbPnju2600.getRequiredPos());

        res.addSegmentValidations(ER3120PosLbPnju2600.genValidation1());
        res.addSegmentValidations(ER3120PosLbPnju2600.genValidation2());

		List<SubmissionField> fs = res.getFields();
		fs.add(sf(0, null, "Flag Detail", sv(M, 3, 3, alfaNumeric).confConstant("D01")));
		fs.add(sf(1, null, "Kode Komponen / Baris",
				sv(M, 10, 10, refTable).confReference(EHeaderMetadataLbUus.R3120_LB2600.getObject())));
		fs.add(sf(2, null, "Nama Penerima Jaminan (Makfuul Lahu)", sv(C, 1, 100, all)
                .confConditionalRequired(ER3120PosLbPnju2600.genConditionForTotal())));
