...
public enum ER3132PosLbPnju3500A implements IObject<KeyValueString> {
//	R_3500A10100 ("3500A10100", "Penerima Jaminan"),
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER3132PosLbPnju3500A eEnum : ER3132PosLbPnju3500A.values()) {
	...
	public String getKeyForm() {
		return EFormLaporanBulananUus.LB_3500A.getCode() + key;
	}
	...
	public static String getName() {
		return ER3132PosLbPnju3500A.class.getSimpleName().substring(6);
	}

	public static int getRefNumber() {
		return Integer.parseInt(ER3132PosLbPnju3500A.class.getSimpleName().substring(2, 6));
	}
