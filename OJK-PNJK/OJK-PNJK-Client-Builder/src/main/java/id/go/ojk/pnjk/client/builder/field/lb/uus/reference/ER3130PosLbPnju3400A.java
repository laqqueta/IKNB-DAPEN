...
public enum ER3130PosLbPnju3400A implements IObject<KeyValueString> {
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER3130PosLbPnju3400A eEnum : ER3130PosLbPnju3400A.values()) {
	...
	public static String getName() {
		return ER3130PosLbPnju3400A.class.getSimpleName().substring(6);
	}

	public static int getRefNumber() {
		return Integer.parseInt(ER3130PosLbPnju3400A.class.getSimpleName().substring(2, 6));
	}
