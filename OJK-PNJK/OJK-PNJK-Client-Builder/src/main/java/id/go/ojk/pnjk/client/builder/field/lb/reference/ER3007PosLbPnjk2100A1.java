...
public enum ER3007PosLbPnjk2100A1 implements IObject<KeyValueString> {
	R_2100A10100 ("2100A10100", "Detail"),
	R_2100A10000 ("2100A10000", "Total"),
	;
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER3007PosLbPnjk2100A1 eEnum : ER3007PosLbPnjk2100A1.values()) {
	...
	public static String getName() {
		return ER3007PosLbPnjk2100A1.class.getSimpleName().substring(6);
	}

	public static int getRefNumber() {
		return Integer.parseInt(ER3007PosLbPnjk2100A1.class.getSimpleName().substring(2, 6));
	}
	...
	public static String genFieldSave() {
		return UtilMetadata.genFieldSave("6|7|12|13|14", getObjects());
	}
	...
	public static SegmentValidation genValidation1() {
		int[] field = new int[] { 0 };
		return UtilSegmentValidation.genEqualsFormula("6|12|13|14", R_2100A10000.key,
				UtilMetadata.genPlusRow(getObjects(), field),
				UtilMetadata.genMessageTotal(R_2100A10000.value, R_2100A10100.value));
	}
}
