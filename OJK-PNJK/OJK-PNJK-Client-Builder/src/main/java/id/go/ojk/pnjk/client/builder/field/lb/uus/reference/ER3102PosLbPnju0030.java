...
public enum ER3102PosLbPnju0030 implements IObject<KeyValueString> {
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER3102PosLbPnju0030 eEnum : ER3102PosLbPnju0030.values()) {
	...
	public static String getName() {
		return ER3102PosLbPnju0030.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER3102PosLbPnju0030.class.getSimpleName().substring(2, 6));
	}
