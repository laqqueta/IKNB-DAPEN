...
public class SampleForm3300AUus extends BaseSampleForm {

	public SampleForm3300AUus(String folder, String periode, String ljk, String kodeKoreksi, int dataCount) {
		super(folder, periode, ljk, kodeKoreksi, dataCount);
	}

	@Override
	public String genFilename() {
		String filename = "LBPPNJU-3300A-{0}-M-{1}-{2}-03.txt";
		return genFilename(filename);
	}

	@Override
	public void writeHeader(BufferedWriter writer) throws IOException {
		final String[] HEADER = new String[] { "H01", "030403", "{ljk}", "{periode}", "LBPPNJU", "3300A",
				"{kodekoreksi}", "" };
	...
	public void writeDetail(BufferedWriter writer) throws IOException {
		String[] detail = new String[] { "D01", "3300A10100", "LO:e1101", "4", "5", "6", "7", "8", "9", "10", "11",
