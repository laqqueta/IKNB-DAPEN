...
AppName=PNJK Client
AppVersion=1.1.0
AppVerName=PNJK-Client 1.1.0
AppPublisher=OJK
AppComments=OJK PNJK Client
AppCopyright=Copyright (C) 2020
;AppPublisherURL=http://java.com/
;AppSupportURL=http://java.com/
;AppUpdatesURL=http://java.com/
DefaultDirName=C:\OJK-PNJK-Client
...
[Setup]
SetupMutex=PNJK-Client,Global\PNJK-Client
OutputDir="..\ftp\app"

[Icons]
Name: "{group}\PNJK-Client"; Filename: "{app}\OjkClient.exe"; IconFilename: "{app}\Client.ico"; Check: returnTrue()
Name: "{commondesktop}\PnjkClient"; Filename: "{app}\OjkClient.exe";  IconFilename: "{app}\Client.ico"; Check: returnFalse()    

[Run]
Filename: "{app}\OjkClient.exe"; Parameters: "-Xappcds:generatecache"; Check: returnFalse()
Filename: "{app}\OjkClient.exe"; Description: "{cm:LaunchProgram,PNJKClient}"; Flags: nowait postinstall skipifsilent; Check: returnTrue()
Filename: "{app}\OjkClient.exe"; Parameters: "-install -svcName ""PNJKClient"" -svcDesc ""PNJKClient"" -mainExe ""OjkClient.exe""  "; Check: returnFalse()

[UninstallRun]
Filename: "{app}\OjkClient.exe "; Parameters: "-uninstall -svcName PNJKClient -stopOnUninstall"; Check: returnFalse()
