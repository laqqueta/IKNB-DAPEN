...
public enum ER3002PosLbPnjs0030 implements IObject<KeyValueString> {
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER3002PosLbPnjs0030 eEnum : ER3002PosLbPnjs0030.values()) {
	...
	public static String getName() {
		return ER3002PosLbPnjs0030.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER3002PosLbPnjs0030.class.getSimpleName().substring(2, 6));
	}
	...
	public static SegmentValidation genValidation5() {
		return UtilSegmentValidation.genEqualsFormula("2|3", R_0030010000.key,
