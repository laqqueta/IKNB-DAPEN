...
//	R_13000102000000 ("13000102000000", "Arus Kas Keluar"),
	R_13000102010000 ("13000102010000", "Pembayaran IJK Co-Guarantee /IJP Penjaminan Ulang/Premi Reasuransi"),
...
//	R_13000301000000 ("13000301000000", "Arus Kas Masuk"),
	...
	R_13000301020000 ("13000301020000", "Penerbitan Sukuk Wajib Konversi"),
...
//	R_13000302000000 ("13000302000000", "Arus Kas Keluar"),
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER3006PosLbPnjs1300 eEnum : ER3006PosLbPnjs1300.values()) {
	...
	public static String getName() {
		return ER3006PosLbPnjs1300.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER3006PosLbPnjs1300.class.getSimpleName().substring(2, 6));
	}
