...
import id.go.ojk.pnjs.client.builder.field.lb.reference.ER3031PosLbPnjs3400B;
...
public class Lb3400B extends BaseMetadata {
	...
	public SubmissionFormat get() {
		...
		fs.add(sf(36, null, "Total-Jumlah Terjamin (Makfuul 'Anhu)-(Satuan)", sv(M, 1, 8, numeric))
				.addFieldValidations(ER3031PosLbPnjs3400B.genFieldValidation36()));
		fs.add(sf(37, null, "Total-Nilai Kafalah (Rp)", sv(M, 1, 16, numeric))
				.addFieldValidations(ER3031PosLbPnjs3400B.genFieldValidation37()));
		fs.add(sf(38, null, "Total-Nilai Klaim (Rp)", sv(M, 1, 16, numeric))
				.addFieldValidations(ER3031PosLbPnjs3400B.genFieldValidation38()));
		return res;
	}
}
