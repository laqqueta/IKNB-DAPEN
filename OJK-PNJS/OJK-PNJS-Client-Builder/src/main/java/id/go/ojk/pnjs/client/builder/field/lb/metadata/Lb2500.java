...
import id.go.ojk.pnjs.client.builder.field.lb.reference.ER3019PosLbPnjs2500;
...
public class Lb2500 extends BaseMetadata {
	...
	public SubmissionFormat get() {
		...
		SubmissionFormat res = new SubmissionFormat(eEnum.getCode(), eEnum.getName(), reportCode, new ArrayList<>(),
				extension, 0, null, ER3019PosLbPnjs2500.genFieldSave(), null, ER3019PosLbPnjs2500.getRequiredPos());

        res.addSegmentValidations(ER3019PosLbPnjs2500.genValidation1());
        res.addSegmentValidations(ER3019PosLbPnjs2500.genValidation2());
		...
		fs.add(sf(2, null, "Keterangan", sv(C, 1, 200, all)
                .confConditionalRequired(ER3019PosLbPnjs2500.genConditionForTotal())));
