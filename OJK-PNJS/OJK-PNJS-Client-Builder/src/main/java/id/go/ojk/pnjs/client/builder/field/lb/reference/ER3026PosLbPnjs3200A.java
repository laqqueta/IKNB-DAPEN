...
public enum ER3026PosLbPnjs3200A implements IObject<KeyValueString> {
	R_3200A10100 ("3200A10100", "Detail"),
	;
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER3026PosLbPnjs3200A eEnum : ER3026PosLbPnjs3200A.values()) {
	...
	public static String getName() {
		return ER3026PosLbPnjs3200A.class.getSimpleName().substring(6);
	}

	public static int getRefNumber() {
		return Integer.parseInt(ER3026PosLbPnjs3200A.class.getSimpleName().substring(2, 6));
	}
