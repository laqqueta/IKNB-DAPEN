...
public enum ER3027PosLbPnjs3200B implements IObject<KeyValueString> {
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER3027PosLbPnjs3200B eEnum : ER3027PosLbPnjs3200B.values()) {
	...
	public static String getName() {
		return ER3027PosLbPnjs3200B.class.getSimpleName().substring(6);
	}

	public static int getRefNumber() {
		return Integer.parseInt(ER3027PosLbPnjs3200B.class.getSimpleName().substring(2, 6));
	}
