...
public enum ER3015PosLbPnjs2100D2 implements IObject<KeyValueString> {
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER3015PosLbPnjs2100D2 eEnum : ER3015PosLbPnjs2100D2.values()) {
	...
	public static String getName() {
		return ER3015PosLbPnjs2100D2.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER3015PosLbPnjs2100D2.class.getSimpleName().substring(2, 6));
	}
