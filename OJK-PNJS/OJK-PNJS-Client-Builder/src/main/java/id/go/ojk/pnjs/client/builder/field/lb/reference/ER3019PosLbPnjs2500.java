...
public enum ER3019PosLbPnjs2500 implements IObject<KeyValueString> {
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER3019PosLbPnjs2500 eEnum : ER3019PosLbPnjs2500.values()) {
	...
	public static String getName() {
		return ER3019PosLbPnjs2500.class.getSimpleName().substring(6);
	}

	public static int getRefNumber() {
		return Integer.parseInt(ER3019PosLbPnjs2500.class.getSimpleName().substring(2, 6));
	}
    ...
    public static SegmentValidation genValidation2() {
        return UtilSegmentValidation.genEqualsFormAdd("3", R_2500000000.key, "2|2",
                ER3004PosLbPnjs1100.R_11000101110000.getKeyForm() + "|" + ER3004PosLbPnjs1100.R_11000102090000.getKeyForm(),
