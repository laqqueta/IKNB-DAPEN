...
import id.go.ojk.pnjs.client.builder.field.lb.reference.ER3033PosLbPnjs3500B;
...
public class Lb3500B extends BaseMetadata {
	...
	public SubmissionFormat get() {
		...
		SubmissionFormat res = new SubmissionFormat(eEnum.getCode(), eEnum.getName(), reportCode, new ArrayList<>(),
				extension, 4, 4, ER3033PosLbPnjs3500B.genFieldSave(), ER3033PosLbPnjs3500B.genFieldSave(),
				ER3033PosLbPnjs3500B.getRequiredPos());
		res.addSegmentValidations(ER3033PosLbPnjs3500B.genValidation5());
		...
		fs.add(sf(68, null, "Total-Pengajuan Klaim (Rp)", sv(M, 1, 16, numeric))
				.addFieldValidations(ER3033PosLbPnjs3500B.genFieldValidation68()));
		fs.add(sf(69, null, "Total-Klaim Diproses (Rp)", sv(M, 1, 16, numeric))
				.addFieldValidations(ER3033PosLbPnjs3500B.genFieldValidation69()));
		fs.add(sf(70, null, "Total-Klaim Disetujui (Rp)", sv(M, 1, 16, numeric))
				.addFieldValidations(ER3033PosLbPnjs3500B.genFieldValidation70()));
		fs.add(sf(71, null, "Total-Klaim Dibayar (Rp)", sv(M, 1, 16, numeric))
				.addFieldValidations(ER3033PosLbPnjs3500B.genFieldValidation71()));
		fs.add(sf(72, null, "Total-Klaim Ditolak (Rp)", sv(M, 1, 16, numeric))
				.addFieldValidations(ER3033PosLbPnjs3500B.genFieldValidation72()));
		fs.add(sf(73, null, "Total-Klaim Disetujui Namun Belum Dibayar (Rp)", sv(M, 1, 16, numeric))
				.addFieldValidations(ER3033PosLbPnjs3500B.genFieldValidation73()));
		return res;
	}
}
