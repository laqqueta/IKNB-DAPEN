...
import id.go.ojk.pnjs.client.builder.field.lb.reference.ER3013PosLbPnjs2100C2;
...
public class Lb2100C2 extends BaseMetadata {
	...
	public SubmissionFormat get() {
		...
		SubmissionFormat res = new SubmissionFormat(eEnum.getCode(), eEnum.getName(), reportCode, new ArrayList<>(),
				extension, 0, null, ER3013PosLbPnjs2100C2.genFieldSave(), ER3013PosLbPnjs2100C2.genFieldSaveForm(), ER3013PosLbPnjs2100C2.getRequiredPos());
		res.addSegmentValidations(ER3013PosLbPnjs2100C2.genValidation1());
		...
		fs.add(sf(2, null, "Jenis Investasi",
				sv(C, 1, 10, refTable).confRegex(PATTERN_REFERENCE_1)
						...
						.confConditionalRequired(ER3013PosLbPnjs2100C2.genConditionA())));
		fs.add(sf(3, null, "Alamat",
				sv(C, 1, 200, all).confConditionalRequired(ER3013PosLbPnjs2100C2.genConditionA())));
		...
		fs.add(sf(7, null, "CKPN-Individual",
				sv(C, 1, 16, numeric).confConditionalRequired(ER3013PosLbPnjs2100C2.genConditionB("8"))));
		fs.add(sf(8, null, "CKPN-Kolektif",
				sv(C, 1, 16, numeric).confConditionalRequired(ER3013PosLbPnjs2100C2.genConditionB("7"))));
		fs.add(sf(9, null, "Jumlah Neto", sv(M, 1, 16, numericNegatif))
				.addFieldValidations(ER3013PosLbPnjs2100C2.genFieldValidation9()));
		return res;
	}
}
