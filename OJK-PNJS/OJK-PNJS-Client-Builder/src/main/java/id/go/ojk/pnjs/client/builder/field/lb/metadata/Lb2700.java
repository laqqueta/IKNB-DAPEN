...
import id.go.ojk.pnjs.client.builder.field.lb.reference.ER3021PosLbPnjs2700;
...
public class Lb2700 extends BaseMetadata {
	...
	public SubmissionFormat get() {
		...
		SubmissionFormat res = new SubmissionFormat(eEnum.getCode(), eEnum.getName(), reportCode, new ArrayList<>(),
				extension, 0, null, ER3021PosLbPnjs2700.genFieldSave(), null,  ER3021PosLbPnjs2700.getRequiredPos());

        res.addSegmentValidations(ER3021PosLbPnjs2700.genValidation1());
        res.addSegmentValidations(ER3021PosLbPnjs2700.genValidation2());

		List<SubmissionField> fs = res.getFields();
		fs.add(sf(0, null, "Flag Detail", sv(M, 3, 3, alfaNumeric).confConstant("D01")));
		fs.add(sf(1, null, "Kode Komponen / Baris",
				sv(M, 10, 10, refTable).confReference(EHeaderMetadataLb.R3021_LB2700.getObject())));
		fs.add(sf(2, null, "Nama Terjamin (Makfuul 'Anhu)", sv(C, 1, 100, all)
                .confConditionalRequired(ER3021PosLbPnjs2700.genConditionTotal())));
