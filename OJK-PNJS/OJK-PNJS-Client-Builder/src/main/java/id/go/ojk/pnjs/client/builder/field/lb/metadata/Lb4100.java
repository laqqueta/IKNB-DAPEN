...
import id.go.ojk.pnjs.client.builder.field.lb.reference.ER3034PosLbPnjs4100;
...
public class Lb4100 extends BaseMetadata {
	...
	public SubmissionFormat get() {
		...
		SubmissionFormat res = new SubmissionFormat(eEnum.getCode(), eEnum.getName(), reportCode, new ArrayList<>(),
				extension, 5, 5, ER3034PosLbPnjs4100.genFieldSave(), null, ER3034PosLbPnjs4100.getRequiredPos());
		res.addSegmentValidations(ER3034PosLbPnjs4100.genValidation6());
