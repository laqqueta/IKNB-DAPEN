...
public enum ER3014PosLbPnjs2100D1 implements IObject<KeyValueString> {
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER3014PosLbPnjs2100D1 eEnum : ER3014PosLbPnjs2100D1.values()) {
	...
	public static String getName() {
		return ER3014PosLbPnjs2100D1.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER3014PosLbPnjs2100D1.class.getSimpleName().substring(2, 6));
	}
