...
import id.go.ojk.pnjs.client.builder.field.lb.reference.ER3018PosLbPnjs2400;
...
public class Lb2400 extends BaseMetadata {
	...
	public SubmissionFormat get() {
		...
		SubmissionFormat res = new SubmissionFormat(eEnum.getCode(), eEnum.getName(), reportCode, new ArrayList<>(),
				extension, 0, null, ER3018PosLbPnjs2400.genFieldSave(), ER3018PosLbPnjs2400.genFieldSave(), ER3018PosLbPnjs2400.getRequiredPos());

        res.addSegmentValidations(ER3018PosLbPnjs2400.genValidation1());
        res.addSegmentValidations(ER3018PosLbPnjs2400.genValidation2());

		List<SubmissionField> fs = res.getFields();
		fs.add(sf(0, null, "Flag Detail", sv(M, 3, 3, alfaNumeric).confConstant("D01")));
		fs.add(sf(1, null, "Kode Komponen / Baris",
				sv(M, 10, 10, refTable).confReference(EHeaderMetadataLb.R3018_LB2400.getObject())
                        .confConditionalRequired(ER3018PosLbPnjs2400.genConditionForTotal())));
