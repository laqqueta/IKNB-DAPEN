...
public enum ER3013PosLbPnjs2100C2 implements IObject<KeyValueString> {
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER3013PosLbPnjs2100C2 eEnum : ER3013PosLbPnjs2100C2.values()) {
	...
	public static String getName() {
		return ER3013PosLbPnjs2100C2.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER3013PosLbPnjs2100C2.class.getSimpleName().substring(2, 6));
	}
