...
import id.go.ojk.pnjs.client.builder.field.lb.reference.ER3026PosLbPnjs3200A;
...
public class Lb3200A extends BaseMetadata {
	...
	public SubmissionFormat get() {
		...
		fs.add(sf(18, null, "Total-Jumlah Terjamin (Makfuul 'Anhu) - (Satuan)", sv(M, 1, 8, numeric))
				.addFieldValidations(ER3026PosLbPnjs3200A.genFieldValidation18()));
		fs.add(sf(19, null, "Total-Nilai Kafalah (Rp)", sv(M, 1, 16, numeric))
				.addFieldValidations(ER3026PosLbPnjs3200A.genFieldValidation19()));
		fs.add(sf(20, null, "Total-Nilai Klaim (Rp)", sv(M, 1, 16, numeric))
				.addFieldValidations(ER3026PosLbPnjs3200A.genFieldValidation20()));
		return res;
	}
}
