...
public enum ER3032PosLbPnjs3500A implements IObject<KeyValueString> {
//	R_3500A10100 ("3500A10100", "Penerima Jaminan"),
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER3032PosLbPnjs3500A eEnum : ER3032PosLbPnjs3500A.values()) {
	...
	public static String getName() {
		return ER3032PosLbPnjs3500A.class.getSimpleName().substring(6);
	}

	public static int getRefNumber() {
		return Integer.parseInt(ER3032PosLbPnjs3500A.class.getSimpleName().substring(2, 6));
	}
