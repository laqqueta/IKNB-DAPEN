...
public enum ER3035PosLbPnjs5100 implements IObject<KeyValueString> {
...
//	R_5100030000 ("5100030000", "Rentabilitas", ""),
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER3035PosLbPnjs5100 eEnum : ER3035PosLbPnjs5100.values()) {
	...
	public static String getName() {
		return ER3035PosLbPnjs5100.class.getSimpleName().substring(6);
	}

	public static int getRefNumber() {
		return Integer.parseInt(ER3035PosLbPnjs5100.class.getSimpleName().substring(2, 6));
	}
	...
	private static String getLookup() {
		...
		ER3035PosLbPnjs5100[] eEnums = ER3035PosLbPnjs5100.values();
		int enumLength = eEnums.length;
		for (int i = 0; i < enumLength; i++) {
			ER3035PosLbPnjs5100 eEnum = ER3035PosLbPnjs5100.values()[i];
