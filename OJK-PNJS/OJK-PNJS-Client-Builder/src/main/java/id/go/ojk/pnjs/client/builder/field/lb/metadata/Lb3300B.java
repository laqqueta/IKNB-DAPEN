...
import id.go.ojk.pnjs.client.builder.field.lb.reference.ER3029PosLbPnjs3300B;
...
public class Lb3300B extends BaseMetadata {
	...
	public SubmissionFormat get() {
		...
		fs.add(sf(36, null, "Total-Jumlah Terjamin (Makfuul Lahu)-(Satuan)", sv(M, 1, 8, numeric))
				.addFieldValidations(ER3029PosLbPnjs3300B.genFieldValidation36()));
		fs.add(sf(37, null, "Total-Nilai Kafalah (Rp)", sv(M, 1, 16, numeric))
				.addFieldValidations(ER3029PosLbPnjs3300B.genFieldValidation37()));
		fs.add(sf(38, null, "Total-Nilai Klaim (Rp)", sv(M, 1, 16, numeric))
				.addFieldValidations(ER3029PosLbPnjs3300B.genFieldValidation38()));
		return res;
	}
}
