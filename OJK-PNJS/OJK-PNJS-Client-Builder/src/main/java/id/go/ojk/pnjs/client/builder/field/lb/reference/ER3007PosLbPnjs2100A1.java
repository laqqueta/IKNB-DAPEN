...
public enum ER3007PosLbPnjs2100A1 implements IObject<KeyValueString> {
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER3007PosLbPnjs2100A1 eEnum : ER3007PosLbPnjs2100A1.values()) {
	...
	public static String getName() {
		return ER3007PosLbPnjs2100A1.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER3007PosLbPnjs2100A1.class.getSimpleName().substring(2, 6));
	}
