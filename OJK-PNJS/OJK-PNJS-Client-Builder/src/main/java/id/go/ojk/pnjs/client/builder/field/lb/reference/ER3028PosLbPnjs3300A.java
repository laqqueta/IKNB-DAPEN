...
public enum ER3028PosLbPnjs3300A implements IObject<KeyValueString> {
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER3028PosLbPnjs3300A eEnum : ER3028PosLbPnjs3300A.values()) {
	...
	public static String getName() {
		return ER3028PosLbPnjs3300A.class.getSimpleName().substring(6);
	}

	public static int getRefNumber() {
		return Integer.parseInt(ER3028PosLbPnjs3300A.class.getSimpleName().substring(2, 6));
	}
