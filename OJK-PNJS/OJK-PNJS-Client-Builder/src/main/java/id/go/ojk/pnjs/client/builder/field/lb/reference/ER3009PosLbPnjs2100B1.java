...
public enum ER3009PosLbPnjs2100B1 implements IObject<KeyValueString> {
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER3009PosLbPnjs2100B1 eEnum : ER3009PosLbPnjs2100B1.values()) {
	...
	public static String getName() {
		return ER3009PosLbPnjs2100B1.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER3009PosLbPnjs2100B1.class.getSimpleName().substring(2, 6));
	}
