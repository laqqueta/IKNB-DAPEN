...
import id.go.ojk.pnjs.client.builder.field.lb.reference.ER3036PosLbPnjs6100;
...
public class Lb6100 extends BaseMetadata {
	...
	public SubmissionFormat get() {
		...
		SubmissionFormat res = new SubmissionFormat(eEnum.getCode(), eEnum.getName(), reportCode, new ArrayList<>(),
				extension, 4, 4, ER3036PosLbPnjs6100.genFieldSave(), ER3036PosLbPnjs6100.genFieldSave(), 
				ER3036PosLbPnjs6100.getRequiredPos());
		res.addSegmentValidations(ER3036PosLbPnjs6100.genValidation6());
