...
public enum ER3020PosLbPnjs2600 implements IObject<KeyValueString> {
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER3020PosLbPnjs2600 eEnum : ER3020PosLbPnjs2600.values()) {
	...
	public static String getName() {
		return ER3020PosLbPnjs2600.class.getSimpleName().substring(6);
	}

	public static int getRefNumber() {
		return Integer.parseInt(ER3020PosLbPnjs2600.class.getSimpleName().substring(2, 6));
	}
    ...
    public static SegmentValidation genValidation2() {
        return UtilSegmentValidation.genEqualsFormAdd("6", R_2600000000.key, "2|2",
                ER3004PosLbPnjs1100.R_11000201060000.getKeyForm() + "|" + ER3004PosLbPnjs1100.R_11000202060000.getKeyForm(),
