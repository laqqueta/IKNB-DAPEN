...
public enum ER3031PosLbPnjs3400B implements IObject<KeyValueString> {
	R_3400B10100 ("3400B10100", "Detail"),
	;
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER3031PosLbPnjs3400B eEnum : ER3031PosLbPnjs3400B.values()) {
	...
	public static String getName() {
		return ER3031PosLbPnjs3400B.class.getSimpleName().substring(6);
	}

	public static int getRefNumber() {
		return Integer.parseInt(ER3031PosLbPnjs3400B.class.getSimpleName().substring(2, 6));
	}
