...
public enum ER1165KategoriUsahaKeuanganBerkelanjutan implements IObject<KeyValueString> {
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER1165KategoriUsahaKeuanganBerkelanjutan eEnum : ER1165KategoriUsahaKeuanganBerkelanjutan.values()) {
	...
	public static String getName() {
		return ER1165KategoriUsahaKeuanganBerkelanjutan.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER1165KategoriUsahaKeuanganBerkelanjutan.class.getSimpleName().substring(2, 6));
	}
	...
	public static String getLookup() {
		...
		ER1165KategoriUsahaKeuanganBerkelanjutan[] eEnums = ER1165KategoriUsahaKeuanganBerkelanjutan.values();
		int enumLength = eEnums.length;
		for (int i= 0; i < enumLength; i++) {
			ER1165KategoriUsahaKeuanganBerkelanjutan eEnum = ER1165KategoriUsahaKeuanganBerkelanjutan.values()[i];
