...
public enum ER1180JenisValuta implements IObject<KeyValueString> {
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER1180JenisValuta eEnum : ER1180JenisValuta.values()) {
	...
	public static String getName() {
		return ER1180JenisValuta.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER1180JenisValuta.class.getSimpleName().substring(2, 6));
	}
	...
	public static String getLookup() {
		...
		ER1180JenisValuta[] eEnums = ER1180JenisValuta.values();
		int enumLength = eEnums.length;
		for (int i= 0; i < enumLength; i++) {
			ER1180JenisValuta eEnum = ER1180JenisValuta.values()[i];
