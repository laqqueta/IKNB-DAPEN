...
public enum ER1086SaluranDistribusiAtauPemasaran implements IObject<KeyValueString> {
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER1086SaluranDistribusiAtauPemasaran eEnum : ER1086SaluranDistribusiAtauPemasaran.values()) {
	...
	public static String getName() {
		return ER1086SaluranDistribusiAtauPemasaran.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER1086SaluranDistribusiAtauPemasaran.class.getSimpleName().substring(2, 6));
	}
}
