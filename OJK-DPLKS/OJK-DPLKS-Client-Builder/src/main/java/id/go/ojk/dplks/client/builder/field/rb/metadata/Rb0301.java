...
import id.go.ojk.dplks.client.builder.field.rb.reference.ER2003PosRbDplks0301;
...
public class Rb0301 extends BaseMetadata {
	...
	public SubmissionFormat get() {
		...
		SubmissionFormat res = new SubmissionFormat(eEnum.getCode(), eEnum.getName(), reportCode, new ArrayList<>(),
				extension, 8, 8, null, null, ER2003PosRbDplks0301.getRequiredPos());
		res.addSegmentValidations(ER2003PosRbDplks0301.genValidationNumericNegatif());
		res.addSegmentValidations(ER2003PosRbDplks0301.genValidationNumericDotNegatif());
		...
		fs.add(sf(4, null, "%", sv(M, 1, 16, numericDotNegatif))
				.addFieldValidations(ER2003PosRbDplks0301.genValidationRatio()));
		return res;
	}
}
