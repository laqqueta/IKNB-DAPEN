...
import id.go.ojk.dplks.client.builder.field.rb.reference.ER2009PosRbDplks0801;
...
public class Rb0801 extends BaseMetadata {
	...
	public SubmissionFormat get() {
		...
		SubmissionFormat res = new SubmissionFormat(eEnum.getCode(), eEnum.getName(), reportCode, new ArrayList<>(),
				extension, 3, 3, ER2009PosRbDplks0801.genFieldSave(), null, ER2009PosRbDplks0801.getRequiredPos());
		res.addSegmentValidations(ER2009PosRbDplks0801.genValidationTotalDanaIuran());
