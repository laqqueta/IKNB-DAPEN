...
import id.go.ojk.dplks.client.builder.field.rb.reference.ER2018PosRbDplks1203;
...
public class Rb1203 extends BaseMetadata {
	...
	public SubmissionFormat get() {
		...
		SubmissionFormat res = new SubmissionFormat(eEnum.getCode(), eEnum.getName(), reportCode, new ArrayList<>(),
				extension, 3, null, null, null, ER2018PosRbDplks1203.getRequiredPos());
		res.addSegmentValidations(ER2018PosRbDplks1203.genValidationNumericNegatif());
		res.addSegmentValidations(ER2018PosRbDplks1203.genValidationNumericDotNegatif());
		res.addSegmentValidations(ER2018PosRbDplks1203.genValidationDecimalMaxLength10());
		res.addSegmentValidations(ER2018PosRbDplks1203.genValidationDecimalMaxLength16());
		...
		fs.add(sf(2, null, "Asumsi Lain yang Relevan",
				sv(C, 0, 200, all).confConditionalRequired(ER2018PosRbDplks1203.genConditionalMustEmpty())));
