...
public enum ER2020PosReDplks0100 implements IObject<KeyValueString> {
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER2020PosReDplks0100 eEnum : ER2020PosReDplks0100.values()) {
	...
	public static String getName() {
		return ER2020PosReDplks0100.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER2020PosReDplks0100.class.getSimpleName().substring(2, 6));
	}
