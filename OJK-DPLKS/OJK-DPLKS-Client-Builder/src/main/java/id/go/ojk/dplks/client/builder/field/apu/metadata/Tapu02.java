...
import id.go.ojk.dplks.client.builder.field.apu.reference.ER5001PosApuDplks02;
...
public class Tapu02 extends BaseMetadata {
	...
	public SubmissionFormat get() {
		...
		SubmissionFormat res = new SubmissionFormat(eEnum.getCode(), eEnum.getName(), reportCode,
				new ArrayList<SubmissionField>(), extension, 24, 24, null, null, ER5001PosApuDplks02.getRequiredPos());
		...
		fs.add(sf(2, null, "Penilaian", sv(M, 1, 1, numeric))
				.addFieldValidations(ER5001PosApuDplks02.genValidationPenilaian()));
