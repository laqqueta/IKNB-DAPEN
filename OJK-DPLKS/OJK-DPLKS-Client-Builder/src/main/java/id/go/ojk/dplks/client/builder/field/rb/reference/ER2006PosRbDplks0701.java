...
public enum ER2006PosRbDplks0701 implements IObject<KeyValueString> {
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER2006PosRbDplks0701 eEnum : ER2006PosRbDplks0701.values()) {
	...
	public static String getName() {
		return ER2006PosRbDplks0701.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER2006PosRbDplks0701.class.getSimpleName().substring(2, 6));
	}
	...
	public static SegmentValidation genValidationInvestasi() {
		return UtilSegmentValidation.genEqualsFormula("2|4|6|8", R_0701012100.key, UtilMetadata.genPlusRow(getObjects(), 0, 19),
