...
import id.go.ojk.dplks.client.builder.field.sa.reference.ER4004PosSaDplks0400;
...
public class Sa0400 extends BaseMetadata {
	...
	public SubmissionFormat get() {
		...
		SubmissionFormat res = new SubmissionFormat(eEnum.getCode(), eEnum.getName(), reportCode, new ArrayList<>(),
				extension, 2, 2, ER4004PosSaDplks0400.getRequiredPos(), true);
		List<SubmissionField> fs = res.getFields();
		fs.add(sf(0, null, "Flag Detail", sv(M, 3, 3, alfaNumeric).confConstant("D01")));
		fs.add(sf(1, null, "Kode Komponen / Baris",
				sv(M, 10, 10, refTable).confReference(EHeaderMetadataSa.R4004_SA0400.getObject())).confUnique(U));
		fs.add(sf(2, null, "Analisis", sv(M, 1, 1, numeric))
				.addFieldValidations(ER4004PosSaDplks0400.genValidationPeringkat()));
