...
import id.go.ojk.dplks.client.builder.field.rb.reference.ER2008PosRbDplks0703;
...
public class Rb0703 extends BaseMetadata {
	...
	public SubmissionFormat get() {
		EFormRencanaBisnis eEnum = EFormRencanaBisnis.RB_0703;
		SubmissionFormat res = new SubmissionFormat(eEnum.getCode(), eEnum.getName(), reportCode, new ArrayList<>(),
				extension, 21, 21, ER2008PosRbDplks0703.genFieldSave(), null, ER2008PosRbDplks0703.getRequiredPos());
		res.addSegmentValidations(ER2008PosRbDplks0703.genValidationTotal());
		List<SubmissionField> fs = res.getFields();
		fs.add(sf(0, null, "Flag Detail", sv(M, 3, 3, alfaNumeric).confConstant("D01")));
		fs.add(sf(1, null, "Kode Komponen / Baris",
				sv(M, 10, 10, refTable).confReference(EHeaderMetadataRb.R2008_RB0703.getObject())).confUnique(U));
		...
		fs.add(sf(5, null, "Hasil Investasi Bersih Aktual Per 30 Sept 20XX-1", sv(M, 1, 20, numericNegatif))
				.addFieldValidations(ER2008PosRbDplks0703.genValidation5()));
		...
		fs.add(sf(9, null, "Hasil Investasi Bersih Proyeksi Per 31 Des 20XX-1", sv(M, 1, 20, numericNegatif))
				.addFieldValidations(ER2008PosRbDplks0703.genValidation9()));
		...
		fs.add(sf(13, null, "Hasil Investasi Bersih Proyeksi Per 30 Jun 20XX", sv(M, 1, 20, numericNegatif))
				.addFieldValidations(ER2008PosRbDplks0703.genValidation13()));
		...
		fs.add(sf(17, null, "Hasil Investasi Bersih Proyeksi Per 31 Des 20XX", sv(M, 1, 20, numericNegatif))
				.addFieldValidations(ER2008PosRbDplks0703.genValidation17()));
		return res;
	}
}
