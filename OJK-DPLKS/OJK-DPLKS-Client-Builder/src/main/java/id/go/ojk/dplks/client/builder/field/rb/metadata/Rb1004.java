...
import id.go.ojk.dplks.client.builder.field.rb.reference.ER2015PosRbDplks1004;
...
public class Rb1004 extends BaseMetadata {
	...
	public SubmissionFormat get() {
		...
		fs.add(sf(3, null, "Kepemilikan (inhouse/ vendor)",
				sv(C, 1, 50, all).confConditionalRequired(ER2015PosRbDplks1004.genConditionalAllExist())));
		fs.add(sf(4, null, "Nama Vendor",
				sv(C, 1, 300, all).confConditionalRequired(ER2015PosRbDplks1004.genConditionalAllExist())));
