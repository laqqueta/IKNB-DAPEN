...
import id.go.ojk.dplks.client.builder.field.rb.reference.ER2004PosRbDplks0403;
...
public class Rb0403 extends BaseMetadata {
	...
	public SubmissionFormat get() {
		...
		fs.add(sf(3, null, "Kebijakan",
				sv(C, 0, 300, all).confConditionalRequired(ER2004PosRbDplks0403.genConditionalAllExist())));
