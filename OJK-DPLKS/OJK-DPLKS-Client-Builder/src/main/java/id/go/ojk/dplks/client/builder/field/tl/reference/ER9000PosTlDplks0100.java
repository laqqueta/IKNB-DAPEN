...
public enum ER9000PosTlDplks0100 implements IObject<KeyValueString> {
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER9000PosTlDplks0100 eEnum : ER9000PosTlDplks0100.values()) {
	...
	public static String getName() {
		return ER9000PosTlDplks0100.class.getSimpleName().substring(6);
	}

	public static int getRefNumber() {
		return Integer.parseInt(ER9000PosTlDplks0100.class.getSimpleName().substring(2, 6));
	}
