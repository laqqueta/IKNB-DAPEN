package id.go.ojk.dplks.client.builder.field.lblt;
...
//                /* Dppk0007Kup.formMetadata(sectorType, programType), -> unused in DPLK */
...
//                /* Dppk0101Roimpl.formMetadata(sectorType, programType), -> unused in DPLK */
...
//                Dppk0016Sbn.formMetadata(sectorType, programType),
                ...
                Dppk0102Pinv.formMetadata(sectorType, programType),
                Dppk0103Pinvs.formMetadata(sectorType, programType),
                Dppk0104Mpbk.formMetadata(sectorType, programType),
                Dppk0105Pmbk.formMetadata(sectorType, programType),
