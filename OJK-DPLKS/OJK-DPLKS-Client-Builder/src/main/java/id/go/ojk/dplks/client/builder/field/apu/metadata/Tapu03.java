...
import id.go.ojk.dplks.client.builder.field.apu.reference.ER5002PosApuDplks03;
...
public class Tapu03 extends BaseMetadata {
	...
	public SubmissionFormat get() {
		...
		SubmissionFormat res = new SubmissionFormat(eEnum.getCode(), eEnum.getName(), reportCode,
				new ArrayList<>(), extension, 1, 1, null, null, ER5002PosApuDplks03.getRequiredPos());
		...
		fs.add(sf(2, null, "Jawaban", sv(M, 1, 1, numeric))
				.addFieldValidations(ER5002PosApuDplks03.genValidationKepemilikan()));
		return res;
	}
}
