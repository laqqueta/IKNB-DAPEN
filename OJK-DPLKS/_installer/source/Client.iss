...
[Setup]
AppId=DPLKSClient
AppName=DPLKS Client
AppVersion=3.3.3
AppVerName=DPLKS-Client 3.3.3
AppPublisher=OJK
AppComments=OJK DPLKS Client
AppCopyright=Copyright (C) 2020
;AppPublisherURL=http://java.com/
;AppSupportURL=http://java.com/
;AppUpdatesURL=http://java.com/
DefaultDirName=C:\OJK-DPLKS-Client
...
[Setup]
SetupMutex=DPLKS-Client,Global\DPLKS-Client
OutputDir="..\ftp\app"

[Icons]
Name: "{group}\DPLKS-Client"; Filename: "{app}\OjkClient.exe"; IconFilename: "{app}\Client.ico"; Check: returnTrue()
Name: "{commondesktop}\DplksClient"; Filename: "{app}\OjkClient.exe";  IconFilename: "{app}\Client.ico"; Check: returnFalse()    

[Run]
Filename: "{app}\OjkClient.exe"; Parameters: "-Xappcds:generatecache"; Check: returnFalse()
Filename: "{app}\OjkClient.exe"; Description: "{cm:LaunchProgram,DPLKSClient}"; Flags: nowait postinstall skipifsilent; Check: returnTrue()
Filename: "{app}\OjkClient.exe"; Parameters: "-install -svcName ""DPLKSClient"" -svcDesc ""DPLKSClient"" -mainExe ""OjkClient.exe""  "; Check: returnFalse()

[UninstallRun]
Filename: "{app}\OjkClient.exe "; Parameters: "-uninstall -svcName DPLKSClient -stopOnUninstall"; Check: returnFalse()
