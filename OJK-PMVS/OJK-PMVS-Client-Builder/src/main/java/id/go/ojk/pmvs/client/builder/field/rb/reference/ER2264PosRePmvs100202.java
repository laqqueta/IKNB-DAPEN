...
public enum ER2264PosRePmvs100202 implements IObject<KeyValueString> {
...
//	R_10020203000000 ("10020203000000", "EKUITAS"),
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER2264PosRePmvs100202 eEnum : ER2264PosRePmvs100202.values()) {
	...
	public static String getName() {
		return ER2264PosRePmvs100202.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER2264PosRePmvs100202.class.getSimpleName().substring(2, 6));
	}
