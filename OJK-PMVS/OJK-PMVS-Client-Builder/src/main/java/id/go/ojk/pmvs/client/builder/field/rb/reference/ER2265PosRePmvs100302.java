...
public enum ER2265PosRePmvs100302 implements IObject<KeyValueString> {
...
//	R_10030204000000000000 ("10030204000000000000", "TAKSIRAN PAJAK PENGHASILAN"),
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER2265PosRePmvs100302 eEnum : ER2265PosRePmvs100302.values()) {
	...
	public static String getName() {
		return ER2265PosRePmvs100302.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER2265PosRePmvs100302.class.getSimpleName().substring(2, 6));
	}
	...
	public static SegmentValidation genValidationFormKeuntunganPendapatanKomprehensifLainnya() {
		...
		return UtilSegmentValidation.genEqualsForm2("2|3", R_10030206000000000000.key, comparatorFormCode, 
				ER2264PosRePmvs100202.R_10020203050200.getKey(), 
