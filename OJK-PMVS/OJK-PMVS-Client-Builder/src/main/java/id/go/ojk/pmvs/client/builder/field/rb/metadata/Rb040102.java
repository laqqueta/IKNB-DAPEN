...
import id.go.ojk.pmvs.client.builder.field.rb.reference.ER2001PosRbPmvs040102;
...
public class Rb040102 extends BaseMetadata {
	...
	public SubmissionFormat get() {
		...
		SubmissionFormat res = new SubmissionFormat(eEnum.getCode(), eEnum.getName(), reportCode, new ArrayList<>(),
				extension, 12, 12, ER2001PosRbPmvs040102.genFieldSave(), ER2001PosRbPmvs040102.genFieldSave(),
				ER2001PosRbPmvs040102.getRequiredPos());
		res.addSegmentValidations(
				ER2001PosRbPmvs040102.genValidationTotalRencanaInvestasiModalVenturaBerdasarkanPrinsipSyariahBaru());
		res.addSegmentValidations(ER2001PosRbPmvs040102.genValidationTotalSaldoPosisi());
