...
import id.go.ojk.pmvs.client.builder.field.EUpdateHeader;
import id.go.ojk.pmvs.client.builder.field.setup.ESetupKeyValueStringFilename;
import lombok.extern.slf4j.Slf4j;

@Slf4j
public class PmvsDatBuilder extends BaseDatBuilder {
	private static final EReport REPORT_RB = EReport.RB_PMVS;
	private static final EReport REPORT_APU = EReport.APU_PMVS;
	private static final String DUMMY_USER = "pmvsdummy@gmail.com";

	public static void main(String[] args) {
		try {
			log.info("starting builder");
			PmvsDatBuilder builder = new PmvsDatBuilder(args);
	...
	public PmvsDatBuilder(String[] args) {
	...
	protected String genDummyClientEntity() {
		return genDummyClientEntity(Constant.SECTOR.getCode(), Arrays.asList("2000000369"), DUMMY_USER);
	}
