package id.go.ojk.pmvs.client.builder.field.apu.reference;
...
public enum ER5001PosApuPmvs02 implements IObject<KeyValueString> {
//	R_0201000000 ("0201000000", "1. PENGAWASAN AKTIF DIREKSI DAN DEWAN KOMISARIS"),
	...
	R_0201040000 ("0201040000", "PADK 4. Apakah direksi pernah memberikan arahan kepada fungsi internal audit untuk dilakukan  pemeriksaan atas kepatuhan unit kerja di Perusahaan dalam menerapkan program APU PPT "),
	...
	R_0201100000 ("0201100000", "PADK 10. Apakah Perusahaan pernah menerima transaksi pembayaran tunai (TKT) lebih dari Rp500 juta dalam sehari oleh debitur?  "),
	...
	R_0201120000 ("0201120000", "PADK 12. Apakah Perusahaan telah melakukan pendaftaran pada sistem GoAML/SIPESAT PPATK?"),
//	R_0202000000 ("0202000000", "2. KEBIJAKAN DAN PROSEDUR"),
	...
	R_0202040000 ("0202040000", "KP 4. Apakah dalam pedoman/kebijakan penerapan program APU dan PPT Perusahaan telah tercantum kebijakan mengenai pengelolaan risiko pencucian uang dan/atau pendanaan terorisme yang berkelanjutan terkait nasabah, negara, produk dan jasa, serta jaringan distribusi (distribution channels) "),
...
//	R_0203000000 ("0203000000", "3. PENGENDALIAN INTERN"),
	...
	R_0203020000 ("0203020000", "PI 2. Apakah pemeriksaan terkait aspek penerapan program APUPPT dilakukan setiap tahun?"),
...
//	R_0205000000 ("0205000000", "5. SUMBER DAYA MANUSIA DAN PELATIHAN"),
	...
	R_0205020000 ("0205020000", "SDM 2. Apakah Perusahaan mengikutsertakan karyawan/pejabat dalam pelatihan terkait APUPPT setiap tahun? Berapa jumlah pelatihan APU PPT yang dikuti setiap tahunnya?"),
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER5001PosApuPmvs02 eEnum : ER5001PosApuPmvs02.values()) {
	...
	public static String getName() {
		return ER5001PosApuPmvs02.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER5001PosApuPmvs02.class.getSimpleName().substring(2, 6));
	}
