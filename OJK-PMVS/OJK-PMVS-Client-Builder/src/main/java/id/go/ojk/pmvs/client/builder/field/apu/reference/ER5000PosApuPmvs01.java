...
public enum ER5000PosApuPmvs01 implements IObject<KeyValueString> {
...
//	R_0102000000000000 ("0102000000000000", "II. PRODUK DAN JASA"),
	R_0102010000000000 ("0102010000000000", "A. Produk/Jasa Lainnya (selain Penyertaan Saham (Equity Participation); Penyertaan Melalui Pembelian Obligasi Konversi (Quasi Equity Participation); Pembiayaan Melalui Pembelian Surat Utang;Pembiayaan Usaha Produktif)"),
//	R_0103000000000000 ("0103000000000000", "III. SALURAN DISTRIBUSI"),
//	R_0103010000000000 ("0103010000000000", " A. Tatap Muka"),
	R_0103010100000000 ("0103010100000000", "  1) Pembayaran melalui Kasir/Counter di Kantor Perusahaan Modal Ventura"),
...
//	R_0103020000000000 ("0103020000000000", " B. Tidak Tatap Muka"),
	...
	R_0103020300000000 ("0103020300000000", "  3) Pembayaran melalui Agen (Misalnya melalui minimarket, kantor pos, dll)"),
//	R_0103020400000000 ("0103020400000000", "  4) Pembayaran melalui Cara Tidak Tatap Muka Lainnya:"),
	R_0103020401000000 ("0103020401000000", "   a) virtual account"),
	R_0103020402000000 ("0103020402000000", "   b) Aplikasi web (tokopedia/ovo/link aja dll)"),
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER5000PosApuPmvs01 eEnum : ER5000PosApuPmvs01.values()) {
	...
	public static String getName() {
		return ER5000PosApuPmvs01.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER5000PosApuPmvs01.class.getSimpleName().substring(2, 6));
	}
