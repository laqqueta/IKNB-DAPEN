...
public enum ER2016PosRbPmvs100402 implements IObject<KeyValueString> {
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER2016PosRbPmvs100402 eEnum : ER2016PosRbPmvs100402.values()) {
	...
	public static String getName() {
		return ER2016PosRbPmvs100402.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER2016PosRbPmvs100402.class.getSimpleName().substring(2, 6));
	}
	...
	public static SegmentValidation genValidationFormKasDanSetaraKasPadaAkhirPeriode() {
		...
		return UtilSegmentValidation.genEqualsForm2("2|3|4|5", R_10040207000000.key, comparatorFormCode, 
				ER2014PosRbPmvs100202.R_10020201010000.getKey(), 
