...
public enum ER2009PosRbPmvs080000 implements IObject<KeyValueString> {
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER2009PosRbPmvs080000 eEnum : ER2009PosRbPmvs080000.values()) {
	...
	public static String getName() {
		return ER2009PosRbPmvs080000.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER2009PosRbPmvs080000.class.getSimpleName().substring(2, 6));
	}
