...
import id.go.ojk.pmvs.client.builder.field.rb.reference.ER2256PosRePmvs060100;
...
public class Re060100 extends BaseMetadata {
	...
	public SubmissionFormat get() {
		...
		SubmissionFormat res = new SubmissionFormat(eEnum.getCode(), eEnum.getName(), reportCode, new ArrayList<>(),
				extension, 4, null, null, null, ER2256PosRePmvs060100.getRequiredPos());
		...
		fs.add(sf(2, null, "Nama Pemegang Saham", sv(C, 1, 160, alfaNumericSpace)
				.confConditionalRequired(ER2256PosRePmvs060100.genValidationMustEmpty())));
		...
		fs.add(sf(6, null, "Deviasi", sv(M, 1, 16, numericNegatif))
				.addFieldValidations(ER2256PosRePmvs060100.genValidationField6()));
		return res;
	}
}
