...
public enum ER2015PosRbPmvs100302 implements IObject<KeyValueString> {
...
//	R_10030204000000000000 ("10030204000000000000", "TAKSIRAN PAJAK PENGHASILAN"),
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER2015PosRbPmvs100302 eEnum : ER2015PosRbPmvs100302.values()) {
	...
	public static String getName() {
		return ER2015PosRbPmvs100302.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER2015PosRbPmvs100302.class.getSimpleName().substring(2, 6));
	}
	...
	public static SegmentValidation genValidationFormKeuntunganPendapatanKomprehensifLainnya() {
		...
		return UtilSegmentValidation.genEqualsForm2("2|3|4|5", R_10030206000000000000.key, comparatorFormCode, 
				ER2014PosRbPmvs100202.R_10020203050200.getKey(), 
