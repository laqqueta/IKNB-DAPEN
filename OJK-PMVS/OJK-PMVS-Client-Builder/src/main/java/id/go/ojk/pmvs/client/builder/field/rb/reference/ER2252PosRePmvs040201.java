...
public enum ER2252PosRePmvs040201 implements IObject<KeyValueString> {
...
//	R_04020102000000 ("04020102000000", "Saldo Posisi (Outstanding Principal):"),
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER2252PosRePmvs040201 eEnum : ER2252PosRePmvs040201.values()) {
	...
	public static String getName() {
		return ER2252PosRePmvs040201.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER2252PosRePmvs040201.class.getSimpleName().substring(2, 6));
	}
	...
	public static SegmentValidation genValidationFormTotalRencanaPenyaluranPembiayaanBaru() {
		String comparatorFormCode = EFormRealisasiBisnis.RE_040102.getCode();
		return UtilSegmentValidation.genEqualsForm2("2|3", R_04020101030000.key, comparatorFormCode, 
				ER2251PosRePmvs040102.R_04010201060000.getKey(), 
	...
	public static SegmentValidation genValidationFormTotalSaldoPosisi() {
		...
		return UtilSegmentValidation.genEqualsForm2("2|3", R_04020102030000.key, comparatorFormCode, 
				ER2251PosRePmvs040102.R_04010202060000.getKey(), 
