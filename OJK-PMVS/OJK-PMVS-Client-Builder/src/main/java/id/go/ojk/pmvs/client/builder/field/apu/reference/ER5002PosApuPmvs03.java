...
public enum ER5002PosApuPmvs03 implements IObject<KeyValueString> {
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER5002PosApuPmvs03 eEnum : ER5002PosApuPmvs03.values()) {
	...
	public static String getName() {
		return ER5002PosApuPmvs03.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER5002PosApuPmvs03.class.getSimpleName().substring(2, 6));
	}
