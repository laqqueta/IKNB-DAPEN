...
import id.go.ojk.pmvs.client.builder.field.rb.reference.ER2009PosRbPmvs080000;
	...
	public SubmissionFormat get() {
		...
		fs.add(sf(3, null, "Jenis Kantor",
				sv(C, 0, 10, refTable).confReference(EHeaderMetadataShared.R006.getObject())
						.confConditionalRequired(ER2009PosRbPmvs080000.genConditionalField3()))
				.addFieldValidations(ER2009PosRbPmvs080000.genValidationField3()));
		fs.add(sf(4, null, "Waktu Pelaksanaan",
				sv(C, 0, 10, yearMonth).confConditionalRequired(ER2009PosRbPmvs080000.genConditionalField4())));
		fs.add(sf(5, null, "Perkiraan Investasi/Biaya",
				sv(C, 0, 16, numericNegatif).confConditionalRequired(ER2009PosRbPmvs080000.genConditionalField5())));
		fs.add(sf(6, null, "Lokasi",
				sv(C, 0, 10, refTable).confConditionalRequired(ER2009PosRbPmvs080000.genConditionalField6())
						.confReference(EHeaderMetadataShared.R002.getObject())));
		fs.add(sf(7, null, "Keterangan",
				sv(C, 0, 1000, all).confConditionalRequired(ER2009PosRbPmvs080000.genConditionalField7())));
		return res;
	}
}
