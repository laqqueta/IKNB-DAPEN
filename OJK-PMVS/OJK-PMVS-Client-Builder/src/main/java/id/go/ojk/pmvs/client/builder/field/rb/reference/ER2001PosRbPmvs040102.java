...
public enum ER2001PosRbPmvs040102 implements IObject<KeyValueString> {
...
//	R_04010202000000 ("04010202000000", "Saldo Posisi (Outstanding Principal):"),
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER2001PosRbPmvs040102 eEnum : ER2001PosRbPmvs040102.values()) {
	...
	public static String getName() {
		return ER2001PosRbPmvs040102.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER2001PosRbPmvs040102.class.getSimpleName().substring(2, 6));
	}
	...
	public static SegmentValidation genValidationTotalRencanaInvestasiModalVenturaBerdasarkanPrinsipSyariahBaru() {
		return UtilSegmentValidation.genEqualsFormula("2|3|4|5", R_04010201060000.key,
	...
	public static SegmentValidation genValidationTotalSaldoPosisi() {
		return UtilSegmentValidation.genEqualsFormula("2|3|4|5", R_04010202060000.key,
