...
import id.go.ojk.pmvs.client.builder.field.rb.reference.ER2006PosRbPmvs060100;
...
public class Rb060100 extends BaseMetadata {
	...
	public SubmissionFormat get() {
		...
		SubmissionFormat res = new SubmissionFormat(eEnum.getCode(), eEnum.getName(), reportCode, new ArrayList<>(),
				extension, 4, null, null, null, ER2006PosRbPmvs060100.getRequiredPos());
		...
		fs.add(sf(2, null, "Nama Pemegang Saham",
				sv(C, 0, 160, all).confConditionalRequired(ER2006PosRbPmvs060100.genValidationMustEmpty())));
		fs.add(sf(3, null, "Kategori Pemegang Saham",
				sv(C, 0, 10, refTable).confReference(EHeaderMetadataShared.R001.getObject())
						.confConditionalRequired(ER2006PosRbPmvs060100.genValidationMustEmpty())));
