...
public enum ER2256PosRePmvs060100 implements IObject<KeyValueString> {
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER2256PosRePmvs060100 eEnum : ER2256PosRePmvs060100.values()) {
	...
	public static String getName() {
		return ER2256PosRePmvs060100.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER2256PosRePmvs060100.class.getSimpleName().substring(2, 6));
	}
