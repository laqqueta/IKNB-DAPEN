...
import id.go.ojk.pmvs.client.builder.field.rb.reference.ER2013PosRbPmvs100100;
...
public class Rb100100 extends BaseMetadata {
	...
	public SubmissionFormat get() {
		...
		SubmissionFormat res = new SubmissionFormat(eEnum.getCode(), eEnum.getName(), reportCode, new ArrayList<>(),
				extension, 10, null, null, null, ER2013PosRbPmvs100100.getRequiredPos());
		res.addSegmentValidations(ER2013PosRbPmvs100100.genValidationNumeric());
		res.addSegmentValidations(ER2013PosRbPmvs100100.genValidationNumericDot());
		res.addSegmentValidations(ER2013PosRbPmvs100100.genValidationMaxLengthNumeric());
		...
		fs.add(sf(2, null, "Asumsi Lainnya",
				sv(C, 0, 200, all).confConditionalRequired(ER2013PosRbPmvs100100.genConditionalMustEmpty())));
