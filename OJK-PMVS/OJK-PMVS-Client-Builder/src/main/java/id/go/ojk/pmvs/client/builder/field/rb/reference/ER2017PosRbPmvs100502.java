...
public enum ER2017PosRbPmvs100502 implements IObject<KeyValueString> {
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER2017PosRbPmvs100502 eEnum : ER2017PosRbPmvs100502.values()) {
	...
	public static String getName() {
		return ER2017PosRbPmvs100502.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER2017PosRbPmvs100502.class.getSimpleName().substring(2, 6));
	}
	...
	public static SegmentValidation genValidationFasilitasPendanaanYangBelumDitarik() {
		return UtilSegmentValidation.genEqualsFormula("2|3|4|5", R_10050201000000.key,
	...
	public static SegmentValidation genValidationFasilitasPendanaanBelumDitarikDalamNegeri() {
		return UtilSegmentValidation.genEqualsFormula("2|3|4|5", R_10050201010000.key,
	...
	public static SegmentValidation genValidationFasilitasPendanaanBelumDitarikLuarNegeri() {
		return UtilSegmentValidation.genEqualsFormula("2|3|4|5", R_10050201020000.key,
	...
	public static SegmentValidation genValidationPenerbitanSuratSanggupBayarDenganPrinsipSyariah() {
		return UtilSegmentValidation.genEqualsFormula("2|3|4|5", R_10050204000000.key,
	...
	public static SegmentValidation genValidationInstrumenDerivatifUntukLindungNilaiSyariah() {
		return UtilSegmentValidation.genEqualsFormula("2|3|4|5", R_10050206000000.key,
	...
	public static SegmentValidation genValidationRekeningAdministratifLainnya() {
		return UtilSegmentValidation.genEqualsFormula("2|3|4|5", R_10050207000000.key,
	...
	public static SegmentValidation genValidationJumlah() {
		return UtilSegmentValidation.genEqualsFormula("2|3|4|5", R_10050208000000.key,
				UtilMetadata.genPlusRow(getObjects(), new int[] { 0, 9, 10, 11, 14, 15, 18 }), "Jumlah|Penjumlahan dari rincian");
	}
}
