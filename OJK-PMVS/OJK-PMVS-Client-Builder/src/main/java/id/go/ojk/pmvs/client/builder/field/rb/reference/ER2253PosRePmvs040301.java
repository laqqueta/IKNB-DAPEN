...
public enum ER2253PosRePmvs040301 implements IObject<KeyValueString> {
...
//	R_04030102000000 ("04030102000000", "Saldo Posisi (Outstanding Principal):"),
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER2253PosRePmvs040301 eEnum : ER2253PosRePmvs040301.values()) {
	...
	public static String getName() {
		return ER2253PosRePmvs040301.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER2253PosRePmvs040301.class.getSimpleName().substring(2, 6));
	}
