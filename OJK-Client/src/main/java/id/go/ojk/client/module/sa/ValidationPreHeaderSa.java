...
public class ValidationPreHeaderSa extends BaseValidationPreHeader {
	...
	public ValidationPreHeaderSa(File file, int sumRow, int reportFormGroupCode, SubmissionFormat submissionFormat,
	...
	protected boolean validatePart7() {
		...
		boolean res = true;
		if (reportFormGroupCode == 2 || reportFormGroupCode == 3 || reportFormGroupCode == 4) {
