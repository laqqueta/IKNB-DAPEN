...
@Slf4j
public class ValidationFileNameLb2 extends ValidationFileName2 {

	public ValidationFileNameLb2(List<ValidFile> files, ReportInfo reportInfo, String memberCode,
