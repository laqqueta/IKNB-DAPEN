...
@XStreamAlias("EqualsToPercentageValidation")
@Slf4j
public class EqualsToPercentageValidation extends BaseDecimalValidation {
	private String comparator1RowCode;
	private String comparator2RowCode;
	private String message;

	public EqualsToPercentageValidation() {
		super();
	}

	public EqualsToPercentageValidation(String parameter) {
		super(parameter);
	}

	@Override
	public EqualsToPercentageValidation initialized() {
		super.initialized();
	...
	private BigDecimal getComparatorValue(String column) {
		...
		return value2.compareTo(BigDecimal.ZERO) != 0
				? value1.multiply(new BigDecimal("100")).divide(value2, scale, RoundingMode.HALF_UP)
				: BigDecimal.ZERO;
	}
