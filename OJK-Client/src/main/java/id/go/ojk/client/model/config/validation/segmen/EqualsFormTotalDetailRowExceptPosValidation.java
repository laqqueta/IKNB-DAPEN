...
@XStreamAlias("EqualsFormTotalDetailRowExceptPosValidation")
public class EqualsFormTotalDetailRowExceptPosValidation extends BaseRowValidation {
    protected String expectPos;
	protected String comparatorForm;
	protected String msgError;

	public EqualsFormTotalDetailRowExceptPosValidation() {
		super();
	}

	public EqualsFormTotalDetailRowExceptPosValidation(String parameter) {
		super(parameter);
	}

	@Override
	public EqualsFormTotalDetailRowExceptPosValidation initialized() {
		super.initialized();
	...
	protected int getComparatorValue() {
		return SubmissionFormat.getFormTotalRowExpectPos(comparatorForm, expectPos);
	}
	...
	public void validate(SubmissionData submissionData, SubmissionFormat submissionFormat,
		...
		final Logger logger = LoggerFactory.getLogger(EqualsFormTotalDetailRowExceptPosValidation.class);
