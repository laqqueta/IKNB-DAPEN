...
public class ValidationPreHeaderLbk extends BaseValidationPreHeader {
	...
	public ValidationPreHeaderLbk(File file, int sumRow, int reportFormGroupCode, SubmissionFormat submissionFormat,
	...
	protected boolean validatePart6() {
		...
		boolean res = false;
		String code = String.valueOf(EReportGroupLbk.getRevisionCodeByCode(reportFormGroupCode));
	...
	protected boolean validatePart7() {
		...
		boolean res = true;
		if (reportFormGroupCode == 2 || reportFormGroupCode == 4) {
