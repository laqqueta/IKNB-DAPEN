...
@Slf4j
public class ValidationFileNameLt3 extends ValidationFileName3 {

	public ValidationFileNameLt3(List<ValidFile> files, ReportInfo reportInfo, String memberCode, String memberTypeCode,
