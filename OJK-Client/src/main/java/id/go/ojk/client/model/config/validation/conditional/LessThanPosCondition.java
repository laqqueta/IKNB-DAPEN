...
public class LessThanPosCondition extends LessThanCondition {
	private String rowCode;

	public LessThanPosCondition() {
	}

	public LessThanPosCondition(String parameter) {
		setParameter(parameter);
	}

	@Override
	public LessThanPosCondition initialized() {
		super.initialized();
