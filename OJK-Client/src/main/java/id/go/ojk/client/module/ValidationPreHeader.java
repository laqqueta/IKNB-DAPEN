...
public class ValidationPreHeader extends BaseValidationPreHeader {
	protected ApplicationContextClient ctx = ApplicationContextClient.getInstance();
	protected ValidFile validFile;
	protected int reportFormGroupCode;

	public ValidationPreHeader(File file, int sumRow, int reportFormGroupCode, SubmissionFormat submissionFormat,
