...
@XStreamAlias("p01PostSegmentValidation")
public class P01PostSegmentValidation extends BasePostSegmentValidation {
	
	private int accountNoField;
	
	public P01PostSegmentValidation(){
		super();
	}

	public P01PostSegmentValidation(String parameter){
		super(parameter);
	}
	...
	@Override
	public P01PostSegmentValidation initialized() {
		super.initialized();
