...
public class ValidationFileNameSa3 extends ValidationFileName3 {
	private final Logger logger = LoggerFactory.getLogger(ValidationFileNameSa3.class);

	public ValidationFileNameSa3(List<ValidFile> files, ReportInfo reportInfo, String memberCode, String memberTypeCode,
