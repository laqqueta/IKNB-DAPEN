 ...
 */
@XStreamAlias("FormulaValidation2")
public class FormulaValidation2 extends BaseFieldFormulaValidation {
  protected String msgError;
  protected int scale;

  public FormulaValidation2(String parameter) {
    super(parameter);
  }

  public FormulaValidation2() {
    super();
  }

  @Override
  public FormulaValidation2 initialized() {
    super.initialized();
  ...
  public void validate(SubmissionFormat submissionFormat, SubmissionField field, ValidationResult validationResult) {
    ...
    Logger logger = LoggerFactory.getLogger(FormulaValidation2.class);
    ...
    if (!result) {
      ...
      validationResult.errors.add(new ValidationError(field, ValidationErrorCode.E50_02_FORMULA, compareValue, msg));
    } else {
