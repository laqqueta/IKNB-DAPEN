...
public class LookupGreaterEqualsValidation extends LookupValidation {
	private int scale = 2;

	public LookupGreaterEqualsValidation() {
		super();
	}

	public LookupGreaterEqualsValidation(String parameter) {
		super(parameter);
	}
	...
	@Override
	public LookupGreaterEqualsValidation initialized() {
		super.initialized();
