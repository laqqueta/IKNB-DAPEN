...
@Slf4j
public class ValidationFileNameLbk3 extends ValidationFileName3 {

	public ValidationFileNameLbk3(List<ValidFile> files, ReportInfo reportInfo, String memberCode, String memberTypeCode,
