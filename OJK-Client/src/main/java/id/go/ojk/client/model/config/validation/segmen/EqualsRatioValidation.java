...
@Slf4j
public class EqualsRatioValidation extends BaseDecimalValidation {
	private String comparator1RowCode;
	private String comparator2RowCode;
	private String message;

	public EqualsRatioValidation() {
		super();
	}

	public EqualsRatioValidation(String parameter) {
		super(parameter);
	}

	@Override
	public EqualsRatioValidation initialized() {
		super.initialized();
