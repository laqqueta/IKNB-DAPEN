...
public class ValidationFileNameLb1 extends ValidationFileName1 {

	public ValidationFileNameLb1(List<File> files, ReportInfo reportInfo) {
		super(files, reportInfo);
	}

	public ValidationFileNameLb1(List<File> files, ReportInfo reportInfo, ReadSubmissionDirModel readDirModel) {
	...
	private EValidExtension getValidExtension() {
		if (EReportTypeCode.isPpiOrPnm(reportInfo.getReportTypeCode())) {
			return EValidExtension.TXT;
		} else {
