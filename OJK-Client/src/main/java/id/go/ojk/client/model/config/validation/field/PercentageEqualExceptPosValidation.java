...
public class PercentageEqualExceptPosValidation extends BaseFieldFormulaValidation {
	protected int scale;
    private String exceptPos;

	public PercentageEqualExceptPosValidation(String parameter) {
		super(parameter);
	}

	public PercentageEqualExceptPosValidation() {
		super();
	}

	@Override
	public PercentageEqualExceptPosValidation initialized() {
		super.initialized();
	...
	public void validate(SubmissionFormat submissionFormat, SubmissionField field, ValidationResult validationResult) {
		...
		Logger logger = LoggerFactory.getLogger(PercentageEqualExceptPosValidation.class);
