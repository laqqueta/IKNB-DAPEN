...
public class ValidationPreHeaderLt extends BaseValidationPreHeader {
	...
	public ValidationPreHeaderLt(File file, int sumRow, int reportFormGroupCode, SubmissionFormat submissionFormat,
	...
	protected boolean validatePart6() {
		...
		boolean res = false;
		String code = String.valueOf(EReportGroupLt.getRevisionCodeByCode(reportFormGroupCode));
