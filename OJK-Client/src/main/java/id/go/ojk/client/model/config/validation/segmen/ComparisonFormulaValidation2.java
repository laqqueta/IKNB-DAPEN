...
@XStreamAlias("ComparisonFormulaValidation2")
public class ComparisonFormulaValidation2 extends BaseRowFormulaValidation {
	private String leftFormula;

	public ComparisonFormulaValidation2() {
		super();
	}

	public ComparisonFormulaValidation2(String parameter) {
		super(parameter);
	}

	@Override
	public ComparisonFormulaValidation2 initialized() {
		leftFormula = getStringParameter("leftFormula");
		super.initialized();
		return this;
	}
	
	private Object getLeftValue(String idxSelectField) {
		return arithmeticOperation(leftFormula, Integer.parseInt(idxSelectField)).setScale(scale, RoundingMode.HALF_UP);
	}
	...
	protected void compare(ScriptEngine engine, SubmissionFormat submissionFormat, ValidationResult validationResult,
		...
		final Logger logger = LoggerFactory.getLogger(ComparisonFormulaValidation2.class);
		Object selectValue = getLeftValue(idxSelectField);
