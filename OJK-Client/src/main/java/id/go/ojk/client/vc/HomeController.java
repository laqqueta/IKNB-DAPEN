...
public class HomeController extends BaseController {
	...
	@FXML public final static String homeButton = "gph9aA0Xhb3W8YngKuDsieNg13EjXmx1TqMw58pAiEk=";
	...
	protected void initialize() {
		...
		scrollPane.viewportBoundsProperty().addListener(new ChangeListener<Bounds>() {
			public void changed(ObservableValue<? extends Bounds> observable, Bounds oldValue, Bounds newValue) {
				...
				setImageFitSize(sendingImage, with*3, 1, 0);
				setImageFitSize(summarySubmissionImage, with*3, 1, 0);
				setImageFitSize(slikWebImage, with*3, 1, 0);
	...
	@FXML public final static String sendingLabel = "2Kmib7EEABTLa5t/883I2DA+tmO9i7USi8KhZcrcpdc=";
