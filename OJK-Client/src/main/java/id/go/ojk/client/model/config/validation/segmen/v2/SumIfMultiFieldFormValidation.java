...
public class SumIfMultiFieldFormValidation extends BaseSumIf<SumIfBaseParams> {

    private String multiRangeFieldErr;

    public SumIfMultiFieldFormValidation(String parameter) {
        super(parameter);
    }

    @Override
    public SumIfMultiFieldFormValidation initialized() {
        super.initialized();
    ...
    public void validate(SubmissionData submissionData, SubmissionFormat submissionFormat, ValidationResult validationResult) {
        ...
        if (selectRowCodes.contains(currentRowCode)) {
            final Logger logger = LoggerFactory.getLogger(SumIfMultiFieldFormValidation.class);
    ...
    protected Map<String, BigDecimal> mappingCriteria(SumIfBaseParams param) {
        ...
        String[] fields = StringUtils.split(param.getRangeField(), "#");
        ...
        SubmissionFormat
                ...
                .forEach(entry -> {
                    ...
                    for (String field : fields) {
                        value[0] = entry.getValue().get(field);
