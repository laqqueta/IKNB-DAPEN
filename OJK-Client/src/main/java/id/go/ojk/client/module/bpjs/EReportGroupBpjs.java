...
public enum EReportGroupBpjs implements IObject<ReportGroup> {
  ...
  /* --- BPTK 2 --- */
  LPBPTKJKK_RUTIN(28, "R", "M", 0, EValidExtension.TXT_PDF),
  LPBPTKJKK_KOREKSI(29, "K", "M", 1, EValidExtension.TXT_PDF),
  LPBPTKJKK_KOREKSI_PENGAWAS(30, "K", "M", 2, EValidExtension.TXT_PDF),
  LPBPTKJK_RUTIN(31, "R", "M", 0, EValidExtension.TXT_PDF),
  LPBPTKJK_KOREKSI(32, "K", "M", 1, EValidExtension.TXT_PDF),
  LPBPTKJK_KOREKSI_PENGAWAS(33, "K", "M", 2, EValidExtension.TXT_PDF),
  LPBPTKJHT_RUTIN(34, "R", "M", 0, EValidExtension.TXT_PDF),
  LPBPTKJHT_KOREKSI(35, "K", "M", 1, EValidExtension.TXT_PDF),
  LPBPTKJHT_KOREKSI_PENGAWAS(36, "K", "M", 2, EValidExtension.TXT_PDF),
  LPBPTKJKP_RUTIN(37, "R", "M", 0, EValidExtension.TXT_PDF),
  LPBPTKJKP_KOREKSI(38, "K", "M", 1, EValidExtension.TXT_PDF),
  LPBPTKJKP_KOREKSI_PENGAWAS(39, "K", "M", 2, EValidExtension.TXT_PDF),
  LPBPTKJP_RUTIN(40, "R", "M", 0, EValidExtension.TXT_PDF),
  LPBPTKJP_KOREKSI(41, "K", "M", 1, EValidExtension.TXT_PDF),
  LPBPTKJP_KOREKSI_PENGAWAS(42, "K", "M", 2, EValidExtension.TXT_PDF),
