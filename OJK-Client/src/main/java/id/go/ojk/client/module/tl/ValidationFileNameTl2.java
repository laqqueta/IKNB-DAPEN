...
public class ValidationFileNameTl2 extends ValidationFileName2 {
	private final Logger logger = LoggerFactory.getLogger(ValidationFileNameTl2.class);

	public ValidationFileNameTl2(List<ValidFile> files, ReportInfo reportInfo, String memberCode,
			String memberTypeCode) {
		super(files, reportInfo, memberCode, memberTypeCode);
	}

	public ValidationFileNameTl2(List<ValidFile> files, ReportInfo reportInfo, String memberCode, String memberTypeCode,
