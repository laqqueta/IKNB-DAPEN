...
@XStreamAlias("DateGreaterEqualsValidation")
public class DateGreaterEqualsValidation extends MapParamFieldValidation {
	protected String fieldComparator;

	public DateGreaterEqualsValidation() { }

	public DateGreaterEqualsValidation(String parameter) {
		setParameter(parameter);
	}

	@Override
	public DateGreaterEqualsValidation initialized() {
	...
	public void validate(SubmissionFormat submissionFormat, SubmissionField field, ValidationResult validationResult) {
		Logger logger = LoggerFactory.getLogger(DateGreaterEqualsValidation.class);
		try {
			...
			if (comparatorValue.isAfter(realValue)) {
				validationResult.errors.add(new ValidationError(field, ValidationErrorCode.E12_16_DATE_GREATER_EQUALS,
