...
@Slf4j
public class ValidationFileNameLb3 extends ValidationFileName3 {

	public ValidationFileNameLb3(List<ValidFile> files, ReportInfo reportInfo, String memberCode, String memberTypeCode,
