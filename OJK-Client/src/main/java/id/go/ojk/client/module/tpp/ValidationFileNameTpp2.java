...
public class ValidationFileNameTpp2 extends ValidationFileName2 {

	public ValidationFileNameTpp2(List<ValidFile> files, ReportInfo reportInfo, String memberCode,
                                  String memberTypeCode) {
		super(files, reportInfo, memberCode, memberTypeCode);
	}

	public ValidationFileNameTpp2(List<ValidFile> files, ReportInfo reportInfo, String memberCode, String memberTypeCode,
