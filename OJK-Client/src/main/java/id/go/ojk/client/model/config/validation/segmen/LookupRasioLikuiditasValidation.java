...
@XStreamAlias("LookupGreaterEqualsValidation")
public class LookupRasioLikuiditasValidation extends LookupValidation {
	private int scale = 2;

	public LookupRasioLikuiditasValidation() {
		super();
	}

	public LookupRasioLikuiditasValidation(String parameter) {
		super(parameter);
	}
	...
	@Override
	public LookupRasioLikuiditasValidation initialized() {
		super.initialized();
