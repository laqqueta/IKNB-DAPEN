...
public abstract class BasePreparationAndSendingController extends BaseController {
	private static Logger logger = LoggerFactory.getLogger(BasePreparationAndSendingController.class);
	@FXML
	...
	private void handleOpen() {
		...
		(new Thread(() -> {
			...
			submissionService.readDirectoryReport(submissionDir, readDirModel, getReportFormGroupCode());
			Platform.runLater(new Runnable() {
				@Override
				public void run() {
					updateDetailFile();
