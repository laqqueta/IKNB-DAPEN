...
public abstract class BaseHomeMetroController extends BaseController {
	@FXML
	private Button sendingButton;
	@FXML
	private ImageView sendingImage;
	@FXML
	private Button openErrorFileButton;
	@FXML
	private ImageView openErrorFileImage;
	@FXML
	private Button openMasterDataButton;
	@FXML
	private Button webSlikButton;
	@FXML
	private ImageView slikWebImage;
	@FXML
	...
	@FXML
	private Button userOfflineMaintenanceMenu;
	@FXML
	private Button applicationSettingButton;
	@FXML
	private ImageView applicationSettingImage;
	@FXML
	private Button updateOnline;
	@FXML
	private ImageView updateOnlineImage;
	@FXML
	private Button updateOffline;
	@FXML
	private ImageView updateOfflineImage;
	@FXML
	...
	@FXML
	protected Label memberTypeLabel;
	@FXML
	private ImageView onlineImage;
	@FXML
	private ImageView offlineImage;
	@FXML
	private Pane separatorPane2;
	@FXML
	private Pane separatorPane3;
	@FXML 
	private Pane separatorPane112;
	@FXML
	...
	@FXML
	private ImageView userManagementImage;
	@FXML
	private VBox userLoginVbox; // (89, 12)
	@FXML
	private VBox memberLoginVbox; // (18, 14)
	@FXML
	private BorderPane mainBorderPane;
	@FXML
	private Label ojkHomeNameLabel;
	@FXML
	private Label ojkAddressLabel;
	@FXML
	...
	protected BaseHomeMetroController() {
	}

	protected abstract void initializeCustomMenu(double with);
...
//				setImageFitSize(sendingImage, with * 3, 2, 5);
				setSendingImageSize(sendingImage, with);
...
//				setRegionSize(separatorPane3, with, 1, 0);
	...
	protected void setImageFitSize(ImageView imageView, double height, double withRasio, double withCorrection) {
		if (imageView != null) {
...
//		mainApplication.showFAQDialog();
	...
	public void loginSuccess(UserSession userSession) {
		...
		memberNameLabel.setText(getMemberName());
	...
	protected abstract void disableCustomButton(boolean isDisable);
	...
	private String getMemberName() {
		String memberName = setupService.getMemberName();
		if (memberName == null) {
			return "-";
		}
		return memberName.length() > 34 ? memberName.substring(0, 31) + "..." : memberName;
	}
