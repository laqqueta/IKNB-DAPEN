...
@XStreamAlias("SumIfsFormValidation")
public class SumIfsFormValidation extends BaseRowValidation {
    ...
    public SumIfsFormValidation() { }

    public SumIfsFormValidation(String parameter) {
        super(parameter);
    }
            ...
            for (int i = 0; i < arrColumn.length; i++) {
                ...
                if (selectValue.compareTo(condsValue) != 0) {
                    ...
                    validationResult.errors.add(new ValidationError(submissionField,
                            ...
                            msgErrors[0], msgErrors[1], condErrors[i], msgErrors[2] ));
                }
    ...
    private Map<String, BigDecimal> calculateConditions() {
        String[] conds = StringUtils.split(criteriaCondition, "|");
