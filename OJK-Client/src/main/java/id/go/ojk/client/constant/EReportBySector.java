...
//	REPORT_LABPTK (EReport.BPTKLA.getId(), Arrays.asList(ESector.BPTK.getCode())),
    REPORT_LKDPK (EReport.LKBT_DPPKK.getId(), Arrays.asList(ESector.DPPKK.getCode())),
    REPORT_LKDPS (EReport.LKBT_DPPKS.getId(), Arrays.asList(ESector.DPPKS.getCode())),
    REPORT_LKDLK (EReport.LKBT_DPLKK.getId(), Arrays.asList(ESector.DPLKK.getCode())),
    REPORT_LKDLS (EReport.LKBT_DPLKS.getId(), Arrays.asList(ESector.DPLKS.getCode())),
	;
