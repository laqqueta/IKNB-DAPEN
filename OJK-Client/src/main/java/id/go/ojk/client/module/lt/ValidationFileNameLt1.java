...
public class ValidationFileNameLt1 extends ValidationFileName1 {

	public ValidationFileNameLt1(List<File> files, ReportInfo reportInfo) {
		super(files, reportInfo);
	}

	public ValidationFileNameLt1(List<File> files, ReportInfo reportInfo, ReadSubmissionDirModel readDirModel) {
