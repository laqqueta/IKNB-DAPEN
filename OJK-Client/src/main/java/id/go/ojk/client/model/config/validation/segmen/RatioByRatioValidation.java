...
@XStreamAlias("RatioValidationDapen")
public class RatioByRatioValidation extends BaseFormulaValidation {
	protected Boolean roundFull;

	public RatioByRatioValidation() {
		super();
	}
	...
	public RatioByRatioValidation(String parameter) {
		super(parameter);
	}
	...
	protected void compareFormula(ValidationResult validationResult, List<SubmissionField> submissionField,
		...
		Logger logger = LoggerFactory.getLogger(RatioByRatioValidation.class);
		boolean result;
	...
	protected BigDecimal calculateRatio(String formula, int seq) {
		...
		try {
			...
			if (value2 != null && value2.compareTo(BigDecimal.ZERO) != 0) {
				value1 = value1.divide(BigDecimal.valueOf(100), 4, RoundingMode.HALF_UP);
