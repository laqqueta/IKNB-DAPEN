...
public class HomeMetroBpjsControllerLABPTK extends HomeMetroBpjsController {
  @FXML
  ...
  protected List<Button> getCustomButtons() {
    return Arrays.asList(btnJKK, btnJK, btnJHT, btnJKP, btnJP);
  }

  @Override
  protected List<ImageView> getCustomButtonImages() {
    return Arrays.asList(imageJKK, imageJK, imageJHT, imageJKP, imageJP);
  }
}
