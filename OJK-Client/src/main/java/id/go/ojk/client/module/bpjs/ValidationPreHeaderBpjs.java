...
public class ValidationPreHeaderBpjs extends BaseValidationPreHeader {
  ...
  public ValidationPreHeaderBpjs(File file, int sumRow, int reportFormGroupCode, SubmissionFormat submissionFormat,
  ...
  protected boolean validatePart6() {
    ...
    boolean res = false;
    String code = String.valueOf(EReportGroupBpjs.getRevisionCodeByCode(reportFormGroupCode));
  ...
  protected boolean validatePart7() {
    ...
    boolean res = true;
    if (EReportGroupBpjs.isKoreksiPengawas(reportFormGroupCode)) {
      if (StringUtils.isBlank(part)) {
        ...
        result.errors
            .add(new ValidationError(null, ValidationErrorCode.E03_26_MAX_LENGTH_NO_SURAT, String.valueOf(maxLen)));
        res = false;
      } else {
