 ...
 *
 */
@XStreamAlias("ExistPosAndComparatorNotEmptyConditional")
public class ExistPosAndComparatorNotEmptyConditional extends MapParamConditionalRequired {
	...
	public ExistPosAndComparatorNotEmptyConditional() {
	}

	public ExistPosAndComparatorNotEmptyConditional(String parameter) {
		setParameter(parameter);
	}

	@Override
	public ExistPosAndComparatorNotEmptyConditional initialized() {
