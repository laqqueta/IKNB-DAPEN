 ...
 */
@XStreamAlias("t01SegmentValidation")
public class T01SegmentValidation extends MapParamSegmentValidation {
	...
	public T01SegmentValidation(){
		super();
	}
	
	public T01SegmentValidation(String parameter){
		super(parameter);
	}
	...
	@Override
	public T01SegmentValidation initialized() {
