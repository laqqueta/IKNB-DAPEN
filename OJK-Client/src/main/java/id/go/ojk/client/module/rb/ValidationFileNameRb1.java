...
public class ValidationFileNameRb1 extends ValidationFileName1 {

	public ValidationFileNameRb1(List<File> files, ReportInfo reportInfo) {
		super(files, reportInfo);
	}

	public ValidationFileNameRb1(List<File> files, ReportInfo reportInfo, ReadSubmissionDirModel readDirModel) {
...
//		if (reportInfo.getReportTypeCode().equals(EReportRb.ASRJU_REALISASI.getReportTypeCode()) || 
//				reportInfo.getReportTypeCode().equals(EReportRb.ASRUU_REALISASI.getReportTypeCode()) ||
//				reportInfo.getReportTypeCode().equals(EReportRb.REASU_REALISASI.getReportTypeCode()) ) {
//			return EValidExtension.PDF;
//		} else {
