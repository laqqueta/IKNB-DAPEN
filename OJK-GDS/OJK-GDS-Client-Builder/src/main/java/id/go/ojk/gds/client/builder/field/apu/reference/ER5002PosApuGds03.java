...
public enum ER5002PosApuGds03 implements IObject<KeyValueString> {
...
//	R_0301010000 ("0301010000", "A. Jumlah Kantor Cabang. "),
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER5002PosApuGds03 eEnum : ER5002PosApuGds03.values()) {
	...
	public static String getName() {
		return ER5002PosApuGds03.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER5002PosApuGds03.class.getSimpleName().substring(2, 6));
	}
