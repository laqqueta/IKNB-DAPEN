...
public enum ER5001PosApuGds02 implements IObject<KeyValueString> {
...
//	R_0205000000 ("0205000000", "5. SUMBER DAYA MANUSIA DAN PELATIHAN"),
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER5001PosApuGds02 eEnum : ER5001PosApuGds02.values()) {
	...
	public static String getName() {
		return ER5001PosApuGds02.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER5001PosApuGds02.class.getSimpleName().substring(2, 6));
	}
