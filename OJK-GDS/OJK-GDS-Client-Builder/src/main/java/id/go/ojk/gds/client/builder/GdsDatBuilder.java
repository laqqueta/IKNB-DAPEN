package id.go.ojk.gds.client.builder;
...
import id.go.ojk.gds.client.builder.field.EUpdateHeader;
import id.go.ojk.gds.client.builder.field.setup.ESetupKeyValueStringFilename;
import id.go.ojk.lib.client.model.update.UpdateHeader;
import lombok.extern.slf4j.Slf4j;

@Slf4j
public class GdsDatBuilder extends BaseDatBuilder {
	private static final EReport REPORT_APU = EReport.APU_GDS;
	private static final String DUMMY_USER = "gdsdummy@gmail.com";

	public static void main(String[] args) {
		try {
			log.info("starting builder");
			GdsDatBuilder builder = new GdsDatBuilder(args);
	...
	public GdsDatBuilder(String[] args) {
	...
	protected String genDummyClientEntity() {
		return genDummyClientEntity(Constant.SECTOR.getCode(), Arrays.asList("2000015404"), DUMMY_USER);
	}
