...
public enum ER2022PosReAsrjk0400 implements IObject<KeyValueString> {
...
//	R_7006000099 ("7006000099", "vi. Return on Equity (ROE)"),
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER2022PosReAsrjk0400 eEnum : ER2022PosReAsrjk0400.values()) {
	...
	public static String getName() {
		return ER2022PosReAsrjk0400.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER2022PosReAsrjk0400.class.getSimpleName().substring(2, 6));
	}
	...
	public static SegmentValidation genValidationTingkatSolvabilitas() {
		return UtilSegmentValidation.genEqualsFormula("2|3", R_7000000000.key, 
	...
	public static SegmentValidation genValidationRasioPencapaianSolvabilitas() {
		return UtilSegmentValidation.genEqualsRatio("2|3", R_7000000099.key, 
				R_7000000000.key + "|" + R_7300000000.key,
	...
	public static SegmentValidation genValidationJumlatRasioABCD() {
		return UtilSegmentValidation.genEqualsFormula("2|3", R_7004000000.key, 
				...
				"Total Rasio I, II, III|Penjumlahan Rasio I, II, III", 2);
	}
