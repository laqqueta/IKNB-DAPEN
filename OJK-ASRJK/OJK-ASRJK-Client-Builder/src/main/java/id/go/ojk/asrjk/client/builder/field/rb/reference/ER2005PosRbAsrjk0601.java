...
public enum ER2005PosRbAsrjk0601 implements IObject<KeyValueString> {
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER2005PosRbAsrjk0601 eEnum : ER2005PosRbAsrjk0601.values()) {
	...
	public static String getName() {
		return ER2005PosRbAsrjk0601.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER2005PosRbAsrjk0601.class.getSimpleName().substring(2, 6));
	}
