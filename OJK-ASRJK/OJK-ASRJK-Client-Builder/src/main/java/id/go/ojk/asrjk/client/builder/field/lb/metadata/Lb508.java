...
import id.go.ojk.asrjk.client.builder.field.lb.reference.ER3017PosLbAsrjk508;
...
public class Lb508 extends BaseMetadata {
	...
	public SubmissionFormat get() {
		...
		SubmissionFormat res = new SubmissionFormat(eEnum.getCode(), eEnum.getName(), reportCode,
				new ArrayList<>(), extension, 7, 7, ER3017PosLbAsrjk508.genFieldSave(), null,
				ER3017PosLbAsrjk508.getRequiredPos());
		res.addSegmentValidations(ER3017PosLbAsrjk508.genValidationTotalRisikoOperasionalPerusahaan());
		res.addSegmentValidations(ER3017PosLbAsrjk508.genValidationTotalRisikoOperasionalPAYDI());
		res.addSegmentValidations(ER3017PosLbAsrjk508.genValidationTotalDeviasi());
