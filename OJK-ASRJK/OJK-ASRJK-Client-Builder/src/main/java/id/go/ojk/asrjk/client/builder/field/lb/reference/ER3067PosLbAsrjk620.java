...
public enum ER3067PosLbAsrjk620 implements IObject<KeyValueString> {
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER3067PosLbAsrjk620 eEnum : ER3067PosLbAsrjk620.values()) {
	...
	public static String getName() {
		return ER3067PosLbAsrjk620.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER3067PosLbAsrjk620.class.getSimpleName().substring(2, 6));
	}
