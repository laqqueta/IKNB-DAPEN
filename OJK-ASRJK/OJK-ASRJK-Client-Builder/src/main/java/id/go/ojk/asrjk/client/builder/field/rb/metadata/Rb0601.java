...
import id.go.ojk.asrjk.client.builder.field.rb.reference.ER2005PosRbAsrjk0601;
...
public class Rb0601 extends BaseMetadata {
	...
	public SubmissionFormat get() {
		...
		SubmissionFormat res = new SubmissionFormat(eEnum.getCode(), eEnum.getName(), reportCode,
				new ArrayList<>(), extension, 1, null, ER2005PosRbAsrjk0601.genFieldSave(), null,
				ER2005PosRbAsrjk0601.getRequiredPos());
		res.addSegmentValidations(ER2005PosRbAsrjk0601.genValidationInvestasi());
		...
		fs.add(sf(2, null, "Jenis Investasi",
				sv(C, 0, 1000, refTable).confReference(EHeaderMetadataShared.R000.getObject())
						.confConditionalRequired(ER2005PosRbAsrjk0601.genConditionalFieldMustEmpty())));
		fs.add(sf(3, null, "Aktual per 30 Sept 20XX-1",
				sv(C, 0, 16, numericNegatif).confConditionalRequired(ER2005PosRbAsrjk0601.genConditionalField())));
