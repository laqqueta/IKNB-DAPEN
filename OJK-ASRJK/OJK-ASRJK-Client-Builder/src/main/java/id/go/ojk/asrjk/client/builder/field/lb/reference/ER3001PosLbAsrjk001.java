...
public enum ER3001PosLbAsrjk001 implements IObject<KeyValueString> {
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER3001PosLbAsrjk001 eEnum : ER3001PosLbAsrjk001.values()) {
	...
	public static String getName() {
		return ER3001PosLbAsrjk001.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER3001PosLbAsrjk001.class.getSimpleName().substring(2, 6));
	}
