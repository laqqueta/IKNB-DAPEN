...
public enum ER2017PosRbAsrjk1311 implements IObject<KeyValueString> {
//	R_7000000098 ("7000000098", "A. TINGKAT SOLVABILITAS"),
	R_7100000000 ("7100000000", "Aset Yang Diperkenankan"),
	R_7200000000 ("7200000000", "Liabilitas (kecuali Pinjaman Subordinasi) "),
	R_7000000000 ("7000000000", "Jumlah Tingkat Solvabilitas (a) "),
//	R_7300000099 ("7300000099", "Modal Minimum Berbasis Risiko (MMBR) "),
	R_7300000000 ("7300000000", "Jumlah MMBR (b) "),
	R_7400000000 ("7400000000", "Kelebihan (Kekurangan) Batas Tingkat Solvabilitas"),
	R_7000000099 ("7000000099", "Rasio Pencapaian Solvabilitas (a:b)"),
...
//	R_7006000099 ("7006000099", "vi. Return on Equity (ROE)"),
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER2017PosRbAsrjk1311 eEnum : ER2017PosRbAsrjk1311.values()) {
	...
	public static String getName() {
		return ER2017PosRbAsrjk1311.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER2017PosRbAsrjk1311.class.getSimpleName().substring(2, 6));
	}
	...
	public static SegmentValidation genValidationTingkatSolvabilitas() {
		return UtilSegmentValidation.genEqualsFormula("2|3|4|5", R_7000000000.key, 
	...
	public static SegmentValidation genValidationKelebihanTingkatSolvabilitas() {
		return UtilSegmentValidation.genEqualsFormula("2|3|4|5", R_7400000000.key, 
				R_7000000000.key + "-" + R_7300000000.key, 
	...
	public static SegmentValidation genValidationRasioPencapaianSolvabilitas() {
		return UtilSegmentValidation.genEqualsRatio("2|3|4|5", R_7000000099.key, 
				R_7000000000.key + "|" + R_7300000000.key,
	...
	public static SegmentValidation genValidationTotalRasioABC() {
		return UtilSegmentValidation.genEqualsFormula("2|3|4|5", R_7004000000.key, 
				...
				"Rasio I + Rasio II + Rasio III|Penjumlahan Rasio I + Rasio II + Rasio III", 2);
	}
