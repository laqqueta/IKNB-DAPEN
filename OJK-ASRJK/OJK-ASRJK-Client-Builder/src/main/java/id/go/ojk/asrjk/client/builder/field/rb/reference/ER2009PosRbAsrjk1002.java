...
public enum ER2009PosRbAsrjk1002 implements IObject<KeyValueString> {
	R_1002010000 ("1002010000", "SDM"),
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER2009PosRbAsrjk1002 eEnum : ER2009PosRbAsrjk1002.values()) {
	...
	public static String getName() {
		return ER2009PosRbAsrjk1002.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER2009PosRbAsrjk1002.class.getSimpleName().substring(2, 6));
	}
