...
import id.go.ojk.asrjk.client.builder.field.lb.reference.ER3034PosLbAsrjk203;
...
public class Lb203 extends BaseMetadata {
	...
	public SubmissionFormat get() {
		...
		SubmissionFormat res = new SubmissionFormat(eEnum.getCode(), eEnum.getName(), reportCode,
				new ArrayList<>(), extension, 9, 9, ER3034PosLbAsrjk203.genFieldSave(), null,
				ER3034PosLbAsrjk203.getRequiredPos());
		res.addSegmentValidations(ER3034PosLbAsrjk203.genValidationTotal());
		...
		fs.add(sf(5, null, "Jumlah", sv(M, 1, 16, numericNegatif))
				.addFieldValidations(ER3034PosLbAsrjk203.genFieldValidation5()));
		...
		fs.add(sf(9, null, "Jumlah", sv(M, 1, 16, numericNegatif))
				.addFieldValidations(ER3034PosLbAsrjk203.genFieldValidation9()));
		return res;
	}
}
