...
import id.go.ojk.asrjk.client.builder.field.rb.uus.reference.ER2133PosRbAsrju1210;
...
public class Rb1210 extends BaseMetadata {
	...
	public SubmissionFormat get() {
		...
		SubmissionFormat res = new SubmissionFormat(eEnum.getCode(), eEnum.getName(), reportCode,
				...
				ER2133PosRbAsrju1210.getRequiredPos());
		res.addSegmentValidations(ER2133PosRbAsrju1210.genValidationNumericNegative());
		res.addSegmentValidations(ER2133PosRbAsrju1210.genValidationNumericDotNegative());
		res.addSegmentValidations(ER2133PosRbAsrju1210.genValidationNumericMaxLength());
		...
		fs.add(sf(2, null, "Asumsi Lain",
				sv(C, 0, 200, all).confConditionalRequired(ER2133PosRbAsrju1210.genConditionField())));
