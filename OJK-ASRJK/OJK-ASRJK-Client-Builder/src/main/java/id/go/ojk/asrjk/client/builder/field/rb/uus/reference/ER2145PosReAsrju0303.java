...
public enum ER2145PosReAsrju0303 implements IObject<KeyValueString> {
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER2145PosReAsrju0303 eEnum : ER2145PosReAsrju0303.values()) {
	...
	public static String getName() {
		return ER2145PosReAsrju0303.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER2145PosReAsrju0303.class.getSimpleName().substring(2, 6));
	}
