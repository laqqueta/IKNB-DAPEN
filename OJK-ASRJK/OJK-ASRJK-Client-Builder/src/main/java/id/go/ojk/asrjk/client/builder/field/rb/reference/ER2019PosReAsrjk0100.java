...
public enum ER2019PosReAsrjk0100 implements IObject<KeyValueString> {
...
//	R_3000000099 ("3000000099", "Ekuitas"),
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER2019PosReAsrjk0100 eEnum : ER2019PosReAsrjk0100.values()) {
	...
	public static String getName() {
		return ER2019PosReAsrjk0100.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER2019PosReAsrjk0100.class.getSimpleName().substring(2, 6));
	}
	...
	public static SegmentValidation genValidationInvestasi() {
		return UtilSegmentValidation.genEqualsFormula("2|3", R_1400000000.key, 
	...
	public static SegmentValidation genValidationBukanInvestasi() {
		return UtilSegmentValidation.genEqualsFormula("2|3", R_1500000000.key, 
	...
	public static SegmentValidation genValidationAset() {
		return UtilSegmentValidation.genEqualsFormula("2|3", R_1000000000.key, 
				R_1400000000.key + "+" + R_1500000000.key,
				"Total Aset|Penjumlahan Aset");
	}

	public static SegmentValidation genValidationHutang() {
		return UtilSegmentValidation.genEqualsFormula("2|3", R_2400000000.key, 
	...
	public static SegmentValidation genValidationCadangan() {
		return UtilSegmentValidation.genEqualsFormula("2|3", R_2500000000.key, 
	...
	public static SegmentValidation genValidationLiabilitas() {
		return UtilSegmentValidation.genEqualsFormula("2|3", R_2100000000.key, 
				R_2400000000.key + "+" + R_2500000000.key,
				"Total Liabilitas|Penjumlahan Liabilitas");
	}

	public static SegmentValidation genValidationEkuitas() {
		return UtilSegmentValidation.genEqualsFormula("2|3", R_3000000000.key, 
				UtilMetadata.genPlusRow(getObjects(), 52, 57), 
				"Total Ekuitas|Penjumlahan Ekuitas");
	}

	public static SegmentValidation genValidationLiabilitasEkuitas() {
		return UtilSegmentValidation.genEqualsFormula("2|3", R_3999999999.key, 
