...
public enum ER4015PosSaAsrjk0502 implements IObject<KeyValueString> {
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER4015PosSaAsrjk0502 eEnum : ER4015PosSaAsrjk0502.values()) {
	...
	public static String getName() {
		return ER4015PosSaAsrjk0502.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER4015PosSaAsrjk0502.class.getSimpleName().substring(2, 6));
	}
