...
public enum ER3019PosLbAsrjk102 implements IObject<KeyValueString> {
...
//	R_1400020001 ("1400020001", "Penempatan di Luar Negeri"),
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER3019PosLbAsrjk102 eEnum : ER3019PosLbAsrjk102.values()) {
	...
	public static String getName() {
		return ER3019PosLbAsrjk102.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER3019PosLbAsrjk102.class.getSimpleName().substring(2, 6));
	}
