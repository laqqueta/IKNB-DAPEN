...
public enum ER2138PosReAsrju0102 implements IObject<KeyValueString> {
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER2138PosReAsrju0102 eEnum : ER2138PosReAsrju0102.values()) {
	...
	public static String getName() {
		return ER2138PosReAsrju0102.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER2138PosReAsrju0102.class.getSimpleName().substring(2, 6));
	}
