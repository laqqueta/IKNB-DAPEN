...
public enum ER4106PosSaAsrju0207 implements IObject<KeyValueString> {
...
//	R_02070302000000 ("02070302000000", "Tingkat Risiko Hukum"),
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER4106PosSaAsrju0207 eEnum : ER4106PosSaAsrju0207.values()) {
	...
	public static String getName() {
		return ER4106PosSaAsrju0207.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER4106PosSaAsrju0207.class.getSimpleName().substring(2, 6));
	}
