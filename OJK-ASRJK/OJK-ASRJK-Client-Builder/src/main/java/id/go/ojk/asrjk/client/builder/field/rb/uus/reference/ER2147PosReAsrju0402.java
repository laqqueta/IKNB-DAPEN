...
public enum ER2147PosReAsrju0402 implements IObject<KeyValueString> {
...
//	R_04020207000000 ("04020207000000", "G. Penghitungan Qardh yang Diperlukan Dana Tanahud"),
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER2147PosReAsrju0402 eEnum : ER2147PosReAsrju0402.values()) {
	...
	public static String getName() {
		return ER2147PosReAsrju0402.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER2147PosReAsrju0402.class.getSimpleName().substring(2, 6));
	}
