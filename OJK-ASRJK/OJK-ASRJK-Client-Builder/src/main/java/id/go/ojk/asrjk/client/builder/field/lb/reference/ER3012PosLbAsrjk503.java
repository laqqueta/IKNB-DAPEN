...
public enum ER3012PosLbAsrjk503 implements IObject<KeyValueString> {
...
//	R_2000000099 ("2000000099", "LIABILITIAS"),
...
//	R_2500000099 ("2500000099", "Cadangan Teknis"),
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER3012PosLbAsrjk503 eEnum : ER3012PosLbAsrjk503.values()) {
	...
	public static String getName() {
		return ER3012PosLbAsrjk503.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER3012PosLbAsrjk503.class.getSimpleName().substring(2, 6));
	}
	...
	public static SegmentValidation genValidationFaktorPAYDI() {
		return UtilSegmentValidation.genFixedValue("7", R_7302020100.key, "1.00");
	}
