...
public enum ER3065PosLbAsrjk618 implements IObject<KeyValueString> {
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER3065PosLbAsrjk618 eEnum : ER3065PosLbAsrjk618.values()) {
	...
	public static String getName() {
		return ER3065PosLbAsrjk618.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER3065PosLbAsrjk618.class.getSimpleName().substring(2, 6));
	}
