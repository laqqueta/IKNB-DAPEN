...
public enum ER3015PosLbAsrjk506 implements IObject<KeyValueString> {
	R_1601000000 ("1601000000", "cadangan premi yang dihitung dengan bunga bebas risiko (CPrF)"),
	R_1602000000 ("1602000000", "cadangan premi yang dihitung aktuaris perusahaan (CP0)"),
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER3015PosLbAsrjk506 eEnum : ER3015PosLbAsrjk506.values()) {
	...
	public static String getName() {
		return ER3015PosLbAsrjk506.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER3015PosLbAsrjk506.class.getSimpleName().substring(2, 6));
	}
