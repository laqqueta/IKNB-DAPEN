...
public enum ER2104PosRbAsrju0105 implements IObject<KeyValueString> {
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER2104PosRbAsrju0105 eEnum : ER2104PosRbAsrju0105.values()) {
	...
	public static String getName() {
		return ER2104PosRbAsrju0105.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER2104PosRbAsrju0105.class.getSimpleName().substring(2, 6));
	}
