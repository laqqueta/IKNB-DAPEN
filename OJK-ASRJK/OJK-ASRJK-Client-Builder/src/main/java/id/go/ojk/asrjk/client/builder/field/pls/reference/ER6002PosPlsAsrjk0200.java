...
public enum ER6002PosPlsAsrjk0200 implements IObject<KeyValueString> {
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER6002PosPlsAsrjk0200 eEnum : ER6002PosPlsAsrjk0200.values()) {
	...
	public static String getName() {
		return ER6002PosPlsAsrjk0200.class.getSimpleName().substring(6);
	}

	public static int getRefNumber() {
		return Integer.parseInt(ER6002PosPlsAsrjk0200.class.getSimpleName().substring(2, 6));
	}
	...
	public static SegmentValidation genValidation2() {
		return UtilSegmentValidation.genEqualsFormula("8", R_0020020000.key, R_0020010000.key,
				"Total|Penjumlahan detail");
	}

	public static SegmentValidation genValidation3() {
		// return UtilSegmentValidation.genIsExistsForm("3", R_0020010000.key,
		// EFormLaporanPolis.PLS_0100.getCode(), "2");
		return UtilSegmentValidation.genIsExistsFormDb("3", R_0020010000.key, EFormLaporanPolis.PLS_0100.getCode(),
				ER6001PosPlsAsrjk0100.R_0010010000.getObject().getKey(), "2");
	}
	...
	public static FieldValidation genValidationNIK3() {
		return UtilFieldValidation.genEqualsComparePosForm(R_0020010000.key, "3", EFormLaporanPolis.PLS_0100.getCode(),
				"7", "2");
	}

	public static SegmentValidation genValidation4() {
		return UtilSegmentValidation.genIsExistsFormDb("5", R_0020010000.key, EFormLaporanPolis.PLS_0100.getCode(),
				ER6001PosPlsAsrjk0100.R_0010010000.getObject().getKey(), "7");
	}
}
