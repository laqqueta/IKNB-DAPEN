...
public enum ER2127PosRbAsrju1204 implements IObject<KeyValueString> {
...
//	R_12040200000000 ("12040200000000", "BEBAN USAHA:"),
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER2127PosRbAsrju1204 eEnum : ER2127PosRbAsrju1204.values()) {
	...
	public static String getName() {
		return ER2127PosRbAsrju1204.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER2127PosRbAsrju1204.class.getSimpleName().substring(2, 6));
	}
