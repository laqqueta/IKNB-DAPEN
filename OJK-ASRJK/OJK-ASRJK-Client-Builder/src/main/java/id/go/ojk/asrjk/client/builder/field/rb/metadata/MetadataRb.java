...
public class MetadataRb {
	private static final String REPORT_CODE = EReportRb.ASRJK_PELAPORAN.getReportTypeCode();
	@Getter
	private static final List<SubmissionFormat> metadata = 
			Arrays.asList(
					...
					new Rb1305(REPORT_CODE).get(),
					new Rb1308(REPORT_CODE).get(),
					new Rb1311(REPORT_CODE).get(),
