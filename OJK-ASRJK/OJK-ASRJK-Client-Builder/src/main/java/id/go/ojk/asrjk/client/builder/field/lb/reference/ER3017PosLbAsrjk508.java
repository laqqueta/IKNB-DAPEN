...
public enum ER3017PosLbAsrjk508 implements IObject<KeyValueString> {
...
//	R_7305020000 ("7305020000", "II. Risiko Operasional PAYDI (ROPAYDI)"),
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER3017PosLbAsrjk508 eEnum : ER3017PosLbAsrjk508.values()) {
	...
	public static String getName() {
		return ER3017PosLbAsrjk508.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER3017PosLbAsrjk508.class.getSimpleName().substring(2, 6));
	}
	...
	public static SegmentValidation genValidationTotalRisikoOperasionalPAYDI() {
		return UtilSegmentValidation.genMultiply("2", R_7305020200.key, R_7305020100.key, ".001",
	...
	public static SegmentValidation genValidationTotalDeviasi() {
		return UtilSegmentValidation.genEqualsFormula("2", R_7305000000.key, UtilMetadata.genPlusRow(getObjects(), new int[] { 3, 5 }), 
				"Total deviasi|Penjumlahan deviasi");
	}
}
