...
public enum ER3044PosLbAsrjk210 implements IObject<KeyValueString> {
...
//	 R_6200000099 ("6200000099", "*) Data premi dan klaim merupakan data gabungan tradisional dan PAYDI"), 
	;
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER3044PosLbAsrjk210 eEnum : ER3044PosLbAsrjk210.values()) {
	...
	public static String getName() {
		return ER3044PosLbAsrjk210.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER3044PosLbAsrjk210.class.getSimpleName().substring(2, 6));
	}
