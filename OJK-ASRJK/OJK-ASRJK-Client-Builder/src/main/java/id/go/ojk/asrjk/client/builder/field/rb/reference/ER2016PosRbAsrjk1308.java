...
public enum ER2016PosRbAsrjk1308 implements IObject<KeyValueString> {
...
//	R_1501040298 ("1501040298", "Arus Kas Keluar"),
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER2016PosRbAsrjk1308 eEnum : ER2016PosRbAsrjk1308.values()) {
	...
	public static String getName() {
		return ER2016PosRbAsrjk1308.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER2016PosRbAsrjk1308.class.getSimpleName().substring(2, 6));
	}
	...
	public static SegmentValidation genValidationArusKasOperasiMasuk() {
	...
	public static SegmentValidation genValidationArusKasOperasiKeluar() {
	...
	public static SegmentValidation genValidationArusKasInvestasiMasuk() {
	...
	public static SegmentValidation genValidationArusKasInvestasiKeluar() {
	...
	public static SegmentValidation genValidationArusKasInvestasi() {
	...
	public static SegmentValidation genValidationArusKasPendanaanMasuk() {
	...
	public static SegmentValidation genValidationArusKasPendanaanKeluar() {
