...
public enum ER4004PosSaAsrjk0204 implements IObject<KeyValueString> {
...
//	R_02040300000000 ("02040300000000", "Tabel II.D.3: Kualitas Penerapan Manajemen Risiko untuk Risiko Kredit"),
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER4004PosSaAsrjk0204 eEnum : ER4004PosSaAsrjk0204.values()) {
	...
	public static String getName() {
		return ER4004PosSaAsrjk0204.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER4004PosSaAsrjk0204.class.getSimpleName().substring(2, 6));
	}
