...
import id.go.ojk.asrjk.client.builder.field.lb.reference.ER3063PosLbAsrjk121;
...
public class Lb121 extends BaseMetadata {
	...
	public SubmissionFormat get() {
		...
		fs.add(sf(1, null, "Kode Komponen / Baris",
				sv(M, 10, 10, refTable).confReference(EHeaderMetadataLb.R3063_LB121.getObject())));
		...
		fs.add(sf(3, null, "Karakteristik Garansi yang Diberikan - Jenis Garansi yang Diberikan",
				sv(C, 1, 50, all).confConditionalRequired(ER3063PosLbAsrjk121.genConditionField())));
		fs.add(sf(4, null, "Karakteristik Garansi yang Diberikan - Mata Uang",
				sv(C, 1, 6, refTable).confReference(EHeaderMetadataShared.R019.getObject())
						.confConditionalRequired(ER3063PosLbAsrjk121.genConditionField())));
		fs.add(sf(5, null, "Karakteristik Garansi yang Diberikan - Kurs",
				sv(C, 1, 16, numeric).confConditionalRequired(ER3063PosLbAsrjk121.genConditionField())));
		fs.add(sf(6, null, "Karakteristik Garansi yang Diberikan - Asumsi / Target Tingkat Hasil Investasi",
				sv(C, 1, 16, numericDot).confConditionalRequired(ER3063PosLbAsrjk121.genConditionField())));
