...
public enum ER3039PosLbAsrjk117 implements IObject<KeyValueString> {
//	R_4501000099 ("4501000099", "Penempatan Investasi Pada Bukan-Afiliasi"),
	...
	R_4501200000 ("4501200000", "Obligasi / Sukuk Daerah"),
	...
	R_4501210000 ("4501210000", "Dana Investasi Infrastruktur Berbentuk Kontrak Investasi Kolektif"),
...
//	R_4502000001 ("4502000001", "Penempatan Investasi Pada Afiliasi"),
	...
	R_4502200000 ("4502200000", "Obligasi / Sukuk Daerah"),
	...
	R_4502210000 ("4502210000", "Dana Investasi Infrastruktur Berbentuk Kontrak Investasi Kolektif"),
	...
	R_4502000000 ("4502000000", "Sub Total"),
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER3039PosLbAsrjk117 eEnum : ER3039PosLbAsrjk117.values()) {
	...
	public static String getName() {
		return ER3039PosLbAsrjk117.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER3039PosLbAsrjk117.class.getSimpleName().substring(2, 6));
	}
	...
	public static FieldValidation genFieldValidation5() {
		return UtilFieldValidation.genEqualsPosFormula("2+3+4", 
				UtilMetadata.genPipeRow(getObjects(), 0, 21) + "|" + UtilMetadata.genPipeRow(getObjects(), 23, 44) + "|" + R_4504000000.key);
	}
	
	public static SegmentValidation genValidationPenempatanInvestasiPadaBukanAfiliasi() {
		return UtilSegmentValidation.genEqualsFormula(UtilMetadata.genPipeColumn(2, 5), R_4501000000.key, 
				UtilMetadata.genPlusRow(getObjects(), 0, 21), "Total penempatan investasi pada bukan-afiliasi|Penjumlahan penempatan investasi pada bukan-afiliasi");
	}
	
	public static SegmentValidation genValidationPenempatanInvestasiPadaAfiliasi() {
		return UtilSegmentValidation.genEqualsFormula(UtilMetadata.genPipeColumn(2, 5), R_4502000000.key, 
				UtilMetadata.genPlusRow(getObjects(), 23, 44), "Total penempatan investasi pada afiliasi|Penjumlahan penempatan investasi pada afiliasi");
	}
	
	public static SegmentValidation genValidationHasilInvestasiBruto() {
		return UtilSegmentValidation.genEqualsFormula(UtilMetadata.genPipeColumn(2, 5), R_4503000000.key, 
				UtilMetadata.genPlusRow(getObjects(), new int[] { 22, 45 }), "Total hasil investasi bruto|Penjumlahan hasil investasi bruto");
	}
	
	public static SegmentValidation genValidationHasilInvestasiNeto() {
		return UtilSegmentValidation.genEqualsFormula(UtilMetadata.genPipeColumn(2, 5), R_4505000000.key, 
				UtilMetadata.genMinusRow(getObjects(), new int[] { 46, 47 }), "Total hasil investasi neto|Penjumlahan hasil investasi neto");
	}
	
	public static SegmentValidation genFormValidationHasilInvestasiNeto() {
		return UtilSegmentValidation.genEqualsForm("5", R_4505000000.key, EFormLaporanBulanan.LB_200.getCode(), "3", 
				ER3006PosLbAsrjk200.R_5600000000.getKey());
	}
}
