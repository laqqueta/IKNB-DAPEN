...
public enum ER4107PosSaAsrju0208 implements IObject<KeyValueString> {
...
//	R_02080302000000 ("02080302000000", "Tingkat Risiko Kepatuhan"),
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER4107PosSaAsrju0208 eEnum : ER4107PosSaAsrju0208.values()) {
	...
	public static String getName() {
		return ER4107PosSaAsrju0208.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER4107PosSaAsrju0208.class.getSimpleName().substring(2, 6));
	}
