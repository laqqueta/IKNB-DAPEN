...
public enum ER3062PosLbAsrjk120 implements IObject<KeyValueString> {
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER3062PosLbAsrjk120 eEnum : ER3062PosLbAsrjk120.values()) {
	...
	public static String getName() {
		return ER3062PosLbAsrjk120.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER3062PosLbAsrjk120.class.getSimpleName().substring(2, 6));
	}
	...
	public static FieldValidation genFieldValidation13() {
		return UtilFieldValidation.genReferenceCondition("2", String.valueOf(EHeaderMetadataShared.R042.getNumber()));
	}
