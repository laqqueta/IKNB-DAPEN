...
public enum ER4013PosSaAsrjk0400 implements IObject<KeyValueString> {
...
//	R_04000200000000 ("04000200000000", "Tabel IV.B: Peringkat Faktor Permodalan"),
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER4013PosSaAsrjk0400 eEnum : ER4013PosSaAsrjk0400.values()) {
	...
	public static String getName() {
		return ER4013PosSaAsrjk0400.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER4013PosSaAsrjk0400.class.getSimpleName().substring(2, 6));
	}
