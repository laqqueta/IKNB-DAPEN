...
public enum ER2014PosRbAsrjk1302 implements IObject<KeyValueString> {
...
//	R_3000000099 ("3000000099", "Ekuitas"),
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER2014PosRbAsrjk1302 eEnum : ER2014PosRbAsrjk1302.values()) {
	...
	public static String getName() {
		return ER2014PosRbAsrjk1302.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER2014PosRbAsrjk1302.class.getSimpleName().substring(2, 6));
	}
	...
	public static SegmentValidation genValidationLiabilitas() {
		return UtilSegmentValidation.genEqualsFormula("2|3|4|5", R_2100000000.key,
