...
public enum ER2146PosReAsrju0401 implements IObject<KeyValueString> {
...
//	R_04010204000000 ("04010204000000", "D. Rasio Aset Unit Syariah"),
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER2146PosReAsrju0401 eEnum : ER2146PosReAsrju0401.values()) {
	...
	public static String getName() {
		return ER2146PosReAsrju0401.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER2146PosReAsrju0401.class.getSimpleName().substring(2, 6));
	}
