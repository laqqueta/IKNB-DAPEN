...
import id.go.ojk.asrjk.client.builder.field.rb.uus.reference.ER2109PosRbAsrju0401;
...
public class Rb0401 extends BaseMetadata {
	...
	public SubmissionFormat get() {
		...
		fs.add(sf(3, null, "Lini Usaha/ Cabang Asuransi",
				sv(C, 0, 1000, all).confConditionalRequired(ER2109PosRbAsrju0401.genConditionalField())));
