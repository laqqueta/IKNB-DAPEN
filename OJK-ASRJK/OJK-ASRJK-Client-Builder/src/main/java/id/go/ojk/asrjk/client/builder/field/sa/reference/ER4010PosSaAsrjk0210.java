...
public enum ER4010PosSaAsrjk0210 implements IObject<KeyValueString> {
...
//	R_0210020000 ("0210020000", "Tabel II.L: Peringkat Faktor Profil Risiko"),
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER4010PosSaAsrjk0210 eEnum : ER4010PosSaAsrjk0210.values()) {
	...
	public static String getName() {
		return ER4010PosSaAsrjk0210.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER4010PosSaAsrjk0210.class.getSimpleName().substring(2, 6));
	}
