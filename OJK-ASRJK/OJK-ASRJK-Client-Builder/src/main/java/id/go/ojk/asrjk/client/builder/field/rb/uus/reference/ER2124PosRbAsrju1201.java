...
public enum ER2124PosRbAsrju1201 implements IObject<KeyValueString> {
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER2124PosRbAsrju1201 eEnum : ER2124PosRbAsrju1201.values()) {
	...
	public static String getName() {
		return ER2124PosRbAsrju1201.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER2124PosRbAsrju1201.class.getSimpleName().substring(2, 6));
	}
