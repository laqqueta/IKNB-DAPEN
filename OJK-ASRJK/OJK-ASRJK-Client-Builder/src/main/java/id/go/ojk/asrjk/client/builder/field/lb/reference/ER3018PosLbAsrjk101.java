...
public enum ER3018PosLbAsrjk101 implements IObject<KeyValueString> {
...
//	R_1500000099 ("1500000099", "Bukan Investasi"),
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER3018PosLbAsrjk101 eEnum : ER3018PosLbAsrjk101.values()) {
	...
	public static String getName() {
		return ER3018PosLbAsrjk101.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER3018PosLbAsrjk101.class.getSimpleName().substring(2, 6));
	}
