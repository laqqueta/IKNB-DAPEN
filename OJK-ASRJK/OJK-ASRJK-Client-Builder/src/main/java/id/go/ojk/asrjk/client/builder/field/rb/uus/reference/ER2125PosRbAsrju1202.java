...
public enum ER2125PosRbAsrju1202 implements IObject<KeyValueString> {
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER2125PosRbAsrju1202 eEnum : ER2125PosRbAsrju1202.values()) {
	...
	public static String getName() {
		return ER2125PosRbAsrju1202.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER2125PosRbAsrju1202.class.getSimpleName().substring(2, 6));
	}
