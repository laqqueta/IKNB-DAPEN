...
public enum ER3000PosLbAsrjk000 implements IObject<KeyValueString> {
	R_0100000000 ("0100000000", "1. Nama Perusahaan"),
	R_0200000000 ("0200000000", "2. Alamat Lengkap"),
	R_0300000000 ("0300000000", "3. DATI I (Provinsi)"),
	R_0400000000 ("0400000000", "4. DATI II (Kabupaten/Kotamdya)"),
	R_0500000000 ("0500000000", "5. Telepon"),
	R_0600000000 ("0600000000", "6. Fax"),
	R_0700000000 ("0700000000", "7. Email"),
	R_0800000000 ("0800000000", "8. NPWP"),
	R_0900000000 ("0900000000", "9. No Izin Usaha"),
	R_1000000000 ("1000000000", "10. Tgl Izin Usaha"),
//	R_1100000000 ("1100000000", "11. Informasi Kantor Cabang/Perwakilan"),
	R_1101000000 ("1101000000", "a. Jumlah Cabang/Perwakilan"),
	R_1102000000 ("1102000000", "b. Jumlah Tertanggung"),
	R_1200000000 ("1200000000", "12. Auditor Eksternal"),
	R_1300000000 ("1300000000", "13. Single Investor Identification (SID)"),
	;
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER3000PosLbAsrjk000 eEnum : ER3000PosLbAsrjk000.values()) {
	...
	public static String getName() {
		return ER3000PosLbAsrjk000.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER3000PosLbAsrjk000.class.getSimpleName().substring(2, 6));
	}
	...
	public static SegmentValidation genValidationDati1() {
		return UtilSegmentValidation.genReference("2", R_0300000000.key, String.valueOf(EHeaderMetadataShared.R005.getNumber()));
	}
	
	public static SegmentValidation genValidationDati2() {
		return UtilSegmentValidation.genReferenceCondition("2", R_0400000000.key, String.valueOf(EHeaderMetadataShared.R033.getNumber()), 
				R_0300000000.key);
	}
