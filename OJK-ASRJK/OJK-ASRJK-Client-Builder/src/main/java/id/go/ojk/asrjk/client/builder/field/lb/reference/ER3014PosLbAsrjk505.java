...
public enum ER3014PosLbAsrjk505 implements IObject<KeyValueString> {
...
//	R_2000000099 ("2000000099", "Liabilitas"),
	...
	R_2002000000 ("2002000000", "Kurs"),
	R_7100000199 ("7100000199", "Jumlah Aset Yang Diperkenankan "),
	R_2000000199 ("2000000199", "Jumlah Liabilitas "),
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER3014PosLbAsrjk505 eEnum : ER3014PosLbAsrjk505.values()) {
	...
	public static String getName() {
		return ER3014PosLbAsrjk505.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER3014PosLbAsrjk505.class.getSimpleName().substring(2, 6));
	}
	...
	public static String genFieldSave() {
		return UtilMetadata.genFieldSave(UtilMetadata.genPipeColumnExcept(3, 62, new int[] { 8, 11, 14, 17, 20, 23, 26, 29, 32, 35, 38, 41, 44, 47, 50, 53, 56, 59 }), 
				getObjects());
	}
	...
	public static SegmentValidation genValidationJumlahAsetYangDiperkenankan() {
		return UtilSegmentValidation.genEqualsFormula("3|4|6|7|9|10|12|13|15|16|18|19|21|22|24|25|27|28|30|31|33|34|36|37|39|40|42|43|45|46|48|49|51|52|54|55|57|58|60|61", 
				...
				"Total Aset Yang Diperkenankan|Penjumlahan Jumlah Aset Yang Diperkenankan");
	}
	...
	public static SegmentValidation genValidationJumlahAsetYangDiperkenankanDalamRupiah() {
		return UtilSegmentValidation.genEqualsFormula("3|4|6|7|9|10|12|13|15|16|18|19|21|22|24|25|27|28|30|31|33|34|36|37|39|40|42|43|45|46|48|49|51|52|54|55|57|58|60|61", 
				R_7100000199.key, R_1000000000.key + "*" + R_2002000000.key, 
				"Total Aset Yang Diperkenankan Dalam Rupiah|Perhitungan Aset Yang Diperkenankan Dalam Rupiah");
	}
	
	public static SegmentValidation genValidationJumlahLiabilitasDalamRupiah() {
		return UtilSegmentValidation.genEqualsFormula("3|4|6|7|9|10|12|13|15|16|18|19|21|22|24|25|27|28|30|31|33|34|36|37|39|40|42|43|45|46|48|49|51|52|54|55|57|58|60|61", 
				R_2000000199.key, R_2000000000.key + "*" + R_2002000000.key, 
	...
	public static SegmentValidation genValidationSelisihAsetYangDiperkenankanAtasLiabilitas() {
		return UtilSegmentValidation.genEqualsFormula("3|4|6|7|9|10|12|13|15|16|18|19|21|22|24|25|27|28|30|31|33|34|36|37|39|40|42|43|45|46|48|49|51|52|54|55|57|58|60|61|62|63", 
				R_7303020100.key, UtilMetadata.genMinusRow(getObjects(), 45, 46), 
				"Selisih Aset Yang Diperkenankan atas Liabilitas|Perhitungan Selisih Aset Yang Diperkenankan atas Liabilitas");
	}
	
	public static SegmentValidation genValidationFaktorSeMmbr2017A() {
		return UtilSegmentValidation.genFactorSeMmbr2017Validation("3|4|6|7|9|10|12|13|15|16|18|19|21|22|24|25|27|28|30|31|33|34|36|37|39|40|42|43|45|46|48|49|51|52|54|55|57|58", 
				R_7303020200.key, R_7303020100.key, R_2000000199.key);
	}
	
	public static SegmentValidation genValidationFaktorSeMmbr2017B() {
		return UtilSegmentValidation.genFixedValue("60|61", R_7303020200.key, "0.00");
	}
	
	public static SegmentValidation genValidationDeviationFaktorSeMmbr2017() {
		return UtilSegmentValidation.genDeviationFactorSeMmbr2017Validation("3|4|6|7|9|10|12|13|15|16|18|19|21|22|24|25|27|28|30|31|33|34|36|37|39|40|42|43|45|46|48|49|51|52|54|55|57|58|60|61", 
				R_7303020000.key, R_7303020200.key, R_7100000199.key, R_2000000199.key, 0);
	}
}
