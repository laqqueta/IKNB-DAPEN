...
public enum ER2010PosRbAsrjk1003 implements IObject<KeyValueString> {
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER2010PosRbAsrjk1003 eEnum : ER2010PosRbAsrjk1003.values()) {
	...
	public static String getName() {
		return ER2010PosRbAsrjk1003.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER2010PosRbAsrjk1003.class.getSimpleName().substring(2, 6));
	}
