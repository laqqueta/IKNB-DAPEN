...
public enum ER2118PosRbAsrju0901 implements IObject<KeyValueString> {
...
//	R_0901030000 ("0901030000", "C. Penutupan "),
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER2118PosRbAsrju0901 eEnum : ER2118PosRbAsrju0901.values()) {
	...
	public static String getName() {
		return ER2118PosRbAsrju0901.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER2118PosRbAsrju0901.class.getSimpleName().substring(2, 6));
	}
