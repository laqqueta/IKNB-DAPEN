...
public enum ER3021PosLbAsrjk104 implements IObject<KeyValueString> {
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER3021PosLbAsrjk104 eEnum : ER3021PosLbAsrjk104.values()) {
	...
	public static String getName() {
		return ER3021PosLbAsrjk104.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER3021PosLbAsrjk104.class.getSimpleName().substring(2, 6));
	}
