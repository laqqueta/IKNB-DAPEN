...
public enum ER3066PosLbAsrjk619 implements IObject<KeyValueString> {
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER3066PosLbAsrjk619 eEnum : ER3066PosLbAsrjk619.values()) {
	...
	public static String getName() {
		return ER3066PosLbAsrjk619.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER3066PosLbAsrjk619.class.getSimpleName().substring(2, 6));
	}
