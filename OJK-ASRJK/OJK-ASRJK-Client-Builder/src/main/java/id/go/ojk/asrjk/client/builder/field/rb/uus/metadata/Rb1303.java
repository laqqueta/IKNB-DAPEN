...
import id.go.ojk.asrjk.client.builder.field.rb.uus.reference.ER2136PosRbAsrju1303;
...
public class Rb1303 extends BaseMetadata {
	...
	public SubmissionFormat get() {
		...
		SubmissionFormat res = new SubmissionFormat(eEnum.getCode(), eEnum.getName(), reportCode,
				new ArrayList<>(), extension, 10, 10, ER2136PosRbAsrju1303.genFieldSave(), null,
				ER2136PosRbAsrju1303.getRequiredPos());
		res.addSegmentValidations(ER2136PosRbAsrju1303.genValidationNumeric());
		res.addSegmentValidations(ER2136PosRbAsrju1303.genValidationNumericDot());
		res.addSegmentValidations(ER2136PosRbAsrju1303.genValidationRasioLikuiditas());
		res.addSegmentValidations(ER2136PosRbAsrju1303.genValidationRasioPendapatanInvestasiNeto());
		res.addSegmentValidations(ER2136PosRbAsrju1303.genValidationPerubahanDana());
		res.addSegmentValidations(ER2136PosRbAsrju1303.genValidationRasioPerubahanDana());
