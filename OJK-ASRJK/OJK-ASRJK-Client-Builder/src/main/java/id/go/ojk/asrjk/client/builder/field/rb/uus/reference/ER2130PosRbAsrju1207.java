...
public enum ER2130PosRbAsrju1207 implements IObject<KeyValueString> {
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER2130PosRbAsrju1207 eEnum : ER2130PosRbAsrju1207.values()) {
	...
	public static String getName() {
		return ER2130PosRbAsrju1207.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER2130PosRbAsrju1207.class.getSimpleName().substring(2, 6));
	}
