...
public enum ER2015PosRbAsrjk1305 implements IObject<KeyValueString> {
...
//	R_5502000000 ("5502000000", "b. Beban Umum dan Administrasi:"),
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER2015PosRbAsrjk1305 eEnum : ER2015PosRbAsrjk1305.values()) {
	...
	public static String getName() {
		return ER2015PosRbAsrjk1305.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER2015PosRbAsrjk1305.class.getSimpleName().substring(2, 6));
	}
	...
	public static SegmentValidation genValidationBiayaAkuisisi() {
		return UtilSegmentValidation.genEqualsFormula("2|3|4|5", R_5402000000.key, 
	...
	public static SegmentValidation genValidationBebanUsaha() {
		return UtilSegmentValidation.genEqualsFormula("2|3|4|5", R_5500000000.key, 
				UtilMetadata.genPlusRow(getObjects(), 22, 28), 
				"Total Beban Usaha|Penjumlahan Beban Usaha");
	}
	
	public static SegmentValidation genValidationBeban() {
		return UtilSegmentValidation.genEqualsFormula("2|3|4|5", R_5000000000.key, 
	...
	public static SegmentValidation genValidationLabaSebelumPajak() {
		return UtilSegmentValidation.genEqualsFormula("2|3|4|5", R_3403010000.key, 
	...
	public static SegmentValidation genValidationLabaSetelahPajak() {
		return UtilSegmentValidation.genEqualsFormula("2|3|4|5", R_3403020000.key, 
	...
	public static SegmentValidation genValidationLabaKomprehensif() {
		return UtilSegmentValidation.genEqualsFormula("2|3|4|5", R_3403040000.key, 
