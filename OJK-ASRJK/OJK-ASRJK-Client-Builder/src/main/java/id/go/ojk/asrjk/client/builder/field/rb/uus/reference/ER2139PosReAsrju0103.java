...
public enum ER2139PosReAsrju0103 implements IObject<KeyValueString> {
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER2139PosReAsrju0103 eEnum : ER2139PosReAsrju0103.values()) {
	...
	public static String getName() {
		return ER2139PosReAsrju0103.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER2139PosReAsrju0103.class.getSimpleName().substring(2, 6));
	}
