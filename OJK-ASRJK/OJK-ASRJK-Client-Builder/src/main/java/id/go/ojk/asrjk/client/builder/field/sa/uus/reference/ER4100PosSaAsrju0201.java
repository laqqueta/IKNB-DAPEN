...
public enum ER4100PosSaAsrju0201 implements IObject<KeyValueString> {
...
//	R_02010302000000 ("02010302000000", "Tingkat Risiko Strategis"),
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER4100PosSaAsrju0201 eEnum : ER4100PosSaAsrju0201.values()) {
	...
	public static String getName() {
		return ER4100PosSaAsrju0201.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER4100PosSaAsrju0201.class.getSimpleName().substring(2, 6));
	}
