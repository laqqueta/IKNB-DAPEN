...
import id.go.ojk.asrjk.client.builder.field.rb.reference.ER2000PosRbAsrjk0104;
...
public class Rb0104 extends BaseMetadata {
	...
	public SubmissionFormat get() {
		...
		SubmissionFormat res = new SubmissionFormat(eEnum.getCode(), eEnum.getName(), reportCode,
				new ArrayList<>(), extension, 13, 13, null, null, ER2000PosRbAsrjk0104.getRequiredPos());
