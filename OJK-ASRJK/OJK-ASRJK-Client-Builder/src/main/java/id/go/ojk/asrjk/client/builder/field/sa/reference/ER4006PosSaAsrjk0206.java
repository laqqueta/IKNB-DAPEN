...
public enum ER4006PosSaAsrjk0206 implements IObject<KeyValueString> {
...
//	R_02060300000000 ("02060300000000", "Tabel II.F.3: Pedoman Penetapan Kualitas Penerapan Manajemen Risiko untuk Risiko Likuiditas"),
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER4006PosSaAsrjk0206 eEnum : ER4006PosSaAsrjk0206.values()) {
	...
	public static String getName() {
		return ER4006PosSaAsrjk0206.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER4006PosSaAsrjk0206.class.getSimpleName().substring(2, 6));
	}
