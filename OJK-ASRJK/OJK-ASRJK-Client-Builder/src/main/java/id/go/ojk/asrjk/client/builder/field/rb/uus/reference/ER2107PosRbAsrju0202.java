...
public enum ER2107PosRbAsrju0202 implements IObject<KeyValueString> {
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER2107PosRbAsrju0202 eEnum : ER2107PosRbAsrju0202.values()) {
	...
	public static String getName() {
		return ER2107PosRbAsrju0202.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER2107PosRbAsrju0202.class.getSimpleName().substring(2, 6));
	}
