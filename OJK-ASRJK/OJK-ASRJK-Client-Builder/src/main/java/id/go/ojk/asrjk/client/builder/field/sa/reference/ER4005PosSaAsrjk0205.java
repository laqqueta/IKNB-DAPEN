...
public enum ER4005PosSaAsrjk0205 implements IObject<KeyValueString> {
...
//	R_02050300000000 ("02050300000000", "Tabel II.E.3: Kualitas Penerapan Manajemen Risiko untuk Risiko Pasar "),
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER4005PosSaAsrjk0205 eEnum : ER4005PosSaAsrjk0205.values()) {
	...
	public static String getName() {
		return ER4005PosSaAsrjk0205.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER4005PosSaAsrjk0205.class.getSimpleName().substring(2, 6));
	}
