...
public enum ER2007PosRbAsrjk0702 implements IObject<KeyValueString> {
...
//	R_0702020000 ("0702020000", "Pemegang Saham"),	
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER2007PosRbAsrjk0702 eEnum : ER2007PosRbAsrjk0702.values()) {
	...
	public static String getName() {
		return ER2007PosRbAsrjk0702.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER2007PosRbAsrjk0702.class.getSimpleName().substring(2, 6));
	}
