...
public enum ER3024PosLbAsrjk107 implements IObject<KeyValueString> {
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER3024PosLbAsrjk107 eEnum : ER3024PosLbAsrjk107.values()) {
	...
	public static String getName() {
		return ER3024PosLbAsrjk107.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER3024PosLbAsrjk107.class.getSimpleName().substring(2, 6));
	}
	...
	public static ConditionalRequired genConditionalField22() {
		return UtilFieldConditional.genExistPosOrComparatorHasValue("N", "N", "M", R_1400000000.key, "2",
				UtilMetadata.genPipeRow(ER1000JenisInvestasi.getObjects(), new int[] { 2, 16, 18 }));
	}
	...
	public static FieldValidation genFieldValidation8() {
		return UtilFieldValidation.genReferenceCondition("2", String.valueOf(EHeaderMetadataShared.R038.getNumber()));
	}
