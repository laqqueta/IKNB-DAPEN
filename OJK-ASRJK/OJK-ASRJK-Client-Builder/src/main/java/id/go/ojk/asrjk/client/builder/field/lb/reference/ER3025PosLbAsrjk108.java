...
public enum ER3025PosLbAsrjk108 implements IObject<KeyValueString> {
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER3025PosLbAsrjk108 eEnum : ER3025PosLbAsrjk108.values()) {
	...
	public static String getName() {
		return ER3025PosLbAsrjk108.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER3025PosLbAsrjk108.class.getSimpleName().substring(2, 6));
	}
	...
	public static FieldValidation genFieldValidation4a() {
		return UtilFieldValidation.genReferenceCondition2("2", 
				...
				String.valueOf(EHeaderMetadataShared.R034.getNumber()));
	}
	...
	public static FieldValidation genFieldValidation4c() {
		return UtilFieldValidation.genMaxLength2("2", ER1002JenisInvestasiPaydi.R_103.getKey(),
				"3", ER1018DalamLuarNegeri.R_LO_E1.getKey(), "30");
	}
	
	public static FieldValidation genFieldValidation7() {
		return UtilFieldValidation.genReferenceCondition("2", String.valueOf(EHeaderMetadataShared.R036.getNumber()));
	}
	
	public static FieldValidation genFieldValidation8() {
		return UtilFieldValidation.genReferenceCondition("2", String.valueOf(EHeaderMetadataShared.R040.getNumber()));
	}
	
	public static SegmentValidation genValidationTotal() {
		return UtilSegmentValidation.genEqualsFormula("17|18|20", R_1400000000.key, R_1400080100.key, "Total|Penjumlahan detail");
	}
}
