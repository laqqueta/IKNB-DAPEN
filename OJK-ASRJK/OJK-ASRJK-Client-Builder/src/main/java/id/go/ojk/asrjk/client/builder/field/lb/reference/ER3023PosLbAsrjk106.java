...
public enum ER3023PosLbAsrjk106 implements IObject<KeyValueString> {
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER3023PosLbAsrjk106 eEnum : ER3023PosLbAsrjk106.values()) {
	...
	public static String getName() {
		return ER3023PosLbAsrjk106.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER3023PosLbAsrjk106.class.getSimpleName().substring(2, 6));
	}
