...
import id.go.ojk.asrjk.client.builder.field.apu.reference.ER5001PosApuAsrjk02;
...
public class Tapu02 extends BaseMetadata {
	...
	public SubmissionFormat get() {
		...
		SubmissionFormat res = new SubmissionFormat(eEnum.getCode(), eEnum.getName(), reportCode, new ArrayList<>(),
				extension, 49, 49, null, null, ER5001PosApuAsrjk02.getRequiredPos());
		...
		fs.add(sf(2, null, "Penilaian", sv(M, 1, 1, numeric))
				.addFieldValidations(ER5001PosApuAsrjk02.genValidationPenilaian()));
