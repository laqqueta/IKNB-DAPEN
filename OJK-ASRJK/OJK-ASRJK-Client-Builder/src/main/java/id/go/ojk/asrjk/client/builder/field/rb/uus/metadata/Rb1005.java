...
import id.go.ojk.asrjk.client.builder.field.rb.uus.reference.ER2123PosRbAsrju1005;
...
public class Rb1005 extends BaseMetadata {
	...
	public SubmissionFormat get() {
		...
		fs.add(sf(3, null, "Kepemilikan (inhouse/ vendor)",
				sv(C, 0, 1000, all).confConditionalRequired(ER2123PosRbAsrju1005.genConditionalField())));
