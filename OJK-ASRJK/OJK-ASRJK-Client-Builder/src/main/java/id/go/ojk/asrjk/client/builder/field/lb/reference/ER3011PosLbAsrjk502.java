...
public enum ER3011PosLbAsrjk502 implements IObject<KeyValueString> {
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER3011PosLbAsrjk502 eEnum : ER3011PosLbAsrjk502.values()) {
	...
	public static String getName() {
		return ER3011PosLbAsrjk502.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER3011PosLbAsrjk502.class.getSimpleName().substring(2, 6));
	}
	...
	public static ConditionalRequired genConditionalMustEmpty2() {
		return UtilFieldConditional.genExistPos("N", "O", R_7301020200.key);
	}
