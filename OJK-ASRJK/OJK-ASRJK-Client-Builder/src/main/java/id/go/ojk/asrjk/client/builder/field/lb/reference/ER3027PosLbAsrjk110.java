...
public enum ER3027PosLbAsrjk110 implements IObject<KeyValueString> {
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER3027PosLbAsrjk110 eEnum : ER3027PosLbAsrjk110.values()) {
	...
	public static String getName() {
		return ER3027PosLbAsrjk110.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER3027PosLbAsrjk110.class.getSimpleName().substring(2, 6));
	}
	...
	public static ConditionalRequired genConditionalField2() {
		return UtilFieldConditional.genExistPos("N", "M", R_1400100200.key);
	}
	...
	public static ConditionalRequired genConditionalField4() {
		return UtilFieldConditional.genExistPosOrComparatorHasValue("N", "N", "M", R_1400100200.key, "3",
				UtilMetadata.genPipeRow(ER1025JenisLiabilitas.getObjects(), new int[] { 1, 2, 5, 6 }));
	}

	public static ConditionalRequired genConditionalField5() {
		return UtilFieldConditional.genExistPosOrComparatorHasValue("N", "N", "M", R_1400100200.key, "3",
				UtilMetadata.genPipeRow(ER1025JenisLiabilitas.getObjects(), 0, 3));
	}
	...
	public static FieldValidation genValidationField5() {
		return UtilFieldValidation.genReferenceCondition("3", String.valueOf(EHeaderMetadataShared.R039.getNumber()));
	}
