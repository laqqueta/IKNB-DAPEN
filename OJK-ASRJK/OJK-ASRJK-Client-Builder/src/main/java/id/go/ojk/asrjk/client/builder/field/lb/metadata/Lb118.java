...
import id.go.ojk.asrjk.client.builder.field.lb.reference.ER3040PosLbAsrjk118;
...
public class Lb118 extends BaseMetadata {
	...
	public SubmissionFormat get() {
		...
		SubmissionFormat res = new SubmissionFormat(eEnum.getCode(), eEnum.getName(), reportCode,
				new ArrayList<>(), extension, 5, 5, ER3040PosLbAsrjk118.genFieldSave(),
				ER3040PosLbAsrjk118.genFieldSave(), ER3040PosLbAsrjk118.getRequiredPos());
		res.addSegmentValidations(ER3040PosLbAsrjk118.genValidationKlaimPenebusanUnit());
		List<SubmissionField> fs = res.getFields();
		fs.add(sf(0, null, "Flag Detail", sv(M, 3, 3, alfaNumeric).confConstant("D01")));
		fs.add(sf(1, null, "Kode Komponen / Baris",
				sv(M, 10, 10, refTable).confReference(EHeaderMetadataLb.R3040_LB118.getObject())).confUnique(U));
		...
		fs.add(sf(5, null, "Jumlah", sv(M, 1, 16, numericNegatif))
				.addFieldValidations(ER3040PosLbAsrjk118.genFieldValidation5()));
		return res;
	}
}
