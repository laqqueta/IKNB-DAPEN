...
public enum ER3060PosLbAsrjk119 implements IObject<KeyValueString> {
	R_1408010000 ("1408010000", "SBN"),
	R_1408010001 ("1408010001", "Rincian baris SBN"),
	R_1408020000 ("1408020000", "OBLIGASI / SUKUK INFRASTRUKTUR"),
	R_1408020001 ("1408020001", "Rincian baris Obligasi/Sukuk Infrastruktur"),
	R_1408030000 ("1408030000", "REKSADANA UNDERLYING SBN"),
	R_1408030001 ("1408030001", "Rincian baris Reksadana Underlying SBN"),
	R_1408040000 ("1408040000", "REKSADANA PENYERTAAN TERBATAS"),
	R_1408040001 ("1408040001", "Rincian baris Reksadana Penyertaan Terbatas"),
	R_1408050000 ("1408050000", "EFEK BERAGUN ASET"),
	R_1408050001 ("1408050001", "Rincian baris Efek Beragun Aset"),
	R_1408060000 ("1408060000", "INVESTASI LAIN UNTUK PEMBIAYAAN PROYEK INFRASTRUKTUR PEMERINTAH"),
	R_1408060001 ("1408060001", "Rincian baris Investasi Lain untuk Pembiayaan Proyek Infrastruktur Pemerintah"),
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER3060PosLbAsrjk119 eEnum : ER3060PosLbAsrjk119.values()) {
	...
	public static String getName() {
		return ER3060PosLbAsrjk119.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER3060PosLbAsrjk119.class.getSimpleName().substring(2, 6));
	}
	...
	public static SegmentValidation genValidationTotal() {
		return UtilSegmentValidation.genEqualsFormula("8", R_1408000000.key, UtilMetadata.genPlusRow(getObjects(), new int[] { 0, 2, 4, 6, 9, 10 }), "Total pemenuhan SBN|Penjumlahan rincian pemenuhan SBN");
	}
}
