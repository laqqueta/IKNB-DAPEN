...
public enum ER4108PosSaAsrju0209 implements IObject<KeyValueString> {
...
//	R_02090302000000 ("02090302000000", "Tingkat Risiko Reputasi"),
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER4108PosSaAsrju0209 eEnum : ER4108PosSaAsrju0209.values()) {
	...
	public static String getName() {
		return ER4108PosSaAsrju0209.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER4108PosSaAsrju0209.class.getSimpleName().substring(2, 6));
	}
