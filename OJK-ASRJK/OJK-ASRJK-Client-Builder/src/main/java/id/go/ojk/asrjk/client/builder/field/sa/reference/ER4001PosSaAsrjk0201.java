...
public enum ER4001PosSaAsrjk0201 implements IObject<KeyValueString> {
...
//	R_02010101010000 ("02010101010000", "1. Rasio perbandingan realisasi terhadap target"),
	R_02010101010100 ("02010101010100", " a. Premi Bruto"),
	R_02010101010200 ("02010101010200", " b. Klaim"),
	R_02010101010300 ("02010101010300", " c. Hasil Underwriting"),
	R_02010101010400 ("02010101010400", " d. Hasil Investasi"),
	R_02010101010500 ("02010101010500", " e. Laba Usaha"),
	...
	R_02010101040000 ("02010101040000", "4. Pertumbuhan premi polis baru"),
	R_02010101050000 ("02010101050000", "5. Rasio pertumbuhan laba dari bisnis utama"),
...
//	R_02010200000000 ("02010200000000", "Tabel II.A.2: Tingkat Risiko Inheren untuk Risiko Strategis"),
	R_02010201000000 ("02010201000000", "Tingkat Risiko Inheren untuk Risiko Strategis"),
//	R_02010300000000 ("02010300000000", "Tabel II.A.3: Kualitas Penerapan Manajemen Risiko untuk Risiko Strategis"),
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER4001PosSaAsrjk0201 eEnum : ER4001PosSaAsrjk0201.values()) {
	...
	public static String getName() {
		return ER4001PosSaAsrjk0201.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER4001PosSaAsrjk0201.class.getSimpleName().substring(2, 6));
	}
	...
	public static SegmentValidation genValidationMaxLengthNumericDotNegative() {
		return UtilSegmentValidation.genMaxLength("2", UtilMetadata.genPipeRow(getObjects(), 0, 8), 8);
	}
	
	public static SegmentValidation genValidationNumeric() {
		return UtilSegmentValidation.genRegexNumeric("2", UtilMetadata.genPipeRow(getObjects(), 23, 24));
	}
	
	public static SegmentValidation genValidationMaxLengthNumeric() {
		return UtilSegmentValidation.genMaxLength("2", UtilMetadata.genPipeRow(getObjects(), 23, 24), 1);
	}
	
	public static SegmentValidation genValidationPeringkat() {
		return UtilSegmentValidation.genFixedValue("2", UtilMetadata.genPipeRow(getObjects(), 23, 24), ER1099Peringkat.getPipedKey());
	}
}
