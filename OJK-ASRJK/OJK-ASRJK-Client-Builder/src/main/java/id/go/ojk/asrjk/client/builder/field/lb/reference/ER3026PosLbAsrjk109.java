...
public enum ER3026PosLbAsrjk109 implements IObject<KeyValueString> {
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER3026PosLbAsrjk109 eEnum : ER3026PosLbAsrjk109.values()) {
	...
	public static String getName() {
		return ER3026PosLbAsrjk109.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER3026PosLbAsrjk109.class.getSimpleName().substring(2, 6));
	}
	...
	public static ConditionalRequired genConditionalField4() {
		return UtilFieldConditional.genExistPosOrComparatorNotEmpty("N", "N", "M", R_1400090200.key, "3");
	}
	...
	public static ConditionalRequired genConditionalField11() {
		return UtilFieldConditional.genExistPosOrComparatorNotEmpty("N", "M", "M", R_1400090200.key, "3");
	}
	...
	public static FieldValidation genFieldValidation5() {
		return UtilFieldValidation.genReferenceCondition("3", String.valueOf(EHeaderMetadataShared.R037.getNumber()));
	}
	
	public static SegmentValidation genValidationTotal() {
		return UtilSegmentValidation.genEqualsFormula("11|12|13|14|15|16|17|18|19", R_1400090200.key, 
				R_1400090100.key, "Total|Penjumlahan detail");
	}
}
