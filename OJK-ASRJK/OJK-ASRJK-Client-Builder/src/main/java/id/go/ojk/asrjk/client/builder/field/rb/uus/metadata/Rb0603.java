...
import id.go.ojk.asrjk.client.builder.field.rb.uus.reference.ER2113PosRbAsrju0603;
...
public class Rb0603 extends BaseMetadata {
	...
	public SubmissionFormat get() {
		...
		fs.add(sf(1, null, "Kode Komponen / Baris",
				sv(M, 10, 10, refTable).confReference(EHeaderMetadataRbUus.R2113_RB0603.getObject())));
		...
		fs.add(sf(3, null, "Aktual per 30 Sept 20XX-1", sv(C, 0, 16, numericNegatif)
				.confConditionalRequired(ER2113PosRbAsrju0603.genConditionalField())));
