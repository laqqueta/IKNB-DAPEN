...
public enum ER2126PosRbAsrju1203 implements IObject<KeyValueString> {
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER2126PosRbAsrju1203 eEnum : ER2126PosRbAsrju1203.values()) {
	...
	public static String getName() {
		return ER2126PosRbAsrju1203.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER2126PosRbAsrju1203.class.getSimpleName().substring(2, 6));
	}
