...
public enum ER2021PosReAsrjk0300 implements IObject<KeyValueString> {
...
//	R_1501040298 ("1501040298", "Arus Kas Keluar"),
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER2021PosReAsrjk0300 eEnum : ER2021PosReAsrjk0300.values()) {
	...
	public static String getName() {
		return ER2021PosReAsrjk0300.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER2021PosReAsrjk0300.class.getSimpleName().substring(2, 6));
	}
	...
	public static SegmentValidation genValidationArusKasMasukOperasi() {
		return UtilSegmentValidation.genEqualsFormula("2|3", R_1501020100.key, 
				...
				"Total Arus Kas Masuk Aktivitas Operasi|Penjumlahan Arus Kas Masuk Aktivitas Operasi");
	}
	...
	public static SegmentValidation genValidationArusKasKeluarOperasi() {
		return UtilSegmentValidation.genEqualsFormula("2|3", R_1501020200.key, 
				...
				"Total Arus Kas Keluar Aktivitas Operasi|Penjumlahan Arus Kas Keluar Aktivitas Operasi");
	}

	public static SegmentValidation genValidationArusKasOperasi() {
		return UtilSegmentValidation.genEqualsFormula("2|3", R_1501020000.key, 
				R_1501020100.key + "-" + R_1501020200.key, 
				"Total Arus Kas Aktivitas Operasi|Penjumlahan Arus Kas Aktivitas Operasi");
	}

	public static SegmentValidation genValidationArusMasukInvestasi() {
		return UtilSegmentValidation.genEqualsFormula("2|3", R_1501030100.key, 
				UtilMetadata.genPlusRow(getObjects(), 15, 18), 
				"Total Arus Kas Masuk Aktivitas Investasi|Penjumlahan Arus Kas Masuk Aktivitas Investasi");
	}

	public static SegmentValidation genValidationArusKeluarInvestasi() {
		return UtilSegmentValidation.genEqualsFormula("2|3", R_1501030200.key, 
				UtilMetadata.genPlusRow(getObjects(), 20, 22), 
				"Total Arus Kas Keluar Aktivitas Investasi|Penjumlahan Arus Kas Keluar Aktivitas Investasi");
	}

	public static SegmentValidation genValidationArusInvestasi() {
		return UtilSegmentValidation.genEqualsFormula("2|3", R_1501030000.key, 
				R_1501030100.key + "-" + R_1501030200.key, 
				"Total Arus Kas Aktivitas Investasi|Penjumlahan Arus Kas Aktivitas Investasi");
	}
	...
	public static SegmentValidation genValidationArusKasMasukPendanaan() {
		return UtilSegmentValidation.genEqualsFormula("2|3", R_1501040100.key, 
				...
				"Total Arus Kas Masuk Aktivitas Pendanaan|Penjumlahan Arus Kas Masuk Aktivitas Pendanaan");
	}
	...
	public static SegmentValidation genValidationArusKasKeluarPendanaan() {
		return UtilSegmentValidation.genEqualsFormula("2|3", R_1501040200.key, 
				...
				"Total Arus Kas Keluar Aktivitas Pendanaan|Penjumlahan Arus Kas Keluar Aktivitas Pendanaan");
	}

	public static SegmentValidation genValidationArusKasPendanaan() {
		return UtilSegmentValidation.genEqualsFormula("2|3", R_1501040000.key, 
				R_1501040100.key + "-" + R_1501040200.key, 
				"Total Arus Kas Aktivitas Pendanaan|Penjumlahan Arus Kas Aktivitas Pendanaan");
	}

	public static SegmentValidation genValidationSaldoAkhir() {
