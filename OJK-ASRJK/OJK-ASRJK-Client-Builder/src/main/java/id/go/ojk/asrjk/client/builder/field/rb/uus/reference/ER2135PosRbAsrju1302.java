...
public enum ER2135PosRbAsrju1302 implements IObject<KeyValueString> {
...
//	R_13020202000000 ("13020202000000", "2. Rasio perimbangan investasi dengan liabilitas"),
	...
	R_13020202050000 ("13020202050000", "e. Aset yang diperhitungkan untuk qard pada dana perusahaan"),
	R_13020202060000 ("13020202060000", "f. Rasio [(a+e):(b+c)]"),
...
//	R_13020207000000 ("13020207000000", "7. Penghitungan Qardh yang Diperlukan Dana Tanahud"),
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER2135PosRbAsrju1302 eEnum : ER2135PosRbAsrju1302.values()) {
	...
	public static String getName() {
		return ER2135PosRbAsrju1302.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER2135PosRbAsrju1302.class.getSimpleName().substring(2, 6));
	}
	...
	public static SegmentValidation genValidationNumeric() {
		return UtilSegmentValidation.genRegexNumericNegative("2|3|4|5",
				UtilMetadata.genPipeRow(getObjects(), 
						new int[] { 0, 1, 2, 3, 7, 8, 9, 11, 12, 14, 15, 16, 18, 20, 21, 23, 24, 26, 27, 28, 30, 31, 32, 33, 34, 35 }));
	}

	public static SegmentValidation genValidationNumericDot() {
		return UtilSegmentValidation.genRegexNumericDotNegative("2|3|4|5",
				UtilMetadata.genPipeRow(getObjects(), new int[] { 4, 5, 6, 10, 13, 17, 19, 22, 25, 29 }));
	}
	...
	public static SegmentValidation genValidationAsetYgTersediaUntukQardhYgDiperhitungkanSebagaiPenambahAYDDanaTabarruDanTanahud() {
		return UtilSegmentValidation.genMaxValue("2|3|4|5", R_13020106000000.key,
				UtilMetadata.genPipeRow(getObjects(), new int[] { 8, 9 }), "",
				"Perhitungan Aset yang Tersedia Untuk Qardh yang Diperhitungkan sebagai Penambah AYD Dana Tabarru' dan Tanahud");
	}

	public static SegmentValidation genValidationKekuranganTingkatSolvabilitasDariTargetInternal() {
		return UtilSegmentValidation.genMaxValue2("2|3|4|5", R_13020106010000.key,
				R_13020104000000.key + "-" + R_13020103000000.key + "*" + R_13020102000000.key, ".01", "0",
				"Perhitungan Kekurangan (kelebihan) tingkat solvabilitas dari target internal", 0);
	}

	public static SegmentValidation genValidationRasioTingkatSolvabilitasDanaPerusahaan() {
		return UtilSegmentValidation.genEqualsRatio("2|3|4|5", R_13020107000000.key,
				UtilMetadata.genPlusRow(getObjects(), new int[] { 0, 7 }) + "|" + R_13020102000000.key, 
				"Rasio Tingkat Solvabilitas Dana Perusahaan|Perhitungan Rasio Tingkat Solvabilitas Dana Perusahaan");
	}
	...
	public static SegmentValidation genValidation20() {
		return UtilSegmentValidation.genEqualsRatio("2|3|4|5", R_13020202060000.key,
				R_13020202010000.key + "+" + R_13020202050000.key+ "|" + R_13020202020000.key + "+" + R_13020202030000.key, 
				"Total Rasio perimbangan investasi (setelah penambahan akun qardh) dengan liabilitas|Perhitungan Rasio perimbangan investasi (setelah penambahan akun qardh) dengan liabilitas");
	}
