...
public enum ER6101PosPlsAsrju0100 implements IObject<KeyValueString> {
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER6101PosPlsAsrju0100 eEnum : ER6101PosPlsAsrju0100.values()) {
	...
	public static String getName() {
		return ER6101PosPlsAsrju0100.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER6101PosPlsAsrju0100.class.getSimpleName().substring(2, 6));
	}
