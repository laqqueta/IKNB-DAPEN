...
import id.go.ojk.asrjk.client.builder.field.sa.reference.ER4014PosSaAsrjk0501;
...
public class Sa0501 extends BaseMetadata {
	...
	public SubmissionFormat get() {
		...
		SubmissionFormat res = new SubmissionFormat(eEnum.getCode(), eEnum.getName(), reportCode,
				new ArrayList<>(), extension, 6, 6, null, null, ER4014PosSaAsrjk0501.getRequiredPos());
		...
		fs.add(sf(2, null, "Peringkat - Individu", sv(M, 1, 1, numeric))
				.addFieldValidations(ER4014PosSaAsrjk0501.genValidationPeringkat()));
