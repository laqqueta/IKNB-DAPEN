...
public enum ER2108PosRbAsrju0203 implements IObject<KeyValueString> {
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER2108PosRbAsrju0203 eEnum : ER2108PosRbAsrju0203.values()) {
	...
	public static String getName() {
		return ER2108PosRbAsrju0203.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER2108PosRbAsrju0203.class.getSimpleName().substring(2, 6));
	}
