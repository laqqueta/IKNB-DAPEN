...
public enum ER2101PosRbAsrju0102 implements IObject<KeyValueString> {
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER2101PosRbAsrju0102 eEnum : ER2101PosRbAsrju0102.values()) {
	...
	public static String getName() {
		return ER2101PosRbAsrju0102.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER2101PosRbAsrju0102.class.getSimpleName().substring(2, 6));
	}
