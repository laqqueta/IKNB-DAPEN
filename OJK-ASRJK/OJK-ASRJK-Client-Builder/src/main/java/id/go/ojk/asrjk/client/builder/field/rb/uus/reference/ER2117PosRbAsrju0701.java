...
public enum ER2117PosRbAsrju0701 implements IObject<KeyValueString> {
...
//	R_0701020000 ("0701020000", "Pemegang Saham "),
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER2117PosRbAsrju0701 eEnum : ER2117PosRbAsrju0701.values()) {
	...
	public static String getName() {
		return ER2117PosRbAsrju0701.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER2117PosRbAsrju0701.class.getSimpleName().substring(2, 6));
	}
