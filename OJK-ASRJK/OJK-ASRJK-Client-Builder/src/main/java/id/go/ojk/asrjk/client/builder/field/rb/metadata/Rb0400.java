...
import id.go.ojk.asrjk.client.builder.field.rb.reference.ER2003PosRbAsrjk0400;
...
public class Rb0400 extends BaseMetadata {
	...
	public SubmissionFormat get() {
		...
		fs.add(sf(3, null, "Lini Usaha/ Cabang Asuransi",
				sv(C, 0, 1000, all).confConditionalRequired(ER2003PosRbAsrjk0400.genConditionalField())));
