...
public enum ER3010PosLbAsrjk501 implements IObject<KeyValueString> {
//	 R_1400000000 ("1400000000", "INVESTASI", "0"), 
//	 R_1401000000 ("1401000000", "Deposito Berjangka", "0"), 
	 R_1401010000 ("1401010000", "Kategori Khusus (sampai dengan 2 milyar per bank)", "0.00"), 
//	 R_1401020000 ("1401020000", "Kategori Lain, sesuai peringkat Bank:", "0"), 
...
//	 R_1402000000 ("1402000000", "Sertifikat Deposito", "0"), 
	 R_1402010000 ("1402010000", "Kategori Khusus (sampai dengan 2 milyar per bank)", "0.00"), 
//	 R_1402020000 ("1402020000", "Kategori Lain, sesuai peringkat Bank:", "0"), 
...
//	 R_1404000000 ("1404000000", "Obligasi Korporasi", "0"), 
...
//	 R_1410000000 ("1410000000", "Obligasi / Sukuk Daerah", "0"), 
...
//	 R_1407000000 ("1407000000", "Surat Berharga Yang Diterbitkan oleh Negara selain Negara RI ", "0"), 
...
//	 R_1416000000 ("1416000000", "Pembiayaan Melalui Kerjasama dengan Pihak Lain*", "0"), 
...
//	 R_1418000000 ("1418000000", "Pinjaman yang Dijamin dengan Hak Tanggungan", "0"), 
//	 R_1415010000 ("1415010000", "Properti residensial", "0"), 
	 R_1415010100 ("1415010100", "a. LTV <= 65%", "2.80"), 
	 R_1415010200 ("1415010200", "b. 65% < LTV < 75%", "4.00"), 
//	 R_1415020000 ("1415020000", "Properti komersial lainnya", "0"), 
...
//	 R_1504000000 ("1504000000", "Aset Reasuransi", "0"), 
...
//	 R_1505000000 ("1505000000", "Tagihan Klaim Koasuransi", "0"), 
	 R_1505010000 ("1505010000", "Dalam Negeri", "2.80"), 
//	 R_1505020000 ("1505020000", "Luar Negeri:", "0"), 
...
//	 R_1503000000 ("1503000000", "Tagihan Premi Reasuransi ", "0"), 
	 R_1503010000 ("1503010000", "Dalam Negeri", "2.80"), 
//	 R_1503020000 ("1503020000", "Luar Negeri:", "0"), 
...
//	 R_1506000000 ("1506000000", "Tagihan Klaim Reasuransi", "0"), 
	 R_1506010000 ("1506010000", "Dalam Negeri", "2.80"), 
//	 R_1506020000 ("1506020000", "Luar Negeri:", "0"), 
...
//	 R_1507000000 ("1507000000", "Tagihan Investasi", "0"), 
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER3010PosLbAsrjk501 eEnum : ER3010PosLbAsrjk501.values()) {
	...
	public static String getName() {
		return ER3010PosLbAsrjk501.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER3010PosLbAsrjk501.class.getSimpleName().substring(2, 6));
	}
	...
	private static String getLookup() {
		...
		ER3010PosLbAsrjk501[] eEnums = ER3010PosLbAsrjk501.values();
		int enumLength = eEnums.length;
		for (int i= 0; i < enumLength; i++) {
			ER3010PosLbAsrjk501 eEnum = ER3010PosLbAsrjk501.values()[i];
