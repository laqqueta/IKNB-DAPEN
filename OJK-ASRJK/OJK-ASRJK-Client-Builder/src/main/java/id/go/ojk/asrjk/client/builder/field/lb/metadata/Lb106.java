...
import id.go.ojk.asrjk.client.builder.field.lb.reference.ER3023PosLbAsrjk106;
...
public class Lb106 extends BaseMetadata {
	...
	public SubmissionFormat get() {
		...
		SubmissionFormat res = new SubmissionFormat(eEnum.getCode(), eEnum.getName(), reportCode,
				new ArrayList<>(), extension, 1, null, ER3023PosLbAsrjk106.genFieldSave(), null,
				ER3023PosLbAsrjk106.getRequiredPos());
		res.addSegmentValidations(ER3023PosLbAsrjk106.genValidationTotal());
		...
		fs.add(sf(2, null, "I. Penempatan Investasi Pada Pihak Terafiliasi Dengan Perusahaan - Nama Perusahaan",
				sv(C, 1, 100, all).confConditionalRequired(ER3023PosLbAsrjk106.genConditionalMustEmpty2())));
		fs.add(sf(3, null, "I. Penempatan Investasi Pada Pihak Terafiliasi Dengan Perusahaan - Hubungan Kepemilikan",
				sv(C, 1, 100, all).confConditionalRequired(ER3023PosLbAsrjk106.genConditionalField345())));
		...
		fs.add(sf(5, null, "I. Penempatan Investasi Pada Pihak Terafiliasi Dengan Perusahaan - Persentase Kepemilikan",
				sv(C, 1, 6, numericDotNegatif).confConditionalRequired(ER3023PosLbAsrjk106.genConditionalField345())));
		fs.add(sf(6, null,
				"I. Penempatan Investasi Pada Pihak Terafiliasi Dengan Perusahaan - Nilai Kepemilikan (dalam Juta Rupiah)",
				sv(C, 1, 16, numericNegatif).confConditionalRequired(ER3023PosLbAsrjk106.genConditionalField6())));
		fs.add(sf(7, null, "II. Penempatan Investasi Pada Pihak Terafiliasi Tidak Dengan Perusahaan - Nama Perusahaan",
				sv(C, 1, 100, all).confConditionalRequired(ER3023PosLbAsrjk106.genConditionalField789())));
