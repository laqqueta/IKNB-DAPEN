...
public enum ER3008PosLbAsrjk400 implements IObject<KeyValueString> {
...
//	R_3412990099 ("3412990099", " Pengurangan Lainnya:"),
...
//	R_3420000099 ("3420000099", "Ekuitas SAP"),
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER3008PosLbAsrjk400 eEnum : ER3008PosLbAsrjk400.values()) {
	...
	public static String getName() {
		return ER3008PosLbAsrjk400.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER3008PosLbAsrjk400.class.getSimpleName().substring(2, 6));
	}
