...
public enum ER4000PosSaAsrjk0100 implements IObject<KeyValueString> {
...
//	R_01000200000000 ("01000200000000", "Tabel I.B: Peringkat Faktor tata kelola Perusahaan yang Baik "),
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER4000PosSaAsrjk0100 eEnum : ER4000PosSaAsrjk0100.values()) {
	...
	public static String getName() {
		return ER4000PosSaAsrjk0100.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER4000PosSaAsrjk0100.class.getSimpleName().substring(2, 6));
	}
