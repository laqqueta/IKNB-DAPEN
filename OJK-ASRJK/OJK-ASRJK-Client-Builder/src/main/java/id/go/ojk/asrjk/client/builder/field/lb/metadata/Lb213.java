...
import id.go.ojk.asrjk.client.builder.field.lb.reference.ER3049PosLbAsrjk213;
...
public class Lb213 extends BaseMetadata {
	...
	public SubmissionFormat get() {
		...
		SubmissionFormat res = new SubmissionFormat(eEnum.getCode(), eEnum.getName(), reportCode,
				new ArrayList<>(), extension, 7, 7, ER3049PosLbAsrjk213.genFieldSave(), null,
				ER3049PosLbAsrjk213.getRequiredPos());
		res.addSegmentValidations(ER3049PosLbAsrjk213.genValidationPremiBruto());
		res.addSegmentValidations(ER3049PosLbAsrjk213.genValidationBebanKlaim());
		List<SubmissionField> fs = res.getFields();
		fs.add(sf(0, null, "Flag Detail", sv(M, 3, 3, alfaNumeric).confConstant("D01")));
		fs.add(sf(1, null, "Kode Komponen / Baris",
				sv(M, 10, 10, refTable).confReference(EHeaderMetadataLb.R3049_LB213.getObject())).confUnique(U));
		...
		fs.add(sf(23, null, "Jumlah", sv(M, 1, 16, numericNegatif))
				.addFieldValidations(ER3049PosLbAsrjk213.genFieldValidation23()));
		return res;
	}
}
