...
public enum ER6001PosPlsAsrjk0100 implements IObject<KeyValueString> {
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER6001PosPlsAsrjk0100 eEnum : ER6001PosPlsAsrjk0100.values()) {
	...
	public static String getName() {
		return ER6001PosPlsAsrjk0100.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER6001PosPlsAsrjk0100.class.getSimpleName().substring(2, 6));
	}
  ...
  public static String getUniquePos() {
	...
	public static String genFieldSave() {
		return UtilMetadata.genFieldSave("14|15|16|17", getObjects());
	}
	...
	public static ConditionalRequired genConditionalExistPosAndComparatorNotEmptyA() {
		return UtilFieldConditional.genExistPosAndComparatorNotEmpty("M", "N", "N", R_0010010000.key, "2");
	}
	
	public static ConditionalRequired genConditionalExistPosAndComparatorNotEmptyB() {
		return UtilFieldConditional.genExistPosAndComparatorNotEmpty("M", "N", "M",  R_0010010000.key, "2");
	}
	...
	public static FieldValidation genValidationField14() {
		return UtilFieldValidation.genGreaterValue("0");
	}
	
	public static FieldValidation genValidationField17A() {
		return UtilFieldValidation.genIfComparatorEquals("4", "200|300", "1");
	}
	
	public static FieldValidation genValidationField17B() {
