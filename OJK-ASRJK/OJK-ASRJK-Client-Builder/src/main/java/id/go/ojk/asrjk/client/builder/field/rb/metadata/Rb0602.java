...
import id.go.ojk.asrjk.client.builder.field.rb.reference.ER2006PosRbAsrjk0602;
...
public class Rb0602 extends BaseMetadata {
	...
	public SubmissionFormat get() {
		...
		SubmissionFormat res = new SubmissionFormat(eEnum.getCode(), eEnum.getName(), reportCode,
				new ArrayList<>(), extension, 1, null, ER2006PosRbAsrjk0602.genFieldSave(), null,
				ER2006PosRbAsrjk0602.getRequiredPos());
		res.addSegmentValidations(ER2006PosRbAsrjk0602.genValidationHasilInvestasi());
		...
		fs.add(sf(2, null, "Jenis Investasi",
				sv(C, 0, 1000, refTable).confReference(EHeaderMetadataShared.R000.getObject())
						.confConditionalRequired(ER2006PosRbAsrjk0602.genConditionalFieldMustEmpty())));
		fs.add(sf(3, null, "Aktual per 30 Sept 20XX-1",
				sv(C, 0, 16, numericNegatif).confConditionalRequired(ER2006PosRbAsrjk0602.genConditionalField())));
