...
public enum ER2103PosRbAsrju0104 implements IObject<KeyValueString> {
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER2103PosRbAsrju0104 eEnum : ER2103PosRbAsrju0104.values()) {
	...
	public static String getName() {
		return ER2103PosRbAsrju0104.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER2103PosRbAsrju0104.class.getSimpleName().substring(2, 6));
	}
