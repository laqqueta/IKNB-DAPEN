...
import id.go.ojk.asrjk.client.builder.field.rb.uus.reference.ER2102PosRbAsrju0103;
...
public class Rb0103 extends BaseMetadata {
	...
	public SubmissionFormat get() {
		...
		SubmissionFormat res = new SubmissionFormat(eEnum.getCode(), eEnum.getName(), reportCode,
				new ArrayList<>(), extension, 8, 8, null, null, ER2102PosRbAsrju0103.getRequiredPos());
