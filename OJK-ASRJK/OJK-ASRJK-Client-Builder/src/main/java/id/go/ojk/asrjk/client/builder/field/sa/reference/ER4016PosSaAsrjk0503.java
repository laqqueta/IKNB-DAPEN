...
public enum ER4016PosSaAsrjk0503 implements IObject<KeyValueString> {
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER4016PosSaAsrjk0503 eEnum : ER4016PosSaAsrjk0503.values()) {
	...
	public static String getName() {
		return ER4016PosSaAsrjk0503.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER4016PosSaAsrjk0503.class.getSimpleName().substring(2, 6));
	}
