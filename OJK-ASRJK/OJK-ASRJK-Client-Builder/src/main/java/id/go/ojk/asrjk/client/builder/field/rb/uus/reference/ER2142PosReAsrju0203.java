...
public enum ER2142PosReAsrju0203 implements IObject<KeyValueString> {
...
//	R_02030102010000 ("02030102010000", "Beban Klaim"),
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER2142PosReAsrju0203 eEnum : ER2142PosReAsrju0203.values()) {
	...
	public static String getName() {
		return ER2142PosReAsrju0203.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER2142PosReAsrju0203.class.getSimpleName().substring(2, 6));
	}
