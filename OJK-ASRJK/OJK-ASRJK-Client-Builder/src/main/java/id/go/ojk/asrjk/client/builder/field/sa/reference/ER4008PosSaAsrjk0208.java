...
public enum ER4008PosSaAsrjk0208 implements IObject<KeyValueString> {
...
//	R_02080102010000 ("02080102010000", "1.  Jenis dan signifikansi pelanggaran yang dilakukan "),
	R_02080102010100 ("02080102010100", "a. Jumlah sanksi adminstrasi berupa sanksi peringatan atau teguran yang dikenakan kepada Perusahaan dan Unit Syariah. b. Jumlah sanksi administrasi berupa denda kewajiban membayar yang dikenakan kepada Perusahaan dan Unit Syariah dari Otoritas Jasa Keuangan. c. Jenis pelanggaran atau ketidakpatuhan yang dilakukan oleh Perusahaan dan Unit Syariah."),
//	R_02080102020000 ("02080102020000", "2. Frekuensi pelanggaran termasuk sanksi yang dilakukan atau track record ketidakpatuhan Perusahaan "),
	R_02080102020100 ("02080102020100", "a. Jenis dan frekuensi pelanggaran yang sama yang ditemukan setiap tahunnya dalam 3 (tiga) tahun terakhir. b. Signifikansi temuan pelanggaran tersebut."),
...
//	R_02080300000000 ("02080300000000", "Tabel II.H.3: Kualitas Penerapan Manajemen Risiko untuk Risiko Kepatuhan"),
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER4008PosSaAsrjk0208 eEnum : ER4008PosSaAsrjk0208.values()) {
	...
	public static String getName() {
		return ER4008PosSaAsrjk0208.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER4008PosSaAsrjk0208.class.getSimpleName().substring(2, 6));
	}
	...
	public static SegmentValidation genValidationNumeric() {
		return UtilSegmentValidation.genRegexNumeric("2", UtilMetadata.genPipeRow(getObjects(), new int[] { 0, 1, 2, 3, 8, 9 }));
	}
	...
	public static SegmentValidation genValidationMaxLengthNumeric3() {
		return UtilSegmentValidation.genMaxLength("2", UtilMetadata.genPipeRow(getObjects(), new int[] { 8, 9 }), 1);
	}
	
	public static SegmentValidation genValidationPeringkat() {
		return UtilSegmentValidation.genFixedValue("2", UtilMetadata.genPipeRow(getObjects(), new int[] { 8, 9 }), ER1099Peringkat.getPipedKey());
	}
}
