...
[Setup]
AppId=ASRJKClient
AppName=ASRJK Client
AppVersion=3.3.3
AppVerName=ASRJK-Client 3.3.3
AppPublisher=OJK
AppComments=OJK ASRJK Client
AppCopyright=Copyright (C) 2020
;AppPublisherURL=http://java.com/
;AppSupportURL=http://java.com/
;AppUpdatesURL=http://java.com/
DefaultDirName=C:\OJK-ASRJK-Client
...
[Setup]
SetupMutex=ASRJK-Client,Global\ASRJK-Client
OutputDir="..\ftp\app"

[Icons]
Name: "{group}\ASRJK-Client"; Filename: "{app}\OjkClient.exe"; IconFilename: "{app}\Client.ico"; Check: returnTrue()
Name: "{commondesktop}\AsrjkClient"; Filename: "{app}\OjkClient.exe";  IconFilename: "{app}\Client.ico"; Check: returnFalse()    

[Run]
Filename: "{app}\OjkClient.exe"; Parameters: "-Xappcds:generatecache"; Check: returnFalse()
Filename: "{app}\OjkClient.exe"; Description: "{cm:LaunchProgram,ASRJKClient}"; Flags: nowait postinstall skipifsilent; Check: returnTrue()
Filename: "{app}\OjkClient.exe"; Parameters: "-install -svcName ""ASRJKClient"" -svcDesc ""ASRJKClient"" -mainExe ""OjkClient.exe""  "; Check: returnFalse()

[UninstallRun]
Filename: "{app}\OjkClient.exe "; Parameters: "-uninstall -svcName ASRJKClient -stopOnUninstall"; Check: returnFalse()
