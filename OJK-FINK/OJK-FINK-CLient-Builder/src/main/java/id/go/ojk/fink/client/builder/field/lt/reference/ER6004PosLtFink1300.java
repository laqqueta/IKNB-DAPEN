...
public enum ER6004PosLtFink1300 implements IObject<KeyValueString> {
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER6004PosLtFink1300 eEnum : ER6004PosLtFink1300.values()) {
	...
	public static String getName() {
		return ER6004PosLtFink1300.class.getSimpleName().substring(6);
	}

	public static int getRefNumber() {
		return Integer.parseInt(ER6004PosLtFink1300.class.getSimpleName().substring(2, 6));
	}
