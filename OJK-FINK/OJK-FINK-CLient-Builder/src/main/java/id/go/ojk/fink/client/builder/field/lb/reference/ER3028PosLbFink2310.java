...
public enum ER3028PosLbFink2310 implements IObject<KeyValueString> {
...
//	R_231004000000("231004000000", "D. Kenaikan (Penurunan) dari Perubahan Kurs Valuta Kas dan Setara Kas"),
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER3028PosLbFink2310 eEnum : ER3028PosLbFink2310.values()) {
	...
	public static String getName() {
		return ER3028PosLbFink2310.class.getSimpleName().substring(6);
	}

	public static int getRefNumber() {
		return Integer.parseInt(ER3028PosLbFink2310.class.getSimpleName().substring(2, 6));
	}
	...
	public static SegmentValidation genRowValidation01B() {
		return UtilSegmentValidation.genEqualsForm("3", R_231001000000.key, EFormLaporanBulanan.LB_1300.getCode(),
				"2", ER3007PosLbFink1300.R_130001000000.getKey(), 
	...
	public static SegmentValidation genRowValidation03B() {
		return UtilSegmentValidation.genEqualsForm("3", R_231001010000.key, EFormLaporanBulanan.LB_1300.getCode(),
				"2", ER3007PosLbFink1300.R_130001010000.getKey(), 
	...
	public static SegmentValidation genRowValidation05B() {
		return UtilSegmentValidation.genEqualsForm("3", R_231001020000.key, EFormLaporanBulanan.LB_1300.getCode(),
				"2", ER3007PosLbFink1300.R_130001020000.getKey(), 
	...
	public static SegmentValidation genRowValidation06B() {
		return UtilSegmentValidation.genEqualsForm("3", R_231002000000.key, EFormLaporanBulanan.LB_1300.getCode(),
				"2", ER3007PosLbFink1300.R_130002000000.getKey(), 
	...
	public static SegmentValidation genRowValidation08B() {
		return UtilSegmentValidation.genEqualsForm("3", R_231002010000.key, EFormLaporanBulanan.LB_1300.getCode(),
				"2", ER3007PosLbFink1300.R_130002010000.getKey(), 
	...
	public static SegmentValidation genRowValidation10B() {
		return UtilSegmentValidation.genEqualsForm("3", R_231002020000.key, EFormLaporanBulanan.LB_1300.getCode(),
				"2", ER3007PosLbFink1300.R_130002020000.getKey(), 
	...
	public static SegmentValidation genRowValidation11B() {
		return UtilSegmentValidation.genEqualsForm("3", R_231003000000.key, EFormLaporanBulanan.LB_1300.getCode(),
				"2", ER3007PosLbFink1300.R_130003000000.getKey(), 
	...
	public static SegmentValidation genRowValidation13B() {
		return UtilSegmentValidation.genEqualsForm("3", R_231003010000.key, EFormLaporanBulanan.LB_1300.getCode(),
				"2", ER3007PosLbFink1300.R_130003010000.getKey(), 
	...
	public static SegmentValidation genRowValidation15B() {
		return UtilSegmentValidation.genEqualsForm("3", R_231003020000.key, EFormLaporanBulanan.LB_1300.getCode(),
				"2", ER3007PosLbFink1300.R_130003020000.getKey(), 
	...
	public static SegmentValidation genRowValidation17B() {
		return UtilSegmentValidation.genEqualsForm("3", R_231004010000.key, EFormLaporanBulanan.LB_1300.getCode(),
				"2", ER3007PosLbFink1300.R_130004000000.getKey(), 
