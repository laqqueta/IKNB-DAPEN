...
import id.go.ojk.fink.client.builder.field.lb.reference.ER3017PosLbFink2112;
...
public class Lb2112 extends BaseMetadata {
	...
	public SubmissionFormat get() {
		...
		SubmissionFormat res = new SubmissionFormat(eEnum.getCode(), eEnum.getName(), reportCode, new ArrayList<>(),
				extension, 1, null, ER3017PosLbFink2112.genFieldSave(), ER3017PosLbFink2112.genFieldSaveForm(),
				ER3017PosLbFink2112.getRequiredPos());
		res.addSegmentValidations(ER3017PosLbFink2112.genRowValidation2());
		...
		fs.add(sf(2, null, "Nama Debitur", sv(C, 1, 100, all).confRegex(patternLJKName)
				.confConditionalRequired(ER3017PosLbFink2112.genConditional())));
		...
		fs.add(sf(5, null, "Jumlah Piutang Lancar Lainnya", sv(M, 1, 16, numericNegatif))
				.addFieldValidations(ER3017PosLbFink2112.genFieldValidation5()));
		fs.add(sf(6, null, "Tanggal Pencairan",
				sv(C, 1, 8, date).confConditionalRequired(ER3017PosLbFink2112.genConditional())));
