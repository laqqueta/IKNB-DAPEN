...
public enum ER3009PosLbFink6901 implements IObject<KeyValueString> {
...
//	R_690102020400("690102020400", "d. Akumulasi Jumlah Akun Borrower Berdasarkan Usia (Bagi Credit Account dari Borrower perseorangan)", ""),
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER3009PosLbFink6901 eEnum : ER3009PosLbFink6901.values()) {
	...
	public static String getName() {
		return ER3009PosLbFink6901.class.getSimpleName().substring(6);
	}

	public static int getRefNumber() {
		return Integer.parseInt(ER3009PosLbFink6901.class.getSimpleName().substring(2, 6));
	}
	...
	public static String getLookup() {
		...
		ER3009PosLbFink6901[] eEnums = ER3009PosLbFink6901.values();
		int enumLength = eEnums.length;
		for (int i= 0; i < enumLength; i++) {
			ER3009PosLbFink6901 eEnum = eEnums[i];
