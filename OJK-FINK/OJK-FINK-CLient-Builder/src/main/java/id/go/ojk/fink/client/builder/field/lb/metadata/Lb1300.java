...
import id.go.ojk.fink.client.builder.field.lb.reference.ER3007PosLbFink1300;
...
public class Lb1300 extends BaseMetadata {
	...
	public SubmissionFormat get() {
		...
		SubmissionFormat res = new SubmissionFormat(eEnum.getCode(), eEnum.getName(), reportCode, new ArrayList<>(),
				extension, 13, 13, ER3007PosLbFink1300.genFieldSave(), ER3007PosLbFink1300.genFieldSave(),
				ER3007PosLbFink1300.getRequiredPos());
		res.addSegmentValidations(ER3007PosLbFink1300.genRowValidation01());
		res.addSegmentValidations(ER3007PosLbFink1300.genRowValidation04());
		res.addSegmentValidations(ER3007PosLbFink1300.genRowValidation07());
		res.addSegmentValidations(ER3007PosLbFink1300.genRowValidation11());
		res.addSegmentValidations(ER3007PosLbFink1300.genRowValidation13());
