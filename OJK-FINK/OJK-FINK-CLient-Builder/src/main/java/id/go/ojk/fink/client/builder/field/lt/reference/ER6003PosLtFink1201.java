...
public enum ER6003PosLtFink1201 implements IObject<KeyValueString> {
...
//	R_120102000000("120102000000", "II. Penambahan (Pengurangan) Ekuitas"),
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER6003PosLtFink1201 eEnum : ER6003PosLtFink1201.values()) {
	...
	public static String getName() {
		return ER6003PosLtFink1201.class.getSimpleName().substring(6);
	}

	public static int getRefNumber() {
		return Integer.parseInt(ER6003PosLtFink1201.class.getSimpleName().substring(2, 6));
	}
	...
	public static SegmentValidation genRowValidation2() {
		return UtilSegmentValidation.genEqualsFormulaForm("2", R_120102010000.key, "2",
				UtilMetadata.genPlusRow(ER6001PosLtFink1100.getObjectsForm(), 42, 43),
				UtilMetadata.genMessage(R_120102010000.getValue(),
						UtilMetadata.genPlusDesc(ER6001PosLtFink1100.getObjects(), 42, 43) + " pada form 1100"));
	}
