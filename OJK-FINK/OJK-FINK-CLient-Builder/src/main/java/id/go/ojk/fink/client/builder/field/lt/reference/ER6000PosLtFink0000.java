...
public enum ER6000PosLtFink0000 implements IObject<KeyValueString> {
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER6000PosLtFink0000 eEnum : ER6000PosLtFink0000.values()) {
	...
	public static String getName() {
		return ER6000PosLtFink0000.class.getSimpleName().substring(6);
	}

	public static int getRefNumber() {
		return Integer.parseInt(ER6000PosLtFink0000.class.getSimpleName().substring(2, 6));
	}
