...
public enum ER3017PosLbFink2112 implements IObject<KeyValueString> {
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER3017PosLbFink2112 eEnum : ER3017PosLbFink2112.values()) {
	...
	public static String getName() {
		return ER3017PosLbFink2112.class.getSimpleName().substring(6);
	}

	public static int getRefNumber() {
		return Integer.parseInt(ER3017PosLbFink2112.class.getSimpleName().substring(2, 6));
	}
