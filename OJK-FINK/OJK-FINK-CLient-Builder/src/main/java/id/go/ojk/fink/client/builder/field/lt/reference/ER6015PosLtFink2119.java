...
public enum ER6015PosLtFink2119 implements IObject<KeyValueString> {
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER6015PosLtFink2119 eEnum : ER6015PosLtFink2119.values()) {
	...
	public static String getName() {
		return ER6015PosLtFink2119.class.getSimpleName().substring(6);
	}

	public static int getRefNumber() {
		return Integer.parseInt(ER6015PosLtFink2119.class.getSimpleName().substring(2, 6));
	}
