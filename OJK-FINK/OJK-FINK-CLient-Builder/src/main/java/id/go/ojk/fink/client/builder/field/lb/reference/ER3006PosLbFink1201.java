...
public enum ER3006PosLbFink1201 implements IObject<KeyValueString> {
...
//	R_120102000000("120102000000", "II. Penambahan (Pengurangan) Ekuitas"),
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER3006PosLbFink1201 eEnum : ER3006PosLbFink1201.values()) {
	...
	public static String getName() {
		return ER3006PosLbFink1201.class.getSimpleName().substring(6);
	}

	public static int getRefNumber() {
		return Integer.parseInt(ER3006PosLbFink1201.class.getSimpleName().substring(2, 6));
	}
	...
	public static SegmentValidation genRowValidation2() {
		return UtilSegmentValidation.genEqualsFormulaForm("2", R_120102010000.key, "2",
				UtilMetadata.genPlusRow(ER3004PosLbFink1100.getObjectsForm(), 42, 43),
				UtilMetadata.genMessage(R_120102010000.getValue(),
						UtilMetadata.genPlusDesc(ER3004PosLbFink1100.getObjects(), 42, 43) + " pada form 1100"));
	}
