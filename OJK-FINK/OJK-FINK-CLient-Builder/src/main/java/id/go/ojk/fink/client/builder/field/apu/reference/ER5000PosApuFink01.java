...
public enum ER5000PosApuFink01 implements IObject<KeyValueString> {
...
//	R_0104040000000000 ("0104040000000000", "D.Pengembalian Pinjaman kepada Lender"),
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER5000PosApuFink01 eEnum : ER5000PosApuFink01.values()) {
	...
	public static String getName() {
		return ER5000PosApuFink01.class.getSimpleName().substring(6);
	}
	
	public static int getRefNumber() {
		return Integer.parseInt(ER5000PosApuFink01.class.getSimpleName().substring(2, 6));
	}
	...
	private static SegmentValidation genPlusValidation(ER5000PosApuFink01 eEnum, int[] rows) {
