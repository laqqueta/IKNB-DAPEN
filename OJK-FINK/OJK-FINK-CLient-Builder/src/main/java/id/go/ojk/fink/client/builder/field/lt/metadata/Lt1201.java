...
import id.go.ojk.fink.client.builder.field.lt.reference.ER6003PosLtFink1201;
...
public class Lt1201 extends BaseMetadata {
	...
	public SubmissionFormat get() {
		...
		SubmissionFormat res = new SubmissionFormat(eEnum.getCode(), eEnum.getName(), reportCode, new ArrayList<>(),
				extension, 6, 6, ER6003PosLtFink1201.genFieldSave(), ER6003PosLtFink1201.genFieldSave(),
				ER6003PosLtFink1201.getRequiredPos());
//		res.addSegmentValidations(ER6003PosLtFink1201.genRowValidation2());//disable, request by OJK
		res.addSegmentValidations(ER6003PosLtFink1201.genRowValidation3());
		res.addSegmentValidations(ER6003PosLtFink1201.genRowValidation6());
