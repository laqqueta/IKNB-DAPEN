...
import id.go.ojk.fink.client.builder.field.lb.reference.ER3030PosLbFink2122;
...
public class Lb2122 extends BaseMetadata {
	...
	public SubmissionFormat get() {
		...
		SubmissionFormat res = new SubmissionFormat(eEnum.getCode(), eEnum.getName(), reportCode, new ArrayList<>(),
				extension, 1, null, ER3030PosLbFink2122.genFieldSave(), null, ER3030PosLbFink2122.getRequiredPos());
		res.addSegmentValidations(ER3030PosLbFink2122.genRowValidation2());
		...
		fs.add(sf(2, null, "Nama Produk Asuransi/Penjaminan", sv(C, 1, 1000, all).confRegex(PATTERN_ALL_1)
				.confConditionalRequired(ER3030PosLbFink2122.genConditional())));
