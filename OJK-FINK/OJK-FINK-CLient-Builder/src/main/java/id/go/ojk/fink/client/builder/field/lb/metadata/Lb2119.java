...
import id.go.ojk.fink.client.builder.field.lb.reference.ER3025PosLbFink2119;
...
public class Lb2119 extends BaseMetadata {
	...
	public SubmissionFormat get() {
		...
		SubmissionFormat res = new SubmissionFormat(eEnum.getCode(), eEnum.getName(), reportCode, new ArrayList<>(),
				extension, 1, null, ER3025PosLbFink2119.genFieldSave(), ER3025PosLbFink2119.genFieldSave(),
				ER3025PosLbFink2119.getRequiredPos());
		res.addSegmentValidations(ER3025PosLbFink2119.genRowValidation2());
		...
		fs.add(sf(2, null, "Nama Pendapatan Non Operasional",
				sv(C, 1, 1000, all).confConditionalRequired(ER3025PosLbFink2119.genConditional())));
		fs.add(sf(3, null, "Jumlah", sv(M, 1, 16, numericNegatif)));
		fs.add(sf(4, null, "Keterangan", sv(C, 1, 1000, all).confRegex(PATTERN_ALL_1)
				.confConditionalRequired(ER3025PosLbFink2119.genConditional())));
		return res;
	}
}
