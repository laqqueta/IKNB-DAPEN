...
public enum ER3026PosLbFink2118 implements IObject<KeyValueString> {
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER3026PosLbFink2118 eEnum : ER3026PosLbFink2118.values()) {
	...
	public static String getName() {
		return ER3026PosLbFink2118.class.getSimpleName().substring(6);
	}

	public static int getRefNumber() {
		return Integer.parseInt(ER3026PosLbFink2118.class.getSimpleName().substring(2, 6));
	}
	...
	public static SegmentValidation genRowValidation2B() {
		return UtilSegmentValidation.genEqualsForm("3", R_211801000000.key, EFormLaporanBulanan.LB_1200.getCode(), "2",
				ER3005PosLbFink1200.R_120003040000.getKey(),
