...
public enum ER6008PosLtFink2116 implements IObject<KeyValueString> {
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER6008PosLtFink2116 eEnum : ER6008PosLtFink2116.values()) {
	...
	public static String getName() {
		return ER6008PosLtFink2116.class.getSimpleName().substring(6);
	}

	public static int getRefNumber() {
		return Integer.parseInt(ER6008PosLtFink2116.class.getSimpleName().substring(2, 6));
	}
