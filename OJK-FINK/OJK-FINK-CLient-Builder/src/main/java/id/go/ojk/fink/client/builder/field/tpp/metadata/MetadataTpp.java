...
public class MetadataTpp {
    ...
    public static List<SubmissionFormat> getMetadata() {
        ...
        String rencana = EReportTpp.FNK_RENCANA_RUTIN.getReportTypeCode();
        String realisasi = EReportTpp.FNK_REALISASI_RUTIN.getReportTypeCode();
        String penilaianResiko = EReportTpp.FNK_PENILAIAN_RESIKO_RUTIN.getReportTypeCode();
