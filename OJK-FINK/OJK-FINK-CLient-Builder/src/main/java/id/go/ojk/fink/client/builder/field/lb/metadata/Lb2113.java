...
import id.go.ojk.fink.client.builder.field.lb.reference.ER3019PosLbFink2113;
...
public class Lb2113 extends BaseMetadata {
	...
	public SubmissionFormat get() {
		...
		SubmissionFormat res = new SubmissionFormat(eEnum.getCode(), eEnum.getName(), reportCode, new ArrayList<>(),
				extension, 1, null, ER3019PosLbFink2113.genFieldSave(), ER3019PosLbFink2113.genFieldSaveForm(),
				ER3019PosLbFink2113.getRequiredPos());
		res.addSegmentValidations(ER3019PosLbFink2113.genRowValidation2());
		...
		fs.add(sf(2, null, "Nama Debitur", sv(C, 1, 100, all).confRegex(patternLJKName)
				.confConditionalRequired(ER3019PosLbFink2113.genConditional())));
		...
		fs.add(sf(5, null, "Jumlah Piutang Tidak Lancar Lainnya", sv(M, 1, 16, numericNegatif))
				.addFieldValidations(ER3019PosLbFink2113.genFieldValidation5()));
		fs.add(sf(6, null, "Tanggal Pencairan",
				sv(C, 1, 8, date).confConditionalRequired(ER3019PosLbFink2113.genConditional())));
