...
public enum ER3004PosLbFink1100 implements IObject<KeyValueString> {
...
//	R_110005000000("110005000000", "III. Ekuitas"),
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER3004PosLbFink1100 eEnum : ER3004PosLbFink1100.values()) {
	...
	public static String getName() {
		return ER3004PosLbFink1100.class.getSimpleName().substring(6);
	}

	public static int getRefNumber() {
		return Integer.parseInt(ER3004PosLbFink1100.class.getSimpleName().substring(2, 6));
	}
	...
	public static SegmentValidation genRowValidation01A() {
		return UtilSegmentValidation.genEqualsForm2("2", R_110001010100.key, EFormLaporanBulanan.LB_1300.getCode(),
				ER3007PosLbFink1300.R_130007000000.getKey(),
	...
	public static SegmentValidation genRowValidation01B() {
		return UtilSegmentValidation.genEqualsForm("2", R_110001010100.key, EFormLaporanBulanan.LB_2111.getCode(), "4",
				ER3016PosLbFink2111.R_211101000000.getKey(),
	...
	public static SegmentValidation genRowValidation10B() {
		return UtilSegmentValidation.genEqualsForm("2", R_110001010800.key, EFormLaporanBulanan.LB_2112.getCode(), "5",
				ER3017PosLbFink2112.R_211201000000.getKey(),
	...
	public static SegmentValidation genRowValidation15() {
		return UtilSegmentValidation.genEqualsForm("2", R_110001030100.key, EFormLaporanBulanan.LB_2116.getCode(), "6",
				ER3018PosLbFink2116.R_211601000000.getKey(),
	...
	public static SegmentValidation genRowValidation21B() {
		return UtilSegmentValidation.genEqualsForm("2", R_110001030700.key, EFormLaporanBulanan.LB_2113.getCode(), "5",
				ER3019PosLbFink2113.R_211301000000.getKey(),
	...
	public static SegmentValidation genRowValidation29B() {
		return UtilSegmentValidation.genEqualsForm("2", R_110003010300.key, EFormLaporanBulanan.LB_2114.getCode(), "5",
				ER3020PosLbFink2114.R_211401000000.getKey(),
	...
	public static SegmentValidation genRowValidation33() {
		return UtilSegmentValidation.genEqualsForm("2", R_110003010500.key, EFormLaporanBulanan.LB_2117.getCode(), "3",
				ER3022PosLbFink2117.R_211701000000.getKey(),
	...
	public static SegmentValidation genRowValidation35B() {
		return UtilSegmentValidation.genEqualsForm("2", R_110003030100.key, EFormLaporanBulanan.LB_2115.getCode(), "5",
				ER3021PosLbFink2115.R_211501000000.getKey(),
	...
	public static SegmentValidation genRowValidation46() {
		return UtilSegmentValidation.genEqualsForm2("2", R_110005050000.key, EFormLaporanBulanan.LB_1200.getCode(), 
				ER3005PosLbFink1200.R_120013000000.getKey(),
				UtilMetadata.genMessage(R_110005050000.getValue(), "Laba (Rugi) Komprehensif pada form 1200"));
	}

	public static SegmentValidation genRowValidation49A() {
	...
	public static SegmentValidation genRowValidation49B() {
		return UtilSegmentValidation.genEqualsForm2("2", R_110006000000.key, EFormLaporanBulanan.LB_1201.getCode(), 
				ER3006PosLbFink1201.R_120103000000.getKey(),
