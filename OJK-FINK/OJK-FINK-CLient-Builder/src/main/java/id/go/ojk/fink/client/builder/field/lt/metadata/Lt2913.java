...
import id.go.ojk.fink.client.builder.field.lt.reference.ER6014PosLtFink2913;
...
public class Lt2913 extends BaseMetadata {
	...
	public SubmissionFormat get() {
		...
		SubmissionFormat res = new SubmissionFormat(eEnum.getCode(), eEnum.getName(), reportCode, new ArrayList<>(),
				extension, 1, null, ER6014PosLtFink2913.genFieldSave(), ER6014PosLtFink2913.genFieldSave(),
				ER6014PosLtFink2913.getRequiredPos());
		res.addSegmentValidations(ER6014PosLtFink2913.genRowValidation2());
		...
		fs.add(sf(2, null, "Nama Beban", sv(C, 1, 1000, all).confRegex(patternLJKName)
				.confConditionalRequired(ER6014PosLtFink2913.genConditional())));
