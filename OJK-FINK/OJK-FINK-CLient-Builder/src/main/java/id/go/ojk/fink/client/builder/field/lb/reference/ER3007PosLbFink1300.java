...
public enum ER3007PosLbFink1300 implements IObject<KeyValueString> {
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER3007PosLbFink1300 eEnum : ER3007PosLbFink1300.values()) {
	...
	public static String getName() {
		return ER3007PosLbFink1300.class.getSimpleName().substring(6);
	}

	public static int getRefNumber() {
		return Integer.parseInt(ER3007PosLbFink1300.class.getSimpleName().substring(2, 6));
	}
