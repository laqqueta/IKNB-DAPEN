...
public enum ER3018PosLbFink2116 implements IObject<KeyValueString> {
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER3018PosLbFink2116 eEnum : ER3018PosLbFink2116.values()) {
	...
	public static String getName() {
		return ER3018PosLbFink2116.class.getSimpleName().substring(6);
	}

	public static int getRefNumber() {
		return Integer.parseInt(ER3018PosLbFink2116.class.getSimpleName().substring(2, 6));
	}
