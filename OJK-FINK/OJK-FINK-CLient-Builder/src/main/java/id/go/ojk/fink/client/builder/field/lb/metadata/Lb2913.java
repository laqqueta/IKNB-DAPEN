...
import id.go.ojk.fink.client.builder.field.lb.reference.ER3027PosLbFink2913;
...
public class Lb2913 extends BaseMetadata {
	...
	public SubmissionFormat get() {
		...
		SubmissionFormat res = new SubmissionFormat(eEnum.getCode(), eEnum.getName(), reportCode, new ArrayList<>(),
				extension, 1, null, ER3027PosLbFink2913.genFieldSave(), ER3027PosLbFink2913.genFieldSave(),
				ER3027PosLbFink2913.getRequiredPos());
		res.addSegmentValidations(ER3027PosLbFink2913.genRowValidation2());
		...
		fs.add(sf(2, null, "Nama Beban", sv(C, 1, 1000, all).confRegex(patternLJKName)
				.confConditionalRequired(ER3027PosLbFink2913.genConditional())));
