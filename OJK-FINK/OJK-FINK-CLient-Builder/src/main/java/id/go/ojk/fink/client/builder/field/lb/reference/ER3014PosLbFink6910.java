...
public enum ER3014PosLbFink6910 implements IObject<KeyValueString> {
	...
	R_691004000000("691004000000", "Akumulasi Pendanaan yang dihapus buku dan hapus tagih"),
	R_691005000000("691005000000", "Akumulasi Pendanaan yang dilakukan klaim Asuransi atau Penjaminan"),
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER3014PosLbFink6910 eEnum : ER3014PosLbFink6910.values()) {
	...
	public static String getName() {
		return ER3014PosLbFink6910.class.getSimpleName().substring(6);
	}

	public static int getRefNumber() {
		return Integer.parseInt(ER3014PosLbFink6910.class.getSimpleName().substring(2, 6));
	}
