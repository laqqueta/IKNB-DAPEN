...
public enum ER3032PosLbFink2912 implements IObject<KeyValueString> {
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER3032PosLbFink2912 eEnum : ER3032PosLbFink2912.values()) {
	...
	public static String getName() {
		return ER3032PosLbFink2912.class.getSimpleName().substring(6);
	}

	public static int getRefNumber() {
		return Integer.parseInt(ER3032PosLbFink2912.class.getSimpleName().substring(2, 6));
	}
