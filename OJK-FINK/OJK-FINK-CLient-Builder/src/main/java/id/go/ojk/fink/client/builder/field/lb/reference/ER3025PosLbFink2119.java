...
public enum ER3025PosLbFink2119 implements IObject<KeyValueString> {
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER3025PosLbFink2119 eEnum : ER3025PosLbFink2119.values()) {
	...
	public static String getName() {
		return ER3025PosLbFink2119.class.getSimpleName().substring(6);
	}

	public static int getRefNumber() {
		return Integer.parseInt(ER3025PosLbFink2119.class.getSimpleName().substring(2, 6));
	}
