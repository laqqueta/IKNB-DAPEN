...
public enum ER3005PosLbFink1200 implements IObject<KeyValueString> {
...
//	R_120008000000("120008000000", "IV. Beban Non Operasional"),
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER3005PosLbFink1200 eEnum : ER3005PosLbFink1200.values()) {
	...
	public static String getName() {
		return ER3005PosLbFink1200.class.getSimpleName().substring(6);
	}

	public static int getRefNumber() {
		return Integer.parseInt(ER3005PosLbFink1200.class.getSimpleName().substring(2, 6));
	}
	...
	public static SegmentValidation genRowValidation07() {
		return UtilSegmentValidation.genEqualsForm("2", R_120003040000.key, EFormLaporanBulanan.LB_2118.getCode(), "3",
				ER3026PosLbFink2118.R_211801000000.getKey(),
	...
	public static SegmentValidation genRowValidation09() {
		return UtilSegmentValidation.genEqualsForm("2", R_120003060000.key, EFormLaporanBulanan.LB_2913.getCode(), "3",
				ER3027PosLbFink2913.R_291301000000.getKey(),
	...
	public static SegmentValidation genRowValidation16B() {
		return UtilSegmentValidation.genEqualsForm("2", R_120007000000.key, EFormLaporanBulanan.LB_2119.getCode(), "3",
				ER3025PosLbFink2119.R_211901000000.getKey(),
