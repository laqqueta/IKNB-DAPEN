...
public enum ER3031PosLbFink2911 implements IObject<KeyValueString> {
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER3031PosLbFink2911 eEnum : ER3031PosLbFink2911.values()) {
	...
	public static String getName() {
		return ER3031PosLbFink2911.class.getSimpleName().substring(6);
	}

	public static int getRefNumber() {
		return Integer.parseInt(ER3031PosLbFink2911.class.getSimpleName().substring(2, 6));
	}
