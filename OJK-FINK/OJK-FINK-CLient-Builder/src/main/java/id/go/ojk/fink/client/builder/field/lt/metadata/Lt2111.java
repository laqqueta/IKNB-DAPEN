...
import id.go.ojk.fink.client.builder.field.lt.reference.ER6006PosLtFink2111;
...
public class Lt2111 extends BaseMetadata {
	...
	public SubmissionFormat get() {
		...
		SubmissionFormat res = new SubmissionFormat(eEnum.getCode(), eEnum.getName(), reportCode, new ArrayList<>(),
				extension, 1, null, ER6006PosLtFink2111.genFieldSave(), ER6006PosLtFink2111.genFieldSave(),
				ER6006PosLtFink2111.getRequiredPos());
		res.addSegmentValidations(ER6006PosLtFink2111.genRowValidation2());
		...
		fs.add(sf(2, null, "Jenis Kas Dan Setara Kas", sv(C, 1, 100, all).confRegex(patternLJKName)
				.confConditionalRequired(ER6006PosLtFink2111.genConditional())));
