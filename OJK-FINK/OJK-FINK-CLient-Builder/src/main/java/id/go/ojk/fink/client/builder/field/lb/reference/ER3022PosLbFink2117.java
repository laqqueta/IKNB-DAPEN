...
public enum ER3022PosLbFink2117 implements IObject<KeyValueString> {
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER3022PosLbFink2117 eEnum : ER3022PosLbFink2117.values()) {
	...
	public static String getName() {
		return ER3022PosLbFink2117.class.getSimpleName().substring(6);
	}

	public static int getRefNumber() {
		return Integer.parseInt(ER3022PosLbFink2117.class.getSimpleName().substring(2, 6));
	}
