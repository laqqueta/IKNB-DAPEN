...
public enum ER3011PosLbFink6903 implements IObject<KeyValueString> {
...
//	R_690317000000("690317000000", "Nilai Pendanaan"),
	...
	public static List<KeyValueString> getObjects() {
		...
		for (ER3011PosLbFink6903 eEnum : ER3011PosLbFink6903.values()) {
	...
	public static String getName() {
		return ER3011PosLbFink6903.class.getSimpleName().substring(6);
	}

	public static int getRefNumber() {
		return Integer.parseInt(ER3011PosLbFink6903.class.getSimpleName().substring(2, 6));
	}
	...
	public static SegmentValidation genRowValidation01() {
		return UtilSegmentValidation.genEqualsPercentageForm("2", R_690301000000.key,
				EFormLaporanBulanan.LB_6908.getCode(), "4", ER3013PosLbFink6908.R_690801030000.getKey(),
				EFormLaporanBulanan.LB_6902.getCode(), "3", ER3010PosLbFink6902.R_690203030000.getKey(),
				UtilMetadata.genMessage(R_690301000000.getValue(), genMessage(
						ER3013PosLbFink6908.R_690801030000.getValue(), ER3010PosLbFink6902.R_690203030000.getValue())),
				2);
	}
	...
	public static SegmentValidation genRowValidation02() {
		return UtilSegmentValidation.genEqualsPercentageForm("2", R_690302000000.key,
				EFormLaporanBulanan.LB_6908.getCode(), "4", ER3013PosLbFink6908.R_690802030000.getKey(),
				EFormLaporanBulanan.LB_6902.getCode(), "3", ER3010PosLbFink6902.R_690203030000.getKey(),
				UtilMetadata.genMessage(R_690302000000.getValue(), genMessage(
						ER3013PosLbFink6908.R_690802030000.getValue(), ER3010PosLbFink6902.R_690203030000.getValue())),
				2);
	}
	...
	public static SegmentValidation genRowValidation03() {
		return UtilSegmentValidation.genEqualsPercentageForm("2", R_690303000000.key,
				EFormLaporanBulanan.LB_6908.getCode(), "4", ER3013PosLbFink6908.R_690803030000.getKey(),
				EFormLaporanBulanan.LB_6902.getCode(), "3", ER3010PosLbFink6902.R_690203030000.getKey(),
				UtilMetadata.genMessage(R_690303000000.getValue(), genMessage(
						ER3013PosLbFink6908.R_690803030000.getValue(), ER3010PosLbFink6902.R_690203030000.getValue())),
				2);
	}
	...
	public static SegmentValidation genRowValidation04() {
		return UtilSegmentValidation.genEqualsPercentageForm("2", R_690304000000.key,
				EFormLaporanBulanan.LB_6908.getCode(), "4", ER3013PosLbFink6908.R_690804030000.getKey(),
				EFormLaporanBulanan.LB_6902.getCode(), "3", ER3010PosLbFink6902.R_690203030000.getKey(),
				UtilMetadata.genMessage(R_690304000000.getValue(), genMessage(
						ER3013PosLbFink6908.R_690804030000.getValue(), ER3010PosLbFink6902.R_690203030000.getValue())),
				2);
	}
	...
	public static SegmentValidation genRowValidation05() {
		return UtilSegmentValidation.genEqualsPercentageForm("2", R_690305000000.key,
				EFormLaporanBulanan.LB_6908.getCode(), "4", ER3013PosLbFink6908.R_690805030000.getKey(),
				EFormLaporanBulanan.LB_6902.getCode(), "3", ER3010PosLbFink6902.R_690203030000.getKey(),
				UtilMetadata.genMessage(R_690305000000.getValue(), genMessage(
						ER3013PosLbFink6908.R_690805030000.getValue(), ER3010PosLbFink6902.R_690203030000.getValue())),
				2);
	}
	...
	public static SegmentValidation genRowValidation117A() {
	...
	public static SegmentValidation genRowValidation46A() {
		return UtilSegmentValidation.genEqualsForm("2", R_690312000000.key, EFormLaporanBulanan.LB_6902.getCode(), "3",
				ER3010PosLbFink6902.R_690202030000.getKey(),
