...
import id.go.ojk.fink.client.builder.field.lb.reference.ER3024PosLbFink2121;
...
public class Lb2121 extends BaseMetadata {
	...
	public SubmissionFormat get() {
		...
		SubmissionFormat res = new SubmissionFormat(eEnum.getCode(), eEnum.getName(), reportCode, new ArrayList<>(),
				extension, 1, 1, null, null, ER3024PosLbFink2121.getRequiredPos());
		...
		fs.add(sf(2, null, "Total Denda", sv(M, 1, 16, numericNegatif))
				.addFieldValidations(ER3024PosLbFink2121.genFieldValidation2()));
