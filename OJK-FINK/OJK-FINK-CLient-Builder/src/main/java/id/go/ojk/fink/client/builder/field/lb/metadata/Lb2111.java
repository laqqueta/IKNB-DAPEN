...
import id.go.ojk.fink.client.builder.field.lb.reference.ER3016PosLbFink2111;
...
public class Lb2111 extends BaseMetadata {
	...
	public SubmissionFormat get() {
		...
		SubmissionFormat res = new SubmissionFormat(eEnum.getCode(), eEnum.getName(), reportCode, new ArrayList<>(),
				extension, 1, null, ER3016PosLbFink2111.genFieldSave(), ER3016PosLbFink2111.genFieldSave(),
				ER3016PosLbFink2111.getRequiredPos());
		res.addSegmentValidations(ER3016PosLbFink2111.genRowValidation2());
		...
		fs.add(sf(2, null, "Jenis Kas Dan Setara Kas", sv(C, 1, 100, all).confRegex(patternLJKName)
				.confConditionalRequired(ER3016PosLbFink2111.genConditional())));
