...
public enum E7001LanMValidationsConfig implements ILbltMetadataValidation, IValidationConverter {
    ...
    SG_SUMIF_PROP(programs(PPMPM),
            () -> {
                ...
                return UtilSegmentValidation.genMultiCriteriaSumIf("3", UtilMetadata.genPipeRow(ER7001PosLtlbDppkLan.getObjects(ProgramType.PPMPM), 17, 19),
...
//
    ...
    SG_PERIODE_BERJALAN_REKINV(programs(PPMPM), () -> {
        ...
        String operationForm = genFormulaFormatter(ER7008PosLtlbDppkRekinv.getObjects(PPMPM), "20", "0" /* can be any fields */);
