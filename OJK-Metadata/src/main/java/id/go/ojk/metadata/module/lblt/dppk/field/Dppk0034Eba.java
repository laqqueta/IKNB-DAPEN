...
import id.go.ojk.metadata.module.lblt.dppk.reference.ER7034PosLtlbDppkEba;
import id.go.ojk.metadata.module.lblt.dppk.validations.E7034EbaValidationsConfig;
...
public enum Dppk0034Eba implements ILbltFieldMetadata {
    ...
    public static SubmissionFormat formMetadata(SectorType sectorType, ProgramType programType) {
        ...
        return new SubmissionConfig(programType.toString())
                .config()
                .setReferenceConfigs(ER7034PosLtlbDppkEba.Configs.REF_CONFIG_PPMP)
