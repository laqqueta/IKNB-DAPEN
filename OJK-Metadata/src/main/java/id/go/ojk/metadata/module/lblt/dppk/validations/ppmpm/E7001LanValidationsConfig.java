...
public enum E7001LanValidationsConfig implements ILbltMetadataValidation, IValidationConverter {
    ...
    SG_SUMIF_PROP(programs(PPMPM),
            () -> {
                ...
                return UtilSegmentValidation.genMultiSpecFieldCriteriaSumIf(
                        UtilMetadata.genPipeColumn(3, 12), UtilMetadata.genPipeRow(ER7001PosLtlbDppkLan.getObjects(ProgramType.PPMPM), 17, 19),
    ...
    SG_SUMIF_PIUT(programs(PPMPM),
            () -> {
                ...
                return UtilSegmentValidation.genSumIf(
                        UtilMetadata.genPipeColumn(3, 12), UtilMetadata.genPipeRow(ER7001PosLtlbDppkLan.getObjects(ProgramType.PPMPM), 24, 26),
    ...
    SG_SUMIF_LAN0101030000(FieldUtil.programs(PPMPM), () -> {
        String sumField = "3";
        String criteriaCondition = ER1255JenisManfaat.getPipedReferenceKeys("MPL1|MPL2|MPL3|ML1|ML2|ML3|ML4|ML5|ML6");
        String criteriaConditionErr = ER1255JenisManfaat.getPipedReferenceKeyValues("MPL1|MPL2|MPL3||ML1|ML2|ML3|ML4|ML5|ML6");
        String sumCriteriaCondition = ER1255JenisManfaat.getPipedReferenceKeys("MP1|MP2|MP3");
    ...
    SG_EQUALS_FORMULA_3(programs(PPMPM),
            () -> UtilSegmentValidation.genEqualsFormula(UtilMetadata.genPipeColumn(3, 13),
                    ...
                    UtilMetadata.genPlusRow(ER7001PosLtlbDppkLan.getObjects(ProgramType.PPMPM), new int[]{21, 30, 36, 37}),
                    UtilMetadata.genMessage(ER7001PosLtlbDppkLan.R_LAN0107000000.getObject().getValue(),
                            UtilMetadata.genPlusDesc(ER7003PosLtlbDppkNrc.getObjects(ProgramType.PPMPM), new int[]{21, 30, 36, 37})))),
    ...
    public static final BaseMetadataValidation<E7001LanValidationsConfig> VALIDATION_METADATA_PPMPM =
            new LbltMetadataValidation<>(E7001LanValidationsConfig.class, PPMPM);
