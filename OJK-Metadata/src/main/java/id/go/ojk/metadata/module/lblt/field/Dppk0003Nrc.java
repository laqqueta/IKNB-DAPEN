...
import id.go.ojk.metadata.module.lblt.validations.ppipik.E7003NrcKValidationsConfig;
...
import static id.go.ojk.metadata.module.lblt.validations.ppmpm.E7003NrcMValidationsConfig.VALIDATION_METADATA_PPMPM;
...
public enum Dppk0003Nrc implements ILbltFieldMetadata {
    ...
    public static SubmissionFormatBuilder getPpmpSubmissionFormatConfig(SectorType sectorType, ProgramType programType) {
        ...
        int minMaxRow = ER7003PosLtlbDppkNrc.getRowSize(programType);
...
//                        .setSegmentValidations(metadataValidation);
        ...
        if (programType.equals(PPIPK)) submissionConfig
