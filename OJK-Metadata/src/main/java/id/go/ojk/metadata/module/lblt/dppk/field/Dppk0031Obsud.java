...
import id.go.ojk.metadata.module.lblt.dppk.reference.ER7031PosLtlbDppkObsud;
import id.go.ojk.metadata.module.lblt.dppk.validations.E7031ObsudValidationsConfig;
...
public enum Dppk0031Obsud implements ILbltFieldMetadata {
    ...
    NAMA_PENERBIT(sectors(KONVENSIONAL, SYARIAH), programs(PPMPK, PPMPM, PPIPK, PPIPM),
            sf(2, null, "Nama Penerbit", sv(C, 1, 100, freeText))),

    KODE_OBLIGASI_SUKUK_DAERAH(sectors(KONVENSIONAL, SYARIAH), programs(PPMPK, PPMPM, PPIPK, PPIPM),
            sf(3, null, "Kode Obligasi/ Sukuk Daerah", sv(C, 1, 30, alfaNumeric))),

    NAMA_OBLIGASI_SUKUK_DAERAH(sectors(KONVENSIONAL, SYARIAH), programs(PPMPK, PPMPM, PPIPK, PPIPM),
    ...
    KUPON(sectors(KONVENSIONAL, SYARIAH), programs(PPMPK, PPMPM, PPIPK, PPIPM),
            sf(7, null, "Kupon (%)", sv(C, 4, 6, numericDot))),

    TANGGAL_JATUH_TEMPO(sectors(KONVENSIONAL, SYARIAH), programs(PPMPK, PPMPM, PPIPK, PPIPM),
    ...
    METODE_PENCATATAN(sectors(KONVENSIONAL, SYARIAH), programs(PPMPK, PPMPM, PPIPK, PPIPM),
    ...
    private static final Map<ProgramType, ReferenceMetadata> KODE_KOMPONEN_HEADERS = Stream.of(
            new AbstractMap.SimpleEntry<>(PPMPK, EHeaderMetadataPpmpk.R7031Obsud.getObject()),
            new AbstractMap.SimpleEntry<>(PPMPM, EHeaderMetadataPpmpm.R7031Obsud.getObject()),
            new AbstractMap.SimpleEntry<>(PPIPK, EHeaderMetadataPpipk.R7031Obsud.getObject()),
            new AbstractMap.SimpleEntry<>(PPIPM, EHeaderMetadataPpipm.R7031Obsud.getObject())
