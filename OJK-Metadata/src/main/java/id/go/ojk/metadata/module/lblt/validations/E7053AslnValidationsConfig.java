...
import static id.go.ojk.metadata.module.lblt.reference.ER7053PosLtlbDppkAsln.R_ASLN000000;
import static id.go.ojk.metadata.module.lblt.reference.ER7053PosLtlbDppkAsln.R_ASLN010000;
...
public enum E7053AslnValidationsConfig implements ILbltMetadataValidation, IValidationConverter {
    ...
    CR_EXISTS_POS_M(programs(PPMPK, PPMPM, PPIPK, PPIPM, DPLK), validationFields(2, 3, 4, 6, 7),
    ...
    public static final BaseMetadataValidation<E7053AslnValidationsConfig> VALIDATION_METADATA_DPLK =
            new LbltMetadataValidation<>(E7053AslnValidationsConfig.class, DPLK);
