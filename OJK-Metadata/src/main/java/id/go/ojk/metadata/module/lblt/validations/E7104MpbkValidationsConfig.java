...
import static id.go.ojk.metadata.module.lblt.reference.ER7104PosLtlbDppkMpbk.R_MPBK000000;
import static id.go.ojk.metadata.module.lblt.reference.ER7104PosLtlbDppkMpbk.R_MPBK010000;
...
public enum E7104MpbkValidationsConfig implements ILbltMetadataValidation, IValidationConverter {
    ...
    SG_EQUAL_FORMULA(programs(PPIPK, PPIPM, DPLK),
    ...
    CR_EXIST_POS(programs(PPIPK, PPIPM, DPLK), validationFields(2,3,5,6,8,9,10,11,12,13,14),
    ...
    public static final BaseMetadataValidation<E7104MpbkValidationsConfig> VALIDATION_METADATA_DPLK =
            new LbltMetadataValidation<>(E7104MpbkValidationsConfig.class, DPLK);
