package id.go.ojk.metadata.util;
...
public class FieldUtil {
    ...
    public static List<Integer> validationFields(Integer ...fields) {
        return Arrays.stream(fields)
                .collect(Collectors.toList());
    }

    public static List<Integer> validationFields(String fields) {
