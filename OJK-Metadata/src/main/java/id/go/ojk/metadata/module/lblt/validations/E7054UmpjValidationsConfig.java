...
import static id.go.ojk.metadata.module.lblt.reference.ER7054PosLtlbDppkUmpj.R_UMPJ000000;
import static id.go.ojk.metadata.module.lblt.reference.ER7054PosLtlbDppkUmpj.R_UMPJ010000;
...
public enum E7054UmpjValidationsConfig implements ILbltMetadataValidation, IValidationConverter {
    ...
    CR_EXISTS_POS_M(programs(PPMPK, PPMPM, PPIPK, PPIPM, DPLK), validationFields(5),
    ...
    public static final BaseMetadataValidation<E7054UmpjValidationsConfig> VALIDATION_METADATA_PPMPK =
            new LbltMetadataValidation<>(E7054UmpjValidationsConfig.class, PPMPK);
    ...
    public static final BaseMetadataValidation<E7054UmpjValidationsConfig> VALIDATION_METADATA_DPLK =
            new LbltMetadataValidation<>(E7054UmpjValidationsConfig.class, DPLK);
