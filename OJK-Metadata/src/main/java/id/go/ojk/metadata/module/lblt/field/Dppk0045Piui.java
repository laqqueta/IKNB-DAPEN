...
public enum Dppk0045Piui implements ILbltFieldMetadata {
    ...
    JENIS_PIUTANG_HASIL_INVESTASI(sectors(KONVENSIONAL, SYARIAH), programs(PPMPK, PPMPM, PPIPK, PPIPM, DPLK),
    ...
    private static final Map<ProgramType, ReferenceMetadata> KODE_KOMPONEN_HEADERS = Stream.of(
            ...
            new AbstractMap.SimpleEntry<>(DPLK, EHeaderMetadataLkbtDplk.R7045Piui.getObject())
