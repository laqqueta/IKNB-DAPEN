...
import static id.go.ojk.metadata.module.lblt.reference.ER7063PosLtlbDppkPdpl.R_PDPL000000;
import static id.go.ojk.metadata.module.lblt.reference.ER7063PosLtlbDppkPdpl.R_PDPL010000;
...
public enum E7063PdplValidationsConfig implements ILbltMetadataValidation, IValidationConverter {
    ...
    CR_EXISTS_POS_M(programs(PPMPK, PPMPM, PPIPK, PPIPM, DPLK), validationFields(2, 4, 5),
    ...
    public static final BaseMetadataValidation<E7063PdplValidationsConfig> VALIDATION_METADATA_PPMPK =
            new LbltMetadataValidation<>(E7063PdplValidationsConfig.class, PPMPK);
    ...
    public static final BaseMetadataValidation<E7063PdplValidationsConfig> VALIDATION_METADATA_DPLK =
            new LbltMetadataValidation<>(E7063PdplValidationsConfig.class, DPLK);
