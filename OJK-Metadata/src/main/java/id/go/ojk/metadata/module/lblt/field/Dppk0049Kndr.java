...
public enum Dppk0049Kndr implements ILbltFieldMetadata {
    ...
    NO_PLAT_KENDARAAN(sectors(KONVENSIONAL, SYARIAH), programs(PPMPK, PPMPM, PPIPK, PPIPM, DPLK),
            sf(2, null, "No Plat Kendaraan", sv(C, 1, 10, alfaNumeric))),

    JENIS_KENDARAAN(sectors(KONVENSIONAL, SYARIAH), programs(PPMPK, PPMPM, PPIPK, PPIPM, DPLK),
    ...
    private static final Map<ProgramType, ReferenceMetadata> KODE_KOMPONEN_HEADERS = Stream.of(
            ...
            new AbstractMap.SimpleEntry<>(DPLK, EHeaderMetadataLkbtDplk.R7049Kndr.getObject())
