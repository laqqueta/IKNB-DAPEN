...
public enum E7013InspValidationsConfig implements ILbltMetadataValidation, IValidationConverter {
    ...
    SG_EQUAL_INVESTASI_RATIO(programs(PPMPM),
            () -> UtilSegmentValidation.genEqualsInvestasiRatio("5", R_INSP010000.key,
                    ...
                    UtilMetadata.genMessage(R_INSP010000.value, R_INSP010000.value + "/ Piutang Investasi pada form LAN"), 2)),
    ...
    public static final BaseMetadataValidation<E7013InspValidationsConfig> VALIDATION_METADATA_PPMPM =
            new LbltMetadataValidation<>(E7013InspValidationsConfig.class, PPMPM);
