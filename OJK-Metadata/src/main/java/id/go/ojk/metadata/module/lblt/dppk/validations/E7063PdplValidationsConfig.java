...
import static id.go.ojk.metadata.module.lblt.dppk.reference.ER7063PosLtlbDppkPdpl.R_PDPL000000;
...
public enum E7063PdplValidationsConfig implements ILbltMetadataValidation, IValidationConverter {
    ...
    CR_EXISTS_POS_M(programs(PPMPK, PPMPM, PPIPK, PPIPM), validationFields(2, 4, 5),
