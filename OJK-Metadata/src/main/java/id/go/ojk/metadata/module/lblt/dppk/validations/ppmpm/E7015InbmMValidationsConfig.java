...
public enum E7015InbmMValidationsConfig implements ILbltMetadataValidation, IValidationConverter {
    ...
    SG_ROW_VALIDATION(programs(PPMPM),
            () -> UtilSegmentValidation.genEqualsInvestasiRatio("5", R_INBM010000.key,
                    ...
                    UtilMetadata.genMessage(R_INBM010000.value, R_INBM010000.value + "/ Piutang Investasi pada form LAN"), 2)),
    ...
    public static final BaseMetadataValidation<E7015InbmMValidationsConfig> VALIDATION_METADATA_PPMPM =
            new LbltMetadataValidation<>(E7015InbmMValidationsConfig.class, PPMPM);
