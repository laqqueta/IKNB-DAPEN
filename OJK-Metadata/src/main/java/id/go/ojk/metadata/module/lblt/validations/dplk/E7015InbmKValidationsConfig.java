...
public enum E7015InbmKValidationsConfig implements ILbltMetadataValidation, IValidationConverter {
    ...
    SG_ROW_VALIDATION(programs(DPLK),
            () -> UtilSegmentValidationV2.genEqualsInvestasiRatio("5", R_INBM010000.key,
                    ...
                    UtilMetadata.genMessage(R_INBM010000.value, R_INBM010000.value + " / Baris 'TOTAL INVESTASI' Manfaat Pensiun pada form LAN"), 2)),

    CR_EXIST_POS_M(programs(DPLK), validationFields(2,3,5,6),
            () -> UtilFieldConditional.genExistPos("N", "M", R_INBM000000.key)),

    CR_EXIST_POS_O(programs(DPLK), validationFields(7),
    ...
    public static final BaseMetadataValidation<E7015InbmKValidationsConfig> VALIDATION_METADATA_DPLK =
            new LbltMetadataValidation<>(E7015InbmKValidationsConfig.class, DPLK);
