...
import static id.go.ojk.metadata.module.lblt.dppk.validations.ppmpk.E7012AlmValidationsConfig.VALIDATION_METADATA_PPMPK;
import static id.go.ojk.metadata.module.lblt.dppk.validations.ppmpm.E7012AlmValidationsConfig.VALIDATION_METADATA_PPMPM;
...
public enum Dppk0012Alm implements ILbltFieldMetadata {
    ...
    public static final LbltMetadataField<Dppk0012Alm> FIELD_KONVEN = new LbltMetadataField<>(Dppk0012Alm.class, Arrays.asList(KONVENSIONAL, SYARIAH), KODE_KOMPONEN_HEADERS);
