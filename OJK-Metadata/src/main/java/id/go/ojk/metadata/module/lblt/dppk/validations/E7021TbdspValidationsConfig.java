...
import id.go.ojk.metadata.module.lblt.dppk.field.Dppk0021Tbdsp;
...
public enum E7021TbdspValidationsConfig implements ILbltMetadataValidation, IValidationConverter {
    ...
    CR_EMPTY_1(programs(PPMPK), validationFields(Dppk0021Tbdsp.URAIAN),
            () -> UtilFieldConditional.genExistPos("N", "M", UtilMetadata.genPipeRowExcept(getObjects(), new int[]{3, 8}))),

    CR_EMPTY_2(programs(PPMPK), validationFields(Dppk0021Tbdsp.KETERANGAN),
