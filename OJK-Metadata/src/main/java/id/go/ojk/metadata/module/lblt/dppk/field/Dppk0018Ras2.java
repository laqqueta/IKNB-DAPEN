...
import id.go.ojk.metadata.module.lblt.dppk.reference.ER7018PosLtlbDppkRas2;
import id.go.ojk.metadata.module.lblt.dppk.validations.E7018Ras2ValidationsConfig;
...
public enum Dppk0018Ras2 implements ILbltFieldMetadata {
    ...
    REALISASI_TAHUN_SEBELUMNYA(sectors(KONVENSIONAL, SYARIAH), programs(PPMPK, PPMPM, PPIPK),
            sf(2, null, "Realisasi Tahun Sebelumnya",
                    sv(C, 1, 18, numeric))),

    ANGGARAN(sectors(KONVENSIONAL, SYARIAH), programs(PPMPK, PPMPM, PPIPK),
            sf(3, null, "Anggaran",
                    sv(C, 1, 18, all2))),

    REALISASI(sectors(KONVENSIONAL, SYARIAH), programs(PPMPK, PPMPM, PPIPK),
            sf(4, null, "Realisasi",
                    sv(C, 1, 18, all2))),
    ...
    public static SubmissionFormat formMetadata(ProgramType programType) {
        ...
        return new SubmissionConfig(programType.toString())
                .config()
                .setReferenceConfigs(ER7018PosLtlbDppkRas2.Configs.REF_CONFIG_PPMP)
