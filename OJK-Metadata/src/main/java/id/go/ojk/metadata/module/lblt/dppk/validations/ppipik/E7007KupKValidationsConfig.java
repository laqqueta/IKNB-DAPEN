...
public enum E7007KupKValidationsConfig implements ILbltMetadataValidation, IValidationConverter {
    ...
    SG_EQUAL_SUM_POS_1(programs(PPIPK),
    ...
    SG_EQUAL_SUM_POS_2(programs(PPIPK),
            () -> UtilSegmentValidation.genEqualsFormula(UtilMetadata.genPipeColumn(3, 5),
    ...
    SG_EQUAL_SUM_POS_3(programs(PPIPK),
            () -> UtilSegmentValidation.genEqualsFormula(UtilMetadata.genPipeColumn(3, 5),
    ...
    SG_EQUAL_SUM_POS_4(programs(PPIPK),
            () -> UtilSegmentValidation.genEqualsFormula(UtilMetadata.genPipeColumn(3, 5),
    ...
    SG_EQUAL_ROW_PLUS_1(programs(PPIPK),
            () -> UtilSegmentValidation.genEqualsFormula(UtilMetadata.genPipeColumn(3, 5),
    ...
    SG_EQUAL_ROW_PLUS_2(programs(PPIPK),
            () -> UtilSegmentValidation.genEqualsFormula(UtilMetadata.genPipeColumn(3, 5),
    ...
    SG_EQUAL_ROW_MINUS_3(programs(PPIPK),
            () -> UtilSegmentValidation.genEqualsFormula(UtilMetadata.genPipeColumn(3, 5),
    ...
    SG_EQUAL_FORM_LAN(programs(PPIPK),
    ...
    SG_REF_KODE_PENDANAAN(programs(PPIPK),
    ...
    CR_URAIAN(programs(PPIPK), validationFields(2),
    ...
    public static final BaseMetadataValidation<E7007KupKValidationsConfig> VALIDATION_METADATA_PPIPK =
            new LbltMetadataValidation<>(E7007KupKValidationsConfig.class, PPIPK);
}
