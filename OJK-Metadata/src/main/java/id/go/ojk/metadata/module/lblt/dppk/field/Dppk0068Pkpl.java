...
public enum Dppk0068Pkpl implements ILbltFieldMetadata {
    ...
    public static final LbltMetadataField<Dppk0068Pkpl> FIELD_KONVEN = new LbltMetadataField<>(Dppk0068Pkpl.class, Arrays.asList(KONVENSIONAL, SYARIAH), KODE_KOMPONEN_HEADERS);
    ...
    public static SubmissionFormat formMetadata(ProgramType programType) {
        FIELD_KONVEN.setProgramType(programType);
                ...
                BaseMetadataValidation<E7068PkplValidationsConfig> metadataValidation;
