...
public enum E7006PstValidationsConfig implements ILbltMetadataValidation, IValidationConverter {
    ...
    SG_SEGMENT_PPMPM(programs(PPMPM),
    ...
    public static final BaseMetadataValidation<E7006PstValidationsConfig> VALIDATION_METADATA_PPMPK =
            new LbltMetadataValidation<>(E7006PstValidationsConfig.class, PPMPK);

    public static final BaseMetadataValidation<E7006PstValidationsConfig> VALIDATION_METADATA_PPMPM =
            new LbltMetadataValidation<>(E7006PstValidationsConfig.class, PPMPM);
