...
import id.go.ojk.metadata.module.lblt.dppk.reference.ER7026PosLtlbDppkSbi;
import id.go.ojk.metadata.module.lblt.dppk.validations.E7026SbiValidationsConfig;
...
public enum Dppk0026Sbi implements ILbltFieldMetadata {
    ...
    public static SubmissionFormat formMetadata(ProgramType programType) {
        ...
        BaseMetadataValidation<E7026SbiValidationsConfig> metadataValidation;
