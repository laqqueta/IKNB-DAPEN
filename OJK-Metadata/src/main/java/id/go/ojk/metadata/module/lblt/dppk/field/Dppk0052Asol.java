...
public enum Dppk0052Asol implements ILbltFieldMetadata {
    ...
    public static final LbltMetadataField<Dppk0052Asol> FIELD_KONVEN = new LbltMetadataField<>(Dppk0052Asol.class, Arrays.asList(KONVENSIONAL, SYARIAH), KODE_KOMPONEN_HEADERS);
    ...
    public static SubmissionFormat formMetadata(ProgramType programType) {
        FIELD_KONVEN.setProgramType(programType);
                ...
                BaseMetadataValidation<E7052AsolValidationsConfig> metadataValidation;
