...
import id.go.ojk.metadata.module.lblt.dppk.reference.ER7052PosLtlbDppkAsol;
import id.go.ojk.metadata.module.lblt.dppk.validations.E7052AsolValidationsConfig;
...
public enum Dppk0052Asol implements ILbltFieldMetadata {
    ...
    public static SubmissionFormat formMetadata(SectorType sectorType, ProgramType programType) {
        ...
        return new SubmissionConfig(programType.toString())
                .config()
                .setReferenceConfigs(ER7052PosLtlbDppkAsol.Configs.REF_CONFIG_PPMP)
