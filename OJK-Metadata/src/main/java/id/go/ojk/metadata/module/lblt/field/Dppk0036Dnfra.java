...
public enum Dppk0036Dnfra implements ILbltFieldMetadata {
    ...
    NILAI_AKTIVA_BERSIH(sectors(KONVENSIONAL, SYARIAH), programs(PPMPK, PPMPM, PPIPK, PPIPM, DPLK),
    ...
    private static final Map<ProgramType, ReferenceMetadata> KODE_KOMPONEN_HEADERS = Stream.of(
            ...
            new AbstractMap.SimpleEntry<>(DPLK, EHeaderMetadataLkbtDplk.R7036Dnfra.getObject())
