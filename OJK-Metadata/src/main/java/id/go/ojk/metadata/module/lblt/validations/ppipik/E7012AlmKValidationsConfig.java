...
public enum E7012AlmKValidationsConfig implements ILbltMetadataValidation, IValidationConverter {
    ...
    SG_FIELD_TOTAL_6(programs(PPIPK), () -> genTotalValidation(R_ALM0106000000.key,
            EFormLaporanBulananTahunan.LTLB_SHM,
            ER7028PosLtlbDppkShm.getObjects(),
            "6", "Nilai Perolehan")),

    SG_FIELD_TOTAL_7(programs(PPIPK), () -> genTotalValidation(R_ALM0107000000.key,
            EFormLaporanBulananTahunan.LTLB_OBLI,
            ER7029PosLtlbDppkObli.getObjects(),
            "12", "Nilai Wajar")),

    SG_FIELD_TOTAL_8(programs(PPIPK), () -> genTotalValidation(R_ALM0108000000.key,
            EFormLaporanBulananTahunan.LTLB_SUKUK,
            ER7030PosLtlbDppkSukuk.getObjects(),
            "12", "Nilai Wajar")),

    SG_FIELD_TOTAL_9(programs(PPIPK), () -> genTotalValidation(R_ALM0109000000.key,
            EFormLaporanBulananTahunan.LTLB_OBSUD,
            ER7031PosLtlbDppkObsud.getObjects(),
            "12", "Nilai Wajar")),

    SG_FIELD_TOTAL_10(programs(PPIPK), () -> genTotalValidation(R_ALM0110000000.key,
            EFormLaporanBulananTahunan.LTLB_RKSD,
            ER7032PosLtlbDppkRksd.getObjects(),
            "9", "Nilai Wajar")),

    SG_FIELD_TOTAL_11(programs(PPIPK), () -> genTotalValidation(R_ALM0111000000.key,
            EFormLaporanBulananTahunan.LTLB_MTN,
            ER7033PosLtlbDppkMtn.getObjects(),
            "12", "Nilai Wajar")),

    SG_FIELD_TOTAL_12(programs(PPIPK), () -> genTotalValidation(R_ALM0112000000.key,
            EFormLaporanBulananTahunan.LTLB_EBA,
            ER7034PosLtlbDppkEba.getObjects(),
            "12", "Nilai Wajar")),

    SG_FIELD_TOTAL_13(programs(PPIPK), () -> genTotalValidation(R_ALM0113000000.key,
            EFormLaporanBulananTahunan.LTLB_DIRE,
            ER7035PosLtlbDppkDire.getObjects(),
            "8", "Nilai Perolehan")),

    SG_FIELD_TOTAL_14(programs(PPIPK), () -> genTotalValidation(R_ALM0114000000.key,
            EFormLaporanBulananTahunan.LTLB_DNFRA,
            ER7036PosLtlbDppkDnfra.getObjects(),
            "7", "Nilai Perolehan")),

    SG_FIELD_TOTAL_15(programs(PPIPK), () -> genTotalValidation(R_ALM0115000000.key,
            EFormLaporanBulananTahunan.LTLB_KOKB,
            ER7037PosLtlbDppkKokb.getObjects(),
            "7", "Nilai Wajar")),

    SG_FIELD_TOTAL_16(programs(PPIPK), () -> genTotalValidation(R_ALM0116000000.key,
            EFormLaporanBulananTahunan.LTLB_REPO,
            ER7038PosLtlbDppkRepo.getObjects(),
            "10", "Nilai Perolehan")),

    SG_FIELD_TOTAL_17(programs(PPIPK), () -> genTotalValidation(R_ALM0117000000.key,
            EFormLaporanBulananTahunan.LTLB_PNYL,
            ER7039PosLtlbDppkPnyl.getObjects(),
            "15", "Nilai Apprasial/wajar - Total")),

    SG_FIELD_TOTAL_18(programs(PPIPK), () -> genTotalValidation(R_ALM0201000000.key,
            EFormLaporanBulananTahunan.LTLB_KASB,
            ER7041PosLtlbDppkKasb.getObjects(),
            "6", "Nominal")),

    SG_FIELD_TOTAL_19(programs(PPIPK), () -> genTotalValidation(R_ALM0207000000.key,
            EFormLaporanBulananTahunan.LTLB_BBMK,
            ER7044PosLtlbDppkBbmk.getObjects(),
            "3", "Jumlah")),

    SG_FIELD_TOTAL_20(programs(PPIPK), () -> genTotalValidation(R_ALM0208000000.key,
            EFormLaporanBulananTahunan.LTLB_PIUI,
            ER7045PosLtlbDppkPiui.getObjects(),
            "4", "Nominal")),

    SG_FIELD_TOTAL_21(programs(PPIPK), () -> genTotalValidation(R_ALM0209000000.key,
            EFormLaporanBulananTahunan.LTLB_PIHI,
            ER7046PosLtlbDppkPihi.getObjects(),
            "4", "Nominal")),

    SG_FIELD_TOTAL_22(programs(PPIPK), () -> genTotalValidation(R_ALM0210000000.key,
            EFormLaporanBulananTahunan.LTLB_PILL,
            ER7047PosLtlbDppkPill.getObjects(),
            "4", "Nominal")),

    SG_FIELD_TOTAL_23(programs(PPIPK), () -> genTotalValidation(R_ALM0301000000.key,
            EFormLaporanBulananTahunan.LTLB_TNBG,
            ER7048PosLtlbDppkTnbg.getObjects(),
            "6", "Nilai Perolehan")),

    SG_FIELD_TOTAL_24(programs(PPIPK), () -> genTotalValidation(R_ALM0302000000.key,
            EFormLaporanBulananTahunan.LTLB_KNDR,
            ER7049PosLtlbDppkKndr.getObjects(),
            "5", "Nilai Perolahan")),

    SG_FIELD_TOTAL_25(programs(PPIPK), () -> genTotalValidation(R_ALM0303000000.key,
            EFormLaporanBulananTahunan.LTLB_PKOM,
            ER7050PosLtlbDppkPkom.getObjects(),
            "4", "Nilai Perolehan")),

    SG_FIELD_TOTAL_26(programs(PPIPK), () -> genTotalValidation(R_ALM0304000000.key,
            EFormLaporanBulananTahunan.LTLB_PKAN,
            ER7051PosLtlbDppkPkan.getObjects(),
            "4", "Nilai Perolehan")),

    SG_FIELD_TOTAL_27(programs(PPIPK), () -> genTotalValidation(R_ALM0305000000.key,
            EFormLaporanBulananTahunan.LTLB_ASOL,
            ER7052PosLtlbDppkAsol.getObjects(),
            "4", "Nilai Perolehan")),

    SG_FIELD_TOTAL_28(programs(PPIPK), () -> genTotalValidation(R_ALM0400000000.key,
            EFormLaporanBulananTahunan.LTLB_ASLN,
            ER7053PosLtlbDppkAsln.getObjects(),
            "5", "Nilai Aset")),

    SG_FIELD_TOTAL_29(programs(PPIPK), () -> genTotalValidation(R_ALM0901000000.key,
            EFormLaporanBulananTahunan.LTLB_UMPJ,
            ER7054PosLtlbDppkUmpj.getObjects(),
            "4", "Jumlah - Total")),

    SG_FIELD_TOTAL_30(programs(PPIPK), () -> genTotalValidation(R_ALM0902000000.key,
            EFormLaporanBulananTahunan.LTLB_UMPS,
            ER7055PosLtlbDppkUmps.getObjects(),
            "4", "Jumlah - Total")),

    SG_FIELD_TOTAL_31(programs(PPIPK), () -> genTotalValidation(R_ALM0903000000.key,
            EFormLaporanBulananTahunan.LTLB_UTIN,
            ER7056PosLtlbDppkUtin.getObjects(),
            "4", "Nilai")),

    SG_FIELD_TOTAL_32(programs(PPIPK), () -> genTotalValidation(R_ALM0904000000.key,
            EFormLaporanBulananTahunan.LTLB_PDDM,
            ER7057PosLtlbDppkPddm.getObjects(),
            "4", "Nilai")),

    SG_FIELD_TOTAL_33(programs(PPIPK), () -> genTotalValidation(R_ALM0905000000.key,
            EFormLaporanBulananTahunan.LTLB_BMHB,
            ER7058PosLtlbDppkBmhb.getObjects(),
            "4", "Nilai")),

    SG_FIELD_TOTAL_34(programs(PPIPK), () -> genTotalValidation(R_ALM0906000000.key,
            EFormLaporanBulananTahunan.LTLB_UTLN,
            ER7059PosLtlbDppkUtln.getObjects(),
            "4", "Nilai")),

    SG_FIELD_TOTAL_35(programs(PPIPK), () -> genTotalValidation(R_ALM0203000000.key,
            EFormLaporanBulananTahunan.LTLB_PIUT,
            ER7042PosLtlbDppkPiut.getObjects(),
            "5", "Piutang Iuran Pemberi Kerja - Total")),

    SG_FIELD_TOTAL_36(programs(PPIPK), () -> genTotalValidation(R_ALM0204000000.key,
            EFormLaporanBulananTahunan.LTLB_PIUT,
            ER7042PosLtlbDppkPiut.getObjects(),
    ...
    SG_SUMIF_PROP_ALM0118000000(programs(PPIPK),
    ...
    SG_SUMIF_PROP_ALM0119000000(programs(PPIPK),
            () -> sumIfValidationHelper(
    ...
    SG_SUMIF_PROP_ALM0120000000(programs(PPIPK),
            () -> sumIfValidationHelper(
...
//                    UtilMetadata.genPipeRowExcept(ER7012PosLtlbDppkAlm.getObjects(PPMPK), new int[] { 51 }))),
    ...
    public static final BaseMetadataValidation<E7012AlmKValidationsConfig> VALIDATION_METADATA_PPIPK =
            new LbltMetadataValidation<>(E7012AlmKValidationsConfig.class, PPIPK);
