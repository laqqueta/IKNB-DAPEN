...
import id.go.ojk.metadata.module.lblt.dppk.field.Dppk0001Lan;
...
public enum E7001LanMValidationsConfig implements ILbltMetadataValidation, IValidationConverter {
    ...
    SG_SUMIF_LAN0101010000(programs(PPIPM),
    ...
    SG_SUMIF_LAN0101020000(programs(PPIPM),
            () -> {
    ...
    SG_SUMIF_LAN0101030000(FieldUtil.programs(PPIPM),
            () -> sumIfValidationHelper(R_LAN0101030000.key,
                    "6", "9",
                    EFormLaporanBulananTahunan.LTLB_SRDP.getCode(),
                    ER7025PosLtlbDppkSrdp.R_SRDP010000.getObject().getKey(), "SRDP|Nilai Nominal"
            )),

    SG_SUMIF_LAN0101040000(FieldUtil.programs(PPIPM),
            () -> sumIfValidationHelper(R_LAN0101040000.key,
                    "8", "11",
                    EFormLaporanBulananTahunan.LTLB_SBI.getCode(),
                    ER7026PosLtlbDppkSbi.R_SBI010000.getObject().getKey(), "SBI|Nilai Wajar")),

    SG_SUMIF_LAN0101050000(FieldUtil.programs(PPIPM),
            () -> sumIfValidationHelper(R_LAN0101050000.key,
                    "8", "11",
                    EFormLaporanBulananTahunan.LTLB_RSBN.getCode(),
                    ER7027PosLtlbDppkRsbn.R_RSBN010000.getObject().getKey(), "RSBN|Nilai Wajar")),

    SG_SUMIF_LAN0101060000(FieldUtil.programs(PPIPM),
            () -> sumIfValidationHelper(R_LAN0101060000.key,
                    "7", "11",
                    EFormLaporanBulananTahunan.LTLB_SHM.getCode(),
                    ER7028PosLtlbDppkShm.R_SHM010000.getObject().getKey(), "SHM|Nilai Perolehan")),

    SG_SUMIF_LAN0101070000(FieldUtil.programs(PPIPM),
            () -> sumIfValidationHelper(R_LAN0101070000.key,
                    "12", "16",
                    EFormLaporanBulananTahunan.LTLB_OBLI.getCode(),
                    ER7029PosLtlbDppkObli.R_OBLI010000.getObject().getKey(), "OBLI|Nilai Wajar")),

    SG_SUMIF_LAN0101080000(FieldUtil.programs(PPIPM),
            () -> sumIfValidationHelper(R_LAN0101080000.key,
                    "12", "16",
                    EFormLaporanBulananTahunan.LTLB_SUKUK.getCode(),
                    ER7030PosLtlbDppkSukuk.R_SUKUK010000.getObject().getKey(), "SUKUK|Nilai Wajar")),

    SG_SUMIF_LAN0101090000(FieldUtil.programs(PPIPM),
            () -> sumIfValidationHelper(R_LAN0101090000.key,
                    "12", "16",
                    EFormLaporanBulananTahunan.LTLB_OBSUD.getCode(),
                    ER7031PosLtlbDppkObsud.R_OBSUD010000.getObject().getKey(), "OBSUD|Nilai Wajar")),

    SG_SUMIF_LAN0101100000(FieldUtil.programs(PPIPM),
            () -> sumIfValidationHelper(R_LAN0101100000.key,
                    "9", "12",
                    EFormLaporanBulananTahunan.LTLB_RKSD.getCode(),
                    ER7032PosLtlbDppkRksd.R_RKSD010000.getObject().getKey(), "RKSD|Nilai Wajar")),

    SG_SUMIF_LAN0101110000(FieldUtil.programs(PPIPM),
            () -> sumIfValidationHelper(R_LAN0101110000.key,
                    "12", "16",
                    EFormLaporanBulananTahunan.LTLB_MTN.getCode(),
                    ER7033PosLtlbDppkMtn.R_MTN010000.getObject().getKey(), "MTN|Nilai Wajar")),

    SG_SUMIF_LAN0101120000(FieldUtil.programs(PPIPM),
            () -> sumIfValidationHelper(R_LAN0101120000.key,
                    "12", "16",
                    EFormLaporanBulananTahunan.LTLB_EBA.getCode(),
                    ER7034PosLtlbDppkEba.R_EBA010000.getObject().getKey(), "EBA|Nilai Wajar")),

    SG_SUMIF_LAN0101130000(FieldUtil.programs(PPIPM),
            () -> sumIfValidationHelper(R_LAN0101130000.key,
                    "8", "11",
                    EFormLaporanBulananTahunan.LTLB_DIRE.getCode(),
                    ER7035PosLtlbDppkDire.R_DIRE010000.getObject().getKey(), "DIRE|Nilai Wajar")),

    SG_SUMIF_LAN0101140000(FieldUtil.programs(PPIPM),
            () -> sumIfValidationHelper(R_LAN0101140000.key,
                    "8", "11",
                    EFormLaporanBulananTahunan.LTLB_DNFRA.getCode(),
                    ER7036PosLtlbDppkDnfra.R_DNFRA010000.getObject().getKey(), "DNFRA|Nilai Aktifa Bersih")),

    SG_SUMIF_LAN0101150000(FieldUtil.programs(PPIPM),
            () -> sumIfValidationHelper(R_LAN0101150000.key,
                    "7", "10",
                    EFormLaporanBulananTahunan.LTLB_KOKB.getCode(),
                    ER7037PosLtlbDppkKokb.R_KOKB010000.getObject().getKey(), "KOKB|Nilai Wajar")),

    SG_SUMIF_LAN0101160000(FieldUtil.programs(PPIPM),
            () -> sumIfValidationHelper(R_LAN0101160000.key,
                    "14", "17",
                    EFormLaporanBulananTahunan.LTLB_REPO.getCode(),
                    ER7038PosLtlbDppkRepo.R_REPO010000.getObject().getKey(), "REPO|Nilai Jual")),

    SG_SUMIF_LAN0101170000(FieldUtil.programs(PPIPM),
            () -> sumIfValidationHelper(R_LAN0101170000.key,
                    "15", "19",
                    EFormLaporanBulananTahunan.LTLB_PNYL.getCode(),
                    ER7039PosLtlbDppkPnyl.R_PNYL010000.getObject().getKey(), "PNYL|Nilai Apprasial/wajar - Total")),
    ...
    SG_SUMIF_PROP(programs(PPIPM),
            () -> {
                ...
                return UtilSegmentValidation.genMultiCriteriaSumIf("3", UtilMetadata.genPipeRow(ER7001PosLtlbDppkLan.getObjects(PPIPM), 17, 19),
    ...
    SG_SUMIF_PIUT(programs(PPIPM),
            () -> {
                ...
                return UtilSegmentValidation.genSumIf(
                        "3", UtilMetadata.genPipeRow(ER7001PosLtlbDppkLan.getObjects(PPIPM), 22, 24),
                        EFormLaporanBulananTahunan.LTLB_PIUT.getCode(),
                        ER7042PosLtlbDppkPiut.R_PIUT010000.getObject().getKey(),
                        "5|8|9", "10", "3", criteriaCondition, sumCriteriaCondition,
    ...
    SG_SUMIF_LAN0103060000(FieldUtil.programs(PPIPM), () -> {
        ...
        return UtilSegmentValidation.genSumIfMultiField("3", posCode,
    ...
    SG_SUMIF_LAN0103070000(programs(PPIPM),
            () -> sumIfValidationHelper(
                    ER7001PosLtlbDppkLan.R_LAN0103070000.getObject().getKey(), "3", "4",
                    EFormLaporanBulananTahunan.LTLB_BBMK.getCode(),
                    ER7044PosLtlbDppkBbmk.R_BBMK010000.getObject().getKey(), "BBMK|Jumlah"
            )),

    SG_SUMIF_LAN0103080000(programs(PPIPM),
            () -> sumIfValidationHelper(
                    ER7001PosLtlbDppkLan.R_LAN0103080000.getObject().getKey(), "4", "5",
                    EFormLaporanBulananTahunan.LTLB_PIUI.getCode(),
                    ER7045PosLtlbDppkPiui.R_PIUI010000.getObject().getKey(), "PIUI|Nominal"
            )),

    SG_SUMIF_LAN0103090000(programs(PPIPM),
            () -> sumIfValidationHelper(
                    ER7001PosLtlbDppkLan.R_LAN0103090000.getObject().getKey(), "4", "5",
                    EFormLaporanBulananTahunan.LTLB_PIHI.getCode(),
                    ER7046PosLtlbDppkPihi.R_PIHI010000.getObject().getKey(), "PIHI|Nominal"
            )),

    SG_SUMIF_LAN0103100000(programs(PPIPM),
            () -> sumIfValidationHelper(
                    ER7001PosLtlbDppkLan.R_LAN0103100000.getObject().getKey(), "4", "6",
                    EFormLaporanBulananTahunan.LTLB_PILL.getCode(),
                    ER7047PosLtlbDppkPill.R_PILL010000.getObject().getKey(), "PILL|Nominal"
            )),

    SG_SUMIF_LAN0106000000(programs(PPIPM),
            () -> sumIfValidationHelper(
                    ER7001PosLtlbDppkLan.R_LAN0106000000.getObject().getKey(), "5", "7",
                    EFormLaporanBulananTahunan.LTLB_ASLN.getCode(),
                    ER7053PosLtlbDppkAsln.R_ASLN010000.getObject().getKey(), "ASLN|Nilai Aset"
            )),

    SG_SUMIF_LAN0108020100(programs(PPIPM),
            () -> sumIfValidationHelper(
                    ER7001PosLtlbDppkLan.R_LAN0108020100.getObject().getKey(), "4", "5",
                    EFormLaporanBulananTahunan.LTLB_UMPJ.getCode(),
                    ER7054PosLtlbDppkUmpj.R_UMPJ010000.getObject().getKey(), "UMPJ|Total - Jumlah"
            )),

    SG_SUMIF_LAN0108020300(programs(PPIPM),
            () -> sumIfValidationHelper(
                    ER7001PosLtlbDppkLan.R_LAN0108020300.getObject().getKey(), "4", "5",
                    EFormLaporanBulananTahunan.LTLB_UTIN.getCode(),
                    ER7056PosLtlbDppkUtin.R_UTIN010000.getObject().getKey(), "UTIN|Nilai"
            )),

    SG_SUMIF_LAN0108020400(programs(PPIPM),
            () -> sumIfValidationHelper(
                    ER7001PosLtlbDppkLan.R_LAN0108020400.getObject().getKey(), "4", "5",
                    EFormLaporanBulananTahunan.LTLB_PDDM.getCode(),
                    ER7057PosLtlbDppkPddm.R_PDDM010000.getObject().getKey(), "PDDM|Nilai"
            )),

    SG_SUMIF_LAN0108020500(programs(PPIPM),
            () -> sumIfValidationHelper(
                    ER7001PosLtlbDppkLan.R_LAN0108020500.getObject().getKey(), "4", "5",
                    EFormLaporanBulananTahunan.LTLB_BMHB.getCode(),
                    ER7058PosLtlbDppkBmhb.R_BMHB010000.getObject().getKey(), "BMHB|Nilai"
            )),

    SG_SUMIF_LAN0108020600(programs(PPIPM),
            () -> sumIfValidationHelper(
                    ER7001PosLtlbDppkLan.R_LAN0108020600.getObject().getKey(), "4", "5",
                    EFormLaporanBulananTahunan.LTLB_UTLN.getCode(),
                    ER7059PosLtlbDppkUtln.R_UTLN010000.getObject().getKey(), "UTLN|Nilai"
            )),

    SG_EQUALS_FORMULA_PERSENTASE_INVESTASI(programs(PPIPM),
            () -> UtilSegmentValidation.genEqualsFormulaLan("2",
                    ER7001PosLtlbDppkLan.R_LAN0102000000.getObject().getKey(),
                    UtilMetadata.genPlusRow(ER7001PosLtlbDppkLan.getObjects(ProgramType.PPIPM), 0, 19),
                    UtilMetadata.genMessage(ER7001PosLtlbDppkLan.R_LAN0102000000.getObject().getValue(),
                            UtilMetadata.genPlusDesc(ER7001PosLtlbDppkLan.getObjects(ProgramType.PPIPM), 0, 19)), 2)),
    ...
    SG_EQUALS_FORMULA_1(programs(PPIPM),
            () -> UtilSegmentValidation.genEqualsFormula("3",
                    ...
                    UtilMetadata.genPlusRow(ER7001PosLtlbDppkLan.getObjects(ProgramType.PPIPM), 0, 19),
                    UtilMetadata.genMessage(ER7001PosLtlbDppkLan.R_LAN0102000000.getObject().getValue(),
                            UtilMetadata.genPlusDesc(ER7001PosLtlbDppkLan.getObjects(ProgramType.PPIPM), 0, 19)))),

    SG_EQUALS_FORMULA_2(programs(PPIPM),
            () -> UtilSegmentValidation.genEqualsFormula("3",
                    ER7001PosLtlbDppkLan.R_LAN0104000000.getObject().getKey(),
                    UtilMetadata.genPlusRow(ER7001PosLtlbDppkLan.getObjects(ProgramType.PPIPM), 21, 29),
                    UtilMetadata.genMessage(ER7001PosLtlbDppkLan.R_LAN0104000000.getObject().getValue(),
                            UtilMetadata.genPlusDesc(ER7001PosLtlbDppkLan.getObjects(ProgramType.PPIPM), 21, 29)))),

    SG_EQUALS_FORMULA_3(programs(PPIPM),
            () -> UtilSegmentValidation.genEqualsFormula("3",
                    ER7001PosLtlbDppkLan.R_LAN0107000000.getObject().getKey(),
                    UtilMetadata.genPlusRow(ER7001PosLtlbDppkLan.getObjects(ProgramType.PPIPM), new int[]{20, 30, 36, 37}),
                    UtilMetadata.genMessage(ER7001PosLtlbDppkLan.R_LAN0107000000.getObject().getValue(),
                            UtilMetadata.genPlusDesc(ER7001PosLtlbDppkLan.getObjects(ProgramType.PPIPM), new int[]{20, 30, 36, 37})))),

    SG_EQUALS_FORMULA_4(programs(PPIPM),
            () -> UtilSegmentValidation.genEqualsFormula("3",
                    ER7001PosLtlbDppkLan.R_LAN0111000000.getObject().getKey(),
                    UtilMetadata.genMinusRow(ER7001PosLtlbDppkLan.getObjects(ProgramType.PPIPM), new int[]{38, 47}),
                    UtilMetadata.genMessage(ER7001PosLtlbDppkLan.R_LAN0111000000.getObject().getValue(),
                            UtilMetadata.genMinusDesc(ER7001PosLtlbDppkLan.getObjects(ProgramType.PPIPM), new int[]{38, 47})))),

    SG_EQUALS_FORMULA_5(programs(PPIPM),
            () -> UtilSegmentValidation.genEqualsFormula("3",
                    ER7001PosLtlbDppkLan.R_LAN0109000000.getObject().getKey(),
                    UtilMetadata.genPlusRow(ER7001PosLtlbDppkLan.getObjects(ProgramType.PPIPM), 39, 45),
                    UtilMetadata.genMessage(ER7001PosLtlbDppkLan.R_LAN0109000000.getObject().getValue(),
                            UtilMetadata.genPlusDesc(ER7001PosLtlbDppkLan.getObjects(ProgramType.PPIPM), 39, 45)))),
    ...
    SG_PERSENTASE_INVESTASI(programs(PPIPM),
            () -> UtilSegmentValidation.genEqualsRatioLan(
                    "2", UtilMetadata.genPipeRow(ER7001PosLtlbDppkLan.getObjects(ProgramType.PPIPM), 0, 19),
                    UtilMetadata.genPipeRow(ER7001PosLtlbDppkLan.getObjects(ProgramType.PPIPM), 0, 19), "3", R_LAN0102000000.key, "3",
                    "TOTAL INVESTASI", 2)),

    /* Update Pak Yahya */

    GEN_VALIDATON_FORM_NRC1(programs(PPIPM), () -> {
        int[] comparatorRows = {21, 22};
        String comparatorField = UtilMetadata.genPlusRow(ER7003PosLtlbDppkNrc.getObjects(PPIPM), comparatorRows);
        ...
        return UtilSegmentValidation.genEqualsFormulaFormV2("3", R_LAN0102000000.key,
    ...
    GEN_VALIDATON_FORM_INSP(programs(PPIPM), () -> {
        ...
        String comparatorPosCode = form + ER7013PosLtlbDppkInsp.R_INSP000000.key;
    ...
    SG_PERIODE_BERJALAN_REKINV(programs(PPIPM), () -> {
        ...
        String operationForm = genFormulaFormatter(ER7008PosLtlbDppkRekinv.getObjects(PPIPM), "20", "0" /* can be any fields */);

        return UtilSegmentValidation.genSumEqualRekinvPeriodePelaporan(selectField, selectPosCode, comparatorForm, operationForm, MessageType.DETAIL);
    }),

    GEN_VALIDATON_FORM_KASB(programs(PPIPM), () -> {
        KeyValueString selectPosCode = R_LAN0103010000.getObject();
        int[] cols = {6};
        String comparatorColumn = UtilMetadata.genPlusColumn(cols);
        String form = EFormLaporanBulananTahunan.LTLB_KASB.getCode();
        String comparatorPosCode = form + ER7041PosLtlbDppkKasb.R_KASB000000.key;
    ...
    CR_EXIST_POS_N_PERSENTASE_INVESTASI(programs(PPIPM), validationFields(2),
            () -> UtilFieldConditional.genExistPos("N", "M",
                    UtilMetadata.genPipeRow(ER7001PosLtlbDppkLan.getObjects(ProgramType.PPIPM), 21, 48))),
    ...
    public static final BaseMetadataValidation<E7001LanMValidationsConfig> VALIDATION_METADATA_PPIPM =
            new LbltMetadataValidation<>(E7001LanMValidationsConfig.class, PPIPM);
    ...
    private static SegmentValidation sumIfValidationHelper(String posCode, String rangeField, String criteriaField, String formCode,
        ...
        return UtilSegmentValidation.genSumIf("3", posCode,
                formCode, formObjects,
                rangeField, criteriaField, sumField, criteriaCondition, sumCriteriaCondition,
                errMsg + "|Manfaat Pensiun/Manfaat Pensiun Lainnya/Manfaat Lain/LCF", criteriaConditionErr, sumCriteriaConditionErr);
    }

    private static SegmentValidation sumIfValidationHelper(String posCode, String rangeField, String criteriaField, String specField,
