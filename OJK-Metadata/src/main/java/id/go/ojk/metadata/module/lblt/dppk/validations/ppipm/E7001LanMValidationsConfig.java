...
public enum E7001LanMValidationsConfig implements ILbltMetadataValidation, IValidationConverter {
    ...
    SG_SUMIF_PROP(programs(PPIPM),
            () -> {
                ...
                return UtilSegmentValidationV2.genMultiCriteriaSumIf("3", UtilMetadata.genPipeRow(ER7001PosLtlbDppkLan.getObjects(PPIPM), 17, 19),
    ...
    SG_PERIODE_BERJALAN_REKINV(programs(PPIPM), () -> {
        ...
        String operationFormErr = "sama dengan " + operation2.getErrMessage() + "pada form REKINV sesuai dengan Periode Bulan Laporan Berjalan ({})";
