...
public enum Dppk0055Umps implements ILbltFieldMetadata {
    ...
    public static final LbltMetadataField<Dppk0055Umps> FIELD_KONVEN = new LbltMetadataField<>(Dppk0055Umps.class, Arrays.asList(KONVENSIONAL, SYARIAH), KODE_KOMPONEN_HEADERS);
    ...
    public static SubmissionFormat formMetadata(ProgramType programType) {
        FIELD_KONVEN.setProgramType(programType);
                ...
                BaseMetadataValidation<E7055UmpsValidationsConfig> metadataValidation;
