...
import id.go.ojk.metadata.module.lblt.dppk.reference.ER7055PosLtlbDppkUmps;
import id.go.ojk.metadata.module.lblt.dppk.validations.E7055UmpsValidationsConfig;
...
public enum Dppk0055Umps implements ILbltFieldMetadata {
    ...
    JUMLAH_LTE_1_TAHUN(sectors(KONVENSIONAL, SYARIAH), programs(PPMPK, PPMPM, PPIPK),
            sf(2, null, "Jumlah <= 1 tahun",
                    sv(M, 1, 18, numeric))
    ),
    JUMLAH_GT_1_TAHUN(sectors(KONVENSIONAL, SYARIAH), programs(PPMPK, PPMPM, PPIPK),
            sf(3, null, "Jumlah > 1 tahun",
                    sv(M, 1, 18, numeric))
    ),
    JUMLAH_TOTAL(sectors(KONVENSIONAL, SYARIAH), programs(PPMPK, PPMPM, PPIPK),
    ...
    private static final Map<ProgramType, ReferenceMetadata> KODE_KOMPONEN_HEADERS = Stream.of(
            ...
            new AbstractMap.SimpleEntry<>(PPIPK, EHeaderMetadataPpipk.R7055Umps.getObject()),
            new AbstractMap.SimpleEntry<>(PPIPM, EHeaderMetadataPpipm.R7055Umps.getObject())
