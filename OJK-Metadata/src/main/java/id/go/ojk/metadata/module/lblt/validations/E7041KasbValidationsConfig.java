...
import static id.go.ojk.metadata.module.lblt.reference.ER7041PosLtlbDppkKasb.R_KASB000000;
import static id.go.ojk.metadata.module.lblt.reference.ER7041PosLtlbDppkKasb.R_KASB010000;
...
public enum E7041KasbValidationsConfig implements ILbltMetadataValidation, IValidationConverter {
    ...
    CR_EXISTS_POS_M(programs(PPMPK, PPMPM, PPIPK, PPIPM, DPLK), validationFields(4,5,7),
            () -> UtilFieldConditional.genExistPos("N", "M", R_KASB000000.key)),

    CR_EXISTS_POS_O(programs(PPMPK, PPMPM, PPIPK, PPIPM, DPLK), validationFields(2,3,8),
    ...
    public static final BaseMetadataValidation<E7041KasbValidationsConfig> VALIDATION_METADATA_PPMPK =
            new LbltMetadataValidation<>(E7041KasbValidationsConfig.class, PPMPK);
    ...
    public static final BaseMetadataValidation<E7041KasbValidationsConfig> VALIDATION_METADATA_DPLK =
            new LbltMetadataValidation<>(E7041KasbValidationsConfig.class, DPLK);
