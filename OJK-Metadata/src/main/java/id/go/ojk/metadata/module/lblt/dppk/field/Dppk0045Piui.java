...
public enum Dppk0045Piui implements ILbltFieldMetadata {
    ...
    JENIS_PIUTANG_HASIL_INVESTASI(sectors(KONVENSIONAL, SYARIAH), programs(PPMPK, PPMPM),
    ...
    public static final LbltMetadataField<Dppk0045Piui> FIELD_KONVEN = new LbltMetadataField<>(Dppk0045Piui.class, Arrays.asList(KONVENSIONAL, SYARIAH), KODE_KOMPONEN_HEADERS);
    ...
    public static SubmissionFormat formMetadata(ProgramType programType) {
        FIELD_KONVEN.setProgramType(programType);
                ...
                BaseMetadataValidation<E7045PiuiValidationsConfig> metadataValidation;
