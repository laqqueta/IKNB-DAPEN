...
import id.go.ojk.metadata.module.lblt.dppk.reference.ER7045PosLtlbDppkPiui;
...
public enum Dppk0045Piui implements ILbltFieldMetadata {
    ...
    JENIS_PIUTANG_HASIL_INVESTASI(sectors(KONVENSIONAL, SYARIAH), programs(PPMPK, PPMPM, PPIPK, PPIPM),
            sf(2, null, "Jenis Piutang Hasil Investasi",
                    sv(C, 1, 6, refTable)
                            /*.confConditionalRequired(E7045PiuiValidationsConfig.CR_EXISTS_POS_M)*/
                            .confRegex(SimpleValidation.patternAlfaNumeric)
    ...
    NOMINAL(sectors(KONVENSIONAL, SYARIAH), programs(PPMPK, PPMPM, PPIPK, PPIPM),
            sf(4, null, "Nominal",
                    sv(M, 1, 18, numeric))
    ),
    ...
    KETERANGAN(sectors(KONVENSIONAL, SYARIAH), programs(PPMPK, PPMPM, PPIPK, PPIPM),
            sf(6, null, "Keterangan",
                    sv(C, 1, 250, freeText)
                    /*.confConditionalRequired(E7045PiuiValidationsConfig.CR_EXISTS_POS_O)*/)
    ),
    ;
    ...
    private static final Map<ProgramType, ReferenceMetadata> KODE_KOMPONEN_HEADERS = Stream.of(
            new AbstractMap.SimpleEntry<>(PPMPK, EHeaderMetadataPpmpk.R7045Piui.getObject()),
            new AbstractMap.SimpleEntry<>(PPMPM, EHeaderMetadataPpmpm.R7045Piui.getObject()),
            new AbstractMap.SimpleEntry<>(PPIPK, EHeaderMetadataPpipk.R7045Piui.getObject()),
            new AbstractMap.SimpleEntry<>(PPIPM, EHeaderMetadataPpipm.R7045Piui.getObject())
    ...
    public static SubmissionFormat formMetadata(SectorType sectorType, ProgramType programType) {
        ...
        return new SubmissionConfig(programType.toString())
                .config()
                .setReferenceConfigs(ER7045PosLtlbDppkPiui.Configs.REF_CONFIG_PPMP)
