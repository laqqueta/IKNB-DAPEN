...
import static id.go.ojk.metadata.module.lblt.reference.ER7038PosLtlbDppkRepo.R_REPO000000;
import static id.go.ojk.metadata.module.lblt.reference.ER7038PosLtlbDppkRepo.R_REPO010000;
...
public enum E7038RepoValidationsConfig implements ILbltMetadataValidation, IValidationConverter {
    ...
    CR_EXISTS_POS_M(programs(PPMPK, PPMPM, PPIPK, PPIPM, DPLK), validationFields(2, 3, 4, 6, 7, 8, 9, 12, 16, 17, 18),
    ...
    public static final BaseMetadataValidation<E7038RepoValidationsConfig> VALIDATION_METADATA_DPLK =
            new LbltMetadataValidation<>(E7038RepoValidationsConfig.class, DPLK);
