...
import id.go.ojk.metadata.module.lblt.reference.ER7067PosLtlbDppkPph;
import id.go.ojk.metadata.module.lblt.validations.E7067PphValidationsConfig;
...
public enum Dppk0067Pph implements ILbltFieldMetadata {
    ...
    JENIS_PAJAK_PENGHASILAN(sectors(KONVENSIONAL, SYARIAH), programs(PPMPK, PPMPM, PPIPK, PPIPM, DPLK, PPMPPPIPK),
            sf(2, null, "Jenis Pajak Penghasilan", sv(C, 1, 100, freeText))),
    ...
    private static final Map<ProgramType, ReferenceMetadata> KODE_KOMPONEN_HEADERS = Stream.of(
            new AbstractMap.SimpleEntry<>(PPMPK, EHeaderMetadataLkdpPpmpk.R7067Pph.getObject()),
            new AbstractMap.SimpleEntry<>(PPMPM, EHeaderMetadataLkdpPpmpm.R7067Pph.getObject()),
            new AbstractMap.SimpleEntry<>(PPIPK, EHeaderMetadataLkdpPpipk.R7067Pph.getObject()),
            new AbstractMap.SimpleEntry<>(PPIPM, EHeaderMetadataLkdpPpipm.R7067Pph.getObject()),
            new AbstractMap.SimpleEntry<>(DPLK, EHeaderMetadataLkdpDplk.R7067Pph.getObject())
    ...
    public static SubmissionFormat formMetadata(SectorType sectorType, ProgramType programType) {
        ...
        switch (programType) {
            ...
            case PPIPM:
                ...
                break;
            case DPLK:
                metadataValidation = E7067PphValidationsConfig.VALIDATION_METADATA_DPLK;
                break;
            default:
        ...
        return new SubmissionConfig(programType)
                .config()
                .setReferenceConfigs(ER7067PosLtlbDppkPph.Configs.REF_CONFIG)
