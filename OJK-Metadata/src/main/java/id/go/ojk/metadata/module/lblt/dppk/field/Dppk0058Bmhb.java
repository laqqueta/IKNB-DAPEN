...
import id.go.ojk.metadata.module.lblt.dppk.reference.ER7058PosLtlbDppkBmhb;
import id.go.ojk.metadata.module.lblt.dppk.validations.E7058BmhbValidationsConfig;
...
public enum Dppk0058Bmhb implements ILbltFieldMetadata {
    ...
    RINCIAN_PENDAPATAN_DITERIMA_DI_MUKA(sectors(KONVENSIONAL, SYARIAH), programs(PPMPK, PPMPM, PPIPK, PPIPM),
    ...
    private static final Map<ProgramType, ReferenceMetadata> KODE_KOMPONEN_HEADERS = Stream.of(
            ...
            new AbstractMap.SimpleEntry<>(PPIPK, EHeaderMetadataPpipk.R7058Bmhb.getObject()),
            new AbstractMap.SimpleEntry<>(PPIPM, EHeaderMetadataPpipm.R7058Bmhb.getObject())
