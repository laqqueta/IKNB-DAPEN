...
public enum E7006PstMValidationsConfig implements ILbltMetadataValidation, IValidationConverter {
    ...
    FV_SUM_ROW(programs(PPMPM), validationFields(5),
            () -> UtilFieldValidation.genEqualsFormula(UtilMetadata.genPlusColumn(2, 4))),

    SG_SEGMENT_1(programs(PPMPM),
    ...
    public static final BaseMetadataValidation<E7006PstMValidationsConfig> VALIDATION_METADATA_PPMPM =
            new LbltMetadataValidation<>(E7006PstMValidationsConfig.class, PPMPM);
