...
public enum E7016SbnMValidationsConfig implements ILbltMetadataValidation, IValidationConverter {
    ...
    SG_EQUAL_SBN_RATION(programs(PPMPM),
...
//    CR_JENIS_INVESTASI_VALUE_SBN(programs(PPMPM),
//            () -> UtilFieldConditional.genEquals("M", "N", "2",
//                    ER1268JenisInvestasi.getReferenceIndex(2))),

    CR_JENIS_INVESTASI_VALUE_SBN(programs(PPMPM), validationFields(7),
            () -> UtilFieldConditional.genExistPosAndComparatorHasValueDapenVer("O", "M", "N",
                    R_SBN010000.key, "2", ER1268JenisInvestasi.getReferenceIndex(2) + "|" + ER1268JenisInvestasi.getReferenceIndex(3))),

//    CR_JENIS_INVESTASI_VALUE_REKSADANA(programs(PPMPM),
//            () -> UtilFieldConditional.genEquals("M", "N", "2",
//                    ER1268JenisInvestasi.getReferenceIndex(3))),

    CR_JENIS_INVESTASI_VALUE_REKSADANA(programs(PPMPM), validationFields(11),
            () -> UtilFieldConditional.genExistPosAndComparatorHasValueDapenVer("O", "M", "N",
    ...
    public static final BaseMetadataValidation<E7016SbnMValidationsConfig> VALIDATION_METADATA_PPMPM =
            new LbltMetadataValidation<>(E7016SbnMValidationsConfig.class, PPMPM);
