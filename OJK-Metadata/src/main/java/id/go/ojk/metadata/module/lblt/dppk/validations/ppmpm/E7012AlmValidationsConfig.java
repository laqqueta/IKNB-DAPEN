...
public enum E7012AlmValidationsConfig implements ILbltMetadataValidation, IValidationConverter {
    ...
    SG_EQUAL_FORMULA_7(programs(PPMPM),
            () -> UtilSegmentValidation.genEqualsFormula("16",
                    ...
                    UtilMetadata.genMessage(ER7012PosLtlbDppkAlm.R_ALM0900000000.getObject().getValue(),
                            UtilMetadata.genMinusDesc(ER7012PosLtlbDppkAlm.getObjects(ProgramType.PPMPM), new int[]{39, 49})))),
    ...
    public static final BaseMetadataValidation<E7012AlmValidationsConfig> VALIDATION_METADATA_PPMPM =
            new LbltMetadataValidation<>(E7012AlmValidationsConfig.class, PPMPM);
