...
import id.go.ojk.metadata.module.lblt.dppk.reference.ER7036PosLtlbDppkDnfra;
...
public enum Dppk0036Dnfra implements ILbltFieldMetadata {
    ...
    NILAI_AKTIVA_BERSIH(sectors(KONVENSIONAL, SYARIAH), programs(PPMPK, PPMPM, PPIPK, PPIPM),
    ...
    private static final Map<ProgramType, ReferenceMetadata> KODE_KOMPONEN_HEADERS = Stream.of(
            ...
            new AbstractMap.SimpleEntry<>(PPIPK, EHeaderMetadataPpipk.R7036Dnfra.getObject()),
            new AbstractMap.SimpleEntry<>(PPIPM, EHeaderMetadataPpipm.R7036Dnfra.getObject())
