...
public enum Dppk0036Dnfra implements ILbltFieldMetadata {
    ...
    public static final LbltMetadataField<Dppk0036Dnfra> FIELD_KONVEN = new LbltMetadataField<>(Dppk0036Dnfra.class, Arrays.asList(KONVENSIONAL, SYARIAH), KODE_KOMPONEN_HEADERS);
    ...
    public static SubmissionFormat formMetadata(ProgramType programType) {
        FIELD_KONVEN.setProgramType(programType);
                ...
                BaseMetadataValidation<E7036DnfraValidationsConfig> metadataValidation;
