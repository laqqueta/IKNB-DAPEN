...
import id.go.ojk.metadata.module.lblt.reference.ER7052PosLtlbDppkAsol;
import id.go.ojk.metadata.module.lblt.validations.E7052AsolValidationsConfig;
...
public enum Dppk0052Asol implements ILbltFieldMetadata {
    ...
    JENIS_ASET_OPERASIONAL_LAIN(sectors(KONVENSIONAL, SYARIAH), programs(PPMPK, PPMPM, PPIPK, PPIPM, DPLK),
            sf(2, null, "Jenis Aset Operasional Lain", sv(C, 1, 50, alfaNumeric))),
    ...
    private static final Map<ProgramType, ReferenceMetadata> KODE_KOMPONEN_HEADERS = Stream.of(
            new AbstractMap.SimpleEntry<>(PPMPK, EHeaderMetadataPpmpk.R7052Asol.getObject()),
            new AbstractMap.SimpleEntry<>(PPMPM, EHeaderMetadataPpmpm.R7052Asol.getObject()),
            new AbstractMap.SimpleEntry<>(PPIPK, EHeaderMetadataPpipk.R7052Asol.getObject()),
            new AbstractMap.SimpleEntry<>(PPIPM, EHeaderMetadataPpipm.R7052Asol.getObject()),
            new AbstractMap.SimpleEntry<>(DPLK, EHeaderMetadataLkbtDplk.R7052Asol.getObject())
    ).collect(Collectors.toMap(Map.Entry::getKey, Map.Entry::getValue));

    public static final LbltMetadataField<Dppk0052Asol> FIELD_METADATA = new LbltMetadataField<>(Dppk0052Asol.class, Arrays.asList(KONVENSIONAL, SYARIAH), KODE_KOMPONEN_HEADERS);
    ...
    public static SubmissionFormat formMetadata(SectorType sectorType, ProgramType programType) {
        ...
        BaseMetadataValidation<E7052AsolValidationsConfig> metadataValidation = null;

        switch (programType) {
            case PPMPK:
                metadataValidation = E7052AsolValidationsConfig.VALIDATION_METADATA_PPMPK;
                break;
            case PPMPM:
                metadataValidation = E7052AsolValidationsConfig.VALIDATION_METADATA_PPMPM;
                break;
            case PPIPK:
                metadataValidation = E7052AsolValidationsConfig.VALIDATION_METADATA_PPIPK;
                break;
            case PPIPM:
                metadataValidation = E7052AsolValidationsConfig.VALIDATION_METADATA_PPIPM;
                break;
            case DPLK:
                break;
            default:
        ...
        return new SubmissionConfig(programType)
                .config()
                .setReferenceConfigs(ER7052PosLtlbDppkAsol.Configs.REF_CONFIG)
