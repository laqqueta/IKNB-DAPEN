...
import static id.go.ojk.metadata.module.lblt.reference.ER7026PosLtlbDppkSbi.R_SBI000000;
import static id.go.ojk.metadata.module.lblt.reference.ER7026PosLtlbDppkSbi.R_SBI010000;
...
public enum E7026SbiValidationsConfig implements ILbltMetadataValidation, IValidationConverter {
    ...
    CR_EXISTS_POS_M(programs(PPMPK, PPMPM, PPIPK, PPIPM, DPLK), validationFields(2, 3, 5, 6, 10, 11, 12),
    ...
    public static final BaseMetadataValidation<E7026SbiValidationsConfig> VALIDATION_METADATA_PPIPK =
            new LbltMetadataValidation<>(E7026SbiValidationsConfig.class, PPIPK);

        public static final BaseMetadataValidation<E7026SbiValidationsConfig> VALIDATION_METADATA_PPIPM =
            new LbltMetadataValidation<>(E7026SbiValidationsConfig.class, PPIPM);

    public static final BaseMetadataValidation<E7026SbiValidationsConfig> VALIDATION_METADATA_DPLK =
            new LbltMetadataValidation<>(E7026SbiValidationsConfig.class, DPLK);
