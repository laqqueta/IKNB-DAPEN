...
public enum E7015InbmKValidationsConfig implements ILbltMetadataValidation, IValidationConverter {
    ...
    CR_EXIST_POS_M(programs(PPIPK), validationFields(2,3,5,6),
            () -> UtilFieldConditional.genExistPos("N", "M", R_INBM000000.key)),

    CR_EXIST_POS_O(programs(PPIPK), validationFields(7),
    ...
    public static final BaseMetadataValidation<E7015InbmKValidationsConfig> VALIDATION_METADATA_PPIPK =
            new LbltMetadataValidation<>(E7015InbmKValidationsConfig.class, PPIPK);
