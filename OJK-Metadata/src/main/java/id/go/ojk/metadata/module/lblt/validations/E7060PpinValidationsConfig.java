...
import static id.go.ojk.metadata.module.lblt.reference.ER7060PosLtlbDppkPpin.R_PPIN000000;
import static id.go.ojk.metadata.module.lblt.reference.ER7060PosLtlbDppkPpin.R_PPIN010000;
...
public enum E7060PpinValidationsConfig implements ILbltMetadataValidation, IValidationConverter {
    ...
    CR_EXISTS_POS_M(programs(PPMPK, PPMPM, PPIPK, PPIPM, DPLK), validationFields(2,5),
    ...
    public static final BaseMetadataValidation<E7060PpinValidationsConfig> VALIDATION_METADATA_PPMPK =
            new LbltMetadataValidation<>(E7060PpinValidationsConfig.class, PPMPK);
    ...
    public static final BaseMetadataValidation<E7060PpinValidationsConfig> VALIDATION_METADATA_DPLK =
            new LbltMetadataValidation<>(E7060PpinValidationsConfig.class, DPLK);
