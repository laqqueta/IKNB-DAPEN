...
//    CR_HAS_VALUE_NAMA_PERUSAHAAN_DETIL(programs(PPMPK, PPMPM), validationFields(3,4,5,6,7,8,10,12,13,14,17,18,19,22,23,24,25,26,27,28,29),
//            () -> UtilFieldConditional.genExistPosAndComparatorNotEmptyDAPENVer("M", "N", "N",
//                    R_PNYL010000.key, "2")),
//
//    CR_HAS_VALUE_NAMA_PERUSAHAAN_TOTAL(programs(PPMPK, PPMPM), validationFields(9,11,15,16,21),
//            () -> UtilFieldConditional.genExistPosAndComparatorNotEmptyDAPENVer("M", "N", "M",
//                    R_PNYL010000.key, "2")),
//
//    CR_HAS_VALUE_ANAK_PERUSAHAAN_DETIL(programs(PPMPK, PPMPM), validationFields(31,32,33,34,35,36,37),
//            () -> UtilFieldConditional.genExistPosAndComparatorNotEmptyDAPENVer("M", "N", "N",
//                    R_PNYL010000.key, "29")),
//
//    CR_HAS_VALUE_ANAK_PERUSAHAAN_TOTAL(programs(PPMPK, PPMPM), validationFields(30),
//            () -> UtilFieldConditional.genExistPosAndComparatorNotEmptyDAPENVer("M", "N", "M",
//                    R_PNYL010000.key, "29")),
