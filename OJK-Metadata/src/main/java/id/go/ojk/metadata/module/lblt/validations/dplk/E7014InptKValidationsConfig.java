...
public enum E7014InptKValidationsConfig implements ILbltMetadataValidation, IValidationConverter {
    ...
    SG_ROW_VALIDATION(programs(DPLK),
            () -> UtilSegmentValidationV2.genEqualsInvestasiRatio("5", R_INPT010000.key,
                    ...
                    UtilMetadata.genMessage(R_INPT010000.value, R_INPT010000.value + " / Baris 'TOTAL INVESTASI' Manfaat Pensiun pada form LAN"), 2)),

    CR_EXISTS_POS_M(programs(DPLK), validationFields(2,3,5,6),
            () -> UtilFieldConditional.genExistPos("N", "M", R_INPT000000.key)),

    CR_EXISTS_POS_O(programs(DPLK), validationFields(7),
    ...
    public static final BaseMetadataValidation<E7014InptKValidationsConfig> VALIDATION_METADATA_DPLK =
            new LbltMetadataValidation<>(E7014InptKValidationsConfig.class, DPLK);
