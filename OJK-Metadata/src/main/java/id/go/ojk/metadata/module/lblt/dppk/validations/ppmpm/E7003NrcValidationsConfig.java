...
public enum E7003NrcValidationsConfig implements ILbltMetadataValidation, IValidationConverter {
    ...
    SG_SUMIF_PROP(programs(PPMPM),
            () -> {
                ...
                return UtilSegmentValidation.genMultiCriteriaSumIf(
                        UtilMetadata.genPipeColumn(2, 11), UtilMetadata.genPipeRow(ER7003PosLtlbDppkNrc.getObjects(ProgramType.PPMPM), 17, 20),
    ...
    SG_SUMIF_PIUT(programs(PPMPM),
            () -> {
                ...
                return UtilSegmentValidation.genSumIf(
                        UtilMetadata.genPipeColumn(2, 11), UtilMetadata.genPipeRow(ER7003PosLtlbDppkNrc.getObjects(ProgramType.PPMPM), 24, 26),
    ...
    SG_SUMIF_DPJKA_DPJKV(programs(PPMPM),
            () -> {
    ...
    SG_EQUALS_FORMULA_1(programs(PPMPM),
            () -> UtilSegmentValidation.genEqualsFormula(UtilMetadata.genPipeColumn(2, 12),
                    ...
                    UtilMetadata.genPlusRow(ER7003PosLtlbDppkNrc.getObjects(ProgramType.PPMPM), 0, 20),
                    UtilMetadata.genMessage(ER7003PosLtlbDppkNrc.R_NRC0102000000.getObject().getValue(),
                            UtilMetadata.genPlusDesc(ER7003PosLtlbDppkNrc.getObjects(ProgramType.PPMPM), 0, 20)))),
    ...
    SG_EQUALS_FORMULA_4(programs(PPMPM),
            () -> UtilSegmentValidation.genEqualsFormula(UtilMetadata.genPipeColumn(2, 12),
                    ...
                    UtilMetadata.genPlusRow(ER7003PosLtlbDppkNrc.getObjects(ProgramType.PPMPM), 45, 51),
                    UtilMetadata.genMessage(ER7003PosLtlbDppkNrc.R_NRC0116000000.getObject().getValue(),
                            UtilMetadata.genPlusDesc(ER7003PosLtlbDppkNrc.getObjects(ProgramType.PPMPM), 45, 51)))),

    SG_EQUALS_FORMULA_5(programs(PPMPM),
            () -> UtilSegmentValidation.genEqualsFormula(UtilMetadata.genPipeColumn(2, 12),
                    ER7003PosLtlbDppkNrc.R_NRC0109000000.getObject().getKey(),
                    UtilMetadata.genPlusRow(ER7003PosLtlbDppkNrc.getObjects(ProgramType.PPMPM), new int[]{21, 22, 33, 40, 41}),
                    UtilMetadata.genMessage(ER7003PosLtlbDppkNrc.R_NRC0109000000.getObject().getValue(),
                            UtilMetadata.genPlusDesc(ER7003PosLtlbDppkNrc.getObjects(ProgramType.PPMPM), new int[]{21, 22, 33, 40, 41})))),

    SG_EQUALS_FORMULA_6(programs(PPMPM),
            () -> UtilSegmentValidation.genEqualsFormula(UtilMetadata.genPipeColumn(2, 12),
                    ER7003PosLtlbDppkNrc.R_NRC0118000000.getObject().getKey(),
                    UtilMetadata.genPlusRow(ER7003PosLtlbDppkNrc.getObjects(ProgramType.PPMPM), new int[]{43, 44, 52}),
                    UtilMetadata.genMessage(ER7003PosLtlbDppkNrc.R_NRC0118000000.getObject().getValue(),
                            UtilMetadata.genPlusDesc(ER7003PosLtlbDppkNrc.getObjects(ProgramType.PPMPM), new int[]{43, 44, 52})))),

    SG_EQUALS_FORM_FORMULA_LAN_1(programs(PPMPM), () -> genEqualsForm("2", "3")),
    SG_EQUALS_FORM_FORMULA_LAN_2(programs(PPMPM), () -> genEqualsForm("3", "4")),
    SG_EQUALS_FORM_FORMULA_LAN_3(programs(PPMPM), () -> genEqualsForm("4", "5")),
    SG_EQUALS_FORM_FORMULA_LAN_4(programs(PPMPM), () -> genEqualsForm("5", "6")),
    SG_EQUALS_FORM_FORMULA_LAN_5(programs(PPMPM), () -> genEqualsForm("6", "7")),
    SG_EQUALS_FORM_FORMULA_LAN_6(programs(PPMPM), () -> genEqualsForm("7", "8")),
    SG_EQUALS_FORM_FORMULA_LAN_7(programs(PPMPM), () -> genEqualsForm("8", "9")),
    SG_EQUALS_FORM_FORMULA_LAN_8(programs(PPMPM), () -> genEqualsForm("9", "10")),
    SG_EQUALS_FORM_FORMULA_LAN_9(programs(PPMPM), () -> genEqualsForm("10", "11")),
    SG_EQUALS_FORM_FORMULA_LAN_10(programs(PPMPM), () -> genEqualsForm("11", "12")),
    ...
    public static final BaseMetadataValidation<E7003NrcValidationsConfig> VALIDATION_METADATA_PPMPM =
            new LbltMetadataValidation<>(E7003NrcValidationsConfig.class, PPMPM);
