...
import id.go.ojk.metadata.module.lblt.dppk.reference.ER7041PosLtlbDppkKasb;
import id.go.ojk.metadata.module.lblt.dppk.validations.E7041KasbValidationsConfig;
...
public enum Dppk0041Kasb implements ILbltFieldMetadata {
    ...
    KETERANGAN_TUJUAN_PENGGUNAAN(sectors(KONVENSIONAL, SYARIAH), programs(PPMPK, PPMPM),
    ...
    public static final LbltMetadataField<Dppk0041Kasb> FIELD_KONVEN = new LbltMetadataField<>(Dppk0041Kasb.class, Arrays.asList(KONVENSIONAL, SYARIAH), KODE_KOMPONEN_HEADERS);
    ...
    public static SubmissionFormat formMetadata(ProgramType programType) {
        FIELD_KONVEN.setProgramType(programType);
                ...
                BaseMetadataValidation<E7041KasbValidationsConfig> metadataValidation;
        ...
        return new SubmissionConfig(programType.toString())
                .config()
                .setReferenceConfigs(ER7041PosLtlbDppkKasb.Configs.REF_CONFIG_PPMP)
