...
import id.go.ojk.metadata.module.lblt.reference.ER7066PosLtlbDppkBipr;
import id.go.ojk.metadata.module.lblt.validations.E7066BiprValidationsConfig;
...
@AllArgsConstructor
public enum Dppk0066Bipr implements ILbltFieldMetadata {
    ...
    JENIS_BEBAN(sectors(KONVENSIONAL, SYARIAH), programs(PPMPK, PPMPM, PPIPK, PPIPM, DPLK, PPMPPPIPK),
    ...
    private static final Map<ProgramType, ReferenceMetadata> KODE_KOMPONEN_HEADERS = Stream.of(
            new AbstractMap.SimpleEntry<>(PPMPK, EHeaderMetadataLkdpPpmpk.R7066Bipr.getObject()),
            new AbstractMap.SimpleEntry<>(PPMPM, EHeaderMetadataLkdpPpmpm.R7066Bipr.getObject()),
            new AbstractMap.SimpleEntry<>(PPIPK, EHeaderMetadataLkdpPpipk.R7066Bipr.getObject()),
            new AbstractMap.SimpleEntry<>(PPIPM, EHeaderMetadataLkdpPpipm.R7066Bipr.getObject()),
            new AbstractMap.SimpleEntry<>(DPLK, EHeaderMetadataLkdpDplk.R7066Bipr.getObject())
    ).collect(Collectors.toMap(Map.Entry::getKey, Map.Entry::getValue));

    public static final LbltMetadataField<Dppk0066Bipr> FIELD_METADATA = new LbltMetadataField<>(Dppk0066Bipr.class, Arrays.asList(KONVENSIONAL, SYARIAH), KODE_KOMPONEN_HEADERS);

    public static SubmissionFormatBuilder getPpmpSubmissionFormatConfig(SectorType sectorType, ProgramType programType) {
        EFormLaporanBulananTahunan BIPR_FORM = EFormLaporanBulananTahunan.LTLB_BIPR;
        SubmissionFormatBuilder sfConfig = SubmissionFormatBuilder.builder()
                .code(BIPR_FORM.getCode())
                .name(BIPR_FORM.getName())
    ...
    public static SubmissionFormat formMetadata(SectorType sectorType, ProgramType programType) {
        ...
        BaseMetadataValidation<E7066BiprValidationsConfig> metadataValidation = null;

        switch (programType) {
            case PPMPK:
                metadataValidation = E7066BiprValidationsConfig.VALIDATION_METADATA_PPMPK;
                break;
            case PPMPM:
                metadataValidation = E7066BiprValidationsConfig.VALIDATION_METADATA_PPMPM;
                break;
            case PPIPK:
                metadataValidation = E7066BiprValidationsConfig.VALIDATION_METADATA_PPIPK;
                break;
            case PPIPM:
                metadataValidation = E7066BiprValidationsConfig.VALIDATION_METADATA_PPIPM;
                break;
            case DPLK:
                metadataValidation = E7066BiprValidationsConfig.VALIDATION_METADATA_DPLK;
                break;
            case PPMPPPIPK:
                break;
            default:
        ...
        if (programType == PPMPPPIPK) {
            ...
            submissionConfig
                    .setReferenceConfigs(ER7066PosLtlbDppkBipr.Configs.REF_CONFIG)
