...
public enum Dppk0025Srdp implements ILbltFieldMetadata {
    ...
    public static final LbltMetadataField<Dppk0025Srdp> FIELD_KONVEN = new LbltMetadataField<>(Dppk0025Srdp.class, Arrays.asList(KONVENSIONAL, SYARIAH), KODE_KOMPONEN_HEADERS);
    ...
    public static SubmissionFormat formMetadata(ProgramType programType) {
        FIELD_KONVEN.setProgramType(programType);
                ...
                BaseMetadataValidation<E7025SrdpValidationsConfig> metadataValidation;
        ...
        return new SubmissionConfig(programType.toString())
                .config()
                .setReferenceConfigs(ER7025PosLtlbDppkSrdp.Configs.REF_CONFIG_PPMP)
