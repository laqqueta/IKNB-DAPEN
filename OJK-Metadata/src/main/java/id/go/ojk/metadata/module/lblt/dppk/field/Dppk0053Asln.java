...
public enum Dppk0053Asln implements ILbltFieldMetadata {
    ...
    JENIS_ASET_LAIN(sectors(KONVENSIONAL, SYARIAH), programs(PPMPK, PPMPM),
    ...
    TANGGAL_REKLASIFIKASI_MENJADI_ASET_LAIN(sectors(KONVENSIONAL, SYARIAH), programs(PPMPK, PPMPM),
            sf(4, null, "Tanggal Reklasifikasi menjadi Aset Lain",
                    sv(C, 8, 8, date)
                            /*.confConditionalRequired(E7053AslnValidationsConfig.CR_EXISTS_POS_M)*/)
    ),
    NILAI_ASET(sectors(KONVENSIONAL, SYARIAH), programs(PPMPK, PPMPM),
            sf(5, null, "Nilai Aset",
                    sv(M, 1, 18, numeric))
    ),
    PENCATATAN_SEBELUM_MENJADI_ASET_LAIN(sectors(KONVENSIONAL, SYARIAH), programs(PPMPK, PPMPM),
    ...
    public static final LbltMetadataField<Dppk0053Asln> FIELD_KONVEN = new LbltMetadataField<>(Dppk0053Asln.class, Arrays.asList(KONVENSIONAL, SYARIAH), KODE_KOMPONEN_HEADERS);
    ...
    public static SubmissionFormat formMetadata(ProgramType programType) {
        FIELD_KONVEN.setProgramType(programType);
                ...
                BaseMetadataValidation<E7053AslnValidationsConfig> metadataValidation;
