...
import id.go.ojk.metadata.module.lblt.dppk.reference.ER7053PosLtlbDppkAsln;
import id.go.ojk.metadata.module.lblt.dppk.validations.E7053AslnValidationsConfig;
...
public enum Dppk0053Asln implements ILbltFieldMetadata {
    ...
    public static SubmissionFormat formMetadata(SectorType sectorType, ProgramType programType) {
        ...
        return new SubmissionConfig(programType.toString())
                .config()
                .setReferenceConfigs(ER7053PosLtlbDppkAsln.Configs.REF_CONFIG_PPMP)
