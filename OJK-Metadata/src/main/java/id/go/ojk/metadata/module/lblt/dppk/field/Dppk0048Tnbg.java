...
public enum Dppk0048Tnbg implements ILbltFieldMetadata {
    ...
    public static final LbltMetadataField<Dppk0048Tnbg> FIELD_KONVEN = new LbltMetadataField<>(Dppk0048Tnbg.class, Arrays.asList(KONVENSIONAL, SYARIAH), KODE_KOMPONEN_HEADERS);
    ...
    public static SubmissionFormat formMetadata(ProgramType programType) {
        FIELD_KONVEN.setProgramType(programType);
                ...
                BaseMetadataValidation<E7048TnbgValidationsConfig> metadataValidation;
