...
import id.go.ojk.metadata.module.lblt.dppk.reference.ER7023PosLtlbDppkDpjka;
import id.go.ojk.metadata.module.lblt.dppk.validations.E7023DpjkaValidationsConfig;
...
public enum Dppk0023Dpjka implements ILbltFieldMetadata {
    ...
    public static final LbltMetadataField<Dppk0023Dpjka> FIELD_KONVEN = new LbltMetadataField<>(Dppk0023Dpjka.class, Arrays.asList(KONVENSIONAL, SYARIAH), KODE_KOMPONEN_HEADERS);
    ...
    public static SubmissionFormat formMetadata(ProgramType programType) {
        FIELD_KONVEN.setProgramType(programType);
                ...
                BaseMetadataValidation<E7023DpjkaValidationsConfig> metadataValidation;
