...
public enum E7013InspMValidationsConfig implements ILbltMetadataValidation, IValidationConverter {
    ...
    SG_EQUAL_INVESTASI_RATIO(programs(PPIPM),
    ...
    public static final BaseMetadataValidation<E7013InspMValidationsConfig> VALIDATION_METADATA_PPIPM =
            new LbltMetadataValidation<>(E7013InspMValidationsConfig.class, PPIPM);
