...
public enum Dppk0063Pdpl implements ILbltFieldMetadata {
    ...
    public static final LbltMetadataField<Dppk0063Pdpl> FIELD_KONVEN = new LbltMetadataField<>(Dppk0063Pdpl.class, Arrays.asList(KONVENSIONAL, SYARIAH), KODE_KOMPONEN_HEADERS);
    ...
    public static SubmissionFormat formMetadata(ProgramType programType) {
        FIELD_KONVEN.setProgramType(programType);
                ...
                BaseMetadataValidation<E7063PdplValidationsConfig> metadataValidation;
