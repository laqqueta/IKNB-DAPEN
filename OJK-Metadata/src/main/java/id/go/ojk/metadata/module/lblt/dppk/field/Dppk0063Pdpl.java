...
import id.go.ojk.metadata.module.lblt.dppk.reference.ER7063PosLtlbDppkPdpl;
import id.go.ojk.metadata.module.lblt.dppk.validations.E7063PdplValidationsConfig;
...
public enum Dppk0063Pdpl implements ILbltFieldMetadata {
    ...
    NAMA_DANA_PENSIUN_YANG_MENGALIHKAN(sectors(KONVENSIONAL, SYARIAH), programs(PPMPK, PPMPM, PPIPK, PPIPM),
    ...
    RINCIAN_MANFAAT_LAIN(sectors(KONVENSIONAL, SYARIAH), programs(PPMPK, PPMPM, PPIPK, PPIPM),
            sf(5, null, "Rincian Manfaat Lain *)", sv(C, 1, 6, refTable)
                    .confRegex(SimpleValidation.patternAlfaNumeric)
                    .confReference(EHeaderMetadataSharedLkbt.R020.getObject()))),
