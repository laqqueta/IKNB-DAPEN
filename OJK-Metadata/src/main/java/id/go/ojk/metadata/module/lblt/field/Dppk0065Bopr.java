...
import id.go.ojk.metadata.module.lblt.reference.ER7065PosLtlbDppkBopr;
import id.go.ojk.metadata.module.lblt.validations.E7065BoprValidationsConfig;
...
public enum Dppk0065Bopr implements ILbltFieldMetadata {
    ...
    JENIS_BEBAN(sectors(KONVENSIONAL, SYARIAH), programs(PPMPK, PPMPM, PPIPK, PPIPM, DPLK, PPMPPPIPK),
            sf(2, null, "Jenis Beban", sv(C, 1, 6, refTable)
                    .confRegex(SimpleValidation.patternAlfaNumeric)
                    .confReference(EHeaderMetadataSharedLblt.R018.getObject()))),
    ...
    private static final Map<ProgramType, ReferenceMetadata> KODE_KOMPONEN_HEADERS = Stream.of(
            new AbstractMap.SimpleEntry<>(PPMPK, EHeaderMetadataLkdpPpmpk.R7065Bopr.getObject()),
            new AbstractMap.SimpleEntry<>(PPMPM, EHeaderMetadataLkdpPpmpm.R7065Bopr.getObject()),
            new AbstractMap.SimpleEntry<>(PPIPK, EHeaderMetadataLkdpPpipk.R7065Bopr.getObject()),
            new AbstractMap.SimpleEntry<>(PPIPM, EHeaderMetadataLkdpPpipm.R7065Bopr.getObject())
    ...
    public static SubmissionFormat formMetadata(SectorType sectorType, ProgramType programType) {
        ...
        switch (programType) {
            ...
            case PPMPM:
                ...
                break;
            case PPIPK:
                metadataValidation = E7065BoprValidationsConfig.VALIDATION_METADATA_PPIPK;
                break;
            case PPIPM:
