...
public enum E7014InptMValidationsConfig implements ILbltMetadataValidation, IValidationConverter {
    ...
    CR_EXISTS_POS_M(programs(PPIPM), validationFields(2,3,5,6),
            () -> UtilFieldConditional.genExistPos("N", "M", R_INPT000000.key)),

    CR_EXISTS_POS_O(programs(PPIPM), validationFields(7),
    ...
    public static final BaseMetadataValidation<E7014InptMValidationsConfig> VALIDATION_METADATA_PPIPM =
            new LbltMetadataValidation<>(E7014InptMValidationsConfig.class, PPIPM);
