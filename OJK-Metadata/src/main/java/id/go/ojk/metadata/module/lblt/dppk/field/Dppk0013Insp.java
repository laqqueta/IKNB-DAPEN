...
import id.go.ojk.metadata.module.lblt.dppk.validations.ppmpk.E7013InspValidationsConfig;
...
import static id.go.ojk.metadata.module.lblt.dppk.validations.ppmpk.E7013InspValidationsConfig.VALIDATION_METADATA_PPMPK;
import static id.go.ojk.metadata.module.lblt.dppk.validations.ppmpm.E7013InspValidationsConfig.VALIDATION_METADATA_PPMPM;
...
public enum Dppk0013Insp implements ILbltFieldMetadata {
    ...
    public static final LbltMetadataField<Dppk0013Insp> FIELD_KONVEN = new LbltMetadataField<>(Dppk0013Insp.class, Arrays.asList(KONVENSIONAL, SYARIAH), KODE_KOMPONEN_HEADERS);
