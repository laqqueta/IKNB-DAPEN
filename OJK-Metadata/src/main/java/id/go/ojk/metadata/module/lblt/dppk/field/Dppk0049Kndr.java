...
import id.go.ojk.metadata.module.lblt.dppk.reference.ER7049PosLtlbDppkKndr;
import id.go.ojk.metadata.module.lblt.dppk.validations.E7049KndrValidationsConfig;
...
public enum Dppk0049Kndr implements ILbltFieldMetadata {
    ...
    NO_PLAT_KENDARAAN(sectors(KONVENSIONAL, SYARIAH), programs(PPMPK, PPMPM, PPIPK),
            sf(2, null, "No Plat Kendaraan",
                    sv(C, 1, 10, alfaNumeric)
                    /*.confConditionalRequired(E7049KndrValidationsConfig.CR_EXISTS_POS_M)*/)
    ),
    JENIS_KENDARAAN(sectors(KONVENSIONAL, SYARIAH), programs(PPMPK, PPMPM, PPIPK),
            sf(3, null, "Jenis Kendaraan",
    ...
    private static final Map<ProgramType, ReferenceMetadata> KODE_KOMPONEN_HEADERS = Stream.of(
            ...
            new AbstractMap.SimpleEntry<>(PPIPK, EHeaderMetadataPpipk.R7049Kndr.getObject()),
            new AbstractMap.SimpleEntry<>(PPIPM, EHeaderMetadataPpipm.R7049Kndr.getObject())
    ...
    public static SubmissionFormat formMetadata(SectorType sectorType, ProgramType programType) {
        ...
        BaseMetadataValidation<E7049KndrValidationsConfig> metadataValidation = null;

        switch (programType) {
            case PPMPK:
                metadataValidation = E7049KndrValidationsConfig.VALIDATION_METADATA_PPMPK;
                break;
            case PPMPM:
                metadataValidation = E7049KndrValidationsConfig.VALIDATION_METADATA_PPMPM;
                break;
            case PPIPK:
                metadataValidation = E7049KndrValidationsConfig.VALIDATION_METADATA_PPIPK;
                break;
            case PPIPM:
