...
public enum E7005LakValidationsConfig implements ILbltMetadataValidation, IValidationConverter {
    ...
    FV_SUM_ROW(programs(PPMPK), validationFields(12),
    ...
    public static final BaseMetadataValidation<E7005LakValidationsConfig> VALIDATION_METADATA_PPMPK =
            new LbltMetadataValidation<>(E7005LakValidationsConfig.class, PPMPK);

    public static final BaseMetadataValidation<E7005LakValidationsConfig> VALIDATION_METADATA_PPMPM =
            new LbltMetadataValidation<>(E7005LakValidationsConfig.class, PPMPM);
