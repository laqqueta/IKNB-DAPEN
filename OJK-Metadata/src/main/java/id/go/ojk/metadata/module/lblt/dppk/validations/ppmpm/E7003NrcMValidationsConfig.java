    ...
    SG_SUMIF_PROP(programs(PPMPM),
            () -> {
                ...
                return UtilSegmentValidation.genMultiCriteriaSumIf(
                        "2", UtilMetadata.genPipeRow(ER7003PosLtlbDppkNrc.getObjects(ProgramType.PPMPM), 17, 20),
    ...
    SG_SUMIF_PIUT(programs(PPMPM),
            () -> {
                ...
                return UtilSegmentValidation.genSumIf(
                        "2", UtilMetadata.genPipeRow(ER7003PosLtlbDppkNrc.getObjects(ProgramType.PPMPM), 24, 26),
...
//
    SG_FIELD_TOTAL_7(programs(PPMPM), () -> genTotalValidation(R_NRC0106010000.key,
            EFormLaporanBulananTahunan.LTLB_TNBG,
            ER7048PosLtlbDppkTnbg.getObjects(),
            "6", "Nilai Perolehan")),

    SG_FIELD_TOTAL_8(programs(PPMPM), () -> genTotalValidation(R_NRC0106020000.key,
            EFormLaporanBulananTahunan.LTLB_KNDR,
            ER7049PosLtlbDppkKndr.getObjects(),
            "5", "Nilai Perolahan")),

    SG_FIELD_TOTAL_9(programs(PPMPM), () -> genTotalValidation(R_NRC0106030000.key,
            EFormLaporanBulananTahunan.LTLB_PKOM,
            ER7050PosLtlbDppkPkom.getObjects(),
            "4", "Nilai Perolehan")),

    SG_FIELD_TOTAL_10(programs(PPMPM), () -> genTotalValidation(R_NRC0106040000.key,
            EFormLaporanBulananTahunan.LTLB_PKAN,
            ER7051PosLtlbDppkPkan.getObjects(),
            "4", "Nilai Perolehan")),

    SG_FIELD_TOTAL_11(programs(PPMPM), () -> genTotalValidation(R_NRC0106050000.key,
            EFormLaporanBulananTahunan.LTLB_ASOL,
            ER7052PosLtlbDppkAsol.getObjects(),
            "4", "Nilai Perolehan")),
//
    SG_MULTI_SUM_NRC0106060000(programs(PPMPM), () -> {
...
//
    SG_EQUALS_FORM_FORMULA_LAN_1(programs(PPMPM), () -> UtilSegmentValidation.genEqualsForm("2", R_NRC0104010000.getObject().getKey(),
    ...
    public static final BaseMetadataValidation<E7003NrcMValidationsConfig> VALIDATION_METADATA_PPMPM =
            new LbltMetadataValidation<>(E7003NrcMValidationsConfig.class, PPMPM);
    ...
    private static SegmentValidation genTotalValidation(String selectPosCode,
        ...
        return UtilSegmentValidation.genFormulaParserAlmValidation("2",
                selectPosCode,
                ...
                MessageType.DETAIL, fieldErrorMessage, "Total");
    }
}
