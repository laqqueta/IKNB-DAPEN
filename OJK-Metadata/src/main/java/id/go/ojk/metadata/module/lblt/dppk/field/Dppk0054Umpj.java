...
public enum Dppk0054Umpj implements ILbltFieldMetadata {
    ...
    public static final LbltMetadataField<Dppk0054Umpj> FIELD_KONVEN = new LbltMetadataField<>(Dppk0054Umpj.class, Arrays.asList(KONVENSIONAL, SYARIAH), KODE_KOMPONEN_HEADERS);
    ...
    public static SubmissionFormat formMetadata(ProgramType programType) {
        FIELD_KONVEN.setProgramType(programType);
                ...
                BaseMetadataValidation<E7054UmpjValidationsConfig> metadataValidation;
