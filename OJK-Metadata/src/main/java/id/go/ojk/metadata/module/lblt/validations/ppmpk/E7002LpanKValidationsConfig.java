...
public enum E7002LpanKValidationsConfig implements ILbltMetadataValidation, IValidationConverter {
    ...
    SG_SUMIF_IUR(programs(PPMPK),
            () -> {
                ...
                return UtilSegmentValidationV2.genSumIf(
                        UtilMetadata.genPipeColumn(2, 11), UtilMetadata.genPipeRow(ER7002PosLtlbDppkLpan.getObjects(PPMPK), 7, 10),
    ...
    SG_LPAN0103000000(programs(PPMPK),
            () -> {
    ...
    SG_LPAN0201000000(programs(PPMPK),
            () -> {
    ...
    public static final BaseMetadataValidation<E7002LpanKValidationsConfig> VALIDATION_METADATA_PPMPK =
            new LbltMetadataValidation<>(E7002LpanKValidationsConfig.class, PPMPK);
