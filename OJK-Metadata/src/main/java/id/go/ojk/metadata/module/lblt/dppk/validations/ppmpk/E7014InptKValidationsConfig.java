...
public enum E7014InptKValidationsConfig implements ILbltMetadataValidation, IValidationConverter {
    ...
    CR_EXISTS_POS_M(programs(PPMPK), validationFields(2,3,5,6),
            () -> UtilFieldConditional.genExistPos("N", "M", R_INPT000000.key)),

    CR_EXISTS_POS_O(programs(PPMPK), validationFields(7),
    ...
    public static final BaseMetadataValidation<E7014InptKValidationsConfig> VALIDATION_METADATA_PPMPK =
            new LbltMetadataValidation<>(E7014InptKValidationsConfig.class, PPMPK);
