...
import static id.go.ojk.metadata.module.lblt.reference.ER7047PosLtlbDppkPill.R_PILL000000;
import static id.go.ojk.metadata.module.lblt.reference.ER7047PosLtlbDppkPill.R_PILL010000;
...
public enum E7047PillValidationsConfig implements ILbltMetadataValidation, IValidationConverter {
    ...
    CR_EXISTS_POS_M(programs(PPMPK, PPMPM, PPIPK, PPIPM, DPLK), validationFields(2,3,5,6),
    ...
    public static final BaseMetadataValidation<E7047PillValidationsConfig> VALIDATION_METADATA_PPMPK =
            new LbltMetadataValidation<>(E7047PillValidationsConfig.class, PPMPK);
    ...
    public static final BaseMetadataValidation<E7047PillValidationsConfig> VALIDATION_METADATA_DPLK =
            new LbltMetadataValidation<>(E7047PillValidationsConfig.class, DPLK);
