...
import static id.go.ojk.metadata.module.lblt.dppk.validations.ppipik.E7014InptKValidationsConfig.VALIDATION_METADATA_PPIPK;
import static id.go.ojk.metadata.module.lblt.dppk.validations.ppipm.E7014InptMValidationsConfig.VALIDATION_METADATA_PPIPM;
import static id.go.ojk.metadata.module.lblt.dppk.validations.ppmpk.E7014InptKValidationsConfig.VALIDATION_METADATA_PPMPK;
import static id.go.ojk.metadata.module.lblt.dppk.validations.ppmpm.E7014InptMValidationsConfig.VALIDATION_METADATA_PPMPM;
...
public enum Dppk0014Inpt implements ILbltFieldMetadata {
    ...
    private static final Map<ProgramType, ReferenceMetadata> KODE_KOMPONEN_HEADERS = Stream.of(
            ...
            new AbstractMap.SimpleEntry<>(PPIPK, EHeaderMetadataPpipk.R7014Inpt.getObject()),
            new AbstractMap.SimpleEntry<>(PPIPM, EHeaderMetadataPpipm.R7014Inpt.getObject())
    ...
    public static SubmissionFormat formMetadata(SectorType sectorType, ProgramType programType) {
        ...
        switch (programType) {
            ...
            case PPIPK:
                ...
                referenceConfig = ER7014PosLtlbDppkInpt.Configs.REF_CONFIG_PPIPK_PPIPM;
                break;
            case PPIPM:
