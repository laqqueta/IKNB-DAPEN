...
public enum E7002LpanMValidationsConfig implements ILbltMetadataValidation, IValidationConverter {
    ...
    SG_EQUAL_FORMULA_1(programs(PPIPM),
            () -> UtilSegmentValidation.genEqualsFormula("2",
                    R_LPAN0102000000.getObject().getKey(), UtilMetadata.genPlusRow(getObjects(ProgramType.PPIPM), 0, 4),
                    UtilMetadata.genMessage(R_LPAN0102000000.getObject().getValue(), UtilMetadata.genPlusDesc(getObjects(ProgramType.PPIPM), 0, 4)))),

    SG_EQUAL_FORMULA_2(programs(PPIPM),
            () -> UtilSegmentValidation.genEqualsFormula("2",
                    R_LPAN0107000000.getObject().getKey(), UtilMetadata.genPlusRow(getObjects(ProgramType.PPIPM), 6, 11),
                    UtilMetadata.genMessage(R_LPAN0107000000.getObject().getValue(), UtilMetadata.genPlusDesc(getObjects(ProgramType.PPIPM), 6, 11)))),

    SG_EQUAL_FORMULA_3(programs(PPIPM),
            () -> UtilSegmentValidation.genEqualsFormula("2",
                    R_LPAN0208000000.getObject().getKey(), UtilMetadata.genPlusRow(getObjects(ProgramType.PPIPM), 13, 19),
                    UtilMetadata.genMessage(R_LPAN0208000000.getObject().getValue(), UtilMetadata.genPlusDesc(getObjects(ProgramType.PPIPM), 13, 19)))),

    SG_EQUAL_FORMULA_4(programs(PPIPM),
            () -> UtilSegmentValidation.genEqualsFormula("2",
                    R_LPAN0300000000.getObject().getKey(), UtilMetadata.genPlusRow(getObjects(ProgramType.PPIPM), new int[]{5, 12}) + "-LPAN0208000000",
                    UtilMetadata.genMessage(R_LPAN0300000000.getObject().getValue(), UtilMetadata.genPlusDesc(getObjects(ProgramType.PPIPM), new int[]{5, 12}) + "-LPAN0208000000"))),

    SG_EQUAL_FORMULA_5(programs(PPIPM),
            () -> UtilSegmentValidation.genEqualsFormula("2",
                    R_LPAN0500000000.getObject().getKey(), UtilMetadata.genMinusRow(getObjects(ProgramType.PPIPM), new int[]{22, 21}),
    ...
    SG_LPAN0103000000(programs(PPIPM),
            () -> {
    ...
    public static final BaseMetadataValidation<E7002LpanMValidationsConfig> VALIDATION_METADATA_PPIPM =
            new LbltMetadataValidation<>(E7002LpanMValidationsConfig.class, PPIPM);
