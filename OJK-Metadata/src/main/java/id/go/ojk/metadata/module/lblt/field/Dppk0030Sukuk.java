...
import id.go.ojk.metadata.module.lblt.reference.ER7030PosLtlbDppkSukuk;
import id.go.ojk.metadata.module.lblt.validations.E7030SukukValidationsConfig;
...
public enum Dppk0030Sukuk implements ILbltFieldMetadata {
    ...
    KODE_SUKUK(sectors(KONVENSIONAL, SYARIAH), programs(PPMPK, PPMPM, PPIPK, PPIPM, DPLK, PPMPPPIPK),
            sf(3, null, "Kode Sukuk", sv(C, 1, 30, alfaNumeric))),

    NAMA_SUKUK(sectors(KONVENSIONAL, SYARIAH), programs(PPMPK, PPMPM, PPIPK, PPIPM, DPLK, PPMPPPIPK),
            sf(4, null, "Nama Sukuk", sv(C, 1, 100, freeText))),
    ...
    private static final Map<ProgramType, ReferenceMetadata> KODE_KOMPONEN_HEADERS = Stream.of(
            new AbstractMap.SimpleEntry<>(PPMPK, EHeaderMetadataLkdpPpmpk.R7030Sukuk.getObject()),
            new AbstractMap.SimpleEntry<>(PPMPM, EHeaderMetadataLkdpPpmpm.R7030Sukuk.getObject()),
            new AbstractMap.SimpleEntry<>(PPIPK, EHeaderMetadataLkdpPpipk.R7030Sukuk.getObject()),
            new AbstractMap.SimpleEntry<>(PPIPM, EHeaderMetadataLkdpPpipm.R7030Sukuk.getObject()),
            new AbstractMap.SimpleEntry<>(DPLK, EHeaderMetadataLkdpDplk.R7030Sukuk.getObject())
    ...
    public static SubmissionFormat formMetadata(SectorType sectorType, ProgramType programType) {
        ...
        switch (programType) {
            ...
            case PPIPM:
                ...
                break;
            case DPLK:
                metadataValidation = E7030SukukValidationsConfig.VALIDATION_METADATA_DPLK;
                break;
            case PPMPPPIPK:
                break;
            default:
