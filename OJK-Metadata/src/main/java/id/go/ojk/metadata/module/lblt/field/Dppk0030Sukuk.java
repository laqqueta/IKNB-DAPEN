...
public enum Dppk0030Sukuk implements ILbltFieldMetadata {
    ...
    KODE_SUKUK(sectors(KONVENSIONAL, SYARIAH), programs(PPMPK, PPMPM, PPIPK, PPIPM, DPLK),
            sf(3, null, "Kode Sukuk", sv(C, 1, 30, alfaNumeric))),

    NAMA_SUKUK(sectors(KONVENSIONAL, SYARIAH), programs(PPMPK, PPMPM, PPIPK, PPIPM, DPLK),
    ...
    private static final Map<ProgramType, ReferenceMetadata> KODE_KOMPONEN_HEADERS = Stream.of(
            ...
            new AbstractMap.SimpleEntry<>(DPLK, EHeaderMetadataLkbtDplk.R7030Sukuk.getObject())
