...
public enum Dppk0029Obli implements ILbltFieldMetadata {
    ...
    KODE_OBLIGASI(sectors(KONVENSIONAL, SYARIAH), programs(PPMPK, PPMPM, PPIPK, PPIPM),
            sf(3, null, "Kode Obligasi", sv(C, 1, 30, alfaNumeric))),

    NAMA_OBLIGASI(sectors(KONVENSIONAL, SYARIAH), programs(PPMPK, PPMPM, PPIPK, PPIPM),
