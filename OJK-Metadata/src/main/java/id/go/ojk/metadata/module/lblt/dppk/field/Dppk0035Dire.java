...
import id.go.ojk.metadata.module.lblt.dppk.reference.ER7035PosLtlbDppkDire;
import id.go.ojk.metadata.module.lblt.dppk.validations.E7035DireValidationsConfig;
...
public enum Dppk0035Dire implements ILbltFieldMetadata {
    ...
    JUMLAH_UNIT(sectors(KONVENSIONAL, SYARIAH), programs(PPMPK, PPMPM, PPIPK, PPIPM),
            sf(6, null, "Jumlah Unit", sv(M, 1, 12, numeric))),
    ...
    private static final Map<ProgramType, ReferenceMetadata> KODE_KOMPONEN_HEADERS = Stream.of(
            ...
            new AbstractMap.SimpleEntry<>(PPIPK, EHeaderMetadataPpipk.R7035Dire.getObject()),
            new AbstractMap.SimpleEntry<>(PPIPM, EHeaderMetadataPpipm.R7035Dire.getObject())
    ).collect(Collectors.toMap(Map.Entry::getKey, Map.Entry::getValue));

    public static final LbltMetadataField<Dppk0035Dire> FIELD_METADATA = new LbltMetadataField<>(Dppk0035Dire.class, Arrays.asList(KONVENSIONAL, SYARIAH), KODE_KOMPONEN_HEADERS);
    ...
    public static SubmissionFormat formMetadata(SectorType sectorType, ProgramType programType) {
        ...
        BaseMetadataValidation<E7035DireValidationsConfig> metadataValidation = null;

        switch (programType) {
            case PPMPK:
                metadataValidation = E7035DireValidationsConfig.VALIDATION_METADATA_PPMPK;
                break;
            case PPMPM:
                metadataValidation = E7035DireValidationsConfig.VALIDATION_METADATA_PPMPM;
                break;
            case PPIPK:
                metadataValidation = E7035DireValidationsConfig.VALIDATION_METADATA_PPIPK;
                break;
            case PPIPM:
        ...
        return new SubmissionConfig(programType.toString())
                .config()
                .setReferenceConfigs(ER7035PosLtlbDppkDire.Configs.REF_CONFIG_PPMP)
