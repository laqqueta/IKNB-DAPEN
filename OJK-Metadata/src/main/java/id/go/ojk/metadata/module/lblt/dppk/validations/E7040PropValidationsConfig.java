...
import static id.go.ojk.metadata.module.lblt.dppk.reference.ER7040PosLtlbDppkProp.R_PROP000000;
import static id.go.ojk.metadata.module.lblt.dppk.reference.ER7040PosLtlbDppkProp.R_PROP010000;
...
public enum E7040PropValidationsConfig implements ILbltMetadataValidation, IValidationConverter {
    ...
    FV_EQUAL_NILAI_BUKU(programs(PPMPK, PPMPM), validationFields(10),
    ...
    CR_EXISTS_POS_M(programs(PPMPK, PPMPM), validationFields(2, 3, 4, 5, 6, 7, 12, 13, 14, 16, 17, 18),
