...
public enum E7013InspKValidationsConfig implements ILbltMetadataValidation, IValidationConverter {
    ...
    SG_EQUAL_INVESTASI_RATIO(programs(PPIPK),
    ...
    public static final BaseMetadataValidation<E7013InspKValidationsConfig> VALIDATION_METADATA_PPIPK =
            new LbltMetadataValidation<>(E7013InspKValidationsConfig.class, PPIPK);
