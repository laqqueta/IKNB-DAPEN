...
public enum Dppk0062Pdin implements ILbltFieldMetadata {
    ...
    JENIS_PENDAPATAN_INVESTASI_LAIN(
            EnumSet.of(KONVENSIONAL, SYARIAH),
            EnumSet.of(PPMPK, PPMPM),
            sf(2, null, "Jenis Pendapatan Investasi Lain",
                    sv(C, 1, 100, alfaNumeric)
                            .confConditionalRequired(E7062PdinValidationsConfig))
    ),
    JUMLAH(
            EnumSet.of(KONVENSIONAL, SYARIAH),
            EnumSet.of(PPMPK, PPMPM),
    ...
    public static final BaseMetadataField<Dppk0062Pdin> FIELD_PPMPK = new LbltMetadataField<>(Dppk0062Pdin.class, PPMPK);
