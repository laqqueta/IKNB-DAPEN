...
import static id.go.ojk.module.lblt.dppk.reference.ER7055PosLtlbDppkUmps.R_UMPS000000;
import static id.go.ojk.module.lblt.dppk.reference.ER7055PosLtlbDppkUmps.R_UMPS010000;
...
public enum E7055UmpsValidationsConfig implements ILbltMetadataValidation, IValidationConverter {
    ...
    CR_EXISTS_POS_1(programs(PPMPK),
            () -> UtilFieldConditional.genExistPos("N", "M", R_UMPS000000.key)),
    ...
    public static final BaseMetadataValidation<E7055UmpsValidationsConfig> VALIDATION_METADATA =
