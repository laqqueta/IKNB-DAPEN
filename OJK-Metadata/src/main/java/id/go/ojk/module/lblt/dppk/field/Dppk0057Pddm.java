...
import id.go.ojk.module.lblt.dppk.reference.ER7057PosLtlbDppkPddm;
import id.go.ojk.module.lblt.dppk.validations.E7057PddmValidationsConfig;
...
public enum Dppk0057Pddm implements ILbltFieldMetadata {
    ...
    public static final LbltMetadataField<Dppk0057Pddm> FIELD_KONVEN = new LbltMetadataField<>(Dppk0057Pddm.class, KONVENSIONAL);
    ...
    public static SubmissionFormat ppmpkKonvensionalFormMetadata(String reportCode) {
        ...
        return new SubmissionConfig(reportCode)
                .config()
                .setReferenceConfigs(ER7057PosLtlbDppkPddm.Configs.REF_CONFIG_PPMPK)
                .setSubmissionFormat(getSubmissionFormatConfig(KONVENSIONAL, reportCode))
                .setSubmissionField(FIELD_KONVEN.getFields())
                .setSegmentValidations(E7057PddmValidationsConfig.VALIDATION_METADATA)
                .build()
                .get();
    }
}