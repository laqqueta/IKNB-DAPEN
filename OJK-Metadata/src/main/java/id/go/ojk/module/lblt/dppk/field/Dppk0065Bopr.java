...
import id.go.ojk.module.lblt.dppk.reference.ER7065PosLtlbDppkBopr;
import id.go.ojk.module.lblt.dppk.validations.E7065BoprValidationsConfig;
...
public enum Dppk0065Bopr implements ILbltFieldMetadata {
    ...
    JENIS_BEBAN(
            ...
            sf(2, null, "Jenis Beban",
                    sv(C, 1, 6, refTable)
                            .confConditionalRequired(E7065BoprValidationsConfig)
                            .confRegex(SimpleValidation.patternAlfaNumeric)
    ...
    public static final LbltMetadataField<Dppk0065Bopr> FIELD_KONVEN = new LbltMetadataField<>(Dppk0065Bopr.class, KONVENSIONAL);
    ...
    public static SubmissionFormat ppmpkKonvensionalFormMetadata(String reportCode) {
        ...
        return new SubmissionConfig(reportCode)
                .config()
                .setRequiredPos(ER7065PosLtlbDppkBopr.getRequiredPos())
                .setSubmissionFormat(getSubmissionFormatConfig(KONVENSIONAL, reportCode))
                .setSubmissionField(FIELD_KONVEN.getFields())
                .setSegmentValidations(E7065BoprValidationsConfig.VALIDATION_METADATA)
                .build()
                .get();
    }
}