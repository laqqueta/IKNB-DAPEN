...
public enum Dppk0065Bopr implements ILbltFieldMetadata {
    ...
    public static final LbltMetadataField<Dppk0065Bopr> FIELD_KONVEN = new LbltMetadataField<>(Dppk0065Bopr.class, Arrays.asList(KONVENSIONAL, SYARIAH), KODE_KOMPONEN_HEADERS);
