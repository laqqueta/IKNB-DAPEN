...
public enum Dppk0028Shm implements ILbltFieldMetadata {
    ...
    public static final LbltMetadataField<Dppk0028Shm> FIELD_KONVEN = new LbltMetadataField<>(Dppk0028Shm.class, KONVENSIONAL);
    ...
    public static SubmissionFormat ppmpkKonvensionalFormMetadata(String reportCode) {
        ...
        return new SubmissionConfig(reportCode)
                .config()
                .setReferenceConfigs(ER7028PosLtlbDppkShm.Configs.REF_CONFIG_PPMPK)
