...
public enum Dppk0011Roism implements ILbltFieldMetadata {
    ...
    HASIL_INVESTASI_BERSIH(sectors(KONVENSIONAL, SYARIAH), programs(PPMPK, PPMPM),
            sf(9, null, "Hasil investasi bersih", sv(O, 1, 18, numeric))
                    .addFieldValidations(E7011RoismValidationsConfig.FV_FIELD_VALIDATION_1)
    ),
    ...
    ROI(sectors(KONVENSIONAL, SYARIAH), programs(PPMPK, PPMPM),
            sf(11, null, "ROI", sv(O, 3, 18, numericDot))
                    .addFieldValidations(E7011RoismValidationsConfig.FV_FIELD_VALIDATION_2)
    ),
    ;
    ...
    public static final LbltMetadataField<Dppk0011Roism> FIELD_KONVEN = new LbltMetadataField<>(Dppk0011Roism.class, Arrays.asList(KONVENSIONAL, SYARIAH), KODE_KOMPONEN_HEADERS);
    ...
    public static SubmissionFormat ppmpKonvensionalFormMetadata(ProgramType programType) {
        ...
        return new SubmissionConfig(programType.toString())
                .config()
                .setReferenceConfigs(ER7011PosLtlbDppkRoism.Configs.REF_CONFIG_PPMPK)
