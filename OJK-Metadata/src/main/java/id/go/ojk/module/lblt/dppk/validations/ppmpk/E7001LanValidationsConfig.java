...
import static id.go.ojk.module.lblt.dppk.reference.ER7001PosLtlbDppkLan.*;
...
public enum E7001LanValidationsConfig implements ILbltMetadataValidation, IValidationConverter {
    ...
    FV_GABUNGAN_EQUALS_EXCEPT(programs(PPMPK),
    ...
    CR_EXIST_POS_N_PERSENTASE_INVESTASI(programs(PPMPK),
    ...
    public static final BaseMetadataValidation<E7001LanValidationsConfig> VALIDATION_METADATA =
            new LbltMetadataValidation<>(E7001LanValidationsConfig.class, PPMPK);

    public static final EnumSet<E7001LanValidationsConfig> testValidation = EnumSet.of(
            SG_EQUALS_FORMULA_1,
            SG_EQUALS_FORMULA_2,
            SG_EQUALS_FORMULA_3,
            SG_EQUALS_FORMULA_4
