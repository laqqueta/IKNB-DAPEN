...
import id.go.ojk.module.lblt.dppk.reference.ER7067PosLtlbDppkPph;
import id.go.ojk.module.lblt.dppk.validations.E7067PphValidationsConfig;
...
public enum Dppk0067Pph implements ILbltFieldMetadata {
    ...
    JENIS_PAJAK_PENGHASILAN(sectors(KONVENSIONAL, SYARIAH), programs(PPMPK, PPMPM),
    ...
    public static final LbltMetadataField<Dppk0067Pph> FIELD_KONVEN = new LbltMetadataField<>(Dppk0067Pph.class, KONVENSIONAL);
    ...
    public static SubmissionFormat ppmpkKonvensionalFormMetadata(String reportCode) {
        ...
        return new SubmissionConfig(reportCode)
                .config()
                .setReferenceConfigs(ER7067PosLtlbDppkPph.Configs.REF_CONFIG_PPMPK)
                .setSubmissionFormat(getSubmissionFormatConfig(KONVENSIONAL, reportCode))
                .setSubmissionField(FIELD_KONVEN.getFields())
                .setSegmentValidations(E7067PphValidationsConfig.VALIDATION_METADATA)
                .build()
                .get();
    }
}