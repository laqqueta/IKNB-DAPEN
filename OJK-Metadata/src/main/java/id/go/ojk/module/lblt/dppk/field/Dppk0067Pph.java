...
public enum Dppk0067Pph implements ILbltFieldMetadata {
    ...
    public static final LbltMetadataField<Dppk0067Pph> FIELD_KONVEN = new LbltMetadataField<>(Dppk0067Pph.class, Arrays.asList(KONVENSIONAL, SYARIAH), KODE_KOMPONEN_HEADERS);
