...
public enum Dppk0002Lpan implements ILbltFieldMetadata {
    ...
    public static final LbltMetadataField<Dppk0002Lpan> FIELD_KONVEN = new LbltMetadataField<>(Dppk0002Lpan.class, KONVENSIONAL, KODE_KOMPONEN_HEADERS);
...
//                .setSegmentValidations(E7002LpanValidationsConfig.VALIDATION_METADATA)
