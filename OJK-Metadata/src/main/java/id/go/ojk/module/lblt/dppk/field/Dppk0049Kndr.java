...
import id.go.ojk.module.lblt.dppk.reference.ER7049PosLtlbDppkKndr;
import id.go.ojk.module.lblt.dppk.validations.E7049KndrValidationsConfig;
...
public enum Dppk0049Kndr implements ILbltFieldMetadata {
    ...
    public static final LbltMetadataField<Dppk0049Kndr> FIELD_KONVEN = new LbltMetadataField<>(Dppk0049Kndr.class, KONVENSIONAL);
    ...
    public static SubmissionFormat ppmpkKonvensionalFormMetadata(String reportCode) {
        ...
        return new SubmissionConfig(reportCode)
                .config()
                .setReferenceConfigs(ER7049PosLtlbDppkKndr.Configs.REF_CONFIG_PPMPK)
