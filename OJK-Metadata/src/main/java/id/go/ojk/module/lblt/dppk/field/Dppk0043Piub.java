...
public enum Dppk0043Piub implements ILbltFieldMetadata {
    ...
    public static final LbltMetadataField<Dppk0043Piub> FIELD_KONVEN = new LbltMetadataField<>(Dppk0043Piub.class, Arrays.asList(KONVENSIONAL, SYARIAH), KODE_KOMPONEN_HEADERS);
