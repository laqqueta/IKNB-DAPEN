...
import static id.go.ojk.module.lblt.dppk.reference.ER7002PosLtlbDppkLpan.*;
...
public enum E7002LpanValidationsConfig implements ILbltMetadataValidation, IValidationConverter {
    ...
    FV_EQUAL_FORMULA_EXCEPT(programs(PPMPK),
    ...
    public static final BaseMetadataValidation<E7002LpanValidationsConfig> VALIDATION_METADATA =
