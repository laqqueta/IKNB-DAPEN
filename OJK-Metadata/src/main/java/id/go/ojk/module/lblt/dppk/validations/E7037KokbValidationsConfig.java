...
import static id.go.ojk.module.lblt.dppk.reference.ER7037PosLtlbDppkKokb.R_KOKB000000;
...
public enum E7037KokbValidationsConfig implements ILbltMetadataValidation, IValidationConverter {
    ...
    CR_NAMA_PENGELOLA(programs(PPMPK),
            () -> UtilFieldConditional.genEqualsExceptPos("O", "M", "11",
    ...
    public static final BaseMetadataValidation<E7037KokbValidationsConfig> VALIDATION_METADATA =
