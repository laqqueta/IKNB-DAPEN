...
public enum Dppk0050Pkom implements ILbltFieldMetadata {
    ...
    public static final LbltMetadataField<Dppk0050Pkom> FIELD_KONVEN = new LbltMetadataField<>(Dppk0050Pkom.class, Arrays.asList(KONVENSIONAL, SYARIAH), KODE_KOMPONEN_HEADERS);
