...
public enum Dppk0027Rsbn implements ILbltFieldMetadata {
    ...
    public static final LbltMetadataField<Dppk0027Rsbn> FIELD_KONVEN = new LbltMetadataField<>(Dppk0027Rsbn.class, KONVENSIONAL);
    ...
    public static SubmissionFormat ppmpkKonvensionalFormMetadata(String reportCode) {
        ...
        return new SubmissionConfig(reportCode)
                .config()
                .setReferenceConfigs(ER7027PosLtlbDppkRsbn.Configs.REF_CONFIG_PPMPK)
