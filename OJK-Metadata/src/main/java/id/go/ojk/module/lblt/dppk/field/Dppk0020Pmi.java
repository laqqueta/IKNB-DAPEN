...
import id.go.ojk.module.lblt.dppk.reference.ER7020PosLtlbDppkPmi;
...
public enum Dppk0020Pmi implements ILbltFieldMetadata {
    ...
    public static final LbltMetadataField<Dppk0020Pmi> FIELD_KONVEN = new LbltMetadataField<>(Dppk0020Pmi.class, KONVENSIONAL, KODE_KOMPONEN_HEADERS);
