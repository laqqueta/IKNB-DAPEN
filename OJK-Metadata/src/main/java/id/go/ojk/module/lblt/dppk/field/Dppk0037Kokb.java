...
import id.go.ojk.module.lblt.dppk.reference.ER7037PosLtlbDppkKokb;
import id.go.ojk.module.lblt.dppk.validations.E7037KokbValidationsConfig;
...
public enum Dppk0037Kokb implements ILbltFieldMetadata {
    ...
    public static final LbltMetadataField<Dppk0037Kokb> FIELD_KONVEN = new LbltMetadataField<>(Dppk0037Kokb.class, Arrays.asList(KONVENSIONAL, SYARIAH), KODE_KOMPONEN_HEADERS);
