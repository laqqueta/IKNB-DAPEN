...
import static id.go.ojk.module.lblt.dppk.reference.ER7029PosLtlbDppkObli.R_OBLI000000;
import static id.go.ojk.module.lblt.dppk.reference.ER7029PosLtlbDppkObli.R_OBLI010000;
...
public enum E7029ObliValidationsConfig implements ILbltMetadataValidation, IValidationConverter {
    ...
    SG_EQUAL_FORMULA(programs(PPMPK),
            () -> UtilSegmentValidation.genEqualsFormula("6|11|12|13", R_OBLI000000.key, R_OBLI010000.key,
