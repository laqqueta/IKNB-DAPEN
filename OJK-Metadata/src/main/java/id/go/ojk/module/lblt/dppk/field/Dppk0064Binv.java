...
public enum Dppk0064Binv implements ILbltFieldMetadata {
    ...
    JENIS_BEBAN(
            ...
            sf(2, null, "Jenis Beban",
                    sv(C, 1, 6, refTable)
                            .confConditionalRequired(E7064BinvValidationsConfig)
                            .confRegex(SimpleValidation.patternAlfaNumeric)
    ...
    public static final BaseMetadataField<Dppk0064Binv> FIELD_PPMPK = new LbltMetadataField<>(Dppk0064Binv.class, PPMPK);
