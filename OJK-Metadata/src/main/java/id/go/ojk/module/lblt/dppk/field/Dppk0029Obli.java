...
public enum Dppk0029Obli implements ILbltFieldMetadata {
    ...
    KODE_OBLIGASI(sectors(KONVENSIONAL, SYARIAH), programs(PPMPK, PPMPM),
            sf(3, null, "Kode Obligasi",
                    sv(C, 1, 30, alfaNumeric)
                            .confConditionalRequired(E7029ObliValidationsConfig.CR_EXISTS_POS_M))
    ),
    NAMA_OBLIGASI(sectors(KONVENSIONAL, SYARIAH), programs(PPMPK, PPMPM),
    ...
    TANGGAL_JATUH_TEMPO(sectors(KONVENSIONAL, SYARIAH), programs(PPMPK, PPMPM),
            sf(8, null, "Tanggal Jatuh Tempo",
                    sv(C, 8, 8, date)
                            .confConditionalRequired(E7029ObliValidationsConfig.CR_EXISTS_POS_M))
                    .addFieldValidations(E7029ObliValidationsConfig.FV_DATE_GREATER)
    ),
    ...
    SELISIH_PENILAIAN_INVESTASI_NILAI(sectors(KONVENSIONAL, SYARIAH), programs(PPMPK, PPMPM),
            sf(13, null, "Selisih Penilaian Investasi Nilai",
                    sv(M, 1, 18, numeric))
                    .addFieldValidations(E7029ObliValidationsConfig.FV_EQUAL_NILAI_INVESTASI)
    ),
    SELISIH_PENILAIAN_INVESTASI_PERSEN(sectors(KONVENSIONAL, SYARIAH), programs(PPMPK, PPMPM),
            sf(14, null, "Selisih Penilaian Investasi %",
                    sv(C, 4, 6, numericDot)
                            .confConditionalRequired(E7029ObliValidationsConfig.CR_EXISTS_POS_M))
                    .addFieldValidations(E7029ObliValidationsConfig.FV_EQUAL_PERSENTASE_INVESTASI)
    ),
    ...
    PENGELOLAAN_NAMA_MANAJER_INVESTASI(sectors(KONVENSIONAL, SYARIAH), programs(PPMPK, PPMPM),
            sf(19, null, "Pengelolaan Nama Manajer Investasi",
                    sv(C, 1, 250, freeText)
                            .confConditionalRequired(E7029ObliValidationsConfig.CR_EXISTS_POS_M)
                            .confConditionalRequired(E7029ObliValidationsConfig.CR_NAMA_PENGELOLA))
    ),
    KETERANGAN(sectors(KONVENSIONAL, SYARIAH), programs(PPMPK, PPMPM),
            sf(20, null, "Keterangan",
                    sv(C, 1, 250, freeText)
                            .confConditionalRequired(E7029ObliValidationsConfig.CR_EXISTS_POS_O))
    ),
    ;
    ...
    public static final LbltMetadataField<Dppk0029Obli> FIELD_KONVEN = new LbltMetadataField<>(Dppk0029Obli.class, Arrays.asList(KONVENSIONAL, SYARIAH), KODE_KOMPONEN_HEADERS);
