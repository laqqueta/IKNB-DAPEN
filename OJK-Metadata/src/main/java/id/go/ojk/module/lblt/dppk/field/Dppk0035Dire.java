...
public enum Dppk0035Dire implements ILbltFieldMetadata {
    ...
    KODE(EnumSet.of(KONVENSIONAL, SYARIAH), EnumSet.of(PPMPK, PPMPM),
            sf(2, null, "Kode",
                    ...
                    .confConditionalRequired(E7035DireValidationsConfig))),
    ...
    SELISIH_PENILAIAN_INVESTASI_NILAI(EnumSet.of(KONVENSIONAL, SYARIAH), EnumSet.of(PPMPK, PPMPM),
            sf(9, null, "Selisih Penilaian Investasi Nilai",
                    sv(M, 1, 18, numeric))
            .addFieldValidations(E7035DireValidationsConfig)),
    ...
    public static final BaseMetadataField<Dppk0035Dire> FIELD_PPMPK = new LbltMetadataField<>(Dppk0035Dire.class, PPMPK);
