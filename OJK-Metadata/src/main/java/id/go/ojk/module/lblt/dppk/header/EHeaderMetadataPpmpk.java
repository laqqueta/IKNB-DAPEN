...
public enum EHeaderMetadataPpmpk implements IObject<ReferenceMetadata> {
    ...
    R7001Lan(ER7001PosLtlbDppkLan.getRefNumber(), ER7001PosLtlbDppkLan.getName(), ER7001PosLtlbDppkLan.getObjects(ProgramType.PPMPK)),
    R7002Lpan(ER7002PosLtlbDppkLpan.getRefNumber(), ER7002PosLtlbDppkLpan.getName(), ER7002PosLtlbDppkLpan.getObjects(ProgramType.PPMPK)),
    R7003Nrc(ER7003PosLtlbDppkNrc.getRefNumber(), ER7003PosLtlbDppkNrc.getName(), ER7003PosLtlbDppkNrc.getObjects(ProgramType.PPMPK)),
    ...
    R7007Kup(ER7007PosLtlbDppkKup.getRefNumber(), ER7007PosLtlbDppkKup.getName(), ER7007PosLtlbDppkKup.getObjects(ProgramType.PPMPK)),
    R7008Rekinv(ER7008PosLtlbDppkRekinv.getRefNumber(), ER7008PosLtlbDppkRekinv.getName(), ER7008PosLtlbDppkRekinv.getObjects(ProgramType.PPMPK)),
    ...
    R7012Alm(ER7012PosLtlbDppkAlm.getRefNumber(), ER7012PosLtlbDppkAlm.getName(), ER7012PosLtlbDppkAlm.getObjects(ProgramType.PPMPK)),
    ...
    R7017Ras1(ER7017PosLtlbDppkRas1.getRefNumber(), ER7017PosLtlbDppkRas1.getName(), ER7017PosLtlbDppkRas1.getObjects(ProgramType.PPMPK)),
