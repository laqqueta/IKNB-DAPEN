...
import static id.go.ojk.module.lblt.dppk.reference.ER7022PosLtlbDppkDoc.R_DOC000000;
import static id.go.ojk.module.lblt.dppk.reference.ER7022PosLtlbDppkDoc.R_DOC010000;
...
public enum E7022DocValidationsConfig implements ILbltMetadataValidation, IValidationConverter {
    ...
    SG_EQUAL_DOC000000_DOC010000(programs(PPMPK),
    ...
    CR_EXISTS_DOC000000_M(programs(PPMPK),
            () -> UtilFieldConditional.genExistPos("N", "M", R_DOC000000.key)),

    CR_EXISTS_DOC000000_O(programs(PPMPK),
            () -> UtilFieldConditional.genExistPos("N", "O", R_DOC000000.key)),

    CR_EQUAL_EXCEPT_DOC000000(programs(PPMPK),
    ...
    public static final BaseMetadataValidation<E7022DocValidationsConfig> VALIDATION_METADATA =
