package id.go.ojk.gdk.client.builder;
...
import id.go.ojk.gdk.client.builder.field.EUpdateHeader;
import id.go.ojk.gdk.client.builder.field.setup.ESetupKeyValueStringFilename;
import id.go.ojk.lib.client.model.update.UpdateHeader;
import lombok.extern.slf4j.Slf4j;

@Slf4j
public class GdkDatBuilder extends BaseDatBuilder {
	private static final EReport REPORT_APU = EReport.APU_GDK;
	private static final String DUMMY_USER = "gdkdummy@gmail.com";

	public static void main(String[] args) {
		try {
			log.info("starting builder");
			GdkDatBuilder builder = new GdkDatBuilder(args);
	...
	public GdkDatBuilder(String[] args) {
	...
	protected String genDummyClientEntity() {
		return genDummyClientEntity(Constant.SECTOR.getCode(), Arrays.asList("2000015328"), DUMMY_USER);
	}
